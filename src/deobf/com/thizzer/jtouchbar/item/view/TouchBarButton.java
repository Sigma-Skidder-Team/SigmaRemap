...
public class TouchBarButton extends TouchBarView {
   ...
   private TouchBarButton$class_33 _type = TouchBarButton$class_33.MOMENTARY_LIGHT;
   ...
   public TouchBarButton$class_33 getType() {
      return this._type;
   }

   public void setType(TouchBarButton$class_33 type) {
      this._type = type;
      this.update();
   }
