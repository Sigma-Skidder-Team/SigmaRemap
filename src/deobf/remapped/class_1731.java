      ...
      if (this.method_42015() && var1.method_6449()) {
         ...
         if (var4 >= 0 || var4 <= 8) {
            if (mcInstance.field_9632.method_26617(class_2584.field_12791).method_27960() == class_4897.field_25206) {
               ...
               float var5 = mcInstance.field_9632.field_41701;
               float var6 = -90.0F;
               ...
               if (mcInstance.field_9632.field_41726 && mcInstance.field_9632.field_41774) {
                  mcInstance.field_9632.method_26595();
               } else if (!(mcInstance.field_9632.method_37098().field_7333 < 0.0)) {
                  if (mcInstance.field_9616.field_32603 == 0.1F) {
                     mcInstance.field_9616.field_32603 = 1.0F;
                  }
               } else {
                  mcInstance.field_9616.field_32603 = 0.1F;
               }
