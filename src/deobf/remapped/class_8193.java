...
public class class_8193 extends class_9128 {
   ...
   public void method_37542(class_7767 var1) {
      if (!this.method_42015()) {
         ...
         if (this.field_41932 > 0) {
            ...
            if (this.field_41932 != 0) {
               if (this.field_41934) {
                  ...
                  if (this.field_41932 != -4) {
                     if (this.field_41932 != -1) {
                        if (class_3347.method_15349() > class_412.field_1747.method_2055()) {
                           if (field_46692.field_9577.field_45450.method_27060() && !this.field_41931) {
                              var1.method_35235(0.0625);
                              class_8865.method_40777(var1, 0.0);
                              this.field_41932 = 1;
                           } else if (this.field_41931 && !field_46692.field_9577.field_45450.method_27060()) {
                  ...
                  } else if (field_46692.field_9577.field_45450.method_27060() && !this.field_41931) {
                     var1.method_35235(0.0625);
                  }
               }
               ...
               if (!class_314.method_1413(field_46692.field_9632, 0.001F)) {
                  var1.method_35235(0.0);
                  class_8865.method_40777(var1, 0.0);
                  if (field_46692.field_9632.field_41706 > 4.0F) {
               ...
               this.field_41932 = 1;
            } else if (!class_314.method_1413(field_46692.field_9632, 0.001F)) {
               var1.method_35235(0.0);
               this.field_41932 = -2;
               class_727.method_3328().method_3335().method_27841(new class_8235("Cubecraft Fly", "Please start on the ground."));
            } else {
               class_8865.method_40777(var1, 0.0);
               var1.method_35235(0.0);
               long var14 = class_314.method_1418() % 90L;
               double var15 = 0.016 + (double)var14 / 10000.0;
               double var16 = field_46692.field_9632.method_37302();
               double var10 = field_46692.field_9632.method_37309() + 0.022;
               double var12 = field_46692.field_9632.method_37156();
               field_46692.method_8614().method_4813(new class_9515(var16, var10, var12, false));
               field_46692.method_8614().method_4813(new class_9515(var16, var10, var12 + 0.07, false));
               field_46692.method_8614().method_4813(new class_9515(var16, var10, var12, false));
               field_46692.method_8614().method_4813(new class_9515(var16, var10 + 3.0, var12, false));
            }
         ...
         if (field_46692.field_9632.field_41697 % 2 == 0) {
            ...
            field_46692.field_9632.method_37256(var4, var6 + 1.0E-10, var8);
         }
      }
   }
   ...
   public void method_37544(class_1393 var1) {
      if (var1.method_6449() && class_314.method_1392()) {
         ...
         if (class_3347.method_15349() == class_412.field_1747.method_2055() && this.field_41932 == 0 && class_314.method_1413(field_46692.field_9632, 0.001F)) {
            var1.method_29715(true);
         }
   ...
   public void method_37541(class_139 var1) {
      if (field_46692.field_9601 != null && field_46692.method_8614() != null && class_314.method_1392()) {
