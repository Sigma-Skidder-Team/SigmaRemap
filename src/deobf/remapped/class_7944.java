...
public class class_7944 extends class_5735 {
   private static final Map<String, String> field_40661 = ImmutableMap.builder()
   ...
   public class_7944(Schema var1, boolean var2) {
      super(var1, var2, "Recipes fix", var0 -> field_40661.getOrDefault(var0, var0));
   }
}
