...
public class class_6937 implements ArgumentType<class_4639> {
   ...
   public <S> CompletableFuture<Suggestions> listSuggestions(CommandContext<S> var1, SuggestionsBuilder var2) {
      return !(var1.getSource() instanceof class_8773)
         ? Suggestions.empty()
         : class_8773.method_40310(((class_8773)var1.getSource()).method_40317().stream().<class_4639>map(class_5621::method_25499), var2);
   }
