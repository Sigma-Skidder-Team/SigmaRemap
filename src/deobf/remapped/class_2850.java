...
public class class_2850 extends class_9128 {
   ...
   public void method_12965(class_7767 var1) {
      if (this.method_42015()) {
         boolean var4 = field_46692.field_9632.field_41726 || class_314.method_1413(field_46692.field_9632, 0.001F);
         if (!var4) {
            if (var1.method_35236() < 0.0) {
               if (this.field_13966 != field_46692.field_9632.method_37245().field_7333) {
                  if (field_46692.field_9632.method_37245().field_7333 + var1.method_35236() < this.field_13966) {
                     this.field_13969 = true;
                     int var5 = this.method_12961();
                     boolean var6 = this.method_42007("Fake Block");
                     if (var5 >= 0 && var6) {
                        field_46692.method_8614().method_4813(new class_7371(var5));
                     }
                     ...
                     if (var6 && (var5 >= 0 || field_46692.field_9632.method_26617(class_2584.field_12791).method_27960() instanceof class_6201)) {
                        ...
                        field_46692.method_8614().method_4813(var8);
                     }
                     ...
                     var1.method_35235(this.field_13966 - field_46692.field_9632.method_37245().field_7333);
                  }
               } else {
                  field_46692.field_9632.method_26595();
                  var1.method_35235(field_46692.field_9632.method_37098().field_7333);
                  this.field_13966 = !field_46692.field_9577.field_45450.method_27060()
                     ? (!this.field_13967 ? field_46692.field_9632.method_37245().field_7333 : field_46692.field_9632.method_37245().field_7333 - 1.0)
                     : (!this.field_13967 ? field_46692.field_9632.method_37245().field_7333 + 1.0 : field_46692.field_9632.method_37245().field_7333);
      ...
      for (int var3 = 36; var3 < 45; var3++) {
         if (field_46692.field_9632.field_3869.method_18878(var3).method_35884()) {
            ...
            if (var4.method_27960() instanceof class_6201) {
               if (var3 - 36 == field_46692.field_9632.field_3853.field_36404) {
                  var3 = 34;
               }
