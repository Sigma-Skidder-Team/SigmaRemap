...
public class class_191 {
   ...
   public void method_845(class_6015 var1) {
      this.method_837();
      this.method_852(new class_3709());
      this.method_852(new class_2368());
      ...
      this.method_852(new class_7232());
      ...
      this.method_852(new class_2776());
      ...
      this.method_852(new class_6518());
      this.method_852(new class_3095());
      this.method_852(new class_3218());
      this.method_852(new class_2016());
      ...
      this.method_852(new class_7042());
      this.method_852(new class_7366());
      ...
      this.method_852(new class_7008());
      if (var1 != class_6015.field_30645) {
         if (var1 == class_6015.field_30644) {
            ...
            this.method_852(new class_2633());
         }
      } else {
