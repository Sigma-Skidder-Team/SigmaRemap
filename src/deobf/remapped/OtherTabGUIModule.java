...
public class OtherTabGUIModule extends Module {
   ...
   public OtherTabGUIModule() {
      super(Category.GUI, "TabGUI", "Manage mods without opening the ClickGUI");
   }

   @Override
   public void method_42012() {
      this.categoryList.add(Category.COMBAT);
      this.categoryList.add(Category.PLAYER);
      this.categoryList.add(Category.MOVEMENT);
      this.categoryList.add(Category.RENDER);
      this.categoryList.add(Category.WORLD);
      this.categoryList.add(Category.MISC);
      ArrayList var3 = new ArrayList();

      for (Category var5 : this.categoryList) {
   ...
   private void method_1198(boolean var1) {
      ...
      Category var7 = this.categoryList.get(var4.field_14700);
   ...
   private void method_1208() {
      if (field_960.size() >= 2) {
         ...
         class_2990 var4 = (class_2990)field_960.get(0);
         Category var5 = this.categoryList.get(var4.field_14700);
         int var6 = 0;
   ...
   private void method_1210(float var1) {
      ...
      if (var4 == 2 || var4 == 3) {
         ...
         Category var9 = this.categoryList.get(var5.field_14700);
