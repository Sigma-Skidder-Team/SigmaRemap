...
public class class_7852 extends class_7038 {
   ...
   public class_7852(class_7038 var1, String var2, int var3, int var4, int var5, int var6) {
      ...
      var10.method_32100((var2x, var3x) -> new Thread(() -> {
            class_8646 var4x = SigmaMainClass.method_3328().method_3332().method_23083();
            if (var4x != null) {
               var4x.method_39656(this.field_39795.method_32165());
            }

            this.field_39791 = SigmaMainClass.method_3328().method_3332().method_23085(var9.method_32165(), SigmaMainClass.method_3328().method_3332().method_23083());
