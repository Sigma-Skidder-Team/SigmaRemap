...
public class class_7096 implements class_4904 {
   ...
   private final ItemStack field_36607;
   ...
   public class_7096(class_2451 var1, int var2, int var3, int var4, float var5) {
      this.field_36607 = new ItemStack(var1);
   ...
   public class_8014 method_22451(Entity var1, Random var2) {
      ...
      ItemStack var6 = class_2931.method_13426(var2, new ItemStack(this.field_36607.method_27960()), var5, false);
      int var7 = Math.min(this.field_36609 + var5, 64);
      ItemStack var8 = new ItemStack(class_4897.field_24997, var7);
