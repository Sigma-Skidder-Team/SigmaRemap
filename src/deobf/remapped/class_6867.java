...
public interface class_6867 extends class_5507 {
   ...
   class_6098 method_31498(int var1);

   class_6098 method_31497(int var1, int var2);

   class_6098 method_31507(int var1);

   void method_31503(int var1, class_6098 var2);
   ...
   default boolean method_31500(int var1, class_6098 var2) {
      return true;
   }
   ...
   default int method_31504(class_2451 var1) {
      ...
      for (int var5 = 0; var5 < this.method_31505(); var5++) {
         class_6098 var6 = this.method_31498(var5);
