...
public class class_2409 extends class_5920<class_4612> {
   ...
   private void method_10963(class_6331 var1, class_4612 var2, LivingEntity var3) {
      for (int var6 = 0; var6 < 10; var6++) {
         Vector3d var7 = class_3425.method_15834(var2, 20, 8);
   ...
   private static void method_10951(class_4612 var0, LivingEntity var1) {
   ...
   private Optional<LivingEntity> method_10955(class_4612 var1) {
      return this.method_10961(var1).stream().findAny();
   }

   private Optional<LivingEntity> method_10954(class_4612 var1) {
   ...
   private Map<LivingEntity, Integer> method_10958(class_4612 var1) {
   ...
   private List<LivingEntity> method_10961(class_4612 var1) {
      return var1.method_26525().<List<LivingEntity>>method_5138(class_6044.field_30875).get();
   }

   private LivingEntity method_10957(LivingEntity var1) {
      return var1.method_26525().<LivingEntity>method_5138(class_6044.field_30861).get();
   }

   @Nullable
   private LivingEntity method_10952(LivingEntity var1) {
      return var1.method_26525()
         .<List<LivingEntity>>method_5138(class_6044.field_30875)
         .get()
         .stream()
   ...
   private boolean method_10959(LivingEntity var1) {
      return var1.method_26525().<LivingEntity>method_5138(class_6044.field_30861).isPresent();
   }

   private boolean method_10956(LivingEntity var1, LivingEntity var2) {
      return var2.method_26525().<LivingEntity>method_5138(class_6044.field_30861).filter(var1x -> var1x == var1).isPresent();
   }
