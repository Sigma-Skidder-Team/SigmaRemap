...
public class class_9824 extends class_9128 {
   ...
   public void method_45280(class_7767 var1) {
      if (this.method_42015()) {
         ...
         if (class_727.method_3328().method_3298().method_847(class_6908.class).method_42003() || !this.method_42007("Only speed")) {
   ...
   public void method_45282(class_8145 var1, double var2, double var4, class_7767 var6) {
      ...
      if (!var27.equals("None")) {
         if (!this.field_49776 && this.method_45278(var26) && !class_727.method_3328().method_3298().method_847(class_2368.class).method_42015()) {
            this.field_49775 *= -1;
      ...
      if (this.field_49776 && field_46692.field_9632.method_37175(var1) > this.method_42002("Radius")) {
         if (!var27.equals("Halt")) {
            ...
            if (var27.equals("Smart")) {
               ...
               if (this.method_45278(var26) && !class_727.method_3328().method_3298().method_847(class_2368.class).method_42015()) {
