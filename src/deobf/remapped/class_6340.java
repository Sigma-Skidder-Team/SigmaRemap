...
public class class_6340 extends class_7621 {
   ...
   private final class_1893 field_32368;
   ...
   public class_6340(class_1893 var1, class_4302 var2, Consumer<Optional<Throwable>> var3, boolean var4) {
   ...
   public static void method_29014(float var0, float var1) {
      ...
      GL11.glEnable(3042);
      class_73.method_97(
         0.0F, 0.0F, (float)class_1893.method_8510().field_9602.method_43166(), (float)class_1893.method_8510().field_9602.method_43163(), field_32371, var0
      );
      class_73.method_103(
         0.0F,
         0.0F,
         (float)class_1893.method_8510().field_9602.method_43166(),
         (float)class_1893.method_8510().field_9602.method_43163(),
         class_314.method_1444(0, 0.75F)
      );
      short var4 = 455;
      byte var5 = 78;
      int var6 = (class_1893.method_8510().field_9602.method_43166() - var4) / 2;
      int var7 = Math.round((float)((class_1893.method_8510().field_9602.method_43163() - var5) / 2) - 14.0F * var0);
      float var8 = 0.75F + var0 * var0 * var0 * var0 * 0.25F;
      GL11.glPushMatrix();
      GL11.glTranslatef((float)(class_1893.method_8510().field_9602.method_43166() / 2), (float)(class_1893.method_8510().field_9602.method_43163() / 2), 0.0F);
      GL11.glScalef(var8, var8, 0.0F);
      GL11.glTranslatef(
         (float)(-class_1893.method_8510().field_9602.method_43166() / 2), (float)(-class_1893.method_8510().field_9602.method_43163() / 2), 0.0F
      );
