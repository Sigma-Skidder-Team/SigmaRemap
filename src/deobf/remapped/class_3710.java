...
public class class_3710 {
   ...
   public void method_17228(class_2072 var1) {
      ...
      this.field_18202++;
      class_1920.method_8739(var1.method_9672(), this.field_18199);
   }
   ...
   public void method_17227() {
      ...
      if (this.field_18202 <= 0) {
         class_1920.method_8766(this.field_18199);
   ...
   public static class_3710 method_17225(class_7667 var0, String var1, InputStream var2, String var3) throws IOException {
      ...
      if (var6 != null) {
         int var7 = class_1920.method_8931(class_7667.method_34736(var0));
         class_1920.method_8845(var7, var6);
         class_1920.method_8888(var7);
         if (class_1920.method_8866(var7, 35713) != 0) {
            class_3710 var9 = new class_3710(var0, var7, var1);
            var0.method_34733().put(var1, var9);
            return var9;
         } else {
            String var8 = StringUtils.trim(class_1920.method_8889(var7, 32768));
