...
public class class_4356 extends class_446 {
   ...
   public void method_32178(float var1) {
      ...
      if (this.method_32093() + this.method_32164() < class_1893.method_8510().field_9602.method_43163() - 36 && this.method_32093() + this.method_32164() > 52
         )
       {
   ...
   public void method_20216() {
      ...
      GL11.glTranslatef((float)(-this.method_32132() - 44), (float)(-this.method_32173() - 44), 0.0F);
      if (this.field_21333 == null) {
         class_1893.method_8510().method_8577().method_35674(new class_4639("textures/misc/unknown_server.png"));
         class_73.method_137(
