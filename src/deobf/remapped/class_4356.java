...
public class class_4356 extends class_446 {
   ...
   public void finalize() throws Throwable {
      try {
         if (this.field_21338 != null) {
            SigmaMainClass.getInstance().method_3329(this.field_21338);
         }

         if (this.field_21333 != null) {
            SigmaMainClass.getInstance().method_3329(this.field_21333);
         }
      } finally {
         super.finalize();
      }
   ...
   public void method_32178(float var1) {
      ...
      if (this.method_32093() + this.method_32164() < MinecraftClient.getInstance().window.method_43163() - 36 && this.method_32093() + this.method_32164() > 52
         )
       {
