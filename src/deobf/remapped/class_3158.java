      ...
      if (var1.method_5850("target")) {
         ...
         if (var1.method_5850("type")) {
            ...
            switch (var4) {
               ...
               case "screen":
                  Class var8 = class_727.method_3328().method_3299().method_31007(var1.method_5861("target"));
                  if (var8 != null) {
   ...
   public class_1293 method_14564() {
      ...
      switch (this.method_14566()) {
         ...
         case field_25373:
            ...
            var3.method_5820("target", class_727.method_3328().method_3299().method_31010((Class<? extends class_266>)this.field_15686));
      }
