...
public class class_1213 extends class_3620 {
   ...
   public double method_5380(int var1) {
      ...
      if (var1 < 0 || var1 >= var4.length) {
         return field_46692.field_9632.method_37098().field_7333;
      } else {
         return class_314.method_1434() && !field_46692.field_9632.field_41744 ? var4[var1] : var5[var1];
      }
   }
   ...
   public double method_5381(int var1) {
      ...
      var1--;
      return var1 >= 0 && var1 < var4.length ? var4[var1] : field_46692.field_9632.method_37098().field_7333;
   }
}
