...
public class class_6722 extends class_4314 {
   ...
   public class_6722(class_3073 var1) {
      ...
      this.method_29284(
         this.field_32751
            .method_36446()
            .method_10308(field_34709, Direction.field_818)
   ...
   public void method_10801(class_2522 var1, World var2, BlockPos var3, class_6414 var4, BlockPos var5, boolean var6) {
      ...
      if (var9 != var1.<Boolean>method_10313(field_34722)) {
         if (var9) {
            this.method_30850(var2, var3, (Direction)null);
         }
   ...
   private boolean method_30853(class_2522 var1, Direction var2, double var3) {
      if (var2.method_1029() != class_9249.field_47216 && !(var3 > 0.8124F)) {
         Direction var7 = var1.<Direction>method_10313(field_34709);
   ...
   public boolean method_30850(World var1, BlockPos var2, Direction var3) {
      ...
      if (!var1.field_33055 && var6 instanceof class_9317) {
         if (var3 == null) {
            var3 = var1.method_28262(var2).<Direction>method_10313(field_34709);
         }
   ...
   private class_4190 method_30851(class_2522 var1) {
      Direction var4 = var1.<Direction>method_10313(field_34709);
            ...
            if (var5 != class_7048.field_36395) {
               if (var4 != Direction.field_818) {
                  if (var4 != Direction.field_800) {
                     return var4 != Direction.field_804 ? field_34710 : field_34714;
                  } else {
                     return field_34708;
                  }
               } else {
               ...
               return var4 != Direction.field_818 && var4 != Direction.field_800 ? field_34720 : field_34712;
            }
         } else {
            return field_34711;
         }
      } else {
         return var4 != Direction.field_818 && var4 != Direction.field_800 ? field_34716 : field_34715;
      }
   }
   ...
   public class_2522 method_29302(class_353 var1) {
      ...
      if (var7 != class_9249.field_47216) {
         boolean var8 = var7 == class_9249.field_47215
               && var6.method_28262(var5.method_6108()).method_8308(var6, var5.method_6108(), Direction.field_804)
               && var6.method_28262(var5.method_6090()).method_8308(var6, var5.method_6090(), Direction.field_809)
            || var7 == class_9249.field_47219
               && var6.method_28262(var5.method_6094()).method_8308(var6, var5.method_6094(), Direction.field_800)
               && var6.method_28262(var5.method_6073()).method_8308(var6, var5.method_6073(), Direction.field_818);
         ...
         boolean var10 = var6.method_28262(var5.method_6100()).method_8308(var6, var5.method_6100(), Direction.field_817);
         ...
         class_2522 var11 = this.method_29260()
            .method_10308(field_34719, var4 != Direction.field_802 ? class_7048.field_36394 : class_7048.field_36399)
   ...
   public class_2522 method_10763(class_2522 var1, Direction var2, class_2522 var3, class_9379 var4, BlockPos var5, BlockPos var6) {
      ...
      if (var10 == var2 && !var1.method_8309(var4, var5) && var9 != class_7048.field_36395) {
         ...
         if (var2.method_1029() == var1.<Direction>method_10313(field_34709).method_1029()) {
            ...
            if (var9 == class_7048.field_36397 && var10.method_1046() == var2 && var3.method_8308(var4, var6, var1.<Direction>method_10313(field_34709))) {
   ...
   // $VF: Unable to simplify switch on enum
   // Please report this to the Vineflower issue tracker, at https://github.com/Vineflower/vineflower/issues with a copy of the class file (if you have the rights to distribute it!)
   private static Direction method_30849(class_2522 var0) {
      switch ((class_7048)var0.method_10313(field_34719)) {
         ...
         default:
            return var0.<Direction>method_10313(field_34709).method_1046();
      }
   }
