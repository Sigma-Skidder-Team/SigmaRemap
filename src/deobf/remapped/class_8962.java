...
public class class_8962<E extends MobEntity> extends class_5920<E> {
   ...
   private final Function<E, Optional<? extends LivingEntity>> field_45911;

   public class_8962(Predicate<E> var1, Function<E, Optional<? extends LivingEntity>> var2) {
   ...
   public class_8962(Function<E, Optional<? extends LivingEntity>> var1) {
      this(var0 -> true, var1);
   }
   ...
   private void method_41121(E var1, LivingEntity var2) {
