...
public class class_7962 {
   ...
   private final Long2ObjectMap<Monitor> field_40793 = new Long2ObjectOpenHashMap();
   ...
   @Nullable
   public Monitor method_36021(long var1) {
      RenderSystem.assertThread(RenderSystem::isInInitPhase);
      return (Monitor)this.field_40793.get(var1);
   }
   ...
   public Monitor getMonitor(MainWindow var1) {
      ...
      if (var4 == 0L) {
         ...
         while (var12.hasNext()) {
            ...
            int var15 = var14 + var13.method_9702().getWidth();
            int var16 = var13.method_9703();
            int var17 = var16 + var13.method_9702().getHeight();
