...
public class class_5527 extends class_2596 {
   ...
   public class_5527() {
      ...
      this.field_28178.method_32100((var0, var1) -> SigmaMainClass.getInstance().getGUIManager().method_30990(new class_2135()));
      this.field_28179.method_32100((var1, var2) -> {
         String var5x = "";

         try {
            var5x = GLFW.glfwGetClipboardString(MinecraftClient.getInstance().window.getHandle());
