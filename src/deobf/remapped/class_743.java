...
public class class_743 extends class_7164<IronGolemEntity, class_7946<IronGolemEntity>> {
   ...
   public class_743(EntityRenderDispatcher var1) {
      super(var1, new class_7946<IronGolemEntity>(), 0.7F);
      this.method_29100(new class_1650(this));
      this.method_29100(new class_2322(this));
   }

   public Identifier method_3373(IronGolemEntity var1) {
      return field_4046;
   }

   public void method_3372(IronGolemEntity var1, class_7966 var2, float var3, float var4, float var5) {
