...
public abstract class class_6967 extends class_3599 {
   ...
   public BlockPos field_35802 = BlockPos.field_7306;
   ...
   public class_6967(class_4612 var1, double var2, int var4, int var5) {
      ...
      this.method_16800(EnumSet.<Flag>of(Flag.MOVE, Flag.JUMP));
   }
   ...
   public boolean method_16799() {
      return this.field_35808 >= -this.field_35809 && this.field_35808 <= 1200 && this.method_31855(this.field_35801.world, this.field_35802);
   }
   ...
   public void method_31859() {
      this.field_35801
         ...
         .method_5595(
            ...
            (double)((float)this.field_35802.getZ()) + 0.5,
            this.field_35803
         );
   }
   ...
   public void method_16794() {
      BlockPos var3 = this.method_31861();
      if (var3.method_12170(this.field_35801.method_37245(), this.method_31857())) {
         ...
         if (this.method_31858()) {
            this.field_35801
               .method_26927()
               .method_5595(
                  (double)((float)var3.getX()) + 0.5, (double)var3.getY(), (double)((float)var3.getZ()) + 0.5, this.field_35803
               );
         }
      }
   }
   ...
   public boolean method_31856() {
      ...
      BlockPos var5 = this.field_35801.method_37075();
         ...
         for (int var8 = 0; var8 < var3; var8++) {
            for (int var9 = 0; var9 <= var8; var9 = var9 <= 0 ? 1 - var9 : -var9) {
               for (int var10 = var9 < var8 && var9 > -var8 ? var8 : 0; var10 <= var8; var10 = var10 <= 0 ? 1 - var10 : -var10) {
                  ...
                  if (this.field_35801.method_26880(var6) && this.method_31855(this.field_35801.world, var6)) {
   ...
   public abstract boolean method_31855(class_4924 var1, BlockPos var2);
}
