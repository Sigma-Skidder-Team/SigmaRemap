...
public final class class_3247 implements ITagCollection<T> {
   ...
   public Identifier method_43144(class_2307<T> var1) {
      return !(var1 instanceof INamedTag) ? (Identifier)this.field_16138.inverse().get(var1) : ((INamedTag)var1).method_40487();
   }
