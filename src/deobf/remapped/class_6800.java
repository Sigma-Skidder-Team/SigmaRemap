...
public class class_6800 implements class_4904 {
   ...
   private final ItemStack field_35048;
   ...
   public class_6800(class_2451 var1, int var2, class_2451 var3, int var4, int var5, int var6, int var7) {
      this.field_35048 = new ItemStack(var3);
   ...
   public class_8014 method_22451(Entity var1, Random var2) {
      ItemStack var5 = new ItemStack(class_4897.field_24997, this.field_35047);
      ...
      ItemStack var8 = class_9541.method_43999(new ItemStack(this.field_35048.method_27960(), this.field_35046), var7);
      return new class_8014(var5, new ItemStack(this.field_35043, this.field_35045), var8, this.field_35044, this.field_35049, this.field_35042);
   }
}
