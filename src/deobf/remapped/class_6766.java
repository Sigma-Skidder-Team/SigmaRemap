...
public class class_6766 extends class_3599 {
   ...
   public boolean method_16795() {
      if (this.field_34923.method_3913() != null) {
         return this.field_34923.world.getGameRules().getBoolean(GameRules.MOB_GRIEFING) ? this.field_34923.method_26594().nextInt(2000) == 0 : false;
      } else {
         return false;
      }
   }
   ...
   public void method_16794() {
      ...
      int var5 = MathHelper.floor(this.field_34923.getPosX() - 1.0 + var3.nextDouble() * 2.0);
      int var6 = MathHelper.floor(this.field_34923.method_37309() + var3.nextDouble() * 2.0);
      int var7 = MathHelper.floor(this.field_34923.getPosZ() - 1.0 + var3.nextDouble() * 2.0);
