...
public class class_7684 extends Module {
         ...
         if (!MinecraftClient.getInstance().gameOptions.hideGUI) {
            if (!(client.screen instanceof class_5766)) {
               ...
               if (this.getBooleanValueByName("Show Player")) {
                  var6 += this.method_34823(0, client.window.method_43163() - 23, 114);
               }

               if (this.getBooleanValueByName("Show Armor")) {
                  var6 += this.method_34822(var6, client.window.method_43163() - 14) + 10;
               }
   ...
   public int method_34822(int var1, int var2) {
      ...
      for (int var6 = 0; var6 < client.thePlayer.inventory.field_36405.size(); var6++) {
         ItemStack var7 = client.thePlayer.inventory.field_36405.get(var6);
