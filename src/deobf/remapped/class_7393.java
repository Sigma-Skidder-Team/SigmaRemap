...
public class class_7393 implements Predicate<class_9115> {
   ...
   private final CompoundNBT field_37749;

   public class_7393(class_2522 var1, Set<class_5019<?>> var2, CompoundNBT var3) {
   ...
   public boolean test(class_9115 var1) {
      ...
      if (!var4.method_8350(this.field_37750.method_8360())) {
         ...
         if (this.field_37749 == null) {
            ...
            return var7 != null && class_4338.method_20182(this.field_37749, var7.method_17396(new CompoundNBT()), true);
         }
      }
   }
}
