...
public class AutoMinerModule extends Module {
   ...
   public void method_22860(PacketEvent var1) {
      if (this.method_42015()) {
         if (var1.method_557() instanceof class_4267) {
            ...
            this.method_22854(mc.field_9601.method_29542(var4.method_19867()).method_27352());
         }
      ...
      for (float var11 = (float)var7; var11 <= (float)var10 && !(var11 > 100.0F); var11++) {
         for (float var12 = (float)var5; var12 <= (float)var8; var12++) {
            for (float var13 = (float)var6; var13 <= (float)var9; var13++) {
               ...
               if (mc.field_9601.method_28262(var14).method_8360() == class_4783.field_23681) {
                  var4.add(var14);
               }
            }
         }
      ...
      if (this.method_42015()) {
         if (mc.field_9632.field_41697 < 20) {
            ...
            while (var12.hasNext()) {
               ...
               if (var13.method_2543(new class_2034(mc.field_9632.field_41742, mc.field_9632.field_41714)) > 7
            ...
            if (!var14 && mc.field_9632.field_41726 && !SigmaMainClass.getInstance().method_3301().method_27149() && this.field_25750 == null) {
                  ...
                  () -> {
                     ...
                     for (class_1331 var6x : var15) {
                        try {
                           ...
                           class_8670 var7x = new class_8670(new class_7047(mc.field_9632.method_37075()));
            ...
            if (this.method_42015() && this.field_25755 != null && this.field_25750 != null) {
               if (mc.field_9632.field_41697 % 20 == 0) {
   ...
   public void method_22857() {
      if (this.method_42015() && this.field_25755 != null && this.field_25750 != null) {
         ...
         for (int var4 = 0; var4 < (int)((float)this.field_25752.size() * var3); var4++) {
            ...
            GL11.glVertex3d(
               var7 - mc.gameRenderer.method_35949().method_41627().method_61() + 0.5,
               var9 - mc.gameRenderer.method_35949().method_41627().method_60(),
               var11 - mc.gameRenderer.method_35949().method_41627().method_62() + 0.5
            );
         }
