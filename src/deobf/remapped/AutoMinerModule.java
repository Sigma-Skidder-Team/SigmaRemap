...
public class AutoMinerModule extends Module {
      ...
      if (this.method_42015()) {
         if (client.thePlayer.field_41697 < 20) {
            ...
            while (var12.hasNext()) {
               ...
               if (var13.method_2543(new class_2034(client.thePlayer.field_41742, client.thePlayer.field_41714)) > 7
   ...
   public void method_22857() {
      if (this.method_42015() && this.field_25755 != null && this.field_25750 != null) {
         ...
         GL11.glBegin(3);
         float var3 = Math.min(1.0F, ((float)(client.thePlayer.field_41697 % 20) + client.theTimer.field_32600) / 20.0F);
         ...
         for (int var4 = 0; var4 < (int)((float)this.field_25752.size() * var3); var4++) {
            ...
            GL11.glVertex3d(
               var7 - client.gameRenderer.method_35949().method_41627().method_61() + 0.5,
               var9 - client.gameRenderer.method_35949().method_41627().method_60(),
               var11 - client.gameRenderer.method_35949().method_41627().method_62() + 0.5
            );
         }
