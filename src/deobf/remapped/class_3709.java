...
public class class_3709 extends class_3620 {
      ...
      try {
         for (int var3 = 36; var3 < 45; var3++) {
            ...
            if (field_46692.field_9632.field_3869.method_18878(var3).method_35884()
               && method_17216(field_46692.field_9632.field_3869.method_18878(var3).method_35898().method_27960())
               && field_46692.field_9632.field_3869.method_18878(var3).method_35898().field_31206 != 0) {
               if (field_46692.field_9632.field_3853.field_36404 == var4) {
                  return;
               }

               field_46692.field_9632.field_3853.field_36404 = var4;
               if (this.method_42016("ItemSpoof").equals("LiteSpoof") && (this.field_18196 < 0 || this.field_18196 != var4)) {
                  field_46692.method_8614().method_9091().method_23485(new class_7371(var4));
   ...
   public void method_17215() {
      ...
      if ((!var3.equals("OpenInv") || field_46692.field_9623 instanceof class_3431) && this.method_17219() != 0) {
         int var4 = 43;
         if (!this.method_42007("Intelligent Block Picker")) {
            if (!this.method_17217()) {
               ...
               for (int var6 = 9; var6 < 36; var6++) {
                  if (field_46692.field_9632.field_3869.method_18878(var6).method_35884()) {
                     class_2451 var7 = field_46692.field_9632.field_3869.method_18878(var6).method_35898().method_27960();
               ...
               for (int var9 = 36; var9 < 45; var9++) {
                  if (!field_46692.field_9632.field_3869.method_18878(var9).method_35884()) {
                     var4 = var9;
                     break;
                  }
               }
               ...
               if (var5 >= 0) {
                  if (!(field_46692.field_9623 instanceof class_3431) && var3.equals("FakeInv")) {
            ...
            if (!this.method_17217()) {
               for (int var11 = 36; var11 < 45; var11++) {
                  if (!field_46692.field_9632.field_3869.method_18878(var11).method_35884()) {
                     var4 = var11;
                     break;
                  }
               }
               ...
               for (int var10 = 36; var10 < 45; var10++) {
                  if (field_46692.field_9632.field_3869.method_18878(var10).method_35884()) {
                     class_2451 var12 = field_46692.field_9632.field_3869.method_18878(var10).method_35898().method_27960();
                     if (method_17216(var12)) {
                        var4 = var10;
                        if (field_46692.field_9632.field_3869.method_18878(var10).method_35898().field_31206
                           == field_46692.field_9632.field_3869.method_18878(var8).method_35898().field_31206) {
                           var4 = -1;
                        }
                        break;
                     }
            ...
            if (var4 >= 0 && field_46692.field_9632.field_3869.method_18878(var4).field_40588 != var8) {
               if (!(field_46692.field_9623 instanceof class_3431) && var3.equals("FakeInv") && class_3347.method_15349() <= class_412.field_1752.method_2055()
                  )
                {
                  field_46692.method_8614().method_4813(new class_8559(class_2105.field_10551));
               }
      ...
      if (this.method_17219() != 0) {
         for (int var5 = 9; var5 < 45; var5++) {
            if (field_46692.field_9632.field_3869.method_18878(var5).method_35884()) {
               class_2451 var6 = field_46692.field_9632.field_3869.method_18878(var5).method_35898().method_27960();
               class_6098 var7 = field_46692.field_9632.field_3869.method_18878(var5).method_35898();
   ...
   public boolean method_17217() {
      for (int var3 = 36; var3 < 45; var3++) {
         if (field_46692.field_9632.field_3869.method_18878(var3).method_35884()) {
            class_2451 var4 = field_46692.field_9632.field_3869.method_18878(var3).method_35898().method_27960();
   ...
   public boolean method_17224(class_2584 var1) {
      ...
      } else if (!method_17216(field_46692.field_9632.method_26617(var1).method_27960())) {
         return false;
      }
   ...
   public void method_17221(int var1, int var2) {
      field_46692.field_9647.method_42134(field_46692.field_9632.field_3869.field_19925, var1, var2, class_6269.field_32026, field_46692.field_9632);
   }

   public void method_17220(class_7767 var1) {
      if (field_46692.field_9616.field_32603 == 0.8038576F) {
         field_46692.field_9616.field_32603 = 1.0F;
      }

      if (this.method_17219() != 0 && (!field_46692.field_9632.field_41774 || this.method_42016("Tower Mode").equalsIgnoreCase("Vanilla"))) {
         if (!class_314.method_1434() || this.method_42007("Tower while moving")) {
            ...
            switch (var4) {
                  ...
                  if (var1.method_35236() > 0.0) {
                     if (class_8865.method_40769() == 0) {
                        if (var1.method_35236() > 0.247 && var1.method_35236() < 0.249) {
                           var1.method_35235(
                              (double)((int)(field_46692.field_9632.method_37309() + var1.method_35236())) - field_46692.field_9632.method_37309()
                           );
                        }
                     } else {
                        double var6 = (double)((int)(field_46692.field_9632.method_37309() + var1.method_35236()));
                        if (var6 != (double)((int)field_46692.field_9632.method_37309())
                           && field_46692.field_9632.method_37309() + var1.method_35236() - var6 < 0.15) {
                           var1.method_35235(var6 - field_46692.field_9632.method_37309());
                        }
                     }
                  }
               ...
               case "AAC":
                  if (var1.method_35236() > 0.247 && var1.method_35236() < 0.249) {
                     var1.method_35235((double)((int)(field_46692.field_9632.method_37309() + var1.method_35236())) - field_46692.field_9632.method_37309());
                     if (field_46692.field_9577.field_45450.field_30024 && !class_314.method_1434()) {
                        class_8865.method_40776(0.0);
                        class_8865.method_40777(var1, 0.0);
                     }
                  } else if (field_46692.field_9632.method_37309() == (double)((int)field_46692.field_9632.method_37309())
                     && class_314.method_1413(field_46692.field_9632, 0.001F)) {
               ...
               case "Vanilla":
                  if (field_46692.field_9577.field_45450.field_30024
                     && class_314.method_1413(field_46692.field_9632, 0.001F)
                     && field_46692.field_9601.method_6680(field_46692.field_9632, field_46692.field_9632.field_41712.method_18918(0.0, 1.0, 0.0)).count()
                        == 0L) {
                     ...
                     class_8865.method_40777(var1, 0.0);
                     field_46692.field_9616.field_32603 = 0.8038576F;
                  }
            }
         }
         ...
         if (!this.method_42016("Tower Mode").equals("NCP")
            ...
            && class_314.method_1413(field_46692.field_9632, 0.001F)
            && field_46692.field_9577.field_45450.field_30024) {
            field_46692.field_9632.field_29600 = 20;
            var1.method_35235(class_8865.method_40786());
         }
