...
public class class_8335 {
   private static String[] field_42664;
   private static final float[][] field_42665 = new float[][]{
      {1.0F, -0.0F},
   ...
   private static final float[][] field_42663 = new float[][]{
      {1.0F, -0.0F},
      {0.9238795F, -0.38268343F},
      {0.70710677F, -0.70710677F},
      {0.38268343F, -0.9238795F},
   ...
   public static void method_38383(float[][] var0, int var1) {
      int var4 = (int)Math.round(Math.log((double)var1) / Math.log(2.0));
      float[][] var5 = var1 != 128 ? field_42663 : field_42665;
