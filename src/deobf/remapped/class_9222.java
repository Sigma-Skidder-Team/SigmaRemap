   ...
   public class_8014 method_22451(Entity var1, Random var2) {
      if (var1.world instanceof class_6331) {
         ...
         if (var6 == null) {
            ...
            ItemStack var7 = class_2143.method_10014(var5, var6.method_12173(), var6.method_12185(), (byte)2, true, true);
            ...
            return new class_8014(
               new ItemStack(class_4897.field_24997, this.field_47148), new ItemStack(class_4897.field_24830), var7, this.field_47152, this.field_47153, 0.2F
            );
         }
      } else {
         return null;
