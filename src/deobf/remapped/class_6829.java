...
public class class_6829<T extends class_5834, M extends class_3169<T>> extends class_5105<T, M> {
   ...
   private final class_6122 field_35220;
   ...
   public void method_23424(class_7966 var1, class_2565 var2, int var3, class_8145 var4, float var5, float var6, float var7, float var8) {
      ...
      this.field_35221 = new class_581(var4.field_41768, var4.method_37302(), var4.method_37309(), var4.method_37156());
      this.field_35221.field_41701 = (float)(Math.atan2((double)var5, (double)var7) * 180.0F / (float)Math.PI);
      this.field_35221.field_41755 = (float)(Math.atan2((double)var6, (double)var11) * 180.0F / (float)Math.PI);
      this.field_35221.field_41711 = this.field_35221.field_41701;
      this.field_35221.field_41762 = this.field_35221.field_41755;
