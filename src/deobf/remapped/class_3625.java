...
public class class_3625 extends DataFix {
   public class_3625(Schema var1, boolean var2) {
      super(var1, var2);
   }

   public TypeRewriteRule makeRule() {
      return this.method_16894(this.getInputSchema().getTypeRaw(class_4002.field_19433));
   }

   private <IS> TypeRewriteRule method_16894(Type<IS> var1) {
      ...
      return this.fixTypeEverywhereTyped(
         ...
         this.getOutputSchema().getType(class_4002.field_19444),
         var4x -> {
            Either var7x = Either.right(DSL.unit());
            Either var8 = Either.right(DSL.unit());
