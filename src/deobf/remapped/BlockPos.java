...
@Immutable
public class BlockPos extends class_2700 {
   ...
   public BlockPos(class_2700 var1) {
   ...
   public BlockPos method_6103(double var1, double var3, double var5) {
      return var1 == 0.0 && var3 == 0.0 && var5 == 0.0
         ? this
         : new BlockPos((double)this.method_12173() + var1, (double)this.method_12165() + var3, (double)this.method_12185() + var5);
   }

   public BlockPos method_6104(int var1, int var2, int var3) {
      return var1 == 0 && var2 == 0 && var3 == 0 ? this : new BlockPos(this.method_12173() + var1, this.method_12165() + var2, this.method_12185() + var3);
   }

   public BlockPos method_6105(class_2700 var1) {
      return this.method_6104(var1.method_12173(), var1.method_12165(), var1.method_12185());
   }

   public BlockPos method_6093(class_2700 var1) {
      return this.method_6104(-var1.method_12173(), -var1.method_12165(), -var1.method_12185());
   }
   ...
   public BlockPos method_6098(Direction var1) {
      return new BlockPos(this.method_12173() + var1.method_1041(), this.method_12165() + var1.method_1054(), this.method_12185() + var1.method_1034());
   }
   ...
   public BlockPos method_6068(class_9249 var1, int var2) {
      if (var2 != 0) {
         ...
         return new BlockPos(this.method_12173() + var5, this.method_12165() + var6, this.method_12185() + var7);
      } else {
         return this;
      }
   }
   ...
   public BlockPos method_6078(class_6631 var1) {
      switch (var1) {
         ...
         default:
            return this;
         case field_34334:
            return new BlockPos(-this.method_12185(), this.method_12165(), this.method_12173());
         case field_34338:
            return new BlockPos(-this.method_12173(), this.method_12165(), -this.method_12185());
         case field_34335:
            return new BlockPos(this.method_12185(), this.method_12165(), -this.method_12173());
      }
   }

   public BlockPos method_6071(class_2700 var1) {
      return new BlockPos(
