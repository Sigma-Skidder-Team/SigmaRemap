...
public class class_2004 extends class_5557<class_9504> {
   ...
   public Stream<class_1331> method_9314(class_6680 var1, Random var2, class_9504 var3, class_1331 var4) {
      return IntStream.range(0, 16).<class_1331>mapToObj(var5 -> {
         int var8 = var5 / 4;
         int var9 = var5 % 4;
         ...
         return new class_1331(var10, var12, var11);
      });
   }
}
