   ...
   public class_353 method_28395(class_353 var1) {
      ...
      if (!var6.method_8350(var7)) {
         ...
         if (!var1.method_21859()) {
            var8 = var1.method_21857() != class_240.field_817 ? class_240.field_817 : var1.method_21863();
         } else {
         ...
         while (var9 < 7) {
            if (!var5.field_33055 && !class_6486.method_29586(var10)) {
               ...
               if (var11 instanceof class_9359 && var10.method_12165() >= var12) {
                  class_5182 var13 = new class_5182(
                     new TranslationTextComponent("build.tooHigh", var12).mergeStyle(TextFormatting.RED), ChatType.GAME_INFO, class_9665.field_49232
                  );
