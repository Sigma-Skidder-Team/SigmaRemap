...
public abstract class class_1820 extends class_3599 {
   ...
   public class_1331 field_9240 = class_1331.field_7306;
   ...
   public boolean method_8057() {
      if (this.field_9242) {
         class_2522 var3 = this.field_9241.field_41768.method_28262(this.field_9240);
   ...
   public void method_8058(boolean var1) {
      if (this.field_9242) {
         class_2522 var4 = this.field_9241.field_41768.method_28262(this.field_9240);
         if (var4.method_8360() instanceof class_4115) {
            ((class_4115)var4.method_8360()).method_19110(this.field_9241.field_41768, var4, this.field_9240, var1);
         }
      }
   }
         ...
         if (this.field_9241.field_41744) {
            ...
            if (var4 != null && !var4.method_18436() && var3.method_41200()) {
               for (int var5 = 0; var5 < Math.min(var4.method_18429() + 2, var4.method_18437()); var5++) {
                  ...
                  this.field_9240 = new class_1331(var6.field_29731, var6.field_29735 + 1, var6.field_29736);
                  if (!(
                     this.field_9241
                           .method_37273((double)this.field_9240.method_12173(), this.field_9241.method_37309(), (double)this.field_9240.method_12185())
                        > 2.25
                  )) {
                     this.field_9242 = class_4115.method_19107(this.field_9241.field_41768, this.field_9240);
                     if (this.field_9242) {
                        return true;
                     }
                  }
