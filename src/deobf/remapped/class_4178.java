      ...
      if (!this.method_1535() && this.method_1537()) {
         ...
         if (this.field_20333) {
            if (this.field_36283 == null) {
               ...
               if (this.method_32132() + this.method_32109() > class_1893.method_8510().field_9602.method_43166()) {
                  this.method_32175(class_1893.method_8510().field_9602.method_43166() - this.method_32109());
               }
               ...
               if (this.method_32173() + this.method_32137() > class_1893.method_8510().field_9602.method_43163()) {
                  this.method_32117(class_1893.method_8510().field_9602.method_43163() - this.method_32137());
               }
            } else {
               if (this.method_32132() < 0) {
                  this.method_32175(0);
