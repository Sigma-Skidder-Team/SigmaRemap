...
public class class_1335 extends DataFix {
   private static final String[] field_7321 = (String[])DataFixUtils.make(new String[128], var0 -> {
   ...
   public class_1335(Schema var1, boolean var2) {
      super(var1, var2);
   }
         ...
         var2 -> {
            ...
            if (var5x.isPresent() && Objects.equals(((Pair)var5x.get()).getSecond(), "minecraft:potion")) {
               ...
               if (var7.isPresent()) {
                  ...
                  if (!var11.isPresent()) {
                     String var12 = field_7321[var8 & 127];
                     ...
                     if ((var8 & 16384) == 16384) {
                        var9 = var9.set(var4, Pair.of(class_4002.field_19439.typeName(), "minecraft:splash_potion"));
                     }
                  }
