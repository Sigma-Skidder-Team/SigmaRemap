...
public class class_9543 extends class_367 {
      ...
      if (!var1.method_6449()) {
         ...
         if ((float)this.field_48557 >= 20.0F / this.getFloatValueByName("CPS")) {
            class_3577 var5 = mcInstance.field_9601
               ...
               .filter(var0 -> var0.method_37175(mcInstance.field_9632) < 6.0F)
   ...
   public void method_44030(class_3368 var1) {
      ...
      if (this.field_48550 != null) {
         double var14 = this.field_48550.method_37302() - mcInstance.gameRenderer.method_35949().method_41627().method_61();
         double var19 = this.field_48550.method_37309() - mcInstance.gameRenderer.method_35949().method_41627().method_60() + 0.5;
         double var20 = this.field_48550.method_37156() - mcInstance.gameRenderer.method_35949().method_41627().method_62();
         float var16 = 0.3F;
   ...
   public static class_1331 method_44011() {
      return new class_1331(
         Math.floor(mcInstance.field_9632.method_37302()),
         Math.floor(mcInstance.field_9632.method_37309()),
         Math.floor(mcInstance.field_9632.method_37156())
      );
   }
   ...
   private boolean method_44012(class_1331 var1) {
      ...
      return (
            mcInstance.field_9601.method_28262(var1).method_8360() == class_4783.field_23433
               || mcInstance.field_9601.method_28262(var1).method_8360() == class_4783.field_23881
         )
         && mcInstance.field_9601.method_28262(var4).method_8360() == class_4783.field_23184
         && mcInstance.field_9601.method_28262(var5).method_8360() == class_4783.field_23184
         && mcInstance.field_9601.<Entity>method_25868(Entity.class, new class_4092(var4)).isEmpty();
   }
   ...
   public static float method_44033(double var0, double var2, double var4, Entity var6) {
      ...
      if (var6 instanceof class_5834) {
         var18 = (double)method_44023(
            (class_5834)var6,
            method_44028(var17),
            new class_2730(mcInstance.field_9601, null, null, null, var0, var2, var4, 6.0F, false, class_7298.field_37309)
         );
      }
   ...
   private static float method_44028(float var0) {
      int var3 = mcInstance.field_9601.method_43370().method_2097();
   ...
   private static void method_44027() {
      if (field_48558) {
         field_48553 = mcInstance.field_9632.field_41701;
         field_48549 = mcInstance.field_9632.field_41755;
         field_48558 = false;
      }
   }
