...
public class GameRenderer implements class_6491, AutoCloseable {
   ...
   public void method_35924(class_7966 var1, Camera var2, float var3, boolean var4, boolean var5, boolean var6) {
      if (!this.field_40630) {
         ...
         SigmaMainClass.getInstance().getEventManager().method_7914(var11);
   ...
   public void method_35945(float var1, long var2, boolean var4) {
      ...
      if (!this.field_40612.field_9589) {
         ...
         if (var4 && this.field_40612.field_9601 != null && !class_3111.method_14350()) {
            ...
            SigmaMainClass.getInstance().getEventManager().method_7914(new class_1711(var1, var2));
         ...
         if (this.field_40612.field_9610 != null) {
            ...
            try {
               if (class_7860.field_39933.method_3596()) {
                  ...
                  SigmaMainClass.getInstance().getEventManager().method_7914(new class_2532());
               }
