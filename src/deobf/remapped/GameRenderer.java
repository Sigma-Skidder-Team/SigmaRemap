...
public class GameRenderer implements class_6491, AutoCloseable {
      ...
      if (var4 != null && this.field_40612.theWorld != null) {
         ...
         if (var16 != null) {
            ...
            if (var8 && var19 > 9.0) {
               ...
               if (var17 instanceof LivingEntity || var17 instanceof class_7451) {
   ...
   private double method_35940(Camera var1, float var2, boolean var3) {
      if (!this.field_40630) {
         ...
         if (var1.method_41633() instanceof LivingEntity && ((LivingEntity)var1.method_41633()).method_26450()) {
            float var9 = Math.min((float)((LivingEntity)var1.method_41633()).field_29677 + var2, 20.0F);
   ...
   private void method_35952(class_7966 var1, float var2) {
      if (this.field_40612.getRenderViewEntity() instanceof LivingEntity) {
         LivingEntity var5 = (LivingEntity)this.field_40612.getRenderViewEntity();
   ...
   public void method_35924(class_7966 var1, Camera var2, float var3, boolean var4, boolean var5, boolean var6) {
      if (!this.field_40630) {
         ...
         if (var4) {
            ...
            if (this.field_40612.gameOptions.field_45512) {
               this.method_35935(var1, var3);
            }

            var10 = this.field_40612.getRenderViewEntity() instanceof LivingEntity && ((LivingEntity)this.field_40612.getRenderViewEntity()).method_26507();
   ...
   public void method_35945(float var1, long var2, boolean var4) {
      ...
      if (!this.field_40612.method_8558()
         && this.field_40612.gameOptions.field_45426
         && (!this.field_40612.gameOptions.field_45570 || !this.field_40612.field_9625.method_39842())) {
      ...
      if (this.field_40612.gameOptions.field_45523) {
         this.field_40612.gameOptions.field_45471 = true;
      }
   }
   ...
   private boolean method_35926() {
      if (!this.field_40606) {
         ...
         if (var4 && !((PlayerEntity)var3).playerAbilities.allowEdit) {
            ItemStack var5 = ((LivingEntity)var3).method_26446();
