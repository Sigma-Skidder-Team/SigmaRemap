...
public interface class_6163 {
   @Nullable
   class_3757 method_28260(BlockPos var1);

   class_2522 method_28262(BlockPos var1);

   class_4774 method_28258(BlockPos var1);

   default int method_28263(BlockPos var1) {
   ...
   default double method_28259(BlockPos var1) {
