...
public class class_4230 {
   ...
   public void method_19708(int var1, int var2, boolean var3) {
      if (RenderSystem.method_16366()) {
         ...
         RenderSystem.method_16474(() -> this.method_19721(var1, var2, var3));
      }
   }
   ...
   private void method_19721(int var1, int var2, boolean var3) {
      ...
      GlStateManager.method_8893(class_6024.field_30769, 0);
   }
   ...
   public void method_19722() {
      ...
      if (this.field_20527 > -1) {
         GlStateManager.method_8893(class_6024.field_30769, 0);
         GlStateManager.method_8857(this.field_20527);
         this.field_20527 = -1;
      }
   }
   ...
   public void method_19710(class_4230 var1) {
      ...
      if (!GlStateManager.method_8795()) {
         ...
         if (var4 != 0) {
            int var5 = GlStateManager.method_8910();
            GlStateManager.method_8791(var4);
            GlStateManager.method_8893(class_6024.field_30769, var1.field_20527);
            GlStateManager.method_8874(3553, 0, 0, 0, 0, 0, Math.min(this.field_20533, var1.field_20533), Math.min(this.field_20535, var1.field_20535));
            GlStateManager.method_8791(var5);
         }
      } else {
         GlStateManager.method_8893(36008, var1.field_20527);
         GlStateManager.method_8893(36009, this.field_20527);
         GlStateManager.method_8835(0, 0, var1.field_20533, var1.field_20535, 0, 0, this.field_20533, this.field_20535, 256, 9728);
      }
   ...
   public void method_19716(int var1, int var2, boolean var3) {
      ...
      this.field_20527 = GlStateManager.method_8828();
      this.field_20525 = class_4970.method_22837();
      if (this.field_20530) {
         this.field_20532 = class_4970.method_22837();
         GlStateManager.method_8791(this.field_20532);
         GlStateManager.method_8879(3553, 10241, 9728);
         GlStateManager.method_8879(3553, 10240, 9728);
         GlStateManager.method_8879(3553, 10242, 10496);
         GlStateManager.method_8879(3553, 10243, 10496);
         GlStateManager.method_8879(3553, 34892, 0);
         GlStateManager.method_8886(3553, 0, 6402, this.field_20533, this.field_20535, 0, 6402, 5126, (IntBuffer)null);
      }

      this.method_19725(9728);
      GlStateManager.method_8791(this.field_20525);
      GlStateManager.method_8886(3553, 0, 32856, this.field_20533, this.field_20535, 0, 6408, 5121, (IntBuffer)null);
      GlStateManager.method_8893(class_6024.field_30769, this.field_20527);
      GlStateManager.method_8747(class_6024.field_30769, class_6024.field_30770, 3553, this.field_20525, 0);
      if (this.field_20530) {
         GlStateManager.method_8747(class_6024.field_30769, class_6024.field_30765, 3553, this.field_20532, 0);
      }
   ...
   public void method_19725(int var1) {
      ...
      GlStateManager.method_8879(3553, 10240, var1);
      GlStateManager.method_8879(3553, 10242, 10496);
      GlStateManager.method_8879(3553, 10243, 10496);
   ...
   public void method_19717(boolean var1) {
      if (RenderSystem.method_16366()) {
         ...
         RenderSystem.method_16474(() -> this.method_19711(var1));
      }
   }
   ...
   public void method_19723() {
      if (RenderSystem.method_16366()) {
         ...
         RenderSystem.method_16474(() -> GlStateManager.method_8893(class_6024.field_30769, 0));
      }
   }
   ...
   private void method_19707(int var1, int var2, boolean var3) {
      ...
      class_8042 var10 = RenderSystem.method_16373();
   ...
   public void method_19712(boolean var1) {
      ...
      GlStateManager.method_8794(var4, var1);
      this.method_19723();
   }
