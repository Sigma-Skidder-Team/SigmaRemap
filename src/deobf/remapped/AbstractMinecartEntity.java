...
public abstract class AbstractMinecartEntity extends Entity {
   ...
   private static final Map<class_3665, Pair<Vector3i, Vector3i>> field_5890 = Util.<Map<class_3665, Pair<Vector3i, Vector3i>>>make(
      Maps.newEnumMap(class_3665.class), var0 -> {
         Vector3i var3 = Direction.field_809.method_1037();
         Vector3i var4 = Direction.field_804.method_1037();
         Vector3i var5 = Direction.field_818.method_1037();
         Vector3i var6 = Direction.field_800.method_1037();
         Vector3i var7 = var3.method_12181();
         Vector3i var8 = var4.method_12181();
         Vector3i var9 = var5.method_12181();
         Vector3i var10 = var6.method_12181();
            ...
            while (var15.hasNext()) {
               ...
               for (int[] var20 : var5) {
                  ...
                  if (class_160.method_648(var21)) {
                     ...
                     Vector3d var24 = Vector3d.method_6219(var7, var21);
   ...
   private static Pair<Vector3i, Vector3i> method_4746(class_3665 var0) {
   ...
   public void method_37123() {
      ...
      if (!this.world.field_33055) {
         ...
         if (this.method_4737() == class_3481.field_17066 && method_37266(this.method_37098()) > 0.01) {
            List var25 = this.world.method_25867(this, this.getBoundingBox().method_18899(0.2F, 0.0, 0.2F), class_3572.method_16616(this));
            if (!var25.isEmpty()) {
            ...
            for (Entity var23 : this.world.method_25870(this, this.getBoundingBox().method_18899(0.2F, 0.0, 0.2F))) {
         ...
         double var14 = MathHelper.wrapDegrees(this.field_5888 - (double)this.rotationYaw);
   ...
   public void method_4744() {
      ...
      this.method_37214(MathHelper.clamp(var5.field_7336, -var3, var3), var5.field_7333, MathHelper.clamp(var5.field_7334, -var3, var3));
      if (this.onGround) {
   ...
   public void method_4750(BlockPos var1, class_2522 var2) {
      ...
      Vector3d var11 = this.method_4748(var5, var7, var9);
      ...
      var17 = new Vector3d(var30 * var22 / var26, var17.field_7333, var30 * var24 / var26);
      ...
      if (var32 instanceof PlayerEntity) {
         Vector3d var33 = var32.method_37098();
      ...
      this.method_37226(
         ...
         new Vector3d(MathHelper.clamp(var76 * var17.field_7336, -var77, var77), 0.0, MathHelper.clamp(var76 * var17.field_7334, -var77, var77))
      );
      if (var20.getY() != 0
      ...
      this.method_4755();
      Vector3d var52 = this.method_4748(this.getPosX(), this.method_37309(), this.getPosZ());
      if (var52 != null && var11 != null) {
         double var53 = (var11.field_7333 - var52.field_7333) * 0.05;
         Vector3d var55 = this.method_37098();
      ...
      if (var58 != var1.getX() || var59 != var1.getZ()) {
         Vector3d var78 = this.method_37098();
      ...
      if (var12) {
         Vector3d var79 = this.method_37098();
         ...
         if (var81 > 0.01) {
            ...
            Vector3d var62 = this.method_37098();
   ...
   @Nullable
   public Vector3d method_4745(double var1, double var3, double var5, double var7) {
   ...
   @Nullable
   public Vector3d method_4748(double var1, double var3, double var5) {
   ...
   public Box method_37210() {
      ...
      return !this.method_4754() ? var3 : var3.grow((double)Math.abs(this.method_4741()) / 16.0);
   }
      ...
      if (!this.world.field_33055 && !var1.field_41731 && !this.field_41731 && !this.method_37072(var1)) {
         ...
         if (var8 >= 1.0E-4F) {
            ...
            if (!(var1 instanceof AbstractMinecartEntity)) {
               ...
               Vector3d var16 = new Vector3d(var12, 0.0, var14).method_6213();
               ...
               Vector3d var20 = this.method_37098();
               Vector3d var21 = var1.method_37098();
