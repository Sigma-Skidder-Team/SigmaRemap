...
public class class_3413 extends class_6315 {
   ...
   public class_3413(int var1, Random var2, class_9616 var3, Direction var4) {
   ...
   public class_3413(class_5799 var1, CompoundNBT var2) {
      super(class_2746.field_13413, var2);
      this.field_16803 = var2.getBoolean("Chest");
   }

   @Override
   public void method_32517(CompoundNBT var1) {
      super.method_32517(var1);
      var1.putBoolean("Chest", this.field_16803);
   }
   ...
   public static class_3413 method_15757(List<class_7060> var0, Random var1, int var2, int var3, int var4, Direction var5, int var6) {
   ...
   public boolean method_32501(class_700 var1, class_2033 var2, class_6541 var3, Random var4, class_9616 var5, class_2034 var6, BlockPos var7) {
      ...
      if (this.field_16803 && var5.method_44395(new BlockPos(this.method_32530(3, 3), this.method_32507(2), this.method_32523(3, 3)))) {
