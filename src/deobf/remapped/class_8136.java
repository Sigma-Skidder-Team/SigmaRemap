...
public class class_8136 extends Module {
   ...
   private void method_37009(class_7767 var1) {
      if (!mc.field_9632.field_41744) {
         ...
         if (mc.field_9632.method_37245().field_7333 != (double)((int) mc.field_9632.method_37245().field_7333)) {
            if (var1.method_35236() < 0.0
               && mc.field_9632.method_37245().field_7333 + var1.method_35236() < (double)((int) mc.field_9632.method_37245().field_7333)) {
               var1.method_35235((double)((int) mc.field_9632.method_37245().field_7333) - mc.field_9632.method_37245().field_7333);
               this.field_41672 = true;
            }
         } else if (this.getBooleanValueByName("AutoJump") || mc.gameOptions.keyJump.isKeyDown()) {
            mc.field_9632.method_26595();
            var1.method_35235(mc.field_9632.method_37098().field_7333);
         } else if (!mc.gameOptions.keySneak.isKeyDown()) {
   ...
   private void method_37010(class_1393 var1) {
      if (this.method_42015() && var1.method_6449()) {
         ...
         if (var4 != null) {
            ...
            if (this.field_41672) {
               if (this.getBooleanValueByName("AutoJump") || mc.gameOptions.keyJump.isKeyDown()) {
