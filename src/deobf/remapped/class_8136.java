      ...
      if (!client.thePlayer.collidedHorizontally) {
         ...
         if (client.thePlayer.method_37245().field_7333 != (double)((int) client.thePlayer.method_37245().field_7333)) {
            if (var1.method_35236() < 0.0
               ...
               var1.method_35235((double)((int) client.thePlayer.method_37245().field_7333) - client.thePlayer.method_37245().field_7333);
               this.field_41672 = true;
            }
         } else if (this.getBooleanValueByName("AutoJump") || client.gameOptions.keyJump.isKeyDown()) {
            client.thePlayer.method_26595();
            var1.method_35235(client.thePlayer.method_37098().field_7333);
         } else if (!client.gameOptions.keySneak.isKeyDown()) {
   ...
   private void method_37010(class_1393 var1) {
      if (this.method_42015() && var1.method_6449()) {
         ...
         if (var4 != null) {
            ...
            if (this.field_41672) {
               if (this.getBooleanValueByName("AutoJump") || client.gameOptions.keyJump.isKeyDown()) {
