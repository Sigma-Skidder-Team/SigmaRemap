...
public class class_3136 extends class_2932 {
   ...
   public final List<class_8145> field_15613;

   public class_3136(List<class_8145> var1) {
      this.field_15613 = var1;
   }

   @Override
   public boolean method_13435(class_7047 var1) {
      for (class_8145 var5 : this.field_15613) {
   ...
   public double method_13436(class_7047 var1) {
      ...
      for (class_8145 var7 : this.field_15613) {
