...
public class class_3282 extends class_3599 {
   ...
   public boolean method_16795() {
      ...
      if (var3 != null) {
         if (!var3.method_37330()) {
            ...
            return var3 instanceof class_704 && ((class_704)var3).field_3876.field_4940 ? false : this.field_16255.method_26905() instanceof class_8509;
         }
      } else {
         return false;
      }
   ...
   public boolean method_16799() {
      ...
      if (var3 != null) {
         if (var3.method_37330()) {
            return var3 instanceof class_704 && ((class_704)var3).field_3876.field_4940 ? false : --this.field_16256 > 0;
         } else {
            return false;
         }
      } else {
