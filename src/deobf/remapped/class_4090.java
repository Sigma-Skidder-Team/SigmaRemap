...
public class class_4090 extends DataFix {
   public class_4090(Schema var1, boolean var2) {
      super(var1, var2);
   }
   ...
   public TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped(
         "ChunkStatusFix", var3, this.getOutputSchema().getType(class_4002.field_19449), var1 -> var1.updateTyped(var5, var0x -> {
