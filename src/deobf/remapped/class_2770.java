...
public class class_2770 extends class_5886 implements class_1869 {
   ...
   public void method_26606() {
      ...
      if (!this.method_26450()) {
         ...
         this.rotationYaw = class_9299.method_42810(this.rotationYaw);
         if (!this.method_26859()) {
            ...
            if (!this.world.field_33055) {
               ...
               if (var6 != null) {
                  ...
                  double var20 = class_9299.method_42827(
                     class_9299.method_42809(180.0 - class_9299.method_42821(var9, var13) * 180.0F / (float)Math.PI - (double)this.rotationYaw), -50.0, 50.0
                  );
               ...
               if (this.field_29612 > 0) {
                  ...
                  double var54 = class_9299.method_42809(this.field_29604 - (double)this.rotationYaw);
            ...
            if (!this.world.field_33055 && this.field_29645 == 0) {
               ...
               this.method_12624(this.world.method_25867(this, this.field_13542.method_37241().method_18898(1.0), class_3572.field_17479));
               this.method_12624(this.world.method_25867(this, this.field_13543.method_37241().method_18898(1.0), class_3572.field_17479));
            }

            float var35 = class_9299.method_42818(this.rotationYaw * (float) (Math.PI / 180.0) - this.field_13546 * 0.01F);
            float var36 = class_9299.method_42840(this.rotationYaw * (float) (Math.PI / 180.0) - this.field_13546 * 0.01F);
   ...
   private void method_12620() {
      ...
      if (this.field_41717.nextInt(10) == 0) {
         List var3 = this.world.<class_3577>method_25868(class_3577.class, this.method_37241().method_18898(32.0));
         ...
         for (int var13 = var5; var13 <= var8; var13++) {
            for (int var14 = var6; var14 <= var9; var14++) {
               ...
               if (!var16.method_8345() && var16.method_8362() != class_5371.field_27434) {
                  if (this.world.method_29537().method_1285(class_291.field_1047) && !class_2351.field_11754.method_10609(var17)) {
   ...
   public void method_26526() {
      ...
      boolean var6 = this.world.method_29537().method_1285(class_291.field_1033);
      short var7 = 500;
