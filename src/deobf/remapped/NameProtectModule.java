      ...
      if (this.method_42015()) {
         ...
         if (var4 instanceof class_1625) {
            ...
            if (var5.method_7241() == class_9120.field_46678) {
               ...
               if (var6.contains(client.method_8502().method_5366())) {
                  var6 = var6.replaceAll(client.method_8502().method_5366(), this.getStringValueByName("Username"));
         ...
         if (var4 instanceof class_7867) {
            ...
            for (int var7 = 0; var7 < var15.size(); var7++) {
               ...
               if (var8.method_27001() != null) {
                  ...
                  if (var9.contains(client.method_8502().method_5366())) {
                     var9 = var9.replaceAll(client.method_8502().method_5366(), this.getStringValueByName("Username"));
         ...
         if (var4 instanceof class_9889) {
            ...
            if (var16.contains(client.method_8502().method_5366())) {
               var16 = var16.replaceAll(client.method_8502().method_5366(), this.getStringValueByName("Username"));
         ...
         if (var4 instanceof class_3299) {
            ...
            if (var18.contains(client.method_8502().method_5366())) {
               var18 = var18.replaceAll(client.method_8502().method_5366(), this.getStringValueByName("Username"));
