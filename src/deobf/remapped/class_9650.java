...
public class class_9650 extends class_2833 {
   ...
   public void method_12883() {
      ...
      double var8 = 1.0 - (double) MathHelper.abs(var4 * 0.7F) / var6;
      ...
      if (!(MathHelper.degreesDifferenceAbs(var12, this.field_49154.field_41701) < 3.0F)) {
         this.field_49156 = MathHelper.approach(this.field_49156, 0.2F, 0.025F);
      } else {
