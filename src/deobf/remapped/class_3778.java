...
public class class_3778 extends class_2596 {
   ...
   public class_3778() {
      ...
      var9.method_32100((var0, var1) -> {
         class_727.method_3328().method_3327(class_6015.field_30642);
         class_1893.method_8510().method_8609(new class_1876());
      });
      var10.method_32100((var0, var1) -> {
         class_727.method_3328().method_3327(class_6015.field_30645);
         class_1893.method_8510().method_8609(new class_1876());
      });
      var11.method_32100((var0, var1) -> {
         class_727.method_3328().method_3327(class_6015.field_30644);
         class_1893.method_8510().method_8609(new class_1876());
      });
   ...
   public void method_32178(float var1) {
      if (class_6340.field_32369 != null) {
         ...
         byte var4 = 40;
         float var5 = -field_18442 / (float)class_1893.method_8510().field_9602.method_43166();
         float var6 = -field_18444 / (float)class_1893.method_8510().field_9602.method_43163();
         class_73.method_96(
            (float)var4 * var5,
            (float)var4 * var6,
            (float)(class_1893.method_8510().field_9602.method_43166() + var4),
            (float)(class_1893.method_8510().field_9602.method_43163() + var4),
            class_6340.field_32369
         );
         float var7 = class_5181.method_23766(field_18445.method_11123(), 0.16, 0.71, 0.0, 0.99);
         int var8 = (class_1893.method_8510().field_9602.method_43166() - 455) / 2;
         int var9 = (int)((float)((class_1893.method_8510().field_9602.method_43163() - 78) / 2 - 14) - 116.0F * var7);
         class_73.method_103(
            0.0F,
            0.0F,
