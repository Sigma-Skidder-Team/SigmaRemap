...
public class SigmaIRC {
   ...
   private void method_20855(class_139 var1) {
      if (var1.method_557() instanceof class_1490) {
         ...
         this.field_21933
            .method_19329("connect", new SigmaIRCLogin(this))
            .method_19329("login-successful", new SigmaIRCConnector(this))
            .method_19329("jello-user", new SigmaIRCSomething(this))
            .method_19329("chat-message", new SigmaIRCManager(this))
            .method_19329("disconnect", new SigmaIRCDisconnect(this));
