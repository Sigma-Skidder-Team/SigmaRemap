   ...
   static {
      for (class_6629 var7 : class_8669.field_44400) {
         ...
         if (field_36499.containsKey(var7)) {
            class_3111.method_14317("Duplicate entity type: " + var7 + ", id1: " + field_36499.get(var7) + ", id2: " + var8);
         }

         if (field_36500.containsKey(var10)) {
            class_3111.method_14317("Duplicate entity location: " + var10 + ", id1: " + field_36500.get(var10) + ", id2: " + var8);
         }

         if (field_36501.containsKey(var10)) {
            class_3111.method_14317("Duplicate entity name: " + var11 + ", id1: " + field_36501.get(var11) + ", id2: " + var8);
         }
