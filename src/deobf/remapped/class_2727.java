...
public class class_2727 extends class_6414 {
   ...
   public void method_29279(World var1, BlockPos var2, class_2730 var3) {
      if (!var1.field_33055) {
         class_1356 var6 = new class_1356(
            var1, (double)var2.getX() + 0.5, (double)var2.getY(), (double)var2.getZ() + 0.5, var3.method_12273()
         );
   ...
   private static void method_12257(World var0, BlockPos var1, LivingEntity var2) {
      if (!var0.field_33055) {
         class_1356 var5 = new class_1356(var0, (double)var1.getX() + 0.5, (double)var1.getY(), (double)var1.getZ() + 0.5, var2);
