         ...
         if (client.thePlayer != null && client.field_9601 != null) {
            for (class_1331 var5 : class_7494.method_34085(class_7494.method_34110(client.playerController.method_42146()))) {
               if (class_7494.method_34116(client.thePlayer, var5)) {
                  class_2522 var6 = client.field_9601.method_28262(var5);
                  if (var6.method_8360() instanceof class_8557 || var6.method_8360() instanceof class_8820 || var6.method_8360() instanceof class_9463) {
                     ...
                     if (var14 != null && var14.method_27960() instanceof class_239) {
                        ...
                        client.field_9601.method_7510(var5, false);
                        return;
                     }
                     ...
                     if (!(var6.method_8360() instanceof class_9281)) {
                        if (var6.method_8360() instanceof class_6278) {
                           class_2522 var7 = client.field_9601.method_28262(var5.method_6100());
                           class_2522 var8 = client.field_9601.method_28262(var5.method_6081());
                           if (!(var7.method_8360() instanceof class_6278) && var8.method_8360() instanceof class_6278) {
                              ...
                              client.field_9601.method_7510(var5.method_6081(), false);
                           }
                        }
                     } else {
                        class_2522 var12 = client.field_9601.method_28262(var5.method_6100());
                        class_2522 var15 = client.field_9601.method_28262(var5.method_6081());
                     ...
                     class_2522 var13 = client.field_9601.method_28262(var5.method_6081());
                     ...
                     if (var16 != -1 && var13.method_8360() instanceof class_3512) {
                        ...
                        client.field_9601.method_29594(var5.method_6081(), var11);
                        return;
                     }
                  }
               }
