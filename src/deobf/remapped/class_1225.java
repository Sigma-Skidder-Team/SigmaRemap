...
public class class_1225 {
   ...
   public static void method_5443(LivingEntity var0, LivingEntity var1, float var2) {
      method_5448(var0, var1);
      method_5438(var0, var1, var2);
   }

   public static boolean method_5453(class_1150<?> var0, LivingEntity var1) {
      return var0.<List<LivingEntity>>method_5138(class_6044.field_30901).filter(var1x -> var1x.contains(var1)).isPresent();
   }

   public static boolean method_5450(class_1150<?> var0, class_6044<? extends LivingEntity> var1, EntityType<?> var2) {
      return method_5441(var0, var1, var1x -> var1x.getType() == var2);
   }

   private static boolean method_5441(class_1150<?> var0, class_6044<? extends LivingEntity> var1, Predicate<LivingEntity> var2) {
      return var0.<LivingEntity>method_5138(var1).filter(var2).filter(LivingEntity::isAlive).filter(var1x -> method_5453(var0, var1x)).isPresent();
   }

   private static void method_5448(LivingEntity var0, LivingEntity var1) {
      method_5444(var0, var1);
      method_5444(var1, var0);
   }

   public static void method_5444(LivingEntity var0, LivingEntity var1) {
      var0.method_26525().method_5105(class_6044.field_30874, new class_4843(var1, true));
   }

   private static void method_5438(LivingEntity var0, LivingEntity var1, float var2) {
      byte var5 = 2;
      method_5445(var0, var1, var2, 2);
      method_5445(var1, var0, var2, 2);
   }

   public static void method_5445(LivingEntity var0, Entity var1, float var2, int var3) {
   ...
   public static void method_5446(LivingEntity var0, BlockPos var1, float var2, int var3) {
   ...
   public static boolean method_5451(MobEntity var0, LivingEntity var1, int var2) {
   ...
   public static boolean method_5457(LivingEntity var0, LivingEntity var1) {
   ...
   public static boolean method_5452(LivingEntity var0, LivingEntity var1, double var2) {
      Optional var6 = var0.method_26525().<LivingEntity>method_5138(class_6044.field_30884);
      if (var6.isPresent()) {
         double var7 = var0.method_37274(((LivingEntity)var6.get()).method_37245());
   ...
   public static boolean method_5449(LivingEntity var0, LivingEntity var1) {
      class_1150 var4 = var0.method_26525();
      return var4.method_5117(class_6044.field_30901) ? var4.<List<LivingEntity>>method_5138(class_6044.field_30901).get().contains(var1) : false;
   }

   public static LivingEntity method_5440(LivingEntity var0, Optional<LivingEntity> var1, LivingEntity var2) {
      return var1.isPresent() ? method_5442(var0, (LivingEntity)var1.get(), var2) : var2;
   }
   ...
   public static Optional<LivingEntity> method_5454(LivingEntity var0, class_6044<UUID> var1) {
      Optional var4 = var0.method_26525().method_5138(var1);
      return var4.<LivingEntity>map(var1x -> (LivingEntity)((class_6331)var0.world).method_28925(var1x));
   }

   public static Stream<class_7666> method_5455(class_7666 var0, Predicate<class_7666> var1) {
      return var0.method_26525()
         .<List<LivingEntity>>method_5138(class_6044.field_30907)
