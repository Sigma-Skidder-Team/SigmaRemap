...
public class class_3658 implements Comparator<class_3357> {
   ...
   public class_3658(InfiniteAuraModule var1) {
   ...
   public int compare(class_3357 var1, class_3357 var2) {
      ...
      float var7 = InfiniteAuraModule.method_33700().field_9632.method_37175(var5);
      float var8 = InfiniteAuraModule.method_33697().field_9632.method_37175(var6);
      if (!(var7 - var8 < 0.0F)) {
