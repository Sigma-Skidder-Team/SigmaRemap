...
public abstract class class_6353<T extends LivingEntity, M extends class_6521<T>> extends class_7067<T> implements class_2514<T, M> {
   ...
   public void method_29107(T var1, float var2, float var3, class_7966 var4, class_2565 var5, int var6) {
      if (!class_7860.field_40097.method_22501() || !class_7860.method_35568(class_7860.field_40097, var1, this, var3, var4, var5, var6)) {
         ...
         float var9 = MathHelper.interpolateAngle(var3, var1.field_29611, var1.field_29605);
         float var10 = MathHelper.interpolateAngle(var3, var1.field_29657, var1.field_29618);
         ...
         if (this.field_32487.field_33203 && var1.getRidingEntity() instanceof LivingEntity) {
            ...
            var9 = MathHelper.interpolateAngle(var3, var12.field_29611, var12.field_29605);
            var11 = var10 - var9;
         ...
         if (!var1.isPassenger() && var1.isAlive()) {
            var35 = MathHelper.lerp(var3, var1.field_29598, var1.field_29643);
