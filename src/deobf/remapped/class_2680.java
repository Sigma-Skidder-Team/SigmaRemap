...
public class class_2680 extends class_246 {
   ...
   private class_2680(ClientWorld var1, double var2, double var4, double var6, double var8, double var10, double var12, class_6571 var14) {
   ...
   public void method_44949() {
      ...
      if (this.field_49475++ < this.field_49476) {
         ...
         if (this.field_49469.method_28262(new BlockPos(this.field_49462, this.field_49473, this.field_49465)).method_8345()) {
