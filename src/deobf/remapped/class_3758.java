...
public class class_3758 implements class_2565 {
   ...
   public final Map<RenderLayer, class_9633> field_18366;
   public RenderLayer field_18370 = null;
   public final Set<class_9633> field_18369 = Sets.newHashSet();
   private final class_7907 field_18365 = new class_6018(this);

   public class_3758(class_9633 var1, Map<RenderLayer, class_9633> var2) {
   ...
   public class_7907 method_11645(RenderLayer var1) {
      ...
      if (!Objects.equals(this.field_18370, var1)) {
         if (this.field_18370 != null) {
            RenderLayer var5 = this.field_18370;
   ...
   private class_9633 method_17420(RenderLayer var1) {
   ...
   public void method_17415() {
      if (!this.field_18369.isEmpty()) {
         ...
         for (RenderLayer var4 : this.field_18366.keySet()) {
            this.method_17416(var4);
         }
      }
   }

   public void method_17416(RenderLayer var1) {
      class_9633 var4 = this.method_17420(var1);
   ...
   public class_7907 method_17417(Identifier var1, class_7907 var2) {
      if (this.field_18370 instanceof class_7634) {
         var1 = RenderLayer.method_16768(var1);
   ...
   public RenderLayer method_17419() {
      return this.field_18370;
   }

   @Override
   public void method_11646() {
      RenderLayer var3 = this.field_18370;
      this.method_17415();
      if (var3 != null) {
