...
public class class_496 extends class_5467 {
   ...
   public class_1899 method_8638(class_6331 var1, class_1899 var2) {
      class_496 var5 = class_6629.field_34232.method_30484(var1);
   ...
   public void method_26851() {
      ...
      this.field_29916.method_3485(2, new class_4520(this, 2.0));
      this.field_29916.method_3485(2, new class_3031(this, this, 1.0));
      this.field_29916.method_3485(3, new class_5685(this, 1.2F, true));
      this.field_29916.method_3485(4, new class_7228(this, 1.0, class_8137.method_37019(class_4783.field_23886.method_10803()), false));
      this.field_29916.method_3485(6, new class_368<class_704>(this, class_704.class, 8.0F, 2.0, 2.0));
      this.field_29916.method_3485(6, new class_368<class_1173>(this, class_1173.class, 4.0F, 2.0, 2.0));
      this.field_29916.method_3485(7, new class_2256(this));
      this.field_29916.method_3485(8, new class_6630(this));
      this.field_29916.method_3485(8, new class_8399(this));
      this.field_3084 = new class_5670(this, class_704.class, 6.0F);
      this.field_29916.method_3485(9, this.field_3084);
      this.field_29916.method_3485(10, new class_9691(this));
      this.field_29916.method_3485(12, new class_4205(this));
      this.field_29916.method_3485(13, new class_8676(this, 1.25));
      this.field_29916.method_3485(14, new class_2889(this, 1.0));
      this.field_29908.method_3485(1, new class_2199(this).method_38757(new Class[0]));
   }
   ...
   public void method_37123() {
      super.method_37123();
      if (this.method_2462()) {
         if (this.field_41768.method_29570() && !this.method_37285()) {
   ...
   public boolean method_2421() {
      return this.method_2462() && this.field_41768.method_29570();
   }
   ...
   private void method_2472() {
      if (this.method_2461() % 5 == 0) {
         ...
         for (int var3 = 0; var3 < 6; var3++) {
            ...
            var4 = var4.method_6212(-this.field_41755 * (float) (Math.PI / 180.0));
            var4 = var4.method_6192(-this.field_41701 * (float) (Math.PI / 180.0));
      ...
      if (this.field_3086 <= 32) {
         if (!this.field_41768.field_33055) {
            ...
            if (this.field_3086 != 1) {
               ...
               float var4 = this.field_41701 * (float) (Math.PI / 180.0);
   ...
   private void method_2426() {
      ...
      for (class_496 var5 : this.field_41768.<class_496>method_25868(class_496.class, this.method_37241().method_18898(10.0))) {
         if (!var5.method_26449() && var5.field_41726 && !var5.method_37285() && var5.method_2451()) {
            var5.method_26595();
         }
      }

      if (!this.field_41768.method_22567() && this.field_41717.nextInt(700) == 0 && this.field_41768.method_29537().method_1285(class_291.field_1033)) {
   ...
   public class_6910 method_26857(class_704 var1, class_2584 var2) {
      ...
      if (!this.method_2421()) {
         if (this.method_2450()) {
            ...
            if (!this.method_26449()) {
               if (!this.field_41768.field_33055 && this.method_8634() == 0 && this.method_24870()) {
                  this.method_24867(var1, var5);
                  this.method_24869(var1);
               } else {
                  if (this.field_41768.field_33055 || this.method_2449() || this.method_37285()) {
                     return class_6910.field_35521;
                  }
