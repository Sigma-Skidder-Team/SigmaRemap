...
public class class_2099 extends class_1859 {
   ...
   public void method_9846() {
      ...
      ConfigManager var3 = SigmaMainClass.getInstance().getModuleManager().getConfigManager();
   ...
   public void method_9849(class_1675 var1) {
      SigmaMainClass.getInstance();
      ConfigManager var4 = SigmaMainClass.getInstance().getModuleManager().getConfigManager();
   ...
   public void method_9847() {
      ...
      for (class_1675 var7 : SigmaMainClass.getInstance().getModuleManager().getConfigManager().method_4305()) {
