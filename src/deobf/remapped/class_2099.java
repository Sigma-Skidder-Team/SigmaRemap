...
public class class_2099 extends class_1859 {
   ...
   public void method_9846() {
      ...
      class_986 var3 = SigmaMainClass.getInstance().getModuleManager().method_848();
   ...
   public void method_9849(class_1675 var1) {
      SigmaMainClass.getInstance();
      class_986 var4 = SigmaMainClass.getInstance().getModuleManager().method_848();
   ...
   public void method_9847() {
      ...
      for (class_1675 var7 : SigmaMainClass.getInstance().getModuleManager().method_848().method_4305()) {
