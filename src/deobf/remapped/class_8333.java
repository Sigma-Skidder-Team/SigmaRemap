...
public class class_8333 extends class_3599 {
   ...
   public boolean method_16799() {
      ...
      return !new BlockPos((double)var3.getX(), this.field_42658.method_37309(), (double)var3.getZ())
   ...
   public void method_16793() {
      BlockPos var3 = this.field_42658.method_2163();
      if (new BlockPos((double)var3.getX(), this.field_42658.method_37309(), (double)var3.getZ())
            .method_12170(this.field_42658.method_37245(), 4.0)
         || this.field_42660) {
   ...
   public void method_16794() {
      ...
      if (this.field_42658.method_2162() || this.field_42658.method_26927().method_5591()) {
         Vector3d var4 = Vector3d.method_6216(this.field_42658.method_2163());
         Vector3d var5 = class_3425.method_15841(this.field_42658, 16, 1, var4, (float) (Math.PI / 8));
         if (var5 == null) {
