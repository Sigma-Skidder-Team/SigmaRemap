...
public class class_9477 {
   ...
   public static class_7481 method_43781(class_6331 var0, class_5799 var1, class_1489 var2, class_2034 var3, class_5734 var4) {
      ...
      class_546 var11 = new class_546(
         var0.method_2755().<class_6325>method_28813(class_8669.field_44359), var3, var8, !var9.method_25939("Biomes", 11) ? null : var9.method_25922("Biomes")
      );
      class_6397 var12 = !var9.method_25939("UpgradeData", 10) ? class_6397.field_32658 : new class_6397(var9.method_25937("UpgradeData"));
      ...
      boolean var15 = var9.method_25933("isLightOn");
      ...
      for (int var22 = 0; var22 < var16.size(); var22++) {
         ...
         if (var15) {
            if (var30.method_25939("BlockLight", 7)) {
            ...
            if (var19 && var30.method_25939("SkyLight", 7)) {
      ...
      if (var40 != class_5592.field_28385) {
         ...
         Object var41;
         if (!var9.method_25939("TileTicks", 9)) {
            var41 = var13;
         } else {
         ...
         Object var44;
         if (!var9.method_25939("LiquidTicks", 9)) {
            var44 = var14;
         } else {
      ...
      for (class_3801 var31 : ((class_5990)var43).method_27364().method_33447()) {
         ...
         if (!var42.method_25939(var32, 12)) {
            var45.add(var31);
         } else {
   ...
   public static class_5734 method_43779(class_6331 var0, class_5990 var1) {
      ...
      if (!var7.method_29208()) {
         var6.method_25946("UpgradeData", var7.method_29205());
      }
      ...
      var6.method_25946("Sections", var9);
      if (var11) {
         var6.method_25934("isLightOn", true);
      }
      ...
      var6.method_25946("TileEntities", var23);
      ...
      if (var1.method_27364().method_33446() != class_5592.field_28385) {
         ...
         var6.method_25946("CarvingMasks", var31);
      } else {
      ...
      var6.method_25946("Entities", var25);
      class_3065 var29 = var1.method_27335();
      if (!(var29 instanceof class_2080)) {
         if (!(var29 instanceof class_968)) {
            var6.method_25946("TileTicks", var0.method_28968().method_13098(var4));
         } else {
            var6.method_25946("TileTicks", ((class_968)var29).method_4244());
         }
      } else {
         var6.method_25946("ToBeTicked", ((class_2080)var29).method_9707());
      }

      class_3065 var33 = var1.method_27336();
      if (!(var33 instanceof class_2080)) {
         if (!(var33 instanceof class_968)) {
            var6.method_25946("LiquidTicks", var0.method_28940().method_13098(var4));
         } else {
            var6.method_25946("LiquidTicks", ((class_968)var33).method_4244());
         }
      } else {
         var6.method_25946("LiquidsToBeTicked", ((class_2080)var33).method_9707());
      }
      ...
      for (Entry var40 : var1.method_27354()) {
         if (var1.method_27364().method_33447().contains(var40.getKey())) {
            var36.method_25946(((class_3801)var40.getKey()).method_17676(), new class_1129(((class_2131)var40.getValue()).method_9954()));
         }
      }

      var6.method_25946("Heightmaps", var36);
      var6.method_25946("Structures", method_43786(var4, var1.method_27363(), var1.method_15066()));
      return var5;
   }
   ...
   private static class_5734 method_43786(class_2034 var0, Map<class_5390<?>, class_3200<?>> var1, Map<class_5390<?>, LongSet> var2) {
      ...
      var5.method_25946("References", var10);
      return var5;
   }
   ...
   private static Map<class_5390<?>, class_3200<?>> method_43784(class_5799 var0, class_5734 var1, long var2) {
      ...
      for (String var9 : var7.method_25952()) {
         ...
         if (var11 != null) {
            class_3200 var12 = class_5390.method_24555(var0, var7.method_25937(var9), var2);
            if (var12 != null) {
