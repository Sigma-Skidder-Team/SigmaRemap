   ...
   public void run(String var1, class_5273[] var2, class_860 var3) throws CommandException {
      if (var2.length <= 0) {
         if (MinecraftClient.IS_SYSTEM_MAC) {
            if (!SigmaMainClass.getInstance().method_3299().method_31004()) {
               var3.method_3731("HighDPI was enabled!");
            } else {
               var3.method_3731("HighDPI was disabled!");
            }

            SigmaMainClass.getInstance().method_3299().method_30980(!SigmaMainClass.getInstance().method_3299().method_31004());
         } else {
