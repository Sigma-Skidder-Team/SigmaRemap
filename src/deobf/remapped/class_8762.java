...
public class class_8762 implements class_4904 {
   ...
   private final ItemStack field_44858;
   ...
   public class_8762(ItemStack var1, int var2, int var3, int var4, int var5) {
      this(var1, var2, var3, var4, var5, 0.05F);
   }

   public class_8762(ItemStack var1, int var2, int var3, int var4, int var5, float var6) {
   ...
   public class_8014 method_22451(Entity var1, Random var2) {
      return new class_8014(
         new ItemStack(class_4897.field_24997, this.field_44864),
         new ItemStack(this.field_44858.method_27960(), this.field_44862),
         this.field_44861,
         this.field_44859,
         this.field_44860
      );
