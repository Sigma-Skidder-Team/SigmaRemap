...
public class class_6014 {
   ...
   public static byte[] method_27451(String var0) throws IOException {
      ...
      try {
         ...
         var3 = (HttpURLConnection)var4.openConnection(MinecraftClient.getInstance().method_8607());
   ...
   public static String method_27452(String var0, Map var1, byte[] var2) throws IOException {
      ...
      try {
         ...
         var5 = (HttpURLConnection)var6.openConnection(MinecraftClient.getInstance().method_8607());
