...
public class class_9185 extends class_8131 {
   ...
   public class_9185(class_5799 var1, class_5734 var2) {
      ...
      if (!var1.startsWith("Chest")) {
         if (!var1.startsWith("Sentry")) {
            if (var1.startsWith("Elytra")) {
               class_7451 var8 = new class_7451(var3.method_7066(), var2, this.field_46996.method_30489(class_240.field_800));
