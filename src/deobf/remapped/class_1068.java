...
public final class class_1068 {
   public static ArrayList<String> field_5846 = new ArrayList<String>(
      Arrays.asList(
   ...
   public static ArrayList<String> field_5847;

   public static String method_4686() {
      return field_5846.get(Math.round(0.0F + (float)Math.random() * (float)(field_5846.size() - 1 - 0)));
   }

   public static String method_4687() {
      return field_5847.get(Math.round(0.0F + (float)Math.random() * (float)(field_5847.size() - 1 - 0)));
   }
   ...
   static {
      ...
      field_5847 = new ArrayList<String>(
         Arrays.asList(
            "完全像一个小丑一样被我打的痛苦连连",
            "你们还真是死皮赖脸的不要皮味",
            "你神爹我都不想和你说话了",
