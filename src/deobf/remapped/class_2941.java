...
public class class_2941 extends class_9128 {
   ...
   private void method_13455(class_1393 var1) {
      if (this.method_42015() && var1.method_6449()) {
         if (!(field_46692.field_9632.method_26576().method_27960() instanceof class_2100)) {
            this.field_14300.clear();
         } else {
   ...
   private void method_13456(class_3278 var1) {
      if (this.method_42015() && !this.method_42007("Silent")) {
         if (!this.field_14300.isEmpty()) {
            float[] var4 = class_7211.method_33005((class_5834)this.field_14300.get(0));
            field_46692.field_9632.field_41701 = var4[0];
            field_46692.field_9632.field_41755 = var4[1];
         }
      }
   }
   ...
   public List<class_8145> method_13451(float var1) {
      ...
      while (var5.hasNext()) {
         ...
         if (var6 == field_46692.field_9632) {
            var5.remove();
         } else if (class_727.method_3328().method_3307().method_14460(var6)) {
            var5.remove();
         } else if (!(var6 instanceof class_5834)) {
            var5.remove();
         } else if (((class_5834)var6).method_26551() == 0.0F) {
            var5.remove();
         } else if (field_46692.field_9632.method_37175(var6) > var1) {
            var5.remove();
         } else if (!field_46692.field_9632.method_26608((class_5834)var6)) {
            var5.remove();
         } else if (var6 instanceof class_9399) {
            var5.remove();
         } else if (!this.method_42007("Players") && var6 instanceof class_704) {
            var5.remove();
         } else if (this.method_42007("Anti-Bot") && var6 instanceof class_704 && class_727.method_3328().method_3331().method_20495(var6)) {
            var5.remove();
