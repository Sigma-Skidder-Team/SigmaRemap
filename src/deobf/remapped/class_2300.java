...
public class class_2300<T> extends class_5920<class_4612> {
   ...
   private final Function<T, Vector3d> field_11486;

   public class_2300(class_6044<T> var1, float var2, int var3, boolean var4, Function<T, Vector3d> var5) {
   ...
   public static class_2300<BlockPos> method_10574(class_6044<BlockPos> var0, float var1, int var2, boolean var3) {
      return new class_2300<BlockPos>(var0, var1, var2, var3, Vector3d::method_6200);
   }
   ...
   private Vector3d method_10576(class_4612 var1) {
   ...
   private boolean method_10580(class_4612 var1) {
      if (var1.method_26525().method_5117(class_6044.field_30889)) {
         ...
         if (var4.method_30559() == this.field_11488) {
            Vector3d var5 = var4.method_30562().method_35464().method_6194(var1.method_37245());
            Vector3d var6 = this.method_10576(var1).method_6194(var1.method_37245());
   ...
   private static void method_10578(class_4612 var0, Vector3d var1, float var2) {
      for (int var5 = 0; var5 < 10; var5++) {
         Vector3d var6 = class_3425.method_15836(var0, 16, 7, var1);
         if (var6 != null) {
