...
public class class_299 extends class_446 {
   ...
   public class_299(class_7038 var1, String var2, int var3, int var4, int var5, int var6, class_1675 var7, int var8) {
      ...
      this.field_1089.method_32143((var2x, var3x) -> {
         if (this.field_1089.method_32098() && var3x == 257) {
            ...
            if (class_727.method_3328().method_3298().method_848().method_4299(this.field_1089.method_32165())) {
               return;
            }
            ...
            try {
               class_727.method_3328().method_3298().method_848().method_4306();
      ...
      this.method_32100((var1x, var2x) -> {
         if (var2x != 1) {
            ...
            if (this.field_1084.method_11123() == 0.0F) {
               class_727.method_3328().method_3298().method_848().method_4300(this.field_1090);
               class_727.method_3328().method_3315().method_21206("switch");
               class_2099 var5x = (class_2099)this.method_32167().method_32167().method_32167();
               var5x.method_32102(() -> var5x.method_9847());

               for (class_9128 var7x : class_727.method_3328().method_3298().method_843().values()) {
                  if (var7x instanceof class_367 && !class_727.method_3328().method_3332().method_23084()) {
   ...
   public void method_32178(float var1) {
      if (this.field_1085.method_11123() == 1.0F && !this.field_1087) {
         ...
         class_727.method_3328().method_3298().method_848().method_4303(this.field_1090);
      ...
      if (class_727.method_3328().method_3298().method_848().method_4301() == this.field_1090) {
         class_73.method_99(
