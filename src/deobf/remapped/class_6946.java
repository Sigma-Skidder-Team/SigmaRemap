...
public class class_6946 implements class_6867, class_3957 {
   ...
   private final class_2831<ItemStack> field_35715;
   ...
   public class_6946(class_4088 var1, int var2, int var3) {
      this.field_35715 = class_2831.<ItemStack>method_12872(var2 * var3, ItemStack.EMPTY);
   ...
   public boolean method_31495() {
      for (ItemStack var4 : this.field_35715) {
   ...
   public ItemStack method_31498(int var1) {
      return var1 < this.method_31505() ? this.field_35715.get(var1) : ItemStack.EMPTY;
   }
   ...
   public ItemStack method_31497(int var1, int var2) {
      ItemStack var5 = class_3037.method_13881(this.field_35715, var1, var2);
   ...
   public void method_18279(class_534 var1) {
      for (ItemStack var5 : this.field_35715) {
