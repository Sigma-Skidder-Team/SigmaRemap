...
public class class_3670 extends class_7038 {
   ...
   public void method_32145(int var1, int var2) {
      ...
      if (!(this.field_17889 + (float)this.field_36278 < 0.0F)) {
         if (this.field_17889 > (float)class_1893.method_8510().field_9602.method_43166()) {
            this.field_17889 = (float)(0 - this.field_36278);
         }
      } else {
         this.field_17889 = (float)class_1893.method_8510().field_9602.method_43166();
      }

      if (!(this.field_17888 + (float)this.field_36257 < 0.0F)) {
         if (this.field_17888 > (float)class_1893.method_8510().field_9602.method_43163()) {
            this.field_17888 = (float)(0 - this.field_36257);
         }
      } else {
         this.field_17888 = (float)class_1893.method_8510().field_9602.method_43163();
      }
