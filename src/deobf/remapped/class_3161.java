...
public class class_3161 {
   public static final Codec<class_3161> field_15713 = RecordCodecBuilder.create(
      var0 -> var0.group(
               SoundEvent.field_43261.fieldOf("sound").forGetter(var0x -> var0x.field_15712),
   ...
   public static final class_3161 field_15715 = new class_3161(SoundEvents.field_1965, 6000, 8, 2.0);
   private SoundEvent field_15712;
   private int field_15711;
   private int field_15714;
   private double field_15710;

   public class_3161(SoundEvent var1, int var2, int var3, double var4) {
   ...
   public SoundEvent method_14592() {
