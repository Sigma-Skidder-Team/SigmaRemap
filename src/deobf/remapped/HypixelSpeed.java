...
public class HypixelSpeed extends Module {
   ...
   public void onDisable() {
      if (this.field_12321 == class_8988.field_46026 && mc.field_9632.method_37098().field_7333 > 0.0 && this.field_12323 == 0) {
         ...
         if (mc.field_9632.field_41726) {
            ...
            if (this.field_12323 >= 0 && class_4181.field_20352 >= 2) {
               if ((var1.method_35236() > 0.0 || this.getBooleanValueByName("AutoJump") && class_314.method_1434()) && !class_314.method_1437(mc.field_9632)) {
                  ...
                  this.field_12323 = 0;
                  this.field_12321 = class_8988.field_46028;
               } else if (class_314.method_1434() && this.getBooleanValueByName("GroundSpeed") && !class_314.method_1437(mc.field_9632)) {
            ...
            switch (this.field_12321) {
               case field_46028:
                  ...
                  if (class_8865.method_40769() == 0 && !SigmaMainClass.getInstance().getModuleManager().method_847(BlockFlyModule.class).method_42015()) {
               ...
               case field_46026:
                  if (this.field_12323 == 0) {
                     ...
                     if (this.getBooleanValueByName("BorderJump")
                        && mc.field_9601
                              .method_6680(mc.field_9632, mc.field_9632.field_41712.method_18928(0.0, -var6 - 0.0625, 0.0))
                              .count()
                           == 0L) {
            ...
            if (this.field_12322 < var4 || mc.field_9632.field_41744 || !class_314.method_1434() || class_314.method_1437(mc.field_9632)) {
   ...
   public void method_11345(class_1711 var1) {
      if (!mc.field_9632.field_41726
         ...
         && this.field_12321 == class_8988.field_46026
         && !(mc.field_9632.method_37309() < this.field_12324)) {
         mc.field_9632.field_41736.field_7333 = this.field_12324;
         mc.field_9632.field_41713 = this.field_12324;
         mc.field_9632.field_3864 = this.field_12324;
         mc.field_9632.field_41698 = this.field_12324;
