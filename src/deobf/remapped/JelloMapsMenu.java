...
public class JelloMapsMenu extends class_2596 {
   ...
   public JelloMapsMenu() {
      super("KeybindManager");
      this.field_11592 = new Date();
      int var3 = Math.max(300, Math.min(850, MinecraftClient.getInstance().window.method_43166() - 40));
      int var4 = Math.max(200, Math.min(550, MinecraftClient.getInstance().window.method_43163() - 80));
   ...
   private void method_10635(class_556 var1) {
      var1.method_2667((var1x, var2, var3, var4) -> {
         ...
         SigmaMainClass.getInstance().method_3309().method_21973(new class_4333(var2, var3.getX(), var3.method_12185(), var4));
         this.method_10637();
      });
   }

   private void method_10637() {
      JelloMapsMenu var3 = this;
