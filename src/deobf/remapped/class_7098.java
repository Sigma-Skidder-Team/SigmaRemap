...
public class class_7098 extends DataFix {
   private static final Map<String, Integer> field_36614 = (Map<String, Integer>)DataFixUtils.make(Maps.newHashMap(), var0 -> {
   ...
   public class_7098(Schema var1, boolean var2) {
      super(var1, var2);
   }

   public static int method_32628(String var0) {
      Integer var3 = field_36614.get(var0);
   ...
   public TypeRewriteRule makeRule() {
      ...
      Function var5 = var1 -> this.method_32626(var1, "DisplayTile", "DisplayData", "DisplayState");
      Function var6 = var1 -> this.method_32626(var1, "inTile", "inData", "inBlockState");
      Type var7 = DSL.and(
         DSL.optional(DSL.field("inTile", DSL.named(class_4002.field_19432.typeName(), DSL.or(DSL.intType(), class_5178.method_23741())))), DSL.remainderType()
      );
      Function var8 = var1 -> var1.update(var7.finder(), DSL.remainderType(), Pair::getSecond);
      return this.fixTypeEverywhereTyped("EntityBlockStateFix", var3.getType(class_4002.field_19444), var4.getType(class_4002.field_19444), var4x -> {
         var4x = this.method_32630(var4x, "minecraft:falling_block", this::method_32627);
         var4x = this.method_32630(var4x, "minecraft:enderman", var1x -> this.method_32626(var1x, "carried", "carriedData", "carriedBlockState"));
         var4x = this.method_32630(var4x, "minecraft:arrow", var6);
         var4x = this.method_32630(var4x, "minecraft:spectral_arrow", var6);
         var4x = this.method_32630(var4x, "minecraft:egg", var8);
         var4x = this.method_32630(var4x, "minecraft:ender_pearl", var8);
         var4x = this.method_32630(var4x, "minecraft:fireball", var8);
         var4x = this.method_32630(var4x, "minecraft:potion", var8);
         var4x = this.method_32630(var4x, "minecraft:small_fireball", var8);
         var4x = this.method_32630(var4x, "minecraft:snowball", var8);
         var4x = this.method_32630(var4x, "minecraft:wither_skull", var8);
         var4x = this.method_32630(var4x, "minecraft:xp_bottle", var8);
         var4x = this.method_32630(var4x, "minecraft:commandblock_minecart", var5);
         var4x = this.method_32630(var4x, "minecraft:minecart", var5);
         var4x = this.method_32630(var4x, "minecraft:chest_minecart", var5);
         var4x = this.method_32630(var4x, "minecraft:furnace_minecart", var5);
         var4x = this.method_32630(var4x, "minecraft:tnt_minecart", var5);
         var4x = this.method_32630(var4x, "minecraft:hopper_minecart", var5);
         return this.method_32630(var4x, "minecraft:spawner_minecart", var5);
      });
   }

   private Typed<?> method_32627(Typed<?> var1) {
      Type var4 = DSL.optional(DSL.field("Block", DSL.named(class_4002.field_19432.typeName(), DSL.or(DSL.intType(), class_5178.method_23741()))));
      Type var5 = DSL.optional(DSL.field("BlockState", DSL.named(class_4002.field_19435.typeName(), DSL.remainderType())));
      Dynamic var6 = (Dynamic)var1.get(DSL.remainderFinder());
      return var1.update(var4.finder(), var5, var1x -> {
         int var4x = (Integer)var1x.map(var0x -> (Integer)((Either)var0x.getSecond()).map(var0xx -> var0xx, class_7098::method_32628), var1xx -> {
            Optional var4xx = var6.get("TileID").asNumber().result();
            return var4xx.<Integer>map(Number::intValue).orElseGet(() -> var6.get("Tile").asByte((byte)0) & 0xFF);
         });
         int var5x = var6.get("Data").asInt(0) & 15;
         return Either.left(Pair.of(class_4002.field_19435.typeName(), class_8237.method_37732(var4x << 4 | var5x)));
      }).set(DSL.remainderFinder(), var6.remove("Data").remove("TileID").remove("Tile"));
   }

   private Typed<?> method_32626(Typed<?> var1, String var2, String var3, String var4) {
      TagType var7 = DSL.field(var2, DSL.named(class_4002.field_19432.typeName(), DSL.or(DSL.intType(), class_5178.method_23741())));
      TagType var8 = DSL.field(var4, DSL.named(class_4002.field_19435.typeName(), DSL.remainderType()));
      Dynamic var9 = (Dynamic)var1.getOrCreate(DSL.remainderFinder());
      return var1.update(var7.finder(), var8, var2x -> {
         int var5 = (Integer)((Either)var2x.getSecond()).map(var0x -> var0x, class_7098::method_32628);
         int var6 = var9.get(var3).asInt(0) & 15;
         return Pair.of(class_4002.field_19435.typeName(), class_8237.method_37732(var5 << 4 | var6));
      }).set(DSL.remainderFinder(), var9.remove(var3));
   }

   private Typed<?> method_32630(Typed<?> var1, String var2, Function<Typed<?>, Typed<?>> var3) {
