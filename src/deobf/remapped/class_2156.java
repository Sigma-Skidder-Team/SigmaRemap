...
public abstract class class_2156 extends class_8844 implements class_3978 {
   ...
   public boolean method_18358(class_6163 var1, BlockPos var2, class_2522 var3, boolean var4) {
      ...
      return var7.isPresent() && this.method_40682().method_29241(var1.method_28262(((BlockPos)var7.get()).method_6098(this.field_45228)));
   }
   ...
   public void method_18359(class_6331 var1, Random var2, BlockPos var3, class_2522 var4) {
      ...
      if (var7.isPresent()) {
         class_2522 var8 = var1.method_28262((BlockPos)var7.get());
         ((class_6408)var8.method_8360()).method_18359(var1, var2, (BlockPos)var7.get(), var8);
      }
   }

   private Optional<BlockPos> method_10045(class_6163 var1, BlockPos var2, class_2522 var3) {
      BlockPos var6 = var2;
      ...
      return var7 != this.method_40682() ? Optional.<BlockPos>empty() : Optional.<BlockPos>of(var6);
   }
