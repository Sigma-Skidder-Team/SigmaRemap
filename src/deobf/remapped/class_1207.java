...
public class class_1207<T extends class_8145> extends class_5272<T> {
   ...
   public void method_29700(T var1, float var2, float var3, float var4, float var5, float var6) {
      ...
      float var12 = -(class_9299.method_42840(var2 * 0.6662F * 2.0F + 0.0F) * 0.4F) * var3;
      float var13 = -(class_9299.method_42840(var2 * 0.6662F * 2.0F + (float) Math.PI) * 0.4F) * var3;
      float var14 = -(class_9299.method_42840(var2 * 0.6662F * 2.0F + (float) (Math.PI / 2)) * 0.4F) * var3;
      float var15 = -(class_9299.method_42840(var2 * 0.6662F * 2.0F + (float) (Math.PI * 3.0 / 2.0)) * 0.4F) * var3;
      float var16 = Math.abs(class_9299.method_42818(var2 * 0.6662F + 0.0F) * 0.4F) * var3;
      float var17 = Math.abs(class_9299.method_42818(var2 * 0.6662F + (float) Math.PI) * 0.4F) * var3;
      float var18 = Math.abs(class_9299.method_42818(var2 * 0.6662F + (float) (Math.PI / 2)) * 0.4F) * var3;
      float var19 = Math.abs(class_9299.method_42818(var2 * 0.6662F + (float) (Math.PI * 3.0 / 2.0)) * 0.4F) * var3;
