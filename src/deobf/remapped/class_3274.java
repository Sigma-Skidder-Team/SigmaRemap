...
public class class_3274 extends DataFix {
   public class_3274(Schema var1) {
      super(var1, false);
   }
   ...
   public TypeRewriteRule makeRule() {
      ...
      Type var9 = DSL.named(class_4002.field_19435.typeName(), DSL.remainderType());
      OpticFinder var10 = DSL.fieldFinder("Palette", DSL.list(var9));
      return this.fixTypeEverywhereTyped(
         "BitStorageAlignFix",
         var3,
         this.getOutputSchema().getType(class_4002.field_19449),
         var5x -> var5x.updateTyped(var5, var4xx -> this.method_14948(method_14949(var6, var8, var10, var4xx)))
      );
   }

   private Typed<?> method_14948(Typed<?> var1) {
      return var1.update(
         DSL.remainderFinder(),
         var0 -> var0.update("Heightmaps", var1x -> var1x.updateMapValues(var1xx -> var1xx.mapSecond(var1xxx -> method_14946(var0, var1xxx, 256, 9))))
      );
   }

   private static Typed<?> method_14949(OpticFinder<?> var0, OpticFinder<?> var1, OpticFinder<List<Pair<String, Dynamic<?>>>> var2, Typed<?> var3) {
   ...
   private static Dynamic<?> method_14946(Dynamic<?> var0, Dynamic<?> var1, int var2, int var3) {
      long[] var6 = var1.asLongStream().toArray();
      long[] var7 = method_14950(var2, var3, var6);
      return var0.createLongList(LongStream.of(var7));
   }

   public static long[] method_14950(int var0, int var1, long[] var2) {
