...
public class class_6561 {
   ...
   public void method_29976(World var1, BlockPos var2, BlockPos var3, boolean var4, class_6414 var5) {
      if (var3.getX() >= 1 && var3.getY() >= 1 && var3.getZ() >= 1) {
         ...
         BlockPos var12 = new BlockPos(
            ...
            Math.min(var2.getY(), var8.getY()),
            Math.min(var2.getZ(), var8.getZ())
         );
         BlockPos var13 = new BlockPos(
            Math.max(var2.getX(), var8.getX()),
            Math.max(var2.getY(), var8.getY()),
            Math.max(var2.getZ(), var8.getZ())
         );
   ...
   private static List<class_4099> method_29979(List<class_4099> var0, List<class_4099> var1, List<class_4099> var2) {
      Comparator var5 = Comparator.<class_4099>comparingInt(var0x -> var0x.field_19965.getY())
         .thenComparingInt(var0x -> var0x.field_19965.getX())
         .thenComparingInt(var0x -> var0x.field_19965.getZ());
      var0.sort(var5);
      var2.sort(var5);
      var1.sort(var5);
   ...
   private void method_29964(World var1, BlockPos var2, BlockPos var3) {
      List var6 = var1.<Entity>method_25869(Entity.class, new Box(var2, var3), var0 -> !(var0 instanceof PlayerEntity));
      this.field_33470.clear();
   ...
   public boolean method_29965(class_1556 var1, BlockPos var2, BlockPos var3, class_8478 var4, Random var5, int var6) {
      if (this.field_33468.isEmpty()) {
         ...
         if ((!var9.isEmpty() || !var4.method_39032() && !this.field_33470.isEmpty())
            ...
            && this.field_33472.getY() >= 1
            && this.field_33472.getZ() >= 1) {
                  ...
                  if (var1.method_7513(var21, var23, var6)) {
                     ...
                     if (var20.field_19968 != null) {
                        ...
                        if (var39 != null) {
                           ...
                           var20.field_19968.putInt("y", var21.getY());
                           var20.field_19968.putInt("z", var21.getZ());
            ...
            if (var13 <= var16) {
               if (!var4.method_39031()) {
                  ...
                  for (Pair var48 : var12) {
                     ...
                     var31.method_26202(var49.getX() - var34, var49.getY() - var37, var49.getZ() - var41, true, true);
                  }
   ...
   public BlockPos method_29970(class_6631 var1) {
      switch (var1) {
         case field_34335:
         case field_34334:
            return new BlockPos(this.field_33472.getZ(), this.field_33472.getY(), this.field_33472.getX());
         default:
            return this.field_33472;
      }
   }
   ...
   public BlockPos method_29977(BlockPos var1, class_9022 var2, class_6631 var3) {
      return method_29978(var1, var2, var3, this.method_29975().getX(), this.method_29975().getZ());
   }
   ...
   public class_9616 method_29973(BlockPos var1, class_6631 var2, BlockPos var3, class_9022 var4) {
      ...
      var13.method_44391(var1.getX(), var1.getY(), var1.getZ());
      return var13;
   }
   ...
   private void method_29989(class_6631 var1, int var2, int var3, class_9616 var4, Direction var5, Direction var6) {
      ...
      var4.method_44391(var9.getX(), 0, var9.getZ());
   }
   ...
   public CompoundNBT method_29993(CompoundNBT var1) {
      if (!this.field_33468.isEmpty()) {
         ...
         for (int var8 = 0; var8 < var7.size(); var8++) {
            ...
            CompoundNBT var10 = new CompoundNBT();
            var10.put("pos", this.method_29983(var9.field_19965.getX(), var9.field_19965.getY(), var9.field_19965.getZ()));
      ...
      for (class_8833 var17 : this.field_33470) {
         ...
         var18.put("blockPos", this.method_29983(var17.field_45183.getX(), var17.field_45183.getY(), var17.field_45183.getZ()));
      ...
      var1.put("size", this.method_29983(this.field_33472.getX(), this.field_33472.getY(), this.field_33472.getZ()));
