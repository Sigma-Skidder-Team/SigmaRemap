...
public class class_3626 extends DataFix {
   private static final Int2ObjectMap<String> field_17689 = (Int2ObjectMap<String>)DataFixUtils.make(new Int2ObjectOpenHashMap(), var0 -> {
   ...
   public class_3626(Schema var1, boolean var2) {
      super(var1, var2);
   }

   public static String method_16899(int var0) {
      return (String)field_17689.get(var0);
   }

   public TypeRewriteRule makeRule() {
      Type var3 = DSL.or(DSL.intType(), DSL.named(class_4002.field_19439.typeName(), class_5178.method_23741()));
      Type var4 = DSL.named(class_4002.field_19439.typeName(), class_5178.method_23741());
      OpticFinder var5 = DSL.fieldFinder("id", var3);
      return this.fixTypeEverywhereTyped(
         "ItemIdFix",
         this.getInputSchema().getType(class_4002.field_19433),
         this.getOutputSchema().getType(class_4002.field_19433),
         var2 -> var2.update(var5, var4, var0x -> (Pair)var0x.map(var0xx -> Pair.of(class_4002.field_19439.typeName(), method_16899(var0xx)), var0xx -> var0xx))
      );
   }
}
