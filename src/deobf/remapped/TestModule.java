...
public class TestModule extends Module {
   ...
   public void onEnable() {
      ...
      this.field_8832 = class_9299.method_42810(mc.field_9632.field_41701);
      this.field_8832 = 39.0F;
      this.field_8826 = mc.field_9632.field_41755;
   ...
   public void method_7650(class_8706 var1) {
      if (!this.method_42015() || mc.field_9623 != null) {
         ;
      }
   }
   ...
   public void method_7655(class_2157 var1) {
      ...
      if (this.method_42015() && mc.field_9632 != null) {
         if (!(var4 instanceof class_3398)) {
            ...
            Entity var6 = var18.method_15695(mc.field_9601);
            if (var6 != null) {
                     ...
                     if (!(var4 instanceof class_624)) {
                        if (!(var4 instanceof class_8077)) {
                           if (!(var4 instanceof class_4548)) {
                              ...
                              if (var8.method_21093() != mc.field_9632.method_37145()) {
                              }
                           }
                        } else {
                        ...
                        if (mc.field_9632.method_26608((class_5834)var7)) {
                           if (!(var7 instanceof class_9399)) {
                              if (var7 instanceof class_704 && SigmaMainClass.getInstance().method_3331().method_20495(var7)) {
                                 ...
                                 if (var5 == null || mc.field_9632.method_37175(var7) < mc.field_9632.method_37175(var5)) {
                                    var5 = var7;
                                 }
                              } else {
                                 var6.remove();
   ...
   public static float[] method_7647(Entity var0) {
      double var3 = var0.method_37302() - mc.field_9632.method_37302();
      double var5 = var0.method_37156() - mc.field_9632.method_37156();
      double var7 = mc.field_9632.method_37309() + (double) mc.field_9632.method_37277() - (var0.method_37309() + (double)var0.method_37277());
   ...
   public static float method_7657(float var0, double var1, double var3) {
      double var7 = var1 - mc.field_9632.method_37302();
      double var9 = var3 - mc.field_9632.method_37156();
      double var11 = 0.0;
   ...
   public static float method_7649(float var0, Entity var1, double var2) {
      ...
      double var8 = var1.method_37156() - mc.field_9632.method_37156();
      double var10 = var2 - 2.2 + (double)var1.method_37277() - mc.field_9632.method_37309();
