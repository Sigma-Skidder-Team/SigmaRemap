...
public class NCPBlockFly extends Module {
   ...
   public void method_42012() {
      this.field_30936 = (BlockFlyModule)this.getModule();
   }
   ...
   public void onDisable() {
      if (this.field_30933 != -1 && this.getModule().getStringValueByName("ItemSpoof").equals("Switch")) {
   ...
   public void method_27623(class_1393 var1) {
      if (this.method_42015() && this.field_30936.method_17219() != 0) {
         if (!var1.method_6449()) {
            ...
            this.field_30940 = Hand.MAIN_HAND;
            if (BlockFlyModule.method_17216(client.thePlayer.method_26617(Hand.OFF_HAND).method_27960())
               ...
               this.field_30940 = Hand.OFF_HAND;
            }
   ...
   public void method_27619(class_7767 var1) {
      if (this.method_42015() && this.field_30936.method_17219() != 0) {
         ...
         switch (var4) {
            ...
            case "Cubecraft":
               double var6 = 0.2;
               float var8 = this.method_27622(MathHelper.wrapDegrees(client.thePlayer.rotationYaw));
