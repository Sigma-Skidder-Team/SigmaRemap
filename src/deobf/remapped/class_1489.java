...
public class class_1489 extends class_9821<class_4402> {
   ...
   public void method_6878(BlockPos var1, class_236 var2) {
      this.method_45269(class_6979.method_31921(var1).method_31925()).method_20516(var1, var2);
   }

   public void method_6864(BlockPos var1) {
      this.method_45269(class_6979.method_31921(var1).method_31925()).method_20510(var1);
   }

   public long method_6866(Predicate<class_236> var1, BlockPos var2, int var3, class_8122 var4) {
      return this.method_6877(var1, var2, var3, var4).count();
   }

   public boolean method_6868(class_236 var1, BlockPos var2) {
   ...
   public Stream<class_8009> method_6863(Predicate<class_236> var1, BlockPos var2, int var3, class_8122 var4) {
   ...
   public Stream<class_8009> method_6877(Predicate<class_236> var1, BlockPos var2, int var3, class_8122 var4) {
      int var7 = var3 * var3;
   ...
   public Stream<BlockPos> method_6867(Predicate<class_236> var1, Predicate<BlockPos> var2, BlockPos var3, int var4, class_8122 var5) {
      return this.method_6877(var1, var3, var4, var5).<BlockPos>map(class_8009::method_36337).filter(var2);
   }

   public Stream<BlockPos> method_6875(Predicate<class_236> var1, Predicate<BlockPos> var2, BlockPos var3, int var4, class_8122 var5) {
      return this.method_6867(var1, var2, var3, var4, var5).sorted(Comparator.comparingDouble(var1x -> var1x.method_12180(var3)));
   }

   public Optional<BlockPos> method_6876(Predicate<class_236> var1, Predicate<BlockPos> var2, BlockPos var3, int var4, class_8122 var5) {
      return this.method_6867(var1, var2, var3, var4, var5).findFirst();
   }

   public Optional<BlockPos> method_6880(Predicate<class_236> var1, BlockPos var2, int var3, class_8122 var4) {
   ...
   public Optional<BlockPos> method_6861(Predicate<class_236> var1, Predicate<BlockPos> var2, BlockPos var3, int var4) {
      return this.method_6877(var1, var3, var4, class_8122.field_41617).filter(var1x -> var2.test(var1x.method_36337())).findFirst().<BlockPos>map(var0 -> {
         var0.method_36339();
         return var0.method_36337();
      });
   }

   public Optional<BlockPos> method_6881(Predicate<class_236> var1, Predicate<BlockPos> var2, class_8122 var3, BlockPos var4, int var5, Random var6) {
      List var9 = this.method_6877(var1, var4, var5, var3).collect(Collectors.toList());
      Collections.shuffle(var9, var6);
      return var9.stream().filter(var1x -> var2.test(var1x.method_36337())).findFirst().<BlockPos>map(class_8009::method_36337);
   }

   public boolean method_6860(BlockPos var1) {
      return this.method_45269(class_6979.method_31921(var1).method_31925()).method_20512(var1);
   }

   public boolean method_6869(BlockPos var1, Predicate<class_236> var2) {
   ...
   public Optional<class_236> method_6870(BlockPos var1) {
   ...
   private void method_6882(class_1315 var1, class_6979 var2, BiConsumer<BlockPos, class_236> var3) {
      var2.method_31902()
         .forEach(
            var2x -> {
   ...
   public void method_6862(class_4924 var1, BlockPos var2, int var3) {
