...
public class class_6011 extends class_1829 {
   ...
   public SoundEvent method_26918() {
      return SoundEvents.field_2229;
   }

   @Override
   public SoundEvent method_26541(DamageSource var1) {
      return SoundEvents.field_2668;
   }

   @Override
   public SoundEvent method_26599() {
      return SoundEvents.field_2581;
   }
   ...
   public void livingTick() {
      ...
      if (!this.method_37134()) {
         this.field_30609 = MathHelper.abs(MathHelper.sin(this.field_30612)) * (float) Math.PI * 0.25F;
         if (!this.world.field_33055) {
         ...
         if (!(this.field_30612 < (float) Math.PI)) {
            ...
            this.field_30609 = MathHelper.sin(var3 * var3 * (float) Math.PI) * (float) Math.PI * 0.25F;
            if (!((double)var3 > 0.75)) {
