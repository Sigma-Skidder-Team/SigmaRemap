...
public class class_3829 extends class_2596 {
   ...
   public void method_32178(float var1) {
      ...
      var4 = Math.min(var4, (int)((float)class_1893.method_8510().field_9602.method_43163() / 1.65F));
      var5 = Math.min(var5, (int)((float)class_1893.method_8510().field_9602.method_43163() / 1.65F));
      this.method_17806();
      class_73.method_94(
         ...
         this.field_18710 = (float)Math.max(
            ...
            Math.min(
               ...
               (double)this.field_18710
                  + 0.05 * (double)(30.0F / (float)class_1893.method_8501())
                  - (double)(this.field_18710 * 0.04F * (30.0F / (float)class_1893.method_8501()))
            )
         );
      }
   }
   ...
   private void method_17806() {
      ...
      class_73.method_96(
         (float)this.field_18706, (float)this.field_18707, (float)(this.method_32109() * 2), (float)(this.method_32137() + 114), class_2209.field_11005
      );
      float var7 = 0.5F;
