...
public class AutoToolsModule extends Module {
   ...
   public void method_29644(class_307 var1) {
      if (this.method_42015() && mc.field_9632 != null && var1.method_1364() == 0) {
         if (this.field_33089 != -1) {
            mc.field_9632.field_3853.field_36404 = this.field_33089;
            this.field_33089 = -1;
         }
      }
   }
   ...
   private void method_29646(class_6435 var1) {
      if (this.method_42015() && mc.field_9632 != null && var1.method_29384() == 0) {
   ...
   private void method_29645(class_5596 var1) {
      if (this.method_42015() && mc.field_9632 != null && mc.gameOptions.keyAttack.isKeyDown()) {
   ...
   public void method_29647(class_1331 var1) {
      class_1331 var4 = var1 == null
         ? (mc.field_9587.method_33990() != class_1430.field_7717 ? null : ((class_9529) mc.field_9587).method_43955())
         : var1;
      if (var4 != null) {
         int var5 = class_2740.method_12348(mc.field_9601.method_28262(var4));
         if (var5 != -1) {
            if (mc.field_9632.field_3853.field_36404 != var5 % 9 && this.field_33089 == -1) {
               this.field_33089 = mc.field_9632.field_3853.field_36404;
            }

            if (var5 >= 36 && var5 <= 44) {
               mc.field_9632.field_3853.field_36404 = var5 % 9;
            } else if (SigmaMainClass.getInstance().method_3310().method_25303() > 1) {
               String var6 = this.getStringValueByName("Inv Mode");
               if (var6.equals("OpenInv") && !(mc.field_9623 instanceof class_3431)) {
                  return;
               }
               ...
               mc.field_9632.field_3853.field_36404 = class_2740.method_12363(var5);
