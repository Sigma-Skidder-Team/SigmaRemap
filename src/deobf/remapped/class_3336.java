...
public enum class_3336 {
   ...
   public float method_15303() {
      if (!this.field_16454.equals(class_4897.field_25206)) {
         ...
         return !(this.field_16448 * class_2100.method_9852(class_3961.method_18288().field_9632.method_26466()) > 0.0F)
            ? class_2100.method_9852(20)
            : class_2100.method_9852(class_3961.method_18287().field_9632.method_26466());
      }
   }
   ...
   public List<class_7047> method_15304() {
      ...
      float var4 = (float)Math.toRadians((double)class_3961.method_18292().field_9632.field_41701);
      float var5 = (float)Math.toRadians((double)class_3961.method_18299().field_9632.field_41755);
      double var6 = class_3961.method_18293().field_9632.field_41754
         + (class_3961.method_18295().field_9632.method_37302() - class_3961.method_18301().field_9632.field_41754)
            * (double)class_3961.method_18284().field_9616.field_32600;
      double var8 = class_3961.method_18283().field_9632.field_41713
         + (class_3961.method_18305().field_9632.method_37309() - class_3961.method_18282().field_9632.field_41713)
            * (double)class_3961.method_18298().field_9616.field_32600;
      double var10 = class_3961.method_18296().field_9632.field_41724
         + (class_3961.method_18291().field_9632.method_37156() - class_3961.method_18302().field_9632.field_41724)
            * (double)class_3961.method_18286().field_9616.field_32600;
      this.field_16461 = var6;
      this.field_16457 = var8 + (double)class_3961.method_18300().field_9632.method_37277() - 0.1F;
      this.field_16443 = var10;
      float var12 = Math.min(20.0F, (float)(72000 - class_3961.method_18290().field_9632.method_26466()) + class_3961.method_18304().method_8554()) / 20.0F;
      ...
      while (this.field_16463 == null && this.field_16449 == null && this.field_16457 > 0.0) {
         ...
         List var17 = class_3961.method_18303()
            .field_9601
            .method_25867(
               class_3961.method_18297().field_9632,
         ...
         class_9529 var18 = class_3961.method_18285()
            .field_9601
            .method_28265(new class_972(var13, var14, class_3132.field_15553, class_9583.field_48747, class_3961.method_18294().field_9632));
