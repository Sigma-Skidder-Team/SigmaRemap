...
public class class_5870 extends class_9128 {
      ...
      if (this.method_42015() && var1.method_6449()) {
         ...
         if (!this.field_29808) {
            if (this.method_26734(class_4897.field_24719) == 0) {
               if (var4.equals("OpenInv") && !(field_46692.field_9623 instanceof class_3431)) {
                  return;
               }
         ...
         } else if (var4.equals("OpenInv") && !(field_46692.field_9623 instanceof class_3431)) {
            this.field_29808 = false;
   ...
   private void method_26736() {
      ...
      if (this.method_42016("Refill mode").equals("FakeInv")
         && !(field_46692.field_9623 instanceof class_3431)
      ...
      if (this.method_42016("Bowls").equals("Stack")) {
         ...
         if (var3 > 0) {
            ...
            if (var4 > 0) {
               ...
               class_2740.method_12356(field_46692.field_9632.field_3869.field_19925, var4, 0, class_6269.field_32023, field_46692.field_9632, true);
               class_2740.method_12356(field_46692.field_9632.field_3869.field_19925, var4, 0, class_6269.field_32027, field_46692.field_9632, true);
               this.field_29804 = -5;
            }
         }
      ...
      if (this.field_29804 >= var3 && class_727.method_3328().method_3310().method_25303() >= var3) {
         while (this.field_29807 < 36) {
            ...
            if (class_2740.method_12311(this.field_29807).method_27960() == class_4897.field_24719
               ...
               class_2740.method_12356(field_46692.field_9632.field_3869.field_19925, this.field_29807, 0, class_6269.field_32019, field_46692.field_9632, true);
               this.field_29804 = 0;
               var4 = true;
            }
   ...
   private void method_26738() {
      ...
      if (!this.method_42016("Soup mode").equals("Instant")) {
         if (this.field_29806 >= 0) {
            ...
            if (var3 < 0 || this.field_29805 <= 3 || field_46692.field_9632.method_26551() > this.method_42002("Health")) {
               return;
            }

            this.field_29806 = field_46692.field_9632.field_3853.field_36404;
            field_46692.field_9632.field_3853.field_36404 = var3;
            field_46692.field_9647.method_42129();
         ...
         field_46692.method_8614().method_4813(new class_7371(var3));
         field_46692.method_8614().method_4813(new class_1022(class_2584.field_12794));
         field_46692.method_8614().method_4813(new class_1022(class_2584.field_12791));
         if (var5) {
            field_46692.method_8614().method_4813(new class_1586(class_7500.field_38266, class_1331.field_7306, class_240.field_802));
         ...
         if (var4.method_27960() == class_4897.field_24454 && var4.method_27997() < 64) {
            ...
            if (var4.method_27960() == class_4897.field_25302) {
               for (int var13 = 36; var13 < 45; var13++) {
                  if (field_46692.field_9632.field_3869.method_18878(var13).method_35898().method_27960() == class_4897.field_24454) {
            ...
            for (int var14 = 9; var14 < 36; var14++) {
               ...
               if (var4.method_27960() == class_4897.field_25302) {
                  for (int var6 = 36; var6 < 45; var6++) {
                     if (field_46692.field_9632.field_3869.method_18878(var6).method_35898().method_27960() == class_4897.field_24454) {
            ...
            for (int var15 = 36; var15 < 45; var15++) {
               if (field_46692.field_9632.field_3869.method_18878(var15).method_35898().method_27960() == class_4897.field_24454) {
   ...
   private int method_26734(class_2451 var1) {
      ...
      for (int var5 = 36; var5 < 45; var5++) {
         if (field_46692.field_9632.field_3869.method_18878(var5).method_35898().method_27960() == var1) {
            var4++;
         }
      }
