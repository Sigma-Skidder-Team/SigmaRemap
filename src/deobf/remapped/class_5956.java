...
public class class_5956 extends class_7038 {
   ...
   public class_5956(class_7038 var1, String var2, int var3, int var4) {
      ...
      this.field_30365
         .method_32100(
            (var1x, var2x) -> {
               class_7309 var5 = SigmaMainClass.getInstance()
                  .method_3303()
                  .method_39908()
                  .get(new Random().nextInt(SigmaMainClass.getInstance().method_3303().method_39908().size()));
               var10.method_9987(var5);
            }
         );
      this.field_30363.method_32100((var0, var1x) -> MinecraftClient.getInstance().method_8609(new class_1876()));
