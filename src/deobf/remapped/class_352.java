         ...
         switch (var7) {
            case "add":
               if (var2.length != 2) {
                  ...
                  if (var15) {
                     boolean var16 = class_727.method_3328().method_3307().method_14458(var2[1].method_24060());
                     if (!var16) {
            ...
            case "remove":
               if (var2.length != 2) {
                  ...
                  boolean var13 = class_727.method_3328().method_3307().method_14466(var2[1].method_24060());
                  if (!var13) {
               ...
               break;
            case "list":
               List var9 = class_727.method_3328().method_3307().method_14471();
               if (var9.isEmpty()) {
               ...
               break;
            case "clear":
               if (class_727.method_3328().method_3307().method_14461()) {
