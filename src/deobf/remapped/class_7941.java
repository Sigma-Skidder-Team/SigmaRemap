...
public class class_7941 implements class_6491, AutoCloseable {
   ...
   public void method_35924(class_7966 var1, class_9071 var2, float var3, boolean var4, boolean var5, boolean var6) {
      if (!this.field_40630) {
         ...
         class_727.method_3328().method_3302().method_7914(var11);
   ...
   public void method_35945(float var1, long var2, boolean var4) {
      ...
      if (!this.field_40612.field_9589) {
         ...
         if (var4 && this.field_40612.field_9601 != null && !class_3111.method_14350()) {
            ...
            class_727.method_3328().method_3302().method_7914(new class_1711(var1, var2));
         ...
         class_3542.method_16438();
         class_727.method_3328().method_3311();
         class_3542.method_16489();
         ...
         } else if (this.field_40612.field_9623 != null && class_727.method_3328().method_3299().method_31001() == null) {
            try {
               if (class_7860.field_39933.method_3596()) {
                  ...
                  class_727.method_3328().method_3302().method_7914(new class_2532());
               }
   ...
   public void method_35950(float var1, long var2, class_7966 var4) {
      ...
      class_727.method_3328().method_3316();
      class_3542.method_16489();
