...
public class class_3004 extends class_446 {
   ...
   public boolean method_29508(int var1, int var2, int var3) {
      if (!super.method_29508(var1, var2, var3)) {
         ...
         if (!class_9732.method_44934(MinecraftClient.getInstance().field_9602.method_43181(), 340)
            && !class_9732.method_44934(MinecraftClient.getInstance().field_9602.method_43181(), 344)) {
         ...
         switch (var1) {
            ...
            case 67:
               if (this.method_13722() && this.field_14756 != this.field_14746) {
                  GLFW.glfwSetClipboardString(
                     MinecraftClient.getInstance().field_9602.method_43181(),
            ...
            case 86:
               if (this.method_13722()) {
                  ...
                  try {
                     var12 = GLFW.glfwGetClipboardString(MinecraftClient.getInstance().field_9602.method_43181());
                     if (var12 == null) {
                        var12 = "";
                     }
   ...
   public boolean method_13722() {
      return class_9732.method_44934(MinecraftClient.getInstance().field_9602.method_43181(), 341)
         || class_9732.method_44934(MinecraftClient.getInstance().field_9602.method_43181(), 345)
         || class_9732.method_44934(MinecraftClient.getInstance().field_9602.method_43181(), 343);
   }
