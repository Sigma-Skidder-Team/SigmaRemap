...
public class class_6377 {
   ...
   public static void method_29157(class_9071 var0, float var1, class_174 var2, int var3, float var4) {
      ...
      if (var0.method_41633() instanceof class_5834 && ((class_5834)var0.method_41633()).method_26480(class_4054.field_19736)) {
         int var26 = ((class_5834)var0.method_41633()).method_26553(class_4054.field_19736).method_10347();
         if (var26 >= 20) {
            var49 = 0.0;
         } else {
   ...
   public static void method_29160(class_9071 var0, class_1026 var1, float var2, boolean var3, float var4) {
      ...
      if (!(var9 >= 0.0F)) {
         if (!var7.method_22007(class_6503.field_33094)) {
            ...
            float var11;
            if (!var7.method_22007(class_6503.field_33095)) {
               if (var8 instanceof class_5834 && ((class_5834)var8).method_26480(class_4054.field_19736)) {
                  int var12 = ((class_5834)var8).method_26553(class_4054.field_19736).method_10347();
            ...
            } else if (var8 instanceof class_5834 && ((class_5834)var8).method_26480(class_4054.field_19745)) {
               var10 = 0.0F;
               var11 = 3.0F;
            } else {
               var10 = 0.25F;
