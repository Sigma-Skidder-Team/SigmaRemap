...
public class class_4972 extends class_9128 {
   ...
   public void method_22861(class_5596 var1) {
      if (this.method_42015()) {
         if (field_46692.field_9632.field_41697 < 20) {
            ...
            if (!var14 && field_46692.field_9632.field_41726 && !class_727.method_3328().method_3301().method_27149() && this.field_25750 == null) {
               List var15 = this.method_22863();
               class_727.method_3328().method_3335().method_27841(new class_8235("AutoMiner", "Computing...", class_2209.field_10993));
                  ...
                  () -> {
                     ...
                     for (class_1331 var6x : var15) {
                        try {
                           ...
                           if (var13x.size() > 1) {
                              class_727.method_3328().method_3301().method_27153(var13x);
   ...
   public void method_42006() {
      ...
      this.field_25751.clear();
      this.field_25748.clear();
      class_727.method_3328().method_3301().method_27144();
      class_727.method_3328().method_3335().method_27841(new class_8235("AutoMiner", "Scanning Terrain..."));
   }
   ...
   public void method_22857() {
      if (this.method_42015() && this.field_25755 != null && this.field_25750 != null) {
         ...
         for (int var4 = 0; var4 < (int)((float)this.field_25752.size() * var3); var4++) {
            ...
            GL11.glVertex3d(
               var7 - field_46692.field_9590.method_35949().method_41627().method_61() + 0.5,
               var9 - field_46692.field_9590.method_35949().method_41627().method_60(),
               var11 - field_46692.field_9590.method_35949().method_41627().method_62() + 0.5
            );
         }
