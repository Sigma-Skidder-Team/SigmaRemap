...
public class class_3744 extends class_3793 {
   private static String[] field_18318;

   public class_3744(class_3073 var1) {
      super(var1);
   }

   @Override
   public class_3757 method_3281(class_6163 var1) {
      return new class_7960();
   }
   ...
   public void method_17625(World var1, BlockPos var2, PlayerEntity var3) {
      ...
      if (var6 instanceof class_7960) {
         ...
         var3.method_3209(class_6234.field_31869);
      }
   }
   ...
   public void method_29280(class_2522 var1, World var2, BlockPos var3, Random var4) {
      if (var1.<Boolean>method_10313(field_18522)) {
         ...
         if (var4.nextDouble() < 0.1) {
            var2.method_29527(var7, var9, var11, SoundEvents.field_2887, class_562.field_3322, 1.0F, 1.0F, false);
         }
         ...
         var2.method_43361(class_3090.field_15321, var7 + var19, var9 + var21, var11 + var23, 0.0, 0.0, 0.0);
      }
   }
}
