...
public class class_2167 extends class_9128 {
   public class_2167() {
   ...
   public void method_42006() {
      ...
      if (!this.method_42016("Jargon").equals("Excuse")) {
         if (!this.method_42016("Jargon").equals("Techincal")) {
            ...
            var3 = this.method_10070();
         }
      } else {
         var3 = this.method_10074();
      }

      field_46692.field_9632.method_27307("" + var3);
      this.method_42023(false);
   }

   public String method_10070() {
      ...
      return this.method_10072(var3, var4, var5, var6, var7, var8);
   }

   public String method_10074() {
   ...
   public String method_10072(String[] var1, String[] var2, String[] var3, String[] var4, String[] var5, String[] var6) {
      String var9 = method_10071(var1);

      while (var9.contains("{")) {
         var9 = StringUtils.replaceOnce(var9, "{0}", method_10071(var2));
         var9 = StringUtils.replaceOnce(var9, "{1}", method_10071(var3));
         var9 = StringUtils.replaceOnce(var9, "{2}", method_10071(var4));
         var9 = StringUtils.replaceOnce(var9, "{3}", method_10071(var5));
         var9 = StringUtils.replaceOnce(var9, "{4}", method_10071(var6));
      }

      return var9.substring(0, 1).toUpperCase() + var9.substring(1);
   }

   public static String method_10071(String[] var0) {
