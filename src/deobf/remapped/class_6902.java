...
public class class_6902 {
   ...
   public static void method_31606(class_6704 var0, LivingEntity var1) {
   ...
   private static void method_31613(class_6704 var0, LivingEntity var1) {
      method_31616(var0).forEach(var1x -> method_31619(var1x, var1));
   }

   private static void method_31619(class_6704 var0, LivingEntity var1) {
   ...
   private static void method_31629(class_6704 var0, LivingEntity var1) {
   ...
   private static Optional<? extends LivingEntity> method_31610(class_6704 var0) {
   ...
   public static void method_31607(class_6704 var0, LivingEntity var1) {
      class_1150 var4 = var0.method_26525();
   ...
   private static void method_31612(class_6704 var0, LivingEntity var1) {
   ...
   private static void method_31617(class_6704 var0, LivingEntity var1) {
      class_1150 var4 = var0.method_26525();
   ...
   private static void method_31608(class_6704 var0, LivingEntity var1) {
      method_31616(var0).forEach(var1x -> method_31625(var1x, var1));
   }

   private static void method_31625(class_6704 var0, LivingEntity var1) {
      if (!method_31623(var0)) {
         Optional var4 = var0.method_26525().<LivingEntity>method_5138(class_6044.field_30884);
         LivingEntity var5 = class_1225.method_5440(var0, var4, var1);
         method_31617(var0, var5);
      }
   }

   public static Optional<SoundEvent> method_31618(class_6704 var0) {
      return var0.method_26525().method_5126().<SoundEvent>map(var1 -> method_31622(var0, var1));
   }

   private static SoundEvent method_31622(class_6704 var0, class_6275 var1) {
      if (var1 == class_6275.field_32068 || var0.method_30710()) {
         return SoundEvents.field_2205;
      } else if (var1 != class_6275.field_32070) {
         return !method_31621(var0) ? SoundEvents.field_2815 : SoundEvents.field_2205;
      } else {
         return SoundEvents.field_2769;
      }
   }
