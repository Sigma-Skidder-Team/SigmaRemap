   ...
   public static void method_15968() {
      ...
      if (class_3111.method_14404()) {
         ...
         try {
            ...
            boolean var4 = class_3111.method_14247(var3);
            InputStream var5 = class_3111.method_14374(var3);
            ArrayList var6 = new ArrayList(256);
            String var7 = class_3111.method_14270(var5);
            var5.close();
            String[] var8 = class_3111.method_14302(var7, "\n\r");
            if (var4) {
               class_3111.method_14277("Natural Textures: Parsing default configuration \"" + var2 + "\"");
               class_3111.method_14277("Natural Textures: Valid only for textures from default resource pack");
            } else {
               class_3111.method_14277("Natural Textures: Parsing configuration \"" + var2 + "\"");
            }
            ...
            for (int var11 = 0; var11 < var8.length; var11++) {
               ...
               if (!var12.startsWith("#")) {
                  ...
                  if (var13.length != 2) {
                     ...
                     if (var16 == null) {
                        class_3111.method_14317("Natural Textures: Texture not found: \"" + var2 + "\" line: " + var12);
                     } else {
            ...
            if (var9 > 0) {
               class_3111.method_14277("NaturalTextures: " + var9);
            }
         } catch (FileNotFoundException var19) {
            class_3111.method_14317("NaturalTextures: configuration \"" + var2 + "\" not found");
            return;
   ...
   public static class_5024 method_15966(class_1331 var0, class_5024 var1) {
      ...
      if (var4 != null) {
         ...
         if (var5 != null) {
            ...
            int var7 = class_3111.method_14242(var0, var6);
            int var8 = 0;
            boolean var9 = false;
