   ...
   private void method_29151(class_8706 var1) {
      if (this.method_42015() && (mc.field_9632.method_37252() || !this.method_42017().getBooleanValueByName("Sneak"))) {
         if (var1.method_40004() == class_3237.field_16101) {
            ...
            double var12 = mc.field_9632.method_37302() - var6;
            double var14 = mc.field_9632.method_37156() - var10;
            double var16 = mc.field_9632.method_37309() - var8;
            ...
            double var30 = mc.field_9632.method_37302();
            double var32 = mc.field_9632.method_37156();
            double var34 = mc.field_9632.method_37309();
            this.field_32569.clear();
            ...
            for (int var36 = 0; (double)var36 < var22 - 1.0; var36++) {
               ...
               if (mc.field_9601.method_6680(mc.field_9632, var39).count() == 0L) {
                  mc.method_8614().method_4813(new class_9515(var30, var34, var32, true));
               }
            ...
            mc.field_9632.method_37256(var6, var8, var10);
   ...
   public void method_29150(class_3368 var1) {
      if (this.method_42015() && this.field_32569 != null && this.field_32569.size() != 0) {
         ...
         for (class_4714 var5 : this.field_32569) {
            GL11.glVertex3d(
               var5.method_21803() - mc.gameRenderer.method_35949().method_41627().method_61(),
               var5.method_21801() - mc.gameRenderer.method_35949().method_41627().method_60(),
               var5.method_21799() - mc.gameRenderer.method_35949().method_41627().method_62()
            );
         }
         ...
         for (class_4714 var12 : this.field_32569) {
            double var6 = var12.method_21803() - mc.gameRenderer.method_35949().method_41627().method_61();
            double var8 = var12.method_21799() - mc.gameRenderer.method_35949().method_41627().method_62();
            class_8194 var10 = new class_8194(
               var6 - 0.3F,
               var12.method_21801() - mc.gameRenderer.method_35949().method_41627().method_60(),
               var8 - 0.3F,
               var6 + 0.3F,
               var12.method_21801() - mc.gameRenderer.method_35949().method_41627().method_60() + 1.6F,
               var8 + 0.3F
            );
