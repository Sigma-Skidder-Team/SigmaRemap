...
public class NoSlowModule extends Module {
   ...
   private void method_44840(class_1393 var1) {
      if (this.method_42015()) {
         ...
         boolean var5 = mc.field_9632.method_26446() != null && mc.field_9632.method_26446().method_27960() instanceof class_2235;
         if (!var1.method_6449()) {
            if (var5 && mc.gameOptions.keyUse.isKeyDown() && !this.field_49354 && !var4 && this.getStringValueByName("Mode").equals("NCP")) {
            ...
            if (this.field_49354 && !mc.gameOptions.keyUse.isKeyDown()) {
               this.field_49354 = false;
            }
         } else if (this.field_49354 && mc.gameOptions.keyUse.isKeyDown() && !var4) {
            if (var5) {
