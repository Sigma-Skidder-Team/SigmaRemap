...
public class Attributes {
   ...
   public static final class_225 field_37473 = method_33412("generic.armor", new class_806("attribute.name.generic.armor", 0.0, 0.0, 30.0).method_951(true));
   public static final class_225 field_37472 = method_33412(
      "generic.armor_toughness", new class_806("attribute.name.generic.armor_toughness", 0.0, 0.0, 20.0).method_951(true)
   );
   public static final class_225 field_37469 = method_33412("generic.luck", new class_806("attribute.name.generic.luck", 0.0, -1024.0, 1024.0).method_951(true));
   public static final class_225 field_37470 = method_33412(
      "zombie.spawn_reinforcements", new class_806("attribute.name.zombie.spawn_reinforcements", 0.0, 0.0, 1.0)
   );
   public static final class_225 field_37464 = method_33412(
      "horse.jump_strength", new class_806("attribute.name.horse.jump_strength", 0.7, 0.0, 2.0).method_951(true)
   );

   private static class_225 method_33412(String var0, class_225 var1) {
      return class_8669.<class_225>method_39791(class_8669.field_44403, var0, var1);
   }
}
