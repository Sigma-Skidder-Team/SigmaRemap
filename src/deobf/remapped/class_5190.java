      ...
      if (this.field_26705.method_8530() != null) {
         if (var1.method_557() instanceof class_5182) {
            ...
            if (!var4.method_23768().getSiblings().isEmpty()
               ...
               class_7309 var6 = class_727.method_3328().method_3303().method_39912();
               if (var6 != null) {
                  class_5933 var7 = new class_5933(this.field_26705.method_8530().field_12675, new Date(Long.MAX_VALUE));
                  var6.method_33331(var7);
                  class_727.method_3328().method_3303().method_39911(var6);
                  class_727.method_3328().method_3303().method_39909();
               }
            }
         }
         ...
         if (!(var1.method_557() instanceof class_2261)) {
            if (!(var1.method_557() instanceof class_7957)) {
               if (var1.method_557() instanceof class_1490) {
                  ...
                  class_7309 var16 = class_727.method_3328().method_3303().method_39912();
                  if (var16 != null) {
                     var16.method_33331(var15);
                     class_727.method_3328().method_3303().method_39911(var16);
                     class_727.method_3328().method_3303().method_39909();
                  }
               }
            } else {
               ...
               class_7309 var10 = class_727.method_3328().method_3303().method_39912();
               if (var10 != null) {
                  var10.method_33331(var17);
                  class_727.method_3328().method_3303().method_39911(var10);
                  class_727.method_3328().method_3303().method_39909();
               }
            }
         } else {
            ...
            class_7309 var20 = class_727.method_3328().method_3303().method_39912();
            if (var20 != null) {
               var20.method_33331(var18);
               class_727.method_3328().method_3303().method_39911(var20);
               class_727.method_3328().method_3303().method_39909();
            }
         }
      }
