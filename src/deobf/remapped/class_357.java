      ...
      if (var0.exists()) {
         ...
         if (!var5.isEmpty()) {
            try {
               ...
               if (class_727.method_3328().method_3326() != null) {
                  class_727.method_3328().method_3326().method_12862("Error when reading json from config. Continuing, but no preferences will be loaded.");
               }

               var7.printStackTrace();
            }
         } else if (class_727.method_3328().method_3326() != null) {
            class_727.method_3328().method_3326().method_12862("Empty config file");
         }

         var4.close();
      } else {
         if (class_727.method_3328().method_3326() != null) {
            class_727.method_3328().method_3326().method_12863("Config does not exist... creating new config file...");
         }
