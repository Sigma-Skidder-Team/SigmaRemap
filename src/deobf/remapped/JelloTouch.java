...
public class JelloTouch {
   ...
   public boolean method_374() {
      return MinecraftClient.IS_SYSTEM_MAC
         && SigmaMainClass.getInstance().method_3312() == class_6015.field_30645
         && (
   ...
   public void method_375() {
      if (this.method_374()) {
         if (this.field_299 != null) {
            this.field_299.hide(GLFWNativeCocoa.glfwGetCocoaWindow(MinecraftClient.getInstance().window.getHandle()));
         }
         ...
         this.field_299.show(GLFWNativeCocoa.glfwGetCocoaWindow(MinecraftClient.getInstance().window.getHandle()));
         this.field_298 = true;
      }
   }
