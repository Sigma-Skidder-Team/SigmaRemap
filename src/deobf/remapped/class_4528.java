...
public class class_4528 extends DataFix {
   private static final Int2ObjectMap<String> field_22105 = (Int2ObjectMap<String>)DataFixUtils.make(new Int2ObjectOpenHashMap(), var0 -> {
   ...
   public class_4528(Schema var1, boolean var2) {
      super(var1, var2);
   }
   ...
   public TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped(
         "ItemStackEnchantmentFix", var3, var2 -> var2.updateTyped(var4, var1x -> var1x.update(DSL.remainderFinder(), this::method_21043))
      );
   }

   private Dynamic<?> method_21043(Dynamic<?> var1) {
      Optional var4 = var1.get("ench")
         .asStreamOpt()
         .map(var0 -> var0.<Dynamic>map(var0x -> var0x.set("id", var0x.createString((String)field_22105.getOrDefault(var0x.get("id").asInt(0), "null")))))
         .map(var1::createList)
         .result();
      if (var4.isPresent()) {
         var1 = var1.remove("ench").set("Enchantments", (Dynamic)var4.get());
      }
      ...
      return var1.update(
         ...
         var0 -> (Dynamic)DataFixUtils.orElse(
               var0.asStreamOpt()
                  .map(
                     var0x -> var0x.<Dynamic>map(
                           var0xx -> var0xx.set("id", var0xx.createString((String)field_22105.getOrDefault(var0xx.get("id").asInt(0), "null")))
                        )
                  )
                  .map(var0::createList)
                  .result(),
