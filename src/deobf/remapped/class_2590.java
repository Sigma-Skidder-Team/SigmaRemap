...
public class class_2590 extends class_367 {
   ...
   private void method_11764(class_3278 var1) {
      if (this.method_42015() && field_46692.field_9632 != null) {
         if (class_727.method_3328().method_3300().method_9486() && class_727.method_3328().method_3300().field_10297.size() != 0) {
            long var4 = System.nanoTime() - this.field_12812;
            float var6 = Math.min(10.0F, Math.max(0.0F, (float)var4 / 1.810361E7F));
            double var7 = 0.0;
            short var9 = 4750;
            if (class_727.method_3328().method_3300().field_10293.size() == 0) {
               return;
            }

            for (int var10 = 0; var10 < 3; var10++) {
               var7 = Math.max(var7, Math.sqrt(class_727.method_3328().method_3300().field_10293.get(var10)) - 1000.0);
            }
