...
public class class_6470 extends class_2596 {
   ...
   public void method_32178(float var1) {
      ...
      if (class_1893.method_8510().field_9610 != null) {
         ...
         if (!class_727.method_3328().method_3323()) {
            var15 = 0.0F;
         }
         ...
         if (var14 > 0.0F && class_727.method_3328().method_3323()) {
            class_6340.method_29014(var13, 1.0F);
            class_727.method_3328().method_3320(false);
         }
   ...
   public void method_29469() {
      if (this.field_32976 == null) {
         this.method_32102(() -> {
            ...
            this.field_32976.method_8236(var0 -> class_727.method_3328().method_3332().method_23089());
