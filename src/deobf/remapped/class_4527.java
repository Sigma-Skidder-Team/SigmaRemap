...
public class class_4527 {
   private static final Map<String, String> field_22097 = Util.<Map<String, String>>make(Maps.newHashMap(), var0 -> {
   ...
   private static final Map<String, String> field_22101 = Util.<Map<String, String>>make(Maps.newHashMap(), var0 -> {
      var0.put("Iglu", "Igloo");
   ...
   private final Map<String, Long2ObjectMap<CompoundNBT>> field_22103 = Maps.newHashMap();
