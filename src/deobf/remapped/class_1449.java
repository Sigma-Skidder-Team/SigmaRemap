...
public interface class_1449 extends class_6163 {
   ...
   default boolean method_6683(Entity var1, class_4092 var2) {
      return this.method_6672(var1, var2, var0 -> true);
   }

   default boolean method_6672(Entity var1, class_4092 var2, Predicate<Entity> var3) {
      return this.method_6676(var1, var2, var3).allMatch(class_4190::method_19485);
   }

   Stream<class_4190> method_6679(Entity var1, class_4092 var2, Predicate<Entity> var3);

   default Stream<class_4190> method_6676(Entity var1, class_4092 var2, Predicate<Entity> var3) {
      return Stream.<class_4190>concat(this.method_6680(var1, var2), this.method_6679(var1, var2, var3));
   }

   default Stream<class_4190> method_6680(Entity var1, class_4092 var2) {
