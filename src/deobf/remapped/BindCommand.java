      ...
      if (var2.length < 1) {
         ...
         if (var2.length != 1) {
            if (var2.length != 2) {
               ...
               if (var14 != -1) {
                  SigmaMainClass.method_3328().method_3298().method_835().method_368(var14, (Module)var6);
            ...
            int var8 = SigmaMainClass.method_3328().method_3298().method_835().method_381((Module)var6);
            String var9 = null;
