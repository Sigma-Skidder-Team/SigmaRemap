...
public class WaypointsModule extends Module {
   ...
   public List<class_4333> method_42044(List<class_4333> var1) {
      ...
      var4.sort(
         (var0, var1x) -> !(
                  client.thePlayer.method_37273((double)var0.field_21071, (double)var0.field_21077, (double)var0.field_21073)
                     < client.thePlayer.method_37273((double)var1x.field_21071, (double)var1x.field_21077, (double)var1x.field_21073)
               )
               ? -1
               : 1
      );
