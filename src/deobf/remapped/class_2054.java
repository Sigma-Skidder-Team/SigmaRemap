...
public class class_2054 extends DataFix {
   private static final Set<String> field_10382 = ImmutableSet.builder()
      ...
      .build();
   private static final Map<String, String> field_10384 = ImmutableMap.builder()
      ...
      .build();
   private static final Map<String, String> field_10383 = ImmutableMap.builder()
      ...
      .build();
   private static final Map<String, String> field_10386 = ImmutableMap.builder()
      .put("stat.entityKilledBy", "minecraft:killed_by")
      .put("stat.killEntity", "minecraft:killed")
      .build();
   private static final Map<String, String> field_10385 = ImmutableMap.builder()
   ...
   public class_2054(Schema var1, boolean var2) {
      super(var1, var2);
   }
   ...
   public TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped(
         "StatsCounterFix",
         this.getInputSchema().getType(class_4002.field_19452),
         var3,
         var2 -> {
            Dynamic var5 = (Dynamic)var2.get(DSL.remainderFinder());
            HashMap var6 = Maps.newHashMap();
            Optional var7 = var5.getMapValues().result();
            if (!var7.isPresent()) {
               ...
               for (Entry var9 : ((Map)var7.get()).entrySet()) {
                  if (((Dynamic)var9.getValue()).asNumber().result().isPresent()) {
                     String var10 = ((Dynamic)var9.getKey()).asString("");
                     if (!field_10382.contains(var10)) {
                        String var12;
                        String var13;
                        if (!field_10384.containsKey(var10)) {
                           ...
                           if (!"stat.mineBlock".equals(var14)) {
                              if (!field_10383.containsKey(var14)) {
                                 if (!field_10386.containsKey(var14)) {
                                    continue;
                                 }

                                 var12 = field_10386.get(var14);
                                 String var15 = var10.substring(var11 + 1).replace('.', ':');
                                 var13 = field_10385.getOrDefault(var15, var15);
                              } else {
                                 var12 = field_10383.get(var14);
                                 String var19 = var10.substring(var11 + 1).replace('.', ':');
                                 String var16 = this.method_9596(var19);
                                 var13 = var16 != null ? var16 : var19;
                              }
                           } else {
                              var12 = "minecraft:mined";
                              var13 = this.method_9595(var10.substring(var11 + 1).replace('.', ':'));
                           }
                        } else {
                           var12 = "minecraft:custom";
                           var13 = field_10384.get(var10);
                        }
   ...
   @Nullable
   public String method_9596(String var1) {
      return class_2703.method_12195(var1, 0);
   }

   public String method_9595(String var1) {
      return class_8237.method_37726(var1);
   }
}
