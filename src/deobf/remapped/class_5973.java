...
public class class_5973 extends class_3599 {
      ...
      if (this.field_30422.method_41215()) {
         if (!this.field_30422.method_41216()) {
            ...
            if (var3 instanceof PlayerEntity) {
               ...
               BlockPos var4 = this.field_30424.method_37075();
               class_2522 var5 = this.field_30422.world.method_28262(var4);
               if (var5.method_8360().method_29299(class_2351.field_11784)) {
                  this.field_30423 = var5.<Direction>method_10309(class_3633.field_1543)
                     .<BlockPos>map(var1 -> var4.method_6098(var1.method_1046()))
   ...
   public void method_16793() {
      ...
      float var3 = this.field_30422.world.method_13578(1.0F);
      if (this.field_30424.method_3202() >= 100
         && (double)var3 > 0.77
         && (double)var3 < 0.8
         && (double)this.field_30422.world.method_43360().nextFloat() < 0.7) {
         this.method_27275();
      }
   ...
   private void method_27275() {
      ...
      var4.method_13364(this.field_30422.method_37075());
      class_1758 var5 = this.field_30422.world.method_29522().method_1722().method_4604(class_5931.field_30109);
      class_8480 var6 = new class_8480((class_6331)this.field_30422.world)
