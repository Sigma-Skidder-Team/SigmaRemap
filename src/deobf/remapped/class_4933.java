...
public class class_4933 {
   private static final BiMap<Identifier, class_2144> field_25577 = HashBiMap.create();
   ...
   @Nullable
   public static class_2144 method_22626(Identifier var0) {
      return (class_2144)field_25577.get(var0);
   }

   @Nullable
   public static Identifier method_22627(class_2144 var0) {
      return (Identifier)field_25577.inverse().get(var0);
   }
}
