...
public class class_7494 {
   ...
   public static final class_6414 method_34120(BlockPos var0) {
   ...
   public static final class_6414 method_34119(double var0, double var2, double var4) {
      return method_34120(new BlockPos(var0, var2, var4));
   }

   public static boolean method_34117(class_6414 var0, BlockPos var1) {
      ...
      return !method_34090(var1)
         ...
         && var1.getY() <= field_38239.thePlayer.method_37075().getY();
   }

   public static void method_34094(BlockPos var0) {
      double var3 = (double)var0.getX() + 0.5 - MinecraftClient.getInstance().thePlayer.getPosX();
      double var5 = (double)var0.getY()
         + 0.5
         - (MinecraftClient.getInstance().thePlayer.method_37309() + (double) MinecraftClient.getInstance().thePlayer.method_37277());
      double var7 = (double)var0.getZ() + 0.5 - MinecraftClient.getInstance().thePlayer.getPosZ();
      ...
      MinecraftClient.getInstance().thePlayer.rotationYaw = MinecraftClient.getInstance().thePlayer.rotationYaw
         + MathHelper.wrapDegrees(var11 - MinecraftClient.getInstance().thePlayer.rotationYaw);
      MinecraftClient.getInstance().thePlayer.rotationPitch = MinecraftClient.getInstance().thePlayer.rotationPitch
         + MathHelper.wrapDegrees(var12 - MinecraftClient.getInstance().thePlayer.rotationPitch);
   }

   public static void method_34111(BlockPos var0) {
      double var3 = (double)var0.getX() + 0.5 - MinecraftClient.getInstance().thePlayer.getPosX();
      double var5 = (double)var0.getY()
         + 0.5
         - (MinecraftClient.getInstance().thePlayer.method_37309() + (double) MinecraftClient.getInstance().thePlayer.method_37277());
      ...
      MinecraftClient.getInstance()
         ...
         .sendPacket(
            new RotationPacket(
               MinecraftClient.getInstance().thePlayer.rotationYaw + MathHelper.wrapDegrees(var11 - MinecraftClient.getInstance().thePlayer.rotationYaw),
               MinecraftClient.getInstance().thePlayer.rotationPitch + MathHelper.wrapDegrees(var12 - MinecraftClient.getInstance().thePlayer.rotationPitch),
               MinecraftClient.getInstance().thePlayer.onGround
            )
         );
   }

   public static float[] method_34076(BlockPos var0) {
      double var3 = (double)var0.getX() + 0.5 - MinecraftClient.getInstance().thePlayer.getPosX();
      double var5 = (double)var0.getY()
         - 0.25
         - (MinecraftClient.getInstance().thePlayer.method_37309() + (double) MinecraftClient.getInstance().thePlayer.method_37277());
   ...
   public static float[] method_34077(BlockPos var0, Direction var1) {
      float var4 = 0.0F;
      float var5 = 0.0F;
      float var6 = 0.0F;
      switch (var1) {
      ...
      double var7 = (double)var0.getX() + 0.5 - MinecraftClient.getInstance().thePlayer.getPosX() + (double)var4;
      double var9 = (double)var0.getY()
         - 0.02
         - (MinecraftClient.getInstance().thePlayer.method_37309() + (double) MinecraftClient.getInstance().thePlayer.method_37277())
         + (double)var6;
      double var11 = (double)var0.getZ() + 0.5 - MinecraftClient.getInstance().thePlayer.getPosZ() + (double)var5;
      ...
      return new float[]{
         MinecraftClient.getInstance().thePlayer.rotationYaw + MathHelper.wrapDegrees(var15 - MinecraftClient.getInstance().thePlayer.rotationYaw),
         MinecraftClient.getInstance().thePlayer.rotationPitch + MathHelper.wrapDegrees(var16 - MinecraftClient.getInstance().thePlayer.rotationPitch)
      };
   }

   public static float[] method_34097(BlockPos var0, Direction var1) {
      float var4 = 0.0F;
      float var5 = 0.0F;
   ...
   public static float method_34095(BlockPos var0, Direction var1) {
      float var4 = 0.0F;
      float var5 = 0.0F;
      switch (var1) {
         case field_804:
      ...
      double var6 = (double)var0.getX() + 0.5 - MinecraftClient.getInstance().thePlayer.getPosX() + (double)var4;
      double var8 = (double)var0.getZ() + 0.5 - MinecraftClient.getInstance().thePlayer.getPosZ() + (double)var5;
      double var10 = (double)var0.getY()
         - 0.02
         - (MinecraftClient.getInstance().thePlayer.method_37309() + (double) MinecraftClient.getInstance().thePlayer.method_37277())
         + 1.0;
      double var12 = (double)var0.getY()
         - 0.02
         - (MinecraftClient.getInstance().thePlayer.method_37309() + (double) MinecraftClient.getInstance().thePlayer.method_37277());
   ...
   public static List<BlockPos> method_34085(List<BlockPos> var0) {
   ...
   public static float method_34108(Entity var0, BlockPos var1) {
   ...
   public static List<BlockPos> method_34110(float var0) {
         ...
         for (float var5 = -var0; var5 <= var0; var5++) {
            for (float var6 = -var0; var6 <= var0; var6++) {
               BlockPos var7 = new BlockPos(
                  field_38239.thePlayer.getPosX() + (double)var5,
                  field_38239.thePlayer.method_37309() + (double)var4,
                  field_38239.thePlayer.getPosZ() + (double)var6
               );
               var3.add(var7);
            }
         }
   ...
   public static List<BlockPos> method_34109(double var0, double var2, double var4) {
   ...
   public static List<BlockPos> method_34078() {
         ...
         for (float var6 = (float)(-var4); var6 <= (float)var4; var6++) {
            for (float var7 = (float)(-var4); var7 <= (float)var4; var7++) {
               BlockPos var8 = new BlockPos(
                  field_38239.thePlayer.getPosX() + (double)var6,
                  field_38239.thePlayer.method_37309() + (double)var5,
                  field_38239.thePlayer.getPosZ() + (double)var7
               );
   ...
   public static BlockPos method_34083(float var0, float var1, float var2) {
   ...
   public static float[] method_34112() {
      ...
      if (var2.method_33990() != class_1430.field_7721) {
         double var3 = var2.method_33993().field_7336 - (double)var2.method_43955().getX();
         double var5 = var2.method_33993().field_7334 - (double)var2.method_43955().getZ();
         double var7 = var2.method_33993().field_7333 - (double)var2.method_43955().getY();
         double var9 = (double)var2.method_43955().getX() - MinecraftClient.getInstance().thePlayer.getPosX() + var3;
         double var11 = (double)var2.method_43955().getY()
            - (MinecraftClient.getInstance().thePlayer.method_37309() + (double) MinecraftClient.getInstance().thePlayer.method_37277())
            + var7;
         double var13 = (double)var2.method_43955().getZ() - MinecraftClient.getInstance().thePlayer.getPosZ() + var5;
         ...
         return new float[]{
            MinecraftClient.getInstance().thePlayer.rotationYaw + MathHelper.wrapDegrees(var17 - MinecraftClient.getInstance().thePlayer.rotationYaw),
            MinecraftClient.getInstance().thePlayer.rotationPitch + MathHelper.wrapDegrees(var18 - MinecraftClient.getInstance().thePlayer.rotationPitch)
         };
      } else {
         return null;
      }
   ...
   public static class_2899 method_34118(BlockPos var0, boolean var1) {
      ...
      for (class_1724 var9 : var5) {
         for (Vector3i var13 : var4) {
            Vector3i var14 = !var9.field_8903
               ? new Vector3i(var13.getX() * var9.field_8900, var13.getY() * var9.field_8901, var13.getZ() * var9.field_8902)
               : new Vector3i(var13.getX() + var9.field_8900, var13.getY() + var9.field_8901, var13.getZ() + var9.field_8902);
   ...
   public static List<BlockPos> method_34089(BlockPos var0) {
      ArrayList var3 = new ArrayList();
      ...
      for (float var5 = -var4; var5 < 1.0F; var5++) {
         for (float var6 = -var4; var6 <= var4; var6++) {
            for (float var7 = -var4; var7 <= var4; var7++) {
               BlockPos var8 = var0.method_6103((double)var6, (double)var5, (double)var7);
               if (field_38239.thePlayer.method_37309() >= (double)var8.getY()) {
                  var3.add(var8);
               }
            }
         }
   ...
   public static class_2899 method_34091(BlockPos var0, boolean var1, boolean var2) {
   ...
   public static boolean method_34090(BlockPos var0) {
      if (var0 != null) {
   ...
   public static float[] method_34082(float var0, float var1, class_2899 var2) {
      ...
      if (var5 != null && var5.method_43955().equals(var2.field_14163)) {
         ...
         float var17 = var16[0];
         float var18 = var16[1];
         float var19 = Math.abs(class_7211.method_33011(MathHelper.wrapDegrees(var0), MathHelper.wrapDegrees(var14)));
         float var20 = Math.abs(class_7211.method_33011(MathHelper.wrapDegrees(var0), MathHelper.wrapDegrees(var17)));
         return !(var19 < var20) ? new float[]{var17, var18} : new float[]{var14, var15};
      }
   }

   public static Direction method_34113(BlockPos var0) {
      Direction var3 = Direction.field_817;
      float var4 = MathHelper.wrapDegrees(method_34121(var0, Direction.field_817)[0]);
      ...
      if (MathHelper.wrapDegrees(method_34121(var0, Direction.field_817)[1]) > 75.0F
         || MathHelper.wrapDegrees(method_34121(var0, Direction.field_817)[1]) < -75.0F) {
   ...
   public static float[] method_34121(BlockPos var0, Direction var1) {
      double var4 = (double)var0.getX() + 0.5 - field_38239.thePlayer.getPosX() + (double)var1.method_1041() / 2.0;
      double var6 = (double)var0.getZ() + 0.5 - field_38239.thePlayer.getPosZ() + (double)var1.method_1034() / 2.0;
      double var8 = field_38239.thePlayer.method_37309() + (double)field_38239.thePlayer.method_37277() - ((double)var0.getY() + 0.5);
   ...
   private float method_34073(Entity var1, BlockPos var2) {
      float var5 = 6.0F;
