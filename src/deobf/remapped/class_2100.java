         ...
         if (!var9.method_28022() || var8) {
            ...
            if (!((double)var11 < 0.1)) {
               ...
               if (!var2.field_33055) {
                  ...
                  if (var12 || var7.playerAbilities.isCreativeMode && (var9.method_27960() == class_4897.field_25049 || var9.method_27960() == class_4897.field_25013)) {
               ...
               if (!var12 && !var7.playerAbilities.isCreativeMode) {
                  var9.method_27970(1);
                  if (var9.method_28022()) {
