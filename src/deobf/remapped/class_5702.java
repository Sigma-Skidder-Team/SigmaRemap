...
public class class_5702 extends class_2596 {
   ...
   public class_5702() {
      ...
      this.field_28860.method_32100((var0, var1) -> MinecraftClient.getInstance().method_8609(new class_1876()));
   }
   ...
   public void method_32178(float var1) {
      ...
      if (this.field_28864) {
         String var6 = SigmaMainClass.getInstance().getAccountManager().method_23081().field_19615;
