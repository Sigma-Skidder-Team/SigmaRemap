...
public class class_4196 extends class_6414 {
      ...
      if (var2.field_33033.nextInt(4) == 0) {
         ...
         if (var7.method_1029().method_42629() && !var1.<Boolean>method_10313(method_19521(var7))) {
            if (this.method_19523(var2, var3)) {
               class_1331 var19 = var3.method_6098(var7);
               ...
               if (!var21.method_8345()) {
                  ...
                  class_1331 var16 = var19.method_6098(var24);
            ...
            if (var3.method_12165() > 0) {
               class_1331 var9 = var3.method_6100();
   ...
   private boolean method_19523(class_6163 var1, class_1331 var2) {
      byte var5 = 4;
      Iterable var6 = class_1331.method_6075(
         var2.method_12173() - 4, var2.method_12165() - 1, var2.method_12185() - 4, var2.method_12173() + 4, var2.method_12165() + 1, var2.method_12185() + 4
      );
      int var7 = 5;

      for (class_1331 var9 : var6) {
