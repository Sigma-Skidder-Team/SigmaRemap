...
public class class_7267 extends class_5920<LivingEntity> {
   ...
   public boolean method_27088(class_6331 var1, LivingEntity var2) {
      ...
      return var1.method_43360().nextInt(100) == 0
         ...
         && var5.<List<LivingEntity>>method_5138(class_6044.field_30901).get().stream().anyMatch(var0 -> EntityType.field_34276.equals(var0.method_37387()));
   }
