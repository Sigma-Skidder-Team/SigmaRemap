...
public class class_8564 extends class_9785 {
   public static final Map<String, String> field_43800 = ImmutableMap.builder()
      ...
      .build();
   public static final Map<String, String> field_43801 = ImmutableMap.builder()
      ...
      .build();
   public static final Map<String, String> field_43798 = ImmutableMap.builder()
      .putAll(field_43801)
   ...
   public class_8564(Schema var1, boolean var2) {
   ...
   public String method_45177(String var1) {
      ...
      return field_43800.getOrDefault(var1, var1);
   }
}
