...
public class class_6025 implements AutoCloseable, class_4568 {
   ...
   private final Map<class_8816<?>, class_5077<? extends Function<class_8816<Unit>, ?>>> field_30771;
   ...
   public static class_1069<Runnable> method_27494(Runnable var0, long var1, IntSupplier var3) {
      return new class_1069<Runnable>(var1x -> () -> {
            var0.run();
            var1x.method_40495(Unit.INSTANCE);
         }, var1, var3, null);
   }
   ...
   private <T> void method_27486(class_8816<T> var1, Function<class_8816<Unit>, T> var2, long var3, IntSupplier var5, boolean var6) {
   ...
   private <T> void method_27491(class_5077<Function<class_8816<Unit>, T>> var1, class_8816<T> var2) {
   ...
   private <T> class_5077<Function<class_8816<Unit>, T>> method_27487(class_8816<T> var1) {
