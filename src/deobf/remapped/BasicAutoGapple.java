...
public class BasicAutoGapple extends Module {
   ...
   public void method_44975(class_6435 var1) {
      if (this.method_42015()) {
         int var4 = mc.gameOptions.hotbarKeys.length;

         for (int var5 = 0; var5 < var4; var5++) {
            class_5916 var6 = mc.gameOptions.hotbarKeys[var5];
            String var7 = var6.method_27055();
            int var8 = Integer.parseInt(String.valueOf(var7.charAt(var7.length() - 1)));
            if (var1.method_29384() == var6.field_30027.field_17800 && var8 - 1 != mc.field_9632.field_3853.field_36404) {
               this.field_49494 = -1;
               this.field_49495 = 0;
            }
         }
   ...
   public void method_44977(class_5596 var1) {
      if (this.method_42015()) {
         ...
         int var4 = -1;
         if (mc.field_9632.method_26551() <= this.method_42017().getFloatValueByName("Health") * 2.0F) {
         ...
         if (var4 >= 0 || this.field_49494 != -1) {
            if (this.field_49494 >= 0) {
               ...
               if (this.field_49494 != 1) {
                  if (this.field_49494 > 1
                     && mc.field_9632.method_26617(class_2584.field_12791).method_27960() != class_4897.field_25037
                     && mc.field_9632.method_26617(class_2584.field_12791).method_27960() != class_4897.field_24966) {
                     mc.field_9632.field_3853.field_36404 = this.field_49493;
                     this.field_49493 = -1;
                     this.field_49494 = -1;
                  }
               } else {
                  this.field_49493 = mc.field_9632.field_3853.field_36404;
                  mc.field_9632.field_3853.field_36404 = var4;
                  mc.field_9647.method_42129();
                  mc.field_9647.method_42155(mc.field_9632, mc.field_9601, class_2584.field_12791);
               }
            }
         }
      }
   ...
   public void method_44978(PacketEvent var1) {
      if (this.method_42015() && this.field_49494 > 1) {
         ...
         if (var4 instanceof class_8163) {
            ...
            if (var5.method_37454() == mc.field_9632.method_37145()) {
