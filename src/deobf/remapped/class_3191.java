...
public class class_3191 {
   ...
   public static <T extends MobEntity> void method_14684(class_1549 var0, class_1549 var1, T var2, float var3, float var4) {
      ...
      if (var2.method_26432() != class_1736.field_8943) {
         var0.field_8191 = -0.0F + MathHelper.cos(var4 * 0.19F) * 0.5F;
         var1.field_8191 = -1.8849558F + MathHelper.cos(var4 * 0.09F) * 0.15F;
         var0.field_8191 += var7 * 1.2F - var8 * 0.4F;
         var1.field_8191 += var7 * 2.2F - var8 * 0.4F;
      } else {
         var0.field_8191 = -1.8849558F + MathHelper.cos(var4 * 0.09F) * 0.15F;
         var1.field_8191 = -0.0F + MathHelper.cos(var4 * 0.19F) * 0.5F;
   ...
   public static void method_14687(class_1549 var0, class_1549 var1, float var2) {
      var0.field_8185 = var0.field_8185 + MathHelper.cos(var2 * 0.09F) * 0.05F + 0.05F;
      var1.field_8185 = var1.field_8185 - (MathHelper.cos(var2 * 0.09F) * 0.05F + 0.05F);
      var0.field_8191 = var0.field_8191 + MathHelper.sin(var2 * 0.067F) * 0.05F;
      var1.field_8191 = var1.field_8191 - MathHelper.sin(var2 * 0.067F) * 0.05F;
   }
