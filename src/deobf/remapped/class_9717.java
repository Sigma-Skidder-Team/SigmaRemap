         ...
         .method_32150(
            AltManagerMenu.method_9896(
               ...
               new class_2612(
                  ...
                  0,
                  114,
                  (int)((float) MinecraftClient.getInstance().field_9602.method_43166() * AltManagerMenu.method_9905(this.field_49398)) - 4,
                  MinecraftClient.getInstance().field_9602.method_43163() - 119 - AltManagerMenu.method_9894(this.field_49398)
               )
            )
         );
