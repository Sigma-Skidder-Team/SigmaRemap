...
public class class_1198 extends class_3599 {
   ...
   public boolean method_16795() {
      if (this.field_6704.method_3913() == null) {
         return this.field_6704.world.method_29537().method_1285(class_291.field_1047) ? this.field_6704.method_26594().nextInt(20) == 0 : false;
      } else {
         return false;
      }
   }
   ...
   public void method_16794() {
      ...
      int var5 = class_9299.method_42847(this.field_6704.getPosX() - 2.0 + var3.nextDouble() * 4.0);
      int var6 = class_9299.method_42847(this.field_6704.method_37309() + var3.nextDouble() * 3.0);
      int var7 = class_9299.method_42847(this.field_6704.getPosZ() - 2.0 + var3.nextDouble() * 4.0);
      ...
      class_1343 var11 = new class_1343(
         (double)class_9299.method_42847(this.field_6704.getPosX()) + 0.5,
         (double)var6 + 0.5,
         (double)class_9299.method_42847(this.field_6704.getPosZ()) + 0.5
      );
