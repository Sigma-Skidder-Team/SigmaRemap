...
public class class_4731 extends DataFix {
   private static final Map<String, String> field_22926 = (Map<String, String>)DataFixUtils.make(Maps.newHashMap(), var0 -> {
   ...
   public class_4731(Schema var1, boolean var2) {
      super(var1, var2);
   }
   ...
   public TypeRewriteRule makeRule() {
      ...
      Type var5 = this.getInputSchema().getType(class_4002.field_19433);
      Type var6 = this.getOutputSchema().getType(class_4002.field_19433);
      return TypeRewriteRule.seq(
         this.convertUnchecked("item stack entity name hook converter", var5, var6),
         this.fixTypeEverywhere("EntityIdFix", var3, var4, var0 -> var0x -> var0x.mapFirst(var0xx -> field_22926.getOrDefault(var0xx, var0xx)))
      );
   }
}
