   ...
   public void method_9687(class_7767 var1) {
      if (this.method_42015()) {
         ...
         if (this.field_10453 != 1) {
            ...
            var1.method_35235(!mcInstance.field_9577.field_45450.method_27060() ? (!this.field_10452 ? 1.0E-4 : -0.99) : (!this.field_10452 ? 0.99 : 1.0E-4));
            class_8865.method_40777(
               var1, !mcInstance.field_9577.field_45450.method_27060() ? (!this.field_10452 ? 3.7 : 2.8) : (!this.field_10452 ? 2.8 : 3.7)
            );
         }
