...
public class class_1686 extends class_7038 {
   ...
   public class_1686(class_7038 var1, String var2, int var3, int var4, int var5, int var6) {
      ...
      String var21 = var10000.append(class_727.field_3957).append("  -  1.8 to ").append(class_3347.field_16514.method_2045()).toString();
      this.method_32148(
      ...
      this.field_8719.method_32184((var1x, var2x) -> {
         if (class_727.method_3328().method_3332().method_23081() != null) {
      ...
      this.field_8722.method_32100((var1x, var2x) -> {
         if (this.field_8712++ > 8) {
            class_727.method_3328().method_3299().method_30990(new class_3829());
         }
      });
   }
   ...
   public void method_32145(int var1, int var2) {
      this.field_8719.method_32104(!class_727.method_3328().method_3332().method_23084());
      byte var5 = 30;
      byte var6 = 90;
      this.field_8724.method_32175(var6 + (!class_727.method_3328().method_3332().method_23084() ? 202 : 0));
      this.field_8714.method_32175(var5 + (!class_727.method_3328().method_3332().method_23084() ? 202 : 0));
      super.method_32145(var1, var2);
   }

   public void method_7598() {
      class_727.method_3328().method_3315().method_21206("clicksound");
   }
