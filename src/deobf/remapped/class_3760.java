...
public class class_3760 extends class_6414 {
   ...
   public class_3760(class_3073 var1) {
      ...
      this.method_29284(
         this.field_32751
            .method_36446()
            .method_10308(field_18377, Direction.field_818)
   ...
   public class_4190 method_10769(class_2522 var1, class_6163 var2, BlockPos var3, class_214 var4) {
      switch ((Direction)var1.method_10313(field_18377)) {
         case field_804:
         default:
            return field_18374;
         case field_809:
   ...
   public boolean method_10787(class_2522 var1, class_4924 var2, BlockPos var3) {
      Direction var6 = var1.<Direction>method_10313(field_18377);
   ...
   public void method_17424(World var1, BlockPos var2, class_2522 var3, boolean var4, boolean var5, int var6, class_2522 var7) {
      Direction var10 = var3.<Direction>method_10313(field_18377);
      ...
      for (int var17 = 1; var17 < 42; var17++) {
         BlockPos var18 = var2.method_6099(var10, var17);
         class_2522 var19 = var1.method_28262(var18);
         if (var19.method_8350(class_4783.field_23812)) {
            if (var19.<Direction>method_10313(field_18377) == var10.method_1046()) {
               var15 = var17;
            }
            break;
         }
      ...
      if (var15 > 0) {
         BlockPos var25 = var2.method_6099(var10, var15);
         Direction var27 = var10.method_1046();
      ...
      if (var11 != var13) {
         for (int var26 = 1; var26 < var15; var26++) {
            BlockPos var28 = var2.method_6099(var10, var26);
   ...
   private void method_17423(World var1, BlockPos var2, boolean var3, boolean var4, boolean var5, boolean var6) {
      if (var4 && !var6) {
         var1.method_43359((PlayerEntity)null, var2, SoundEvents.field_2588, class_562.field_3322, 0.4F, 0.6F);
      } else if (!var4 && var6) {
         var1.method_43359((PlayerEntity)null, var2, SoundEvents.field_2873, class_562.field_3322, 0.4F, 0.5F);
      } else if (var3 && !var5) {
         var1.method_43359((PlayerEntity)null, var2, SoundEvents.field_2480, class_562.field_3322, 0.4F, 0.7F);
      } else if (!var3 && var5) {
         var1.method_43359((PlayerEntity)null, var2, SoundEvents.field_2628, class_562.field_3322, 0.4F, 1.2F / (var1.field_33033.nextFloat() * 0.2F + 0.9F));
      }
   }

   private void method_17425(World var1, BlockPos var2, Direction var3) {
   ...
   public void method_10761(class_2522 var1, World var2, BlockPos var3, class_2522 var4, boolean var5) {
      if (!var5 && !var1.method_8350(var4.method_8360())) {
         ...
         if (var9) {
            ...
            var2.method_29563(var3.method_6098(var1.<Direction>method_10313(field_18377).method_1046()), this);
         }
   ...
   public class_2522 method_10785(class_2522 var1, class_6631 var2) {
      return var1.method_10308(field_18377, var2.method_30489(var1.<Direction>method_10313(field_18377)));
   }

   @Override
   public class_2522 method_10773(class_2522 var1, class_9022 var2) {
      return var1.method_8318(var2.method_41390(var1.<Direction>method_10313(field_18377)));
   }
