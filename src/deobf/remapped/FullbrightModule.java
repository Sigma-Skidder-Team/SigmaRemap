...
public class FullbrightModule extends Module {
   ...
   public void method_42012() {
      if (!this.method_42015()) {
         mcInstance.gameOptions.brightnessGamma = 1.0;
      }
   }
   ...
   public void onEnable() {
      if (this.getStringValueByName("Type").equals("Normal")) {
         mcInstance.gameOptions.brightnessGamma = 999.0;
      }
   }
         ...
         if (mcInstance.field_9601 != null) {
            if (!this.getStringValueByName("Type").equals("Normal")) {
               ...
               if (!(this.field_4691 < 1.5F)) {
                  mcInstance.gameOptions.brightnessGamma = (double)Math.min(Math.max(1.0F, this.field_4691), 10.0F);
               }
            }
         }
      }
