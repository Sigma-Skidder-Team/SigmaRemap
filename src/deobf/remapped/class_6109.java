...
public class class_6109 extends class_5920<LivingEntity> {
   private static String[] field_31246;
   private final Predicate<LivingEntity> field_31248;
   ...
   public class_6109(Predicate<LivingEntity> var1, float var2) {
   ...
   public boolean method_27088(class_6331 var1, LivingEntity var2) {
      return var2.method_26525().<List<LivingEntity>>method_5138(class_6044.field_30901).get().stream().anyMatch(this.field_31248);
   }
