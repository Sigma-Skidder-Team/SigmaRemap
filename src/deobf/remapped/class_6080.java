...
public class class_6080 {
   ...
   public class_1893 field_31116 = class_1893.method_8510();
   ...
   private void method_27845(class_3278 var1) {
      if (!class_1893.method_8510().field_9577.field_45567) {
         this.field_31115 = Math.max(Math.round((float)(6 - class_1893.method_8501() / 10)), 1);

         for (int var4 = 0; var4 < this.field_31118.size(); var4++) {
            class_8235 var5 = this.field_31118.get(var4);
            float var6 = this.method_27838(var5);
            int var7 = class_1893.method_8510().field_9602.method_43166() - this.field_31113 - (int)((float)this.field_31110 * var6 * var6);
   ...
   private void method_27839() {
      for (int var3 = 0; var3 < this.field_31118.size(); var3++) {
         ...
         int var6 = class_1893.method_8510().field_9602.method_43166() - this.field_31113 - (int)((float)this.field_31110 * var5 * var5);
