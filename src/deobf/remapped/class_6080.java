...
public class class_6080 {
   ...
   private List<Notification> field_31118 = new ArrayList<Notification>();
   ...
   public float method_27838(Notification var1) {
   ...
   private void method_27845(class_3278 var1) {
      if (!MinecraftClient.getInstance().gameOptions.hideGUI) {
         ...
         for (int var4 = 0; var4 < this.field_31118.size(); var4++) {
            Notification var5 = this.field_31118.get(var4);
   ...
   private void method_27839() {
      for (int var3 = 0; var3 < this.field_31118.size(); var3++) {
         Notification var4 = this.field_31118.get(var3);
