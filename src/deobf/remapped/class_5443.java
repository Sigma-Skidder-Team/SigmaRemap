...
public class class_5443<E extends MobEntity> extends class_5920<E> {
   ...
   private final Predicate<LivingEntity> field_27719;

   public class_5443(Predicate<LivingEntity> var1) {
   ...
   private LivingEntity method_24798(E var1) {
      return var1.method_26525().<LivingEntity>method_5138(class_6044.field_30884).get();
   }

   private static <E extends LivingEntity> boolean method_24799(E var0) {
   ...
   private boolean method_24797(E var1) {
      Optional var4 = var1.method_26525().<LivingEntity>method_5138(class_6044.field_30884);
