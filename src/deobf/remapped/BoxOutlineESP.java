         ...
         mc.field_9601
            ...
            .forEach(
               (var1, var2) -> {
                  ...
                  if (!SigmaMainClass.getInstance().method_3331().method_20495(var2) && var5 && var6 && var2 != mc.field_9632) {
   ...
   private void method_18558(boolean var1) {
      for (Entity var5 : mc.field_9601.method_736()) {
         if (!SigmaMainClass.getInstance().method_3331().method_20495(var5)) {
            ...
            if ((var7 || var6 || var8) && var9 && var5 != mc.field_9632) {
               GL11.glPushMatrix();
               GL11.glTranslated(
               ...
               double var11 = (var5.method_37302() - var5.field_41754) * (double) mc.field_9616.field_32600 - (var5.method_37302() - var5.field_41754);
               double var13 = (var5.method_37309() - var5.field_41713) * (double) mc.field_9616.field_32600 - (var5.method_37309() - var5.field_41713);
               double var15 = (var5.method_37156() - var5.field_41724) * (double) mc.field_9616.field_32600 - (var5.method_37156() - var5.field_41724);
