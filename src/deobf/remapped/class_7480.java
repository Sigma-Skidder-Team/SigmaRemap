...
public class class_7480 extends Module {
   ...
   public void onEnable() {
      ...
      double var6 = mc.field_9632.method_37245().field_7333 - (double)((int) mc.field_9632.method_37245().field_7333);
      ...
      this.field_38165 = (double)((int) mc.field_9632.method_37245().field_7333) + var3;
      mc.field_9632.method_37256(mc.field_9632.method_37245().field_7336, this.field_38165, mc.field_9632.method_37245().field_7334);
   }

   @Override
   public void onDisable() {
      class_8865.method_40776(0.2);
      if (mc.field_9632.method_37098().field_7333 > 0.03) {
   ...
   public void method_34006(class_717 var1) {
      ...
      double var7 = mc.field_9632.method_37245().field_7333 - (double)((int) mc.field_9632.method_37245().field_7333);
      ...
      this.field_38165 = (double)((int) mc.field_9632.method_37245().field_7333) + var4;
      mc.field_9632.method_37256(mc.field_9632.method_37245().field_7336, this.field_38165, mc.field_9632.method_37245().field_7334);
   }
   ...
   public void method_34005(class_7767 var1) {
      ...
      if (this.field_38166 != 1) {
         if (this.field_38166 > 1) {
            mc.field_9632
               .method_37256(mc.field_9632.method_37245().field_7336, this.field_38165, mc.field_9632.method_37245().field_7334);
            double var4 = !mc.gameOptions.keySneak.isKeyDown() ? 0.405 + (double)class_8865.method_40770() * 0.02 : 0.25;
            class_8865.method_40777(var1, var4);
            this.field_38166 = 0;
         }
      } else {
         if (mc.gameOptions.keyJump.isKeyDown() && this.field_38168 == 0) {
         ...
         double var6 = !mc.gameOptions.keySneak.isKeyDown() ? 0.6 : 0.25;
