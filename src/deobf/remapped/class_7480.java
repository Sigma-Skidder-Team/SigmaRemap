   ...
   public void method_34005(class_7767 var1) {
      ...
      if (this.field_38166 != 1) {
         if (this.field_38166 > 1) {
            ...
            double var4 = !mcInstance.gameOptions.keySneak.isKeyDown() ? 0.405 + (double)class_8865.method_40770() * 0.02 : 0.25;
            class_8865.method_40777(var1, var4);
            this.field_38166 = 0;
         }
      } else {
         if (mcInstance.gameOptions.keyJump.isKeyDown() && this.field_38168 == 0) {
         ...
         double var6 = !mcInstance.gameOptions.keySneak.isKeyDown() ? 0.6 : 0.25;
