...
public class WaterAvoidingRandomWalkingGoal extends class_8285 {
   private static String[] field_14137;
   public final float field_14136;

   public WaterAvoidingRandomWalkingGoal(class_4612 var1, double var2) {
      this(var1, var2, 0.001F);
   }

   public WaterAvoidingRandomWalkingGoal(class_4612 var1, double var2, float var4) {
      super(var1, var2);
