      ...
      if (var2.length == 0) {
         ...
         for (int var6 = 0; (double)var6 < 80.0 + 40.0 * (var2[0].method_24062() - 0.5); var6++) {
            field_18219.method_8614()
               .sendPacket(
                  new class_9515(
                     field_18219.thePlayer.getPosX(), field_18219.thePlayer.method_37309() + 0.06, field_18219.thePlayer.getPosZ(), false
                  )
               );
            field_18219.method_8614()
               .sendPacket(
                  new class_9515(field_18219.thePlayer.getPosX(), field_18219.thePlayer.method_37309(), field_18219.thePlayer.getPosZ(), false)
               );
         }
         ...
         field_18219.method_8614()
            .sendPacket(
               new class_9515(field_18219.thePlayer.getPosX(), field_18219.thePlayer.method_37309() + 0.02, field_18219.thePlayer.getPosZ(), false)
            );
