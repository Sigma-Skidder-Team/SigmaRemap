...
public class class_8948 extends DataFix {
   private static final Map<String, String> field_45869 = ImmutableMap.builder()
      .put("structure_references", field_45868[3])
      .put("biomes", field_45868[3])
      .put("base", "surface")
      .put("carved", "carvers")
   ...
   public class_8948(Schema var1, boolean var2) {
      super(var1, var2);
   }
   ...
   public TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped(
         "ChunkStatusFix2", var3, this.getOutputSchema().getType(class_4002.field_19449), var1 -> var1.updateTyped(var5, var0x -> {
               Dynamic var3x = (Dynamic)var0x.get(DSL.remainderFinder());
               String var4x = var3x.get("Status").asString("empty");
               String var5x = field_45869.getOrDefault(var4x, "empty");
