...
public class class_1275 implements class_1517 {
   ...
   private boolean method_5715(class_6331 var1) {
      for (class_704 var5 : var1.method_25873()) {
         if (!var5.method_37221()) {
            class_1331 var6 = var5.method_37075();
            if (var1.method_28994(var6) && var1.method_22561(var6).method_28887() != class_8862.field_45296) {
               for (int var7 = 0; var7 < 10; var7++) {
                  ...
                  if (this.method_5713(var1, new class_1331(this.field_7017, this.field_7015, this.field_7012)) != null) {
                     this.field_7013 = 0;
                     this.field_7016 = 20;
                     break;
                  }
   ...
   private void method_5716(class_6331 var1) {
      class_1343 var4 = this.method_5713(var1, new class_1331(this.field_7017, this.field_7015, this.field_7012));
      if (var4 != null) {
         class_2811 var5;
         try {
   ...
   @Nullable
   private class_1343 method_5713(class_6331 var1, class_1331 var2) {
      for (int var5 = 0; var5 < 10; var5++) {
         ...
         class_1331 var9 = new class_1331(var6, var8, var7);
