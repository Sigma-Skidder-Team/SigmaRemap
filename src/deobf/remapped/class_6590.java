...
public class class_6590 {
   ...
   public void method_30349() {
      for (class_3841 var4 : this.field_34003) {
         MinecraftClient.getInstance().field_9601.method_29594(var4.field_18753, var4.field_18752);
      }
   ...
   public class_2522 method_30352(class_1331 var1) {
      if (!this.field_34001.containsKey(var1)) {
         return !this.field_33996.containsKey(var1) ? MinecraftClient.getInstance().field_9601.method_28262(var1) : this.field_33996.get(var1);
      } else {
