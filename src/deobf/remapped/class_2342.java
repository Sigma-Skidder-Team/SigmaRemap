...
public class class_2342 extends class_2895 {
   public static final Map<String, String> field_11687 = ImmutableMap.builder()
   ...
   public class_2342(Schema var1, boolean var2) {
      super(var1, var2, "Biomes fix", field_11687);
   }
}
