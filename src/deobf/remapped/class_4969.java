...
public class class_4969 extends Module {
   ...
   private void method_22829(class_5596 var1) {
      if (this.method_42015() && field_46692.field_9632 != null && field_46692.field_9601 != null) {
         this.field_25741++;
         if ((double)field_25738 < field_46692.field_9632.method_37309() && field_46692.field_9632.field_41726) {
            field_25738 += 0.5F;
         }
         ...
         if (this.field_25741 >= 1) {
            ...
            for (int var5 = -this.field_25729 / 2; var5 < this.field_25729 / 2; var5++) {
               for (int var6 = -this.field_25729 / 2; var6 < this.field_25729 / 2; var6++) {
                  var4.add(field_46692.field_9601.method_29554(field_46692.field_9632.field_41742 + var5, field_46692.field_9632.field_41714 + var6));
               }
            }
            ...
            while (var11.hasNext()) {
               ...
               int var7 = var12.field_22373.method_27352().method_9549(new class_2034(field_46692.field_9632.field_41742, field_46692.field_9632.field_41714));
               if (var7 > 7) {
                  var11.remove();
               }
            }
            ...
            this.field_25736 = (field_46692.field_9632.method_37302() - (double)(field_46692.field_9632.field_41742 * 16)) / 16.0;
            this.field_25734 = (field_46692.field_9632.method_37156() - (double)(field_46692.field_9632.field_41714 * 16)) / 16.0;
            this.field_25730 = this.method_22831(this.field_25739);
            this.field_25727 = field_46692.field_9632.method_37075();
            this.field_25741 = 0;
         }
      }
   }
            ...
            if (!MinecraftClient.getInstance().field_9577.field_45470) {
               if (!MinecraftClient.getInstance().field_9577.field_45567) {
                  ...
                  if (var4 != null) {
                     ...
                     GL11.glRotatef(90.0F - field_46692.field_9632.field_41701, 0.0F, 0.0F, 1.0F);
                     ...
                     GL11.glRotatef((float)(270 + var15) - field_46692.field_9632.field_41701, 0.0F, 0.0F, 1.0F);
