...
public class class_3962 extends class_5920<class_5834> {
   ...
   private Optional<class_1331> field_19192 = Optional.<class_1331>empty();
   ...
   public boolean method_27088(class_6331 var1, class_5834 var2) {
      ...
      if (var5.isPresent() && ((class_1331)var5.get()).method_12170(var2.method_37245(), (double)this.field_19190)) {
         this.field_19192 = var5;
      } else {
         this.field_19192 = Optional.<class_1331>empty();
      }
   ...
   public void method_27080(class_6331 var1, class_5834 var2, long var3) {
      ...
      if (!var8.isPresent()) {
         ...
         if (!var8.isPresent()) {
            ...
            if (var9.isPresent()) {
               var8 = Optional.<class_1331>of(((class_8150)var9.get()).method_37409());
            }
         }
      }
      ...
      if (var8.isPresent()) {
         ...
         var7.method_5105(class_6044.field_30899, class_8150.method_37410(var1.method_29545(), (class_1331)var8.get()));
         if (!((class_1331)var8.get()).method_12170(var2.method_37245(), (double)this.field_19190)) {
            var7.method_5105(class_6044.field_30889, new class_6651((class_1331)var8.get(), this.field_19191, this.field_19190));
         }
      }
   }
}
