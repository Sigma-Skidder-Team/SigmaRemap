...
public class class_5674<E extends class_5834, T extends class_8145> extends class_5920<E> {
   private static String[] field_28761;
   private final int field_28760;
   private final BiPredicate<E, class_8145> field_28759;

   public class_5674(int var1, BiPredicate<E, class_8145> var2) {
   ...
   public boolean method_27088(class_6331 var1, E var2) {
      class_8145 var5 = var2.method_37243();
      class_8145 var6 = var2.method_26525().<class_8145>method_5138(class_6044.field_30903).orElse((class_8145)null);
      if (var5 == null && var6 == null) {
         return false;
      } else {
         class_8145 var7 = var5 != null ? var5 : var6;
         return !this.method_25659((E)var2, var7) || this.field_28759.test((E)var2, var7);
      }
   }

   private boolean method_25659(E var1, class_8145 var2) {
