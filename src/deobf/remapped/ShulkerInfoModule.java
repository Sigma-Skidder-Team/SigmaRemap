...
public class ShulkerInfoModule extends Module {
         ...
         for (Entity var5 : class_314.method_1440()) {
            if (var5 instanceof class_91) {
               ...
               if (this.method_31556(var6)) {
                  double var7 = class_9189.method_42357(var5).field_42648 - mc.gameRenderer.method_35949().method_41627().method_61();
                  double var9 = class_9189.method_42357(var5).field_42646 - mc.gameRenderer.method_35949().method_41627().method_60();
                  double var11 = class_9189.method_42357(var5).field_42649 - mc.gameRenderer.method_35949().method_41627().method_62();
                  float var13 = 0.3F;
                  GL11.glEnable(3042);
                  ...
                  GL11.glDisable(3042);
                  if (mc.gameOptions.keyUse.isKeyDown()) {
                     mc.gameOptions.keyUse.pressed = false;
   ...
   public boolean method_31556(class_91 var1) {
      if (mc.field_9632.method_37175(var1) > 5.0F) {
         return false;
      } else {
         float var4 = (float)Math.sqrt(6.0 / class_9189.method_42352(var1));
         float var5 = 10.0F * var4;
         double var6 = var1.method_37302() - mc.field_9632.method_37302();
         double var8 = var1.method_37309() - mc.field_9632.method_37309() - (double) mc.field_9632.method_37074() + 0.4F;
         double var10 = var1.method_37156() - mc.field_9632.method_37156();
         double var12 = (double)class_9299.method_42842(var6 * var6 + var10 * var10);
         float var14 = class_7211.method_33002(mc.field_9632.field_41701, (float)(Math.atan2(var10, var6) * 180.0 / Math.PI) - 90.0F, 360.0F);
         float var15 = class_7211.method_33002(mc.field_9632.field_41755, (float)(-(Math.atan2(var8, var12) * 180.0 / Math.PI)), 360.0F);
         return this.method_31550(mc.field_9632.field_41701, var14) <= var5 && this.method_31550(mc.field_9632.field_41755, var15) <= var5;
      }
   }
   ...
   public void method_31552(double var1, double var3, double var5, Entity var7, float var8) {
      ...
      float var13 = (float)(var1 - mc.gameRenderer.method_35949().method_41627().method_61());
      float var14 = (float)(var3 - mc.gameRenderer.method_35949().method_41627().method_60());
      float var15 = (float)(var5 - mc.gameRenderer.method_35949().method_41627().method_62());
   ...
   private void method_31551(class_2532 var1) {
      if (this.method_42015()) {
         if (mc.field_9623 instanceof class_2208) {
            class_2208 var4 = (class_2208) mc.field_9623;
   ...
   private void method_31549(int var1, int var2, List<class_6098> var3, String var4, boolean var5) {
      ...
      for (int var23 = 0; var23 < var3.size(); var23++) {
         ...
         if (var23 == this.field_35424 && var5) {
            class_3542.method_16487();
            int var29 = mc.textRenderer.method_45395(var24.method_28008().getUnformattedComponentText());
            List var32 = this.method_31554(var24);

            for (int var20 = 0; var20 < var32.size(); var20++) {
               var29 = Math.max(var29, mc.textRenderer.method_45395((String)var32.get(var20)));
            }
   ...
   public List<String> method_31554(class_6098 var1) {
      List var4 = var1.method_28012(mc.field_9632, !mc.gameOptions.field_45482 ? class_2575.field_12746 : class_2575.field_12747);
