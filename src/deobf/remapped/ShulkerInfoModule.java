...
public class ShulkerInfoModule extends Module {
   ...
   public boolean method_31556(class_91 var1) {
      if (client.thePlayer.method_37175(var1) > 5.0F) {
         ...
         float var14 = class_7211.method_33002(client.thePlayer.field_41701, (float)(Math.atan2(var10, var6) * 180.0 / Math.PI) - 90.0F, 360.0F);
         float var15 = class_7211.method_33002(client.thePlayer.field_41755, (float)(-(Math.atan2(var8, var12) * 180.0 / Math.PI)), 360.0F);
         return this.method_31550(client.thePlayer.field_41701, var14) <= var5 && this.method_31550(client.thePlayer.field_41755, var15) <= var5;
      }
   }
