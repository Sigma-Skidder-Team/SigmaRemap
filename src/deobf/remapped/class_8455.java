...
public class class_8455 {
   private final class_1893 field_43225;
   ...
   public class_8455(class_1893 var1) {
   ...
   private boolean method_38886(int var1) {
      if (this.field_43229 > 0L && this.field_43229 < class_9665.method_44650() - 100L) {
         ...
         switch (var1) {
               ...
               class_1013.field_5250
                  .method_38567(
                     ...
                     class_9299.method_42827(
                        (double)(this.field_43225.field_9577.field_45537 + (class_266.method_1190() ? -1 : 1)),
            ...
            case 73:
               if (!this.field_43225.field_9632.method_3179()) {
                  this.method_38890(this.field_43225.field_9632.method_37163(2), !class_266.method_1190());
               }

               return true;
            case 76:
               class_1893 var6 = class_3111.method_14327();
            ...
            case 79:
               if (class_3111.method_14424()) {
                  class_708 var10 = new class_708((class_266)null, class_3111.method_14310());
   ...
   public void method_38889(long var1, int var3, int var4, int var5, int var6) {
      if (var1 == this.field_43225.method_8552().method_43181()) {
         ...
         if (this.field_43229 <= 0L) {
            if (class_9732.method_44934(class_1893.method_8510().method_8552().method_43181(), 67)
               && class_9732.method_44934(class_1893.method_8510().method_8552().method_43181(), 292)) {
               this.field_43227 = true;
               this.field_43229 = class_9665.method_44650();
               this.field_43224 = class_9665.method_44650();
               this.field_43230 = 0L;
            }
         } else if (!class_9732.method_44934(class_1893.method_8510().method_8552().method_43181(), 67)
            || !class_9732.method_44934(class_1893.method_8510().method_8552().method_43181(), 292)) {
            this.field_43229 = -1L;
         }

         class_266 var15 = this.field_43225.field_9623;
         ...
         if (var5 != 0 && var3 == 66 && class_266.method_1185() && var10) {
         ...
         if (this.field_43225.field_9623 == null || this.field_43225.field_9623.field_951) {
            ...
            if (var5 != 0) {
               ...
               if (this.field_43225.field_9623 == null) {
                  if (var3 == 256) {
                     boolean var13 = class_9732.method_44934(class_1893.method_8510().method_8552().method_43181(), 292);
                     this.field_43225.method_8597(var13);
                  }

                  var12 = class_9732.method_44934(class_1893.method_8510().method_8552().method_43181(), 292) && this.method_38886(var3);
               ...
               if (var3 == 292) {
                  if (!this.field_43227) {
                     ...
                     this.field_43225.field_9577.field_45471 = this.field_43225.field_9577.field_45470 && class_266.method_1190();
                     this.field_43225.field_9577.field_45549 = this.field_43225.field_9577.field_45470 && class_266.method_1169();
   ...
   private void method_38884(long var1, int var3, int var4) {
      if (var1 == this.field_43225.method_8552().method_43181()) {
         ...
         class_266 var7 = this.field_43225.field_9623;
