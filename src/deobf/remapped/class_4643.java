...
public class class_4643 extends class_6220 {
   ...
   public void method_32178(float var1) {
      ...
      byte var5 = 40;
      float var6 = -class_3778.field_18442 / (float) MinecraftClient.method_8510().field_9602.method_43166();
      float var7 = -class_3778.field_18444 / (float) MinecraftClient.method_8510().field_9602.method_43163();
      class_73.method_96(
         (float)var5 * var6,
         (float)var5 * var7,
         (float)(MinecraftClient.method_8510().field_9602.method_43166() + var5),
         (float)(MinecraftClient.method_8510().field_9602.method_43163() + var5),
