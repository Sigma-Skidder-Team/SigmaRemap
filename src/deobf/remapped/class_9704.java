...
public class class_9704 extends Module {
   ...
   private void method_44840(class_1393 var1) {
      if (this.method_42015()) {
         ...
         if (!var1.method_6449()) {
            if (var5 && mcInstance.gameOptions.keyUse.isKeyDown() && !this.field_49354 && !var4 && this.getStringValueByName("Mode").equals("NCP")) {
            ...
            if (this.field_49354 && !mcInstance.gameOptions.keyUse.isKeyDown()) {
               this.field_49354 = false;
            }
         } else if (this.field_49354 && mcInstance.gameOptions.keyUse.isKeyDown() && !var4) {
            if (var5) {
