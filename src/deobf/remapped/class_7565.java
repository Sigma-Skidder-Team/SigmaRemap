...
public class class_7565 extends class_367 {
   ...
   private void method_34401(class_1711 var1) {
      if (this.field_38555 != null) {
         ...
         switch (var4) {
            case "Center":
               this.field_38545 = class_1893.method_8510().field_9602.method_43166() / 2 - this.field_38556 / 2;
               this.field_38544 = class_1893.method_8510().field_9602.method_43163() / 2 + 40;
               break;
            case "Bottom":
               this.field_38545 = class_1893.method_8510().field_9602.method_43166() / 2 - this.field_38556 / 2;
               this.field_38544 = class_1893.method_8510().field_9602.method_43163() - 200;
         }
   ...
   private void method_34397(int var1) {
      if (field_46692.field_9623 == null || field_46692.field_9623 instanceof class_5766) {
         ...
         class_6122 var4 = class_1893.method_8510().method_8587();
         ...
         class_3758 var12 = class_1893.method_8510().method_8589().method_13796();
