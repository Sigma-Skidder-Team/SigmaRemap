...
public class BreadcrumbsModule extends Module {
   private List<Vector3d> field_13172 = new ArrayList<Vector3d>();
   ...
   public void method_12071(class_7767 var1) {
      if (this.isEnabled()) {
         if (var1.method_35234() != 0.0 || var1.method_35236() != 0.0 || var1.method_35231() != 0.0) {
            this.field_13172
               .add(new Vector3d(client.thePlayer.getPosX(), client.thePlayer.method_37309(), client.thePlayer.getPosZ()));
         }
      }
   }
   ...
   public Vector3d method_12072(Vector3d var1) {
   ...
   public void method_12069(class_3368 var1) {
      if (this.isEnabled()) {
         ...
         for (Vector3d var6 : this.field_13172) {
            Vector3d var7 = this.method_12072(var6);
         ...
         Vector3d var12 = this.method_12072(var4);
