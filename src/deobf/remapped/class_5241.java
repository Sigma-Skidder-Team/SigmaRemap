...
public class class_5241 extends DataFix {
   private static final ImmutableMap<String, Pair<String, ImmutableMap<String, String>>> field_26855 = ImmutableMap.builder()
      .put(
         "EndCity",
         Pair.of(
            "ECP",
   ...
   public class_5241(Schema var1, boolean var2) {
      super(var1, var2);
   }
   ...
   public TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped(
         ...
         var3,
         var2 -> var2.updateTyped(
               var4, var2x -> var2x.update(DSL.remainderFinder(), var2xx -> this.method_23983((Dynamic<?>)var2.get(DSL.remainderFinder()), var2xx))
            )
      );
   }

   private Dynamic<?> method_23983(Dynamic<?> var1, Dynamic<?> var2) {
      String var5 = var1.get("id").asString("");
      if (field_26855.containsKey(var5)) {
         Pair var6 = (Pair)field_26855.get(var5);
         if (((String)var6.getFirst()).equals(var2.get("id").asString(""))) {
            String var7 = var2.get("Template").asString("");
            var2 = var2.set("Template", var2.createString((String)((ImmutableMap)var6.getSecond()).getOrDefault(var7, var7)));
         }
      }
