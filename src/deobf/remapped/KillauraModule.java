...
public class KillauraModule extends Module {
   ...
   public void onEnable() {
      ...
      this.field_12570 = 0;
      field_12551 = 0;
      this.field_12569 = new class_1988(mc.field_9632.field_30535, mc.field_9632.field_30524);
      this.field_12567 = new class_1988(mc.field_9632.field_41701, mc.field_9632.field_41755);
      field_12563 = new class_1988(mc.field_9632.field_41701, mc.field_9632.field_41755);
      this.field_12562 = -1.0F;
      this.field_12561
         .method_40099(
            mc.field_9632.method_26617(class_2584.field_12791).method_27960() instanceof class_2235
               && mc.gameOptions.keyUse.isKeyDown()
         );
   ...
   public void method_11535(class_4996 var1) {
      if (this.method_42015()) {
         if (!this.getStringValueByName("Autoblock Mode").equals("None")
            && (mc.field_9632.method_26446().method_27960() instanceof class_2235 || this.field_12565 != mc.field_9632.field_3853.field_36404)
            && field_12558 != null) {
            var1.method_29715(true);
         } else if (mc.field_9632.method_26446().method_27960() instanceof class_2235) {
            this.field_12555 = 2;
         }
      }
   }
   ...
   public void method_11549(class_1393 var1) {
      if (this.method_42015() && mc.field_9632 != null) {
         if (!var1.method_6449()) {
            this.field_12565 = mc.field_9632.field_3853.field_36404;
            ...
            if (this.field_12561.method_40094() && (!(mc.field_9632.method_26446().method_27960() instanceof class_2235) || field_12558 == null)) {
            ...
            if (this.field_12560 != null && !this.field_12560.isEmpty()) {
               ...
               this.method_11545();
               if (var1.method_6442() - mc.field_9632.field_41701 != 0.0F) {
               ...
               float var7 = !((double) mc.field_9632.method_3163() < 1.26) && this.getBooleanValueByName("Cooldown")
                  ? mc.field_9632.method_3203(0.0F)
                  : 1.0F;
   ...
   public void method_11551(class_3278 var1) {
      if (field_12556 != null && !this.getBooleanValueByName("Silent") && !this.getStringValueByName("Rotation Mode").equals("None")) {
         float var4 = class_9299.method_42810(
            this.field_12569.field_10069 + (this.field_12567.field_10069 - this.field_12569.field_10069) * mc.method_8554()
         );
         float var5 = class_9299.method_42810(
            this.field_12569.field_10067 + (this.field_12567.field_10067 - this.field_12569.field_10067) * mc.method_8554()
         );
         mc.field_9632.field_41701 = var4;
         mc.field_9632.field_41755 = var5;
      }
   }
   ...
   public void method_11537(PacketEvent var1) {
      ...
      if (!(var4 instanceof class_527)) {
         if (var4 instanceof class_295) {
            ...
            if (var5.method_1329() == 3 && this.field_12561.field_44743.containsKey(var5.method_1331(mc.field_9601))) {
               this.field_12561.field_44743.remove(var5.method_1331(mc.field_9601));
            }
         }
      } else {
         ...
         if (var11.method_2565() && (var11.field_3209 != 0 || var11.field_3213 != 0 || var11.field_3207 != 0)) {
            for (Entry var7 : this.field_12561.field_44743.entrySet()) {
               ...
               if (var11.method_2564(mc.field_9601) == var8) {
   ...
   public boolean method_11555() {
      return field_12558 != null
         && mc.field_9632.method_26446() != null
         && mc.field_9632.method_26446().method_27960() instanceof class_2235
   ...
   public void method_11542(class_1393 var1, String var2, boolean var3) {
      ...
      if (this.field_12553 == 0 && this.field_12545 >= 1 && StepModule.field_20352 > 1) {
         ...
         this.field_12553 = 0;
         var8 = false;
         if (var2.equals("Hypixel") && this.field_12550 != null && mc.field_9632.method_37098().field_7333 < 0.0) {
            mc.method_8614().method_4813(new class_9515(this.field_12550[0], this.field_12550[1], this.field_12550[2], false));
      ...
      if (!var9) {
         ...
         this.field_12545++;
         if ((
               !SigmaMainClass.getInstance().getModuleManager().method_847(SpeedModule.class).method_42015()
                  || SigmaMainClass.getInstance().getModuleManager().method_847(SpeedModule.class).getStringValueByName("Type").equalsIgnoreCase("Cubecraft")
                  || SigmaMainClass.getInstance().getModuleManager().method_847(SpeedModule.class).getStringValueByName("Type").equalsIgnoreCase("Vanilla")
            )
            && mc.field_9632.field_41774
            && var9
            && !mc.field_9632.field_29654
            ...
            var1.method_6455(mc.field_9632.method_37309() + var6);
   ...
   private Entity method_11557(List<class_3357> var1) {
      ...
      return !var1.isEmpty() && ((class_3357)var1.get(0)).method_15377().method_37175(mc.field_9632) <= this.getFloatValueByName("Block Range")
   ...
   private void method_11546() {
      ...
      if (var6 != null && var6.size() != 0 && !mc.gameOptions.keyAttack.isPressed()) {
         ...
         if (var6.size() == 0) {
            ...
            this.field_12553 = 0;
            field_12548 = false;
            this.field_12567.field_10069 = mc.field_9632.field_41701;
            this.field_12567.field_10067 = mc.field_9632.field_41755;
            ...
            if (!var5.equals("Switch")) {
               if (!var5.equals("Multi2")) {
                  ...
                  field_12556 == null
                     ...
                     || mc.field_9632.method_37175(field_12556.method_15377()) > var4
               )
   ...
   private void method_11545() {
      ...
      switch (var7) {
         case "Test":
            ...
            if (mc.field_9632.field_41697 % 5 == 0) {
               double var32 = 10.0;
               this.field_12567.field_10069 = this.field_12567.field_10069
                  + (float)this.method_11543(-var32, var32) / (mc.field_9632.method_37175(var3) + 1.0F);
         ...
         case "AAC":
            ...
            if (var29 == 0.0F || var29 >= 1.0F || (double)var35 > 0.1 && this.field_12547 < 4.0F) {
               ...
               if (mc.field_9662 == null && var29 != 1.0F) {
         ...
         case "Test2":
            ...
            if (var10 == 0.0F || var10 >= 1.0F || (double)var19 > 0.1 && this.field_12547 < 4.0F) {
               ...
               this.field_12562 = 0.0F;
               if (mc.field_9662 == null && var10 != 1.0F) {
                  this.field_12549 = Math.random() * 0.5 + 0.25;
               }
