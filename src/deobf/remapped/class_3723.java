...
public class class_3723 extends Module {
   ...
   private void method_17268() {
      int var3 = class_314.method_1444(this.method_42017().getIntValueByName("Regular Color"), 0.14F);
      ...
      for (class_3757 var7 : mcInstance.field_9601.field_33053) {
         ...
         if (var8 || var9 || var10) {
            ...
            class_8194 var18 = new class_8194(
               var7.method_17403().method_8334(mcInstance.field_9601, var7.method_17399()).method_19483().method_18918(var11, var13, var15)
            );
