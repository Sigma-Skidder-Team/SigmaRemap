...
public class class_734 extends class_2596 {
   ...
   private static class_1893 field_4009 = class_1893.method_8510();
   ...
   public class_734() {
      ...
      class_122 var9;
      this.method_32148(var9 = new class_122(this, "more", this.method_32109() - 69, this.method_32137() - 55, 55, 41, class_2209.field_11042));
   ...
   public boolean method_3358() {
      if (class_727.method_3328().method_3300().method_9492() && class_727.method_3328().method_3300().method_9499()) {
         return false;
         ...
         this.method_32102(() -> {
            ...
            if (!class_727.method_3328().method_3300().method_9492()) {
               var3.add(new class_8888(class_2880.field_14098, "- Python 2.7.17", 30));
            }

            if (!class_727.method_3328().method_3300().method_9499()) {
   ...
   public void method_32145(int var1, int var2) {
      ...
      this.field_4010.method_32104(class_727.method_3328().method_3298().method_847(class_7723.class).method_42015());
   ...
   public void method_29509(int var1) {
      ...
      int var4 = class_727.method_3328().method_3298().method_835().method_380(class_1046.class);
   ...
   public void method_32178(float var1) {
      ...
      if (class_727.method_3328().method_3298().method_848().method_4301() != null) {
         String var12 = class_727.method_3328().method_3298().method_848().method_4301().field_8677;
         class_73.method_87(
