...
public class class_9487 {
   ...
   public final Map<Direction, class_7300> field_48353;
   public final class_1868 field_48351;
   public final boolean field_48348;

   public class_9487(class_2426 var1, class_2426 var2, Map<Direction, class_7300> var3, class_1868 var4, boolean var5) {
   ...
   private void method_43823() {
      for (Entry var4 : this.field_48353.entrySet()) {
         float[] var5 = this.method_43822((Direction)var4.getKey());
   ...
   private float[] method_43822(Direction var1) {
      switch (var1) {
         case field_802:
            return new float[]{
