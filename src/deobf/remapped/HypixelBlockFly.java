...
public class HypixelBlockFly extends Module {
   ...
   public void onEnable() {
      this.field_31713 = mc.field_9632.field_3853.field_36404;
      this.field_31712 = this.field_31711 = 999.0F;
      ((BlockFlyModule)this.method_42017()).field_18196 = -1;
      if (mc.gameOptions.keySneak.isKeyDown() && this.getBooleanValueByName("Downwards")) {
      ...
      if (mc.field_9632.field_41726) {
         this.field_31717 = mc.field_9632.method_37309();
      }
   ...
   public void onDisable() {
      if (this.field_31713 != -1 && this.method_42017().getStringValueByName("ItemSpoof").equals("Switch")) {
         mc.field_9632.field_3853.field_36404 = this.field_31713;
      }
         ...
         if (!var4.method_42015() || !var4.getStringValueByName("Type").equalsIgnoreCase("Hypixel") || !var4.method_16864().getStringValueByName("Bypass").equals("Blink")) {
            if (!var1.method_6449()) {
               ...
               if (this.field_31718 != null) {
                  ...
                  int var21 = mc.field_9632.field_3853.field_36404;
                  if (!this.method_42017().getStringValueByName("ItemSpoof").equals("None")) {
                     this.field_31710.method_17211();
                  }

                  mc.field_9647.method_42147(mc.field_9632, mc.field_9601, this.field_31708, var20);
                  if (!this.method_42017().getBooleanValueByName("NoSwing")) {
                     mc.field_9632.method_26597(this.field_31708);
                  } else {
                     mc.method_8614().method_4813(new class_3195(this.field_31708));
                  }
                  ...
                  if (this.method_42017().getStringValueByName("ItemSpoof").equals("Spoof") || this.method_42017().getStringValueByName("ItemSpoof").equals("LiteSpoof")) {
                     mc.field_9632.field_3853.field_36404 = var21;
                  }
               }
            } else {
               this.field_31714++;
               ...
               if (BlockFlyModule.method_17216(mc.field_9632.method_26617(class_2584.field_12794).method_27960())
                  && (
                     mc.field_9632.method_26617(this.field_31708).method_28022()
                        || !BlockFlyModule.method_17216(mc.field_9632.method_26617(this.field_31708).method_27960())
                  )) {
               ...
               if (mc.field_9632.method_37098().field_7333 < 0.0
                  ...
                  var9 += Math.min(mc.field_9632.method_37098().field_7333 * 2.0, 4.0);
               ...
               if (!class_7494.method_34090(
                  ...
                  var5 = mc.field_9632.method_37245().method_61();
                  var7 = mc.field_9632.method_37245().method_62();
               }
               ...
               if (!class_7494.method_34090(var11) && this.field_31710.method_17224(this.field_31708)) {
                  ...
                  if (var12 != null) {
                     ...
                     if ((double)var12.field_14163.field_13230 - mc.field_9632.method_37309() < 0.0) {
                        double var14 = mc.field_9632.method_37302()
                        ...
                        if (var18 < 2.0) {
                           var13[0] = mc.field_9632.field_41701 + 1.0F;
                           var13[1] = 90.0F;
                        }
                     }
                  ...
                  if (this.getBooleanValueByName("KeepRotations") && this.field_31711 != 999.0F) {
                     var1.method_6441(mc.field_9632.field_41701 + 1.0F);
   ...
   public void method_28400(class_7767 var1) {
      if (this.method_42015() && this.field_31710.method_17219() != 0) {
         ...
         switch (var4) {
            case "Jump":
               if (mc.field_9632.field_41726 && class_314.method_1434() && !mc.field_9632.method_37252() && !this.field_31719) {
                  this.field_31715 = false;
               ...
               break;
            case "AAC":
               if (this.field_31714 == 0 && mc.field_9632.field_41726) {
                  class_8865.method_40777(var1, class_8865.method_40775() * 0.82);
               }
               break;
            case "Cubecraft":
               double var6 = 0.2;
               float var8 = this.method_28399(class_9299.method_42810(mc.field_9632.field_41701));
               if (mc.gameOptions.keyJump.isKeyDown()) {
                  mc.theTimer.timerSpeed = 1.0F;
               } else if (mc.field_9632.field_41726) {
                  if (class_314.method_1434() && !mc.field_9632.method_37252() && !this.field_31719) {
   ...
   public void method_28404(class_1711 var1) {
      if (this.method_42015() && this.getStringValueByName("Speed Mode").equals("Cubecraft") && this.field_31716 >= 0) {
         if (!(mc.field_9632.field_41706 > 1.2F)) {
            if (!(mc.field_9632.field_3864 < this.field_31717)) {
               if (!mc.field_9632.field_29654) {
                  mc.field_9632.field_41736.field_7333 = this.field_31717;
                  mc.field_9632.field_41713 = this.field_31717;
                  mc.field_9632.field_3864 = this.field_31717;
                  mc.field_9632.field_41698 = this.field_31717;
