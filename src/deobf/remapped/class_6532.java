...
public class class_6532 {
   ...
   public class_5734 method_29742(class_4639 var1) {
   ...
   public void method_29743(class_4639 var1, class_5734 var2) {
   ...
   public Stream<class_4639> method_29741() {
      return this.field_33229.entrySet().stream().<class_4639>flatMap(var0 -> var0.getValue().method_34897(var0.getKey()));
   }
