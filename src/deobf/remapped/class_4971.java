...
public class class_4971 extends DataFix {
   private static final String[] field_25746 = (String[])DataFixUtils.make(new String[256], var0 -> {
      var0[1] = "Item";
      var0[2] = "XPOrb";
      var0[7] = "ThrownEgg";
      var0[8] = "LeashKnot";
   ...
   public class_4971(Schema var1, boolean var2) {
      super(var1, var2);
   }

   public TypeRewriteRule makeRule() {
      Schema var3 = this.getInputSchema();
      Type var4 = var3.getType(class_4002.field_19433);
      OpticFinder var5 = DSL.fieldFinder("id", DSL.named(class_4002.field_19439.typeName(), class_5178.method_23741()));
      OpticFinder var6 = DSL.fieldFinder("id", DSL.string());
      OpticFinder var7 = var4.findField("tag");
      OpticFinder var8 = var7.type().findField("EntityTag");
      OpticFinder var9 = DSL.typeFinder(var3.getTypeRaw(class_4002.field_19444));
      Type var10 = this.getOutputSchema().getTypeRaw(class_4002.field_19444);
      return this.fixTypeEverywhereTyped(
         "ItemSpawnEggFix",
         var4,
         var6x -> {
            Optional var9x = var6x.getOptional(var5);
            if (var9x.isPresent() && Objects.equals(((Pair)var9x.get()).getSecond(), "minecraft:spawn_egg")) {
               Dynamic var10x = (Dynamic)var6x.get(DSL.remainderFinder());
               short var11 = var10x.get("Damage").asShort((short)0);
               Optional var12 = var6x.getOptionalTyped(var7);
               Optional var13 = var12.flatMap(var1x -> var1x.getOptionalTyped(var8));
               Optional var14 = var13.flatMap(var1x -> var1x.getOptionalTyped(var9));
               Optional var15 = var14.flatMap(var1x -> var1x.getOptional(var6));
               Typed var16 = var6x;
               String var17 = field_25746[var11 & 255];
               if (var17 != null && (!var15.isPresent() || !Objects.equals(var15.get(), var17))) {
                  ...
                  Typed var22 = (Typed)((Pair)var20.write()
                        .flatMap(var3xx -> var10.readTyped(var3xx.set("id", var10x.createString(var17))))
                        .result()
