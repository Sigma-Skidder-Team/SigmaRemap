...
public class class_9211 extends class_1809 {
         ...
         if (var4 == null) {
            this.field_47111 = CompletableFuture.runAsync(() -> {
               ...
               if (this.method_42548()) {
                  ...
                  try {
                     var3 = (HttpURLConnection)new URL(this.field_47110).openConnection(MinecraftClient.getInstance().method_8607());
   ...
   private boolean method_42548() {
      if (this.field_47109) {
         Proxy var3 = MinecraftClient.getInstance().method_8607();
   ...
   private void method_42541() {
      try {
         class_1951 var3 = class_2316.method_10646(this.field_47110, MinecraftClient.getInstance().method_8607());
