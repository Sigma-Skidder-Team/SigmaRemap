...
public class class_8278 extends class_7449 {
   public class_8278(Schema var1, String var2) {
      super(var1, false, "Villager profession data fix (" + var2 + ")", class_4002.field_19444, var2);
   }
            ...
            .set(
               ...
               var4.createMap(
                  ImmutableMap.of(
                     ...
                     var4.createString(method_38154(var4.get("Profession").asInt(0), var4.get("Career").asInt(0))),
   ...
   private static String method_38154(int var0, int var1) {
      if (var0 != 0) {
         if (var0 != 1) {
            if (var0 != 2) {
               if (var0 != 3) {
