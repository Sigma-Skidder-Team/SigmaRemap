...
public class class_2063 extends Schema {
   public static final Map<String, String> field_10421 = (Map<String, String>)DataFixUtils.make(Maps.newHashMap(), var0 -> {
   ...
   public static final HookFunction field_10423 = new class_8166();

   public class_2063(int var1, Schema var2) {
      super(var1, var2);
   }

   public static void method_9643(Schema var0, Map<String, Supplier<TypeTemplate>> var1, String var2) {
   ...
   public Type<?> getChoiceType(TypeReference var1, String var2) {
      return !Objects.equals(var1.typeName(), class_4002.field_19434.typeName())
         ? super.getChoiceType(var1, var2)
         : super.getChoiceType(var1, class_5178.method_23742(var2));
   }

   public Map<String, Supplier<TypeTemplate>> registerBlockEntities(Schema var1) {
      HashMap var4 = Maps.newHashMap();
      method_9643(var1, var4, "minecraft:furnace");
      method_9643(var1, var4, "minecraft:chest");
      ...
      method_9643(var1, var4, "minecraft:dispenser");
      method_9643(var1, var4, "minecraft:dropper");
      ...
      method_9643(var1, var4, "minecraft:brewing_stand");
      ...
      method_9643(var1, var4, "minecraft:hopper");
      var1.registerSimple(var4, "minecraft:comparator");
      var1.register(var4, "minecraft:flower_pot", var1x -> DSL.optionalFields("Item", DSL.or(DSL.constType(DSL.intType()), class_4002.field_19439.in(var1))));
   ...
   public void registerTypes(Schema var1, Map<String, Supplier<TypeTemplate>> var2, Map<String, Supplier<TypeTemplate>> var3) {
      ...
      var1.registerType(false, class_4002.field_19434, () -> DSL.taggedChoiceLazy("id", class_5178.method_23741(), var3));
      var1.registerType(
         true,
