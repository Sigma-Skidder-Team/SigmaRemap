...
public class class_9886 extends class_6127<LivingEntity> {
   ...
   public static void method_45544(LivingEntity var0) {
      Optional var3 = var0.method_26525().<List<LivingEntity>>method_5138(class_6044.field_30907);
      if (var3.isPresent()) {
   ...
   public static void method_45543(LivingEntity var0) {
