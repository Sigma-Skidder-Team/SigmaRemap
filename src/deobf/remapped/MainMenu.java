...
public class MainMenu extends class_2596 {
   ...
   public MainMenu() {
      ...
      String var12 = var10000.append(SigmaMainClass.clientVersion).append(" for Minecraft 1.8 to ").append(class_3347.field_16514.method_2045()).toString();
