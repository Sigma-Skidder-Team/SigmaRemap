...
public class class_6081 extends DataFix {
   private static final Map<String, String> field_31123 = (Map<String, String>)DataFixUtils.make(Maps.newHashMap(), var0 -> {
   ...
   public class_6081(Schema var1, boolean var2) {
      super(var1, var2);
   }
   ...
   public TypeRewriteRule makeRule() {
      ...
      OpticFinder var5 = DSL.fieldFinder("id", class_5178.method_23741());
      ...
      return this.fixTypeEverywhereTyped("ItemInstanceSpawnEggFix", var3, var4x -> {
         ...
         if (var7x.isPresent() && Objects.equals(((Pair)var7x.get()).getSecond(), "minecraft:spawn_egg")) {
            ...
            if (var10.isPresent()) {
               return var4x.set(var4, Pair.of(class_4002.field_19439.typeName(), field_31123.getOrDefault(var10.get(), "minecraft:pig_spawn_egg")));
            }
         }
