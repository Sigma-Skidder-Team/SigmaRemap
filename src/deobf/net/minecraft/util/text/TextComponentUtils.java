...
public class TextComponentUtils {
   ...
   private static Style func_240646_a_(class_9155 p_240646_0_, Style p_240646_1_, class_8145 p_240646_2_, int p_240646_3_) throws CommandSyntaxException {
      ...
      if (itextcomponent != null) {
         ...
         if (hoverevent1 != null) {
            HoverEvent var8 = new HoverEvent(HoverEvent$class_48.SHOW_TEXT, func_240645_a_(p_240646_0_, hoverevent1, p_240646_2_, p_240646_3_ + 1));
   ...
   public static <T extends Comparable<T>> ITextComponent makeSortedList(Collection<T> collection, Function<T, ITextComponent> toTextComponent) {
      if (collection.isEmpty()) {
         ...
         ArrayList var4 = Lists.newArrayList(collection);
