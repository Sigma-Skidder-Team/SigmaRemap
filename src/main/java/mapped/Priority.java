...
public final class Priority implements Class7383<RunnableWithPriority, Runnable> {
   private static String[] field31593;
   private final List<Queue<Runnable>> field31594;

   public Priority(int var1) {
   ...
   public boolean method23499(RunnableWithPriority var1) {
