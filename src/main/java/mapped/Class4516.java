...
public class Class4516 extends Class4515
{
    ...
    public Class4516(final Class1795 class1795, final Class1932 field19921, final Class354 class1796, final Class2052 field19922, final int n) {
        super(Class9520.field40979, 0);
        this.field19921 = field19921;
        final Class354 class1797 = Class5172.method16138().get(field19921);
        this.field19920 = class1796.method1134(class1797.method1074(), class1797.method1075() - n, class1797.method1076());
    ...
    @Override
    public void method13511(final String anObject, final Class354 class354, final Class1851 class355, final Random random, final Class6997 class356) {
    ...
    public boolean method13421(final Class1851 class1851, final Class6346<?> class1852, final Random random, final Class6997 class1853, final Class7859 class1854) {
        ...
        final Class354 class1855 = Class5172.method16138().get(this.field19921);
        final Class354 method32854 = this.field19920.method1135(Class6585.method19953(method32853, new Class354(3 - class1855.method1074(), 0, 0 - class1855.method1076())));
        final int method32855 = class1851.method6699(Class2020.field11521, method32854.method1074(), method32854.method1076());
        final Class354 field19920 = this.field19920;
        this.field19920 = this.field19920.method1134(0, method32855 - 90 - 1, 0);
        ...
        if (this.field19921.equals(Class5172.method16140())) {
            final Class354 method32857 = this.field19920.method1135(Class6585.method19953(method32853, new Class354(3, 0, 5)));
