...
public class TradeTask extends Class3676<VillagerEntity> {
   private static String[] field19775;
   private final float field19776;

   public TradeTask(float var1) {
      super(ImmutableMap.of(MemoryModuleType.field39824, Class2217.field14486, MemoryModuleType.field39825, Class2217.field14486), Integer.MAX_VALUE);
   ...
   private void method12590(VillagerEntity var1) {
      ...
      var4.method21406(MemoryModuleType.field39824, new Class8999(new Class7865(var1.method4740(), false), this.field19776, 2));
      var4.method21406(MemoryModuleType.field39825, new Class7865(var1.method4740(), true));
   }
}
