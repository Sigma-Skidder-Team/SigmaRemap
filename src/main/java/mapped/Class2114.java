...
public enum Class2114 implements Class2115 {
   ...
   field13774("chainmail", 15, new int[]{1, 4, 5, 2}, 12, SoundEvents.field26348, 0.0F, 0.0F, () -> Ingredient.fromItems(Items.IRON_INGOT)),
   field13775("iron", 15, new int[]{2, 5, 6, 2}, 9, SoundEvents.field26353, 0.0F, 0.0F, () -> Ingredient.fromItems(Items.IRON_INGOT)),
   ...
   field13779("netherite", 37, new int[]{3, 6, 8, 3}, 15, SoundEvents.field26355, 3.0F, 0.1F, () -> Ingredient.fromItems(Items.NETHERITE_INGOT));
   ...
   private final LazyValue<Ingredient> field13788;
   ...
   private Class2114(String var3, int var4, int[] var5, int var6, SoundEvent var7, float var8, float var9, Supplier<Ingredient> var10) {
      ...
      this.field13788 = new LazyValue<Ingredient>(var10);
   }
