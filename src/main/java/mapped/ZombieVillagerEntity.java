...
public class ZombieVillagerEntity extends ZombieEntity implements Class1041 {
   ...
   public ZombieVillagerEntity(EntityType<? extends ZombieVillagerEntity> var1, World var2) {
      super(var1, var2);
      this.method4673(this.method4674().method26574(Registry.VILLAGER_PROFESSION.method9254(this.rand)));
   }
   ...
   public void registerData() {
      ...
      this.dataManager.register(field5770, new Class7921(VillagerType.field44542, VillagerProfession.field36011, 1));
   }
   ...
   private void method4669(ServerWorld var1) {
      VillagerEntity var4 = this.<VillagerEntity>method4292(EntityType.VILLAGER, false);
   ...
   public Class5093 method4276(ServerWorldAccess var1, Class9755 var2, SpawnReason var3, Class5093 var4, CompoundNBT var5) {
      this.method4673(this.method4674().method26573(VillagerType.method37068(var1.func_242406_i(this.getPosition()))));
