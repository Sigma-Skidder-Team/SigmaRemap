...
public class InvadeHomeGoal extends Class2595 {
   private static String[] field16864;
   private final AbstractRaiderEntity field16865;
   ...
   public InvadeHomeGoal(AbstractRaiderEntity var1, double var2, int var4) {
   ...
   private boolean method10818() {
      ...
      Optional var5 = var3.getPointOfInterestManager()
         .getRandom(var0 -> var0 == PointOfInterestType.HOME, this::method10819, PointOfInterestManager.Status.ANY, var4, 48, AbstractRaiderEntity.method4565(this.field16865));
      if (var5.isPresent()) {
