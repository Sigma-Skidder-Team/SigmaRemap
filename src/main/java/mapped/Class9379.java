...
public class Class9379 {
   ...
   public static ImmutableList<Pair<Integer, ? extends Class3676<? super VillagerEntity>>> method35581(VillagerProfession var0, float var1) {
      return ImmutableList.of(
         ...
         Pair.of(0, new Class3699(var0.getPointOfInterest(), MemoryModuleType.field39814)),
         Pair.of(0, new Class3699(var0.getPointOfInterest(), MemoryModuleType.field39815)),
         Pair.of(1, new Class3735()),
         Pair.of(2, new Class3737(var0)),
         Pair.of(3, new Class3710(var1)),
         new Pair[]{
            Pair.of(5, new Class3724(var1, false, 4)),
            Pair.of(6, new Class3698(var0.getPointOfInterest(), MemoryModuleType.field39814, MemoryModuleType.field39815, true, Optional.<Byte>empty())),
            Pair.of(7, new Class3753(var1)),
            Pair.of(8, new Class3728(var1)),
            Pair.of(10, new Class3698(PointOfInterestType.HOME, MemoryModuleType.field39813, false, Optional.<Byte>of((byte)14))),
            Pair.of(10, new Class3698(PointOfInterestType.MEETING, MemoryModuleType.field39816, true, Optional.<Byte>of((byte)14))),
   ...
   public static ImmutableList<Pair<Integer, ? extends Class3676<? super VillagerEntity>>> method35584(VillagerProfession var0, float var1) {
      return ImmutableList.of(
         ...
         Pair.of(3, new Class3699(PointOfInterestType.HOME, MemoryModuleType.field39813)),
   ...
   public static ImmutableList<Pair<Integer, ? extends Class3676<? super VillagerEntity>>> method35585(VillagerProfession var0, float var1) {
      return ImmutableList.of(
         ...
         Pair.of(3, new Class3717(100)),
         Pair.of(3, new Class3699(PointOfInterestType.MEETING, MemoryModuleType.field39816)),
         Pair.of(
            3,
            new Class3692(
               ImmutableMap.of(),
