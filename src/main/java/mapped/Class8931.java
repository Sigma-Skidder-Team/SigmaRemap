...
public class Class8931
{
    ...
    public static void method31493(final CommandDispatcher<Class7492> commandDispatcher) {
        commandDispatcher.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)Class7788.method25001("publish").requires(class7492 -> class7492.method23255().method1500() && class7492.method23210(4))).executes(commandContext -> method31494((Class7492)commandContext.getSource(), Class7676.method24365()))).then(Class7788.method25002("port", (com.mojang.brigadier.arguments.ArgumentType<Object>)IntegerArgumentType.integer(0, 65535)).executes(commandContext -> method31494((Class7492)commandContext.getSource(), IntegerArgumentType.getInteger(commandContext, "port")))));
    }
    ...
    private static int method31494(final Class7492 class7492, final int i) throws CommandSyntaxException {
        if (class7492.method23255().method1539()) {
            throw Class8931.field37537.create((Object)class7492.method23255().method1496());
        }
        if (class7492.method23255().method1544(class7492.method23255().method1445(), false, i)) {
            class7492.method23257(new Class2259("commands.publish.success", new Object[] { i }), true);
            return i;
        }
    ...
    static {
        field37536 = new SimpleCommandExceptionType((Message)new Class2259("commands.publish.failed", new Object[0]));
        field37537 = new DynamicCommandExceptionType(o -> {
            new Class2259("commands.publish.alreadyPublished", new Object[] { o });
            return;
        });
    }
}
