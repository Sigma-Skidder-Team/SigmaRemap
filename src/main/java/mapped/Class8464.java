...
public class Class8464
{
    ...
    private static Collection<String> method28250(final Collection<? extends Class399> collection) {
        final HashSet hashSet = Sets.newHashSet();
        final Iterator<? extends Class399> iterator = collection.iterator();
        while (iterator.hasNext()) {
            hashSet.addAll(((Class399)iterator.next()).method1645());
        }
        return hashSet;
    }
    
    private static int method28251(final Class7492 class7492, final Collection<? extends Class399> collection, final String s) throws CommandSyntaxException {
        int n = 0;
        final Iterator<? extends Class399> iterator = collection.iterator();
        while (iterator.hasNext()) {
            if (!((Class399)iterator.next()).method1646(s)) {
                continue;
            }
            ++n;
        }
        if (n != 0) {
            if (collection.size() != 1) {
                ...
                class7492.method23257(new Class2259("commands.tag.add.success.single", new Object[] { s, ((Class399)collection.iterator().next()).method1871() }), true);
            }
            return n;
        }
    ...
    private static int method28252(final Class7492 class7492, final Collection<? extends Class399> collection, final String s) throws CommandSyntaxException {
        int n = 0;
        final Iterator<? extends Class399> iterator = collection.iterator();
        while (iterator.hasNext()) {
            if (!((Class399)iterator.next()).method1647(s)) {
                continue;
            }
            ++n;
        }
        if (n != 0) {
            if (collection.size() != 1) {
                ...
                class7492.method23257(new Class2259("commands.tag.remove.success.single", new Object[] { s, ((Class399)collection.iterator().next()).method1871() }), true);
            }
            return n;
        }
    ...
    private static int method28253(final Class7492 class7492, final Collection<? extends Class399> collection) {
        final HashSet hashSet = Sets.newHashSet();
        ...
        if (collection.size() != 1) {
            ...
            final Class399 class7493 = (Class399)collection.iterator().next();
            if (!hashSet.isEmpty()) {
