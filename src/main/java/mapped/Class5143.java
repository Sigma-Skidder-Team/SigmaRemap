...
public class Class5143 implements Class5113
{
    ...
    private final Class354 field22132;
    
    public Class5143(final boolean field22130, final List<Class9341> field22131, final Class354 field22132) {
    ...
    public <T> Dynamic<T> method16010(final DynamicOps<T> dynamicOps) {
        return (Dynamic<T>)new Dynamic((DynamicOps)dynamicOps, dynamicOps.createMap((Map)ImmutableMap.of(dynamicOps.createString("crystalInvulnerable"), dynamicOps.createBoolean(this.field22130), dynamicOps.createString("spikes"), dynamicOps.createList((Stream)this.field22131.stream().map(class9341 -> class9341.method34625((com.mojang.datafixers.types.DynamicOps<Object>)dynamicOps2).getValue())), dynamicOps.createString("crystalBeamTarget"), (this.field22132 != null) ? dynamicOps.createList((Stream)IntStream.of(this.field22132.method1074(), this.field22132.method1075(), this.field22132.method1076()).mapToObj((IntFunction<?>)dynamicOps::createInt)) : dynamicOps.createList((Stream)Stream.empty()))));
    }
    ...
    public static <T> Class5143 method16057(final Dynamic<T> dynamic) {
        ...
        if (list2.size() != 3) {
            ...
            class354 = new Class354(list2.get(0), list2.get(1), list2.get(2));
        }
