...
public class Class4269 extends InteractiveWidget {
   public UIInput field20694;

   public Class4269(GuiComponent var1, String var2, int var3, int var4, int var5, int var6) {
      super(var1, var2, var3, var4, var5, var6, ColorHelper.field27961, "", false);
      this.font = ResourceRegistry.JelloLightFont20;
      this.addToList(
            this.field20694 = new UIInput(this, "chat", 14, 0, var5 - 28, var6, UIInput.field20741, "", "Chat..."));
   ...
   public void keyPressed(int keyCode) {
      ...
      if (keyCode == 257) {
         ...
         Client.getInstance().networkManager.field38429.method29515("SF4FSERFERF", this.field20694.getTypedText());
