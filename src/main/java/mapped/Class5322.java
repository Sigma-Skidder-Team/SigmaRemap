...
public class Class5322 extends Class5259
{
    private static String[] field22356;
    
    public List<Class7276> method16376(final ByteBuf byteBuf) throws Exception {
        final ArrayList list = new ArrayList();
        Class7276 class7276;
        do {
            class7276 = Class7964.field32731.method16378(byteBuf);
            if (class7276 != null) {
                list.add(class7276);
            }
    ...
    public void method16377(final ByteBuf byteBuf, final List<Class7276> list) throws Exception {
        ...
        while (iterator.hasNext()) {
            Class7964.field32731.method16379(byteBuf, iterator.next());
        }
        Class7964.field32731.method16379(byteBuf, null);
    }
}
