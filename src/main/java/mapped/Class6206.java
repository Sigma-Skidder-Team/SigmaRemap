...
public class Class6206 {
   ...
   public static void method19111(CommandDispatcher<CommandSource> var0) {
      var0.register(
         (LiteralArgumentBuilder)((LiteralArgumentBuilder) Commands.method18839("function").requires(var0x -> var0x.method20129(2)))
            .then(
               Commands.method18840("name", Class7566.method24766())
                  .suggests(field27688)
   ...
   private static int method19112(CommandSource var0, Collection<Class7744> var1) {
      ...
      for (Class7744 var6 : var1) {
         var4 += var0.getServer().method1397().method22825(var6, var0.method20162().method20164(2));
      }

      if (var1.size() != 1) {
         var0.sendFeedback(new TranslationTextComponent("commands.function.success.multiple", var4, var1.size()), true);
      } else {
         var0.sendFeedback(new TranslationTextComponent("commands.function.success.single", var4, ((Class7744)var1.iterator().next()).method25652()), true);
      }
