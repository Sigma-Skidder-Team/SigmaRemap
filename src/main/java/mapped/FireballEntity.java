...
public class FireballEntity extends Class898 {
   public int field5139 = 1;

   public FireballEntity(EntityType<? extends FireballEntity> var1, World var2) {
      super(var1, var2);
   }

   public FireballEntity(World var1, double var2, double var4, double var6, double var8, double var10, double var12) {
      super(EntityType.FIREBALL, var2, var4, var6, var8, var10, var12, var1);
   }

   public FireballEntity(World var1, LivingEntity var2, double var3, double var5, double var7) {
