...
public class Class9410 {
   public static void method36043(CommandDispatcher<CommandSource> var0) {
      var0.register(
         (LiteralArgumentBuilder) Commands.method18839("me")
            .then(
               Commands.method18840("action", StringArgumentType.greedyString())
                  .executes(
                     var0x -> {
                        String var3 = StringArgumentType.getString(var0x, "action");
                        Entity var4 = ((CommandSource)var0x.getSource()).method20173();
                        MinecraftServer var5 = ((CommandSource)var0x.getSource()).getServer();
                        if (var4 == null) {
