...
public final class Class363 implements Class356
{
    private final Class383 field2191;
    private final Class354 field2192;
    
    private Class363(final Class383 field2191, final Class354 field2192) {
        this.field2191 = field2191;
        this.field2192 = field2192;
    }
    
    public static Class363 method1167(final Class383 class383, final Class354 class384) {
        return new Class363(class383, class384);
    }
    
    public static Class363 method1168(final Dynamic<?> dynamic) {
        return dynamic.get("dimension").map((Function)Class383::method1268).flatMap(p1 -> dynamic2.get("pos").map((Function)Class354::method1122).map(class384 -> new Class363(class383, class384))).orElseThrow(() -> new IllegalArgumentException("Could not parse GlobalPos"));
    }
