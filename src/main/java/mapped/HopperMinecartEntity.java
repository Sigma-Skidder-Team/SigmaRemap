...
public class HopperMinecartEntity extends Class919 implements Class937 {
   private boolean field5299 = true;
   private int field5300 = -1;
   private final BlockPos field5301 = BlockPos.ZERO;

   public HopperMinecartEntity(EntityType<? extends HopperMinecartEntity> var1, World var2) {
      super(var1, var2);
   }

   public HopperMinecartEntity(World var1, double var2, double var4, double var6) {
   ...
   public boolean method3737() {
      if (!Class936.method3705(this)) {
         List var3 = this.world.<Entity>getEntitiesInAABBexcluding(ItemEntity.class, this.getBoundingBox().grow(0.25, 0.0, 0.25), EntityPredicates.IS_ALIVE);
         if (!var3.isEmpty()) {
