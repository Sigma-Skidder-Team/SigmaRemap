...
public class TntEntity extends Entity {
   private static final DataParameter<Integer> field5562 = EntityDataManager.<Integer>createKey(TntEntity.class, DataSerializers.VARINT);
   private LivingEntity field5563;
   private int field5564 = 80;

   public TntEntity(EntityType<? extends TntEntity> var1, World var2) {
      super(var1, var2);
      this.preventEntitySpawning = true;
   }

   public TntEntity(World var1, double var2, double var4, double var6, LivingEntity var8) {
