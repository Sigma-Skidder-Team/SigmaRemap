...
public abstract class Class5610<P extends Class573 & Class664<?>>
{
    ...
    public boolean method16916() {
        return this.method16915().method3716();
    }
    
    public void method16917(final boolean b) {
        this.method16915().method3717(b);
    }
    
    public boolean method16918() {
        return this.method16915().method3718();
    }
    
    public void method16919(final boolean b) {
        this.method16915().method3719(b);
    }
