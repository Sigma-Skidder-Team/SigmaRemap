...
public class Class4341 extends Class4339 implements Class4342 {
   ...
   public Class4341(GuiComponent var1, String var2, int var3, int var4, int var5, int var6, ModuleCategory var7) {
   ...
   public void method13511() {
      ...
      for (Module var5 : Client.getInstance().moduleManager.getModulesByCategory(this.field21214)) {
         ...
         ColorHelper var12 = new ColorHelper(!var5.isEnabled() ? 1895167477 : -14047489,
               ...
               .method19410(
                     !var5.isEnabled() ? ClientColors.DEEP_TEAL.getColor()
   ...
   public void draw(float partialTicks) {
      this.method13225();
      super.draw(partialTicks * ((JelloClickGUIPanels) this.screen).field21195);
   }
