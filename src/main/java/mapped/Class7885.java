...
public class Class7885 extends Sensor<LivingEntity> {
   ...
   public Set<MemoryModuleType<?>> method26424() {
      return ImmutableSet.of(MemoryModuleType.field39818);
   }

   public static void method26441(LivingEntity var0) {
      Optional<List<LivingEntity>> var3 = var0.getBrain().<List<LivingEntity>>getMemory(MemoryModuleType.field39818);
      if (var3.isPresent()) {
   ...
   public static void method26442(LivingEntity var0) {
      var0.getBrain().method21407(MemoryModuleType.field39842, true, 600L);
   }
}
