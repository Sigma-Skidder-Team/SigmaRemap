...
public class Class5742 extends LivingRenderer<ArmorStandEntity, Class2892> {
   ...
   public Class5742(EntityRendererManager var1) {
      ...
      this.addLayer(new BipedArmorLayer<ArmorStandEntity, Class2892, Class2892>(this, new Class2892(0.5F), new Class2892(1.0F)));
      this.addLayer(new Class242<ArmorStandEntity, Class2892>(this));
      this.addLayer(new Class220<ArmorStandEntity, Class2892>(this));
      this.addLayer(new Class235<ArmorStandEntity, Class2892>(this));
   }
   ...
   public void method17842(ArmorStandEntity var1, MatrixStack var2, float var3, float var4, float var5) {
      ...
      float var8 = (float)(var1.world.getGameTime() - var1.field5584) + var5;
      if (var8 < 5.0F) {
