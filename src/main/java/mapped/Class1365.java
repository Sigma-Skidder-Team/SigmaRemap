...
public class Class1365 implements Runnable
{
    ...
    public void run() {
        ...
        if (Class8788.method30614(this.field7500) <= 2L) {
            ...
            for (long n7 = 4L * this.field7496; n7 < Class8788.method30614(this.field7500); n7 += 4 * this.field7497) {
            ...
            for (long n14 = 4L * this.field7496; n14 < Class8788.method30614(this.field7500); n14 += 4 * this.field7497) {
