...
public class Class1167 extends Class1155<Class1167> {
   ...
   public void render(MatrixStack var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, boolean var9, float var10) {
      ...
      this.field6332.field6836.font.func_243248_b(var1, var13.field26007, (float)(var4 + 18 + 5), (float)(var3 + 6), 16777215);
   }
   ...
   private void method5570(MatrixStack var1, int var2, int var3, Item var4) {
      ...
      this.field6332.field6836.field4563.renderItemIntoGUI(new ItemStack(var4), var2 + 2, var3 + 2);
