...
public class Chunk implements IChunk {
         ...
         try {
            if (var5 >= 0 && var5 >> 4 < this.sections.length) {
               ...
               if (!ChunkSection.isEmpty(var7)) {
                  return var7.getBlockState(var4 & 15, var5 & 15, var6 & 15);
               }
            }
      ...
      try {
         if (var2 >= 0 && var2 >> 4 < this.sections.length) {
            ...
            if (!ChunkSection.isEmpty(var6)) {
               return var6.getFluidState(var1 & 15, var2 & 15, var3 & 15);
            }
         }
   ...
   public BlockState setBlockState(BlockPos var1, BlockState var2, boolean var3) {
      ...
      BlockState var11 = var9.setBlockState(var6, var7 & 15, var8, var2);
      if (var11 != var2) {
         ...
         if (var9.getBlockState(var6, var7 & 15, var8).isIn(var12)) {
   ...
   public Stream<BlockPos> getLightSources() {
      return StreamSupport.<BlockPos>stream(
            BlockPos.getAllInBoxMutable(this.field9132.getX(), 0, this.field9132.getZ(), this.field9132.getXEnd(), 255, this.field9132.getZEnd())
               .spliterator(),
            false
         )
