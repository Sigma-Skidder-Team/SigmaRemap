...
public class Class7215 {
   ...
   public static TeleportationRepositioner method22658(BlockPos var0, Direction.Axis var1, int var2, Direction.Axis var3, int var4, Predicate<BlockPos> var5) {
      BlockPos.Mutable var8 = var0.method8354();
      Direction var9 = Direction.getFacingFromAxis(Direction.AxisDirection.NEGATIVE, var1);
      Direction var10 = var9.getOpposite();
      Direction var11 = Direction.getFacingFromAxis(Direction.AxisDirection.NEGATIVE, var3);
