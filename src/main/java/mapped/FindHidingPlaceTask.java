...
public class FindHidingPlaceTask extends Class3676<LivingEntity> {
   ...
   public FindHidingPlaceTask(int var1, float var2, int var3) {
   ...
   public boolean method12508(ServerWorld worldIn, LivingEntity var2) {
      Optional optional = worldIn.getPointOfInterestManager()
         .find(var0 -> var0 == PointOfInterestType.HOME, var0 -> true, var2.getPosition(), this.field19905 + 1, PointOfInterestManager.Status.ANY);
      if (optional.isPresent() && ((BlockPos)optional.get()).withinDistance(var2.getPositionVec(), (double)this.field19905)) {
         this.field19906 = optional;
      } else {
   ...
   public void startExecuting(ServerWorld var1, LivingEntity var2, long var3) {
      ...
      if (!var8.isPresent()) {
         var8 = var1.getPointOfInterestManager()
            .getRandom(var0 -> var0 == PointOfInterestType.HOME, var0 -> true, PointOfInterestManager.Status.ANY, var2.getPosition(), this.field19904, var2.getRNG());
         if (!var8.isPresent()) {
