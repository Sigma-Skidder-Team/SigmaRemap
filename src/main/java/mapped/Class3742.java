...
public class Class3742 extends Class3676<VillagerEntity> {
   ...
   private final MemoryModuleType<List<Class9378>> field19870;
   private final MemoryModuleType<Class9378> field19871;
   ...
   public Class3742(MemoryModuleType<List<Class9378>> var1, float var2, int var3, int var4, MemoryModuleType<Class9378> var5) {
      super(ImmutableMap.of(MemoryModuleType.field39824, Class2217.field14486, var1, Class2217.field14484, var5, Class2217.field14484));
   ...
   public boolean method12508(ServerWorld var1, VillagerEntity var2) {
      Optional var5 = var2.getBrain().<List<Class9378>>getMemory(this.field19870);
      Optional var6 = var2.getBrain().<Class9378>getMemory(this.field19871);
      if (var5.isPresent() && var6.isPresent()) {
         ...
         if (!var7.isEmpty()) {
            ...
            return this.field19876 != null
               ...
               && ((Class9378)var6.get()).method35579().withinDistance(var2.getPositionVec(), (double)this.field19874);
         }
      }
