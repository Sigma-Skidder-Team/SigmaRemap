...
public class StriderEntity extends AnimalEntity implements Class1071, Class1069 {
   ...
   private static final Ingredient field5903 = Ingredient.fromItems(Items.WARPED_FUNGUS);
   private static final Ingredient field5904 = Ingredient.fromItems(Items.WARPED_FUNGUS, Items.field38065);
   ...
   public void method4942(SoundCategory var1) {
      ...
      if (var1 != null) {
         this.world.playSoundFromEntity((PlayerEntity)null, this, SoundEvents.field27101, var1, 0.5F, 1.0F);
      }
   }
   ...
   public boolean method4277() {
      ...
      if (!(var3 instanceof PlayerEntity)) {
         ...
         return var4.getHeldItemMainhand().getItem() == Items.field38065 || var4.getHeldItemOffhand().getItem() == Items.field38065;
      }
   }
