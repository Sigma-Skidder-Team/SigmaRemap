...
public class VillagerEntity extends Class1043 implements Class1062, Class1041 {
   private static final DataParameter<Class7921> field5776 = EntityDataManager.<Class7921>createKey(VillagerEntity.class, DataSerializers.field33406);
   ...
   public static final Map<MemoryModuleType<Class9378>, BiPredicate<VillagerEntity, PointOfInterestType>> field5793 = ImmutableMap.of(
      MemoryModuleType.field39813,
      (BiPredicate<VillagerEntity, PointOfInterestType>)(var0, var1) -> var1 == PointOfInterestType.HOME,
      MemoryModuleType.field39814,
      (BiPredicate<VillagerEntity, PointOfInterestType>)(var0, var1) -> var0.method4674().method26571().getPointOfInterest() == var1,
      MemoryModuleType.field39815,
      (BiPredicate<VillagerEntity, PointOfInterestType>)(var0, var1) -> PointOfInterestType.ANY_VILLAGER_WORKSTATION.test(var1),
      MemoryModuleType.field39816,
      (BiPredicate<VillagerEntity, PointOfInterestType>)(var0, var1) -> var1 == PointOfInterestType.MEETING
   );

   public VillagerEntity(EntityType<? extends VillagerEntity> var1, World var2) {
      this(var1, var2, VillagerType.field44542);
   }

   public VillagerEntity(EntityType<? extends VillagerEntity> var1, World var2, VillagerType var3) {
      super(var1, var2);
      ((Class6991)this.method4230()).method21682(true);
      this.method4230().method21674(true);
      this.method4281(true);
      this.method4695(this.method4674().method26573(var3).method26574(VillagerProfession.field36011));
   }
   ...
   private void method4678(Brain<VillagerEntity> var1) {
   ...
   public void updateAITasks() {
      ...
      if (this.method4674().method26571() == VillagerProfession.field36011 && this.method4741()) {
         this.method4684();
      }
   ...
   public void registerData() {
      super.registerData();
      this.dataManager.register(field5776, new Class7921(VillagerType.field44542, VillagerProfession.field36011, 1));
   }
   ...
   public ITextComponent getProfessionName() {
      return new TranslationTextComponent(this.getType().method33210() + '.' + Registry.VILLAGER_PROFESSION.getKey(this.method4674().method26571()).getPath());
   }
   ...
   public Class5093 method4276(ServerWorldAccess var1, Class9755 var2, SpawnReason var3, Class5093 var4, CompoundNBT var5) {
      if (var3 == SpawnReason.field14395) {
         this.method4695(this.method4674().method26574(VillagerProfession.field36011));
      }

      if (var3 == SpawnReason.field14404 || var3 == SpawnReason.field14403 || var3 == SpawnReason.field14393 || var3 == SpawnReason.field14405) {
         this.method4695(this.method4674().method26573(VillagerType.method37068(var1.func_242406_i(this.getPosition()))));
      }
   ...
   public VillagerEntity method4389(ServerWorld var1, Class1045 var2) {
      double var5 = this.rand.nextDouble();
      VillagerType var7;
      if (!(var5 < 0.5)) {
         if (!(var5 < 0.75)) {
            var7 = ((VillagerEntity)var2).method4674().method26570();
         } else {
            var7 = this.method4674().method26570();
         }
      } else {
         var7 = VillagerType.method37068(var1.func_242406_i(this.getPosition()));
      }
   ...
   public void method3353(ServerWorld var1, LightningBoltEntity var2) {
      if (var1.method6997() == Difficulty.PEACEFUL) {
         ...
         WitchEntity var5 = EntityType.WITCH.create(var1);
   ...
   public void method4714(ServerWorld var1, VillagerEntity var2, long var3) {
   ...
   public void method4716(ServerWorld var1, long var2, int var4) {
      if (this.method4717(var2)) {
         ...
         List<VillagerEntity> var8 = var1.getEntitiesWithinAABB(VillagerEntity.class, var7);
         List<VillagerEntity> var9 = var8.stream().filter(var2x -> var2x.method4717(var2)).limit(5L).collect(Collectors.toList());
         if (var9.size() >= var4) {
            IronGolemEntity var10 = this.method4718(var1);
            if (var10 != null) {
   ...
   @Nullable
   private IronGolemEntity method4718(ServerWorld var1) {
      ...
      for (int var5 = 0; var5 < 10; var5++) {
         ...
         if (var10 != null) {
            IronGolemEntity var11 = EntityType.IRON_GOLEM
