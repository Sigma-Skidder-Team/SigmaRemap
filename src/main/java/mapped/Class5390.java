...
public class Class5390 implements Class5391 {
   private final Map<VillagerType, Item> field24027;
   private final int field24028;
   private final int field24029;
   private final int field24030;

   public Class5390(int var1, int var2, int var3, Map<VillagerType, Item> var4) {
      Registry.field16089.stream().filter(var1x -> !var4.containsKey(var1x)).findAny().ifPresent(var0 -> {
   ...
   public Class9346 method16977(Entity var1, Random var2) {
      if (!(var1 instanceof Class1041)) {
         ...
         return new Class9346(var5, new ItemStack(Items.EMERALD), this.field24029, this.field24030, 0.05F);
      }
   }
}
