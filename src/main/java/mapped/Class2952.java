   ...
   public boolean method11213(ISeedReader var1, ChunkGenerator var2, Random var3, BlockPos var4, Class4712 var5) {
      ...
      for (Integer var13 : var9) {
         for (Integer var15 : var10) {
            ...
            BlockPos var16 = var1.getHeight(Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, var11);
            if (var1.method7007(var16) || var1.getBlockState(var16).getCollisionShape(var1, var16).isEmpty()) {
