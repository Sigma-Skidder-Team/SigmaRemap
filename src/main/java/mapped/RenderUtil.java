...
public class RenderUtil {
    ...
    public static void startScissorHalal(float var0, float var1, float var2, float var3) {
        startScissor((int) var0, (int) var1, (int) var2, (int) var3, true);
    }
    ...
    public static void startScissorNoGL(int var0, int var1, int var2, int var3) {
        startScissor(var0, var1, var2, var3, false);
    }

    public static void startScissor(int var0, int var1, int var2, int var3, boolean var4) {
        if (!var4) {
    ...
    public static void drawString(TrueTypeFont var0, float var1, float var2, String var3, int var4) {
        ColorHelper.method11441(var0, var1, var2, var3, var4, Class2218.field14488, Class2218.field14489, false);
    }

    public static void method11440(TrueTypeFont var0, float var1, float var2, String var3, int var4, Class2218 var5,
                                   Class2218 var6) {
        ColorHelper.method11441(var0, var1, var2, var3, var4, var5, var6, false);
    }
    ...
    public static void method11443(Class7431 var0, float var1, float var2, String var3, int var4, Class2218 var5,
                                   Class2218 var6) {
        method11444(var0, var1, var2, var3, var4, var5, var6, false);
    }

    public static void method11444(Class7431 var0, float var1, float var2, String var3, int var4, Class2218 var5,
    ...
    public static void method11453(
            float var0, float var1, float var2, float var3, ByteBuffer var4, int var5, float var6, float var7, float var8,
            float var9, boolean var10, boolean var11) {
        if (var4 != null) {
            RenderSystem.color4f(0.0F, 0.0F, 0.0F, 1.0F);
            GL11.glColor4f(0.0F, 0.0F, 0.0F, 0.0F);
    ...
    public static void method11456(float var0, float var1, float var2, float var3, Texture var4, float var5, float var6,
    ...
    public static void method11458(float var0, float var1, float var2, int var3) {
        ...
        for (int var7 = 0; var7 < 360; var7 = (int) ((float) var7 + 51.42857F)) {
            ...
            drawFilledArc(var0 + var8, var1 + var9, var2 / 4.0F, var3);
        }
    }
    ...
    public static void method11466(int var0, int var1, int var2, int var3, int var4, int var5, int var6) {
        ...
        drawRect((float) (var0 + var10), (float) (var1 + var10), (float) (var0 + var2 - var10),
                (float) (var1 + var3 - var10), var4);
        drawImage((float) (var0 - var11), (float) (var1 - var11), (float) var9, (float) var9,
                ResourceList.floatingCornerPNG, var4);
        GL11.glPushMatrix();
        ...
        drawImage((float) (var0 + var10), (float) (var1 + var10 + var3), (float) var9, (float) var9,
                ResourceList.floatingCornerPNG, var4);
        GL11.glPopMatrix();
        startScissorNoGL(var5 - var9, var6 + var10, var5 - var11 + var9, var6 - var10 + var3);

        for (int var12 = 0; var12 < var3; var12 += var9) {
            drawImage((float) (var0 - var11), (float) (var1 + var10 + var12), (float) var9, (float) var9,
                    ResourceList.floatingBorderPNG, var4);
        }

        endScissor();
        startScissorNoGL(var5, var6 - var11, var5 + var2 - var10, var6 + var10);
        ...
        endScissor();
        startScissorNoGL(var5 + var2 - var10, var6 - var11, var0 + var2 + var11, var6 + var3 - var10);
        ...
        endScissor();
        startScissorNoGL(var5 - var10, var6 - var11 + var3 - var9, var5 + var2 - var10, var6 + var3 + var10 * 2);
    ...
    public static void method11467(int var0, int var1, int var2, int var3, int var4) {
        ...
        byte var8 = 10;
        int var9 = var7 - var8;
        drawRect((float) (var0 + var8), (float) (var1 + var8), (float) (var0 + var2 - var8), (float) (var1 + var3 - var8),
                var4);
        drawImage((float) (var0 - var9), (float) (var1 - var9), (float) var7, (float) var7,
                ResourceList.floatingCornerPNG, var4);
        GL11.glPushMatrix();
        ...
        for (int var12 = 0; var12 < var3; var12 += var7) {
            ...
            drawImage((float) (var0 - var2 + var8), (float) (var1 - var8 - var12) - 0.4F, (float) var7,
                    (float) var7 + 0.4F, ResourceList.floatingBorderPNG, var4);
            GL11.glPopMatrix();
        }
    ...
    public static void method11472(float var0, float var1, float var2, float var3, float var4, int var5) {
        drawFilledArc(var0 + var4, var1 + var4, var4, var5);
        drawFilledArc(var0 - var4 + var2, var1 + var4, var4, var5);
        drawFilledArc(var0 + var4, var1 - var4 + var3, var4, var5);
        drawFilledArc(var0 - var4 + var2, var1 - var4 + var3, var4, var5);
    ...
    public static java.awt.Color sampleScreenColor(int mouseX, int mouseY, java.awt.Color var2) {
        ...
        GL11.glReadPixels(mouseX, Minecraft.getInstance().mainWindow.getFramebufferHeight() - mouseY, 1, 1, 6407, 5120,
                var5);
    ...
    public static double[] worldToScreen(double x, double y, double z) {
        ...
        return !isSuccessful
                ...
                (double) (((float) mc.framebuffer.framebufferHeight - screenCoords.get(1))
