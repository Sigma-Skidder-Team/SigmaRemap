...
public class Class2739 extends Class2736 {
   ...
   private BlockPos method10951(SectionPos var1) {
      ...
      Class1653 var5 = var4.getPointOfInterestManager();
      List var6 = var5.method6666(var0 -> true, var1.getCenter(), 8, Class2093.field13636).<BlockPos>map(Class9343::method35355).collect(Collectors.toList());
