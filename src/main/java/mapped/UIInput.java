...
public class UIInput extends Class4278 {
   ...
   public void draw(float partialTicks) {
      ...
      float var9 = (float) var7 + this.field20746
            + (float) this.font.getWidth(var6.substring(0, this.field20749));
      if (this.method13297()) {
         RenderUtil.drawRect(
               ...
               MultiUtilities.applyAlpha(this.textColor.getTextColor(), !var5 ? 0.1F * partialTicks : 0.8F));
      ...
      float var14 = (float) var7 + this.field20746
            + (float) this.font.getWidth(var6.substring(0, this.field20750));
      float var11 = (float) var7 + this.field20746
            + (float) this.font.getWidth(var6.substring(0, this.field20751));
      RenderUtil.drawRect(
            var14,
            (float) (this.yA + this.heightA / 2 - this.font.getHeight(var6) / 2),
            var11,
            (float) (this.yA + this.heightA / 2 + this.font.getHeight(var6) / 2),
            MultiUtilities.applyAlpha(-5516546, partialTicks));
      ...
      RenderUtil.method11440(
            ...
            MultiUtilities.applyAlpha(this.textColor.getTextColor(),
                  (this.field20744 / 2.0F + 0.4F) * partialTicks * (this.field20905 && var6.length() > 0 ? 1.0F : 0.5F)),
            var12,
            var13);
      ...
      if (this.field20758) {
         RenderUtil.drawRect(
               ...
               MultiUtilities.applyAlpha(this.textColor.method19405(), (this.field20744 / 2.0F + 0.5F) * partialTicks));
      }
