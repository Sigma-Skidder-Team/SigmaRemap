...
public final class Class4384 implements Class4383 {
   ...
   public Collection<ResourceLocation> method13746(RegistryKey<? extends Registry<?>> var1) {
      return this.field21395.getAllResourceLocations(var1.getLocation().getPath(), var0 -> var0.endsWith(".json"));
   }
   ...
   public <E> DataResult<Pair<E, OptionalInt>> method13747(
      ...
      try (
              IResource var9 = this.field21395.getResource(var8);
              InputStreamReader var11 = new InputStreamReader(var9.getInputStream(), StandardCharsets.UTF_8);
      ) {
