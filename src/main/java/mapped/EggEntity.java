...
public class EggEntity extends Class890 {
   private static String[] field5128;

   public EggEntity(EntityType<? extends EggEntity> var1, World var2) {
      super(var1, var2);
   }

   public EggEntity(World var1, LivingEntity var2) {
      super(EntityType.EGG, var2, var1);
   }

   public EggEntity(World var1, double var2, double var4, double var6) {
      ...
      if (!this.world.isRemote) {
         if (this.rand.nextInt(8) == 0) {
            ...
            for (int var5 = 0; var5 < var4; var5++) {
               ChickenEntity var6 = EntityType.CHICKEN.create(this.world);
