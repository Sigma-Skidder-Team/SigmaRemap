...
public class Class218<T extends LivingEntity & Class1041, M extends Class2827<T> & Class2801> extends LayerRenderer<T, M> implements IResourceManagerReloadListener {
   ...
   private final Object2ObjectMap<VillagerType, Class1984> field859 = new Object2ObjectOpenHashMap();
   private final Object2ObjectMap<VillagerProfession, Class1984> field860 = new Object2ObjectOpenHashMap();
   ...
   public void render(MatrixStack var1, IRenderTypeBuffer var2, int var3, T var4, float var5, float var6, float var7, float var8, float var9, float var10) {
      if (!var4.isInvisible()) {
         ...
         VillagerType var14 = var13.method26570();
         VillagerProfession var15 = var13.method26571();
         Class1984 var16 = this.method819(this.field859, "type", Registry.field16089, var14);
         Class1984 var17 = this.method819(this.field860, "profession", Registry.VILLAGER_PROFESSION, var15);
         ...
         if (var15 != VillagerProfession.field36011 && !var4.isChild()) {
            ResourceLocation var20 = this.method818("profession", Registry.VILLAGER_PROFESSION.getKey(var15));
            method824(var18, var20, var1, var2, var3, var4, 1.0F, 1.0F, 1.0F);
            if (var15 != VillagerProfession.field36022) {
