...
public class Class3698 extends Class3676<CreatureEntity> {
   ...
   public Class3698(PointOfInterestType var1, MemoryModuleType<Class9378> var2, MemoryModuleType<Class9378> var3, boolean var4, Optional<Byte> var5) {
   ...
   public Class3698(PointOfInterestType var1, MemoryModuleType<Class9378> var2, boolean var3, Optional<Byte> var4) {
   ...
   public void method12502(ServerWorld var1, CreatureEntity var2, long var3) {
      ...
      Set<BlockPos> var9 = var7.method6669(this.field19741.getPredicate(), var8, var2.getPosition(), 48, Class2093.field13635).limit(5L).collect(Collectors.toSet());
      ...
      if (var10 != null && var10.method28708()) {
         ...
         var7.method6676(var13).ifPresent(var5 -> {
            var7.method6672(this.field19741.getPredicate(), var1xx -> var1xx.equals(var13), var13, 1);
