...
public class Class8288
{
    ...
    private static void method27547(final Class1862 class1862, final Class322 o) {
        ...
        if (class1862.method7039().field34080.remove(o)) {
            final Set<Class179> method7066 = o.method993();
            final boolean contains = method7066.contains(Class179.field516);
            final boolean contains2 = method7066.contains(Class179.field515);
            final boolean contains3 = method7066.contains(Class179.field514);
            final boolean contains4 = method7066.contains(Class179.field513);
            ...
            for (final Class354 class1864 : Class354.method1158(n, 0, n3, n2, method7065.method6986() - 1, n4)) {
                Class7096 class1866;
                final Class7096 class1865 = class1866 = method7065.method6701(class1864);
                for (final Class179 class1867 : values) {
    ...
    private static Class7096 method27548(final Class7096 class7096, final Class179 class7097, final Class1851 class7098, final Class354 class7099, final Class354 class7100) {
            ...
            for (int i = 0; i < 16; ++i) {
                ...
                if (class1863 != null && array != null && array.length > 0) {
                    ...
                    for (final int n : array) {
                        ...
                        for (final Class179 class1865 : values) {
                            method1297.method1303(method1296).method1304(class1865);
                            if (method1296.method1074() >> 4 == method1298.field32290 && method1296.method1076() >> 4 == method1298.field32291) {
