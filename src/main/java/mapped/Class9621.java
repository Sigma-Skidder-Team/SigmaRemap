...
public class Class9621 {
   ...
   public static final int[] field44998 = new int[Direction.Axis.values().length];

   static {
      try {
         field44998[Direction.Axis.X.ordinal()] = 1;
      } catch (NoSuchFieldError var10) {
      }

      try {
         field44998[Direction.Axis.Z.ordinal()] = 2;
      ...
      try {
         field44997[Direction.UP.ordinal()] = 2;
