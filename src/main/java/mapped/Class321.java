...
public interface Class321<Msg> extends AutoCloseable {
   ...
   default <Source> CompletableFuture<Source> func_213141_a(Function<? super Class321<Source>, ? extends Msg> var1) {
   ...
   default <Source> CompletableFuture<Source> func_233528_c_(Function<? super Class321<Either<Source, Exception>>, ? extends Msg> var1) {
