...
public class Class2667 extends Class2661 {
   ...
   private List<BlockPos> method10882() {
      ...
      Class1653 var4 = ((ServerWorld)this.field17022.world).getPointOfInterestManager();
      Stream<Class9343> var5 = var4.method6666(var0 -> var0 == PointOfInterestType.BEEHIVE || var0 == PointOfInterestType.BEE_NEST, var3, 20, Class2093.field13637);
