...
public class RedeemKeyScreen extends GuiComponent {
   ...
   public RedeemKeyScreen(GuiComponent var1, String var2, int var3, int var4, int var5, int var6) {
      ...
      this.addToList(
            this.field21138 = new UIInput(this, "captcha", 195, 290, 75, 35, UIInput.field20742, "", "Captcha"));
      ...
      var10.doThis((var2x, var3x) -> new Thread(() -> {
         ...
         this.field21135 = Client.getInstance().networkManager.redeemPremium(var9.getTypedText(),
               Client.getInstance().networkManager.method30452());
