...
public class EnderPearlEntity extends Class890 {
   private static String[] field5130;

   public EnderPearlEntity(EntityType<? extends EnderPearlEntity> var1, World var2) {
      super(var1, var2);
   }

   public EnderPearlEntity(World var1, LivingEntity var2) {
      super(EntityType.ENDER_PEARL, var2, var1);
   }

   public EnderPearlEntity(World var1, double var2, double var4, double var6) {
