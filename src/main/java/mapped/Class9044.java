...
public class Class9044 {
   public static final double field41371 = Math.PI;
   public static final double field41372 = Math.E;
   public static final int field41373 = 750;
   public static final int field41374 = 1500;
   public static final int field41375 = 1024;
   public static final int field41376 = 1025;
   private static final double field41377 = StrictMath.log(Double.MAX_VALUE);
   private static final boolean field41378 = false;
   private static final double field41379 = 0.69314706F;
   private static final double field41380 = 1.1730463525082348E-7;
   private static final double[][] field41381 = new double[][]{
   ...
   private static final double[][] field41382 = new double[][]{
   ...
   private static final int field41383 = 14;
   private static final double[] field41384 = new double[]{
      0.0,
      0.12467474F,
      0.24740395F,
      0.3662725F,
   ...
   private static final double[] field41385 = new double[]{
      0.0,
   ...
   private static final double[] field41386 = new double[]{
      1.0,
      0.99219763F,
      0.96891236F,
      0.93050766F,
   ...
   private static final double[] field41387 = new double[]{
      0.0,
   ...
   private static final double[] field41388 = new double[]{
      0.0,
      0.12565514F,
      0.25534195F,
      0.39362657F,
   ...
   private static final double[] field41389 = new double[]{
      0.0,
   ...
   private static final long[] field41390 = new long[]{
   ...
   private static final long[] field41391 = new long[]{-3958705157555305932L, -4267615245585081135L};
   private static final double[] field41392 = new double[]{0.0, 0.125, 0.25, 0.375, 0.5, 0.625, 0.75, 0.875, 1.0, 1.125, 1.25, 1.375, 1.5, 1.625};
   private static final double[] field41393 = new double[]{0.6299605249474366, 0.7937005259840998, 1.0, 1.2599210498948732, 1.5874010519681994};
   private static final long field41394 = 1073741824L;
   private static final long field41395 = -1073741824L;
   private static final int field41396 = Integer.MAX_VALUE;
   private static final long field41397 = Long.MAX_VALUE;
   private static final double field41398 = 4.5035996E15F;
   private static final double field41399 = 9.007199E15F;
   private static final double field41400 = 0.3333333333333333;
   private static final double field41401 = 0.2;
   private static final double field41402 = 0.14285714285714285;
   private static final double field41403 = 0.1111111111111111;
   private static final double field41404 = 0.09090909090909091;
   private static final double field41405 = 0.07692307692307693;
   private static final double field41406 = 0.06666666666666667;
   private static final double field41407 = 0.058823529411764705;
   private static final double field41408 = 0.75;
   private static final double field41409 = 0.9375;
   private static final double field41410 = 0.9285714285714286;
   private static final double field41411 = 0.9166666666666666;
   private static final double field41412 = 0.9;
   private static final double field41413 = 0.875;
   private static final double field41414 = 0.8333333333333334;
   private static final double field41415 = 0.5;
   private static final double field41416 = 0.25;

   private Class9044() {
   }

   private static double method33545(double var0) {
      if (var0 > -Class9356.field43415 && var0 < Class9356.field43415) {
         return var0;
      } else {
   ...
   public static double method33546(double var0) {
      return Math.sqrt(var0);
   }

   public static double method33547(double var0) {
      if (var0 == var0) {
         if (!(var0 > 20.0)) {
            if (!(var0 < -20.0)) {
               ...
               return var21 * 0.5;
            } else if (!(var0 <= -field41377)) {
               return 0.5 * method33560(-var0);
            } else {
               double var33 = method33560(-0.5 * var0);
               return 0.5 * var33 * var33;
            }
         } else if (!(var0 >= field41377)) {
            return 0.5 * method33560(var0);
         } else {
            double var23 = method33560(0.5 * var0);
   ...
   public static double method33548(double var0) {
      boolean var4 = false;
      if (var0 == var0) {
         if (!(var0 > 20.0)) {
            if (!(var0 < -20.0)) {
               ...
               double var58 = method33560(-0.5 * var0);
               return -0.5 * var58 * var58;
            }
         } else if (!(var0 >= field41377)) {
            return 0.5 * method33560(var0);
         } else {
            double var28 = method33560(0.5 * var0);
   ...
   public static double method33549(double var0) {
      boolean var4 = false;
      if (var0 == var0) {
         if (!(var0 > 20.0)) {
            if (!(var0 < -20.0)) {
               if (var0 != 0.0) {
                  ...
                  if (!(var0 >= 0.5)) {
                     ...
                     method33561(var0 * 2.0, 0.0, var32);
   ...
   public static double method33550(double var0) {
      return method33564(var0 + method33546(var0 * var0 - 1.0));
   }

   public static double method33551(double var0) {
      boolean var4 = false;
      if (var0 < 0.0) {
         var4 = true;
         var0 = -var0;
      ...
      if (!(var0 > 0.167)) {
         ...
         var7 = method33564(method33546(var0 * var0 + 1.0) + var0);
      }

      return !var4 ? var7 : -var7;
   }

   public static double method33552(double var0) {
      boolean var4 = false;
      if (var0 < 0.0) {
         var4 = true;
         var0 = -var0;
      ...
      if (!(var0 > 0.15)) {
         ...
         var7 = 0.5 * method33564((1.0 + var0) / (1.0 - var0));
      }

      return !var4 ? var7 : -var7;
   }

   public static double method33553(double var0) {
      return !(var0 < 0.0) ? (!(var0 > 0.0) ? var0 : 1.0) : -1.0;
   }

   public static float method33554(float var0) {
      return !(var0 < 0.0F) ? (!(var0 > 0.0F) ? var0 : 1.0F) : -1.0F;
   }

   public static double method33555(double var0) {
      return method33596(var0, Double.POSITIVE_INFINITY);
   }

   public static float method33556(float var0) {
      return method33597(var0, Double.POSITIVE_INFINITY);
   }

   public static double method33557(double var0) {
      return method33596(var0, Double.NEGATIVE_INFINITY);
   }

   public static float method33558(float var0) {
      return method33597(var0, Double.NEGATIVE_INFINITY);
   }

   public static double method33559() {
      return Math.random();
   }

   public static double method33560(double var0) {
      return method33561(var0, 0.0, null);
   }

   private static double method33561(double var0, double var2, double[] var4) {
      int var7 = (int)var0;
      if (!(var0 < 0.0)) {
         if (var7 > 709) {
            if (var4 != null) {
         ...
         if (var7 < -709) {
            double var35 = method33561(var0 + 40.191406F, var2, var4) / 2.8504009514401178E17;
            if (var4 != null) {
         ...
         if (var7 == -709) {
            double var29 = method33561(var0 + 1.4941406F, var2, var4) / 4.455505956692757;
            if (var4 != null) {
      ...
      double var8 = Class9543.method36925()[750 + var7];
      double var10 = Class9543.method36926()[750 + var7];
      int var12 = (int)((var0 - (double)var7) * 1024.0);
      double var13 = Class8282.method28944()[var12];
      double var15 = Class8282.method28945()[var12];
   ...
   public static double method33562(double var0) {
      return method33563(var0, null);
   }

   private static double method33563(double var0, double[] var2) {
      if (var0 != var0 || var0 == 0.0) {
         ...
         double var12 = Class8282.method28944()[var11] - 1.0;
         double var14 = Class8282.method28945()[var11];
   ...
   public static double method33564(double var0) {
      return method33565(var0, null);
   }

   private static double method33565(double var0, double[] var2) {
      if (var0 == 0.0) {
         ...
         if (((var5 & Long.MIN_VALUE) != 0L || var0 != var0) && var0 != 0.0) {
            ...
            if ((var7 == -1 || var7 == 0) && var0 < 1.01 && var0 > 0.99 && var2 == null) {
               ...
               double[] var8 = Class7482.method24368()[(int)((var5 & 4499201580859392L) >> 42)];
   ...
   public static double method33566(double var0) {
      if (var0 != -1.0) {
         if (var0 != Double.POSITIVE_INFINITY) {
            if (!(var0 > 1.0E-6) && !(var0 < -1.0E-6)) {
               ...
               double var9 = method33565(var4, var8);
   ...
   public static double method33567(double var0) {
      double[] var4 = new double[2];
      double var5 = method33565(var0, var4);
   ...
   public static double method33568(double var0, double var2) {
      return method33564(var2) / method33564(var0);
   }

   public static double method33569(double var0, double var2) {
               ...
               if (var2 != Double.NEGATIVE_INFINITY) {
                  if (var0 < 0.0) {
                     if (var2 >= 9.007199E15F || var2 <= -9.007199E15F) {
                        return method33569(-var0, var2);
                     } else if (var2 != (double)((long)var2)) {
                        return Double.NaN;
                     } else {
                        return ((long)var2 & 1L) != 0L ? -method33569(-var0, var2) : method33569(-var0, var2);
                     }
                  } else {
                     double var33;
                     double var36;
                     ...
                     double var30 = method33565(var0, var6);
                     if (!Double.isInfinite(var30)) {
                        ...
                        var25 *= var15;
                        return method33561(var31, var25, null);
                     } else {
                        return var30;
                     }
                  }
   ...
   public static double method33570(double var0, int var2) {
      if (var2 != 0) {
         if (var2 < 0) {
            var2 = -var2;
            var0 = 1.0 / var0;
   ...
   private static double method33571(double var0) {
   ...
   private static double method33572(double var0) {
      double var4 = var0 * var0;
   ...
   private static double method33573(double var0, double var2) {
      int var6 = (int)(var0 * 8.0 + 0.5);
      double var7 = var0 - field41392[var6];
      double var9 = field41384[var6];
      double var11 = field41385[var6];
      double var13 = field41386[var6];
      double var15 = field41387[var6];
      double var19 = method33571(var7);
      double var21 = 1.0;
      double var23 = method33572(var7);
   ...
   private static double method33574(double var0, double var2) {
      ...
      return method33573(var10, var12);
   }

   private static double method33575(double var0, double var2, boolean var4) {
      int var7 = (int)(var0 * 8.0 + 0.5);
      double var8 = var0 - field41392[var7];
      double var10 = field41384[var7];
      double var12 = field41385[var7];
      double var14 = field41386[var7];
      double var16 = field41387[var7];
      double var20 = method33571(var8);
      double var22 = 1.0;
      double var24 = method33572(var8);
   ...
   private static void method33576(double var0, double[] var2) {
      long var5 = Double.doubleToRawLongBits(var0);
      ...
      long var14;
      if (var9 == 0) {
         var10 = var8 != 0 ? field41390[var8 - 1] : 0L;
         var12 = field41390[var8];
         var14 = field41390[var8 + 1];
      } else {
         var10 = var8 != 0 ? field41390[var8 - 1] << var9 : 0L;
         var10 |= field41390[var8] >>> 64 - var9;
         var12 = field41390[var8] << var9 | field41390[var8 + 1] >>> 64 - var9;
         var14 = field41390[var8 + 1] << var9 | field41390[var8 + 2] >>> 64 - var9;
      }
      ...
      var20 = field41391[0] >>> 32;
      var22 = field41391[0] & 4294967295L;
      var24 = var16 * var20;
      var26 = var18 * var22;
      var28 = var18 * var20;
      var30 = var16 * var22;
      ...
      var20 = field41391[1] >>> 32;
      var22 = field41391[1] & 4294967295L;
      var24 = var16 * var20;
      var28 = var18 * var20;
      var30 = var16 * var22;
      var24 += var28 + var30 >>> 32;
   ...
   public static double method33577(double var0) {
      boolean var4 = false;
      int var5 = 0;
      double var6 = 0.0;
      double var8 = var0;
      ...
      if (var8 == 0.0) {
         ...
         if (var8 > 3294198.0) {
            ...
            method33576(var8, var12);
            var5 = (int)var12[0] & 3;
            var8 = var12[1];
            var6 = var12[2];
         } else if (var8 > Math.PI / 2) {
            Class9042 var13 = new Class9042(var8);
            var5 = var13.method33540() & 3;
            var8 = var13.method33541();
            var6 = var13.method33542();
         }
         ...
         switch (var5) {
            case 0:
               return method33573(var8, var6);
            case 1:
               return method33574(var8, var6);
            case 2:
               return -method33573(var8, var6);
            case 3:
               return -method33574(var8, var6);
   ...
   public static double method33578(double var0) {
      int var4 = 0;
      double var5 = var0;
      if (var0 < 0.0) {
         var5 = -var0;
      ...
      if (var5 == var5 && var5 != Double.POSITIVE_INFINITY) {
         ...
         if (var5 > 3294198.0) {
            ...
            method33576(var5, var9);
            var4 = (int)var9[0] & 3;
            var5 = var9[1];
            var7 = var9[2];
         } else if (var5 > Math.PI / 2) {
            Class9042 var10 = new Class9042(var5);
            var4 = var10.method33540() & 3;
            var5 = var10.method33541();
            var7 = var10.method33542();
         }

         switch (var4) {
            case 0:
               return method33574(var5, var7);
            case 1:
               return -method33573(var5, var7);
            case 2:
               return -method33574(var5, var7);
            case 3:
               return method33573(var5, var7);
   ...
   public static double method33579(double var0) {
      boolean var4 = false;
      int var5 = 0;
      double var6 = var0;
      if (var0 < 0.0) {
      ...
      if (var6 != 0.0) {
         if (var6 == var6 && var6 != Double.POSITIVE_INFINITY) {
            ...
            if (!(var6 > 3294198.0)) {
               if (var6 > Math.PI / 2) {
                  Class9042 var12 = new Class9042(var6);
                  var5 = var12.method33540() & 3;
                  var6 = var12.method33541();
                  var19 = var12.method33542();
               }
            } else {
               double[] var21 = new double[3];
               method33576(var6, var21);
               var5 = (int)var21[0] & 3;
               var6 = var21[1];
               var19 = var21[2];
            }
            ...
            double var20;
            if ((var5 & 1) != 0) {
               var20 = -method33575(var6, var19, true);
            } else {
               var20 = method33575(var6, var19, false);
            }
   ...
   public static double method33580(double var0) {
      return method33581(var0, 0.0, false);
   }

   private static double method33581(double var0, double var2, boolean var4) {
      if (var0 != 0.0) {
         boolean var7;
         if (!(var0 < 0.0)) {
            var7 = false;
         ...
         if (!(var0 > 1.633123935319537E16)) {
            ...
            double var40 = field41388[var10];
            double var11 = field41389[var10];
         ...
         return !var4 ? var0 : method33628(Math.PI, var0);
      }
   }

   public static double method33582(double var0, double var2) {
      if (var2 != var2 || var0 != var0) {
         ...
         if (var22 != 0.0) {
            ...
            return !(var2 > 0.0) ? method33628(Math.PI, var0) : var0;
         }
      } else if (var0 != Double.POSITIVE_INFINITY) {
         if (var0 != Double.NEGATIVE_INFINITY) {
            ...
            if (!Double.isInfinite(var6)) {
               double var8 = method33545(var6);
               double var10 = var6 - var8;
               double var12 = method33545(var2);
               ...
               var8 = var16;
               if (var16 == 0.0) {
                  var8 = method33628(0.0, var0);
               }

               return method33581(var8, var10, var2 < 0.0);
            } else {
               return method33581(var6, 0.0, var2 < 0.0);
            }
         } else if (var2 == Double.POSITIVE_INFINITY) {
            return -Math.PI / 4;
         } else {
   ...
   public static double method33583(double var0) {
      if (var0 == var0) {
         if (var0 > 1.0 || var0 < -1.0) {
            ...
            return method33581(var4, var26, false);
         } else {
            return var0;
         }
      } else {
   ...
   public static double method33584(double var0) {
      if (var0 == var0) {
         if (var0 > 1.0 || var0 < -1.0) {
            return Double.NaN;
         } else if (var0 == -1.0) {
   ...
   public static double method33585(double var0) {
      long var4 = Double.doubleToRawLongBits(var0);
   ...
   public static double method33587(double var0) {
      if (!Double.isInfinite(var0) && var0 != 0.0) {
   ...
   public static int method33588(int var0) {
      int var3 = var0 >>> 31;
      return (var0 ^ ~var3 + 1) + var3;
   }

   public static long method33589(long var0) {
      long var4 = var0 >>> 63;
      return (var0 ^ ~var4 + 1L) + var4;
   }

   public static float method33590(float var0) {
      return Float.intBitsToFloat(2147483647 & Float.floatToRawIntBits(var0));
   }

   public static double method33591(double var0) {
      return Double.longBitsToDouble(Long.MAX_VALUE & Double.doubleToRawLongBits(var0));
   }

   public static double method33592(double var0) {
      return !Double.isInfinite(var0) ? method33591(var0 - Double.longBitsToDouble(Double.doubleToRawLongBits(var0) ^ 1L)) : Double.POSITIVE_INFINITY;
   }

   public static float method33593(float var0) {
      return !Float.isInfinite(var0) ? method33590(var0 - Float.intBitsToFloat(Float.floatToIntBits(var0) ^ 1)) : Float.POSITIVE_INFINITY;
   }

   public static double method33594(double var0, int var2) {
  ...
  /* public static float method33595(float var0, int var1) {
   ...
   public static double method33596(double var0, double var2) {
   ...
   public static float method33597(float var0, double var1) {
   ...
   public static double method33598(double var0) {
      if (var0 == var0) {
   ...
   public static double method33599(double var0) {
      if (var0 == var0) {
         double var4 = method33598(var0);
         if (var4 != var0) {
            var4++;
   ...
   public static double method33600(double var0) {
      double var4 = method33598(var0);
   ...
   public static long method33601(double var0) {
      return (long)method33598(var0 + 0.5);
   }

   public static int method33602(float var0) {
      return (int)method33598((double)(var0 + 0.5F));
   }

   public static int method33603(int var0, int var1) {
      return var0 > var1 ? var1 : var0;
   }

   public static long method33604(long var0, long var2) {
      return var0 > var2 ? var2 : var0;
   }

   public static float method33605(float var0, float var1) {
      if (!(var0 > var1)) {
         if (!(var0 < var1)) {
            if (var0 == var1) {
   ...
   public static double method33606(double var0, double var2) {
      if (!(var0 > var2)) {
         if (!(var0 < var2)) {
            if (var0 == var2) {
               long var6 = Double.doubleToRawLongBits(var0);
   ...
   public static int method33607(int var0, int var1) {
      return var0 > var1 ? var0 : var1;
   }

   public static long method33608(long var0, long var2) {
      return var0 > var2 ? var0 : var2;
   }

   public static float method33609(float var0, float var1) {
      if (!(var0 > var1)) {
         if (!(var0 < var1)) {
            if (var0 == var1) {
               int var4 = Float.floatToRawIntBits(var0);
   ...
   public static double method33610(double var0, double var2) {
      if (!(var0 > var2)) {
         if (!(var0 < var2)) {
            if (var0 == var2) {
               long var6 = Double.doubleToRawLongBits(var0);
   ...
   public static double method33611(double var0, double var2) {
      if (Double.isInfinite(var0) || Double.isInfinite(var2)) {
         return Double.POSITIVE_INFINITY;
      } else if (!Double.isNaN(var0) && !Double.isNaN(var2)) {
         int var6 = method33630(var0);
         int var7 = method33630(var2);
         if (var6 > var7 + 27) {
            return method33591(var0);
         } else if (var7 <= var6 + 27) {
            int var8 = (var6 + var7) / 2;
            double var9 = method33594(var0, -var8);
            double var11 = method33594(var2, -var8);
            double var13 = method33546(var9 * var9 + var11 * var11);
            return method33594(var13, var8);
         } else {
            return method33591(var2);
         }
      } else {
         return Double.NaN;
      }
   ...
   public static double method33612(double var0, double var2) {
      return StrictMath.IEEEremainder(var0, var2);
   }

   public static int method33613(long var0) throws Class2492 {
      if (var0 >= -2147483648L && var0 <= 2147483647L) {
         return (int)var0;
      } else {
         throw new Class2492(Class2297.field15616);
      }
   }

   public static int method33614(int var0) throws Class2492 {
      if (var0 != Integer.MAX_VALUE) {
         return var0 + 1;
      } else {
         throw new Class2492(Class2297.field15618, var0, 1);
      }
   }

   public static long method33615(long var0) throws Class2492 {
   ...
   public static int method33616(int var0) throws Class2492 {
      if (var0 != Integer.MIN_VALUE) {
         return var0 - 1;
      } else {
         throw new Class2492(Class2297.field15619, var0, 1);
      }
   }

   public static long method33617(long var0) throws Class2492 {
   ...
   public static int method33618(int var0, int var1) throws Class2492 {
      int var4 = var0 + var1;
      if ((var0 ^ var1) >= 0 && (var4 ^ var1) < 0) {
         throw new Class2492(Class2297.field15618, var0, var1);
      } else {
         return var4;
      }
   }

   public static long method33619(long var0, long var2) throws Class2492 {
      long var6 = var0 + var2;
      if ((var0 ^ var2) >= 0L && (var6 ^ var2) < 0L) {
         throw new Class2492(Class2297.field15618, var0, var2);
      } else {
         return var6;
      }
   }

   public static int method33620(int var0, int var1) {
      int var4 = var0 - var1;
      if ((var0 ^ var1) < 0 && (var4 ^ var1) >= 0) {
         throw new Class2492(Class2297.field15619, var0, var1);
      } else {
         return var4;
      }
   }

   public static long method33621(long var0, long var2) {
      long var6 = var0 - var2;
      if ((var0 ^ var2) < 0L && (var6 ^ var2) >= 0L) {
         throw new Class2492(Class2297.field15619, var0, var2);
      } else {
         return var6;
      }
   }

   public static int method33622(int var0, int var1) {
      if (var1 > 0 && (var0 > Integer.MAX_VALUE / var1 || var0 < Integer.MIN_VALUE / var1)
         ...
         throw new Class2492(Class2297.field15620, var0, var1);
      } else {
         return var0 * var1;
      }
   }

   public static long method33623(long var0, long var2) {
      if (var2 > 0L && (var0 > Long.MAX_VALUE / var2 || var0 < Long.MIN_VALUE / var2)
         ...
         throw new Class2492(Class2297.field15620, var0, var2);
      } else {
         return var0 * var2;
      }
   }

   public static int method33624(int var0, int var1) throws Class2492 {
      if (var1 != 0) {
         int var4 = var0 % var1;
         return (var0 ^ var1) < 0 && var4 != 0 ? var0 / var1 - 1 : var0 / var1;
      } else {
         throw new Class2492(Class2297.field15681);
      }
   }

   public static long method33625(long var0, long var2) throws Class2492 {
      if (var2 != 0L) {
         long var6 = var0 % var2;
   ...
   public static int method33626(int var0, int var1) throws Class2492 {
      if (var1 != 0) {
         int var4 = var0 % var1;
   ...
   public static long method33627(long var0, long var2) {
      if (var2 != 0L) {
         long var6 = var0 % var2;
   ...
   public static double method33628(double var0, double var2) {
      long var6 = Double.doubleToRawLongBits(var0);
      long var8 = Double.doubleToRawLongBits(var2);
      return (var6 ^ var8) < 0L ? -var0 : var0;
   }

   public static float method33629(float var0, float var1) {
      int var4 = Float.floatToRawIntBits(var0);
      int var5 = Float.floatToRawIntBits(var1);
      return (var4 ^ var5) < 0 ? -var0 : var0;
   }

   public static int method33630(double var0) {
      return (int)(Double.doubleToRawLongBits(var0) >>> 52 & 2047L) - 1023;
   }

   public static int method33631(float var0) {
      return (Float.floatToRawIntBits(var0) >>> 23 & 0xFF) - 127;
   }

   public static void main(String[] var0) {
      PrintStream var3 = System.out;
      Class8599.method30768(var3, "EXP_INT_TABLE_A", 1500, Class9543.method36925());
      Class8599.method30768(var3, "EXP_INT_TABLE_B", 1500, Class9543.method36926());
      Class8599.method30768(var3, "EXP_FRAC_TABLE_A", 1025, Class8282.method28944());
      Class8599.method30768(var3, "EXP_FRAC_TABLE_B", 1025, Class8282.method28945());
      Class8599.method30767(var3, "LN_MANT", 1024, Class7482.method24368());
      Class8599.method30768(var3, "SINE_TABLE_A", 14, field41384);
      Class8599.method30768(var3, "SINE_TABLE_B", 14, field41385);
      Class8599.method30768(var3, "COSINE_TABLE_A", 14, field41386);
      Class8599.method30768(var3, "COSINE_TABLE_B", 14, field41387);
      Class8599.method30768(var3, "TANGENT_TABLE_A", 14, field41388);
      Class8599.method30768(var3, "TANGENT_TABLE_B", 14, field41389);
   }
}
