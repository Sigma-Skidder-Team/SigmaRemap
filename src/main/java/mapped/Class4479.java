...
public abstract class Class4479 extends Class4473
{
    ...
    public Class7096 method13462() {
        switch (Class8427.field34588[this.field19869.ordinal()]) {
            ...
            case 2: {
                return Class7521.field29165.method11878();
            }
        }
    }
    ...
    public Class7096 method13463() {
        switch (Class8427.field34588[this.field19869.ordinal()]) {
            ...
            case 2: {
                return Class7521.field29623.method11878();
            }
        }
    }
    
    public boolean method13464(final Class1855 class1855, final Class6997 class1856, final int n, final int n2, final int n3, final int n4) {
        for (int i = n; i <= n2; ++i) {
