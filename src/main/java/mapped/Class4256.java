...
public class Class4256 extends InteractiveWidget {
   public int field20635;
   public Class4360 field20636;
   public Class4360 field20637;
   public Class4360 field20638;

   public Class4256(GuiComponent var1, String var2, int var3, int var4, int var5, int var6, int var7) {
      ...
      this.field20636.onPress(var1x -> this.method13060());
      this.field20637.onPress(var1x -> this.method13060());
      this.field20638.onPress(var1x -> this.method13060());
   }
