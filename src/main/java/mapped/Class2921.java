...
public abstract class Class2921<U extends Class4698> extends Class2898<U> {
   ...
   @Override
   public boolean method11213(ISeedReader var1, ChunkGenerator var2, Random var3, BlockPos var4, U var5) {
      ...
      for (int var10 = 0; var10 < this.method11252((U)var5); var10++) {
         ...
         if (var1.method7007(var11) && var11.getY() < 255 && var8.isValidPosition(var1, var11) && this.method11251(var1, var11, (U)var5)) {
