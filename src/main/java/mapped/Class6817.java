...
public final class Class6817 implements Class6814
{
    private static final int field26760 = 20;
    private final Class2309 field26761;
    private final boolean field26762;
    private Class8904 field26763;
    private Object field26764;
    private volatile boolean field26765;
    
    public Class6817(final Class2309 field26761, final boolean field26762) {
        this.field26761 = field26761;
        this.field26762 = field26762;
    }
    
    public void method20862() {
        this.field26765 = true;
        final Class8904 field26763 = this.field26763;
        if (field26763 != null) {
            field26763.method31375();
        }
    }
    
    public boolean method20863() {
    ...
    public Class8904 method20865() {
        return this.field26763;
    }
    
    @Override
    public Class1753 method20856(final Class8711 class8711) throws IOException {
        Class8596 method29905 = class8711.method29905();
        this.field26763 = new Class8904(this.field26761.method9405(), this.method20866(method29905.method29109()), this.field26764);
        int i = 0;
        Class1753 class8712 = null;
        while (!this.field26765) {
            Class1753 obj = null;
            boolean b = true;
            try {
                obj = ((Class8712)class8711).method29910(method29905, this.field26763, null, null);
                b = false;
            }
            ...
            final Class8596 method29906 = this.method20869(obj);
            if (method29906 == null) {
                if (!this.field26762) {
                    this.field26763.method31372();
                }
            ...
            if (!this.method20870(obj, method29906.method29109())) {
                this.field26763.method31372();
                this.field26763 = new Class8904(this.field26761.method9405(), this.method20866(method29906.method29109()), this.field26764);
            }
    ...
    private boolean method20867(final IOException ex, final boolean b, final Class8596 class8596) {
        this.field26763.method31376(ex);
        return this.field26761.method9408() && (!b || !(class8596.method29114() instanceof Class7772)) && this.method20868(ex, b) && this.field26763.method31380();
    }
    ...
    private Class8596 method20869(final Class1753 class1753) throws IOException {
        if (class1753 == null) {
        ...
        switch (method31372) {
            ...
            case 303: {
                ...
                final Class8846 method31375 = class1753.method6186().method29109().method30957(method31374);
                if (method31375 == null) {
                    return null;
                }
                if (!method31375.method30930().equals(class1753.method6186().method29109().method30930()) && !this.field26761.method9406()) {
                    return null;
                }
    ...
    private boolean method20870(final Class1753 class1753, final Class8846 class1754) {
        final Class8846 method29109 = class1753.method6186().method29109();
