...
public class Class3689 extends Class3676<LivingEntity> {
   ...
   public boolean method12508(ServerWorld var1, LivingEntity var2) {
      if (var1.getGameTime() - this.field19712 < 20L) {
         ...
         Class1653 var6 = var1.getPointOfInterestManager();
         Optional var7 = var6.method6671(PointOfInterestType.HOME.getPredicate(), var2.getPosition(), 48, Class2093.field13637);
   ...
   public void method12502(ServerWorld var1, LivingEntity var2, long var3) {
      ...
      Class1653 var8 = var1.getPointOfInterestManager();
      ...
      Stream var10 = var8.method6668(PointOfInterestType.HOME.getPredicate(), var9, var2.getPosition(), 48, Class2093.field13637);
