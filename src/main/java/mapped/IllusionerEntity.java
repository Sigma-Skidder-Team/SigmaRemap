...
public class IllusionerEntity extends Class1031 implements Class1022 {
   private static String[] field5738;
   private int field5739;
   private final Vector3d[][] field5740;

   public IllusionerEntity(EntityType<? extends IllusionerEntity> var1, World var2) {
      super(var1, var2);
      this.field5594 = 5;
   ...
   public void method4219() {
      ...
      this.goalSelector.addGoal(1, new Class2696(this));
      this.goalSelector.addGoal(4, new Class2677(this));
      this.goalSelector.addGoal(5, new Class2673(this));
      this.goalSelector.addGoal(6, new Class2758<IllusionerEntity>(this, 0.5, 20, 15.0F));
      ...
      this.targetSelector.addGoal(3, new NearestAttackableTargetGoal<IronGolemEntity>(this, IronGolemEntity.class, false).method10917(300));
   }
