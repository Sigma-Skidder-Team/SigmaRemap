...
public class Class4359 extends InteractiveWidget {
   ...
   public Class4359(GuiComponent var1, String var2, int var3, int var4, int var5, int var6) {
   ...
   public void draw(float partialTicks) {
      ...
      if (this.isMouseDownOverComponent() && this.method13298() && var5 != 0.0) {
         int var10 = this.getHeightO() - this.getAbsoluteX();
      ...
      if (var4 == 0 && !this.field21314.method24319()) {
         RenderUtil.renderBackgroundBox(
               ...
               MultiUtilities.applyAlpha(ClientColors.DEEP_TEAL.getColor(), 0.43F * partialTicks));
      } else {
         RenderUtil.renderBackgroundBox(
               (float) this.getXA(),
               (float) this.getYA(),
