...
public abstract class LivingRenderer<T extends LivingEntity, M extends Class2827<T>> extends EntityRenderer<T>
    ...
    public final List<LayerRenderer<T, M>> layerRenderers = Lists.newArrayList();
    ...
    public final boolean addLayer(LayerRenderer<T, M> var1) {
    ...
    public void render(T entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn) {
        if (!Reflector.field42990.exists() || !Reflector.postForgeBusEvent(Reflector.field42990, entityIn, this,
            ...
            Client.getInstance().eventManager.call(eventRenderEntity);
            ...
            float f8 = this.method17871((T) entityIn, partialTicks);
            this.method17842((T) entityIn, matrixStackIn, f8, f, partialTicks);
            ...
            eventRenderEntity.setState(RenderState.field13213);
            Client.getInstance().eventManager.call(eventRenderEntity);
            this.entityModel.setLivingAnimations((T) entityIn, f5, f9, partialTicks);
            this.entityModel.setRotationAngles((T) entityIn, f5, f9, f8, f2, f7);
            ...
            if (var22 != null) {
                IVertexBuilder var23 = bufferIn.getBuffer(var22);
                ...
                this.entityModel.render(matrixStackIn, var23, packedLightIn, var25, 1.0F, 1.0F, 1.0F,
            ...
            eventRenderEntity.setState(RenderState.field13214);
            Client.getInstance().eventManager.call(eventRenderEntity);
            matrixStackIn.pop();
            super.render((T) entityIn, entityYaw, partialTicks, matrixStackIn, bufferIn, packedLightIn);
            if (Reflector.field42992.exists()) {
                Reflector.postForgeBusEvent(Reflector.field42992, entityIn, this, partialTicks, matrixStackIn, bufferIn, packedLightIn);
            }
        }
    }
    ...
    public List<LayerRenderer<T, M>> method17886() {
