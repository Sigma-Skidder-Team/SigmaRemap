...
public class BreedGoal extends Class2595 {
   ...
   public BreedGoal(AnimalEntity var1, double var2) {
      this(var1, var2, (Class<? extends AnimalEntity>)var1.getClass());
   }

   public BreedGoal(AnimalEntity var1, double var2, Class<? extends AnimalEntity> var4) {
