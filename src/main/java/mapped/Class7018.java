...
public class Class7018 implements Class7016 {
                     ...
                     if (!var1.method7019(
                        ...
                        if (var15 == Biome.Category.MUSHROOM) {
                           ...
                           for (int var18 = 0; var18 < var17; var18++) {
                              ...
                              var13.setX(var13.getX() + var6.nextInt(5) - var6.nextInt(5));
                              var13.setZ(var13.getZ() + var6.nextInt(5) - var6.nextInt(5));
                           }
   ...
   private boolean method21749(ServerWorld var1, BlockPos var2, Random var3, boolean var4) {
      ...
      if (Class8170.method28428(var1, var2, var7, var7.getFluidState(), EntityType.PILLAGER)) {
         if (PatrollerEntity.method4572(EntityType.PILLAGER, var1, SpawnReason.field14406, var2, var3)) {
            PatrollerEntity var8 = EntityType.PILLAGER.create(var1);
            if (var8 == null) {
               return false;
            } else {
               if (var4) {
