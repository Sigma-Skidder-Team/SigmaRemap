...
public class Class3533 extends Class3531
{
    ...
    public void method11082() {
        for (int i = 0; i < 3; ++i) {
            final Class354 method1134 = new Class354(this.field16567).method1134(-2 + Class771.method4274(this.field16567).nextInt(5), 1, -2 + Class771.method4275(this.field16567).nextInt(5));
