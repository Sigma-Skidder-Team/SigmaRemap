...
public class Class7640 extends Class7641 {
   public static final Map<String, String> field32720 = ImmutableMap.<String, String>builder()
   ...
   public Class7640(Schema var1, boolean var2) {
      super(var1, var2, "Biomes fix", field32720);
   }
}
