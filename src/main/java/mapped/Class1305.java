...
public class Class1305 extends Screen implements Class1306 {
   ...
   public void method6180() {
      ...
      this.<Button>addButton(
         new Button(this.width / 2 - 100, this.height - 28, 200, 20, DialogTexts.DONE, var1 -> this.mc.displayGuiScreen(this.field6900))
      );
   ...
   private void method6186(MatrixStack var1, int var2, int var3, Item var4) {
      ...
      this.field4563.renderItemIntoGUI(var4.method11742(), var2 + 2, var3 + 2);
