...
public class StayNearPointTask extends Class3676<VillagerEntity> {
   ...
   public StayNearPointTask(MemoryModuleType<Class9378> var1, float var2, int var3, int var4, int var5) {
   ...
   private void method12701(VillagerEntity var1, long var2) {
