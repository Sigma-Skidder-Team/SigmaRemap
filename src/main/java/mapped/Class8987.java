...
public class Class8987 {
   ...
   public static void method33189(CommandDispatcher<CommandSource> var0) {
      var0.register(
         (LiteralArgumentBuilder)((LiteralArgumentBuilder) Commands.method18839("save-on").requires(var0x -> var0x.method20129(4))).executes(var0x -> {
            ...
            if (var4) {
               var3.sendFeedback(new TranslationTextComponent("commands.save.enabled"), true);
               return 1;
            } else {
