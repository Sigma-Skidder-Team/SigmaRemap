...
public class Class2786 extends Class2785 {
   ...
   public Class2786(FoxEntity var1, double var2) {
      super(var1, var2);
   ...
   public void method10979() {
      ...
      FoxEntity var4 = (FoxEntity)this.field17407.method4389(var3, this.field17410);
      if (var4 != null) {
         ...
         if (var5 == null) {
            ...
            FoxEntity.method5171(var4, var5.getUniqueID());
         }

         if (var6 != null && var5 != var6) {
            FoxEntity.method5171(var4, var6.getUniqueID());
         }
