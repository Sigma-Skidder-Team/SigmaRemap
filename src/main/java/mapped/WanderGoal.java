...
public class WanderGoal extends Class2595 {
   private static String[] field17111;
   public final BeeEntity field17112;

   public WanderGoal(BeeEntity var1) {
   ...
   public boolean method10803() {
      return BeeEntity.method4495(this.field17112).method21664() && BeeEntity.method4496(this.field17112).nextInt(10) == 0;
   }

   @Override
   public boolean method10806() {
      return BeeEntity.method4497(this.field17112).method21665();
   }
   ...
   public void startExecuting() {
      ...
      if (var3 != null) {
         BeeEntity.method4499(this.field17112).method21656(BeeEntity.method4498(this.field17112).method21651(new BlockPos(var3), 1), 1.0);
      }
   }
