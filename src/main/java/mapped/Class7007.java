...
public class Class7007 extends Class7006
{
    ...
    private final Class399 field27325;
    
    public Class7007(final Class399 class399) {
        this(class399, class399.method1934());
    }
    
    public Class7007(final Class399 field27325, final Class5487 class5487) {
        super(class5487);
        this.field27325 = field27325;
    }
    
    public Class399 method21452() {
