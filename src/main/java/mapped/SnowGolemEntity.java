...
public class SnowGolemEntity extends Class1056 implements Class1020, Class1022 {
   private static final DataParameter<Byte> field5709 = EntityDataManager.<Byte>createKey(SnowGolemEntity.class, DataSerializers.field33390);

   public SnowGolemEntity(EntityType<? extends SnowGolemEntity> var1, World var2) {
      super(var1, var2);
   }
   ...
   public void method4530(LivingEntity var1, float var2) {
      SnowballEntity var5 = new SnowballEntity(this.world, this);
