...
public class Class6639 {
   ...
   public static CompletableFuture<?> method20256(File var0, String var1, Map<String, String> var2, int var3, Class1339 var4, Proxy var5) {
      return CompletableFuture.supplyAsync(() -> {
         HttpURLConnection var8 = null;
         InputStream var9 = null;
         DataOutputStream var10 = null;
         if (var4 != null) {
            var4.method6417(new TranslationTextComponent("resourcepack.downloading"));
            var4.method6418(new TranslationTextComponent("resourcepack.requesting"));
         }
         ...
         try {
            try {
               ...
               for (Entry var16 : var2.entrySet()) {
                  ...
                  if (var4 != null) {
                     var4.method6419((int)(++var13 / var14 * 100.0F));
                  }
               }
               ...
               if (var4 != null) {
                  var4.method6418(new TranslationTextComponent("resourcepack.progress", String.format(Locale.ROOT, "%.2f", var14 / 1000.0F / 1000.0F)));
               }
               ...
               if (var0.exists()) {
                  ...
                  field29186.warn("Deleting {} as it does not match what we currently have ({} vs our {}).", var0, var32, var17);
               ...
               if (var8 != null) {
                  ...
                  try {
                     field29186.error(IOUtils.toString(var12));
