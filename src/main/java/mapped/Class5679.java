...
public class Class5679 extends Class5676<IllusionerEntity> {
   ...
   public Class5679(EntityRendererManager var1) {
      super(var1, new Class2823<IllusionerEntity>(0.0F, 0.0F, 64, 64), 0.5F);
      this.addLayer(new Class243(this, this));
      this.entityModel.method11026().showModel = true;
   }

   public ResourceLocation method17843(IllusionerEntity var1) {
      return field25044;
   }
   ...
   public boolean method17869(IllusionerEntity var1) {
      return true;
   }
}
