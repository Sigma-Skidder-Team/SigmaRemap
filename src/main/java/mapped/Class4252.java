...
public class Class4252 extends InteractiveWidget {
   ...
   public Class4252(GuiComponent var1, String var2, int var3, int var4, int var5, int var6, int var7, boolean var8) {
   ...
   public static void method13052(int var0, int var1, int var2, float var3) {
      byte var6 = 14;
      RenderUtil.drawCircle((float) var0, (float) var1, (float) var6,
            MultiUtilities.applyAlpha(ClientColors.DEEP_TEAL.getColor(), 0.1F * var3));
      RenderUtil.drawCircle((float) var0, (float) var1, (float) (var6 - 1),
            MultiUtilities.applyAlpha(ClientColors.DEEP_TEAL.getColor(), 0.14F * var3));
      RenderUtil.drawCircle((float) var0, (float) var1, (float) (var6 - 2),
