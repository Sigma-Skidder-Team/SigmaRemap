...
public class GatherPOITask extends Class3676<CreatureEntity> {
   private static String[] field19740;
   private final PointOfInterestType field19741;
   ...
   public GatherPOITask(PointOfInterestType var1, MemoryModuleType<Class9378> var2, MemoryModuleType<Class9378> var3, boolean var4, Optional<Byte> var5) {
   ...
   public GatherPOITask(PointOfInterestType var1, MemoryModuleType<Class9378> var2, boolean var3, Optional<Byte> var4) {
   ...
   public void startExecuting(ServerWorld var1, CreatureEntity var2, long var3) {
      ...
      PointOfInterestManager pointofinterestmanager = var1.getPointOfInterestManager();
      ...
      Set<BlockPos> var9 = pointofinterestmanager.func_242324_b(this.field19741.getPredicate(), var8, var2.getPosition(), 48, PointOfInterestManager.Status.HAS_SPACE).limit(5L).collect(Collectors.toSet());
      Class8238 var10 = var2.method4230().method21650(var9, this.field19741.getValidRange());
      if (var10 != null && var10.method28708()) {
         BlockPos var13 = var10.method28712();
         pointofinterestmanager.getType(var13).ifPresent(var5 -> {
            pointofinterestmanager.take(this.field19741.getPredicate(), var1xx -> var1xx.equals(var13), var13, 1);
