...
public class Class4513 extends Class4500
{
    ...
    public Class4513(final int n, final Random random, final Class6997 field19849, final Class179 class179) {
    ...
    public Class4513(final Class1795 class1795, final Class51 class1796) {
        super(Class9520.field40975, class1796);
        this.field19914 = class1796.method329("Left");
        this.field19915 = class1796.method329("Right");
    }
    
    @Override
    public void method13415(final Class51 class51) {
        super.method13415(class51);
        class51.method312("Left", this.field19914);
        class51.method312("Right", this.field19915);
    }
    ...
    public static Class4513 method13508(final List<Class4473> list, final Random random, final int n, final int n2, final int n3, final Class179 class179, final int n4) {
    ...
    public boolean method13421(final Class1851 class1851, final Class6346<?> class1852, final Random random, final Class6997 class1853, final Class7859 class1854) {
        ...
        final Class7096 class1855 = ((Class7097<O, Class7096>)Class7521.field29288.method11878()).method21773((Class7111<Comparable>)Class4023.field18110, Class179.field516);
        final Class7096 class1856 = ((Class7097<O, Class7096>)Class7521.field29288.method11878()).method21773((Class7111<Comparable>)Class4023.field18110, Class179.field515);
