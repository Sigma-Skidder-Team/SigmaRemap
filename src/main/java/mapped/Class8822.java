...
public class Class8822 extends Class8823 {
   private static final Map<String, String> field39784 = ImmutableMap.<String, String>builder()
   ...
   public Class8822(Schema var1, boolean var2) {
      super(var1, var2, "AdvancementsFix", var0 -> field39784.getOrDefault(var0, var0));
   }
}
