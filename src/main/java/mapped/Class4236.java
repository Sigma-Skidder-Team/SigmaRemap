...
{
    private final Class3833 field19049;
    private final Class9357 field19050;
    
    public Class4236(final Class3833 field19049, final Class9357 field19050) {
        super(Class4632.method13817());
        this.field19049 = field19049;
        this.field19050 = field19050;
    }
    
    public static Class4236 method12737(final Class3833 class3833) {
    ...
    public JsonElement method12682() {
        ...
        if (this.field19049 != null) {
            jsonObject.addProperty("block", Class90.field208.method503(this.field19049).toString());
        }
