...
public final class VillagerType {
   public static final VillagerType field44540 = method37067("desert");
   public static final VillagerType field44541 = method37067("jungle");
   public static final VillagerType field44542 = method37067("plains");
   public static final VillagerType field44543 = method37067("savanna");
   public static final VillagerType field44544 = method37067("snow");
   public static final VillagerType field44545 = method37067("swamp");
   public static final VillagerType field44546 = method37067("taiga");
   private final String field44547;
   private static final Map<RegistryKey<Biome>, VillagerType> field44548 = Util.<Map<RegistryKey<Biome>, VillagerType>>make(
   ...
   private static VillagerType method37067(String var0) {
      return Registry.<VillagerType, VillagerType>register(Registry.field16089, new ResourceLocation(var0), new VillagerType(var0));
   }

   public static VillagerType method37068(Optional<RegistryKey<Biome>> var0) {
      return var0.<VillagerType>flatMap(var0x -> Optional.ofNullable(field44548.get(var0x))).orElse(field44542);
   }
}
