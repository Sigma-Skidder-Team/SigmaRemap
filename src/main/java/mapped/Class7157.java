...
public class Class7157 extends Class7133<Class6932>
{
    ...
    public Stream<Class354> method21918(final Class1851 class1851, final Class6346<? extends Class7065> class1852, final Random random, final Class6932 class1853, final Class354 class1854) {
        return IntStream.range(0, random.nextInt(class1853.field27159 - class1853.field27158) + class1853.field27158).mapToObj(p3 -> {
            ...
            return new Class354(n2, class1856.method6699(Class2020.field11523, n2, n3), n3);
        });
    }
}
