...
public class Class9343 {
   ...
   private final PointOfInterestType field43376;
   ...
   public static Codec<Class9343> method35350(Runnable var0) {
      return RecordCodecBuilder.create(
         var1 -> var1.group(
                  ...
                  Registry.POINT_OF_INTEREST_TYPE.fieldOf("type").forGetter(var0xx -> var0xx.field43376),
   ...
   private Class9343(BlockPos var1, PointOfInterestType var2, int var3, Runnable var4) {
   ...
   public Class9343(BlockPos var1, PointOfInterestType var2, Runnable var3) {
      this(var1, var2, var2.getMaxFreeTickets(), var3);
   }
   ...
   public boolean method35352() {
      if (this.field43377 < this.field43376.getMaxFreeTickets()) {
         this.field43377++;
         this.field43378.run();
         return true;
      } else {
   ...
   public boolean method35354() {
      return this.field43377 != this.field43376.getMaxFreeTickets();
   }
   ...
   public PointOfInterestType method35356() {
