...
public class SmallFireballEntity extends Class898 {
   private static String[] field5140;

   public SmallFireballEntity(EntityType<? extends SmallFireballEntity> var1, World var2) {
      super(var1, var2);
   }

   public SmallFireballEntity(World var1, LivingEntity var2, double var3, double var5, double var7) {
      super(EntityType.SMALL_FIREBALL, var2, var3, var5, var7, var1);
   }

   public SmallFireballEntity(World var1, double var2, double var4, double var6, double var8, double var10, double var12) {
