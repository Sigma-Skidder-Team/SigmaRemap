...
public class Class3850 extends Class3849
{
            ...
            try (final Class386 method1296 = Class386.method1296()) {
                ...
                for (int length = values.length, i = 0; i < length; ++i) {
                    ...
                    if (method1297.method21696() == this && !this.method11911(method1297, class7097, method1296)) {
                        class7097.method6907().method21345(method1296, this, Class9546.method35658(random, 20, 40));
                    }
                }
            }
        }
        else {
            class7097.method6907().method21345(class7098, this, Class9546.method35658(random, 20, 40));
        }
    }
    
    private boolean method11911(final Class7096 class7096, final Class1847 class7097, final Class354 class7098) {
    ...
    private boolean method11912(final Class1855 class1855, final Class354 class1856, final int n) {
        int n2 = 0;
        try (final Class386 method1296 = Class386.method1296()) {
            final Class179[] values = Class179.values();
            for (int length = values.length, i = 0; i < length; ++i) {
