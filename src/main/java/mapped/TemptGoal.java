...
public class TemptGoal extends Class2595 {
   ...
   public TemptGoal(CreatureEntity var1, double var2, Ingredient var4, boolean var5) {
      this(var1, var2, var5, var4);
   }

   public TemptGoal(CreatureEntity var1, double var2, boolean var4, Ingredient var5) {
   ...
   public boolean method10806() {
      if (this.method10899()) {
         if (!(this.field17079.getDistanceSq(this.field17086) < 36.0)) {
            ...
            if (this.field17086.getDistanceSq(this.field17081, this.field17082, this.field17083) > 0.010000000000000002) {
               return false;
            }
