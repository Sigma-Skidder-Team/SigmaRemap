...
public class Class7961 implements Class7954
{
    ...
    private final Class8321 field32712;
    ...
    public Class7961(final Class3833 class3833, final int n, final int n2, final int n3, final int n4) {
        this(new Class8321(class3833), n, n2, n3, n4);
    }
    
    public Class7961(final Class3820 class3820, final int n, final int n2, final int n3) {
        this(new Class8321(class3820), n, n2, 12, n3);
    }
    
    public Class7961(final Class3820 class3820, final int n, final int n2, final int n3, final int n4) {
        this(new Class8321(class3820), n, n2, n3, n4);
    }
    
    public Class7961(final Class8321 class8321, final int n, final int n2, final int n3, final int n4) {
        this(class8321, n, n2, n3, n4, 0.05f);
    }
    
    public Class7961(final Class8321 field32712, final int field32713, final int field32714, final int field32715, final int field32716, final float field32717) {
    ...
    public Class9017 method25804(final Class399 class399, final Random random) {
        return new Class9017(new Class8321(Class7739.field31514, this.field32713), new Class8321(this.field32712.method27622(), this.field32714), this.field32715, this.field32716, this.field32717);
    }
}
