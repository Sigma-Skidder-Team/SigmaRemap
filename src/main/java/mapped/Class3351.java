...
public class Class3351 extends Class3350 {
   ...
   public Class3351(Properties var1) {
      super(var1);
   }
   ...
   public void method11918(World var1, BlockPos var2, PlayerEntity var3) {
      ...
      if (var6 instanceof Class987) {
         ...
         var3.method2911(Stats.field40165);
      }
   }
   ...
   public void animateTick(BlockState var1, World var2, BlockPos var3, Random var4) {
      if (var1.<Boolean>get(field18876)) {
         ...
         if (var4.nextDouble() < 0.1) {
            var2.playSound(var7, var9, var11, SoundEvents.field26416, SoundCategory.field14732, 1.0F, 1.0F, false);
         }
