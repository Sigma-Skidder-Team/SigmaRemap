...
public final class Class8321
{
    ...
    public <T extends Class511> void method27636(final int n, final T t, final Consumer<T> consumer) {
        if (!t.field2391.field10067) {
    ...
    public void method27637(final Class511 class511, final Class512 class512) {
        final Class3820 method27622 = this.method27622();
    ...
    public boolean method27640(final Class512 class512, final Class511 class513, final Class316 class514) {
    ...
    public void method27651(final Class1847 class1847, final Class512 class1848, final int n) {
    ...
    public void method27654(final Class1847 class1847, final Class511 class1848, final int n) {
    ...
    public List<Class2250> method27668(final Class512 class512, final Class1981 class513) {
        ...
        if (!class513.method7991() && !this.method27667() && this.method27622() == Class7739.field31425) {
            arrayList.add(new Class2260("#" + Class4094.method12329(this)).method8469(Class2116.field12316));
        }
        int method8470 = 0;
        ...
        if ((method8470 & 0x20) == 0x0) {
            this.method27622().method11728(this, (class512 == null) ? null : class512.field2391, arrayList, class513);
        }
        if (this.method27656()) {
            ...
            if (this.field34179.method316("display", 10)) {
                ...
                if (method8471.method316("color", 3)) {
                    if (class513.method7991()) {
                        arrayList.add(new Class2259("item.color", new Object[] { String.format("#%06X", method8471.method319("color")) }).method8469(Class2116.field12316));
                    }
                    else {
                        arrayList.add(new Class2259("item.dyed", new Object[0]).method8468(Class2116.field12316, Class2116.field12329));
                    }
                }
        ...
        for (final Class2215 class514 : Class2215.values()) {
            ...
            if (!method8475.isEmpty() && (method8470 & 0x2) == 0x0) {
                arrayList.add(new Class2260(""));
                arrayList.add(new Class2259("item.modifiers." + class514.method8404(), new Object[0]).method8469(Class2116.field12316));
        ...
        if (this.method27656() && this.method27657().method329("Unbreakable") && (method8470 & 0x4) == 0x0) {
            arrayList.add(new Class2259("item.unbreakable", new Object[0]).method8469(Class2116.field12318));
        }
        if (this.method27656() && this.field34179.method316("CanDestroy", 9) && (method8470 & 0x8) == 0x0) {
            ...
            if (!method8477.isEmpty()) {
                arrayList.add(new Class2260(""));
                arrayList.add(new Class2259("item.canBreak", new Object[0]).method8469(Class2116.field12316));
        ...
        if (this.method27656() && this.field34179.method316("CanPlaceOn", 9) && (method8470 & 0x10) == 0x0) {
            ...
            if (!method8478.isEmpty()) {
                arrayList.add(new Class2260(""));
                arrayList.add(new Class2259("item.canPlace", new Object[0]).method8469(Class2116.field12316));
        ...
        if (class513.method7991()) {
            ...
            arrayList.add(new Class2260(Class90.field211.method503(this.method27622()).toString()).method8469(Class2116.field12317));
            if (this.method27656()) {
                arrayList.add(new Class2259("item.nbt_tags", new Object[] { this.method27657().method293().size() }).method8469(Class2116.field12317));
            }
        }
        return arrayList;
    }
    ...
    private static Collection<Class2250> method27670(final String s) {
        try {
            ...
            if (b || b2) {
                if (b) {
                    return Lists.newArrayList((Iterable)method23803.method21696().method11855().method8469(Class2116.field12317));
                }
        ...
        return Lists.newArrayList((Iterable)new Class2260("missingno").method8469(Class2116.field12317));
    }
    ...
    public void method27676(final String s, final Class41 class41) {
    ...
    public void method27694(final Class1847 class1847, final Class511 class1848, final int n) {
