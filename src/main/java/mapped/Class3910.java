...
public abstract class Class3910 extends Class3911
{
    ...
    private static boolean method12015(final Class7096 class7096, final Class1852 class7097, final Class354 class7098) {
        final Class354 method1137 = class7098.method1137();
        final Class7096 method1138 = class7097.method6701(method1137);
        return (method1138.method21696() == Class7521.field29329 && method1138.method21772((Class7111<Integer>)Class4030.field18124) == 1) || Class1890.method7299(class7097, class7096, class7098, method1138, method1137, Class179.field512, method1138.method21700(class7097, method1137)) < class7097.method6985();
    }
    
    private static boolean method12016(final Class7096 class7096, final Class1852 class7097, final Class354 class7098) {
        final Class354 method1137 = class7098.method1137();
    ...
    public void method11822(final Class7096 class7096, final Class1849 class7097, final Class354 class7098, final Random random) {
        if (method12015(class7096, class7097, class7098)) {
            if (class7097.method6969(class7098.method1137()) >= 9) {
                ...
                for (int i = 0; i < 4; ++i) {
                    final Class354 method11879 = class7098.method1134(random.nextInt(3) - 1, random.nextInt(5) - 3, random.nextInt(3) - 1);
