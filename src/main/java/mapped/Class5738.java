...
public class Class5738 extends EntityRenderer<FishingBobberEntity> {
   ...
   public void render(FishingBobberEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn) {
      PlayerEntity var9 = entityIn.method3544();
      if (var9 != null) {
         matrixStackIn.push();
         matrixStackIn.push();
         ...
         Class8892 var10 = matrixStackIn.getLast();
         Matrix4f var11 = var10.getMatrix();
         Matrix3f var12 = var10.method32362();
         IVertexBuilder var13 = bufferIn.getBuffer(field25160);
         method17922(var13, var11, var12, packedLightIn, 0.0F, 0, 0, 1);
         method17922(var13, var11, var12, packedLightIn, 1.0F, 0, 1, 1);
         method17922(var13, var11, var12, packedLightIn, 1.0F, 1, 1, 0);
         method17922(var13, var11, var12, packedLightIn, 0.0F, 1, 0, 0);
         matrixStackIn.pop();
         ...
         float var16 = var9.getSwingProgress(partialTicks);
         float var17 = MathHelper.sin(MathHelper.sqrt(var16) * (float) Math.PI);
         float var18 = MathHelper.lerp(partialTicks, var9.prevRenderYawOffset, var9.renderYawOffset) * (float) (Math.PI / 180.0);
         ...
         if ((this.field25097.options == null || this.field25097.options.getPointOfView().func_243192_a()) && var9 == Minecraft.getInstance().player) {
            ...
            var35 = var35.method11350(-MathHelper.lerp(partialTicks, var9.prevRotationPitch, var9.rotationPitch) * (float) (Math.PI / 180.0));
            var35 = var35.method11351(-MathHelper.lerp(partialTicks, var9.prevRotationYaw, var9.rotationYaw) * (float) (Math.PI / 180.0));
            var35 = var35.method11351(var17 * 0.5F);
            var35 = var35.method11350(-var17 * 0.7F);
            var27 = MathHelper.lerp((double) partialTicks, var9.prevPosX, var9.getPosX()) + var35.x;
            var29 = MathHelper.lerp((double) partialTicks, var9.prevPosY, var9.getPosY()) + var35.y;
            var31 = MathHelper.lerp((double) partialTicks, var9.prevPosZ, var9.getPosZ()) + var35.z;
            var36 = var9.getEyeHeight();
         } else {
            var27 = MathHelper.lerp((double) partialTicks, var9.prevPosX, var9.getPosX()) - var21 * var23 - var19 * 0.8;
            var29 = var9.prevPosY + (double)var9.getEyeHeight() + (var9.getPosY() - var9.prevPosY) * (double) partialTicks - 0.45;
            var31 = MathHelper.lerp((double) partialTicks, var9.prevPosZ, var9.getPosZ()) - var19 * var23 + var21 * 0.8;
            var36 = !var9.isCrouching() ? 0.0F : -0.1875F;
         }

         double var49 = MathHelper.lerp((double) partialTicks, entityIn.prevPosX, entityIn.getPosX());
         double var37 = MathHelper.lerp((double) partialTicks, entityIn.prevPosY, entityIn.getPosY()) + 0.25;
         double var39 = MathHelper.lerp((double) partialTicks, entityIn.prevPosZ, entityIn.getPosZ());
         float var41 = (float)(var27 - var49);
         float var42 = (float)(var29 - var37) + var36;
         float var43 = (float)(var31 - var39);
         IVertexBuilder var44 = bufferIn.getBuffer(RenderType.getLines());
         Matrix4f var45 = matrixStackIn.getLast().getMatrix();
         byte var46 = 16;
