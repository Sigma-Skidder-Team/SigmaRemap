...
public class MoveTowardsRaidGoal<T extends AbstractRaiderEntity> extends Class2595 {
   private static String[] field17240;
   private final T field17241;

   public MoveTowardsRaidGoal(T var1) {
   ...
   private void method10940(Raid var1) {
      if (var1.method25433()) {
         ...
         List<AbstractRaiderEntity> var5 = this.field17241
            .world
            .getEntitiesInAABBexcluding(
               AbstractRaiderEntity.class, this.field17241.getBoundingBox().grow(16.0), var1x -> !var1x.method4552() && Class7531.method24612(var1x, var1)
            );
         var4.addAll(var5);
