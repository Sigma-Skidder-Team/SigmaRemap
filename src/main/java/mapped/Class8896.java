...
public class Class8896 {
      ...
      if (var2.length <= 0) {
         ...
         for (int var8 = 0; var8 < var2.length; var8++) {
            ...
            if (var9.length() > 0) {
               ...
               String[] var15 = Config.method26903(var12, ",");
   ...
   public int[] method32399(String var1) {
      if (var1 == null) {
         ...
         for (int var6 = 0; var6 < var5.length; var6++) {
            String var7 = var5[var6];
            if (!var7.contains("-")) {
               int var14 = Config.method26899(var7, -1);
               if (var14 >= 0) {
                  var4.add(var14);
               } else {
   ...
   public Direction method32401(String var1) {
      ...
      if (var1.equals("bottom") || var1.equals("down")) {
         ...
         Config.method26811("Unknown face: " + var1);
         return null;
      } else {
   ...
   public void method32402(String var1) {
      Config.method26810("" + this.field40258 + ": " + var1);
   }

   public void method32403(String var1) {
      Config.method26811("" + this.field40258 + ": " + var1);
   }
   ...
   private Class7589 method32405(String var1) {
      if (var1 != null) {
         if (var1.indexOf(45) < 0) {
            int var7 = Config.method26899(var1, -1);
            if (var7 >= 0) {
            ...
            String[] var4 = Config.method26903(var1, "-");
            if (var4.length == 2) {
               int var5 = Config.method26899(var4[0], -1);
               int var6 = Config.method26899(var4[1], -1);
               if (var5 >= 0 && var6 >= 0) {
   ...
   public <T> T[] method32412(String var1, T[] var2, Class7855 var3, String var4, T[] var5) {
      if (var1 == null) {
         ...
         var1 = var1.toLowerCase().trim();
         String[] var8 = Config.method26903(var1, " ");
   ...
   private Class9710 method32419(String var1) {
      ...
      VillagerProfession var9 = this.method32420(var4);
      if (var9 != null) {
   ...
   private VillagerProfession method32420(String var1) {
      if (var1 != null) {
         var1 = var1.toLowerCase();
         ResourceLocation var4 = new ResourceLocation(var1);
         Class2351 var5 = Registry.VILLAGER_PROFESSION;
         return var5.method9193(var4) ? (VillagerProfession)var5.getOrDefault(var4) : null;
      } else {
         return null;
      }
   }
   ...
   public int[] method32421(String var1) {
      ...
      return Config.method26976(var12);
   }
