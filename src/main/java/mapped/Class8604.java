...
public class Class8604 extends Schema {
    ...
    public static TypeTemplate method30792(Schema var0) {
        return DSL.optionalFields("Equipment", DSL.list(TypeReferences.ITEM_STACK.in(var0)));
    }
    ...
    public static void method30795(Schema var0, Map<String, Supplier<TypeTemplate>> var1, String var2) {
        var0.register(var1, var2, () -> DSL.optionalFields("DisplayTile", TypeReferences.BLOCK_NAME.in(var0)));
    }
    ...
    public Map<String, Supplier<TypeTemplate>> registerEntities(Schema var1) {
        ...
        var1.register(var4, "Item", var1x -> DSL.optionalFields("Item", TypeReferences.ITEM_STACK.in(var1)));
        ...
        var1.register(var4, "Arrow", var1x -> DSL.optionalFields("inTile", TypeReferences.BLOCK_NAME.in(var1)));
        var1.register(var4, "TippedArrow", var1x -> DSL.optionalFields("inTile", TypeReferences.BLOCK_NAME.in(var1)));
        var1.register(var4, "SpectralArrow", var1x -> DSL.optionalFields("inTile", TypeReferences.BLOCK_NAME.in(var1)));
        ...
        var1.register(var4, "ThrownPotion", var1x -> DSL.optionalFields("inTile", TypeReferences.BLOCK_NAME.in(var1), "Potion", TypeReferences.ITEM_STACK.in(var1)));
        method30794(var1, var4, "ThrownExpBottle");
        var1.register(var4, "ItemFrame", var1x -> DSL.optionalFields("Item", TypeReferences.ITEM_STACK.in(var1)));
        method30794(var1, var4, "WitherSkull");
        var1.registerSimple(var4, "PrimedTnt");
        var1.register(var4, "FallingSand", var1x -> DSL.optionalFields("Block", TypeReferences.BLOCK_NAME.in(var1), "TileEntityData", TypeReferences.BLOCK_ENTITY.in(var1)));
        var1.register(var4, "FireworksRocketEntity", var1x -> DSL.optionalFields("FireworksItem", TypeReferences.ITEM_STACK.in(var1)));
        var1.registerSimple(var4, "Boat");
        var1.register(var4, "Minecart", () -> DSL.optionalFields("DisplayTile", TypeReferences.BLOCK_NAME.in(var1), "Items", DSL.list(TypeReferences.ITEM_STACK.in(var1))));
        method30795(var1, var4, "MinecartRideable");
        var1.register(
                var4, "MinecartChest", var1x -> DSL.optionalFields("DisplayTile", TypeReferences.BLOCK_NAME.in(var1), "Items", DSL.list(TypeReferences.ITEM_STACK.in(var1)))
        );
        method30795(var1, var4, "MinecartFurnace");
        method30795(var1, var4, "MinecartTNT");
        var1.register(var4, "MinecartSpawner", () -> DSL.optionalFields("DisplayTile", TypeReferences.BLOCK_NAME.in(var1), TypeReferences.UNTAGGED_SPAWNER.in(var1)));
        var1.register(
                var4, "MinecartHopper", var1x -> DSL.optionalFields("DisplayTile", TypeReferences.BLOCK_NAME.in(var1), "Items", DSL.list(TypeReferences.ITEM_STACK.in(var1)))
        );
        ...
        var1.register(var4, "Enderman", var1x -> DSL.optionalFields("carried", TypeReferences.BLOCK_NAME.in(var1), method30792(var1)));
    ...
    public Map<String, Supplier<TypeTemplate>> registerBlockEntities(Schema var1) {
        ...
        var1.register(var4, "RecordPlayer", var1x -> DSL.optionalFields("RecordItem", TypeReferences.ITEM_STACK.in(var1)));
        method30796(var1, var4, "Trap");
        method30796(var1, var4, "Dropper");
        var1.registerSimple(var4, "Sign");
        var1.register(var4, "MobSpawner", var1x -> TypeReferences.UNTAGGED_SPAWNER.in(var1));
        ...
        var1.register(var4, "FlowerPot", var1x -> DSL.optionalFields("Item", DSL.or(DSL.constType(DSL.intType()), TypeReferences.ITEM_NAME.in(var1))));
    ...
    public void registerTypes(Schema var1, Map<String, Supplier<TypeTemplate>> var2, Map<String, Supplier<TypeTemplate>> var3) {
        ...
        var1.registerType(
                ...
                () -> DSL.optionalFields("Inventory", DSL.list(TypeReferences.ITEM_STACK.in(var1)), "EnderItems", DSL.list(TypeReferences.ITEM_STACK.in(var1)))
        );
        var1.registerType(
                false,
        ...
        var1.registerType(true, TypeReferences.BLOCK_ENTITY, () -> DSL.taggedChoiceLazy("id", DSL.string(), var3));
        var1.registerType(true, TypeReferences.ENTITY_TREE, () -> DSL.optionalFields("Riding", TypeReferences.ENTITY_TREE.in(var1), TypeReferences.ENTITY.in(var1)));
        var1.registerType(false, TypeReferences.ENTITY_NAME, () -> DSL.constType(Class3639.method12354()));
        ...
        var1.registerType(
                ...
                () -> DSL.hook(
                        DSL.optionalFields(
                                "id",
                                DSL.or(DSL.constType(DSL.intType()), TypeReferences.ITEM_NAME.in(var1)),
                                "tag",
                                DSL.optionalFields(
                                        "EntityTag",
        ...
        var1.registerType(false, TypeReferences.BLOCK_NAME, () -> DSL.or(DSL.constType(DSL.intType()), DSL.constType(Class3639.method12354())));
        var1.registerType(false, TypeReferences.ITEM_NAME, () -> DSL.constType(Class3639.method12354()));
        var1.registerType(false, TypeReferences.STATS, DSL::remainder);
        var1.registerType(
                false,
        ...
        var1.registerType(false, TypeReferences.STRUCTURE_FEATURE, DSL::remainder);
        var1.registerType(false, TypeReferences.OBJECTIVE, DSL::remainder);
        var1.registerType(false, TypeReferences.TEAM, DSL::remainder);
        var1.registerType(true, TypeReferences.UNTAGGED_SPAWNER, DSL::remainder);
