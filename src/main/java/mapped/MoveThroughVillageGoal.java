...
public class MoveThroughVillageGoal extends Class2595 {
   ...
   public MoveThroughVillageGoal(CreatureEntity var1, double var2, boolean var4, int var5, BooleanSupplier var6) {
            ...
            if (!var3.method6954(var4, 6)) {
               ...
               Vector3d var5 = Class8037.method27584(this.field17103, 15, 7, var3x -> {
                  if (var3.method6952(var3x)) {
                     Optional var6x = var3.getPointOfInterestManager().find(PointOfInterestType.MATCH_ANY, this::method10902, var3x, 10, PointOfInterestManager.Status.IS_OCCUPIED);
               ...
               if (var5 == null) {
                  ...
                  Optional var6 = var3.getPointOfInterestManager().find(PointOfInterestType.MATCH_ANY, this::method10902, new BlockPos(var5), 10, PointOfInterestManager.Status.IS_OCCUPIED);
                  if (!var6.isPresent()) {
                     return false;
                  } else {
                     this.field17106 = ((BlockPos)var6.get()).toImmutable();
