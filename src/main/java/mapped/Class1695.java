...
public class Class1695 implements AutoCloseable {
   ...
   private void method7291(MatrixStack var1, IRenderTypeBuffer var2, boolean var3, int var4) {
      boolean var7 = false;
      boolean var8 = false;
      float var9 = 0.0F;
      Matrix4f var10 = var1.getLast().getMatrix();
      IVertexBuilder var11 = var2.getBuffer(this.field9233);
      ...
      for (Class7982 var14 : this.field9231.field32327.values()) {
         if (!var3 || var14.method27130()) {
            ...
            float var21 = -0.001F;
            IVertexBuilder var22 = var2.getBuffer(Class194.method599());
   ...
   // $VF: synthetic method
   public static void method7293(Class1695 var0, MatrixStack var1, IRenderTypeBuffer var2, boolean var3, int var4) {
