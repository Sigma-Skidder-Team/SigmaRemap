...
public class Class210 extends SectionLightStorage<Class7587> {
   ...
   public int method702(long var1) {
      ...
      int var7 = SectionPos.extractY(var5);
      ...
      if (var9 != Class7587.method24837(var8) && var7 < var9) {
         ...
         if (var10 == null) {
            for (var1 = BlockPos.method8334(var1); var10 == null; var10 = this.method700(var8, var5)) {
               var5 = SectionPos.withOffset(var5, Direction.UP);
               if (++var7 >= var9) {
                  return 15;
               }
   ...
   public void method710(long var1) {
      int var5 = SectionPos.extractY(var1);
      ...
      if (var8 < var5 + 1) {
         ...
         if (this.field790.contains(var6)) {
            ...
            if (var8 > Class7587.method24837(this.field776)) {
               long var9 = SectionPos.asLong(SectionPos.extractX(var1), var8 - 1, SectionPos.extractZ(var1));
               this.method719(var9);
            }
   ...
   public void method711(long var1) {
      ...
      int var8 = SectionPos.extractY(var1);
      if (Class7587.method24836(this.field776).get(var5) == var8 + 1) {
         long var9;
         for (var9 = var1; !this.hasSection(var9) && this.method722(var8); var9 = SectionPos.withOffset(var9, Direction.DOWN)) {
            var8--;
         }
   ...
   public void setColumnEnabled(long var1, boolean var3) {
      ...
      if (var3 && this.field790.add(var1)) {
         ...
         if (var6 != Class7587.method24837(this.field776)) {
            long var7 = SectionPos.asLong(SectionPos.extractX(var1), var6 - 1, SectionPos.extractZ(var1));
            this.method720(var7);
            this.method721();
         }
      } else if (!var3) {
   ...
   public NibbleArray method705(long var1) {
      ...
      if (var5 != null) {
         ...
         long var6 = SectionPos.withOffset(var1, Direction.UP);
         int var8 = Class7587.method24836(this.field776).get(SectionPos.toSectionColumnPos(var1));
         if (var8 != Class7587.method24837(this.field776) && SectionPos.extractY(var6) < var8) {
            NibbleArray var9;
            while ((var9 = this.method699(var6, true)) == null) {
               var6 = SectionPos.withOffset(var6, Direction.UP);
            }
             ...
             for (long var7 : this.field788) {
                 ...
                 if (var9 != 2 && !this.field789.contains(var7) && this.field787.add(var7)) {
                     if (var9 == 1) {
                         ...
                         int var34 = SectionPos.toWorld(SectionPos.extractX(var7));
                         int var36 = SectionPos.toWorld(SectionPos.extractY(var7));
                         int var12 = SectionPos.toWorld(SectionPos.extractZ(var7));

                         for (Direction var16 : field786) {
                             long var17 = SectionPos.withOffset(var7, var16);
                             if ((this.field789.contains(var17) || !this.field787.contains(var17) && !this.field788.contains(var17)) && this.hasSection(var17)) {
                                 for (int var19 = 0; var19 < 16; var19++) {
                                     for (int var20 = 0; var20 < 16; var20++) {
                                         ...
                                         var1.scheduleUpdate(var21, var23, var1.getEdgeLevel(var21, var23, 0), true);
                                     }
                                 }
                             }
                         }
                         ...
                         for (int var37 = 0; var37 < 16; var37++) {
                             for (int var38 = 0; var38 < 16; var38++) {
                                 long var25 = BlockPos.pack(
                                         SectionPos.toWorld(SectionPos.extractX(var7)) + var37,
                                         SectionPos.toWorld(SectionPos.extractY(var7)),
                                         SectionPos.toWorld(SectionPos.extractZ(var7)) + var38
                                 );
                                 long var39 = BlockPos.pack(
                                         SectionPos.toWorld(SectionPos.extractX(var7)) + var37,
                                         SectionPos.toWorld(SectionPos.extractY(var7)) - 1,
                                         SectionPos.toWorld(SectionPos.extractZ(var7)) + var38
                                 );
                                 var1.scheduleUpdate(var25, var39, var1.getEdgeLevel(var25, var39, 0), true);
                             }
                         }
                     } else {
                         for (int var10 = 0; var10 < 16; var10++) {
                             for (int var11 = 0; var11 < 16; var11++) {
                                 long var27 = BlockPos.pack(
                                         SectionPos.toWorld(SectionPos.extractX(var7)) + var10,
                                         SectionPos.toWorld(SectionPos.extractY(var7)) + 16 - 1,
                                         SectionPos.toWorld(SectionPos.extractZ(var7)) + var11
                                 );
                                 var1.scheduleUpdate(Long.MAX_VALUE, var27, 0, true);
                             }
                         }
                     }
                 }
                     ...
                     for (int var33 = 0; var33 < 16; var33++) {
                         for (int var35 = 0; var35 < 16; var35++) {
                             long var29 = BlockPos.pack(
                                     SectionPos.toWorld(SectionPos.extractX(var32)) + var33,
                                     SectionPos.toWorld(SectionPos.extractY(var32)) + 16 - 1,
                                     SectionPos.toWorld(SectionPos.extractZ(var32)) + var35
                             );
                             var1.scheduleUpdate(Long.MAX_VALUE, var29, 15, false);
                         }
                     }
                 }
             }
   ...
   public boolean method723(long var1) {
      ...
      if ((var5 & 15) == 15) {
         ...
         if (this.field790.contains(var8)) {
            ...
            return SectionPos.toWorld(var10) == var5 + 16;
         } else {
            return false;
         }
      } else {
   ...
   public boolean method724(long var1) {
      ...
      return var7 == Class7587.method24837(this.field776) || SectionPos.extractY(var1) >= var7;
   }
