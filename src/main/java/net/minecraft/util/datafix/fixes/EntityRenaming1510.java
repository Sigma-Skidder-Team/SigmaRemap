...
public class EntityRenaming1510 extends TypedEntityRenameHelper {
   public static final Map<String, String> ENTITY_RENAME_MAP = ImmutableMap.<String, String>builder()
      ...
      .build();
   public static final Map<String, String> BLOCK_RENAME_MAP = ImmutableMap.<String, String>builder()
      ...
      .build();
   public static final Map<String, String> ITEM_RENAME_MAP = ImmutableMap.<String, String>builder()
      .putAll(BLOCK_RENAME_MAP)
   ...
   public EntityRenaming1510(Schema var1, boolean var2) {
   ...
   public String rename(String var1) {
      ...
      return ENTITY_RENAME_MAP.getOrDefault(var1, var1);
   }
}
