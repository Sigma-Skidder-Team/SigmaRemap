...
public class CryptManager {
   public static SecretKey method32736() throws CryptException {
      try {
   ...
   public static byte[] method32738(String var0, PublicKey var1, SecretKey var2) throws CryptException {
      try {
   ...
   public static PublicKey decodePublicKey(byte[] var0) throws CryptException {
      try {
   ...
   public static SecretKey method32741(PrivateKey var0, byte[] var1) throws CryptException {
   ...
   public static byte[] method32742(Key var0, byte[] var1) throws CryptException {
      return method32744(1, var0, var1);
   }

   public static byte[] method32743(Key var0, byte[] var1) throws CryptException {
      return method32744(2, var0, var1);
   }

   private static byte[] method32744(int var0, Key var1, byte[] var2) throws CryptException {
      try {
   ...
   public static Cipher method32746(int var0, Key var1) throws CryptException {
      try {
