...
import mapped.DelegatedTaskExecutor;
...
public class ChatFilterClient$ProfileFilter implements IChatFilter {
   ...
   public ChatFilterClient$ProfileFilter(ChatFilterClient this$0, GameProfile p_i244507_2_) {
      ...
      DelegatedTaskExecutor var5 = DelegatedTaskExecutor.method1650(ChatFilterClient.access$200(this$0), "chat stream for " + p_i244507_2_.getName());
