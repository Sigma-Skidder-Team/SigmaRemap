...
public class HoverEvent
{
   ...
   public static HoverEvent deserialize(JsonObject json)
   {
      ...
      else
      {
         ...
         else
         {
            ...
            {
               ITextComponent itextcomponent = ITextComponent.Serializer.getComponentFromJson(json.get("value").toString());
   ...
   {
      public static final Action<ITextComponent> SHOW_TEXT = new Action<ITextComponent>(
   ...
   public static class EntityHover
   {
      ...
      public static HoverEvent.EntityHover deserialize(JsonElement element)
      {
         ...
         else
         {
            ...
            ITextComponent itextcomponent = ITextComponent.Serializer.getComponentFromJson(jsonobject.get("name").toString());
