...
public class ClientWorld extends World {
   ...
   public int getBlockColor(BlockPos var1, ColorResolver var2) {
      ...
      return var5.method32731(var1, () -> this.getBlockColorRaw(var1, var2));
   }

   public int getBlockColorRaw(BlockPos var1, ColorResolver var2) {
   ...
   public BlockPos method6880() {
      ...
      if (!this.getWorldBorder().contains(var3)) {
         var3 = this.getHeight(Heightmap.Type.MOTION_BLOCKING,
