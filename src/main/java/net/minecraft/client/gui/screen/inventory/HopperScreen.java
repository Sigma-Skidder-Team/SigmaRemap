...
import mapped.Class5816;
import net.minecraft.entity.player.PlayerInventory;
import net.minecraft.util.ResourceLocation;
import net.minecraft.util.text.ITextComponent;

public class HopperScreen extends ContainerScreen<Class5816> {
   private static final ResourceLocation field4814 = new ResourceLocation("textures/gui/container/hopper.png");

   public HopperScreen(Class5816 var1, PlayerInventory var2, ITextComponent var3) {
