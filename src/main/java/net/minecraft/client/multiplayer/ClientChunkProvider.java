...
public class ClientChunkProvider extends AbstractChunkProvider {
   ...
   private static boolean isValid(Chunk var0, int var1, int var2) {
      if (var0 == null) {
         return false;
      } else {
   ...
   @Nullable
   public Chunk loadChunk(int chunkX, int chunkZ, BiomeContainer biomeContainerIn, PacketBuffer packetIn, CompoundNBT nbtTagIn, int sizeIn, boolean p_228313_7_)
   {
   ...
   public void method7403(int viewDistance) {
