...
public enum RecipeBookCategories {
   ...
   CRAFTING_REDSTONE(new ItemStack(Items.REDSTONE_DUST)),
   ...
   public static final Map<RecipeBookCategories, List<RecipeBookCategories>> field_243235_w = ImmutableMap.of(
           CRAFTING_SEARCH,
   ...
   private RecipeBookCategories(ItemStack... var3) {
      this.icons = ImmutableList.copyOf(var3);
   }
