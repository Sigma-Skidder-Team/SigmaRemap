...
import mapped.Class4379;
import mapped.Class9084;
import mapped.Class9402;
import mapped.I18n;
...
public class GlDebugTextUtils {
   ...
   public static void setDebugVerbosity(int var0, boolean var1) {
         ...
         if (!var4.GL_KHR_debug) {
            if (var4.GL_ARB_debug_output) {
               ...
               ARBDebugOutput.glDebugMessageCallbackARB(
                  GLX.<GLDebugMessageARBCallbackI>make(GLDebugMessageARBCallback.create(GlDebugTextUtils::method24818), LWJGLMemoryUntracker::method29101), 0L
               );
            }
         } else {
            GL11.glEnable(37600);
            ...
            KHRDebug.glDebugMessageCallback(
               GLX.<GLDebugMessageCallbackI>make(GLDebugMessageCallback.create(GlDebugTextUtils::method24818), LWJGLMemoryUntracker::method29101), 0L
            );
         }
      }
   }
