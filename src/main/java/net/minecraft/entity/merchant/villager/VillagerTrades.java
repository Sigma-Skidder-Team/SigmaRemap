...
public class VillagerTrades {
   ...
   public static final Map<VillagerProfession, Int2ObjectMap<Class5391[]>> field45414 = Util.<Map<VillagerProfession, Int2ObjectMap<Class5391[]>>>make(
      Maps.newHashMap(),
      var0 -> {
         var0.put(
            VillagerProfession.field36016,
            method38080(
               ImmutableMap.of(
                  1,
                  new Class5391[]{
                  ...
                  new Class5391[]{
                     ...
                     new Class5390(
                        ...
                        ImmutableMap.<VillagerType, Item>builder()
                           .put(VillagerType.field44542, Items.OAK_BOAT)
                           .put(VillagerType.field44546, Items.field38121)
                           .put(VillagerType.field44544, Items.field38121)
                           .put(VillagerType.field44540, Items.field38123)
                           .put(VillagerType.field44541, Items.field38123)
                           .put(VillagerType.field44543, Items.field38124)
                           .put(VillagerType.field44545, Items.field38125)
                           .build()
                     )
                  }
               )
         ...
         var0.put(
            ...
            method38080(
               ImmutableMap.of(
                  ...
                  2,
                  new Class5391[]{
                     new Class5396(Items.IRON_INGOT, 4, 12, 10),
         ...
         var0.put(
            ...
            method38080(
               ImmutableMap.of(
                  ...
                  2,
                  new Class5391[]{new Class5396(Items.IRON_INGOT, 4, 12, 10), new Class5395(new ItemStack(Items.field38167), 36, 1, 12, 5, 0.2F)},
                  3,
