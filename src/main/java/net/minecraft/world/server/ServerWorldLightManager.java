...
public class ServerWorldLightManager extends WorldLightManager implements AutoCloseable {
   ...
   private final DelegatedTaskExecutor<Runnable> field735;
   ...
   public ServerWorldLightManager(IChunkLightProvider var1, ChunkManager var2, boolean var3, DelegatedTaskExecutor<Runnable> var4, Class321<ChunkTaskPriorityQueueSorter.FunctionEntry<Runnable>> var5) {
