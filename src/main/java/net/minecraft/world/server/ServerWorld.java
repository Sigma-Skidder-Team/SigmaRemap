...
public class ServerWorld extends World implements ISeedReader {
         ...
         for (ChunkSection var26 : var1.getSections()) {
            if (var26 != Chunk.field9111 && var26.method21860()) {
               ...
               for (int var15 = 0; var15 < var2; var15++) {
                  ...
                  BlockState var17 = var26.getBlockState(var16.getX() - var7, var16.getY() - var14, var16.getZ() - var8);
   ...
   public void notifyBlockUpdate(BlockPos var1, BlockState var2, BlockState var3, int var4) {
      ...
      VoxelShape var8 = var3.getCollisionShape(this, var1);
   ...
   public void onBlockStateChange(BlockPos var1, BlockState var2, BlockState var3) {
      Optional<PointOfInterestType> var6 = PointOfInterestType.forState(var2);
      Optional<PointOfInterestType> var7 = PointOfInterestType.forState(var3);
      if (!Objects.equals(var6, var7)) {
         BlockPos var8 = var1.toImmutable();
         var6.ifPresent(var2x -> this.getServer().execute(() -> {
               this.getPointOfInterestManager().remove(var8);
               DebugPacketSender.method23614(this, var8);
            }));
         var7.ifPresent(var2x -> this.getServer().execute(() -> {
               this.getPointOfInterestManager().add(var8, var2x);
   ...
   public boolean method6953(SectionPos var1) {
      return this.method6952(var1.getCenter());
   }
   ...
   public int method6955(SectionPos var1) {
      return this.getPointOfInterestManager().sectionsToVillage(var1);
   }
   ...
   public static void method6973(ServerWorld var0) {
      ...
      int var6 = var3.getZ();
      BlockPos.getAllInBoxMutable(var4 - 2, var5 + 1, var6 - 2, var4 + 2, var5 + 3, var6 + 2)
         .forEach(var1 -> var0.setBlockState(var1, Blocks.AIR.getDefaultState()));
      BlockPos.getAllInBoxMutable(var4 - 2, var5, var6 - 2, var4 + 2, var5, var6 + 2).forEach(var1 -> var0.setBlockState(var1, Blocks.OBSIDIAN.getDefaultState()));
   }
