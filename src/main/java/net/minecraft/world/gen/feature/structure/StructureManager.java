...
public class StructureManager {
   ...
   public Stream<? extends StructureStart<?>> func_235011_a_(SectionPos var1, Structure<?> var2) {
      return this.field32171
         .getChunk(var1.getSectionX(), var1.getSectionZ(), ChunkStatus.STRUCTURE_REFERENCES)
         .method7099(var2)
         .stream()
         .<SectionPos>map(var0 -> SectionPos.from(new ChunkPos(var0), 0))
         .<StructureStart<?>>map(var2x -> this.method24341(var2x, var2, this.field32171.getChunk(var2x.getSectionX(), var2x.getSectionZ(), ChunkStatus.STRUCTURE_STARTS)))
