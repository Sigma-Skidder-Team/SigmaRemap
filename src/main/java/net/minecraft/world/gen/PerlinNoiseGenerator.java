...
public class PerlinNoiseGenerator implements Class7690 {
   private final Class8972[] field32932;
   private final double field32933;
   private final double field32934;

   public PerlinNoiseGenerator(SharedSeedRandom var1, IntStream var2) {
      this(var1, var2.boxed().collect(ImmutableList.toImmutableList()));
   }

   public PerlinNoiseGenerator(SharedSeedRandom var1, List<Integer> var2) {
      this(var1, new IntRBTreeSet(var2));
   }

   private PerlinNoiseGenerator(SharedSeedRandom var1, IntSortedSet var2) {
      if (var2.isEmpty()) {
   ...
   public double noiseAt(double var1, double var3, boolean var5) {
      double var8 = 0.0;
   ...
   public double method25314(double var1, double var3, double var5, double var7) {
      return this.noiseAt(var1, var3, true) * 0.55;
   }
}
