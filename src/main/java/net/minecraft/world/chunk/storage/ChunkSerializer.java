...
public class ChunkSerializer {
   ...
   public static ChunkPrimer read(ServerWorld var0, TemplateManager var1, PointOfInterestManager var2, ChunkPos var3, CompoundNBT var4) {
      ...
      for (int var22 = 0; var22 < var16.size(); var22++) {
         ...
         if (var30.contains("Palette", 9) && var30.contains("BlockStates", 12)) {
            ...
            var2.checkConsistencyWithBlocks(var3, var27);
         }
      ...
      if (var40 != Class2076.field13525) {
         ...
         if (!var15 && var26.getStatus().isAtLeast(ChunkStatus.LIGHT)) {
            for (BlockPos var29 : BlockPos.getAllInBoxMutable(var3.getX(), 0, var3.getZ(), var3.getXEnd(), 255, var3.getZEnd())) {
