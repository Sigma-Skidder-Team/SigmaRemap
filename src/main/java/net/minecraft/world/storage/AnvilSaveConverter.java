...
public class AnvilSaveConverter {
   ...
   private static void method34801(DynamicRegistriesImpl var0, File var1, File var2, BiomeProvider var3, int var4, int var5, Class1339 var6) {
      ...
      try (
              RegionFile var10 = new RegionFile(var2, var1, true);
              RegionFile var12 = new RegionFile(new File(var1, var9.substring(0, var9.length() - ".mcr".length()) + ".mca"), var1, true);
      ) {
         for (int var14 = 0; var14 < 32; var14++) {
            for (int var15 = 0; var15 < 32; var15++) {
               ...
               if (var10.method7265(var16) && !var12.method7265(var16)) {
                  CompoundNBT var20;
                  try (DataInputStream var17 = var10.func_222666_a(var16)) {
                     if (var17 == null) {
