...
public class Raid {
   ...
   private void method25404() {
      Stream<SectionPos> var3 = SectionPos.getAllInBox(SectionPos.from(this.field32977), 2);
      var3.filter(this.field32978::method6953)
         .map(SectionPos::getCenter)
   ...
   private void method25412(BlockPos var1) {
      ...
      for (ServerPlayerEntity var8 : this.field32978.getPlayers()) {
         ...
         if (var11 <= 64.0F || var6.contains(var8)) {
            var8.connection.sendPacket(new SPlaySoundEffectPacket(SoundEvents.field26992, SoundCategory.field14734, var12, var8.getPosY(), var14, 64.0F, 1.0F));
         }
      }
   }
