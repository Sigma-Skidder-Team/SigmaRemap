...
import mapped.SectionDistanceGraph;
...
public abstract class SectionLightStorage<M extends LightDataMap<M>> extends SectionDistanceGraph {
   ...
   @Override
   public int getSourceLevel(long var1) {
   ...
   public void method706(LightEngine<?, ?> var1, long var2) {
      if (var1.func_227467_c_() >= 8192) {
         int var6 = SectionPos.toWorld(SectionPos.extractX(var2));
         int var7 = SectionPos.toWorld(SectionPos.extractY(var2));
         int var8 = SectionPos.toWorld(SectionPos.extractZ(var2));

         for (int var9 = 0; var9 < 16; var9++) {
            for (int var10 = 0; var10 < 16; var10++) {
               for (int var11 = 0; var11 < 16; var11++) {
                  long var12 = BlockPos.pack(var6 + var9, var7 + var10, var8 + var11);
                  var1.cancelUpdate(var12);
               }
            }
         }
      } else {
         var1.func_227465_a_(var2x -> SectionPos.worldToSection(var2x) == var2);
      }
   }
   ...
   private void method709(LightEngine<M, ?> var1, long var2) {
      if (this.hasSection(var2)) {
         ...
         for (Direction var12 : field769) {
            long var13 = SectionPos.withOffset(var2, var12);
            if (!this.field779.containsKey(var13) && this.hasSection(var13)) {
               for (int var15 = 0; var15 < 16; var15++) {
                  for (int var16 = 0; var16 < 16; var16++) {
                     ...
                     var1.scheduleUpdate(var17, var19, var1.getEdgeLevel(var17, var19, var1.getLevel(var17)), false);
                     var1.scheduleUpdate(var19, var17, var1.getEdgeLevel(var19, var17, var1.getLevel(var19)), false);
                  }
               }
            }
         }
   ...
   public void updateSectionStatus(long var1, boolean var3) {
      ...
      if (!var6 && !var3) {
         ...
         this.scheduleUpdate(Long.MAX_VALUE, var1, 0, true);
      }

      if (var6 && var3) {
         this.field773.add(var1);
         this.scheduleUpdate(Long.MAX_VALUE, var1, 2, false);
      }
   }
