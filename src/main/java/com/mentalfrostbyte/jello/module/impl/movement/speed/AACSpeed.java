...
public class AACSpeed extends Module {
    ...
    public void method16009(EventMove var1) {
        if (this.isEnabled()) {
            ...
            switch (var4) {
                case "Basic":
                    this.field23401 = getAacHopSpeed(this.field23398, this.field23399, () -> this.field23399 = 0);
                    break;
                case "Fast1":
            ...
            if (this.field23398 >= 0) {
                this.field23404 = MovementUtil.setMotionWithTurnLimit(var1, this.field23401, MovementUtil.getDirectionArray()[0], this.field23404, 45.0F);
            }
    ...
    public static double getAacHopSpeed(int hopTicks, int speedStage, Runnable resetStage) {
        ...
        double[] baseSpeedByTick = new double[]{0.497, 0.3031, 0.302, base3019, base3019, base3019, base3019, base3019, base3019, base3019, base3019, 0.3, 0.301, 0.298, 0.297};
        double[] stage2AddByTick = new double[]{0.1069, 0.0642, 0.0629, 0.0607, 0.0584, 0.0561, 0.0539, 0.0517, 0.0496, 0.0475, 0.0455, 0.045, 0.042, 0.042, 0.042};
        double[] stage3AddByTick = new double[]{0.046, dynamicAdd, dynamicAdd, dynamicAdd, dynamicAdd, dynamicAdd, dynamicAdd, dynamicAdd, dynamicAdd, dynamicAdd, dynamicAdd, 0.018, dynamicAdd + 0.001, dynamicAdd + 0.001, dynamicAdd + 0.001};
        if (hopTicks >= 0) {
