            ...
            if (this.field23836) {
                if (this.getBooleanValueFromSettingName("GUI")) {
                    ...
                    if (this.field23834 != null) {
                        ...
                        RenderUtil.drawImage((float) (var6 - var4.getWidth(this.field23833) - 80), (float) (var7 - 120), 50.0F, 100.0F, this.field23834);
                        RenderUtil.drawString(
                                var4, (float) (var6 - var4.getWidth(this.field23833) - 20), (float) (var7 - var4.getHeight(this.field23833) - 60), this.field23833, -1
                        );
                    }
                }
            }
