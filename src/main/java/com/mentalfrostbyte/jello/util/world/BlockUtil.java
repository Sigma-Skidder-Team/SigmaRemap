...
public class BlockUtil {
    ...
    public static BlockCache findValidBlockCache(BlockPos var0, boolean var1) {
        ...
        for (PlacementPattern pattern : placementPatterns) {
            for (Vector3i offset : relativePositions) {
                Vector3i positionToCheck = !pattern.field31325
                        ? new Vector3i(offset.getX() * pattern.offsetX, offset.getY() * pattern.field31323, offset.getZ() * pattern.field31324)
                        : new Vector3i(offset.getX() + pattern.offsetX, offset.getY() + pattern.field31323, offset.getZ() + pattern.field31324);

                for (Direction var18 : Direction.values()) {
                    if ((var18 != Direction.DOWN || !var1) && isValidBlockPosition(var0.method8337(positionToCheck).method8350(var18, -1))) {
                        return new BlockCache(var0.method8337(positionToCheck).method8350(var18, -1), var18);
                    }
                }
            }
        }
    ...
    public static BlockCache method34577(BlockPos var0, boolean var1, boolean var2) {
        ...
        for (BlockPos var8 : method34547(
            ...
            for (Direction var12 : Direction.values()) {
                if ((var12 != Direction.DOWN || !var1) && !isValidBlockPosition(var8) && isValidBlockPosition(var8.method8350(var12, -1))) {
                    return new BlockCache(var8.method8350(var12, -1), var12);
                }
            }
        }
    ...
    public static boolean isValidBlockPosition(BlockPos var0) {
        if (var0 != null) {
    ...
    public static float[] method34579(float var0, float var1, BlockCache var2) {
