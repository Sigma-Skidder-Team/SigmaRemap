...
public class ClassicEditAlt extends Screen {
   ...
   public ClassicEditAlt(Account var1) {
      ...
      this.addToList(this.field21027 = new SigmaClassicTextBox(this, "username", var6, var5, var4, 45,
            SigmaClassicTextBox.field20741, "", "New name", ResourceRegistry.DefaultClientFont));
      var5 += 80;
      this.addToList(this.field21028 = new SigmaClassicTextBox(this, "password", var6, var5, var4, 45,
            SigmaClassicTextBox.field20741, "", "New password", ResourceRegistry.DefaultClientFont));
      var5 += 190;
      this.addToList(this.field21029 = new Class4300(this, "edit", var6, var5, var4, 40, "Edit",
            ClientColors.MID_GREY.getColor()));
      var5 += 50;
      this.addToList(this.field21030 = new Class4300(this, "back", var6, var5, var4, 40, "Cancel",
            ClientColors.MID_GREY.getColor()));
   ...
   public void draw(float partialTicks) {
      ...
      RenderUtil.drawRect(0.0F, 0.0F, (float) this.getWidthA(), (float) this.getHeightA(),
            MultiUtilities.applyAlpha(ClientColors.DEEP_TEAL.getColor(), 0.95F));
      RenderUtil.method11440(
            ResourceRegistry.DefaultClientFont, (float) (this.getWidthA() / 2), 20.0F, "Edit Alt",
