            ...
            for (Entry var5 : Client.getInstance().networkManager.field38429.method29510().entrySet()) {
                  ...
                  navBa
                              .addToList(
                                          new Class4273(
                                                      navBa,
                                                      ((Class8433) var5.getValue()).field36142 + "_"
                                                                  + navBa.method13241().size(),
                                                      0,
                                                      0,
                                                      navBa.getWidthA(),
                                                      var3,
      ...
      public void draw(float partialTicks) {
            ...
            try {
                  if (this.field21003) {
                        ...
                        this.field21004 = TextureUtil.method32933("blur",
                                    ImageUtil.method35042(var11, 0.0F, 1.1F, 1.3F));
                  }
            ...
            partialTicks = QuadraticEasing.easeInOutQuad(this.field20994, 0.0F, 1.0F, 1.0F);
            RenderUtil.drawRoundedRect((float) (var7 + 5), (float) (var8 + 5), (float) (this.field21002 - 10),
                        (float) (var10 - 10), 25.0F, partialTicks * 0.4F);
            ...
            RenderUtil.drawBlurredBackground(var7 + this.field21002, var8 - this.field20998,
                        var7 + var9 + this.field20998,
                        var8 + var10 + this.field20998);
            RenderUtil.method11467(var7, var8, var9, var10,
                        MultiUtilities.applyAlpha(ClientColors.LIGHT_GREYISH_BLUE.getColor(), partialTicks));
            RenderUtil.endScissor();
            RenderUtil.drawBlurredBackground(var7 - this.field20998, var8 - this.field20998, var7 + this.field21002,
                        var8 + var10 + this.field20998);
            RenderUtil.method11467(var7, var8, var9, var10, MultiUtilities.applyAlpha(-2236963, partialTicks * 0.75F));
            RenderUtil.drawRect(
