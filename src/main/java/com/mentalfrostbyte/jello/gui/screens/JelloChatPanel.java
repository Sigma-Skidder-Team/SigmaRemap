...
public class JelloChatPanel extends Screen {
      ...
      public void draw(float partialTicks) {
            ...
            RenderUtil.startScissorNoGL(var7 + this.field21002, var8 - this.field20998,
                        var7 + var9 + this.field20998,
                        var8 + var10 + this.field20998);
            RenderUtil.method11467(var7, var8, var9, var10,
                        MultiUtilities.applyAlpha(ClientColors.LIGHT_GREYISH_BLUE.getColor(), partialTicks));
            RenderUtil.endScissor();
            RenderUtil.startScissorNoGL(var7 - this.field20998, var8 - this.field20998, var7 + this.field21002,
                        var8 + var10 + this.field20998);
