...
public class GroupTouchBarItem extends TouchBarItem
{
    ...
    public GroupTouchBarItem(final String identifier) {
        super(identifier);
    }
    
    public GroupTouchBarItem(final String identifier, final TouchBarView view) {
    ...
    public void setGroupTouchBar(final JTouchBar groupTouchBar) {
    ...
    public void setPrefersEqualWidths(final boolean prefersEqualWidths) {
    ...
    public void setPreferredItemWidth(final float preferredItemWidth) {
