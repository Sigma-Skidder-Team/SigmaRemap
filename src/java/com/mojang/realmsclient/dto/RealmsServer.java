...
public class RealmsServer extends Class6109 {
   ...
   public static RealmsServer method18912(JsonObject var0) {
      RealmsServer var3 = new RealmsServer();
   ...
   private static void method18913(RealmsServer var0) {
      var0.field27450
         .sort(
   ...
   public static RealmsServer method18917(String var0) {
      try {
      ...
      if (var1 != null) {
         if (var1 != this) {
            if (var1.getClass() == this.getClass()) {
               RealmsServer var4 = (RealmsServer)var1;
