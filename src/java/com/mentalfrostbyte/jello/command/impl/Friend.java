         ...
         switch (var7) {
            case "add":
               if (var2.length != 2) {
                  ...
                  if (var15) {
                     ...
                     if (!var16) {
                        var3.send("\"" + var2[1].method30899() + "\" is already your friend.");
                     } else {
                        var3.send("\"" + var2[1].method30899() + "\" is now your friend.");
                     }
                  } else {
            ...
            case "remove":
               if (var2.length != 2) {
                  ...
                  if (!var13) {
                     var3.send("\"" + var2[1].method30899() + "\" is not your friend :(.");
                  } else {
                     var3.send("\"" + var2[1].method30899() + "\" is no longer your friend.");
                  }
               }
               break;
            case "list":
