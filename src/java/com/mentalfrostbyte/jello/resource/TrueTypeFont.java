...
import org.newdawn.slick.TrueTypeFont$IntObject;
...
public class TrueTypeFont implements Font {
    ...
    private final TrueTypeFont$IntObject[] charArray = new TrueTypeFont$IntObject[256];
    ...
    private void method23950(char[] var1) {
        ...
        try {
            ...
            for (int i = 0; i < 256 + customCharsLength; i++) {
                ...
                TrueTypeFont$IntObject var14 = new TrueTypeFont$IntObject(this);
                var14.width = fontImage.getWidth();
                var14.height = fontImage.getHeight();
                if (this.field31944 > 0) {
                    var14.field35435 = this.method23949(ch);
                } else {
                ...
                if (i < 256) {
                    ...
                    this.customChars.put(new Character(ch), var14);
                }
    ...
    public int getWidth(String var1) {
        int var4 = 0;
        TrueTypeFont$IntObject var5 = null;
        char var6 = '\u0000';
        if (var1 != null) {
            for (int var7 = 0; var7 < var1.length(); var7++) {
                var6 = var1.charAt(var7);
                if (var6 >= 256) {
                    var5 = (TrueTypeFont$IntObject) this.customChars.get(new Character(var6));
                } else {
    ...
    public void drawString(float var1, float var2, String whatchars, Color color, int var5, int var6) {
        ...
        for (int i = 0; i < whatchars.length(); i++) {
            ...
            if (charCurrent >= 256) {
                intObject = (TrueTypeFont$IntObject) this.customChars.get(new Character(charCurrent));
            } else {
