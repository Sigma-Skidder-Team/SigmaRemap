...
public class ClassicMainScreen extends Screen {
        ...
        public ClassicMainScreen() {
                ...
                Client.getInstance();
                String var12 = var10000.append(Client.VERSION).append(" for Minecraft 1.8 to ").append("1.16.4")
                                .toString();
        ...
        public void draw(float partialTicks) {
                ...
                GL11.glTranslated(
                                ...
                                0.0);
                RenderUtil.method11455(-10.0F, -10.0F, (float) (this.getWidthA() + 20),
                                (float) (this.getHeightA() + 20),
                                ResourceList.mainmenubackground);
                GL11.glPopMatrix();
                this.field21103
                                .method13286(
                                                (int) ((float) (-this.getWidthA() / 40) + this.field21104 / 40.0F),
                                                (int) ((float) (-this.getHeightA() / 40) + this.field21105 / 40.0F)
                                                                + var4);
                this.field21102
