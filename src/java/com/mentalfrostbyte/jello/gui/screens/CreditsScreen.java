...
public class CreditsScreen extends Screen {
   ...
   public void draw(float partialTicks) {
      ...
      RenderUtil.drawRect(
            ...
            MultiUtilities.applyAlpha(ClientColors.LIGHT_GREYISH_BLUE.getColor(), 0.9F * this.field21072));
      float var6 = EasingFunctions.easeOutBack(
            !((double) this.field21072 < 0.5) ? (float) ((double) this.field21072 - 0.5) * 2.0F : 0.0F, 0.0F, 1.0F,
            1.0F);
      GL11.glPushMatrix();
      ...
      RenderUtil.drawImage(
            (float) (this.getWidthA() / 2)
                  - ((float) var4 - (float) var4 * (this.field21072 - 1.0F) * this.field21072) / 2.0F,
            (float) ((double) (Math.max((float) var5 * 1.2F, (float) (this.getHeightA() / 2)) - (float) var5)
                  - (double) var5
