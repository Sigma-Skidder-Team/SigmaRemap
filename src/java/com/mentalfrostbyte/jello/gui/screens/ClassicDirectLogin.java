...
public class ClassicDirectLogin extends Screen {
   ...
   public ClassicDirectLogin() {
      ...
      this.field20989.doThis((var1, var2) -> {
         ...
         var5x = GLFW.glfwGetClipboardString(Minecraft.getInstance().mainWindow.getHandle()) == null ? ""
               : GLFW.glfwGetClipboardString(Minecraft.getInstance().mainWindow.getHandle());
