...
public class LoginAndOutScreen extends Screen {
   ...
   public LoginAndOutScreen() {
      ...
      this.field21087 = ResourceList
            .createScaledAndProcessedTexture2("com/mentalfrostbyte/gui/resources/background/panorama5.png", 0.075F, 8);
      this.addToList(
      ...
      if (this.field21092) {
         var4 = 1.0F
               - (float) Math.sin((Math.PI / 2)
                     + (double) QuadraticEasing.easeInOutQuad(1.0F - this.field21093.calcPercent(), 0.0F, 1.0F, 1.0F)
                           * (Math.PI / 2))
                     * 0.2F;
      }
