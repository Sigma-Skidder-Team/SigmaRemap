...
public class JelloClickGUI extends Screen {
   ...
   public JelloClickGUI() {
      ...
      var9.method13307().method19406(MultiUtilities.applyAlpha(ClientColors.LIGHT_GREYISH_BLUE.color, 0.3F));
   ...
   public void draw(float var1) {
      ...
      if (Client.getInstance().getModuleManager().getConfigurationManager().getCurrentConfig() != null) {
         ...
         RenderUtil.drawString(
            ...
            var12,
            MultiUtilities.applyAlpha(ClientColors.LIGHT_GREYISH_BLUE.color, 0.5F * Math.max(0.0F, Math.min(1.0F, var4)))
         );
      }
