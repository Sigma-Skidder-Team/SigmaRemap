...
public class ClassicMainScreen extends Screen {
    ...
    public ClassicMainScreen() {
        ...
        Client.getInstance();
        String var12 = var10000.append(Client.VERSION).append(" for Minecraft 1.8 to ").append(JelloPortal.defaultVersion.getVersionName()).toString();
        ...
        this.addToList(new UITextDisplay(this, "names", 130, 9, var9.method23942(var11), 140, var15, var17, ClassicDecryption.regular17));
        this.addToList(
                this.field21094 = new UITextDisplay(
                        this,
                        "Version",
                        this.getWidthA() - var9.method23942(var12) - 9,
                        this.getHeightA() - 31,
                        114,
                        140,
