        ...
        if (this.isEnabled()) {
            ...
            while (chunkIterator.hasNext()) {
                ...
                if (chunkPos != null) {
                    ...
                    RenderUtil.render3DColoredBox(box, MultiUtilities.applyAlpha(ClientColors.PALE_ORANGE.color, 0.1F));
                    RenderUtil.renderWireframeBox(box, MultiUtilities.applyAlpha(ClientColors.PALE_ORANGE.color, 0.1F));
