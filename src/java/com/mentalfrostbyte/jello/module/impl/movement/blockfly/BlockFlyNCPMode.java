...
public class BlockFlyNCPMode extends Module {
            ...
            if (!event.isPre()) {
                ...
                if (this.field23923 != null) {
                    BlockRayTraceResult var13 = new BlockRayTraceResult(
                            method16814(this.field23923.blockpos, this.field23923.facing), this.field23923.facing, this.field23923.blockpos, false
                    );
                ...
                if (!BlockUtil.method34578(var15) && this.field23928.method16739(this.field23927)) {
                    ...
                    if (var11 != null) {
                        float[] rots = BlockUtil.getRotationsToBlock(this.field23923.blockpos, this.field23923.facing);
                        this.pitch = rots[1];
                        this.yaw = rots[0];
                        Rots.rotating = true;
    ...
    public void method16809(EventMove var1) {
        if (this.isEnabled() && this.field23928.method16735() != 0) {
            ...
            switch (var4) {
                case "Jump":
                    if (mc.player.onGround && MultiUtilities.method17686() && !mc.player.isServerSneakState() && !this.field23929) {
                        this.field23930 = false;
                        mc.player.jump();
                ...
                case "Cubecraft":
                    ...
                    if (mc.gameSettings.keyBindJump.isKeyDown()) {
                        ...
                        if (MultiUtilities.method17686() && !mc.player.isServerSneakState() && !this.field23929) {
                            var1.setY(1.01);
                        }
