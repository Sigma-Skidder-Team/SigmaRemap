...
public class Class2802<T extends Entity> extends Class2803<T> implements Class2824, Class2801 {
   ...
   public void method10998(T var1, float var2, float var3, float var4, float var5, float var6) {
      ...
      this.field17453.field31035 = MathHelper.cos(var2 * 0.6662F) * 1.4F * var3 * 0.5F;
      this.field17454.field31035 = MathHelper.cos(var2 * 0.6662F + (float) Math.PI) * 1.4F * var3 * 0.5F;
