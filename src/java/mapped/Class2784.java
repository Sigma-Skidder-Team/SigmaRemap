...
public class Class2784 extends Class2595 {
            ...
            if (var3 instanceof PlayerEntity) {
               ...
               if (var5.getBlock().isIn(BlockTags.field32770)) {
                  this.field17403 = var5.<Direction>method23464(Class3250.HORIZONTAL_FACING)
                     .<BlockPos>map(var1 -> var4.offset(var1.getOpposite()))
   ...
   private boolean method10974() {
      for (Class1098 var4 : this.field17401.world.<Class1098>getEntitiesWithinAABB(Class1098.class, new AxisAlignedBB(this.field17403).method19664(2.0))) {
