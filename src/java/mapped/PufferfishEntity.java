...
public class PufferfishEntity extends AbstractFishEntity {
   private static final DataParameter<Integer> field5820 = EntityDataManager.<Integer>createKey(PufferfishEntity.class, DataSerializers.VARINT);
   ...
   public PufferfishEntity(EntityType<? extends PufferfishEntity> var1, World var2) {
      super(var1, var2);
   }
   ...
   public void livingTick() {
      ...
      if (this.isAlive() && this.method4828() > 0) {
         for (MobEntity var4 : this.world.getEntitiesInAABBexcluding(MobEntity.class, this.getBoundingBox().grow(0.3), field5823)) {
            if (var4.isAlive()) {
   ...
   // $VF: synthetic method
   public static int method4834(PufferfishEntity var0, int var1) {
      return var0.field5821 = var1;
   }

   // $VF: synthetic method
   public static int method4835(PufferfishEntity var0, int var1) {
