   ...
   public void method10998(T var1, float var2, float var3, float var4, float var5, float var6) {
      ...
      if (this.field17730 != 3) {
         ...
         if (this.field17730 != 2) {
            this.field17722.field31035 = MathHelper.cos(var2 * 0.6662F) * var3;
            this.field17723.field31035 = MathHelper.cos(var2 * 0.6662F + (float) Math.PI) * var3;
            this.field17724.field31035 = MathHelper.cos(var2 * 0.6662F + (float) Math.PI) * var3;
            this.field17725.field31035 = MathHelper.cos(var2 * 0.6662F) * var3;
            if (this.field17730 != 1) {
               this.field17727.field31035 = 1.7278761F + 0.47123894F * MathHelper.cos(var2) * var3;
            } else {
               this.field17727.field31035 = 1.7278761F + (float) (Math.PI / 4) * MathHelper.cos(var2) * var3;
            }
         } else {
            this.field17722.field31035 = MathHelper.cos(var2 * 0.6662F) * var3;
            this.field17723.field31035 = MathHelper.cos(var2 * 0.6662F + 0.3F) * var3;
            this.field17724.field31035 = MathHelper.cos(var2 * 0.6662F + (float) Math.PI + 0.3F) * var3;
            this.field17725.field31035 = MathHelper.cos(var2 * 0.6662F + (float) Math.PI) * var3;
            this.field17727.field31035 = 1.7278761F + (float) (Math.PI / 10) * MathHelper.cos(var2) * var3;
         }
      }
   }
