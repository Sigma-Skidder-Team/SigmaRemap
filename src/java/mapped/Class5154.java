...
public class Class5154 extends Module {
   ...
   public void method15966() {
      this.field23398 = -1;
      this.field23399 = 0;
      this.field23403 = field23386.field1339.getPosY();
   ...
   public void method16009(Class4435 var1) {
      if (this.method15996()) {
         ...
         if (field23386.field1339.field4984 == 0.0F && field23386.field1339.field4982 == 0.0F
            || field23386.field1339.field5037
         ...
         switch (var4) {
            ...
            case "Fast1":
               ...
               field23386.field1339.method3433().field18049 = this.field23402;
               break;
            case "Fast2":
         ...
         if (this.method15974("Fluid Fix")) {
            if (!field23386.field1339.field5037 && !field23386.field1339.field5038) {
               ...
               if (!((float)this.field23398 > var5) && this.field23398 >= 0) {
                  ...
                  field23386.field1339.field5028.field18049 = this.field23403 + var6;
                  field23386.field1339.field4909 = 0.0F;
               }
            } else {
               field23386.field1339.field5028.field18049 = field23386.field1339.method3389().field28450;
               this.field23403 = field23386.field1339.getPosY();
               this.field23398 = -1;
            }
         }
   ...
   private double method16012(int var1) {
      double var4 = field23386.field1339.method3433().field18049;
      boolean var6 = Class5628.method17730(field23386.field1339, 0.37F);
   ...
   private double method16013(int var1, int var2) {
      boolean var5 = Class5628.method17730(field23386.field1339, 0.37F);
   ...
   public static double method16016(int var0, int var1, Runnable var2) {
      ...
      if (var0 >= 0) {
         ...
         if (field23386.field1339.field4984 <= 0.0F) {
            var5 -= 0.06;
         }
