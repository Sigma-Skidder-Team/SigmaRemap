...
public class Class6830 extends Class6829 {
   ...
   public void method20810() {
      ...
      if (this.field29714 == Class2335.field15967 && !this.field29715.method4230().method21664()) {
         ...
         this.field29715.method3113(Class9679.method37821(0.125F, this.field29715.method2918(), var3));
         ...
         if (var6 != 0.0) {
            double var11 = (double)Class9679.method37766(var4 * var4 + var6 * var6 + var8 * var8);
         ...
         if (var4 != 0.0 || var8 != 0.0) {
            float var10 = (float)(Class9679.method37814(var8, var4) * 180.0F / (float)Math.PI) - 90.0F;
