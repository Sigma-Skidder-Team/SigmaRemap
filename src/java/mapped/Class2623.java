...
public class Class2623 extends Class2595 {
   ...
   public boolean method10803() {
      if (this.field16916 <= this.field16917.ticksExisted
         ...
         List var3 = this.field16917
            .world
            .<ItemEntity>getEntitiesInAABBexcluding(ItemEntity.class, this.field16917.getBoundingBox().grow(6.0, 6.0, 6.0), Class1097.method5243());
   ...
   public void method10804() {
      List var3 = this.field16917
         .world
         .<ItemEntity>getEntitiesInAABBexcluding(ItemEntity.class, this.field16917.getBoundingBox().grow(8.0, 8.0, 8.0), Class1097.method5243());
