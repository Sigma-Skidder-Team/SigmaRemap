...
public class VanillaMainMenuScreen extends Screen {
   private static final Logger field4703 = LogManager.getLogger();
   public static final RenderSkyboxCube field4704 = new RenderSkyboxCube(new ResourceLocation("textures/gui/title/background/panorama"));
   ...
   public VanillaMainMenuScreen() {
      this(false);
   }

   public VanillaMainMenuScreen(boolean var1) {
   ...
   public boolean mouseClicked(double var1, double var3, int var5) {
      if (!super.mouseClicked(var1, var3, var5)) {
         if (this.method2594() && this.field4713.mouseClicked(var1, var3, var5)) {
            return true;
         } else {
