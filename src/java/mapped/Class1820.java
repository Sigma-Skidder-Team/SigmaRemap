...
public abstract class Class1820<T extends Class511, M extends Class5860<T>> extends Class1799<T, M>
{
    ...
    public abstract void method6586(final Class7351 p0, final Class7807 p1, final int p2, final Class399 p3, final float p4, final float p5, final float p6, final float p7);
    ...
    public void method6551(final Class7351 class7351, final Class7807 class7352, final int n, final T t, final float n2, final float n3, final float n4, final float n5, final float n6, final float n7) {
        ...
        if (method6585 > 0) {
            for (int i = 0; i < method6585; ++i) {
                ...
                class7351.method22564(Class9546.method35700(nextFloat, method6587.field41046, method6587.field41049) / 16.0f, Class9546.method35700(nextFloat2, method6587.field41047, method6587.field41050) / 16.0f, Class9546.method35700(nextFloat3, method6587.field41048, method6587.field41051) / 16.0f);
