...
public class Class5176 extends Module {
    ...
    public void isInDevelopment() {
        this.field23469 = mc.player.field4902.field5443;
    ...
    public void method15965() {
        if (this.field23469 != -1 && this.method16004().getStringSettingValueByName("ItemSpoof").equals("Switch")) {
            mc.player.field4902.field5443 = this.field23469;
        }
            ...
            if (!var4.method15996() || !var4.getStringSettingValueByName("Type").equalsIgnoreCase("Hypixel") || !var4.method16726().getStringSettingValueByName("Bypass").equals("Blink")) {
                if (!var1.method13921()) {
                    ...
                    if (this.field23468 != null) {
                        ...
                        int var21 = mc.player.field4902.field5443;
                        if (!this.method16004().getStringSettingValueByName("ItemSpoof").equals("None")) {
                            this.field23473.method16734();
                        }

                        mc.field1337.method23139(mc.player, mc.world, this.field23472, var20);
                        ...
                        if (this.method16004().getStringSettingValueByName("ItemSpoof").equals("Spoof") || this.method16004().getStringSettingValueByName("ItemSpoof").equals("LiteSpoof")) {
                            mc.player.field4902.field5443 = var21;
                        }
                    }
                } else {
                    this.field23470++;
                    ...
                    if (BlockFly.method16733(mc.player.getHeldItem(Hand.field183).method32107())
                            && (
                            mc.player.getHeldItem(this.field23472).method32105()
                                    || !BlockFly.method16733(mc.player.getHeldItem(this.field23472).method32107())
                    )) {
                    ...
                    if (!Class9217.method34578(var11) && this.field23473.method16739(this.field23472)) {
                        ...
                        if (var12 != null) {
                            ...
                            if ((double) var12.field33646.field13028 - mc.player.getPosY() < 0.0) {
                                ...
                                if (var18 < 2.0) {
                                    var13[0] = mc.player.field5031 + 1.0F;
                                    var13[1] = 90.0F;
                                }
                            }
                        ...
                        if (this.method15974("KeepRotations") && this.field23466 != 999.0F) {
                            var1.method13918(mc.player.field5031 + 1.0F);
    ...
    public void method16112(Class4435 var1) {
        if (this.method15996() && this.field23473.method16735() != 0) {
            ...
            switch (var4) {
                case "Jump":
                    if (mc.player.field5036 && Class5628.method17686() && !mc.player.method3331() && !this.field23474) {
                        this.field23475 = false;
                    ...
                    break;
                case "AAC":
                    if (this.field23470 == 0 && mc.player.field5036) {
                        Class9567.method37088(var1, Class9567.method37075() * 0.82);
                    }
                    break;
                case "Cubecraft":
                    double var6 = 0.2;
                    float var8 = this.method16118(MathHelper.method37792(mc.player.field5031));
            ...
            if (!(mc.player.field5045 > 1.2F)) {
                if (!(mc.player.field4915 < this.field23476)) {
                    if (!mc.player.field4981) {
                        mc.player.field5028.field18049 = this.field23476;
                        mc.player.field5049 = this.field23476;
                        mc.player.field4915 = this.field23476;
                        mc.player.field5026 = this.field23476;
