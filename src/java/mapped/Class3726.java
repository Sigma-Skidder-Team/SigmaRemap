...
public class Class3726 extends Class3676<CreatureEntity> {
   ...
   public boolean method12508(ServerWorld var1, CreatureEntity var2) {
      Optional<Class9378> var5 = var2.getBrain().<Class9378>method21410(this.field19820);
   ...
   public void method12502(ServerWorld var1, CreatureEntity var2, long var3) {
      if (var3 > this.field19821) {
         ...
         var2.getBrain().method21408(Class8830.field39824, var7.map(var1x -> new Class8999(var1x, this.field19823, 1)));
