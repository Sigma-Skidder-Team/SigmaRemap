...
public class Class3726 extends Class3676<CreatureEntity> {
   private static String[] field19819;
   private final MemoryModuleType<Class9378> field19820;
   private long field19821;
   private final int field19822;
   private float field19823;

   public Class3726(MemoryModuleType<Class9378> var1, float var2, int var3) {
   ...
   public boolean method12508(ServerWorld var1, CreatureEntity var2) {
      Optional<Class9378> var5 = var2.getBrain().<Class9378>getMemory(this.field19820);
