   ...
   public void method10890() {
      ...
      if (!(this.field17064.getDistanceSq(var3) < 9.0)) {
         for (int var9 = 0; var9 < 16; var9++) {
            ...
            int var13 = 1 * var9;
            this.method10896(
               this.field17064.getPosX() + (double) MathHelper.method37764(var8) * var11,
               this.field17064.getPosZ() + (double) MathHelper.method37763(var8) * var11,
               var4,
               var6,
               var8,
               var13
         ...
         for (int var14 = 0; var14 < 5; var14++) {
            ...
            this.method10896(
               this.field17064.getPosX() + (double) MathHelper.method37764(var10) * 1.5,
               this.field17064.getPosZ() + (double) MathHelper.method37763(var10) * 1.5,
               var4,
               var6,
               var10,
               0
         ...
         for (int var15 = 0; var15 < 8; var15++) {
            ...
            this.method10896(
               this.field17064.getPosX() + (double) MathHelper.method37764(var16) * 2.5,
               this.field17064.getPosZ() + (double) MathHelper.method37763(var16) * 2.5,
               var4,
               var6,
               var16,
               3
   ...
   private void method10896(double var1, double var3, double var5, double var7, float var9, int var10) {
      ...
      while (true) {
         ...
         if (!var18.method23454(this.field17064.field5024, var17, Direction.field673)) {
            ...
            if (var13.getY() >= MathHelper.method37769(var5) - 1) {
               continue;
            }
            break;
         }
