...
public class Class8981 {
    ...
    public static Class214 field40592;
    ...
    public static final File field40892 = new File(Minecraft.getInstance().field1303, "shaderpacks");
    public static File field40893 = new File(Minecraft.getInstance().field1303, "optionsshaders.txt");
    ...
    private static Class1656 field40918 = null;
    ...
    private static Class6627 method32963(int var0, String var1) {
        ...
        try {
            ...
            if (var3 == null) {
                ...
                var4.method1090(field40591.method1537());
    ...
    private static void method32977(Class4671 var0, Properties var1) throws IOException {
        ...
        File var3 = new File(Minecraft.getInstance().field1303, var2);
        if (var1.isEmpty()) {
            var3.delete();
        } else {
    ...
    public static int method32984(String var0) {
        ...
        if (var1 != 0 && Class9084.method33877(var1)) {
            ...
            if (Class7944.method26981() && Class4379.method13743("ShowGlErrorShaders", 10000L)) {
                String var5 = Class9088.method33883("of.message.openglError", var1, var2);
                method32988(var5);
            }
        }
    ...
    public static boolean method33001(Class4520 var0) {
    ...
    public static void method33006() {
        ...
        if (!field40594) {
            ...
            String var2 = "";
            if (field40918 != null) {
                int var3 = Class8509.method30145(field40918.method6813());
            ...
            if (var8 != null) {
                ...
                if (var8 instanceof Class880) {
                    ...
                    if (var12.method3033(Class8254.field35482)) {
                        Class214 var13 = field40592;
                        field40665 = Class214.method750(var12, var2);
                    }
                ...
                Vector3d var16 = var5.method6873(var8.method3432(), var2);
    ...
    public static void method33043(Class1656 var0) {
        if (field40918 != var0) {
            Class1656 var1 = field40918;
            field40918 = var0;
            method33052(field40591.method1550());
    ...
    public static void method33053(MatrixStack var0, Class9624 var1, float var2) {
        ...
        if (field40791) {
            ...
            var0.method35291((double) ((float) var5 % var13 - var14), (double) ((float) var7 % var13 - var14), (double) ((float) var9 % var13 - var14));
        }
    ...
    public static void method33060() {
        if (!field40609) {
            ...
            if (var0) {
                ...
                Class7414.method23803(33984);
                field40591.getTextureManager().bindTexture(Class289.field1102);
            }
        }
    }
    ...
    public static void method33070(MatrixStack var0) {
        ...
        var1.method17025(var7, var13, var9).method17031();
        var1.method17025(var7, var11, var9).method17031();
        var1.method17025(var9, var11, var7).method17031();
        var1.method17025(var9, var13, var7).method17031();
        var1.method17025(var9, var13, var7).method17031();
        var1.method17025(var9, var11, var7).method17031();
        var1.method17025(var9, var11, var5).method17031();
        var1.method17025(var9, var13, var5).method17031();
        var1.method17025(var9, var13, var5).method17031();
        var1.method17025(var9, var11, var5).method17031();
        var1.method17025(var7, var11, var3).method17031();
        var1.method17025(var7, var13, var3).method17031();
        var1.method17025(var7, var13, var3).method17031();
        var1.method17025(var7, var11, var3).method17031();
        var1.method17025(var5, var11, var3).method17031();
        var1.method17025(var5, var13, var3).method17031();
        var1.method17025(var5, var13, var3).method17031();
        var1.method17025(var5, var11, var3).method17031();
        var1.method17025(var3, var11, var5).method17031();
        var1.method17025(var3, var13, var5).method17031();
        var1.method17025(var3, var13, var5).method17031();
        var1.method17025(var3, var11, var5).method17031();
        var1.method17025(var3, var11, var7).method17031();
        var1.method17025(var3, var13, var7).method17031();
        var1.method17025(var3, var13, var7).method17031();
        var1.method17025(var3, var11, var7).method17031();
        var1.method17025(var5, var11, var9).method17031();
        var1.method17025(var5, var13, var9).method17031();
        var1.method17025(var5, var13, var9).method17031();
        var1.method17025(var5, var11, var9).method17031();
        var1.method17025(var7, var11, var9).method17031();
        var1.method17025(var7, var13, var9).method17031();
        var1.method17025(var9, var13, var9).method17031();
        var1.method17025(var9, var13, var3).method17031();
        var1.method17025(var3, var13, var3).method17031();
        var1.method17025(var3, var13, var9).method17031();
    ...
    public static boolean method33075(Class9574 var0) {
        if (!field40886) {
            return true;
        } else {
            method32984("shouldRenderClouds");
            return field40609 ? field40863 : var0.field44577 != Class1904.field11184;
        }
    }
    ...
    public static void method33083() {
        if (field40605) {
    ...
    public static void method33089() {
        if (field40605) {
    ...
    public static void method33090(Class944 var0) {
        if (field40605) {
    ...
    public static void method33091(Class944 var0) {
    ...
    private static int method33092(Class944 var0) {
        if (var0 == null) {
            return -1;
        } else {
            Class7380 var1 = var0.method3775();
    ...
    private static void method33142() {
        ...
        if (field40886) {
            ...
            if (!Class7944.method26928().field44676.equals(var2)) {
                String var4 = Class7944.method26928().field44676;
    ...
    private static boolean method33152(ItemStack var0) {
        if (var0 == null) {
            ...
            Class3257 var1 = var0.method32107();
            if (var1 == null) {
                return false;
                ...
                if (var3 == null) {
                    ...
                    Class4520 var4 = Class8928.method32630(var3.method11579());
    ...
    public static Class1656 method33164() {
        return field40918;
    }
