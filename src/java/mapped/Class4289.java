...
public class Class4289 extends Class4278 {
   ...
   public void draw(float var1) {
      ...
      int var9 = MultiUtilities.applyAlpha(ClientColors.DEEP_TEAL.color, var1);
      if (this.field20783.field42046) {
         var8 = MultiUtilities.applyAlpha(-15038729, var1);
         var4 += 402 - var6;
         var9 = MultiUtilities.applyAlpha(ClientColors.LIGHT_GREYISH_BLUE.color, var1);
      }
      ...
      for (String var14 : this.field20783.field42047) {
         RenderUtil.drawString(ResourceRegistry.JelloLightFont18, (float)(var4 + 10), (float)(var5 + 5 + var10 * ResourceRegistry.JelloLightFont18.getHeight()), var14, var9);
         var10++;
      }
