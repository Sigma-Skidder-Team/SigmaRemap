...
public class Class3441 extends Block {
   ...
   private void method12113(World var1, BlockPos var2, BlockState var3) {
      var1.method6742((PlayerEntity)null, var2, SoundEvents.field27167, SoundCategory.field14732, 0.7F, 0.9F + var1.rand.nextFloat() * 0.2F);
   ...
   public void randomTick(BlockState var1, ServerWorld var2, BlockPos var3, Random var4) {
      if (this.method12116(var2) && method12114(var2, var3)) {
         ...
         if (var7 >= 2) {
            var2.method6742((PlayerEntity)null, var3, SoundEvents.field27169, SoundCategory.field14732, 0.7F, 0.9F + var4.nextFloat() * 0.2F);
            ...
            var2.method6742((PlayerEntity)null, var3, SoundEvents.field27168, SoundCategory.field14732, 0.7F, 0.9F + var4.nextFloat() * 0.2F);
   ...
   public boolean method11497(BlockState var1, BlockItemUseContext var2) {
      return var2.method18357().getItem() == this.asItem() && var1.<Integer>get(field19244) < 4 ? true : super.method11497(var1, var2);
   }
