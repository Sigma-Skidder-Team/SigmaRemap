...
public class Class6799 {
   ...
   public void method20712(CompoundNBT var1) {
      ...
      var4.method115("mayfly", this.allowFlying);
      var4.method115("instabuild", this.isCreativeMode);
   ...
   public void method20713(CompoundNBT var1) {
      if (var1.method119("abilities", 10)) {
         ...
         this.allowFlying = var4.method132("mayfly");
         this.isCreativeMode = var4.method132("instabuild");
