...
public class Class5199 extends Module {
    ...
    private void method16187(Class4435 var1) {
        if (this.method15996()) {
            if (var1.method13994() < -0.5
                    && (double) field23386.field1339.field5045 > 2.0 + (double) Class9567.method37079() * 0.5
                ...
                for (int var8 = 0; var8 < var5; var8++) {
                    ...
                    double var11 = field23386.field1339.getPosY();
                    ...
                    if (var13 > var17 && var13 < var15) {
                        Class6488 var19 = field23386.field1339.field5035.method19667(var1.method13992(), var1.method13994() + var13 + var17, var1.method13996());
                        if (field23386.field1338.method7055(field23386.field1339, var19).count() != 0L) {
                            var13 -= 1.0E-5;
    ...
    private void method16188(Class4399 var1) {
        if (this.method15996() && field23386.field1339 != null) {
            if (!(field23386.field1339.getPosY() < 2.0)) {
                ...
                switch (var4) {
                    case "OldHypixel":
                        if (var1.method13921()) {
                            ...
                            if (field23386.field1339.method3433().field18049 < -0.1) {
                                if (this.field23509 == 0.0) {
                                }

                                this.field23509 = this.field23509 - field23386.field1339.method3433().field18049;
                            }
                        ...
                        break;
                    case "Hypixel":
                        if (var1.method13921() && field23386.field1339.method3433().field18049 < 0.0 && !field23386.field1339.field5036 && Class5628.method17716()) {
                    ...
                    case "Hypixel2":
                        if (var1.method13921()) {
                            ...
                            if (field23386.field1339.method3433().field18049 < -0.1 && field23386.field1339.field5045 > 3.0F) {
                                this.field23509++;
                    ...
                    case "AAC":
                        if (var1.method13921()) {
                            ...
                            if (!this.field23507 && field23386.field1339.field5045 > 3.0F && this.method15978("Mode").equals("AAC")) {
                                this.field23507 = !this.field23507;
                                Class5605 var7 = new Class5605(field23386.field1339.getPosX(), Double.NaN, field23386.field1339.getPosZ(), true);
                                field23386.getClientPlayNetHandler().sendPacket(var7);
                            }
                        }
                        break;
                    case "Vanilla":
                        if (var1.method13921() && field23386.field1339.method3433().field18049 < -0.1) {
                            var1.method13920(true);
                        }
                        break;
                    case "Vanilla Legit":
                        ...
                        if (field23386.field1339.field5045 > 3.0F) {
                            this.field23510 = true;
                        }

                        if (this.field23510 && field23386.field1339.field5036 && !field23386.field1339.method3250()) {
                            ...
                            field23386.getClientPlayNetHandler().sendPacket(new Class5605(var12, var14 + 3.01, var16, false));
                            field23386.getClientPlayNetHandler().sendPacket(new Class5605(var12, var14, var16, false));
                            field23386.getClientPlayNetHandler().sendPacket(new Class5605(var12, var14, var16, true));
                    ...
                    case "NCPSpigot":
                        if (var1.method13921()) {
                            ...
                            if (this.field23508 && Client.getInstance().method19939().method31329() == 0 && field23386.field1339.field5036) {
