   ...
   public AccountSignUpScreen(CustomGuiScreen var1, String var2, int var3, int var4, int var5, int var6) {
      ...
      this.addToList(
            this.registerButton = new UIButton(
                  this, "RegisterButton", 468, 291, ResourceRegistry.JelloLightFont25.getStringWidth("Register"), 70,
                  ColorHelper.field27961, "Register", ResourceRegistry.JelloLightFont25));
      this.addToList(
            this.loginButton = new UIButton(
                  this, "LoginButton", 98, 333, ResourceRegistry.JelloLightFont14.getStringWidth("Login"), 14,
      ...
      this.addToList(
            this.usernameInputBox = new UIInput(this, "Username", 228, var11, var10, var9, var12, "", "Username"));
      ...
      this.addToList(this.passwordInputBox = new UIInput(this, "Password", 228, var11 + 106, var10, var9, var12, "",
            "Password"));
      this.passwordInputBox.setFont(ResourceRegistry.JelloLightFont20);
      this.passwordInputBox.method13155(true);
      this.addToList(
            this.captchaBox = new UIInput(this, "CaptchaBox", 228, var11 + 53 + 135, 80, var9, var12, "", "Captcha"));
      ...
      if (var7 != null) {
         ...
         if (var7.method36702()) {
            RenderUtil.renderBackgroundBox(
                  (float) (this.xA + var6), (float) (this.yA + var5), 114.0F, 40.0F,
                  MultiUtilities.applyAlpha(ClientColors.DEEP_TEAL.getColor, 0.04F));
         }
   ...
   public void method13126() {
      new Thread(
            () -> {
               ...
               String var4 = Client.getInstance().networkManager
                     .method30448(this.usernameInputBox.getTypedText(), this.passwordInputBox.getTypedText(),
                           this.emailInputBox.getTypedText(), var3);
