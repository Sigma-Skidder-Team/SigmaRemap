         ...
         if (var11 != Items.WATER_BUCKET) {
            if (var11 != Items.BUCKET) {
               if (var11 != Items.field37972) {
                  if (var11 == Items.field37971 && Class9741.method38185(var9) == Class8137.field34977) {
                     if (var10 < 3 && !var2.isRemote) {
                        ...
                        var2.playSound((PlayerEntity)null, var3, SoundEvents.field26417, Class2266.field14732, 1.0F, 1.0F);
                  ...
                  if (var10 > 0 && !var2.isRemote) {
                     ...
                     var2.playSound((PlayerEntity)null, var3, SoundEvents.field26418, Class2266.field14732, 1.0F, 1.0F);
                     this.method12051(var2, var3, var1, var10 - 1);
                  }
               ...
               if (var10 == 3 && !var2.isRemote) {
                  ...
                  var2.playSound((PlayerEntity)null, var3, SoundEvents.field26429, Class2266.field14732, 1.0F, 1.0F);
               }
            ...
            if (var10 < 3 && !var2.isRemote) {
               ...
               var2.playSound((PlayerEntity)null, var3, SoundEvents.field26426, Class2266.field14732, 1.0F, 1.0F);
            }
