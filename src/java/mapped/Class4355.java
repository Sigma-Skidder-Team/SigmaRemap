...
public class Class4355 extends Class4247 {
   ...
   public void method13028(int var1, int var2) {
      ...
      boolean var5 = this.method13216() || var1 > this.method13271() + this.getWidth() - 62;
   ...
   public void draw(float var1) {
      ...
      RenderUtil.method11424(
         (float)(this.x + var5), (float)(this.y + var4), 20.0F, 2.0F, ColorUtils.applyAlpha(ClientColors.DEEP_TEAL.getColor, var6)
      );
      RenderUtil.method11424(
         (float)(this.x + var5), (float)(this.y + var4 + 5), 20.0F, 2.0F, ColorUtils.applyAlpha(ClientColors.DEEP_TEAL.getColor, var6)
      );
      RenderUtil.method11424(
         (float)(this.x + var5), (float)(this.y + var4 + 10), 20.0F, 2.0F, ColorUtils.applyAlpha(ClientColors.DEEP_TEAL.getColor, var6)
      );
      ...
      RenderUtil.method11438((float)(this.x + 35), (float)(this.y + this.height / 2), 17.0F, this.field21293);
      RenderUtil.drawRoundedRect(
         (float)this.x, (float)this.y, (float)this.width, (float)this.height, 14.0F, var1 * 0.2F * this.field21289.calcPercent()
      );
      super.draw(var1);
   }
}
