...
public class Class7589
{
    ...
    private static int method23874(final Class7492 class7492, final Class9544 class7493, final float n, final float n2, final boolean b, final Collection<? extends Class399> collection) throws CommandSyntaxException {
        ...
        final double n5 = class7493.field41091 + n2;
        final double n6 = class7493.field41092 + n2;
        ...
        class7492.method23257(new Class2259("commands.spreadplayers.success." + (b ? "teams" : "entities"), new Object[] { method23878.length, class7493.field41091, class7493.field41092, String.format(Locale.ROOT, "%.2f", method23877(collection, class7492.method23250(), method23878, b)) }), true);
    ...
    private static void method23876(final Class9544 class9544, final double n, final Class1849 class9545, final Random random, final double n2, final double n3, final double n4, final double n5, final Class8296[] array, final boolean b) throws CommandSyntaxException {
        int n6 = 1;
        ...
        if (!b) {
            throw Class7589.field30109.create((Object)array.length, (Object)class9544.field41091, (Object)class9544.field41092, (Object)String.format(Locale.ROOT, "%.2f", min));
        }
