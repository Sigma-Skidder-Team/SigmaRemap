...
public class Class8912
{
    ...
    private static final Set<Class7096> field37459;
    private static final Map<Class7096, Class8912> field37460;
    ...
    private final Set<Class7096> field37482;
    private final int field37483;
    private final Predicate<Class8912> field37484;
    private final int field37485;
    
    private static Set<Class7096> method31394(final Class3833 class3833) {
        return (Set<Class7096>)ImmutableSet.copyOf((Collection)class3833.method11876().method32902());
    }
    
    private Class8912(final String field37481, final Set<Class7096> set, final int field37482, final Predicate<Class8912> field37483, final int field37484) {
        this.field37481 = field37481;
        this.field37482 = (Set<Class7096>)ImmutableSet.copyOf((Collection)set);
        this.field37483 = field37482;
        this.field37484 = field37483;
        this.field37485 = field37484;
    }
    
    private Class8912(final String field37481, final Set<Class7096> set, final int field37482, final int field37483) {
        this.field37481 = field37481;
        this.field37482 = (Set<Class7096>)ImmutableSet.copyOf((Collection)set);
        this.field37483 = field37482;
    ...
    private static Class8912 method31398(final String s, final Set<Class7096> set, final int n, final int n2) {
        return method31400(Class90.field241.method558(new Class1932(s), new Class8912(s, set, n, n2)));
    }
    
    private static Class8912 method31399(final String s, final Set<Class7096> set, final int n, final Predicate<Class8912> predicate, final int n2) {
    ...
    public static Optional<Class8912> method31401(final Class7096 class7096) {
        return Optional.ofNullable(Class8912.field37460.get(class7096));
    }
    
    public static Stream<Class7096> method31402() {
    ...
    static {
        ...
        field37472 = method31398("nitwit", (Set<Class7096>)ImmutableSet.of(), 1, 1);
