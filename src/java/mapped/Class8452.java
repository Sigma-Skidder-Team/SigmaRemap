...
public class Class8452 {
   ...
   public static URL method29725(String var0, String var1, String var2) {
      try {
         ...
         if (!var6.has("releases")) {
            ...
            Class2344 var7 = var6.method21768("releases");
            if (var7.method9132(0)) {
               return var5;
            } else {
               JSONObject var8 = var7.method9129(0).method21769("release-group");
               if (!var8.has("id")) {
                  return var5;
               } else {
                  ...
                  return !var9.has("images") ? var5 : new URL(var9.method21768("images").method9129(0).method21769("thumbnails").method21773("small"));
               }
            }
         }
   ...
   public static JSONObject method29726(String var0, String var1) throws Class2455, IOException {
