...
public class Class3006 implements Class2982 {
   ...
   public void method11398(Class8563 var1) throws Exception {
      ...
      if (var4 != 1010) {
         if (var4 == 2001) {
            var1.method30558(BruhMotha.field22526, 1, this.field18134.field20160.method19376().method18528(var5));
         }
      } else {
         var1.method30558(BruhMotha.field22526, 1, this.field18134.field20160.method19376().method18530(var5));
      }
   }
}
