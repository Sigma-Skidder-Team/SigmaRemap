...
public class Class6734 extends Class6717 {
   public Class6734(Schema var1, boolean var2) {
      super(var1, var2, "EntityHorseSaddleFix", Class8239.field35391, "EntityHorse");
   }
   ...
   public Typed<?> method20508(Typed<?> var1) {
      ...
      Type<?> var5 = this.getInputSchema().getTypeRaw(Class8239.field35387);
      ...
      if (!var7.isPresent() && var8.get("Saddle").asBoolean(false)) {
         ...
         var9 = var9.set(var4, Pair.of(Class8239.field35393.typeName(), "minecraft:saddle"));
