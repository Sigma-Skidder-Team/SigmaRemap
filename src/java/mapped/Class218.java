...
public class Class218<T extends Class880 & Class1041, M extends Class2827<T> & Class2801> extends Class219<T, M> implements Class215 {
   ...
   private final Class192 field861;
   private final String field862;

   public Class218(Class5714<T, M> var1, Class192 var2, String var3) {
      super(var1);
      this.field861 = var2;
      this.field862 = var3;
      var2.method587(this);
   ...
   public <K> Class1984 method819(Object2ObjectMap<K, Class1984> var1, String var2, Class2351<K> var3, K var4) {
      return (Class1984)var1.computeIfAbsent(var4, var4x -> {
         try (Class1783 var7 = this.field861.method580(this.method818(var2, var3.method9181(var4)))) {
