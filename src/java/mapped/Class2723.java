...
public class Class2723<T extends PillagerEntity> extends Class2595 {
   ...
   public void method10805() {
      ...
      if (var4.method21664()) {
         ...
         if (this.field17212.method4579() && var5.isEmpty()) {
            ...
            var10 = this.field17212.world.getHeight(Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, var10);
   ...
   private boolean method10932() {
      ...
      BlockPos var4 = this.field17212
         .world
         .getHeight(Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, this.field17212.getPosition().add(-8 + var3.nextInt(16), 0, -8 + var3.nextInt(16)));
