...
public class Class2723<T extends PillagerEntity> extends Class2595 {
   ...
   public void method10805() {
      ...
      if (var4.method21664()) {
         ...
         if (this.field17212.method4579() && var5.isEmpty()) {
            ...
            Vector3d var8 = var7.subtract(var6);
            var6 = var8.method11351(90.0F).scale(0.4).add(var6);
            Vector3d var9 = var6.subtract(var7).method11333().scale(10.0).add(var7);
            BlockPos var10 = new BlockPos(var9);
            var10 = this.field17212.world.getTopPosition(Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, var10);
   ...
   private boolean method10932() {
      ...
      BlockPos var4 = this.field17212
         .world
         .getTopPosition(Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, this.field17212.getPosition().add(-8 + var3.nextInt(16), 0, -8 + var3.nextInt(16)));
