...
public class Class8373 {
   ...
   private static int method29331(CommandSource var0, Collection<GameProfile> var1) throws CommandSyntaxException {
      Class4528 var4 = var0.getServer().getPlayerList().method19461();
      int var5 = 0;
      ...
      for (GameProfile var7 : var1) {
         if (var4.method14431(var7)) {
            ...
            var5++;
            var0.sendFeedback(new TranslationTextComponent("commands.pardon.success", TextComponentUtils.getDisplayName(var7)), true);
         }
      }
