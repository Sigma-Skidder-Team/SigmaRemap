...
public class RotationHelper {
   ...
   public static float[] method34136(LivingEntity var0, double var1, double var3, double var5) {
      ...
      double var12 = var0.getPosY() - (double)field42012.player.getEyeHeight() - 0.02F + (double)var0.getEyeHeight() - var3;
   ...
   public static float[] method34138(Entity var0, double var1, double var3, double var5) {
      ...
      double var17 = var13 - (double)field42012.player.getEyeHeight() - 0.02F + (double)var0.getEyeHeight() - var3;
   ...
   public static float[] method34139(LivingEntity var0, double var1, double var3, double var5) {
      ...
      double var11 = var0.getPosY() - (double)field42012.player.getEyeHeight() - 0.02F + (double)var0.getEyeHeight() - var3 - Math.random();
   ...
   public static float[] method34140(LivingEntity var0, double var1, double var3, double var5) {
      ...
      double var17 = var0.getPosY() - var3 - (double)field42012.player.getEyeHeight() + (double)var0.getEyeHeight() - 0.02F - 0.6F - var11;
   ...
   public static float[] method34141(LivingEntity var0, double var1, double var3, double var5, float var7) {
      ...
      if (var10 == null) {
         if (field42015 <= new Date().getTime() - 500L) {
            ...
            double var19 = var0.getPosY() - var3 - (double)field42012.player.getEyeHeight() + (double)var0.getEyeHeight() - 0.02F - 0.6F - var13;
   ...
   public static float[] method34146(LivingEntity var0) {
      ...
      double var19 = (double)field42012.player.getDistance(var0);
      var19 -= var19 % 0.8;
      double var21 = 1.0;
      double var23 = 1.0;
      ...
      double var30 = var7 + (double)field42012.player.getEyeHeight() - (var13 + (double)var0.getHeight());
      double var32 = (double)field42012.player.getDistance(var0);
   ...
   public static Class7461 method34148(Vector3d var0) {
      float[] var3 = method34145(field42012.player.getPositionVec().add(0.0, (double)field42012.player.getEyeHeight(), 0.0), var0);
      return new Class7461(var3[0], var3[1]);
   }

   public static boolean method34149(Vector3d var0) {
      Vector3d var3 = new Vector3d(
         field42012.player.getPosX(), field42012.player.getPosY() + (double)field42012.player.getEyeHeight(), field42012.player.getPosZ()
      );
      RayTraceContext var4 = new RayTraceContext(var3, var0, Class2271.field14775, Class1985.field12962, field42012.player);
      BlockRayTraceResult var5 = field42012.world.rayTraceBlocks(var4);
   ...
   public static Class7461 method34150(Entity var0, boolean var1) {
      ...
      if (var1 && !method34149(var4)) {
         for (int var5 = -1; var5 < 2; var5++) {
            ...
            double var16 = var12 - (double)field42012.player.getEyeHeight() - 0.02F - field42012.player.getPosY();
            ...
            for (int var25 = -1; var25 < 2; var25 += 2) {
               ...
               var16 = var12 - (double)field42012.player.getEyeHeight() - 0.02 - field42012.player.getPosY();
   ...
   public static float method34154(float var0, Entity var1, double var2) {
      ...
      double var10 = var2 - 2.2 + (double)var1.getEyeHeight() - field42012.player.getPosY();
