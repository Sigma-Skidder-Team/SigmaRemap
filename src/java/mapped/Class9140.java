...
public class Class9140 {
   ...
   public static void method34124(float var0, float var1, float var2) {
      if ((field41996.field1339.method3138() || field41996.field1339.method3418()) && field41996.field1339.method3250()) {
         double var5 = field41996.field1339.getPosY();
         float var7 = method34128();
         float var8 = 0.02F;
         float var9 = (float)Class7858.method26326(field41996.field1339);
         if (var9 > 3.0F) {
            var9 = 3.0F;
         }

         if (!field41996.field1339.field5036) {
            var9 *= 0.5F;
         }

         if (var9 > 0.0F) {
            var7 += (0.54600006F - var7) * var9 / 3.0F;
            var8 += (field41996.field1339.method2918() - var8) * var9 / 3.0F;
         }
         ...
         if (!field41996.field1339.method3247()) {
            field42006 -= 0.02;
         }

         if (field41996.field1339.field5037
            && field41996.field1339.method3224(field42005, field42006 + 0.6F - field41996.field1339.getPosY() + var5, field42007)) {
            field42006 = 0.3F;
         }
      }
   }
   ...
   public static boolean method34129() {
      return method34125(field41996.field1339.method3389().method19662(0.0, -0.4F, 0.0).method19660(0.001, 0.001, 0.001), Class8649.field38941);
   }
}
