...
public class Class4269 extends Class4247 {
   ...
   public void draw(float var1) {
      super.method13225();
      RenderUtil.method11467(this.x, this.y, this.width, this.height, ColorUtils.applyAlpha(ClientColors.LIGHT_GREYISH_BLUE.getColor, var1));
      super.draw(var1);
   }
   ...
   public void keyPressed(int var1) {
      ...
      if (var1 == 257) {
         ((Class4312)this.getIconPanel()).method13359(this.field20694.method13303());
