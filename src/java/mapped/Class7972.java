...
public class Class7972 {
   ...
   public static void method27106(Class7219 var0, Class7219 var1, Class880 var2, boolean var3) {
      ...
      float var9 = Class9679.method37777((float)var2.method3160(), 0.0F, var8);
      float var10 = var9 / var8;
      var7.field31036 = Class9679.method37821(var10, 0.4F, 0.85F) * (float)(!var3 ? -1 : 1);
      var7.field31035 = Class9679.method37821(var10, var7.field31035, (float) (-Math.PI / 2));
   }

   public static <T extends Class1006> void method27107(Class7219 var0, Class7219 var1, T var2, float var3, float var4) {
      float var7 = Class9679.method37763(var3 * (float) Math.PI);
      float var8 = Class9679.method37763((1.0F - (1.0F - var3) * (1.0F - var3)) * (float) Math.PI);
      ...
      if (var2.method2967() != Class2205.field14418) {
         var0.field31035 = -0.0F + Class9679.method37764(var4 * 0.19F) * 0.5F;
         var1.field31035 = -1.8849558F + Class9679.method37764(var4 * 0.09F) * 0.15F;
         var0.field31035 += var7 * 1.2F - var8 * 0.4F;
         var1.field31035 += var7 * 2.2F - var8 * 0.4F;
      } else {
         var0.field31035 = -1.8849558F + Class9679.method37764(var4 * 0.09F) * 0.15F;
         var1.field31035 = -0.0F + Class9679.method37764(var4 * 0.19F) * 0.5F;
   ...
   public static void method27108(Class7219 var0, Class7219 var1, float var2) {
      var0.field31037 = var0.field31037 + Class9679.method37764(var2 * 0.09F) * 0.05F + 0.05F;
      var1.field31037 = var1.field31037 - (Class9679.method37764(var2 * 0.09F) * 0.05F + 0.05F);
      var0.field31035 = var0.field31035 + Class9679.method37763(var2 * 0.067F) * 0.05F;
      var1.field31035 = var1.field31035 - Class9679.method37763(var2 * 0.067F) * 0.05F;
   }
