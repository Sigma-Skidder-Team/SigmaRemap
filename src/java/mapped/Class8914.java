...
public class Class8914
{
    ...
    private static int method31411(final Class7492 class7492) {
        ...
        if (size <= 0) {
            ...
            final String join = Joiner.on(", ").join((Iterator)method20488.stream().sorted().map(Class7859::new).map(Class7859::toString).iterator());
            if (size != 1) {
            ...
            if (min2 >= -30000000) {
                if (max < 30000000) {
                    if (max2 < 30000000) {
                        ...
                        if (i != 0) {
                            if (i != 1) {
                                class7492.method23257(new Class2259("commands.forceload." + (b ? "added" : "removed") + ".multiple", new Object[] { i, method20487, new Class7859(n, n2), new Class7859(n3, n4) }), true);
                            }
                            else {
