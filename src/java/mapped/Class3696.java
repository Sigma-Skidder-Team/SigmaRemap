...
public class Class3696<E extends Class880, T extends Class880> extends Class3676<E> {
   ...
   private final Class8992<? extends T> field19732;
   ...
   public Class3696(Class8992<? extends T> var1, int var2, Predicate<E> var3, Predicate<T> var4, Class8830<T> var5, float var6, int var7) {
   ...
   public static <T extends Class880> Class3696<Class880, T> method12551(Class8992<? extends T> var0, int var1, Class8830<T> var2, float var3, int var4) {
   ...
   private boolean method12553(Class880 var1) {
      return this.field19732.equals(var1.method3204()) && this.field19734.test((T)var1);
   }
