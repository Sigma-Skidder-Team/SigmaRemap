...
public class PotionEntity extends Class890 implements Class889 {
   public static final Predicate<LivingEntity> field5131 = LivingEntity::method3124;

   public PotionEntity(EntityType<? extends PotionEntity> var1, World var2) {
      super(var1, var2);
   }

   public PotionEntity(World var1, LivingEntity var2) {
      super(EntityType.POTION, var2, var1);
   }

   public PotionEntity(World var1, double var2, double var4, double var6) {
            ...
            if (var8.canBeHitWithPotion()) {
               ...
               if (var9 < 16.0) {
                  ...
                  for (EffectInstance var14 : var1) {
                     ...
                     if (!var15.isInstant()) {
                        int var16 = (int)(var11 * (double)var14.getDuration() + 0.5);
                        if (var16 > 20) {
                           var8.addPotionEffect(new EffectInstance(var15, var16, var14.getAmplifier(), var14.isAmbient(), var14.doesShowParticles()));
                        }
                     } else {
