...
public class Class3496 {
   public static final Codec<Class3496> field19366 = RecordCodecBuilder.create(
      var0 -> var0.group(
               Class9455.field43936.fieldOf("sound").forGetter(var0x -> var0x.field19367),
            ...
            .apply(var0, Class3496::new)
   );
   private final Class9455 field19367;
   private final int field19368;
   private final int field19369;
   private final boolean field19370;

   public Class3496(Class9455 var1, int var2, int var3, boolean var4) {
