...
public class Class5322 extends Module {
    ...
    public void method16715(Class4399 var1) {
        if (this.method15996() && field23386.field1339 != null) {
            this.field23868++;
            boolean var4 = var1.method13911() > field23386.field1339.getPosY() - 1.0E-6 && var1.method13911() < field23386.field1339.getPosY() + 1.0E-6;
            if (var4) {
                var1.method13912(field23386.field1339.getPosY() + 0.4);
            ...
            if (this.field23868 > 60) {
                ...
                for (int var5 = 0; var5 < 10; var5++) {
                    ...
                    Class5605 var9 = new Class5605(
                            field23386.field1339.getPosX(), field23386.field1339.getPosY() + var7, field23386.field1339.getPosZ(), true
                    );
                ...
                if (!this.field23869.isEmpty()) {
                    for (int var10 = 0; var10 < this.field23869.size(); var10++) {
                        ...
                        if (var11.method32423()) {
                            field23386.getClientPlayNetHandler().sendPacket(var11.method32424());
