...
public class Class5398 implements Class5391 {
   ...
   public Class9346 method16977(Entity var1, Random var2) {
      if (var1.field5024 instanceof Class1657) {
         Class1657 var5 = (Class1657)var1.field5024;
         BlockPos var6 = var5.method6943(this.field24070, var1.method3432(), 100, true);
         if (var6 == null) {
            return null;
         } else {
            Class8848 var7 = Class3316.method11859(var5, var6.method8304(), var6.method8306(), (byte)2, true, true);
            ...
            return new Class9346(
               new Class8848(Class8514.field38049, this.field24069), new Class8848(Class8514.field37905), var7, this.field24072, this.field24073, 0.2F
            );
         }
      } else {
         return null;
