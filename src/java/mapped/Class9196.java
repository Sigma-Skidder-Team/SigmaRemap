...
public class Class9196 {
   ...
   private static boolean method34465(Block var0) {
      return var0 == Blocks.field36764 || var0 == Blocks.HONEY_BLOCK;
   }

   private static boolean method34466(Block var0, Block var1) {
      if (var0 == Blocks.HONEY_BLOCK && var1 == Blocks.field36764) {
         return false;
      } else {
         return var0 == Blocks.field36764 && var1 == Blocks.HONEY_BLOCK ? false : method34465(var0) || method34465(var1);
      }
   }
