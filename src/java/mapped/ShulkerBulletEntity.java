...
public class ShulkerBulletEntity extends ProjectileEntity {
   ...
   public ShulkerBulletEntity(EntityType<? extends ShulkerBulletEntity> var1, World var2) {
      super(var1, var2);
      this.noClip = true;
   }

   public ShulkerBulletEntity(World var1, double var2, double var4, double var6, double var8, double var10, double var12) {
   ...
   public ShulkerBulletEntity(World var1, LivingEntity var2, Entity var3, Direction.Axis var4) {
      this(EntityType.SHULKER_BULLET, var1);
