...
public class Class9670 {
   ...
   public List<Class30> method37725(Class30 var1) throws CommandSyntaxException {
      List var4 = Collections.<Class30>singletonList(var1);
   ...
   public int method37726(Class30 var1) {
      List var4 = Collections.<Class30>singletonList(var1);
   ...
   private List<Class30> method37727(Class30 var1) throws CommandSyntaxException {
      List var4 = Collections.<Class30>singletonList(var1);
   ...
   public List<Class30> method37728(Class30 var1, Supplier<Class30> var2) throws CommandSyntaxException {
      List var5 = this.method37727(var1);
      Class8356 var6 = this.field45160[this.field45160.length - 1];
      return var6.method29297(var5, var2);
   }

   private static int method37729(List<Class30> var0, Function<Class30, Integer> var1) {
      return var0.stream().<Integer>map(var1).reduce(0, (var0x, var1x) -> var0x + var1x);
   }

   public int method37730(Class30 var1, Supplier<Class30> var2) throws CommandSyntaxException {
      List var5 = this.method37727(var1);
      Class8356 var6 = this.field45160[this.field45160.length - 1];
      return method37729(var5, var2x -> var6.method29294(var2x, var2));
   }

   public int method37731(Class30 var1) {
      List var4 = Collections.<Class30>singletonList(var1);
