...
public class Class4751 extends BruhMotha<Class8173> {
   ...
   public Class8173 method14894(ByteBuf var1) throws Exception {
      ...
      Class72 var9 = BruhMotha.field22555.method14894(var1);
      ...
      if (var1.readableBytes() > 0) {
         byte[] var17 = BruhMotha.field22521.method14894(var1);
   ...
   public void method14895(ByteBuf var1, Class8173 var2) throws Exception {
      ...
      try {
         ...
         var12.readerIndex(0);
         BruhMotha.field22544.method14908(var1, var12.readableBytes());
         var1.writeBytes(var12);
      } finally {
         var12.release();
      }

      BruhMotha.field22556.method14895(var1, var2.method28451().<Class72>toArray(field22576));
   }
