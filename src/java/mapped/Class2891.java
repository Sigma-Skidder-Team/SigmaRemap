...
public class Class2891<T extends Entity> extends Class2802<T> {
   ...
   public void method10998(T var1, float var2, float var3, float var4, float var5, float var6) {
      ...
      this.field17455.field31035 = MathHelper.sin((float)var1.field5055 * var9) * 4.5F * (float) (Math.PI / 180.0);
      this.field17455.field31036 = 0.0F;
      this.field17455.field31037 = MathHelper.cos((float)var1.field5055 * var9) * 2.5F * (float) (Math.PI / 180.0);
      if (this.field17911) {
