...
public class Class7127 {
   ...
   public static final ITextComponent field30659 = new TranslationTextComponent("gui.cancel");
   ...
   public static final ITextComponent field30662 = new TranslationTextComponent("gui.proceed");
