...
public class Class1331 extends Screen {
   ...
   public void method1921() {
      ...
      this.field7047 = this.field4562.field1298.method5989().method5934().size();
         ...
         if (!super.method1920(var1, var2, var3)) {
            if (var1 != 256) {
               if (var1 == 257 || var1 == 335) {
                  ...
                  this.field4562.field1298.method5989().method5937((double)(this.field4562.field1298.method5989().method5947() - 1));
                  return true;
               } else if (var1 != 267) {
                  return false;
               } else {
   ...
   public boolean method2649(double var1, double var3, double var5) {
      ...
      if (!this.field7050.method20831(var5)) {
         ...
         this.field4562.field1298.method5989().method5937(var5);
         return true;
      } else {
         return true;
      }
   ...
   public boolean method1958(double var1, double var3, int var5) {
      if (!this.field7050.method20832((double)((int)var1), (double)((int)var3), var5)) {
         if (var5 == 0) {
            Class1266 var8 = this.field4562.field1298.method5989();
   ...
   public void method6345(int var1) {
      ...
      int var5 = this.field4562.field1298.method5989().method5934().size();
      var4 = Class9679.method37775(var4, 0, var5);
      if (var4 != this.field7047) {
         if (var4 != var5) {
            ...
            this.field7048.method5635(this.field4562.field1298.method5989().method5934().get(var4));
   ...
   public void method1923(Class9332 var1, int var2, int var3, float var4) {
      ...
      method5686(var1, 2, this.field4565 - 14, this.field4564 - 2, this.field4565 - 2, this.field4562.field1299.method37141(Integer.MIN_VALUE));
      this.field7048.method1923(var1, var2, var3, var4);
      this.field7050.method20843(var1, var2, var3);
      Style var7 = this.field4562.field1298.method5989().method5939((double)var2, (double)var3);
   ...
   // $VF: synthetic method
   public static Class6850 method6347(Class1331 var0) {
