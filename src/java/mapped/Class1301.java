...
public class Class1301 extends TextFieldWidget {
   ...
   public IFormattableTextComponent method5634() {
      return ! SocialInteractionsScreen.method5497(this.field6893).getText().isEmpty() && SocialInteractionsScreen.method5498(this.field6893).method6137()
