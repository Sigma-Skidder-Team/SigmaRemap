...
public class Class3965 extends Class3833 implements Class3966
{
    ...
    public static void method12096(final Class1847 class1847, final Class354 class1848, final boolean b) {
        final Class7096 method6701 = class1847.method6701(class1848);
        class1847.method6708(class1848.method1074(), class1848.method1075(), class1848.method1076(), b ? Class8520.field35088 : Class8520.field35087, Class286.field1582, 1.0f, 1.0f, false);
        final double n = method6701.method21725(class1847, class1848).method24547(Class111.field352, 0.5, 0.5) + 0.03125;
        final Random method6702 = class1847.method6790();
        for (int i = 0; i < 10; ++i) {
            class1847.method6709(Class8432.field34626, class1848.method1074() + 0.13124999403953552 + 0.737500011920929 * method6702.nextFloat(), class1848.method1075() + n + method6702.nextFloat() * (1.0 - n), class1848.method1076() + 0.13124999403953552 + 0.737500011920929 * method6702.nextFloat(), method6702.nextGaussian() * 0.02, method6702.nextGaussian() * 0.02, method6702.nextGaussian() * 0.02);
        }
    }
    ...
    public Class2201 method11844(final Class7096 class7096, final Class1847 class7097, final Class354 class7098, final Class512 class7099, final Class316 class7100, final Class7005 class7101) {
        ...
        if (!class7097.field10067) {
            final Class427 class7102 = new Class427(class7097, class7098.method1074() + (class7097.field10062.nextFloat() * 0.7f + 0.15000000596046448), class7098.method1075() + (class7097.field10062.nextFloat() * 0.7f + 0.06000000238418579 + 0.6), class7098.method1076() + (class7097.field10062.nextFloat() * 0.7f + 0.15000000596046448), new Class8321(Class7739.field31400));
    ...
    private static void method12097(final Class7096 class7096, final Class1851 class7097, final Class354 class7098) {
        class7097.method6688(class7098, ((Class7097<O, Class7096>)class7096).method21773((Class7111<Comparable>)Class3965.field17915, 0), 3);
    }
    
    private static boolean method12098(final Class7096 class7096, final Class1851 class7097, final Class354 class7098, final Class8321 class7099) {
        final int intValue = class7096.method21772((Class7111<Integer>)Class3965.field17915);
    ...
    @Override
    public Class441 method12099(final Class7096 class7096, final Class1851 class7097, final Class354 class7098) {
        final int intValue = class7096.method21772((Class7111<Integer>)Class3965.field17915);
        if (intValue != 8) {
