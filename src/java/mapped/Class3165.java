...
public class Class3165 implements Class2982 {
   ...
   public void method11398(Class8563 var1) throws Exception {
      ...
      if (var4 == 0 || var4 == 2) {
         ...
         var1.<String>method30561(BruhMotha.field22539);
         int var8 = var1.<Byte>method30559(BruhMotha.field22518).intValue();
         if (var8 == -1) {
            var8 = 21;
         }

         if (ViaVersion3.method27612().setTeamColourFix()) {
            Class2307 var9 = this.field18406.field20335.method19395(var6);
            var8 = var9.ordinal();
            var7 = var9.toString() + var7;
         }

         var1.method30560(BruhMotha.field22544, var8);
         var1.method30560(BruhMotha.field22538, Class2980.method11394(var6));
         var1.method30560(BruhMotha.field22538, Class2980.method11394(var7));
      }

      if (var4 == 0 || var4 == 3 || var4 == 4) {
         String[] var10 = var1.<String[]>method30559(BruhMotha.field22540);

         for (int var11 = 0; var11 < var10.length; var11++) {
            var10[var11] = this.field18406.field20335.method19396(var10[var11]);
         }

         var1.method30560(BruhMotha.field22540, var10);
      }
   }
}
