...
public abstract class Class1182 extends Class1180 {
   ...
   public Class1182(Class1127 class1127, List<Class9125> var1, ITextComponent var2) {
      ...
      this.field6381 = class1127.field4562.field1294.method38828(var2, 175);
   }
   ...
   public void method5612(Class9332 var1, int var2, int var3) {
      if (this.field6381.size() != 1) {
         if (this.field6381.size() >= 2) {
            ...
            this.field6378.field4562.field1294.method38804(var1, this.field6381.get(1), (float)var3, (float)(var2 + 10), 16777215);
         }
      } else {
         this.field6378.field4562.field1294.method38804(var1, this.field6381.get(0), (float)var3, (float)(var2 + 5), 16777215);
      }
   }
}
