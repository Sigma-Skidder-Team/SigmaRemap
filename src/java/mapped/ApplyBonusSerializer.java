...
public class ApplyBonusSerializer extends LootFunctionSerializer<Class138> {
   ...
   public Class138 deserialize(JsonObject var1, JsonDeserializationContext var2, ILootCondition[] var3) {
      ResourceLocation var6 = new ResourceLocation(JSONUtils.method32763(var1, "enchantment"));
      Class6069 var7 = Registry.field16073.method9187(var6).orElseThrow(() -> new JsonParseException("Invalid enchantment id: " + var6));
      ResourceLocation var8 = new ResourceLocation(JSONUtils.method32763(var1, "formula"));
