...
public class Class4805 extends Class4803
{
    ...
    public Class4805(final Class4803 class4803, final String s, final Class4405 class4804) {
        ...
        this.method14239(new Class4834(this, "title", 0, n, 0, 0, Class6523.field25964, method13268, Class9400.field40325));
        n += 55;
        for (int i = 0; i < method13269.method462(); ++i) {
            this.method14239(new Class4834(this, "change" + i, 0, n, 0, 0, new Class6523(0, 0, 0, Class6430.method19118(Class265.field1278.field1292, 0.8f)), " - " + method13269.method459(i), Class9400.field40313));
            n += 22;
        }
        n += 75;
        this.method14279(n);
