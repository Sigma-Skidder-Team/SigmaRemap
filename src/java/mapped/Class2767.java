...
public class Class2767 extends Class2595 {
   ...
   public boolean method10803() {
      List var3 = this.field17342.world.<LivingEntity>getEntitiesInAABBexcluding(LivingEntity.class, this.field17342.getBoundingBox().grow(2.0), Class1054.method4833());
      return !var3.isEmpty();
   }
