...
public class Class4901 extends Class4874<Class4488> {
   ...
   public Class4488 method15047(JsonObject var1, Class9587 var2, Class9366 var3) {
      RegistryKey var6 = !var1.has("from") ? null : RegistryKey.<World>getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation(JSONUtils.getString(var1, "from")));
      RegistryKey var7 = !var1.has("to") ? null : RegistryKey.<World>getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation(JSONUtils.getString(var1, "to")));
