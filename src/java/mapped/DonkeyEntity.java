...
public class DonkeyEntity extends Class1066 {
   private static String[] field5878;

   public DonkeyEntity(EntityType<? extends DonkeyEntity> var1, World var2) {
      super(var1, var2);
   }
   ...
   public Class1045 method4389(ServerWorld var1, Class1045 var2) {
      EntityType var5 = !(var2 instanceof HorseEntity) ? EntityType.DONKEY : EntityType.MULE;
