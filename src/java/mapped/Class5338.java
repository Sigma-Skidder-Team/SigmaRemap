...
public class Class5338 extends Class5325 {
    public Class5338() {
        ...
        this.registerSetting(new Class6010("Regular Color", "The render color", Class1979.field12896.field12910));
        this.registerSetting(new BooleanSetting("Show Trapped Chests", "Renders the regular chest esp", true));
        this.registerSetting(new Class6010("Trapped Color", "The render color", -13108));
        this.registerSetting(new BooleanSetting("Show Ender Chests", "Renders the regular chest esp", true));
        this.registerSetting(new Class6010("Ender Color", "The render color", -1848065));
    }
}
