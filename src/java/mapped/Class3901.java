...
public class Class3901 extends Class3758 {
   ...
   public void method12725() {
      ...
      this.map(BruhMotha.field22551);
      this.map(BruhMotha.field22526);
      this.map(BruhMotha.field22524);
      this.method12733(var0 -> {
         int var3 = var0.<Integer>method30555(BruhMotha.field22526, 0);
         if (var3 == 2002) {
            int var4 = var0.<Integer>method30555(BruhMotha.field22526, 1);
            boolean var5 = false;
            ...
            if (var6 != null) {
               ...
               ViaVersion3.method27613().getLogger().warning("Received unknown 1.11 -> 1.10.2 potion data (" + var4 + ")");
               var4 = 0;
            }

            if (var5) {
               var0.method30558(BruhMotha.field22526, 0, 2007);
            }

            var0.method30558(BruhMotha.field22526, 1, var4);
         }
      });
   }
}
