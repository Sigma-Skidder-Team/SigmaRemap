...
public abstract class Class2914 extends Class2898<Class4712> {
   ...
   public boolean method11250(Class1660 var1, Random var2, BlockPos var3, Class7380 var4) {
      ...
      if ((var8.method23448(Class8487.field36413) || var8.method23446(Class7645.field32786)) && var1.method6738(var7).method23448(Class8487.field36413)) {
         var1.method6725(var3, var4, 3);
         if (!(var2.nextFloat() < 0.25F)) {
            if (var2.nextFloat() < 0.05F) {
               var1.method6725(var7, Class8487.field37005.method11579().method23465(Class3195.field18472, Integer.valueOf(var2.nextInt(4) + 1)), 2);
            }
         } else {
         ...
         for (Direction var10 : Class76.field161) {
            if (var2.nextFloat() < 0.2F) {
               ...
               if (var1.method6738(var11).method23448(Class8487.field36413)) {
