...
public class Class2888<T extends Class1070> extends Class2803<T> {
   ...
   public void method10998(Class1070 var1, float var2, float var3, float var4, float var5, float var6) {
      ...
      this.field17894.field31033 = this.field17894.field31033 - 2.0F * MathHelper.cos(var2 * 1.5F) * 2.0F * var3;
      this.field17893.field31035 = MathHelper.sin(var2 * 1.5F * 0.5F) * 2.0F * var3;
      this.field17892.field31035 = MathHelper.sin(var2 * 1.5F * 0.5F + (float) Math.PI) * 2.0F * var3;
      ...
      this.field17893.field31033 = 8.0F + 2.0F * MathHelper.sin(var2 * 1.5F * 0.5F + (float) Math.PI) * 2.0F * var3;
      this.field17892.field31033 = 8.0F + 2.0F * MathHelper.sin(var2 * 1.5F * 0.5F) * 2.0F * var3;
