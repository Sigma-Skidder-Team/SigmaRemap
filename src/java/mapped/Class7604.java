   ...
   public Class2139 method24894(MatrixStack var1, ToastGui var2, long var3) {
      ...
      if (var7 == null) {
         ...
         if (var8.size() != 1) {
            ...
            float var11 = 300.0F;
            if (var3 >= 1500L) {
               int var12 = MathHelper.method37767(MathHelper.method37777((float)(var3 - 1500L) / 300.0F, 0.0F, 1.0F) * 252.0F) << 24 | 67108864;
         ...
         if (!this.field32645 && var3 > 0L) {
            ...
            if (var7.method34938() == Class1965.field12815) {
               var2.method5915().getSoundHandler().method1000(MinecraftSoundManager.method19293(Sounds.field27182, 1.0F, 1.0F));
            }
         }
