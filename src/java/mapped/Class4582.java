...
public class Class4582 extends Class4566 {
   ...
   public Class4582(Class1656 var1, double var2, double var4, double var6) {
   ...
   public void method14500() {
      ...
      if (this.field22055++ < this.field22056) {
         ...
         if (!this.field22037.method6739(new BlockPos(this.field22041, this.field22042, this.field22043)).method23486(Class8953.field40469) || this.field22048
            )
          {
            this.method14518();
         }
