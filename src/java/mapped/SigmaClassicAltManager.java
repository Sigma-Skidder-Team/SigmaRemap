...
public class SigmaClassicAltManager extends Screen {
   ...
   public SigmaClassicAltManager() {
      ...
      this.method13403();
      this.addToList(
         this.field21067 = new Class4332(this, "toolbar", (Minecraft.getInstance().mainWindow.getWidth() - var9) / 2 + 16, this.getHeight() - 94)
      );
   ...
   private void method13395(Account var1) {
      ...
      this.field21055
         .addToList(
            var5 = new Class4349(this.field21055, var1.getEmail(), 4, var4 * this.method13400() + 4, this.field21055.getWidth() - 8, var4, var1)
         );
   ...
   private void method13401() {
      ...
      RenderUtil.method11424(0.0F, 0.0F, (float)this.getWidth(), (float)this.getHeight(), ColorUtils.applyAlpha(ClientColors.DEEP_TEAL.getColor, 0.23F));
   }
