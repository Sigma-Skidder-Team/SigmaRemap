   ...
   public void method29258(Random var1, int var2, int var3, int var4, boolean var5) {
      if (!var5) {
         ...
         if (!(var8 < 0.2F)) {
            if (!(var8 < 0.5F)) {
               if (!(var8 < 0.55F)) {
                  this.field35874 = Blocks.STONE_BRICKS.getDefaultState();
               } else {
                  this.field35874 = Blocks.INFESTED_STONE_BRICKS.getDefaultState();
               }
            } else {
               this.field35874 = Blocks.MOSSY_STONE_BRICKS.getDefaultState();
            }
         } else {
            this.field35874 = Blocks.CRACKED_STONE_BRICKS.getDefaultState();
         }
      }
   }
