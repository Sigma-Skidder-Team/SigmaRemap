...
public class Class9069 {
   ...
   public static Brain<?> method33778(Brain<Class1091> var0) {
      method33779(var0);
      method33780(var0);
      method33781(var0);
      method33782(var0);
   ...
   private static void method33779(Brain<Class1091> var0) {
      var0.method21425(Activity.field40219, 0, ImmutableList.of(new Class3681(45, 90), new Class3735()));
   }

   private static void method33780(Brain<Class1091> var0) {
      var0.method21425(
         Activity.field40220,
         10,
   ...
   private static void method33781(Brain<Class1091> var0) {
      var0.method21426(
         Activity.field40229,
         10,
              ImmutableList.<Class3676<? super Class1091>>of(
   ...
   private static void method33782(Brain<Class1091> var0) {
      var0.method21426(
         Activity.field40232,
         10,
         ImmutableList.of(
   ...
   public static void method33784(Class1091 var0) {
      Brain<Class1091> var3 = var0.getBrain();
   ...
   private static SoundEvent method33799(Class1091 var0, Activity var1) {
   ...
   private static List<Class1091> method33800(Class1091 var0) {
      return var0.getBrain().<List<Class1091>>method21410(Class8830.field39863).orElse(ImmutableList.of());
   }
