...
public class Class7236 {
   ...
   public static void method22721(World var0, BlockPos var1, Class920 var2) {
      method22723(var0, (double)var1.method8304(), (double)var1.getY(), (double)var1.method8306(), var2);
   }

   public static void method22722(World var0, Entity var1, Class920 var2) {
      method22723(var0, var1.getPosX(), var1.getPosY(), var1.getPosZ(), var2);
   }

   private static void method22723(World var0, double var1, double var3, double var5, Class920 var7) {
      for (int var10 = 0; var10 < var7.method3629(); var10++) {
         method22725(var0, var1, var3, var5, var7.method3618(var10));
      }
   }

   public static void method22724(World var0, BlockPos var1, Class25<ItemStack> var2) {
