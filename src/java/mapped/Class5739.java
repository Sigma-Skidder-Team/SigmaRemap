...
public class Class5739 extends EntityRenderer<LeashKnotEntity> {
   ...
   public void render(LeashKnotEntity var1, float var2, float var3, MatrixStack var4, IRenderTypeBuffer var5, int var6) {
      var4.push();
      var4.scale(-1.0F, -1.0F, 1.0F);
      this.field25162.setRotationAngles(var1, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F);
      IVertexBuilder var9 = var5.getBuffer(this.field25162.method11028(field25161));
      this.field25162.render(var4, var9, var6, OverlayTexture.NO_OVERLAY, 1.0F, 1.0F, 1.0F, 1.0F);
      var4.pop();
