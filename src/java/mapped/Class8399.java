...
public class Class8399 extends ByteToMessageDecoder {
   ...
   private static final Marker field36044 = MarkerManager.getMarker("PACKET_RECEIVED", Class8586.field38641);
   ...
   public void decode(ChannelHandlerContext var1, ByteBuf var2, List<Object> var3) throws Exception {
      if (var2.readableBytes() != 0) {
         ...
         Packet var8 = ((Class1858)var1.channel().attr(Class8586.field38642).get()).method8103(this.field36045, var7);
         if (var8 == null) {
         ...
         if (var6.readableBytes() > 0) {
            throw new IOException(
               "Packet "
                  + ((Class1858)var1.channel().attr(Class8586.field38642).get()).method8104()
                  + "/"
                  + var7
                  + " ("
         ...
         if (field36043.isDebugEnabled()) {
            field36043.debug(field36044, " IN: [{}:{}] {}", var1.channel().attr(Class8586.field38642).get(), var7, var8.getClass().getName());
         }
      }
   }
}
