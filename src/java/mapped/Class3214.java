         ...
         if (var2.getBlockState(var7).isAir()) {
            if (!var2.field9020) {
               ...
               for (int var8 = 0; var8 < 128; var8++) {
                  ...
                  double var14 = MathHelper.method37822(var9, (double)var7.getX(), (double)var3.getX()) + (var2.field9016.nextDouble() - 0.5) + 0.5;
                  double var16 = MathHelper.method37822(var9, (double)var7.getY(), (double)var3.getY()) + var2.field9016.nextDouble() - 0.5;
                  double var18 = MathHelper.method37822(var9, (double)var7.getZ(), (double)var3.getZ()) + (var2.field9016.nextDouble() - 0.5) + 0.5;
