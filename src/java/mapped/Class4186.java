...
public class Class4186 extends Class4180 {
   ...
   public void method12897(CompoundNBT var1) {
      ...
      var1.putString("Template", this.field20473);
      var1.putString("Rot", this.field20474.name());
      ...
      if (!var1.startsWith("Chest")) {
         if (!var1.startsWith("Sentry")) {
            if (var1.startsWith("Elytra")) {
               ...
               var8.method4092(new ItemStack(Items.ELYTRA), false);
               var3.addEntity(var8);
            }
         } else {
            ShulkerEntity var9 = EntityType.SHULKER.create(var3.method6970());
