         ...
         (LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)Class6099.method18839("time")
                  ...
                  .then(
                     ((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)Class6099.method18839("set")
                                    .then(Class6099.method18839("day").executes(var0x -> method27790((CommandSource)var0x.getSource(), 1000))))
                                 .then(Class6099.method18839("noon").executes(var0x -> method27790((CommandSource)var0x.getSource(), 6000))))
                              .then(Class6099.method18839("night").executes(var0x -> method27790((CommandSource)var0x.getSource(), 13000))))
                           .then(Class6099.method18839("midnight").executes(var0x -> method27790((CommandSource)var0x.getSource(), 18000))))
                        .then(
