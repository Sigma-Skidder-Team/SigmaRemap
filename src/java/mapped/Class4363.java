...
public class Class4363 extends Class4247 {
   ...
   public void method13643(List<String> var1, int var2) {
      Class4362 var5 = new Class4362(this, "sub" + var2, this.widthA + 10, this.getHeightA() * (var2 + 1), 200,
   ...
   private void method13646() {
      ...
      this.addToList(dropdownButton = new ButtonPanel(this, "dropdownButton", 0, 0, this.getHeightA(),
            this.getHeightA(), this.textColor));
