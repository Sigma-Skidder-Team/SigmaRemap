        ...
        try {
            ...
            if (((JsonElement)o).isJsonObject()) {
                if (((JsonElement)o).getAsJsonObject().has("version")) {
                    ...
                    ((JsonElement)o).getAsJsonObject().add("version", (JsonElement)asJsonObject);
                }
            }
            else {
                o = new JsonObject();
            ...
            if (Class8563.method28792().method23283()) {
                asJsonObject.add("supportedVersions", Class8557.method28750().toJsonTree((Object)Class8563.method28791().method31746()));
            }
            ...
            if (method19536 != null) {
                if (intValue == method19535 || intValue == 0) {
                    asJsonObject.addProperty("protocol", (Number)class8700.method20207());
                }
            }
            else {
                class8699.method29841().method18234(false);
            ...
            if (Class8563.method28792().method23293().contains(class8700.method20207())) {
                asJsonObject.addProperty("protocol", (Number)(-1));
            }
