...
public class Class8616 extends AudioFileReader {
   public static final Type field38743 = new Type("AAC", "aac");
   public static final Type field38744 = new Type("MP4", "mp4");
   private static final Encoding field38745 = new Encoding("AAC");
   ...
   private AudioFileFormat getAudioFileFormat(InputStream var1, int var2) throws UnsupportedAudioFileException, IOException {
      ...
      if (var6) {
         AudioFormat var7 = new AudioFormat(field38745, -1.0F, -1, var2, -1, -1.0F, true);
         return new AudioFileFormat(field38743, var7, -1);
      } else {
