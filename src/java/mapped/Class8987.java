...
public class Class8987 extends DataFix
{
    private static final Map<String, String> field37878;
    private static final Set<String> field37879;
    private static final Set<String> field37880;
    
    public Class8987(final Schema schema, final boolean b) {
        super(schema, b);
    }
    
    public TypeRewriteRule makeRule() {
        return this.fixTypeEverywhereTyped("ItemInstanceTheFlatteningFix", this.getInputSchema().getType(Class9451.field40622), typed -> {
    ...
    @Nullable
    public static String method31988(final String s, final int i) {
        if (!Class8987.field37879.contains(s)) {
            return null;
        }
        final String s2 = Class8987.field37878.get(s + '.' + i);
        return (s2 != null) ? s2 : Class8987.field37878.get(s + ".0");
    }
    
    static {
        field37878 = (Map)DataFixUtils.make((Object)Maps.newHashMap(), hashMap -> {
