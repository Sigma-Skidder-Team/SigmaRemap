   ...
   public int method19263(Class7161 var1, Class72 var2) {
      ...
      if (var5.method18688(var6)) {
         ...
         if (var7 >= 6854 && var7 <= 7109) {
            ...
            ViaVersion3.method27613().getLogger().warning("Why does this block have the banner block entity? :(" + var2);
         }
         ...
         ViaVersion3.method27613().getLogger().warning("Received an banner color update packet, but there is no banner! O_o " + var2);
         return -1;
      }
   }
