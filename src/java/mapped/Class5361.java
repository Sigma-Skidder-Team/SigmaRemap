...
public class Class5361 extends Module {
    ...
    private void method16862(Class4399 var1) {
        if (this.method15996()) {
            if (var1.method13921() && mc.method1528() != null) {
                ...
                if (this.field23967 != null) {
                    try {
                        for (UUID var5 : this.field23967) {
                            Class6589 var6 = mc.getClientPlayNetHandler().method15792(var5);
    ...
    private void method16863(Class4396 var1) {
        if (this.method15996()) {
            if (mc.getClientPlayNetHandler() != null && var1.method13898() instanceof Class5503) {
                Class5503 var4 = (Class5503) var1.method13898();
                if (var4.method17308() == Class2176.field14283) {
                    for (Class8790 var6 : var4.method17307()) {
                        Class6589 var7 = mc.getClientPlayNetHandler().method15792(var6.method31726().getId());
