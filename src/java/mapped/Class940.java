...
public class Class940 extends Class939 implements Class930, ITickableTileEntity {
   ...
   public void openInventory(PlayerEntity var1) {
      if (!var1.isSpectator()) {
         ...
         if (this.field5306 == 1) {
            this.world
               .playSound((PlayerEntity)null, this.pos, SoundEvents.field27045, Class2266.field14732, 0.5F, this.world.rand.nextFloat() * 0.1F + 0.9F);
         }
      }
   }
   ...
   public void closeInventory(PlayerEntity var1) {
      if (!var1.isSpectator()) {
         ...
         if (this.field5306 <= 0) {
            this.world
               .playSound((PlayerEntity)null, this.pos, SoundEvents.field27044, Class2266.field14732, 0.5F, this.world.rand.nextFloat() * 0.1F + 0.9F);
         }
      }
   }
