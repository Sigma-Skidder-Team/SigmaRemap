...
public class HorseEntity extends AbstractHorseEntity {
   ...
   private static final DataParameter<Integer> field5917 = EntityDataManager.<Integer>createKey(HorseEntity.class, DataSerializers.VARINT);

   public HorseEntity(EntityType<? extends HorseEntity> var1, World var2) {
      super(var1, var2);
   }
   ...
   public boolean method4386(AnimalEntity var1) {
      if (var1 != this) {
         return !(var1 instanceof DonkeyEntity) && !(var1 instanceof HorseEntity) ? false : this.method4961() && ((AbstractHorseEntity)var1).method4961();
      } else {
         return false;
      }
   }
   ...
   public Class1045 method4389(ServerWorld var1, Class1045 var2) {
      ...
      if (!(var2 instanceof DonkeyEntity)) {
         HorseEntity var5 = (HorseEntity)var2;
         ...
         ((HorseEntity)var6).method4994(var8, var10);
      } else {
