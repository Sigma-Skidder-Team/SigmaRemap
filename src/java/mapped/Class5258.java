...
public class Class5258 extends PremiumModule {
    ...
    private void method16422(Class4435 var1) {
        if (this.method15996()) {
            if (field23649 > 0 && !mc.field1339.field5036) {
    ...
    private void method16423(Class4399 var1) {
        if (this.method15996() && mc.field1337.method23150()) {
            ...
            if (field23649 == (!this.method15974("Cubecraft") ? 3 : 5)) {
                if (mc.field1339.field4902.field5443 != this.field23647) {
                    this.field23648 = mc.field1339.field4902.field5443;
                    mc.field1339.field4902.field5443 = this.field23647;
            ...
            if (!Client.getInstance().getModuleManager().method14662(Class5333.class).method15996()
                ...
                if (var5 != null) {
                    if (var1.method13921() && field23649 == -1) {
                        ...
                        if (var7 != mc.field1339.field4902.field5443) {
                            this.field23648 = mc.field1339.field4902.field5443;
    ...
    private BlockPos method16425() {
        ...
        double var5 = mc.field1339.method3433().field18049;
        double var7 = mc.field1339.method3433().field18050;
        Class6488 var9 = mc.field1339.field5035.method19662(var3, 0.0, var7).method19667(0.0, var5, 0.0);
        Stream var10 = mc.field1338.method7055(mc.field1339, var9);
        ...
        while (var11.hasNext()) {
            ...
            if (Class9217.method34578(var15)
                    && (double) (var15.getY() + 1) < mc.field1339.getPosY()
                    && (
                    var12 == null
                            || mc.field1339
        ...
        if (var12 != null) {
            ...
            var5 = mc.field1339.method3433().field18049 - 1.0;
            var9 = mc.field1339.field5035.method19662(var3, 0.0, var7).method19667(0.0, var5, 0.0);
            var10 = mc.field1338.method7055(mc.field1339, var9);
            ...
            while (var11.hasNext()) {
                ...
                if (Class9217.method34578(var22)
                        && (double) (var22.getY() + 1) < mc.field1339.getPosY()
                        && (
                        var12 == null
                                || mc.field1339
                                .method3276((double) var12.method8304() + 0.5 - var3, var12.getY() + 1, (double) var12.method8306() + 0.5 - var7)
