...
public class Class1160 extends Class1155<Class1160> {
   ...
   public final RealmsScreenReal field6314;

   public Class1160(RealmsScreenReal var1, Class6110 var2) {
      this.field6314 = var1;
      this.field6312 = var2;
   ...
   public boolean mouseClicked(double var1, double var3, int var5) {
      Class6065.method18805(RealmsScreenReal.method2390(this.field6314), this, this.field6313, var5, var1, var3);
      return true;
   }

   private void method5556(MatrixStack var1, Class6110 var2, int var3, int var4, int var5, int var6) {
      RealmsScreenReal.method2394(this.field6314).method38801(var1, var2.field27371, (float)(var3 + 38), (float)(var4 + 1), 16777215);
      RealmsScreenReal.method2395(this.field6314).method38801(var1, var2.field27372, (float)(var3 + 38), (float)(var4 + 12), 7105644);
      RealmsScreenReal.method2396(this.field6314).method38801(var1, Class9740.method38174(var2.field27374), (float)(var3 + 38), (float)(var4 + 24), 7105644);
      Class6065.method18804(var1, this.field6313, RealmsScreenReal.method2390(this.field6314), var3, var4, var5, var6);
