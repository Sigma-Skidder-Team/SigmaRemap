...
public class Class4539 extends Class4536
{
    ...
    public boolean method13536(final Class1851 class1851, final Random rnd, final Class354 class1852, final Class7096 class1853) {
        ...
        final Class354 method1153 = class1854.method1153();
        final int n2 = rnd.nextInt(3) + 2;
        final ArrayList arrayList = Lists.newArrayList((Iterable)Class98.field268);
        Collections.shuffle(arrayList, rnd);
        for (final Class179 class1855 : arrayList.subList(0, n2)) {
