...
public class Class6119 implements Class6113
{
    ...
    public void method18269(final Class7351 class7351, final Class7807 class7352, final double n, final double n2, final double n3) {
        ...
        this.field24838.forEach((p1, list) -> {
            ...
            final Object o = new Class354(class7354.method18161().field22770, 0.0, class7354.method18161().field22772);
            int i = 0;
            while (i < list.size()) {
                final Class7472 class7355 = list.get(i);
                if (!(!class7353.method1081(class7355.field28861, 160.0))) {
                    Class7282.method22339(class7355.field28863, class7355.field28861.method1074() + 0.5, class7355.field28861.method1075() + 2.0 + i * 0.25, class7355.field28861.method1076() + 0.5, class7355.field28864 ? -16711936 : -3355444);
                }
                ++i;
            }
            return;
