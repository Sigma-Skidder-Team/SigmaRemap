...
public class Class6698 extends Class6693
{
    ...
    public void run(final String s, final Class8025[] array, final Class6428 class6428) throws CommandException {
        final List<Class6693> method32668 = Class9463.method35173().method35204().method32668();
        ...
        if (array.length == 1 && array[0].method26310() == Class1954.field10636) {
            final Class6693 method32669 = Class9463.method35173().method35204().method32667(array[0].method26314());
            if (method32669 == null) {
                throw new Class2332();
            }
