...
public class MusicPlayer extends Class4278 {
   ...
   public MusicPlayer(CustomGuiScreen var1, String var2) {
      ...
      this.addToList(this.field20851 = new Class4339(this, "musictabs", 0, this.field20847 + 14, this.field20845,
            this.getHeightA() - 64 - this.field20848));
      this.addToList(
      ...
      ColorHelper var6 = new ColorHelper(1250067, -15329770).method19410(ClientColors.LIGHT_GREYISH_BLUE.getColor())
            .method19414(Class2218.field14492);
      ...
      this.pngButtons
            .addToList(
                  this.play = new PNGIconButton(
                        this.pngButtons, "play", var15, 27, 38, 38, ResourceList.playPNG,
                        new ColorHelper(ClientColors.LIGHT_GREYISH_BLUE.getColor()), null));
      this.pngButtons
            .addToList(
                  this.pause = new PNGIconButton(
                        this.pngButtons, "pause", var15, 27, 38, 38, ResourceList.pausePNG,
                        new ColorHelper(ClientColors.LIGHT_GREYISH_BLUE.getColor()), null));
      this.pngButtons
            .addToList(
                  this.forwards = new PNGIconButton(
                        this.pngButtons, "forwards", var15 + 114, 23, 46, 46, ResourceList.forwardsPNG,
                        new ColorHelper(ClientColors.LIGHT_GREYISH_BLUE.getColor()), null));
      this.pngButtons
            .addToList(
                  this.backwards = new PNGIconButton(
                        this.pngButtons, "backwards", var15 - 114, 23, 46, 46, ResourceList.backwardsPNG,
                        new ColorHelper(ClientColors.LIGHT_GREYISH_BLUE.getColor()), null));
      this.pngButtons.addToList(this.volumeSlider = new VolumeSlider(this.pngButtons, "volume",
            this.getWidthA() - this.field20845 - 19, 14, 4, 40));
      ...
      this.volumeSlider.method13709(
            var1x -> this.field20854.method24311((int) ((1.0F - this.volumeSlider.method13707()) * 100.0F)));
      this.volumeSlider.method13708(1.0F - (float) this.field20854.method24314() / 100.0F);
      this.addToList(
            this.searchBox = new SearchBoxButton(
                  this, "search", this.field20845, 0, this.getWidthA() - this.field20845,
   ...
   public void draw(float partialTicks) {
      ...
      RenderUtil.drawRect(
            ...
            MultiUtilities.applyAlpha(-14277082, partialTicks * 0.8F));
      RenderUtil.drawRect(
            (float) this.getXA(),
            (float) this.getYA(),
            (float) (this.getXA() + this.field20845),
            (float) (this.getYA() + this.getHeightA() - this.field20848),
            MultiUtilities.applyAlpha(-16777216, partialTicks * 0.95F));
   ...
   private void method13192(float var1) {
      ...
      RenderUtil.drawString(
            ...
            (float) (this.getXA() + this.getWidthA() - 14
                  - ResourceRegistry.JelloLightFont14.getWidth(Class9275.method34955(var5))),
            (float) (this.getYA() + this.getHeightA() - 10) - 22.0F * var1,
   ...
   private void method13193(float var1) {
      ...
      if (var4 != null && var5 != null) {
         ...
         RenderUtil.drawRoundedRect(
               (float) (this.getXA() + (this.field20845 - 114) / 2), (float) (this.getYA() + this.getHeightA() - 170),
   ...
   private void method13196(float var1) {
      ...
      if (this.field20863 != this.field20852.method13513()) {
         try {
            ...
            this.field20864 = TextureUtil.method32933(
                  "blur",
                  ImageUtil.method35037(this.getXA() + this.field20845, this.getYA(),
                        this.getWidthA() - this.field20845, this.field20847, 10, 10));
      ...
      RenderUtil.drawString(
            ...
            (float) ((this.getWidthA() - ResourceRegistry.JelloLightFont25.getWidth(this.field20849)
                  + this.field20845) / 2),
      ...
      RenderUtil.drawString(
            ...
            (float) ((this.getWidthA() - ResourceRegistry.JelloMediumFont25.getWidth(this.field20849)
                  + this.field20845) / 2),
            16.0F + (1.0F - var4) * 14.0F,
            this.field20849,
