...
public class Class283 extends Class281 {
   ...
   private Map<ResourceLocation, Class122> field1080 = ImmutableMap.of();
   ...
   @Nullable
   public Class122 method1052(ResourceLocation var1) {
      return this.field1080.get(var1);
   }

   public void method971(Map<ResourceLocation, JsonElement> var1, Class191 var2, Class7165 var3) {
      Builder<ResourceLocation, Class122> var6 = ImmutableMap.builder();
      var1.forEach((var1x, var2x) -> {
         try {
            if (var2x.isJsonArray()) {
               Class122[] var5 = field1079.fromJson(var2x, Class122[].class);
               var6.put(var1x, new Class125(var5));
            } else {
               Class122 var7x = field1079.fromJson(var2x, Class122.class);
      ...
      ImmutableMap<ResourceLocation, Class122> var7 = var6.build();
