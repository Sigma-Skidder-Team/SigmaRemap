...
public class Class4561 extends CacheLoader<Long, List<Class9648>> {
   ...
   public List<Class9648> load(Long var1) {
      ...
      for (int var6 = 0; var6 < 10; var6++) {
         int var7 = MathHelper.method37769(42.0 * Math.cos(2.0 * (-Math.PI + (Math.PI / 10) * (double)var6)));
         int var8 = MathHelper.method37769(42.0 * Math.sin(2.0 * (-Math.PI + (Math.PI / 10) * (double)var6)));
