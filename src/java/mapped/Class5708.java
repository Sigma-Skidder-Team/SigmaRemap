...
public class Class5708 extends Class5651<Class1027, Class2891<Class1027>> {
   ...
   public void render(Class1027 entity, float var2, float var3, MatrixStack var4, Class7733 var5, int var6) {
      this.mainModel.method11207(!entity.getHeldItemMainhand().isEmpty());
