...
public class Class134 extends Class128 {
   ...
   private final List<Enchantment> field455;

   public Class134(ILootCondition[] var1, Collection<Enchantment> var2) {
      super(var1);
   ...
   public ItemStack method371(ItemStack var1, LootContext var2) {
      ...
      if (!this.field455.isEmpty()) {
         ...
         var6 = (Enchantment)var8.get(var5.nextInt(var8.size()));
      }

      return method391(var1, var6, var5);
   }

   private static ItemStack method391(ItemStack var0, Enchantment var1, Random var2) {
   ...
   // $VF: synthetic method
   public static List<Enchantment> method395(Class134 var0) {
