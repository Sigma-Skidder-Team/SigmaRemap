...
public abstract class Class7665 {
   ...
   private boolean method25187(Class1660 var1, BlockPos var2) {
      for (BlockPos var6 : Mutable.method8359(var2.down().method8342(2).method8346(2), var2.up().method8344(2).method8348(2))) {
         if (var1.getBlockState(var6).method23446(BlockTags.field32773)) {
            return true;
         }
      }
