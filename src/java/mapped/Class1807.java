...
public class Class1807 implements AutoCloseable {
         ...
         for (Class1768 var7x : var1) {
            ...
            if (var8 != null) {
               ...
               if (var8 != Class2054.field13380) {
                  this.field9740.computeIfAbsent(Class9679.method37773(((Class2052)var8).method8699(false)), var0 -> new IntArrayList()).add(var3);
               }
               break;
            }
         }
   ...
   public Class8978 method7926(Class2052 var1) {
      IntList var4 = (IntList)this.field9740.get(Class9679.method37773(var1.method8699(false)));
