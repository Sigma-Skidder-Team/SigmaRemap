    ...
    public void method17588(final T t, final float n, final float n2, final float n3, final float n4, final float n5) {
        ...
        if (t.method4216()) {
            if (method2713.method27620() || method2713.method27622() != Class7739.field31279) {
                final float method2714 = Class9546.method35638(this.field23955 * 3.1415927f);
                final float method2715 = Class9546.method35638((1.0f - (1.0f - this.field23955) * (1.0f - this.field23955)) * 3.1415927f);
