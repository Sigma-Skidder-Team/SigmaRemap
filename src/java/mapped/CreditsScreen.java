...
public class CreditsScreen extends Screen {
   ...
   public void draw(float var1) {
      ...
      this.method13416();
      RenderUtil.drawRect(
         0.0F, 0.0F, (float)this.getWidth(), (float)this.getHeight(), ColorUtils.applyAlpha(ClientColors.LIGHT_GREYISH_BLUE.getColor, 0.9F * this.field21072)
      );
      ...
      GL11.glPushMatrix();
      GL11.glTranslatef((float)(this.getWidth() / 2), (float)(this.getHeight() / 2), 0.0F);
      ...
      RenderUtil.drawString(
         var9, (float)((this.getWidth() - var9.method23942(var8)) / 2), (float)(this.getHeight() - 110), var8, ClientColors.DEEP_TEAL.getColor
      );
      GL11.glPopMatrix();
      RenderUtil.method11449(
         (float)(this.getWidth() / 2) - ((float)var4 - (float)var4 * (this.field21072 - 1.0F) * this.field21072) / 2.0F,
         (float)(
            (double)(Math.max((float)var5 * 1.2F, (float)(this.getHeight() / 2)) - (float)var5)
               - (double)var5
   ...
   private void method13416() {
      ...
      RenderUtil.method11455(
         (float)this.field21074, (float)this.field21073, (float)(this.getWidth() * 2), (float)(this.getHeight() + 114), ResourcesDecrypter.panoramaPNG
      );
      float var7 = 0.5F;
