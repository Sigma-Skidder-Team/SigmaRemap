...
public class Class829 extends Screen {
   ...
   public Class829(BooleanConsumer var1, ITextComponent var2, ITextComponent var3) {
      this(var1, var2, var3, Class7127.field30660, Class7127.field30661);
   }

   public Class829(BooleanConsumer var1, ITextComponent var2, ITextComponent var3, ITextComponent var4, ITextComponent var5) {
      super(var2);
      this.field4605 = var1;
      this.field4600 = var3;
      this.field4602 = var4;
   ...
   public String method2326() {
      return super.method2326() + ". " + this.field4600.getString();
   }
