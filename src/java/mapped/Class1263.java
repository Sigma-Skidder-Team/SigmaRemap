...
public class Class1263 extends Class1193 implements Class1190, Class1152 {
   ...
   public void method5901(Minecraft var1, Class9266 var2, int var3, int var4, int var5, int var6, float var7) {
      ...
      if (var20 > var21) {
         this.field6681 = (int)((float)this.field6681 - var7 * (float)Class9679.method37773((var20 - var21) / var7));
      }

      float var22 = (float)this.field6681;
      float var23 = (float)(var6 - 100);
      if (var22 < var23) {
         this.field6681 = (int)((float)this.field6681 - var7 * (float)Class9679.method37773((var22 - var23) / var7));
      }
   ...
   public void method1923(Class9332 var1, int var2, int var3, float var4) {
      if (this.field6679) {
         ...
         int var9 = Class9679.method37773((float)this.field6678.size() / (float)var7);
         byte var10 = 24;
         byte var11 = 4;
         byte var12 = 82;
         short var13 = 208;
