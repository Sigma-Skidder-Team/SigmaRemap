...
public class Class4191 extends Class4188 {
   ...
   public Class4191(Class8761 var1, Class39 var2) {
   ...
   public boolean method12933(Class1658 var1, Class9764 var2, Random var3, int var4, int var5, int var6, ResourceLocation var7) {
      ...
      if (var2.method38396(var10) && var1.method6738(var10).method23393() && !var1.method6738(var10.method8313()).method23393()) {
         Class7380 var11 = Class8487.field36550.method11579().method23465(Class3430.field19191, !var3.nextBoolean() ? Class96.field248 : Class96.field247);
   ...
   public boolean method12896(Class1658 var1, Class7480 var2, Class5646 var3, Random var4, Class9764 var5, Class7481 var6, BlockPos var7) {
      if (this.method12919(var1, var5)) {
         ...
         Class7380 var15 = this.method12967();
         ...
         if (this.field20484) {
            this.method12929(var1, var5, var4, 0.6F, 0, 0, 0, 2, 1, var14, Class8487.field36481.method11579(), field20443, false, true);
         }
         ...
         for (int var16 = 0; var16 < this.field20486; var16++) {
            ...
            if (this.field20484 && !this.field20485) {
               ...
               if (var5.method38396(var22) && this.method12925(var1, 1, 0, var19, var5)) {
                  ...
                  var1.method6725(var22, Class8487.field36532.method11579(), 2);
                  Class944 var23 = var1.method6759(var22);
                  if (var23 instanceof Class960) {
                     ((Class960)var23).method3911().method24790(Class8992.field41013);
                  }
               }
            }
         }
         ...
         for (int var24 = 0; var24 <= 2; var24++) {
            for (int var26 = 0; var26 <= var14; var26++) {
               byte var28 = -1;
               Class7380 var30 = this.method12924(var1, var24, -1, var26, var5);
               if (var30.method23393() && this.method12925(var1, var24, -1, var26, var5)) {
                  byte var32 = -1;
         ...
         if (this.field20483) {
            Class7380 var25 = Class8487.field36550.method11579().method23465(Class3430.field19191, Class96.field247);

            for (int var27 = 0; var27 <= var14; var27++) {
               Class7380 var29 = this.method12924(var1, 1, -1, var27, var5);
               if (!var29.method23393() && var29.method23409(var1, new BlockPos(this.method12920(1, var27), this.method12921(-1), this.method12922(1, var27)))
                  )
                {
   ...
   private void method12973(Class1658 var1, Class9764 var2, int var3, int var4, int var5, int var6, int var7, Random var8) {
      if (this.method12969(var1, var2, var3, var7, var6, var5)) {
         Class7380 var11 = this.method12967();
         Class7380 var12 = this.method12968();
         ...
         if (var8.nextInt(4) != 0) {
            ...
            this.method12930(
               var1, var2, var8, 0.05F, var3 + 1, var6, var5 - 1, Class8487.field36529.method11579().method23465(Class3382.field18985, Direction.NORTH)
            );
            this.method12930(
               var1, var2, var8, 0.05F, var3 + 1, var6, var5 + 1, Class8487.field36529.method11579().method23465(Class3382.field18985, Direction.SOUTH)
            );
         } else {
   ...
   private void method12974(Class1658 var1, Class9764 var2, Random var3, float var4, int var5, int var6, int var7) {
      if (this.method12925(var1, var5, var6, var7, var2)) {
         this.method12930(var1, var2, var3, var4, var5, var6, var7, Class8487.field36481.method11579());
      }
   }
}
