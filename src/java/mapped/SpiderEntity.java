...
public class SpiderEntity extends MonsterEntity {
   ...
   private static final DataParameter<Byte> field6057 = EntityDataManager.<Byte>createKey(SpiderEntity.class, DataSerializers.field33390);

   public SpiderEntity(EntityType<? extends SpiderEntity> var1, World var2) {
      super(var1, var2);
   }
   ...
   public Class5093 method4276(ServerWorldAccess var1, Class9755 var2, SpawnReason var3, Class5093 var4, CompoundNBT var5) {
      ...
      if (var1.method6814().nextInt(100) == 0) {
         SkeletonEntity var8 = EntityType.SKELETON.create(this.world);
