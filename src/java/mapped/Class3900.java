...
public class Class3900 extends Class3892 implements Class3840
{
    ...
    @Nullable
    public static Class179 method11985(final Class1855 class1855, final Class354 class1856) {
        final Class7096 method6701 = class1855.method6701(class1856);
        return (method6701.method21696() instanceof Class3900) ? method6701.method21772((Class7111<Class179>)Class3900.field17564) : null;
    }
    
    @Override
    public Class2201 method11844(Class7096 method6701, final Class1847 class1847, Class354 method6702, final Class512 class1848, final Class316 class1849, final Class7005 class1850) {
        if (class1847.field10067) {
            return Class2201.field13401;
        }
        if (method6701.method21772(Class3900.field17599) != Class105.field323) {
            method6702 = method6702.method1149(method6701.method21772((Class7111<Class179>)Class3900.field17564));
        ...
        if (!class1847.field10063.method20494() || class1847.method6959(method6702) == Class7102.field27640) {
            ...
            final Class354 method6703 = method6702.method1149(method6701.method21772((Class7111<Class179>)Class3900.field17564).method782());
            if (class1847.method6701(method6703).method21696() == this) {
                class1847.method6690(method6703, false);
            }
            class1847.method6724(null, Class7929.method25704(), method6702.method1074() + 0.5, method6702.method1075() + 0.5, method6702.method1076() + 0.5, 5.0f, true, Class2196.field13367);
    ...
    private boolean method11986(final Class1847 class1847, final Class354 class1848) {
        final List<Class399> method6739 = class1847.method6739((Class<? extends Class399>)Class824.class, new Class6221(class1848), Class511::method2783);
    ...
    private void method11987(final Class399 class399) {
    ...
    public Class7096 method11789(final Class7096 class7096, final Class179 class7097, final Class7096 class7098, final Class1851 class7099, final Class354 class7100, final Class354 class7101) {
        if (class7097 != method11988(class7096.method21772(Class3900.field17599), class7096.method21772((Class7111<Class179>)Class3900.field17564))) {
    ...
    private static Class179 method11988(final Class105 class105, final Class179 class106) {
        return (class105 != Class105.field324) ? class106.method782() : class106;
    }
    ...
    public void method11870(final Class1847 class1847, final Class354 class1848, final Class7096 class1849, final Class512 class1850) {
        ...
        final Class354 method1149 = class1848.method1149(method11988(class1851, class1849.method21772((Class7111<Class179>)Class3900.field17564)));
    ...
    public Class7096 method11846(final Class7074 class7074) {
        final Class179 method21644 = class7074.method21644();
    ...
    public Class7702 method11808(final Class7096 class7096, final Class1855 class7097, final Class354 class7098, final Class7543 class7099) {
        switch (Class9422.field40421[method11989(class7096).method782().ordinal()]) {
            case 1: {
    ...
    public static Class179 method11989(final Class7096 class7096) {
        final Class179 class7097 = class7096.method21772((Class7111<Class179>)Class3900.field17564);
        return (class7096.method21772(Class3900.field17599) != Class105.field323) ? class7097 : class7097.method782();
    }
    ...
    public static Optional<Class5487> method11991(final Class7499<?> class7499, final Class1852 class7500, final Class354 class7501, int n) {
        final Class179 class7502 = class7500.method6701(class7501).method21772((Class7111<Class179>)Class3900.field17564);
        final int method1074 = class7501.method1074();
        final int method1075 = class7501.method1075();
        final int method1076 = class7501.method1076();
        for (int i = 0; i <= 1; ++i) {
            final int n2 = method1074 - class7502.method785() * i - 1;
            final int n3 = method1076 - class7502.method787() * i - 1;
            final int n4 = n2 + 2;
            final int n5 = n3 + 2;
            for (int j = n2; j <= n4; ++j) {
                for (int k = n3; k <= n5; ++k) {
                    final Optional<Class5487> method1077 = method11992(class7499, class7500, new Class354(j, method1075, k));
    ...
    public static Optional<Class5487> method11992(final Class7499<?> class7499, final Class1852 class7500, final Class354 class7501) {
        if (class7500.method6701(class7501).method21727(class7500, class7501).method24536(Class111.field352) > 0.4375) {
            return Optional.empty();
        }
        final Class385 class7502 = new Class385(class7501);
        while (class7502.method1075() >= 0) {
            if (class7501.method1075() - class7502.method1075() > 2) {
                break;
            }
            if (!class7500.method6701(class7502).method21727(class7500, class7502).method24540()) {
                break;
            }
            class7502.method1290(Class179.field511);
        }
        final Class7702 method21727 = class7500.method6701(class7502).method21727(class7500, class7502);
        if (method21727.method24540()) {
            return Optional.empty();
        }
        final double n = class7502.method1075() + method21727.method24536(Class111.field352) + 2.0E-7;
        if (class7501.method1075() - n <= 2.0) {
            final float n2 = class7499.method23369() / 2.0f;
            final Class5487 value = new Class5487(class7502.method1074() + 0.5, n, class7502.method1076() + 0.5);
    ...
    public void method11853(final Class1847 class1847, final Class354 class1848, final Class7096 class1849, final Class511 class1850, final Class8321 class1851) {
        ...
        if (!class1847.field10067) {
            class1847.method6688(class1848.method1149(class1849.method21772((Class7111<Class179>)Class3900.field17564)), ((Class7097<O, Class7096>)class1849).method21773(Class3900.field17599, Class105.field323), 3);
    ...
    public long method11868(final Class7096 class7096, final Class354 class7097) {
        final Class354 method1150 = class7097.method1150(class7096.method21772((Class7111<Class179>)Class3900.field17564), (class7096.method21772(Class3900.field17599) != Class105.field323) ? 1 : 0);
        return Class9546.method35689(method1150.method1074(), class7097.method1075(), method1150.method1076());
    }
