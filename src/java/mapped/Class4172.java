...
public class Class4172 extends Class4167 {
   ...
   public boolean method12896(ISeedReader var1, Class7480 var2, ChunkGenerator var3, Random var4, Class9764 var5, ChunkPos var6, BlockPos var7) {
      ...
      BlockState var12 = var11.with(Class3239.field18683, Boolean.valueOf(true));
      BlockState var13 = var11.with(Class3239.field18681, Boolean.valueOf(true));
      ...
      for (int var14 = 1; var14 <= 11; var14 += 2) {
         ...
         this.method12923(var1, Blocks.NETHER_BRICKS.method11579(), var14, 13, 0, var5);
         this.method12923(var1, Blocks.NETHER_BRICKS.method11579(), var14, 13, 12, var5);
         this.method12923(var1, Blocks.NETHER_BRICKS.method11579(), 0, 13, var14, var5);
         this.method12923(var1, Blocks.NETHER_BRICKS.method11579(), 12, 13, var14, var5);
         if (var14 != 11) {
      ...
      this.method12923(
         var1,
         Blocks.NETHER_BRICK_FENCE.method11579().with(Class3239.field18680, Boolean.valueOf(true)).with(Class3239.field18681, Boolean.valueOf(true)),
         0,
         13,
         0,
         var5
      ...
      this.method12923(
         var1,
         Blocks.NETHER_BRICK_FENCE.method11579().with(Class3239.field18682, Boolean.valueOf(true)).with(Class3239.field18681, Boolean.valueOf(true)),
         0,
         13,
         12,
         var5
      ...
      this.method12923(
         var1,
         Blocks.NETHER_BRICK_FENCE.method11579().with(Class3239.field18682, Boolean.valueOf(true)).with(Class3239.field18683, Boolean.valueOf(true)),
         12,
         13,
         12,
         var5
      ...
      this.method12923(
         var1,
         Blocks.NETHER_BRICK_FENCE.method11579().with(Class3239.field18680, Boolean.valueOf(true)).with(Class3239.field18683, Boolean.valueOf(true)),
         12,
         13,
         0,
         var5
      ...
      BlockState var20 = Blocks.NETHER_BRICK_STAIRS.method11579().with(Class3421.field19131, Direction.NORTH);
      ...
      for (int var15 = 0; var15 <= 6; var15++) {
         ...
         if (var16 >= 5 && var16 <= 8) {
            this.method12927(var1, var5, 5, 5, var16, 7, var15 + 4, var16, Blocks.NETHER_BRICKS.method11579(), Blocks.NETHER_BRICKS.method11579(), false);
         } else if (var16 >= 9 && var16 <= 10) {
            this.method12927(var1, var5, 5, 8, var16, 7, var15 + 4, var16, Blocks.NETHER_BRICKS.method11579(), Blocks.NETHER_BRICKS.method11579(), false);
         }
      ...
      this.method12927(var1, var5, 2, 5, 2, 3, 5, 3, Blocks.NETHER_BRICKS.method11579(), Blocks.NETHER_BRICKS.method11579(), false);
      this.method12927(var1, var5, 2, 5, 9, 3, 5, 10, Blocks.NETHER_BRICKS.method11579(), Blocks.NETHER_BRICKS.method11579(), false);
      this.method12927(var1, var5, 2, 5, 4, 2, 5, 8, Blocks.NETHER_BRICKS.method11579(), Blocks.NETHER_BRICKS.method11579(), false);
      ...
      BlockState var22 = var20.with(Class3421.field19131, Direction.EAST);
      BlockState var23 = var20.with(Class3421.field19131, Direction.WEST);
      ...
      this.method12927(var1, var5, 3, 5, 4, 4, 5, 8, Blocks.NETHER_WART.method11579(), Blocks.NETHER_WART.method11579(), false);
      this.method12927(var1, var5, 8, 5, 4, 9, 5, 8, Blocks.NETHER_WART.method11579(), Blocks.NETHER_WART.method11579(), false);
      ...
      for (int var24 = 4; var24 <= 8; var24++) {
         for (int var18 = 0; var18 <= 2; var18++) {
            this.method12932(var1, Blocks.NETHER_BRICKS.method11579(), var24, -1, var18, var5);
            this.method12932(var1, Blocks.NETHER_BRICKS.method11579(), var24, -1, 12 - var18, var5);
         }
      }

      for (int var25 = 0; var25 <= 2; var25++) {
         for (int var26 = 4; var26 <= 8; var26++) {
            this.method12932(var1, Blocks.NETHER_BRICKS.method11579(), var25, -1, var26, var5);
            this.method12932(var1, Blocks.NETHER_BRICKS.method11579(), 12 - var25, -1, var26, var5);
         }
      }
