...
public class Class2608 extends Class2595 {
         ...
         if (!this.field16860.world.method6740()) {
            if (this.field16860.getRNG().nextInt(this.field16861) == 0) {
               ...
               if (var3.method6954(var4, 6)) {
                  Vector3d var5 = Class8037.method27584(this.field16860, 15, 7, var1 -> (double)(-var3.method6955(SectionPos.method8390(var1))));
   ...
   private void method10814() {
      ...
      BlockPos var4 = this.field16860
         .world
         .method7006(Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, this.field16860.getPosition().method8336(-8 + var3.nextInt(16), 0, -8 + var3.nextInt(16)));
