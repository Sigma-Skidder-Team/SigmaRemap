...
public class Class4251 extends Class4247 {
   ...
   public void draw(float var1) {
      ...
      RenderUtil.renderBackgroundBox(
         ...
         1.0F,
         (float)this.heightA,
         MultiUtilities.applyAlpha(ClientColors.DEEP_TEAL.color, 0.14F)
      );
      int var6 = MultiUtilities.applyAlpha(MultiUtilities.method17691(-7687425, 0.2F), 0.8F);
      var6 = MultiUtilities.applyAlpha(ClientColors.DEEP_TEAL.color, 0.6F);
      ...
      RenderUtil.drawString(
         ...
         var7,
         MultiUtilities.applyAlpha(ClientColors.LIGHT_GREYISH_BLUE.color, 0.5F)
      );
   }
