...
public class Class9453 {
   ...
   private boolean method36341(int var1) {
      if (this.field43918 > 0L && this.field43918 < Util.method38487() - 100L) {
         return true;
      } else {
         switch (var1) {
            case 65:
               this.field43915.field1287.method868();
            ...
            case 66:
               ...
               return true;
            case 67:
               if (this.field43915.field1339.method2964()) {
                  return false;
               } else {
                  ClientPlayNetHandler var9 = this.field43915.field1339.connection;
                  if (var9 == null) {
                     return false;
                  }
                  ...
                  this.method36350(
                     String.format(
                        ...
                        this.field43915.field1339.field5024.method6813().method31399(),
                        this.field43915.field1339.getPosX(),
                        this.field43915.field1339.getPosY(),
                        this.field43915.field1339.getPosZ(),
                        this.field43915.field1339.field5031,
                        this.field43915.field1339.field5032
                     )
                  );
                  return true;
               }
            case 68:
               if (this.field43915.field1298 != null) {
                  this.field43915.field1298.method5989().method5929(false);
               }
            ...
            case 70:
               ...
               this.method36339("debug.cycle_renderdistance.message", this.field43915.field1299.field44574);
               return true;
            case 71:
               ...
               return true;
            case 72:
               this.field43915.field1299.field44588 = !this.field43915.field1299.field44588;
               this.method36339(this.field43915.field1299.field44588 ? "debug.advanced_tooltips.on" : "debug.advanced_tooltips.off");
               this.field43915.field1299.method37146();
               return true;
            case 73:
               if (!this.field43915.field1339.method2964()) {
                  this.method36342(this.field43915.field1339.method3424(2), !Screen.method2476());
               }

               return true;
            case 76:
               Minecraft var6 = Class7944.method26860();
               var6.field1287.field1023 = 1;
               StringTextComponent var7 = new StringTextComponent(Class9088.method33883("of.message.loadingVisibleChunks"));
               var6.field1298.method5989().method5931(var7, 201435902);
               return true;
            case 78:
               if (!this.field43915.field1339.method3424(2)) {
                  this.method36339("debug.creative_spectator.error");
               } else if (!this.field43915.field1339.method2800()) {
                  this.field43915.field1339.method5389("/gamemode spectator");
               } else {
                  this.field43915.field1339.method5389("/gamemode " + this.field43915.field1337.method23156().method8153());
               }
            ...
            case 79:
               ...
               return true;
            case 80:
               this.field43915.field1299.field44589 = !this.field43915.field1299.field44589;
               this.field43915.field1299.method37146();
               this.method36339(this.field43915.field1299.field44589 ? "debug.pause_focus.on" : "debug.pause_focus.off");
               return true;
            case 81:
               this.method36339("debug.help.message");
               Class1266 var8 = this.field43915.field1298.method5989();
      ...
      if (var5 != null) {
         switch (Class8869.field40061[var5.method31417().ordinal()]) {
            case 1:
               ...
               Class7380 var7 = this.field43915.field1339.field5024.method6738(var6);
               if (var1) {
                  if (var2) {
                     this.field43915.field1339.connection.method15799().method14179(var6, var3 -> {
                        this.method36343(var7, var6, var3);
                        this.method36339("debug.inspect.server.block");
                     });
                  } else {
                     Class944 var11 = this.field43915.field1339.field5024.method6759(var6);
   ...
   public void method36345(long var1, int var3, int var4, int var5, int var6) {
      if (var1 == this.field43915.method1580().method8039()) {
         ...
         if (this.field43915.field1355 != null) {
            if (this.field43915.field1355 instanceof Class1331 && var3 == 258) {
         ...
         if (this.field43918 <= 0L) {
            if (Class9798.method38639(Minecraft.getInstance().method1580().method8039(), 67)
               ...
               this.field43918 = Util.method38487();
               this.field43919 = Util.method38487();
               this.field43920 = 0L;
            }
         ...
         Screen var15 = this.field43915.field1355;
         if (!(this.field43915.field1355 instanceof Class1138) || ((Class1138)var15).field6200 <= Util.method38487() - 20L) {
            if (var5 != 1) {
               if (var5 == 0 && this.field43915.field1355 instanceof Class1138) {
                  ((Class1138)this.field43915.field1355).field6199 = null;
               }
            } else {
               if (this.field43915.field1299.field44652.method8519(var3, var4)) {
                  this.field43915.method1580().method8034();
                  this.field43915.field1299.field44626 = this.field43915.method1580().method8040();
                  this.field43915.field1299.method37146();
                  return;
               }

               if (this.field43915.field1299.field44649.method8519(var3, var4)) {
                  if (!Screen.method2475()) {
                  }

                  Class8683.method31251(
                     this.field43915.field1303,
                     this.field43915.method1580().method8041(),
                     this.field43915.method1580().method8042(),
                     this.field43915.method1464(),
                     var1x -> this.field43915.execute(() -> this.field43915.field1298.method5989().method5930(var1x))
                  );
                  return;
               }
            }
         ...
         if (var5 != 0 && var3 == 66 && Screen.method2475() && var10) {
            Class5805.field25346.method17945(this.field43915.field1299, 1);
               ...
               if (var5 != 1 && (var5 != 2 || !this.field43916)) {
                  if (var5 == 0) {
                     if (Class9299.field42888.method20214()) {
                        var11[0] = Class9299.method35056(Class9299.field42888, this.field43915.field1355, var3, var4, var6);
                        if (var11[0]) {
                           return;
                        }
                     }
                     ...
                     if (Class9299.field42889.method20214() && !var11[0]) {
                        var11[0] = Class9299.method35056(Class9299.field42889, this.field43915.field1355, var3, var4, var6);
                     }
                  }
               } else {
                  if (Class9299.field42886.method20214()) {
                     var11[0] = Class9299.method35056(Class9299.field42886, this.field43915.field1355, var3, var4, var6);
                     if (var11[0]) {
                        return;
                     }
                  }
                  ...
                  if (Class9299.field42887.method20214() && !var11[0]) {
                     var11[0] = Class9299.method35056(Class9299.field42887, this.field43915.field1355, var3, var4, var6);
                  }
               }
         ...
         if (this.field43915.field1355 == null || this.field43915.field1355.field4567) {
            Class8115 var16 = Class9798.method38637(var3, var4);
            if (var5 != 0) {
               if (var3 == 293 && this.field43915.field1295 != null) {
                  this.field43915.field1295.method734();
               }
               ...
               if (this.field43915.field1355 == null) {
                  ...
                  if (var3 == 290) {
                     this.field43915.field1299.field44662 = !this.field43915.field1299.field44662;
                  }
               }

               if (!var12) {
                  Class2007.method8505(var16, true);
                  Class2007.method8504(var16);
               } else {
                  Class2007.method8505(var16, false);
               }

               if (this.field43915.field1299.field44665 && var3 >= 48 && var3 <= 57) {
               ...
               if (var3 == 292) {
                  if (!this.field43921) {
                     this.field43915.field1299.field44664 = !this.field43915.field1299.field44664;
                     this.field43915.field1299.field44665 = this.field43915.field1299.field44664 && Screen.method2476();
                     this.field43915.field1299.field44666 = this.field43915.field1299.field44664 && Screen.method2477();
                     if (this.field43915.field1299.field44664) {
                        if (this.field43915.field1299.field44697) {
                           this.field43915.field1299.field44666 = true;
                        }

                        if (this.field43915.field1299.field44698) {
                           this.field43915.field1299.field44665 = true;
                        }
                     }
                  } else {
   ...
   private void method36346(long var1, int var3, int var4) {
      if (var1 == this.field43915.method1580().method8039()) {
         ...
         Screen var7 = this.field43915.field1355;
         if (var7 != null && this.field43915.method1577() == null) {
            if (Character.charCount(var3) != 1) {
               for (char var11 : Character.toChars(var3)) {
                  Screen.method2483(() -> {
                     if (!Class9299.field42884.method20214() || !Class9299.method35056(Class9299.field42884, this.field43915.field1355, var11, var4)) {
                        boolean var6 = var7.method1932(var11, var4);
                        if (Class9299.field42885.method20214() && !var6) {
                           Class9299.method35056(Class9299.field42885, this.field43915.field1355, var11, var4);
                        }
                     }
               ...
               Screen.method2483(() -> {
                  if (!Class9299.field42884.method20214() || !Class9299.method35056(Class9299.field42884, this.field43915.field1355, (char)var3, var4)) {
                     boolean var6 = var7.method1932((char)var3, var4);
                     if (Class9299.field42885.method20214() && !var6) {
                        Class9299.method35056(Class9299.field42885, this.field43915.field1355, (char)var3, var4);
                     }
                  }
               }, "charTyped event handler", var7.getClass().getCanonicalName());
            }
