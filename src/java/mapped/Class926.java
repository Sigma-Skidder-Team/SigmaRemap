...
public class Class926 implements Class920, Class925 {
   ...
   private final Class25<Class8848> field5256;
   ...
   public Class926(Class5812 var1, int var2, int var3) {
      this.field5256 = Class25.<Class8848>method68(var2 * var3, Class8848.field39973);
      this.field5259 = var1;
      this.field5257 = var2;
      this.field5258 = var3;
   }
   ...
   public boolean method3617() {
      for (Class8848 var4 : this.field5256) {
         if (!var4.method32105()) {
            return false;
         }
      }
   ...
   public Class8848 method3618(int var1) {
      return var1 < this.method3629() ? this.field5256.get(var1) : Class8848.field39973;
   }
   ...
   public Class8848 method3619(int var1, int var2) {
      Class8848 var5 = Class7920.method26563(this.field5256, var1, var2);
      if (!var5.method32105()) {
   ...
   public void method3659(Class6207 var1) {
      for (Class8848 var5 : this.field5256) {
