...
public class Class8010 extends Class8006<GameProfile, Class6027>
{
    ...
    public String[] method26210() {
        final String[] array = new String[((Class8006<K, Class6027>)this).method26216().size()];
        int n = 0;
        final Iterator<Class6027> iterator = ((Class8006<K, Class6027>)this).method26216().iterator();
