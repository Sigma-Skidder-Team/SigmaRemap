...
public class Class5425 extends Class5424 implements Class5426 {
   ...
   private Class4520 field24127 = null;
   private boolean[] field24128 = new boolean[256];
   private Class1713[] field24129 = null;
   private Class1713[] field24130 = null;
   private Class1713 field24131 = null;
   ...
   private void method17056(int var1) {
      if (this.field24117 + var1 > this.field24113.capacity()) {
         ...
         if (this.field24129 != null) {
            Class1713[] var7 = this.field24129;
            int var8 = this.method17078();
            this.field24129 = new Class1713[var8];
   ...
   public void method17058(float var1, float var2, float var3) {
      ...
      if (this.field24129 != null) {
         Class1713[] var19 = new Class1713[this.field24119 / 4];
   ...
   public void method17062(Class9244 var1) {
      ...
      if (Class9244.method34766(var1) == null) {
         ...
         if (this.field24129 == null || this.field24129.length < this.method17078()) {
            this.field24129 = new Class1713[this.method17078()];
         }

         Class1713[] var6 = Class9244.method34766(var1);
         System.arraycopy(var6, 0, this.field24129, 0, var6.length);
      }
   }

   public void method17063(int var1, Class7831 var2) {
      if (!this.field24126) {
   ...
   private void method17064(Class7831 var1) {
      if (this.field24123 != var1) {
         ...
         boolean var4 = var1 == Class9337.field43335;
         boolean var5 = var1 == Class9337.field43334;
   ...
   public void method17069() {
      ...
      if (this.field24108 && this.field24120.method28517() == Class2142.field14020) {
         Class5426.super.method17026(this.field24109, this.field24110, this.field24111, this.field24112);
      }
   }
   ...
   public Class5422 method17026(int var1, int var2, int var3, int var4) {
      if (!this.field24108) {
         return Class5426.super.method17026(var1, var2, var3, var4);
      } else {
   ...
   public void method17075() {
      if (this.field24129 != null) {
         ...
         for (int var7 = 0; var7 < var6; var7++) {
            Class1713 var8 = this.field24129[var7];
            if (var8 != null) {
   ...
   private int method17076(Class1713 var1, int var2) {
      ...
      for (int var8 = var2; var8 < var7; var8++) {
         Class1713 var9 = this.field24129[var8];
         if (var9 != var1) {
            if (var6 >= 0) {
   ...
   @Override
   public Class8391 method17022(Class7380 var1, BlockPos var2) {
   ...
   public void method17087(float var1, float var2, float var3, int var4, int var5, int var6, int var7, float var8, float var9, int var10, int var11) {
      if (this.field24123.method26216() == Class9337.field43347.method26216()) {
         this.method17068(0, var1);
         this.method17068(4, var2);
         this.method17068(8, var3);
