...
public class Class8618 extends DataFix {
   ...
   public Class8618(Schema var1, boolean var2) {
      super(var1, var2);
   }
   ...
   public TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped(
         ...
         var2 -> var2.updateTyped(
               var4, var2x -> var2x.update(DSL.remainderFinder(), var2xx -> this.method30873((Dynamic<?>)var2.get(DSL.remainderFinder()), var2xx))
            )
      );
   }

   private Dynamic<?> method30873(Dynamic<?> var1, Dynamic<?> var2) {
      String var5 = var1.get("id").asString("");
      if (field38747.containsKey(var5)) {
         Pair var6 = (Pair)field38747.get(var5);
