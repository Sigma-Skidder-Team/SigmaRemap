        ...
        if (method7136 == null) {
            if (this.field23797 >= 100) {
                ...
                if (method7137 != null) {
                    ...
                    this.field23764.method5127().method33698(Class7193.field27956).method17256(new Class5487(method7137.method1938(), method7137.method1941(), method7137.method1945()));
                }
            }
        }
        else if (this.field23797 <= 25) {
            final float n = (float)(Math.acos((float)new Class5487(Class9546.method35638(this.field23764.field2399 * 0.017453292f), 0.0, -Class9546.method35639(this.field23764.field2399 * 0.017453292f)).method16738().method16739(new Class5487(method7136.method1938() - this.field23764.method1938(), 0.0, method7136.method1945() - this.field23764.method1945()).method16738())) * 57.2957763671875) + 0.5f;
            if (n < 0.0f || n > 10.0f) {
                ...
                final double method7138 = Class9546.method35654(Class9546.method35669(180.0 - Class9546.method35693(n2, n3) * 57.2957763671875 - this.field23764.field2399), -100.0, 100.0);
                final Class852 field23764 = this.field23764;
                field23764.field4547 *= 0.8f;
                final float n5;
                float n4 = n5 = Class9546.method35641(n2 * n2 + n3 * n3) + 1.0f;
                if (n4 > 40.0f) {
                    n4 = 40.0f;
                }
