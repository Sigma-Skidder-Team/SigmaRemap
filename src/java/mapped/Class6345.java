...
public class Class6345 extends Class6333 {
   ...
   public void method19269() {
      if (!this.field27877.field5041) {
         ...
         float var3 = Class9679.method37766(Entity.method3234(this.field27877.method3433()));
         if (!((double)var3 >= 0.01)) {
            this.field27878 = 0.0F;
            this.field27856 = 0.0F;
         } else {
            this.field27878 = Class9679.method37777(this.field27878 + 0.0025F, 0.0F, 1.0F);
            this.field27856 = Class9679.method37821(Class9679.method37777(var3, 0.0F, 0.5F), 0.0F, 0.7F);
         }
      } else {
         this.method19271();
      }
