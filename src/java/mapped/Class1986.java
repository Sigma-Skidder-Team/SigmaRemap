...
public enum Class1986
{
    field10996("RUN_ONE", 0) {
        public Class1988(final String s, final int n) {
        }
        
        @Override
        public <E extends Class511> void method7999(final Class8841<Class5419<? super E>> class8841, final Class1849 class8842, final E e, final long n) {
    ...
    field10997("TRY_ALL", 1) {
        public Class1987(final String s, final int n) {
        }
    ...
    public abstract <E extends Class511> void method7999(final Class8841<Class5419<? super E>> p0, final Class1849 p1, final E p2, final long p3);
}
