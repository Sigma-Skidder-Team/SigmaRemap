...
public class JelloOptionsMainMenu extends CustomGuiScreen {
   public JelloOptionsMainMenu(CustomGuiScreen var1, String var2, int var3, int var4, int var5, int var6) {
      ...
      UIButton var11;
      this.addToList(var11 = new UIButton(this, "openGui", var5 / 2, var6 - 80, 300, 38, var9, "Open Jello's Click GUI",
      ...
      var10.doThis(
            (var0, var1x) -> JelloInGameOptions.method13438(new Class1144(new StringTextComponent("Keybind Manager"))));
      var11.doThis((var0, var1x) -> JelloInGameOptions.method13438(new ClickGui(new StringTextComponent("Click GUI"))));
      var12.doThis(
            (var0, var1x) -> JelloInGameOptions.method13438(new Class1133(new StringTextComponent("GuiCredits"))));
      UICheckBox var13;
   ...
   public void draw(float var1) {
      ...
      String var5 = "Click GUI is currently bound to: "
            + MultiUtilities
                  .method17736(Client.getInstance().moduleManager.getMacOSTouchBar().method13728(ClickGui.class))
            + " Key";
      RenderUtil.drawString(
            ResourceRegistry.JelloLightFont20,
      ...
      RenderUtil.drawString(
            ResourceRegistry.JelloLightFont20,
            (float) (this.getXA() + (this.getWidthA() - ResourceRegistry.JelloLightFont20.getStringWidth(var7)) / 2
                  - 114),
      ...
      RenderUtil.drawString(
            ResourceRegistry.JelloLightFont20,
            (float) (this.getXA() + (this.getWidthA() - ResourceRegistry.JelloLightFont20.getStringWidth(var8)) / 2
                  + 52),
            (float) (this.getYA() + this.getHeightA() - 221),
            var8,
            MultiUtilities.applyAlpha(ClientColors.LIGHT_GREYISH_BLUE.getColor, 0.5F * var1));
