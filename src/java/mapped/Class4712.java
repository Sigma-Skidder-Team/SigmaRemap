...
public abstract class Class4712<T extends Class759, M extends Class5845<T>> extends Class4710<T, M>
{
    ...
    public boolean method14005(final T t, final Class6664 class6664, final double n, final double n2, final double n3) {
        if (!super.method13952((T)t, class6664, n, n2, n3)) {
            final Class399 method4206 = t.method4206();
    ...
    private <E extends Class399> void method14007(final T t, final float n, final Class7351 class7351, final Class7807 class7352, final E e) {
        if (!Class8571.method28955() || !Class9216.field39049) {
            class7351.method22567();
            final double n2 = Class9546.method35700(n * 0.5f, e.field2399, e.field2401) * 0.017453292f;
            final double n3 = Class9546.method35700(n * 0.5f, e.field2400, e.field2402) * 0.017453292f;
            ...
            final double n4 = Class9546.method35701(n, e.field2392, e.method1938()) - cos * 0.7 - sin * 0.5 * cos2;
            final double n5 = Class9546.method35701(n, e.field2393 + e.method1892() * 0.7, e.method1941() + e.method1892() * 0.7) - sin2 * 0.5 - 0.25;
            final double n6 = Class9546.method35701(n, e.field2394, e.method1945()) - sin * 0.7 + cos * 0.5 * cos2;
            final double n7 = Class9546.method35700(n, t.field2951, t.field2952) * 0.017453292f + 1.5707963267948966;
            final double n8 = Math.cos(n7) * t.method1930() * 0.4;
            final double n9 = Math.sin(n7) * t.method1930() * 0.4;
            final double n10 = Class9546.method35701(n, t.field2392, t.method1938()) + n8;
            final double method35701 = Class9546.method35701(n, t.field2393, t.method1941());
            final double n11 = Class9546.method35701(n, t.field2394, t.method1945()) + n9;
            ...
            final float n15 = Class9546.method35694(n12 * n12 + n14 * n14) * 0.025f / 2.0f;
            ...
            final int method35706 = t.field2391.method6992(Class237.field911, new Class354(t.method1747(n)));
            final int method35707 = t.field2391.method6992(Class237.field911, new Class354(e.method1747(n)));
    ...
    public static void method14008(final Class4150 class4150, final Class6789 class4151, final float n, final float n2, final float n3, final int n4, final int n5, final int n6, final int n7, final float n8, final float n9, final float n10, final float n11) {
        for (int i = 0; i < 24; ++i) {
            ...
            final int method1422 = Class392.method1422((int)Class9546.method35700(n12, (float)n4, (float)n5), (int)Class9546.method35700(n12, (float)n6, (float)n7));
