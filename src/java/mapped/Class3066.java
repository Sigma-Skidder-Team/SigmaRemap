...
public class Class3066 implements Class2982 {
   ...
   public void method11398(Class8563 var1) throws Exception {
      if (ViaVersion3.method27612().setMinimizeCooldown()) {
         if (var1.method30555(BruhMotha.field22544, 0) == var1.method30580().method22438(Class6057.class).method18753()) {
            int var4 = var1.method30559(BruhMotha.field22526);
            Map<String, Class9284> var5 = new HashMap<>(var4);

            for (int var6 = 0; var6 < var4; var6++) {
               String var7 = var1.method30559(BruhMotha.field22539);
               Double var8 = var1.method30559(BruhMotha.field22528);
               int var9 = var1.method30559(BruhMotha.field22544);
            ...
            var1.method30560(BruhMotha.field22526, var5.size());

            for (Entry var13 : var5.entrySet()) {
               var1.method30560(BruhMotha.field22539, (String)var13.getKey());
               var1.method30560(BruhMotha.field22528, (Double)((Class9284)var13.getValue()).method35008());
               var1.method30560(BruhMotha.field22544, ((List)((Class9284)var13.getValue()).method35009()).size());

               for (Class7753 var15 : (List<Class7753>)((Class9284)var13.getValue()).method35009()) {
                  var1.method30560(BruhMotha.field22541, (UUID)var15.method25698());
                  var1.method30560(BruhMotha.field22528, (Double)var15.method25699());
                  var1.method30560(BruhMotha.field22518, (Byte)var15.method25700());
               }
            }
         }
      }
