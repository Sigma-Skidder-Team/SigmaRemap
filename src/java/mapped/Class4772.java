...
public class Class4772 extends BruhMotha<Class8173> {
   public Class4772() {
   ...
   public Class8173 method14894(ByteBuf var1) throws Exception {
      ...
      if (var1.readableBytes() > 0) {
         byte[] var16 = BruhMotha.field22521.method14894(var1);
   ...
   public void method14895(ByteBuf var1, Class8173 var2) throws Exception {
      ...
      try {
         ...
         var5.readerIndex(0);
         BruhMotha.field22544.method14908(var1, var5.readableBytes() + (var2.method28439() ? 1024 : 0));
      ...
      BruhMotha.field22556.method14895(var1, var2.method28451().<Class72>toArray(new Class72[0]));
   }
