...
public class Class8558 extends Class8557 {
   ...
   public Class8558(Class8557 var1, Class1713 var2) {
   ...
   private static int[] method30533(int[] var0, Class1713 var1, Class1713 var2) {
      int[] var5 = Arrays.copyOf(var0, var0.length);

      for (int var6 = 0; var6 < 4; var6++) {
         Class7831 var7 = Class9337.field43334;
