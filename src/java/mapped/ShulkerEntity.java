...
public class ShulkerEntity extends Class1056 implements IMob {
   ...
   public ShulkerEntity(EntityType<? extends ShulkerEntity> var1, World var2) {
      super(var1, var2);
      this.field5594 = 5;
   }
         ...
         if (var12 > 0.0) {
            ...
            if (!var14.isEmpty()) {
               for (Entity var16 : var14) {
                  if (!(var16 instanceof ShulkerEntity) && !var16.noClip) {
                     var16.move(
   ...
   // $VF: synthetic method
   public static Random method4858(ShulkerEntity var0) {
      return var0.rand;
   }

   // $VF: synthetic method
   public static Random method4859(ShulkerEntity var0) {
      return var0.rand;
   }

   // $VF: synthetic method
   public static Random method4860(ShulkerEntity var0) {
      return var0.rand;
   }

   // $VF: synthetic method
   public static Random method4861(ShulkerEntity var0) {
      return var0.rand;
   }

   // $VF: synthetic method
   public static Random method4862(ShulkerEntity var0) {
      return var0.rand;
   }
}
