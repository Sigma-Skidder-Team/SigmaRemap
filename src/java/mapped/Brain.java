...
public class Brain<E extends LivingEntity> {
   ...
   public static <E extends LivingEntity> Codec<Brain<E>> method21401(
      ...
      return (Codec<Brain<E>>)var4.getValue();
   }
   ...
   public Schedule method21413() {
      return this.field30103;
   }

   public void method21414(Schedule var1) {
      this.field30103 = var1;
   }

   public void method21415(Set<Activity> var1) {
   ...
   public List<Class3676<? super E>> method21416() {
      ...
      for (Map<Activity, Set<Class3676<? super E>>> var5 : this.field30102.values()) {
   ...
   public Optional<Activity> method21418() {
      for (Activity var4 : this.field30107) {
         if (!this.field30106.contains(var4)) {
            return Optional.<Activity>of(var4);
         }
      }
   ...
   public void method21419(Activity var1) {
   ...
   private void method21420(Activity var1) {
   ...
   public void method21422(long var1, long var3) {
      if (var3 - this.field30109 > 20L) {
         ...
         Activity var7 = this.method21413().method28663((int)(var1 % 24000L));
   ...
   public void method21423(List<Activity> var1) {
      for (Activity var5 : var1) {
   ...
   public void method21424(Activity var1) {
      this.field30108 = var1;
   }

   public void method21425(Activity var1, int var2, ImmutableList<? extends Class3676<? super E>> var3) {
   ...
   public void method21427(Activity var1, ImmutableList<? extends Pair<Integer, ? extends Class3676<? super E>>> var2) {
   ...
   public boolean method21430(Activity var1) {
      return this.field30107.contains(var1);
   }

   public Brain<E> method21431() {
   ...
   public void method21435(ServerWorld var1, E var2) {
      long var5 = var2.world.getGameTime();
   ...
   private void method21436(ServerWorld var1, E var2) {
      long var5 = var1.getGameTime();

      for (Map<Activity, Set<Class3676<? super E>>> var8 : this.field30102.values()) {
         for (Entry<Activity, Set<Class3676<? super E>>> var10 : var8.entrySet()) {
            Activity var11 = var10.getKey();
   ...
   private boolean method21438(Activity var1) {
   ...
   // $VF: synthetic method
   public static Stream<Class9802<?>> method21446(Brain var0) {
