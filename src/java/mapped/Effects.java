...
public class Effects {
   public static final Effect SPEED = register(
      1,
      "speed",
      new Effect(EffectType.BENEFICIAL, 8171462).addAttributesModifier(Attributes.MOVEMENT_SPEED, "91AEAA56-376B-4498-935B-2F7F68070635", 0.2F, AttributeModifierOperation.MULTIPLY_TOTAL)
   );
   public static final Effect SLOWNESS = register(
      2,
      "slowness",
      new Effect(EffectType.HARMFUL, 5926017).addAttributesModifier(Attributes.MOVEMENT_SPEED, "7107DE5E-7CE8-4030-940E-514C1F160890", -0.15F, AttributeModifierOperation.MULTIPLY_TOTAL)
   );
   public static final Effect HASTE = register(
      3,
      "haste",
      new Effect(EffectType.BENEFICIAL, 14270531).addAttributesModifier(Attributes.ATTACK_SPEED, "AF8B6E3F-3328-4C0A-AA36-5BA2BB9DBEF3", 0.1F, AttributeModifierOperation.MULTIPLY_TOTAL)
   );
   public static final Effect MINING_FATIGUE = register(
      4,
      "mining_fatigue",
      new Effect(EffectType.HARMFUL, 4866583).addAttributesModifier(Attributes.ATTACK_SPEED, "55FCED67-E92A-486E-9800-B47F202C4386", -0.1F, AttributeModifierOperation.MULTIPLY_TOTAL)
   );
   public static final Effect STRENGTH = register(
      5,
      "strength",
      new Class7148(EffectType.BENEFICIAL, 9643043, 3.0).addAttributesModifier(Attributes.field42110, "648D7064-6A60-4F59-8ABE-C2C23A6DD7A9", 0.0, AttributeModifierOperation.ADDITION)
   );
   ...
   public static final Effect WEAKNESS = register(
      18,
      "weakness",
      new Class7148(EffectType.HARMFUL, 4738376, -4.0).addAttributesModifier(Attributes.field42110, "22653B89-116E-49DC-9B6B-9971489B5BE5", 0.0, AttributeModifierOperation.ADDITION)
   );
   ...
   public static final Effect HEALTH_BOOST = register(
      21,
      "health_boost",
      new Class7149(EffectType.BENEFICIAL, 16284963).addAttributesModifier(Attributes.field42105, "5D6F0BA2-1186-46AC-B896-C61C5CEE99CC", 4.0, AttributeModifierOperation.ADDITION)
   );
   ...
   public static final Effect LUCK = register(
      26,
      "luck",
      new Effect(EffectType.BENEFICIAL, 3381504).addAttributesModifier(Attributes.LUCK, "03C3C89D-7037-4B42-869F-B146BCB64D2E", 1.0, AttributeModifierOperation.ADDITION)
   );
   public static final Effect UNLUCK = register(
      27,
      "unluck",
      new Effect(EffectType.HARMFUL, 12624973).addAttributesModifier(Attributes.LUCK, "CC5AF142-2BD2-4215-B636-2605AED11727", -1.0, AttributeModifierOperation.ADDITION)
   );
   ...
   public static final Effect BAD_OMEN = register(31, "bad_omen", new Class7147(EffectType.NEUTRAL, 745784));
   public static final Effect HERO_OF_THE_VILLAGE = register(32, "hero_of_the_village", new Effect(EffectType.BENEFICIAL, 4521796));

   private static Effect register(int var0, String var1, Effect var2) {
      return Registry.<Effect, Effect>register(Registry.EFFECTS, var0, var1, var2);
   }
}
