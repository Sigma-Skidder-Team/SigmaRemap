...
public abstract class Class6255 {
   public abstract String method19220();

   public abstract String method19221();

   public String method19223() {
      return this.method19220();
   }

   public String method19224() {
   ...
   public String method19226(String var1) {
