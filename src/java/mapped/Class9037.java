...
public class Class9037 {
   ...
   private static int method33496(Class6619 var0, int var1) {
      ...
      BlockPos var5 = new BlockPos(
         var0.method20171().x,
         (double)var0.method20172().method7006(Heightmap.Type.field296, new BlockPos(var0.method20171())).getY(),
         var0.method20171().z
      );
   ...
   private static int method33497(Class6619 var0, Class4871 var1, int var2) {
      ...
      int var7 = var0.method20172().method7006(Heightmap.Type.field296, var6).getY();
