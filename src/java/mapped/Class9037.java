...
public class Class9037 {
   ...
   private static int method33490(CommandSource var0, String var1, int var2, int var3, int var4) {
      if (var2 <= 48 && var3 <= 48 && var4 <= 48) {
         ...
         BlockPos var9 = new BlockPos(var8.getX(), var0.method20172().getHeight(Heightmap.Type.WORLD_SURFACE, var8).getY(), var8.getZ() + 3);
   ...
   private static int method33496(CommandSource var0, int var1) {
      ...
      BlockPos var5 = new BlockPos(
         var0.method20171().x,
         (double)var0.method20172().getHeight(Heightmap.Type.WORLD_SURFACE, new BlockPos(var0.method20171())).getY(),
         var0.method20171().z
      );
   ...
   private static int method33497(CommandSource var0, Class4871 var1, int var2) {
      ...
      int var7 = var0.method20172().getHeight(Heightmap.Type.WORLD_SURFACE, var6).getY();
   ...
   private static void method33502(CommandSource var0, Collection<Class4871> var1, int var2, int var3) {
      BlockPos var6 = new BlockPos(var0.method20171());
      BlockPos var7 = new BlockPos(var6.getX(), var0.method20172().getHeight(Heightmap.Type.WORLD_SURFACE, var6).getY(), var6.getZ() + 3);
