...
public class Class7727 {
   ...
   private Class7727 method25549(String var1) throws Class2455 {
      if (var1 == null) {
         throw new Class2499("Null pointer");
      } else if (this.field33177 != 'o' && this.field33177 != 'a') {
         throw new Class2499("Value out of sequence.");
      } else {
         try {
   ...
   public Class7727 method25550() throws Class2455 {
      if (this.field33177 != 'i' && this.field33177 != 'o' && this.field33177 != 'a') {
         throw new Class2499("Misplaced array.");
      } else {
   ...
   private Class7727 method25551(char var1, char var2) throws Class2455 {
      if (this.field33177 != var1) {
         throw new Class2499(var1 == 'a' ? "Misplaced endArray." : "Misplaced endObject.");
      } else {
   ...
   public Class7727 method25552() throws Class2455 {
      return this.method25551('a', ']');
   }

   public Class7727 method25553() throws Class2455 {
      return this.method25551('k', '}');
   }

   public Class7727 method25554(String var1) throws Class2455 {
      if (var1 == null) {
         throw new Class2499("Null key.");
      } else if (this.field33177 == 'k') {
         try {
            this.field33178[this.field33179 - 1].method21807(var1, Boolean.TRUE);
            if (this.field33176) {
               this.field33180.write(44);
            }
         ...
         throw new Class2499("Misplaced key.");
      }
   }

   public Class7727 method25555() throws Class2455 {
      if (this.field33177 == 'i') {
         this.field33177 = 'o';
      }

      if (this.field33177 != 'o' && this.field33177 != 'a') {
         throw new Class2499("Misplaced object.");
      } else {
         this.method25549("{");
   ...
   private void method25556(char var1) throws Class2455 {
      if (this.field33179 > 0) {
         ...
         if (var4 == var1) {
            ...
            throw new Class2499("Nesting error.");
         }
      } else {
         throw new Class2499("Nesting error.");
      }
   ...
   private void method25557(JSONObject var1) throws Class2455 {
      if (this.field33179 < 200) {
         this.field33178[this.field33179] = var1;
         this.field33177 = (char)(var1 != null ? 107 : 97);
         this.field33179++;
      } else {
         throw new Class2499("Nesting too deep.");
      }
   }

   public Class7727 method25558(boolean var1) throws Class2455 {
      return this.method25549(!var1 ? "false" : "true");
   }

   public Class7727 method25559(double var1) throws Class2455 {
      return this.method25561(new Double(var1));
   }

   public Class7727 method25560(long var1) throws Class2455 {
      return this.method25549(Long.toString(var1));
   }

   public Class7727 method25561(Object var1) throws Class2455 {
