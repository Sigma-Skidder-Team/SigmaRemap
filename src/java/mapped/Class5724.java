...
public class Class5724 extends EntityRenderer<ItemEntity> {
   ...
   public void render(ItemEntity var1, float var2, float var3, MatrixStack var4, IRenderTypeBuffer var5, int var6) {
      var4.push();
      ...
      for (int var25 = 0; var25 < var13; var25++) {
         ...
         this.field25129.method781(var9, ItemCameraTransformsTransformType.GROUND, false, var4, var5, var6, OverlayTexture.NO_OVERLAY, var11);
         var4.pop();
         if (!var12) {
