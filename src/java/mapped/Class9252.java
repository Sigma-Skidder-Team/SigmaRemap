...
public class Class9252 {
   ...
   public static Iterator<Class8066> method34804(Class1656 var0, double var1, Entity var3, int var4, Class9242 var5) {
      ...
      if (!(var8 <= 0.0F) && !(var8 >= (float)((var4 - 1) * 16))) {
         ...
         float var11 = Class8981.field40936 * MathHelper.field45214;
         float var12 = var10 > MathHelper.field45212 && var10 < 3.0F * MathHelper.field45212 ? var10 + MathHelper.field45210 : var10;
         float var13 = -MathHelper.method37763(var12);
         float var14 = MathHelper.method37764(var12) * MathHelper.method37764(var11);
         float var15 = -MathHelper.method37764(var12) * MathHelper.method37763(var11);
         BlockPos var16 = new BlockPos(
            MathHelper.method37769(var3.getPosX()) >> 4, MathHelper.method37769(var3.getPosY()) >> 4, MathHelper.method37769(var3.getPosZ()) >> 4
         );
