...
public class Class5885<T extends Class399> extends Class5846<T>
{
    ...
    public void method17557(final T t, final float n, final float n2, final float n3, final float n4, final float n5) {
        ...
        for (int i = 0; i < 4; ++i) {
            this.field24157[i].field25181 = -2.0f + Class9546.method35639((i * 2 + n3) * 0.25f);
            this.field24157[i].field25180 = Class9546.method35639(n6) * 9.0f;
            this.field24157[i].field25182 = Class9546.method35638(n6) * 9.0f;
            ++n6;
        }
        float n7 = 0.7853982f + n3 * 3.1415927f * 0.03f;
        for (int j = 4; j < 8; ++j) {
            this.field24157[j].field25181 = 2.0f + Class9546.method35639((j * 2 + n3) * 0.25f);
            this.field24157[j].field25180 = Class9546.method35639(n7) * 7.0f;
            this.field24157[j].field25182 = Class9546.method35638(n7) * 7.0f;
            ++n7;
        }
        float n8 = 0.47123894f + n3 * 3.1415927f * -0.05f;
        for (int k = 8; k < 12; ++k) {
            this.field24157[k].field25181 = 11.0f + Class9546.method35639((k * 1.5f + n3) * 0.5f);
            this.field24157[k].field25180 = Class9546.method35639(n8) * 5.0f;
            this.field24157[k].field25182 = Class9546.method35638(n8) * 5.0f;
            ++n8;
        }
