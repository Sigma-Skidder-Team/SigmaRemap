...
public class Class6224
{
    ...
    public Class6224(final String field25085, final String field25086, final int field25087, final Class7776 field25088) {
    ...
    public Class6224(final String s, final String s2, final Class7776 class7776) {
        this(s, s2, 4000, class7776);
    }
    
    public Class6224(final String s, final String s2, final int n) {
        this(s, s2, n, Class7853.field32187);
    }
