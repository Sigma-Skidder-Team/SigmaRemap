...
public class ClientPlayerEntity extends AbstractClientPlayerEntity {
    ...
    public void livingTick() {
        ...
        if (this.isHandActive() && !this.isPassenger()) {
            EventSlowDown slowdownEvent = new EventSlowDown(0.2F);
            Client.getInstance().eventManager.call(slowdownEvent);
            if (!slowdownEvent.isCancelled()) {
                this.movementInput.moveStrafe = this.movementInput.moveStrafe * slowdownEvent.getSlowDown();
                this.movementInput.moveForward = this.movementInput.moveForward * slowdownEvent.getSlowDown();
