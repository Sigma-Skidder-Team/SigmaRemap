...
public class Class8920
{
    ...
    private static int method31447(final Class7492 class7492, final String input) throws CommandSyntaxException {
        ...
        if (method20592.method26223(input)) {
            ((Class8006<String, V>)method20592).method26208(input);
            class7492.method23257(new Class2259("commands.pardonip.success", new Object[] { input }), true);
            return 1;
        }
    ...
    static {
        field37504 = new SimpleCommandExceptionType((Message)new Class2259("commands.pardonip.invalid", new Object[0]));
        field37505 = new SimpleCommandExceptionType((Message)new Class2259("commands.pardonip.failed", new Object[0]));
    }
}
