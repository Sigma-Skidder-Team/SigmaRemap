...
public class Class5747 extends Class5651<Class1098, Class2861<Class1098>> {
   ...
   public void method17842(Class1098 var1, MatrixStack var2, float var3, float var4, float var5) {
      ...
      if (var8 > 0.0F) {
         ...
         var2.rotate(Vector3f.ZP.rotationDegrees(MathHelper.method37827(var8, 0.0F, 90.0F)));
         BlockPos var9 = var1.getPosition();

         for (PlayerEntity var11 : var1.world.<PlayerEntity>getEntitiesWithinAABB(PlayerEntity.class, new AxisAlignedBB(var9).method19663(2.0, 2.0, 2.0))) {
            if (var11.isSleeping()) {
