...
public class Class6206 {
   ...
   public static void method19111(CommandDispatcher<Class6619> var0) {
      var0.register(
         (LiteralArgumentBuilder)((LiteralArgumentBuilder)Class6099.method18839("function").requires(var0x -> var0x.method20129(2)))
            .then(
               Class6099.method18840("name", Class7566.method24766())
                  .suggests(field27688)
                  .executes(var0x -> method19112((Class6619)var0x.getSource(), Class7566.method24769(var0x, "name")))
            )
      );
   }

   private static int method19112(Class6619 var0, Collection<Class7744> var1) {
      int var4 = 0;
