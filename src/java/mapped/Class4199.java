...
public class Class4199 extends Class4197 {
   private static String[] field20502;

   public Class4199(int var1, Random var2, MutableBoundingBox var3, Direction var4) {
      super(Class7792.field33447, var1);
      this.method12939(var4);
      this.field20495 = this.method12985(var2);
      this.field20444 = var3;
   }

   public Class4199(TemplateManager var1, CompoundNBT var2) {
      super(Class7792.field33447, var2);
   }
   ...
   public static Class4199 method12992(List<Class4178> var0, Random var1, int var2, int var3, int var4, Direction var5, int var6) {
      MutableBoundingBox var9 = MutableBoundingBox.method38388(var2, var3, var4, -1, -1, 0, 5, 5, 5, var5);
      return method12989(var9) && Class4178.method12918(var0, var9) == null ? new Class4199(var6, var1, var9, var5) : null;
   }
