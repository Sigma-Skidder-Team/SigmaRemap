...
public class Class5957<T extends Class956> extends Class5942<T> {
   ...
   private static final List<Class4520> field25981 = IntStream.range(0, 16)
      .<Class4520>mapToObj(var0 -> Class4520.method14344(var0 + 1))
      .collect(ImmutableList.toImmutableList());

   public Class5957(Class8086 var1) {
      super(var1);
   }
   ...
   private void method18487(T var1, float var2, float var3, Class9367 var4, Class5422 var5) {
      ...
      this.method18488((T)var1, var4, var5, 0.0F, 1.0F, 0.0F, 0.0F, 0.0F, 0.0F, 1.0F, 1.0F, var8, var9, var10, Direction.field672);
   ...
   private void method18488(
      ...
      if (var1.method3870(var15)) {
         var3.method17040(var2, var4, var6, var8).method17033(var12, var13, var14, 1.0F).method17031();
         var3.method17040(var2, var5, var6, var9).method17033(var12, var13, var14, 1.0F).method17031();
         var3.method17040(var2, var5, var7, var10).method17033(var12, var13, var14, 1.0F).method17031();
         var3.method17040(var2, var4, var7, var11).method17033(var12, var13, var14, 1.0F).method17031();
      }
   }
