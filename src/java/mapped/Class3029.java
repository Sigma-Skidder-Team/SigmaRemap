...
public class Class3029 implements Class3008 {
   ...
   public void method11400(Class8563 var1) throws Exception {
      var1.method30560(BruhMotha.field22544, var1.method30580().<Class6043>method22438(Class6043.class).method18709());
      ...
      int var10 = var1.<Integer>method30561(BruhMotha.field22544);

      for (int var8 = 0; var8 < var10; var8++) {
         String var9 = var1.<String>method30559(BruhMotha.field22539);
         if (var9.startsWith("/") && var5 == 0) {
            var9 = var9.substring(1);
         }

         var1.method30560(BruhMotha.field22539, var9);
