...
public class Class4350 extends Class4278 {
   ...
   public void draw(float var1) {
      if (this.field20912 != null) {
         RenderUtil.drawRect((float)this.getX(), (float)this.getY(), (float)this.width, (float)this.height, -14144460);
         RenderUtil.method11464(
            (float)this.getX(), (float)this.getY(), (float)this.width, (float)(this.height - this.getY()), 114.0F, var1
         );
         byte var4 = 30;
         ...
         for (int var11 = 0; var11 < var7.length; var11++) {
            ...
            for (String var15 : var12) {
               RenderUtil.drawString(
                  var5,
                  (float)(this.getX() + var13 + var4),
                  (float)(this.getY() + var4 + var11 * var5.method23952()),
                  var15,
         ...
         RenderUtil.drawRect(
            (float)var4 + var10,
            (float)(this.getY() + var4 + var9 * var5.method23952()),
            (float)var4 + var10 + 1.0F,
            (float)(this.getY() + var4 + var5.method23941(this.field20912) + var9 * var5.method23952()),
