...
public class Class3836 extends Class3834
{
    ...
    public Class3836(final boolean field17445, final Class9288 class9288) {
        super(class9288);
        this.method11877(((Class7097<O, Class7096>)((Class7097<O, Class7096>)this.field17406.method32903()).method21773((Class7111<Comparable>)Class3836.field17415, Class179.field513)).method21773((Class7111<Comparable>)Class3836.field17438, false));
    ...
    public Class7702 method11808(final Class7096 class7096, final Class1855 class7097, final Class354 class7098, final Class7543 class7099) {
        ...
        switch (Class8558.field35936[class7096.method21772((Class7111<Class179>)Class3836.field17415).ordinal()]) {
            case 1: {
    ...
    public Class7096 method11846(final Class7074 class7074) {
        return ((Class7097<O, Class7096>)((Class7097<O, Class7096>)this.method11878()).method21773((Class7111<Comparable>)Class3836.field17415, class7074.method21642().method782())).method21773((Class7111<Comparable>)Class3836.field17438, false);
    }
    
    private void method11892(final Class1847 class1847, final Class354 class1848, final Class7096 class1849) {
        final Class179 class1850 = class1849.method21772((Class7111<Class179>)Class3836.field17415);
        ...
        if (method11893 && !class1849.method21772((Class7111<Boolean>)Class3836.field17438)) {
            if (new Class9236(class1847, class1848, class1850, true).method34052()) {
                class1847.method6763(class1848, this, 0, class1850.method779());
            }
        }
        else if (!method11893) {
            if (class1849.method21772((Class7111<Boolean>)Class3836.field17438)) {
                final Class354 method11894 = class1848.method1150(class1850, 2);
                ...
                class1847.method6763(class1848, this, n, class1850.method779());
            }
        }
    }
    
    private boolean method11893(final Class1847 class1847, final Class354 class1848, final Class179 class1849) {
        for (final Class179 class1850 : Class179.values()) {
            if (class1850 != class1849 && class1847.method6747(class1848.method1149(class1850), class1850)) {
                return true;
            }
        }
        if (!class1847.method6747(class1848, Class179.field511)) {
            final Class354 method1137 = class1848.method1137();
            for (final Class179 class1851 : Class179.values()) {
                if (class1851 != Class179.field511 && class1847.method6747(method1137.method1149(class1851), class1851)) {
                    return true;
                }
            }
            return false;
    ...
    public boolean method11857(final Class7096 class7096, final Class1847 class7097, final Class354 class7098, final int n, final int n2) {
        final Class179 class7099 = class7096.method21772((Class7111<Class179>)Class3836.field17415);
        if (!class7097.field10067) {
        ...
        if (n != 0) {
            if (n == 1 || n == 2) {
                ...
                class7097.method6729(class7098, Class3960.method12080(((Class7097<O, Class7096>)this.method11878()).method21773((Class7111<Comparable>)Class3836.field17415, Class179.method792(n2 & 0x7)), class7099, false, true));
                if (!this.field17445) {
                    class7097.method6690(class7098.method1149(class7099), false);
                }
                else {
                    final Class354 method11895 = class7098.method1134(class7099.method785() * 2, class7099.method786() * 2, class7099.method787() * 2);
                            ...
                            Label_0467: {
                                if (n == 1) {
                                    if (!method11896.method21706()) {
                                        if (method11894(method11896, class7097, method11895, class7099.method782(), false, class7099)) {
    ...
    public static boolean method11894(final Class7096 class7096, final Class1847 class7097, final Class354 class7098, final Class179 class7099, final boolean b, final Class179 class7100) {
        ...
        if (class7098.method1075() < 0 || (class7099 == Class179.field511 && class7098.method1075() == 0)) {
            return false;
        }
        if (class7098.method1075() <= class7097.method6986() - 1 && (class7099 != Class179.field512 || class7098.method1075() != class7097.method6986() - 1)) {
    ...
    private boolean method11895(final Class1847 class1847, final Class354 class1848, final Class179 class1849, final boolean b) {
        final Class354 method1149 = class1848.method1149(class1849);
        if (!b) {
        ...
        if (class1850.method34052()) {
            ...
            for (int k = method1150.size() - 1; k >= 0; --k) {
                final Class354 class1854 = method1150.get(k);
                final Class7096 method1154 = class1847.method6701(class1854);
                final Class354 method1155 = class1854.method1149(class1852);
            ...
            while (iterator.hasNext()) {
                class1847.method6688((Class354)iterator.next(), method1156, 82);
            }
            for (final Map.Entry<Class354, V> entry : hashMap.entrySet()) {
                final Class354 class1857 = entry.getKey();
            ...
            for (int l = method1152.size() - 1; l >= 0; --l) {
                ...
                final Class354 class1859 = method1152.get(l);
            ...
            for (int n2 = method1150.size() - 1; n2 >= 0; --n2) {
                class1847.method6696((Class354)method1150.get(n2), array[n++].method21696());
            }
            if (b) {
    ...
    public Class7096 method11790(final Class7096 class7096, final Class2052 class7097) {
        return ((Class7097<O, Class7096>)class7096).method21773((Class7111<Comparable>)Class3836.field17415, class7097.method8142(class7096.method21772((Class7111<Class179>)Class3836.field17415)));
    }
    
    @Override
    public Class7096 method11791(final Class7096 class7096, final Class2181 class7097) {
        return class7096.method21708(class7097.method8344(class7096.method21772((Class7111<Class179>)Class3836.field17415)));
    }
