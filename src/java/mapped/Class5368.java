...
public class Class5368 extends Module {
    ...
    public void method15966() {
        if (!field23386.field1339.field5036) {
            ...
            this.field23984 = false;
            field23386.getClientPlayNetHandler().sendPacket(new Class5605(var3, var5 + 0.2, var7, false));
            field23386.getClientPlayNetHandler().sendPacket(new Class5605(var3, var5 + 0.1, var7, false));
    ...
    public void method15965() {
        ...
        if (this.field23984) {
            ...
            for (int var4 = 0; var4 < var3; var4++) {
                field23386.getClientPlayNetHandler().sendPacket(this.field23983.get(var4));
            }
    ...
    public void method16898(Class4399 var1) {
        if (field23386.field1339 != null) {
            if (!this.field23984 && field23386.field1339.field5036) {
                if (!this.method15974("Instant")) {
                    Client.getInstance().getNotificationManager().post(new Notification("Hypixel disabler", "Wait 5s..."));
                } else {
                    Client.getInstance().getNotificationManager().post(new Notification("Hypixel disabler", "Move where you want"));
        ...
        if (field23386.field1339 != null) {
            ...
            if (this.field23985.method27121() > 10000L && this.field23984) {
                ...
                for (int var5 = 0; var5 < var4; var5++) {
                    field23386.getClientPlayNetHandler().sendPacket(this.field23983.get(var5));
                }
    ...
    private void method16900(Class4402 var1) {
        if (field23386.getClientPlayNetHandler() != null) {
            if (this.field23984) {
    ...
    public void method16901(Class4396 var1) {
        if (field23386.field1339 != null && this.field23984) {
                ...
                if (var1.method13898() instanceof Class5473) {
                    ...
                    if (!this.method15974("Instant")) {
                        ...
                        for (int var6 = 0; var6 < var5; var6++) {
                            field23386.getClientPlayNetHandler().sendPacket(this.field23983.get(var6));
                        }
