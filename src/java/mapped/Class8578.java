...
public class Class8578 {
   ...
   private static Class9574 field38571;
   private static Class7165 field38572;
   ...
   public static void method30657(MatrixStack var0, int var1) {
      if (field38571 != null && (field38571.field44697 || field38571.field44666)) {
         ...
         var9.method17063(1, Class9337.field43342);
         ...
         int var22 = var7 - 80;
         int var24 = var7 - 160;
         field38570.field1294.method38801(var0, "30", 2.0F, (float)(var24 + 1), -8947849);
         field38570.field1294.method38801(var0, "30", 1.0F, (float)var24, -3881788);
         field38570.field1294.method38801(var0, "60", 2.0F, (float)(var22 + 1), -8947849);
         field38570.field1294.method38801(var0, "60", 1.0F, (float)var22, -3881788);
         Class7414.method23830(5889);
   ...
   private static long method30658(int var0, long var1, int var3, int var4, int var5, float var6, Class5425 var7) {
      long var10 = var1 / 200000L;
      if (var10 >= 3L) {
         var7.method17025((double)((float)var0 + 0.5F), (double)(var6 - (float)var10 + 0.5F), 0.0).method17026(var3, var4, var5, 255).method17031();
         var7.method17025((double)((float)var0 + 0.5F), (double)(var6 + 0.5F), 0.0).method17026(var3, var4, var5, 255).method17031();
         return var10;
      } else {
         return 0L;
      }
   ...
   private static long method30659(int var0, int var1, long var2, int var4, int var5, int var6, float var7, Class5425 var8) {
      long var11 = var2 / 200000L;
      if (var11 >= 3L) {
         var8.method17025((double)((float)var0 + 0.5F), (double)(var7 - (float)var11 + 0.5F), 0.0).method17026(var4, var5, var6, 255).method17031();
         var8.method17025((double)((float)var1 + 0.5F), (double)(var7 - (float)var11 + 0.5F), 0.0).method17026(var4, var5, var6, 255).method17031();
         return var11;
      } else {
         return 0L;
      }
