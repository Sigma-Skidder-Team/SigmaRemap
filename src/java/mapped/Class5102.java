...
public class Class5102 implements Class5103 {
   ...
   public void method15584(Class5540 var1) {
      ...
      Class6639.field29187.submit(() -> {
         ...
         if (var7x != null) {
            if (this.field23200.method1528() == null || !this.field23200.method1528().method25582()) {
   ...
   private MinecraftSessionService method15586() {
      return this.field23200.method1548();
   }
   ...
   public void method15587(Class5598 var1) {
      ...
      this.field23203.method30690(Class1858.field9902);
      this.field23203.method30692(new ClientPlayNetHandler(this.field23200, this.field23201, this.field23203, this.field23204));
   }

   @Override
   public void method15588(ITextComponent var1) {
      if (this.field23201 != null && this.field23201 instanceof Class798) {
         this.field23200.displayGuiScreen(new Class801(this.field23201, Class7127.field30664, var1));
      } else {
         this.field23200.displayGuiScreen(new Class832(this.field23201, Class7127.field30664, var1));
      }
   }
   ...
   public void method15592(Class5496 var1) {
      ...
      this.field23203.method30693(new Class5571(var1.method17282(), (PacketBuffer)null));
   }
}
