...
public class Class9302 extends Class9301 {
   ...
   @Override
   public void method35101(Class8827 var1) throws IOException {
      this.field43177 = var1.method31866(100, "UTF-8");
      this.field43178 = var1.method31866(100, "UTF-8");
      this.field43179 = var1.method31863(8);
      this.field43180 = var1.method31863(8);
      int var4 = var1.method31861();
      this.field43181 = new long[var4];

      for (int var5 = 0; var5 < var4; var5++) {
         this.field43181[var5] = var1.method31863(4);
      }
   }
