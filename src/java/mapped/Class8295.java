   ...
   public static void method28988(CommandDispatcher<CommandSource> var0) {
      var0.register(
         (LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)Class6099.method18839("weather")
                  ...
                  .then(
                     ((LiteralArgumentBuilder)Class6099.method18839("clear").executes(var0x -> method28989((CommandSource)var0x.getSource(), 6000)))
                        .then(
               ...
               .then(
                  ((LiteralArgumentBuilder)Class6099.method18839("rain").executes(var0x -> method28990((CommandSource)var0x.getSource(), 6000)))
                     .then(
                        Class6099.method18840("duration", IntegerArgumentType.integer(0, 1000000))
            ...
            .then(
               ((LiteralArgumentBuilder)Class6099.method18839("thunder").executes(var0x -> method28991((CommandSource)var0x.getSource(), 6000)))
                  .then(
                     Class6099.method18840("duration", IntegerArgumentType.integer(0, 1000000))
