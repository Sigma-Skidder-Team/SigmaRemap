...
public interface Class1092 {
   ...
   static boolean method5091(Class880 var0, Class880 var1) {
      ...
      if (!var0.method3005() && (int)var4 > 0) {
         var5 = var4 / 2.0F + (float)var0.field5024.field9016.nextInt((int)var4);
      } else {
         var5 = var4;
      }
   ...
   static void method5092(Class880 var0, Class880 var1) {
      ...
      if (!(var8 <= 0.0)) {
         ...
         float var14 = (float)(var0.field5024.field9016.nextInt(21) - 10);
         double var15 = var8 * (double)(var0.field5024.field9016.nextFloat() * 0.5F + 0.2F);
         Vector3d var17 = new Vector3d(var10, 0.0, var12).method11333().method11344(var15).method11351(var14);
         double var18 = var8 * (double)var0.field5024.field9016.nextFloat() * 0.5;
