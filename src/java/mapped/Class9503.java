            ...
            if (byteBuf.readUnsignedByte() == 254) {
                ...
                switch (byteBuf.readableBytes()) {
                    ...
                    case 1: {
                        ...
                        Class9503.field40883.debug("Ping: (1.4-1.5.x) from {}:{}", (Object)inetSocketAddress.getAddress(), (Object)inetSocketAddress.getPort());
                    ...
                    default: {
                        ...
                        Class9503.field40883.debug("Ping: (1.6) from {}:{}", (Object)inetSocketAddress.getAddress(), (Object)inetSocketAddress.getPort());
