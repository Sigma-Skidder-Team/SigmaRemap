...
public abstract class Class6853<T> extends Class6852<T> {
   ...
   public Class6852 method20870(UUID var1) {
      return this.method20871(Class8042.method27614().method34431(var1));
   }
   ...
   public Class6852 method20874(UUID var1) {
      return this.method20875(Class8042.method27614().method34431(var1));
   }
   ...
   public Set<UUID> method20879() {
      return this.field29770.stream().<UUID>map(var0 -> Class8042.method27614().method34420(var0)).filter(Objects::nonNull).collect(Collectors.<UUID>toSet());
   }
