...
public class Class8245 implements GameVersion {
   ...
   private Class8245() {
      ...
      this.field35429 = Class9246.method34774();
      this.field35430 = 6;
   ...
   private Class8245(JsonObject var1) {
      this.field35425 = Class8963.method32763(var1, "id");
      this.field35426 = Class8963.method32763(var1, "name");
      this.field35432 = Class8963.method32763(var1, "release_target");
      this.field35427 = Class8963.method32768(var1, "stable");
      this.field35428 = Class8963.method32777(var1, "world_version");
      this.field35429 = Class8963.method32777(var1, "protocol_version");
      this.field35430 = Class8963.method32777(var1, "pack_version");
      this.field35431 = Date.from(ZonedDateTime.parse(Class8963.method32763(var1, "build_time")).toInstant());
   }
      ...
      try (InputStream var2 = Class8245.class.getResourceAsStream("/version.json")) {
         if (var2 != null) {
            ...
            try (InputStreamReader var5 = new InputStreamReader(var2)) {
               var37 = new Class8245(Class8963.method32801(var5));
            }
