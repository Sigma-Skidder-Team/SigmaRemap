...
public class Class2811 extends Class2803<Class1114> {
   ...
   public void method10998(Class1114 var1, float var2, float var3, float var4, float var5, float var6) {
      if (!var1.method5364()) {
         ...
         this.field17495.field31035 = (float) (Math.PI / 4) + Class9679.method37764(var4 * 0.1F) * 0.15F;
         this.field17495.field31036 = 0.0F;
         this.field17496.field31036 = Class9679.method37764(var4 * 1.3F) * (float) Math.PI * 0.25F;
