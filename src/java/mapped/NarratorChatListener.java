...
public class NarratorChatListener implements Class6687 {
   ...
   public void method20400(ChatType var1, ITextComponent var2, UUID var3) {
      NarratorStatus var6 = method20402();
      if (var6 != NarratorStatus.field11267
         && this.field29303.active()
         && (var6 == NarratorStatus.field11268 || var6 == NarratorStatus.field11269 && var1 == ChatType.CHAT || var6 == NarratorStatus.field11270 && var1 == ChatType.SYSTEM)) {
         Object var7;
   ...
   public void say(String var1) {
      NarratorStatus var4 = method20402();
      if (this.field29303.active() && var4 != NarratorStatus.field11267 && var4 != NarratorStatus.field11269 && !var1.isEmpty()) {
         this.field29303.clear();
         this.method20403(true, var1);
      }
   }

   private static NarratorStatus method20402() {
   ...
   public void method20404(NarratorStatus var1) {
      this.clear();
      ...
      } else if (var1 != NarratorStatus.field11267) {
   ...
   public void clear() {
      if (method20402() != NarratorStatus.field11267 && this.field29303.active()) {
         this.field29303.clear();
      }
   }
