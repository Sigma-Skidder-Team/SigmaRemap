...
public class Class5290 extends Module {
    ...
    public void isInDevelopment() {
        ...
        this.field23797 = mc.currentScreen instanceof Class859;
        field23798 = false;
    }
    ...
    public void method16615(TickEvent var1) {
        if (this.method15996()) {
            ...
            if (!this.getStringSettingValueByName("Mode").equals("OpenInv") || mc.currentScreen instanceof Class859) {
                ...
                if (!this.field23797 && !(mc.currentScreen instanceof Class859) && this.field23796.method27121() > 0L) {
            ...
            for (int var12 = 9; var12 < 45; var12++) {
                if (mc.player.field4904.method18131(var12).method18266()) {
                    ...
                    if (var9.method32107() instanceof Class3256
                            && this.field23799
                            && !(mc.player.field4902.method3618(36 + Class2106.field13735.method8773()).method32107() instanceof Class3256)) {
                        ...
                        if (Class2106.field13735 == var7
                            ...
                            if (!(mc.player.field4902.method3618(36 + var7.method8773()).method32107() instanceof Class3280)) {
                        ...
                        if (var10.method11805() == var7
                            ...
                            this.method16617(var1);
                            Class3257 var11 = mc.player.field4902.method3618(36 + var10.method11805().method8773()).method32107();
    ...
    private void method16617(boolean var1) {
        if (var1 && this.field23797 && !(mc.currentScreen instanceof Class859) && Class8005.method27349() <= Class5989.field26136.method18582()) {
