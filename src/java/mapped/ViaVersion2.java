...
public class ViaVersion2 {
   ...
   private static String method18598(boolean var0) {
      if (ViaVersion3.method27613().getVersion().equals("${project.version}")) {
         ...
         if (var3 == null) {
            ...
            Class2025 var4;
            try {
               var4 = new Class2025(ViaVersion3.method27613().getVersion());
   ...
   private static String method18599() {
      try {
         ...
         var3.addRequestProperty("User-Agent", "ViaVersion " + ViaVersion3.method27613().getVersion() + " " + ViaVersion3.method27613().getClientName());
