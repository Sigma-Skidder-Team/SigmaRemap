...
public class Class4724 implements Class4716 {
   public static final Codec<Class4724> field22385 = RecordCodecBuilder.create(
      var0 -> var0.group(
               Class97.field261.fieldOf("step").forGetter(var0x -> var0x.field22386), Codec.FLOAT.fieldOf("probability").forGetter(var0x -> var0x.field22387)
            )
            .apply(var0, Class4724::new)
   );
   public final Class97 field22386;
   public final float field22387;

   public Class4724(Class97 var1, float var2) {
