...
public class Class9259 extends DataFix {
   private static final Int2ObjectMap<String> field42567 = (Int2ObjectMap<String>)DataFixUtils.make(new Int2ObjectOpenHashMap(), var0 -> {
   ...
   public Class9259(Schema var1, boolean var2) {
      super(var1, var2);
   }
   ...
   public TypeRewriteRule makeRule() {
      return this.fixTypeEverywhereTyped(
         ...
         var0 -> var0.update(DSL.remainderFinder(), var0x -> var0x.getMapValues().<Dynamic<?>>map(var1 -> var0x.createMap(var1.entrySet().stream().map(var0xxx -> {
                     if (!(var0xxx.getKey()).asString("").startsWith("key_")) {
                        return Pair.of(var0xxx.getKey(), var0xxx.getValue());
                     } else {
                        int var3 = Integer.parseInt((var0xxx.getValue()).asString(""));
                        if (var3 >= 0) {
                           String var6 = field42567.getOrDefault(var3, "key.unknown");
                           return Pair.of(var0xxx.getKey(), var0xxx.getValue().createString(var6));
                        } else {
                           int var4 = var3 + 100;
                           String var5;
                           if (var4 != 0) {
                           ...
                           return Pair.of(var0xxx.getKey(), var0xxx.getValue().createString(var5));
                        }
                     }
