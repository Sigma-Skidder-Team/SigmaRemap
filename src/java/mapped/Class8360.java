...
public class Class8360 implements Class8356 {
   ...
   private final Class39 field35908;
   private final Predicate<Class30> field35909;

   public Class8360(Class39 var1) {
   ...
   public void method29292(Class30 var1, Supplier<Class30> var2, List<Class30> var3) {
      ...
      if (var1 instanceof Class41) {
         Class41 var7 = (Class41)var1;
         var7.stream().filter(this.field35909).forEach(var2x -> {
            var3.add(var2x);
            var6.setTrue();
         });
         if (var6.isFalse()) {
            Class39 var8 = this.field35908.method79();
            var7.add(var8);
            var3.add(var8);
         }
      }
