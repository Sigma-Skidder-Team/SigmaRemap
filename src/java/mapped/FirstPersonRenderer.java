...
public class FirstPersonRenderer {
   private static final RenderType field45076 = RenderType
         .method14339(new ResourceLocation("textures/map/map_background.png"));
   private static final RenderType field45077 = RenderType
         .method14339(new ResourceLocation("textures/map/map_background_checkerboard.png"));
   ...
   private void method37586(MatrixStack var1, Class7733 var2, int var3, float var4, float var5, HandSide var6) {
      ...
      var1.translate((double) (var10 * (var12 + 0.64000005F)), (double) (var13 + -0.6F + var4 * -0.6F),
            (double) (var14 + -0.71999997F));
   ...
   public void method37590(float var1, MatrixStack var2, Class7735 var3, ClientPlayerEntity var4, int var5) {
      ...
      if (var11) {
         ...
         if (!Reflector.field42894.exists()
               || !Reflector.callBoolean(Reflector.field42894, Hand.MAIN_HAND, var2, var3, var5, var1, var10, var21,
                     var16, this.field45079)) {
      ...
      if (var12) {
         ...
         if (!Reflector.field42894.exists()
               || !Reflector.callBoolean(Reflector.field42894, Hand.OFF_HAND, var2, var3, var5, var1, var10, var22,
                     var23, this.field45080)) {
   ...
   private void method37591(
      ...
      if (!Config.isShaders() || !Shaders.method33153(var4)) {
         ...
         if (var6.isEmpty()) {
            ...
            this.renderItemSide(var1, var6, flag2 ? ItemCameraTransformsTransformType.FIRST_PERSON_RIGHT_HAND
                  : ItemCameraTransformsTransformType.FIRST_PERSON_LEFT_HAND, !flag2, matrixStackIn, var9, var10);
         } else {
            boolean flag2 = handside == HandSide.RIGHT;
            EventHandAnimation eventHandAnimation = new EventHandAnimation(true, swingProgress, equippedProgress,
                  handside, var6, matrixStackIn);
            ...
            if (var1.isHandActive() && var1.getItemInUseCount() > 0 && var1.getActiveHand() == var4) {
               ...
               switch (Class6063.field26304[var6.getUseAction().ordinal()]) {
                  ...
                  case 5:
                     ...
                     matrixStackIn.rotate(Vector3f.ZP.rotationDegrees((float) i * -9.785F));
                     float f8 = (float) var6.getUseDuration()
                           - ((float) this.mc.player.getItemInUseCount() - var2 + 1.0F);
                     float f11 = f8 / 20.0F;
                  ...
                  case 6:
                     ...
                     matrixStackIn.rotate(Vector3f.YP.rotationDegrees((float) i * 35.3F));
                     matrixStackIn.rotate(Vector3f.ZP.rotationDegrees((float) i * -9.785F));
                     float f13 = (float) var6.getUseDuration()
                           - ((float) this.mc.player.getItemInUseCount() - var2 + 1.0F);
                     float f16 = f13 / 10.0F;
                     if (f16 > 1.0F) {
                        f16 = 1.0F;
               ...
               Client.getInstance().eventManager.call(eventHandAnimation);
            ...
            if (eventHandAnimation.isBlocking()) {
               if (var6.getItem() instanceof ShieldItem
                  ...
                  return;
               this.renderItemSide(var1, var6,
                     flag2 ? ItemCameraTransformsTransformType.FIRST_PERSON_RIGHT_HAND
                           : ItemCameraTransformsTransformType.FIRST_PERSON_LEFT_HAND,
                     !flag2, matrixStackIn, var9, var10);
            }

            eventHandAnimation = new EventHandAnimation(false, swingProgress, equippedProgress, handside, var6,
                  matrixStackIn);
            Client.getInstance().eventManager.call(eventHandAnimation);
         }
   ...
   public void method37592() {
      ...
      if (!var3.isRowingBoat()) {
         ...
         if (Reflector.field42896.exists()) {
            boolean var7 = Reflector.callBoolean(Reflector.field42896, this.field45079, var4,
                  var3.inventory.currentItem);
         ...
         this.field45081 = this.field45081
               + MathHelper.clamp((this.field45079 != var4 ? 0.0F : var6 * var6 * var6) - this.field45081, -0.4F, 0.4F);
         this.field45083 = this.field45083
               + MathHelper.clamp((float) (this.field45080 != var5 ? 0 : 1) - this.field45083, -0.4F, 0.4F);
      } else {
