...
public abstract class AbstractArrowEntity extends Class882 {
   ...
   public void method2724(CompoundNBT var1) {
      ...
      var1.method109("SoundEvent", Registry.field16069.getKey(this.field5107).toString());
   ...
   public void method3459(Entity var1) {
      ...
      if (var1 instanceof PlayerEntity) {
         this.field5102 = !((PlayerEntity)var1).abilities.isCreativeMode ? Class2192.field14332 : Class2192.field14333;
      }
   }
   ...
   public void method3279(PlayerEntity var1) {
      if (!this.world.isRemote && (this.field5100 || this.method3493()) && this.field5103 <= 0) {
         ...
         if (this.field5102 == Class2192.field14332 && !var1.inventory.method4045(this.method3480())) {
            var4 = false;
         }
