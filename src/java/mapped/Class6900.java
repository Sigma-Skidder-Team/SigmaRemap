   ...
   public List<Class9359> method21065(Class1679 var1, Random var2, int var3, BlockPos var4, Set<BlockPos> var5, Class9764 var6, Class4733 var7) {
      ...
      for (int var11 = var3 - 2 - var2.nextInt(4); var11 > var3 / 2; var11 -= 2 + var2.nextInt(4)) {
         ...
         for (int var15 = 0; var15 < 5; var15++) {
            var13 = (int)(1.5F + Class9679.method37764(var12) * (float)var15);
            var14 = (int)(1.5F + Class9679.method37763(var12) * (float)var15);
            BlockPos var16 = var4.method8336(var13, var11 - 3 + var15 / 2, var14);
            method21070(var1, var2, var16, var5, var6, var7);
         }

         var10.add(new Class9359(var4.method8336(var13, var11, var14), -2, false));
      }
