...
public abstract class Class3452 extends Class3444 implements Class3196 {
   ...
   public Class3452(Properties var1, Direction var2, VoxelShape var3, boolean var4, double var5) {
      ...
      this.method11578(this.field18612.method35393().with(field19267, Integer.valueOf(0)));
   }

   @Override
   public BlockState method12122(Class1660 var1) {
      return this.method11579().with(field19267, Integer.valueOf(var1.method6814().nextInt(25)));
   }
