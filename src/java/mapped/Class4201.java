...
public class Class4201 extends Class4194 {
   ...
   public Class4201(int var1, Random var2, MutableBoundingBox var3, Direction var4) {
   ...
   public boolean method12896(ISeedReader var1, StructureManager var2, ChunkGenerator var3, Random var4, MutableBoundingBox var5, ChunkPos var6, BlockPos var7) {
      ...
      BlockState var10 = Blocks.WALL_TORCH.getDefaultState().with(Class3382.field18985, Direction.EAST);
      BlockState var11 = Blocks.WALL_TORCH.getDefaultState().with(Class3382.field18985, Direction.WEST);
