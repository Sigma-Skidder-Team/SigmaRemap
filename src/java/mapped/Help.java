...
public class Help extends Command {
   ...
   public void run(String var1, Class8623[] var2, Class6669 var3) throws CommandException {
      List var6 = Client.getInstance().getCommandManager().method30232();
      ...
      if (var2.length == 1 && var2[0].method30895() == Class2193.field14335) {
         ...
         if (var12 == null) {
            ...
            var3.method20327("§f" + var12.method18324() + "§8" + " > " + "§7" + var12.method18325());
            if (var12.method18326().length() <= 0) {
               var3.method20327("   [no options]");
            } else {
               var3.method20327("   " + var12.method18326());
            }
         }
      } else if (var2.length <= 1) {
         if (var8 + 1 <= var7 && var8 >= 0) {
            var3.method20327("§fHelp:§7 Page " + (var8 + 1) + "/" + var7);
            var3.method20327("");
            ...
            for (int var9 = 0; var9 < 7; var9++) {
               ...
               if (var6.size() > var10) {
                  ...
                  var3.method20327("§f" + var11.method18324() + "§8" + " > " + "§7" + var11.method18325());
                  if (var11.method18326().length() <= 0) {
                     var3.method20327("   [no options]");
                  } else {
                     var3.method20327("   " + var11.method18326());
                  }
               }
            }
         } else {
