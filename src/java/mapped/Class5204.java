...
public class Class5204 extends Module {
    ...
    public void method15966() {
        this.field23523 = field23386.field1339.field4902.field5443;
        this.field23520 = field23386.field1339.field5031;
        this.field23521 = field23386.field1339.field5032;
        this.field23522 = (int) field23386.field1339.getPosY();
        this.field23525 = -1;
    ...
    public void method15965() {
        if (this.field23523 != -1 && this.method16004().method15978("ItemSpoof").equals("Switch")) {
            field23386.field1339.field4902.field5443 = this.field23523;
        }
    ...
    public void method16204(Class4417 var1) {
        if (this.method15996()) {
            if (field23386.field1339.field5036 && Client.getInstance().getModuleManager().method14662(Class5363.class).method15996()) {
    ...
    public void method16205(Class4435 var1) {
        if (this.method15996()) {
            ...
            if (!this.method15974("Haphe (AACAP)")) {
                field23386.field1299.field44638.field13071 = false;
                field23386.field1339.method3098(false);
            }

            ((Class5328) this.method16004()).method16741(var1);
            if (this.method15974("Haphe (AACAP)")) {
                if (!field23386.field1339.field5036 || field23386.field1339.field4984 == 0.0F && field23386.field1339.field4982 == 0.0F) {
                ...
                if (field23386.field1339.field4984 == 0.0F && field23386.field1339.field4982 == 0.0F || field23386.field1339.field5037) {
                    this.field23525 = 0;
                }
    ...
    private void method16206(Class4423 var1) {
        if (this.method15996() && field23386.field1338 != null && field23386.field1339 != null) {
            if (this.method15974("Haphe (AACAP)") && Class9567.method37087() && !field23386.field1339.method3337()) {
    ...
    private boolean method16207() {
        Class8711 var3 = (Class8711) Class9217.method34569(field23386.field1339.field6122, field23386.field1339.field6123, Class9217.method34560(), 0.0F);
        boolean var4 = false;
        if (var3 != null && var3.method31417() == Class2100.field13690) {
            if (this.method16004().method15978("ItemSpoof").equals("None")) {
                Class5328 var10000 = (Class5328) this.method16004();
                if (!Class5328.method16733(field23386.field1339.method3094(Class79.field182).method32107())) {
                    return false;
                }
            }

            if (this.method15974("Haphe (AACAP)") && !field23386.field1339.field4981 && !field23386.field1339.field5036) {
            ...
            if (var3.method31424() == Direction.field673
                    && (double) (var3.method31423().getY() + 2) > field23386.field1339.getPosY()
                    && Class9217.method34578(var3.method31423())) {
                return false;
            }

            if ((double) var3.method31423().getY() == field23386.field1339.getPosY()) {
                return false;
            }

            ((Class5328) this.method16004()).method16736();
            int var5 = field23386.field1339.field4902.field5443;
            if (!this.method16004().method15978("ItemSpoof").equals("None")) {
                ((Class5328) this.method16004()).method16734();
            }

            Class2274 var6 = field23386.field1337.method23139(field23386.field1339, field23386.field1338, Class79.field182, var3);
            if (this.method16004().method15978("ItemSpoof").equals("Spoof") || this.method16004().method15978("ItemSpoof").equals("LiteSpoof")) {
                field23386.field1339.field4902.field5443 = var5;
            }
    ...
    public List<Class9238> method16208(Class3209 var1, BlockPos var2) {
        return Class9291.method35030(var1, var2, (int) field23386.field1337.method23135());
    }
    ...
    private void method16210(Class4399 var1) {
        if (this.method15996()) {
            if (!var1.method13921()) {
                if (Class9567.method37087() && field23386.field1339.field5036 && this.method15974("Haphe (AACAP)") && !field23386.field1339.field4981) {
                    field23386.field1339.method2914();
                }
                ...
                double var4 = field23386.field1339.getPosY();
                if (!field23386.field1339.field4981 && this.method15974("Haphe (AACAP)")) {
                    var4 = this.field23522;
                }

                BlockPos var6 = new BlockPos(field23386.field1339.getPosX(), (double) Math.round(var4 - 1.0), field23386.field1339.getPosZ());
                List var7 = this.method16208(Class8487.field36388, var6);
                if (!var7.isEmpty()) {
