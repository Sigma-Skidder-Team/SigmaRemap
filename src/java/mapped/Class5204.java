...
public class Class5204 extends Module {
    ...
    public void isInDevelopment() {
        this.field23523 = mc.player.field4902.field5443;
    ...
    public void method15965() {
        if (this.field23523 != -1 && this.method16004().getStringSettingValueByName("ItemSpoof").equals("Switch")) {
            mc.player.field4902.field5443 = this.field23523;
        }
    ...
    private boolean method16207() {
        Class8711 var3 = (Class8711) Class9217.method34569(mc.player.field6122, mc.player.field6123, Class9217.method34560(), 0.0F);
        boolean var4 = false;
        if (var3 != null && var3.method31417() == Class2100.field13690) {
            if (this.method16004().getStringSettingValueByName("ItemSpoof").equals("None")) {
                ...
                if (!BlockFly.method16733(mc.player.getHeldItem(Hand.field182).method32107())) {
                    return false;
                }
            }
            ...
            if (var3.method31424() == Direction.field673
                    && (double) (var3.method31423().getY() + 2) > mc.player.getPosY()
                    && Class9217.method34578(var3.method31423())) {
                return false;
            }

            if ((double) var3.method31423().getY() == mc.player.getPosY()) {
                return false;
            }

            ((BlockFly) this.method16004()).method16736();
            int var5 = mc.player.field4902.field5443;
            if (!this.method16004().getStringSettingValueByName("ItemSpoof").equals("None")) {
                ((BlockFly) this.method16004()).method16734();
            }

            ActionResultType var6 = mc.field1337.method23139(mc.player, mc.world, Hand.field182, var3);
            if (this.method16004().getStringSettingValueByName("ItemSpoof").equals("Spoof") || this.method16004().getStringSettingValueByName("ItemSpoof").equals("LiteSpoof")) {
                mc.player.field4902.field5443 = var5;
            }
