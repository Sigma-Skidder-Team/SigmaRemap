   ...
   public static void method32029(CommandDispatcher<CommandSource> var0) {
      var0.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)Class6099.method18839("help").executes(var1 -> {
         ...
         for (String var6 : var4.values()) {
            ((CommandSource)var1.getSource()).method20179(new StringTextComponent("/" + var6), false);
         }
         ...
         if (var4.getContext().getNodes().isEmpty()) {
            ...
            for (String var7 : var5.values()) {
               ((CommandSource)var1.getSource()).method20179(new StringTextComponent("/" + var4.getReader().getString() + " " + var7), false);
            }
