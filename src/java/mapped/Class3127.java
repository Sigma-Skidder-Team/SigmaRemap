   ...
   public void method11398(Class8563 var1) throws Exception {
      ...
      if (var4 != 1010) {
         if (var4 == 2001) {
            int var6 = var5 & 4095;
            int var7 = var5 >> 12;
            var1.method30558(BruhMotha.field22526, 1, Class7795.method25886(var6 << 4 | var7));
         }
      } else {
         var1.method30558(BruhMotha.field22526, 1, this.field18337.field20212.method19376().method18533().get(var5 << 4));
      }
   }
}
