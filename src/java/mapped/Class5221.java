...
public class Class5221 extends Module {
    ...
    public void method16256(Class4428 var1) {
        if (this.method15996()) {
            Vector3d var4 = new Vector3d(field23386.field1339.getPosX(), 0.0, field23386.field1339.getPosZ());
            if (field23386.field1339.field5036 && this.field23558 != null) {
                double var5 = var4.method11341(this.field23558) / (double) this.field23557;
                var5 *= field23386.field1284.field40360;
                boolean var7 = Client.getInstance().method19939().method31329() > 1 && field23386.field1339.field4999 == 0;
            ...
            this.field23557 = !field23386.field1339.field5036 ? this.field23557++ : 1;
