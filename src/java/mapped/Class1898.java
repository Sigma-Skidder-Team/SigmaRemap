...
public class Class1898 extends Class1897<Class7500>
{
    ...
    private static final Class179[] field10314;
    ...
    public int method7351(long n) {
        ...
        if (value != Class7500.method23392(class7500) && method1100 < value) {
            ...
            if (class7501 == null) {
                n = Class354.method1131(n);
                while (class7501 == null) {
                    n2 = Class353.method1093(n2, Class179.field512);
                    if (++method1100 >= value) {
                        return 15;
                    }
                    n = Class354.method1125(n, 0, 16, 0);
                    class7501 = this.method7349(class7500, n2);
                }
            }
            return class7501.method22322(Class353.method1096(Class354.method1126(n)), Class353.method1096(Class354.method1127(n)), Class353.method1096(Class354.method1128(n)));
        }
        return 15;
    }
    ...
    public void method7359(final long n) {
        ...
        if (Class7500.method23391((Class7500)this.field10306).get(method1112) == method1113 + 1) {
            long method1114;
            for (method1114 = n; !this.method7347(method1114) && this.method7370(method1113); --method1113, method1114 = Class353.method1093(method1114, Class179.field511)) {}
    ...
    public Class7281 method7354(final long n) {
        ...
        long n2 = Class353.method1093(n, Class179.field512);
                ...
                for (final long longValue : this.field10316) {
                    ...
                    if (method7302 != 2 && !this.field10317.contains(longValue) && this.field10315.add(longValue)) {
                        if (method7302 == 1) {
                            ...
                            for (final Class179 class1891 : Class1898.field10314) {
                                    ...
                                    for (int j = 0; j < 16; ++j) {
                                        for (int k = 0; k < 16; ++k) {
                                            ...
                                            switch (Class7043.field27418[class1891.ordinal()]) {
                                                case 1: {
                                                    n = Class354.method1130(method7303 + j, method7304 + k, method7305);
                                                    n2 = Class354.method1130(method7303 + j, method7304 + k, method7305 - 1);
                                                    break;
                                                }
                                                case 2: {
                                                    n = Class354.method1130(method7303 + j, method7304 + k, method7305 + 16 - 1);
                                                    n2 = Class354.method1130(method7303 + j, method7304 + k, method7305 + 16);
                                                    break;
                                                }
                                                case 3: {
                                                    n = Class354.method1130(method7303, method7304 + j, method7305 + k);
                                                    n2 = Class354.method1130(method7303 - 1, method7304 + j, method7305 + k);
                                                    break;
                                                }
                                                default: {
                                                    n = Class354.method1130(method7303 + 16 - 1, method7304 + j, method7305 + k);
                                                    n2 = Class354.method1130(method7303 + 16, method7304 + j, method7305 + k);
                                                    break;
                                                }
                                            }
                            ...
                            for (int l = 0; l < 16; ++l) {
                                for (int n3 = 0; n3 < 16; ++n3) {
                                    final long method7307 = Class354.method1130(Class353.method1098(Class353.method1099(longValue)) + l, Class353.method1098(Class353.method1100(longValue)), Class353.method1098(Class353.method1101(longValue)) + n3);
                                    final long method7308 = Class354.method1130(Class353.method1098(Class353.method1099(longValue)) + l, Class353.method1098(Class353.method1100(longValue)) - 1, Class353.method1098(Class353.method1101(longValue)) + n3);
                            ...
                            for (int n4 = 0; n4 < 16; ++n4) {
                                for (int n5 = 0; n5 < 16; ++n5) {
                                    class1890.method7320(Long.MAX_VALUE, Class354.method1130(Class353.method1098(Class353.method1099(longValue)) + n4, Class353.method1098(Class353.method1100(longValue)) + 16 - 1, Class353.method1098(Class353.method1101(longValue)) + n5), 0, true);
                                }
                            }
                        }
                    }
                    ...
                    if (this.field10315.remove(longValue2) && this.method7347(longValue2)) {
                        for (int n6 = 0; n6 < 16; ++n6) {
                            for (int n7 = 0; n7 < 16; ++n7) {
                                class1890.method7320(Long.MAX_VALUE, Class354.method1130(Class353.method1098(Class353.method1099(longValue2)) + n6, Class353.method1098(Class353.method1100(longValue2)) + 16 - 1, Class353.method1098(Class353.method1101(longValue2)) + n7), 15, false);
                            }
                        }
                    }
                }
    ...
    static {
        field10314 = new Class179[] { Class179.field513, Class179.field514, Class179.field515, Class179.field516 };
    }
}
