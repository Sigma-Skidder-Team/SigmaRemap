...
public class Class6828 extends Class6829 {
   ...
   public void method20810() {
      if (this.field29714 == Class2335.field15967 && !this.field29705.method4230().method21664()) {
         ...
         this.field29705.renderYawOffset = this.field29705.rotationYaw;
         float var13 = (float)(this.field29711 * this.field29705.getAttributeValue(Attributes.MOVEMENT_SPEED));
         float var14 = MathHelper.lerp(0.125F, this.field29705.getAIMoveSpeed(), var13);
         this.field29705.setAIMoveSpeed(var14);
         ...
         this.field29705
            .setMotion(this.field29705.getMotion().add(var15 * var17, var21 * (var19 + var17) * 0.25 + (double)var14 * var8 * 0.1, var15 * var19));
         Class8092 var23 = this.field29705.method4227();
         double var24 = this.field29705.getPosX() + var6 * 2.0;
         double var26 = this.field29705.getPosYEye() + var8 / var4;
