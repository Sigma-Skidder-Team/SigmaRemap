...
public class Class4566 extends Class4535<Class5122>
{
    ...
    public boolean method13535(final Class1851 class1851, final Class6346<? extends Class7065> class1852, final Random random, final Class354 class1853, final Class5122 class1854) {
        if (class1853.method1075() > class1851.method6743() - 1) {
            return false;
        }
        ...
        for (final Class179 class1855 : Class179.values()) {
            if (class1855 != Class179.field511 && class1851.method6701(class1853.method1149(class1855)).method21696() == Class7521.field29548) {
                n = 1;
                break;
            }
        }
        if (n != 0) {
            ...
            for (int j = 0; j < 200; ++j) {
                ...
                if (n3 >= 1) {
                    final Class354 method1134 = class1853.method1134(random.nextInt(n3) - random.nextInt(n3), n2, random.nextInt(n3) - random.nextInt(n3));
