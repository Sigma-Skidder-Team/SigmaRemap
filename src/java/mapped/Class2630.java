...
public class Class2630 extends Class2628 {
      ...
      if (!this.field16941.isInWater() && this.method10838()) {
         if (TurtleEntity.method5059(this.field16941) >= 1) {
            if (TurtleEntity.method5059(this.field16941) > 200) {
               ...
               var4.setBlockState(
                  this.field16933.up(),
                  Blocks.TURTLE_EGG.getDefaultState().with(TurtleEggBlock.field19244, Integer.valueOf(TurtleEntity.method5061(this.field16941).nextInt(4) + 1)),
                  3
               );
   ...
   public boolean method10840(IWorldReader var1, BlockPos var2) {
      return var1.method7007(var2.up()) ? TurtleEggBlock.method12115(var1, var2) : false;
   }
}
