...
public class Class4376 extends PNGIconButton implements Class4238 {
      ...
      public void draw(float var1) {
            ...
            int var9 = (int) ((float) (this.getYA() - (var7 - this.getHeightA()) / 2)
                        - (float) (this.getHeightA() / 2) * (var4 - 1.0F));
            ...
            RenderUtil.drawImage(
                        ...
                        MultiUtilities.applyAlpha(
                                    MultiUtilities.method17690(this.textColor.method19405(),
                                                this.textColor.method19403(), 1.0F - var5),
                                    var1));
