...
public class Class5281 extends Module {
    ...
    public static float[] method16562(Entity var0) {
        double var3 = var0.getPosX() - field23386.field1339.getPosX();
        double var5 = var0.getPosZ() - field23386.field1339.getPosZ();
        double var7 = field23386.field1339.getPosY() + (double) field23386.field1339.method3393() - (var0.getPosY() + (double) var0.method3393());
    ...
    public static float method16563(float var0, double var1, double var3) {
        double var7 = var1 - field23386.field1339.getPosX();
        double var9 = var3 - field23386.field1339.getPosZ();
        double var11 = 0.0;
    ...
    public static float method16565(float var0, Entity var1, double var2) {
        ...
        double var8 = var1.getPosZ() - field23386.field1339.getPosZ();
        double var10 = var2 - 2.2 + (double) var1.method3393() - field23386.field1339.getPosY();
    ...
    public void method15966() {
        ...
        this.field23745 = Class9679.method37792(field23386.field1339.field5031);
        this.field23745 = 39.0F;
        this.field23746 = field23386.field1339.field5032;
    ...
    public void method16556(Class4429 var1) {
        if (!this.method15996() || field23386.field1355 != null) {
        }
    }
    ...
    public void method16558(Class4402 var1) {
        ...
        if (this.method15996() && field23386.field1339 != null) {
            if (!(var4 instanceof Class5505)) {
                ...
                Entity var6 = var18.method17315(field23386.field1338);
                if (var6 != null) {
                            ...
                            if (!(var4 instanceof Class5615)) {
                                if (!(var4 instanceof Class5581)) {
                                    if (!(var4 instanceof Class5590)) {
                                        ...
                                        if (var8.method17565() != field23386.field1339.method3205()) {
                                        }
                                    }
                                } else {
                ...
                if (!Client.getInstance().getFriendManager().method26997(var7)) {
                    if (var7 instanceof Class880) {
                        if (((Class880) var7).method3042() != 0.0F) {
                            if (!(field23386.field1339.method3275(var7) > var1)) {
                                if (field23386.field1339.method3026((Class880) var7)) {
                                    if (!(var7 instanceof Class1005)) {
                                        if (var7 instanceof PlayerEntity && Client.getInstance().getCombatManager().method29346(var7)) {
                                            var6.remove();
                                        } else if (field23386.field1339.method3421() != null && field23386.field1339.method3421().equals(var7)) {
                                            var6.remove();
                                        } else if (!var7.method3362()) {
                                            if (var5 == null || field23386.field1339.method3275(var7) < field23386.field1339.method3275(var5)) {
                                                var5 = var7;
                                            }
                                        } else {
                                            var6.remove();
