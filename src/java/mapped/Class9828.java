...
public class Class9828 {
   private final Ingredient field45909;
   private final Ingredient field45910;
   private final Item field45911;
   private final Class7999 field45912 = Class7999.method27304();
   private final Class6504<?> field45913;

   public Class9828(Class6504<?> var1, Ingredient var2, Ingredient var3, Item var4) {
   ...
   public static Class9828 method38783(Ingredient var0, Ingredient var1, Item var2) {
   ...
   public void method38786(Consumer<Class4664> var1, ResourceLocation var2) {
      ...
      var1.accept(
         new Class4667(
            ...
            this.field45911,
            this.field45912,
            new ResourceLocation(var2.getNamespace(), "recipes/" + this.field45911.getGroup().getPath() + "/" + var2.getPath())
         )
      );
   }
