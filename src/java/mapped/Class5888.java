...
public class Class5888 implements Class5871<Class5888> {
   ...
   private final List<Class127> field25695 = Lists.newArrayList();
   ...
   public Class7318 method18322() {
      return new Class7318(this.field25696, this.field25694.toArray(new Class8894[0]), this.field25695.toArray(new Class127[0]));
   }
}
