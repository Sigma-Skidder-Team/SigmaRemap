...
public class Class6064 extends Class6065 {
   ...
   public void method18799(MatrixStack var1, int var2, int var3, boolean var4) {
      RealmsScreenReal.method2398(this.field26306.field6314).getTextureManager().bindTexture(RealmsScreenReal.method2397());
      RenderSystem.color4f(1.0F, 1.0F, 1.0F, 1.0F);
      float var7 = !var4 ? 0.0F : 19.0F;
      AbstractGui.method5699(var1, var2, var3, var7, 0.0F, 18, 18, 37, 18);
      if (var4) {
         RealmsScreenReal.method2399(this.field26306.field6314, RealmsScreenReal.method2400());
      }
   }

   @Override
   public void method18800(int var1) {
      RealmsScreenReal.method2401(this.field26306.field6314, var1);
   }
}
