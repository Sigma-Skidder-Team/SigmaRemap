...
public class Class6587 {
         ...
         if (var7 != Class1894.field11101) {
            var3.then(
               ((LiteralArgumentBuilder)Class6099.method18839(var7.method8153())
                     .executes(var1 -> method19962(var1, Collections.<Class878>singleton(((Class6619)var1.getSource()).method20175()), var7)))
                  .then(
   ...
   private static void method19961(Class6619 var0, Class878 var1, Class1894 var2) {
   ...
   private static int method19962(CommandContext<Class6619> var0, Collection<Class878> var1, Class1894 var2) {
      int var5 = 0;
