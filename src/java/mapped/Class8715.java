   ...
   public static void method31435(Class4671 var0) {
      ...
      if (var0 != null) {
         if (Reflector.field42965.exists() && Minecraft.getInstance().getResourceManager() == null) {
            Config.method26810("[Shaders] Delayed loading of item mappings after resources are loaded");
            field39328 = true;
         } else {
   ...
   private static void method31437(InputStream var0, String var1, List<Integer> var2) {
      if (var0 != null) {
         try {
            ...
            var5.load(var0);
            var0.close();
            Config.method26810("[Shaders] Parsing item mappings: " + var1);
            ...
            for (String var8 : (Set<String>) (Set<?>) var5.keySet()) {
               ...
               if (!var8.startsWith(var10)) {
                  Config.method26811("[Shaders] Invalid item ID: " + var8);
               } else {
                  String var11 = Class9402.method35762(var8, var10);
                  int var12 = Config.method26899(var11, -1);
                  if (var12 < 0) {
                     Config.method26811("[Shaders] Invalid item alias ID: " + var12);
                  } else {
                     ...
                     if (var13 != null && var13.length >= 1) {
                        ...
                        Config.method26811("[Shaders] Invalid item ID mapping: " + var8 + "=" + var9);
                     }
                  }
               }
            }
