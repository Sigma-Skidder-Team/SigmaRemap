...
public class Class1264 extends Class1193 {
   ...
   public Class1264(Minecraft var1) {
      this.field6688 = var1;
   }
   ...
   // $VF: synthetic method
   public static Minecraft method5916(Class1264 var0) {
   ...
   public class Class9765<T extends Class7601> {
      ...
      private float method38404(long var1) {
         float var5 = Class9679.method37777((float)(var1 - this.field45686) / 600.0F, 0.0F, 1.0F);
         var5 *= var5;
      ...
      public boolean method38405(int var1, int var2, Class9332 var3) {
         ...
         Class2139 var8 = this.field45685.method24894(var3, Class1264.this, var6 - this.field45687);
