...
public final class Class5688 extends Class5685<HorseEntity, Class2856<HorseEntity>> {
   ...
   public Class5688(EntityRendererManager var1) {
      super(var1, new Class2856<HorseEntity>(0.0F), 1.1F);
      this.addLayer(new Class248(this));
      this.addLayer(new Class258(this));
   }

   public ResourceLocation method17843(HorseEntity var1) {
