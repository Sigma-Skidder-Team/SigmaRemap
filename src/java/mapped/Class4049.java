...
public class Class4049 {
   ...
   public static final float method12820(Class7380 var0, Class1663 var1, BlockPos var2) {
      float var5 = var0.method23399(var1, var2);
      return Class7551.method24694(var5);
   }

   public static final int method12821(Class7380 var0, Class1663 var1, BlockPos var2) {
      if (!(var1 instanceof Class1664)) {
         return Class264.method945(var1, var0, var2);
      } else {
         ...
         if (var7 >= 0 && var7 < var6.length && var6 != null) {
            int var8 = var6[var7];
            if (var8 == -1) {
               var8 = Class264.method945(var1, var0, var2);
               var6[var7] = var8;
            }
