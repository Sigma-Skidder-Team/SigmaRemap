...
public class Class4254 extends Class4247 {
   ...
   public void draw(float var1) {
      ...
      int var5 = this.xA + 12 - (ResourceList.regular20.getStringWidth(this.field20891) - this.widthA) / 2;
      int var6 = this.yA + 102;
      GL11.glAlphaFunc(516, 0.1F);
      RenderUtil.drawString(ResourceList.regular20, (float)var5, (float)(var6 + 1), this.field20891, MultiUtilities.applyAlpha(ClientColors.DEEP_TEAL.getColor, 0.5F));
      RenderUtil.drawString(ResourceList.regular20, (float)var5, (float)var6, this.field20891, ClientColors.LIGHT_GREYISH_BLUE.getColor);
