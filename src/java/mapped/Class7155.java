...
public class Class7155 extends Class7133<Class6935>
{
    ...
    public Stream<Class354> method21893(final Class1851 class1851, final Class6346<? extends Class7065> class1852, final Random random, final Class6935 class1853, final Class354 class1854) {
        return IntStream.range(0, class1853.field27165).filter(p2 -> random2.nextFloat() < class1855.field27166).mapToObj(p3 -> {
            ...
            return new Class354(n3, class1857.method6699(Class2020.field11525, n3, n4), n4);
        });
    }
}
