...
public class Class9142 {
   ...
   public static float[] method34137(Entity var0) {
      double var3 = field42012.field1339.getPosX() + (field42012.field1339.getPosX() - field42012.field1339.field5048) * (double)field42012.method1562();
      double var5 = field42012.field1339.getPosZ() + (field42012.field1339.getPosZ() - field42012.field1339.field5050) * (double)field42012.method1562();
      double var7 = field42012.field1339.getPosY() + (field42012.field1339.getPosY() - field42012.field1339.field5049) * (double)field42012.method1562();
   ...
   public static float[] method34146(Class880 var0) {
      ...
      double var19 = (double)field42012.field1339.method3275(var0);
      var19 -= var19 % 0.8;
      double var21 = 1.0;
      double var23 = 1.0;
   ...
   public static Class7461 method34147(Entity var0) {
      float[] var3 = method34138(var0, field42012.field1339.getPosX(), field42012.field1339.getPosY(), field42012.field1339.getPosZ());
   ...
   public static boolean method34149(Vector3d var0) {
      Vector3d var3 = new Vector3d(
         field42012.field1339.getPosX(), field42012.field1339.getPosY() + (double)field42012.field1339.method3393(), field42012.field1339.getPosZ()
      );
      ...
      if (var1 && !method34149(var4)) {
         for (int var5 = -1; var5 < 2; var5++) {
            ...
            for (int var25 = -1; var25 < 2; var25 += 2) {
               ...
               if (!(field42012.field1339.getPosX() < var8 + var26)) {
                  if (field42012.field1339.getPosX() > var8 + var26) {
                     if (!(field42012.field1339.getPosZ() < var10 - var28)) {
                        var8 += var26;
                     } else {
                        var8 -= var26;
                     }
   ...
   public static float method34151(float var0, double var1, double var3) {
      double var7 = var1 - field42012.field1339.getPosX();
      double var9 = var3 - field42012.field1339.getPosZ();
      double var11 = 0.0;
