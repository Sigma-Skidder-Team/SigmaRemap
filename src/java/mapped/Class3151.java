...
public class Class3151 implements Class2982 {
   ...
   public void method11398(Class8563 var1) throws Exception {
      ...
      for (int var7 = 0; var7 < var6.length; var7++) {
         var6[var7] = var1.<Integer>method30559(BruhMotha.field22544);
      }

      Class8600 var13 = Class6966.method21489(var4, var6);
      if (var13 != null && var13.method30771() != -1) {
         if (var13.method30771() == 11) {
            int var8 = var1.<Integer>method30555(BruhMotha.field22526, 1);
            float var9 = var1.<Float>method30555(BruhMotha.field22532, 6);
            if (var8 == 0) {
               var1.method30558(BruhMotha.field22526, 1, 1);
               var1.method30558(BruhMotha.field22532, 6, 0.0F);
               List var10 = var13.method30773();

               for (int var11 = 0; var11 < 3; var11++) {
                  float var12 = var1.<Float>method30555(BruhMotha.field22532, var11 + 3) * var9;
                  if (var12 == 0.0F && var11 == 0) {
                     var12 = 1.0F;
                  }

                  ((Class9231)var10.get(var11)).method34723(var12);
                  var1.method30558(BruhMotha.field22532, var11 + 3, 0.0F);
               }
            }
         }

         var1.method30558(BruhMotha.field22526, 0, var13.method30771());
