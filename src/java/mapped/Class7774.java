...
public class Class7774 extends DataFix {
   private static final Map<String, String> field33351 = DataFixUtils.make(Maps.newHashMap(), var0 -> {
   ...
   private static final Set<String> field33352 = field33351.keySet()
      .stream()
      .<String>map(var0 -> var0.substring(0, var0.indexOf(46)))
      .collect(Collectors.<String>toSet());
   private static final Set<String> field33353 = Sets.newHashSet(
      new String[]{
         "minecraft:bow",
   ...
   public Class7774(Schema var1, boolean var2) {
      super(var1, var2);
   }
   ...
   public TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped("ItemInstanceTheFlatteningFix", var3, var2 -> {
         ...
         if (var5x.isPresent()) {
            ...
            if (var9 != null) {
               var6 = var2.set(var4, Pair.of(TypeReferences.ITEM_NAME.typeName(), var9));
            }
   ...
   @Nullable
   public static String method25754(String var0, int var1) {
      if (!field33352.contains(var0)) {
         return null;
      } else {
         String var4 = field33351.get(var0 + '.' + var1);
         return var4 != null ? var4 : field33351.get(var0 + ".0");
      }
   }
}
