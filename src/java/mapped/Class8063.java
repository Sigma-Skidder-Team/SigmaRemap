...
public class Class8063 implements DynamicOps<Class30> {
   public static final Class8063 field34602 = new Class8063();
   ...
   public DataResult<String> getStringValue(Class30 var1) {
      return !(var1 instanceof Class40) ? DataResult.error("Not a string") : DataResult.success(var1.method81());
   }
   ...
   private static Class27<?> method27681(byte var0, byte var1) {
      if (!method27682(var0, var1, (byte)4)) {
         if (!method27682(var0, var1, (byte)1)) {
            return (Class27<?>)(!method27682(var0, var1, (byte)3) ? new Class41() : new Class28(new int[0]));
         } else {
   ...
   public DataResult<Class30> mergeToMap(Class30 var1, Class30 var2, Class30 var3) {
      if (!(var1 instanceof Class39) && !(var1 instanceof Class38)) {
         return DataResult.error("mergeToMap called with not a map: " + var1, var1);
      } else if (var2 instanceof Class40) {
         Class39 var6 = new Class39();
         if (var1 instanceof Class39) {
            Class39 var7 = (Class39)var1;
            var7.method97().forEach(var2x -> var6.method99(var2x, var7.method116(var2x)));
         }

         var6.method99(var2.method81(), var3);
   ...
   public DataResult<Class30> mergeToMap(Class30 var1, MapLike<Class30> var2) {
      if (!(var1 instanceof Class39) && !(var1 instanceof Class38)) {
         ...
         if (var1 instanceof Class39) {
            ...
            var6.method97().forEach(var2x -> var5.method99(var2x, var6.method116(var2x)));
         }

         ArrayList var7 = Lists.newArrayList();
         var2.entries().forEach(var2x -> {
            Class30 var5x = (Class30)var2x.getFirst();
            if (var5x instanceof Class40) {
               var5.method99(var5x.method81(), (Class30)var2x.getSecond());
            } else {
               var7.add(var5x);
            }
         });
   ...
   public Class30 createMap(Stream<Pair<Class30, Class30>> var1) {
      ...
      var1.forEach(var1x -> var4.method99(((Class30)var1x.getFirst()).method81(), (Class30)var1x.getSecond()));
      return var4;
   }
   ...
   public Class30 remove(Class30 var1, String var2) {
      if (!(var1 instanceof Class39)) {
         ...
         Class39 var6 = new Class39();
         var5.method97().stream().filter(var1x -> !Objects.equals(var1x, var2)).forEach(var2x -> var6.method99(var2x, var5.method116(var2x)));
         return var6;
      }
   }
