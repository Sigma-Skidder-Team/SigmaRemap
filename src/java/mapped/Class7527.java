...
public class Class7527 {
   ...
   private static final Predicate<Class7380> field32308 = var0 -> !var0.method23393();
   private static final Predicate<Class7380> field32309 = var0 -> var0.method23384().method31087();
   private final Class7776 field32310 = new Class7776(9, 256);
   private final Predicate<Class7380> field32311;
   ...
   public boolean method24578(int var1, int var2, int var3, Class7380 var4) {
         ...
         if (!this.field32311.test(var4)) {
            if (var7 - 1 == var2) {
               ...
               for (int var9 = var2 - 1; var9 >= 0; var9--) {
                  ...
                  if (this.field32311.test(this.field32312.method6738(var8))) {
