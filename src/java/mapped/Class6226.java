...
{
    public Class6226() {
        super(new Class1932("apply_bonus"), Class130.class);
    }
    ...
    public void method18533(final JsonObject jsonObject, final Class130 class130, final JsonSerializationContext jsonSerializationContext) {
        ...
        jsonObject.addProperty("enchantment", Class90.field209.method503(Class130.method658(class130)).toString());
    ...
    public Class130 method18534(final JsonObject jsonObject, final JsonDeserializationContext jsonDeserializationContext, final Class122[] array) {
        final Class6257 class6257 = Class90.field209.method506(new Class1932(Class9583.method35895(jsonObject, "enchantment"))).orElseThrow(() -> {
            new JsonParseException("Invalid enchantment id: " + obj2);
            return;
        });
        final Class1932 obj = new Class1932(Class9583.method35895(jsonObject, "formula"));
