...
public class Class5283 extends Module {
    ...
    private void method16578(Class4428 var1) {
        if (this.method15996()) {
            if (Class5628.method17705() > this.field23755 && field23386.field1339.field5055 % 3 == 0) {
                this.field23755++;
            }
            ...
            boolean var4 = Class9567.method37087() || field23386.field1339.field4981 || field23386.field1339.method3331();
            if (!var4) {
            ...
            if (field23386.field1339 != null) {
                if (!Minecraft.getInstance().field1299.field44664) {
                    if (!Minecraft.getInstance().field1299.field44662) {
                        ...
                        String var5 = field23386.field1339.method3432().method8304()
                                + " "
                                + field23386.field1339.method3432().getY()
                                + " "
                                + field23386.field1339.method3432().method8306();
                        byte var6 = 85;
