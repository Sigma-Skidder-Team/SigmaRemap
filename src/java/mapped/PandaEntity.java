...
public class PandaEntity extends AnimalEntity {
   private static final DataParameter<Integer> field6017 = EntityDataManager.<Integer>createKey(PandaEntity.class, DataSerializers.VARINT);
   private static final DataParameter<Integer> field6018 = EntityDataManager.<Integer>createKey(PandaEntity.class, DataSerializers.VARINT);
   private static final DataParameter<Integer> field6019 = EntityDataManager.<Integer>createKey(PandaEntity.class, DataSerializers.VARINT);
   ...
   public Class1045 method4389(ServerWorld var1, Class1045 var2) {
      PandaEntity var5 = EntityType.PANDA.create(var1);
      if (var2 instanceof PandaEntity) {
         var5.method5225(this, (PandaEntity)var2);
      }
   ...
   private void method5224() {
      ...
      for (PandaEntity var5 : this.world.<PandaEntity>getEntitiesWithinAABB(PandaEntity.class, this.getBoundingBox().grow(10.0))) {
   ...
   public void method5225(PandaEntity var1, PandaEntity var2) {
      if (var2 != null) {
   ...
   // $VF: synthetic method
   public static Random method5232(PandaEntity var0) {
      return var0.rand;
   }

   // $VF: synthetic method
   public static Random method5233(PandaEntity var0) {
      return var0.rand;
   }

   // $VF: synthetic method
   public static Random method5234(PandaEntity var0) {
      return var0.rand;
   }

   // $VF: synthetic method
   public static Random method5235(PandaEntity var0) {
      return var0.rand;
   }

   // $VF: synthetic method
   public static Random method5236(PandaEntity var0) {
      return var0.rand;
   }
   ...
   // $VF: synthetic method
   public static Class2616 method5238(PandaEntity var0) {
      return var0.field6034;
   }

   // $VF: synthetic method
   public static boolean method5239(PandaEntity var0) {
      return var0.field6024;
   }

   // $VF: synthetic method
   public static boolean method5240(PandaEntity var0) {
      return var0.field6025;
   }

   // $VF: synthetic method
   public static Random method5241(PandaEntity var0) {
      return var0.rand;
   }

   // $VF: synthetic method
   public static Random method5242(PandaEntity var0) {
      return var0.rand;
   }
   ...
   // $VF: synthetic method
   public static Random method5244(PandaEntity var0) {
      return var0.rand;
   }

   // $VF: synthetic method
   public static Random method5245(PandaEntity var0) {
      return var0.rand;
   }

   // $VF: synthetic method
   public static void method5246(PandaEntity var0) {
      var0.method5228();
   }

   // $VF: synthetic method
   public static Random method5247(PandaEntity var0) {
      return var0.rand;
   }

   // $VF: synthetic method
   public static Random method5248(PandaEntity var0) {
      return var0.rand;
   }
}
