   ...
   private void method10906(ItemStack var1) {
      if (!var1.isEmpty()) {
         ...
         var6.method3435(
            (double)(
               0.3F
                     * -MathHelper.sin(this.field17115.field5031 * (float) (Math.PI / 180.0))
                     * MathHelper.cos(this.field17115.field5032 * (float) (Math.PI / 180.0))
                  + MathHelper.cos(var8) * var9
            ),
            (double)(0.3F * MathHelper.sin(this.field17115.field5032 * (float) (Math.PI / 180.0)) * 1.5F),
            (double)(
               0.3F
                     * MathHelper.cos(this.field17115.field5031 * (float) (Math.PI / 180.0))
                     * MathHelper.cos(this.field17115.field5032 * (float) (Math.PI / 180.0))
