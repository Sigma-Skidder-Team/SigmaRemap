...
public class Class7572
{
    ...
    private final Map<Class7111<?>, Comparable<?>> field30034;
    private final Map<String, String> field30035;
    private Class1932 field30036;
    private Class9104<Class3833, Class7096> field30037;
    private Class7096 field30038;
    private Class51 field30039;
    private Class1932 field30040;
    ...
    public Class7572(final StringReader field30032, final boolean field30033) {
        ...
        this.field30036 = new Class1932("");
        this.field30040 = new Class1932("");
        this.field30042 = Class7572.field30031;
        this.field30032 = field30032;
        this.field30033 = field30033;
    }
    
    public Map<Class7111<?>, Comparable<?>> method23798() {
    ...
    private CompletableFuture<Suggestions> method23805(final SuggestionsBuilder suggestionsBuilder) {
        ...
        for (final Class7111 class7111 : this.field30038.method21770()) {
            if (this.field30034.containsKey(class7111)) {
                continue;
            }
            if (!class7111.method21826().startsWith(lowerCase)) {
                continue;
            }
            suggestionsBuilder.suggest(class7111.method21826() + '=');
        }
    ...
    private CompletableFuture<Suggestions> method23806(final SuggestionsBuilder suggestionsBuilder) {
        ...
        if (this.field30040 != null) {
            if (!this.field30040.method7797().isEmpty()) {
                final Class7909<Class3833> method18460 = Class7188.method22057().method18460(this.field30040);
                if (method18460 != null) {
                    final Iterator<Class3833> iterator = method18460.method25616().iterator();
                    while (iterator.hasNext()) {
                        for (final Class7111 class7111 : iterator.next().method11876().method32905()) {
                            if (this.field30035.containsKey(class7111.method21826())) {
                                continue;
                            }
                            if (!class7111.method21826().startsWith(lowerCase)) {
                                continue;
    ...
    private static <T extends Comparable<T>> SuggestionsBuilder method23811(final SuggestionsBuilder suggestionsBuilder, final Class7111<T> class7111) {
        for (final Comparable<T> comparable : class7111.method21829()) {
            if (!(comparable instanceof Integer)) {
                suggestionsBuilder.suggest(class7111.method21831((T)comparable));
            }
            else {
    ...
    private CompletableFuture<Suggestions> method23812(final SuggestionsBuilder suggestionsBuilder, final String s) {
        ...
        if (this.field30040 != null) {
            if (!this.field30040.method7797().isEmpty()) {
                final Class7909<Class3833> method18460 = Class7188.method22057().method18460(this.field30040);
                if (method18460 != null) {
                    for (final Class3833 class3833 : method18460.method25616()) {
                        final Class7111<?> method18461 = class3833.method11876().method32906(s);
                        if (method18461 != null) {
                        ...
                        final Iterator<Class7111<?>> iterator2 = class3833.method11876().method32905().iterator();
                        while (iterator2.hasNext()) {
                            if (this.field30035.containsKey(iterator2.next().method21826())) {
                                continue;
                            }
                            n = 1;
                            break;
    ...
    private CompletableFuture<Suggestions> method23813(final SuggestionsBuilder suggestionsBuilder) {
        if (suggestionsBuilder.getRemaining().isEmpty()) {
            ...
            if (method18460 != null) {
                ...
                boolean b2 = false;
                for (final Class3833 class3833 : method18460.method25616()) {
                    b |= !class3833.method11876().method32905().isEmpty();
    ...
    private CompletableFuture<Suggestions> method23816(final SuggestionsBuilder suggestionsBuilder) {
        ...
        Class7491.method23220(Class90.field208.method507(), suggestionsBuilder);
        return suggestionsBuilder.buildFuture();
    }
    
    public void method23817() throws CommandSyntaxException {
        this.field30032.getCursor();
        this.field30036 = Class1932.method7799(this.field30032);
        final Class3833 class3833 = Class90.field208.method506(this.field30036).orElseThrow(() -> {
        ...
        this.field30037 = class3833.method11876();
        this.field30038 = class3833.method11878();
    }
    ...
    public void method23818() throws CommandSyntaxException {
        if (this.field30033) {
            ...
            this.field30040 = Class1932.method7799(this.field30032);
            return;
        }
    ...
    public void method23819() throws CommandSyntaxException {
        ...
        while (this.field30032.canRead()) {
            ...
            final Class7111<?> method32906 = this.field30037.method32906(string);
            if (method32906 == null) {
                this.field30032.setCursor(cursor);
            ...
            this.field30032.skip();
            this.field30032.skipWhitespace();
            this.field30042 = (Function<SuggestionsBuilder, CompletableFuture<Suggestions>>)(suggestionsBuilder2 -> method23811(suggestionsBuilder2, (Class7111<Comparable>)class7111).buildFuture());
    ...
    private <T extends Comparable<T>> void method23822(final Class7111<T> class7111, final String s, final int cursor) throws CommandSyntaxException {
        final Optional method21830 = class7111.method21830(s);
        if (!method21830.isPresent()) {
            this.field30032.setCursor(cursor);
            throw Class7572.field30028.createWithContext((ImmutableStringReader)this.field30032, (Object)this.field30036.toString(), (Object)class7111.method21826(), (Object)s);
        }
        this.field30038 = (Class7096)((Class7097<Object, Object>)this.field30038).method21773(class7111, method21830.get());
        this.field30034.put(class7111, (Comparable<?>)method21830.get());
    }
    
    public static String toString(final Class7096 class7096) {
        final StringBuilder sb = new StringBuilder(Class90.field208.method503(class7096.method21696()).toString());
        if (!class7096.method21770().isEmpty()) {
            ...
            for (final Map.Entry entry : class7096.method21776().entrySet()) {
                ...
                method23823(sb, (Class7111<Comparable>)entry.getKey(), (Comparable<?>)entry.getValue());
                n = 1;
            }
            sb.append(']');
        }
    ...
    private static <T extends Comparable<T>> void method23823(final StringBuilder sb, final Class7111<T> class7111, final Comparable<?> comparable) {
        sb.append(class7111.method21826());
        sb.append('=');
        sb.append(class7111.method21831((T)comparable));
    }
