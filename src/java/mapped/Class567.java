...
public class Class567 extends Class566
{
    ...
    public void method2975(final int n, final int n2, final float n3) {
        ...
        if (n4 >= 1.0f) {
            ...
            Class565.method3293(0, 0, method7696, method7697, this.field3373 | Class9546.method35649((1.0f - Class9546.method35653(n4 - 1.0f, 0.0f, 1.0f)) * 255.0f) << 24);
            method7699 = 1.0f - Class9546.method35653(n4 - 1.0f, 0.0f, 1.0f);
        }
        else if (this.field3369) {
            if (this.field3366.field4700 != null && n5 < 1.0f) {
                this.field3366.field4700.method2975(n, n2, n3);
            }
            Class565.method3293(0, 0, method7696, method7697, this.field3373 | Class9546.method35650(Class9546.method35654(n5, 0.15, 1.0) * 255.0) << 24);
            method7699 = Class9546.method35653(n5, 0.0f, 1.0f);
        }
        else {
        ...
        this.field3370 = Class9546.method35653(this.field3370 * 0.95f + this.field3367.method27189() * 0.050000012f, 0.0f, 1.0f);
        Class9570.field41188.method22608(new Object[0]);
        if (n4 < 1.0f) {
            this.method3307(method7696 / 2 - 150, method7697 / 4 * 3, method7696 / 2 + 150, method7697 / 4 * 3 + 10, 1.0f - Class9546.method35653(n4, 0.0f, 1.0f));
        }
        if (n4 >= 2.0f) {
    ...
    private void method3307(final int n, final int n2, final int n3, final int n4, final float n5) {
        final int method35649 = Class9546.method35649((n3 - n - 1) * this.field3370);
        ...
        Class565.method3293(n - 1, n2 - 1, n3 + 1, n4 + 1, 0xFF000000 | (int)Class9546.method35700(1.0f - n5, (float)(this.field3375 >> 16 & 0xFF), n6) << 16 | (int)Class9546.method35700(1.0f - n5, (float)(this.field3375 >> 8 & 0xFF), n7) << 8 | (int)Class9546.method35700(1.0f - n5, (float)(this.field3375 & 0xFF), n8));
        Class565.method3293(n, n2, n3, n4, this.field3374 | 0xFF000000);
        Class565.method3293(n + 1, n2 + 1, n + method35649, n4 - 1, 0xFF000000 | (int)Class9546.method35700(1.0f - n5, (float)(this.field3376 >> 16 & 0xFF), n6) << 16 | (int)Class9546.method35700(1.0f - n5, (float)(this.field3376 >> 8 & 0xFF), n7) << 8 | (int)Class9546.method35700(1.0f - n5, (float)(this.field3376 & 0xFF), n8));
    }
