...
public class Class5431 extends Class5419<Class787>
{
    ...
    private final Class8233<? extends Class399> field22623;
    private final float field22624;
    
    public Class5431(final Class8233<? extends Class399> field22623, final float field22624) {
    ...
    public boolean method16553(final Class1849 class1849, final Class787 class1850) {
        return class1850.method1734((Class399)class1850.method2618().method1198(this.field22623).get()) < 36.0;
    }
    
    public void method16554(final Class1849 class1849, final Class787 class1850, final long n) {
        method16588(class1850, (Class399)class1850.method2618().method1198(this.field22623).get(), this.field22624);
    }
    
    public static void method16588(final Class787 class787, final Class399 class788, final float n) {
        for (int i = 0; i < 10; ++i) {
            final Class5487 method24909 = Class7775.method24909(class787, 16, 7, class788.method1934());
            if (method24909 != null) {
