...
public class Class4339 extends Class4304 {
   ...
   private final void method13511() {
      this.method13241().add(this.buttonList = new IconPanel(this, "content", 0, 0, this.width, this.height));
   ...
   public void method13028(int var1, int var2) {
      if (!this.field21203 || this.method13287()) {
         ...
         this.buttonList.setY(-1 * this.field21205.method13162());

         for (IconPanel var6 : this.getButtons().method13241()) {
