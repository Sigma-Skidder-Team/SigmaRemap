...
public abstract class Class5872<T extends Class5872<T>> extends Class5873<T> implements Class5871<T> {
   ...
   private final List<ILootFunction> field25661 = Lists.newArrayList();
   ...
   public ILootFunction[] method18298() {
      return this.field25661.<ILootFunction>toArray(new ILootFunction[0]);
   }
