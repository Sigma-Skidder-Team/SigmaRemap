...
public class Class3361 extends Class3355
{
        ...
        if (this.method9906() && Class3361.field15514.field4682.method27330()) {
            if (class5744.method17046()) {
                if (Class3361.field16007 >= 0) {
                    ...
                    final float[] method30919 = Class8845.method30919(this.field16008.method1074() + 0.5, this.field16008.method1076() + 0.5, this.field16008.method1075() + 0.5);
                ...
                if (method30920 != -1) {
                    if (!Class3361.field15514.field4684.field2404) {
                        if (Class3361.field15514.field4684.field2414 > 3.0f) {
                            final Class354 method30921 = this.method10649();
                            if (method30921 != null) {
                                if (class5744.method17046() && Class3361.field16007 == -1) {
                                    final float[] method30922 = Class8845.method30919(method30921.method1074() + 0.5, method30921.method1076() + 0.5, method30921.method1075() + 0.5);
    ...
    private Class354 method10649() {
        ...
        while (iterator.hasNext()) {
            final Class354 class353 = new Class354(iterator.next().method24537().method18517());
            if (!Class4609.method13708(class353)) {
                continue;
            }
            if (class353.method1075() + 1 >= Class3361.field15514.field4684.field2396) {
                continue;
            }
            if (class352 != null && Class3361.field15514.field4684.method1733(class352.method1074() + 0.5 - field22770, class352.method1075() + 1, class352.method1076() + 0.5 - field22772) <= Class3361.field15514.field4684.method1733(class353.method1074() + 0.5 - field22770, class353.method1075() + 1, class353.method1076() + 0.5 - field22772)) {
                continue;
            }
            class352 = class353;
        }
        if (class352 == null) {
            ...
            while (iterator2.hasNext()) {
                final Class354 class354 = new Class354(iterator2.next().method24537().method18517());
                if (!Class4609.method13708(class354)) {
                    continue;
                }
                if (class354.method1075() + 1 >= Class3361.field15514.field4684.field2396) {
                    continue;
                }
                if (class352 != null && Class3361.field15514.field4684.method1733(class352.method1074() + 0.5 - field22770, class352.method1075() + 1, class352.method1076() + 0.5 - field22772) <= Class3361.field15514.field4684.method1733(class354.method1074() + 0.5 - field22770, class354.method1075() + 1, class354.method1076() + 0.5 - field22772)) {
                    continue;
                }
                class352 = class354;
            }
            return (Class354)class352;
        }
        return (Class354)class352;
    }
}
