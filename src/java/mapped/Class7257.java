...
public abstract class Class7257 extends Class7255
{
    ...
    public Class5487 method22155(final Class1855 class1855, final Class354 class1856, final Class7099 class1857) {
        double n = 0.0;
        double n2 = 0.0;
        Class5487 method1302;
        try (final Class386 method1296 = Class386.method1296()) {
            for (final Class179 class1858 : Class98.field268) {
                ...
                if (this.method22168(method1297)) {
                    ...
                    n += class1858.method785() * n3;
                    n2 += class1858.method787() * n3;
                }
            }
            Class5487 method1301 = new Class5487(n, 0.0, n2);
    ...
    public boolean method22169(final Class1855 class1855, final Class354 class1856, final Class179 class1857) {
        final Class7096 method6701 = class1855.method6701(class1856);
        return !class1855.method6702(class1856).method21779().method22165(this) && (class1857 == Class179.field512 || (method6701.method21697() != Class8059.field33183 && method6701.method21761(class1855, class1856, class1857)));
    }
    
    public void method22170(final Class1851 class1851, final Class354 class1852, final Class7099 class1853) {
        if (!class1853.method21781()) {
            final Class7096 method6701 = class1851.method6701(class1852);
            final Class354 method6702 = class1852.method1139();
            ...
            if (!this.method22190(class1851, class1852, method6701, Class179.field511, method6702, method6703, class1851.method6702(method6702), method6704.method21779())) {
                ...
                this.method22179(class1851, method6702, method6703, Class179.field511, method6704);
    ...
    private void method22171(final Class1851 class1851, final Class354 class1852, final Class7099 class1853, final Class7096 class1854) {
        int n = class1853.method21784() - this.method22191(class1851);
        if (class1853.method21772((Class7111<Boolean>)Class7257.field28132)) {
            n = 7;
        }
        if (n > 0) {
            for (final Map.Entry<Class179, V> entry : this.method22188(class1851, class1852, class1854).entrySet()) {
                final Class179 class1855 = entry.getKey();
                final Class7099 class1856 = (Class7099)entry.getValue();
                final Class354 method1149 = class1852.method1149(class1855);
    ...
    public Class7099 method22172(final Class1852 class1852, final Class354 class1853, final Class7096 class1854) {
        int max = 0;
        int n = 0;
        for (final Class179 class1855 : Class98.field268) {
            final Class354 method1149 = class1853.method1149(class1855);
        ...
        final Class354 method1154 = class1853.method1137();
        ...
        if (!method1156.method21781()) {
            if (method1156.method21779().method22165(this)) {
                if (this.method22173(Class179.field512, class1852, class1853, class1854, method1154, method1155)) {
    ...
    private boolean method22173(final Class179 class179, final Class1855 class180, final Class354 class181, final Class7096 class182, final Class354 class183, final Class7096 class184) {
    ...
    public void method22179(final Class1851 class1851, final Class354 class1852, final Class7096 class1853, final Class179 class1854, final Class7099 class1855) {
    ...
    public abstract void method22180(final Class1851 p0, final Class354 p1, final Class7096 p2);
    
    private static short method22181(final Class354 class354, final Class354 class355) {
        return (short)((class355.method1074() - class354.method1074() + 128 & 0xFF) << 8 | (class355.method1076() - class354.method1076() + 128 & 0xFF));
    }
    
    public int method22182(final Class1852 class1852, final Class354 class1853, final int n, final Class179 class1854, final Class7096 class1855, final Class354 class1856, final Short2ObjectMap<Pair<Class7096, Class7099>> short2ObjectMap, final Short2BooleanMap short2BooleanMap) {
        int n2 = 1000;
        for (final Class179 class1857 : Class98.field268) {
            if (class1857 == class1854) {
                continue;
            }
            final Class354 method1149 = class1853.method1149(class1857);
            ...
            final int method1151 = this.method22182(class1852, method1149, n + 1, class1857.method782(), class1858, class1856, short2ObjectMap, short2BooleanMap);
            if (method1151 >= n2) {
                continue;
            }
            n2 = method1151;
    ...
    private boolean method22183(final Class1855 class1855, final Class7255 class1856, final Class354 class1857, final Class7096 class1858, final Class354 class1859, final Class7096 class1860) {
        return this.method22173(Class179.field511, class1855, class1857, class1858, class1859, class1860) && (class1860.method21756().method21779().method22165(this) || this.method22189(class1855, class1859, class1860, class1856));
    }
    
    private boolean method22184(final Class1855 class1855, final Class7255 class1856, final Class354 class1857, final Class7096 class1858, final Class179 class1859, final Class354 class1860, final Class7096 class1861, final Class7099 class1862) {
    ...
    private int method22187(final Class1852 class1852, final Class354 class1853) {
        int n = 0;
    ...
    public Map<Class179, Class7099> method22188(final Class1852 class1852, final Class354 class1853, final Class7096 class1854) {
        int n = 1000;
        ...
        for (final Class179 class1855 : Class98.field268) {
            final Class354 class1865 = class1853.method1149(class1855);
            ...
            if (!((Short2BooleanMap)short2BooleanOpenHashMap).computeIfAbsent(method1150, p4 -> {
                ...
                method1152 = this.method22182(class1852, class1865, 1, class1855.method782(), class1856, class1853, (Short2ObjectMap<Pair<Class7096, Class7099>>)short2ObjectOpenHashMap, (Short2BooleanMap)short2BooleanOpenHashMap);
            }
            else {
                method1152 = 0;
            }
    ...
    private boolean method22189(final Class1855 class1855, final Class354 class1856, final Class7096 class1857, final Class7255 class1858) {
    ...
    public boolean method22190(final Class1855 class1855, final Class354 class1856, final Class7096 class1857, final Class179 class1858, final Class354 class1859, final Class7096 class1860, final Class7099 class1861, final Class7255 class1862) {
    ...
    public int method22192(final Class1847 class1847, final Class354 class1848, final Class7099 class1849, final Class7099 class1850) {
        return this.method22156(class1847);
    }
    
    @Override
    public void method22151(final Class1847 class1847, final Class354 class1848, Class7099 obj) {
        if (!obj.method21780()) {
    ...
    private static boolean method22194(final Class7099 class7099, final Class1855 class7100, final Class354 class7101) {
    ...
    @Override
    public Class7702 method22167(final Class7099 key, final Class1855 class1855, final Class354 class1856) {
