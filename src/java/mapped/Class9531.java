...
public class Class9531 {
   public static void method36833(CommandDispatcher<CommandSource> var0) {
      var0.register(
         (LiteralArgumentBuilder)((LiteralArgumentBuilder) Commands.method18839("setidletimeout").requires(var0x -> var0x.method20129(3)))
            .then(
               Commands.method18840("minutes", IntegerArgumentType.integer(0))
   ...
   private static int method36834(CommandSource var0, int var1) {
      ...
      var0.sendFeedback(new TranslationTextComponent("commands.setidletimeout.success", var1), true);
      return var1;
   }
}
