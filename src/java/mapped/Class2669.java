...
public class Class2669 extends Class2595 {
   private final SkeletonHorseEntity field17046;

   public Class2669(SkeletonHorseEntity var1) {
   ...
   private AbstractHorseEntity method10886(Class9755 var1) {
      SkeletonHorseEntity var4 = EntityType.SKELETON_HORSE.create(this.field17046.world);
   ...
   private SkeletonEntity method10887(Class9755 var1, AbstractHorseEntity var2) {
      SkeletonEntity var5 = EntityType.SKELETON.create(var2.world);
