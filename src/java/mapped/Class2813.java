...
public class Class2813<T extends Entity> extends Class2803<T> {
   ...
   public void method10998(T var1, float var2, float var3, float var4, float var5, float var6) {
      ...
      float var12 = -(MathHelper.method37764(var2 * 0.6662F * 2.0F + 0.0F) * 0.4F) * var3;
      float var13 = -(MathHelper.method37764(var2 * 0.6662F * 2.0F + (float) Math.PI) * 0.4F) * var3;
      float var14 = -(MathHelper.method37764(var2 * 0.6662F * 2.0F + (float) (Math.PI / 2)) * 0.4F) * var3;
      float var15 = -(MathHelper.method37764(var2 * 0.6662F * 2.0F + (float) (Math.PI * 3.0 / 2.0)) * 0.4F) * var3;
      float var16 = Math.abs(MathHelper.method37763(var2 * 0.6662F + 0.0F) * 0.4F) * var3;
      float var17 = Math.abs(MathHelper.method37763(var2 * 0.6662F + (float) Math.PI) * 0.4F) * var3;
      float var18 = Math.abs(MathHelper.method37763(var2 * 0.6662F + (float) (Math.PI / 2)) * 0.4F) * var3;
      float var19 = Math.abs(MathHelper.method37763(var2 * 0.6662F + (float) (Math.PI * 3.0 / 2.0)) * 0.4F) * var3;
