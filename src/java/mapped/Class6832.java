...
public class Class6832 extends Class6831
{
    ...
    public void method20918() {
        ...
        if (!this.field26829.field2410 && (this.field26830 <= 20 || this.field26829.method2773())) {
            this.field26837 = (float)this.field26829.method1938();
            this.field26838 = (float)this.field26829.method1941();
            this.field26839 = (float)this.field26829.method1945();
            final float n = (float)this.field26829.method1935().method16753();
            if (n < 1.0E-7) {
