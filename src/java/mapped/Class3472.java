...
public abstract class Class3472 extends Class3471 {
   ...
   private static boolean method12160(Class7380 var0, Class1662 var1, BlockPos var2) {
      ...
      if (var6.method23448(Class8487.field36571) && var6.<Integer>method23463(Class3410.field19092) == 1) {
         return true;
      ...
      if (method12160(var1, var2, var3)) {
         if (var2.method7015(var3.method8311()) >= 9) {
            ...
            for (int var8 = 0; var8 < 4; var8++) {
               ...
               if (var2.method6738(var9).method23448(Class8487.field36396) && method12161(var7, var2, var9)) {
                  var2.method6730(var9, var7.method23465(field19323, Boolean.valueOf(var2.method6738(var9.method8311()).method23448(Class8487.field36571))));
               }
            }
         }
      } else {
         var2.method6730(var3, Class8487.field36396.method11579());
      }
   }
}
