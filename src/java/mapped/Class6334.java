...
public abstract class Class6334 extends Class6333 {
   ...
   public void method19269() {
      ...
      if (!this.field27846.field5041 && !this.field27847) {
         ...
         float var4 = Class9679.method37766(Entity.method3234(this.field27846.method3433()));
         if (!((double)var4 >= 0.01)) {
            this.field27857 = 0.0F;
            this.field27856 = 0.0F;
         } else {
            this.field27857 = Class9679.method37821(Class9679.method37777(var4, this.method19272(), this.method19273()), this.method19272(), this.method19273());
            this.field27856 = Class9679.method37821(Class9679.method37777(var4, 0.0F, 0.5F), 0.0F, 1.2F);
         }
      } else {
         this.method19271();
      }
