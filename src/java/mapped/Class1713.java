...
public class Class1713 implements AutoCloseable {
   private final Class289 field9324;
   ...
   private Class191 field9359;

   public Class1713(ResourceLocation var1) {
      this.field9324 = null;
   ...
   private Class1713(Class1713 var1) {
   ...
   public Class1713(Class289 var1, Class9431 var2, int var3, int var4, int var5, int var6, int var7, Class1806 var8) {
      this.field9324 = var1;
      ...
      try {
         try {
            ...
            Class4526 var29 = Class4526.method14413(var22, "Generating mipmaps for frame");
            Class8965 var32 = var29.method14410("Frame being iterated");
            var32.method32806("First frame", () -> {
         ...
         Class4526 var28 = Class4526.method14413(var23, "Applying mipmap");
         Class8965 var31 = var28.method14410("Sprite being mipmapped");
         var31.method32806("Sprite name", () -> this.method7465().toString());
         var31.method32806("Sprite size", () -> this.method7457() + " x " + this.method7458());
         var31.method32806("Sprite frames", () -> this.method7467() + " frames");
         var31.method32807("Mipmap levels", var3);
         throw new Class2506(var28);
      }
   ...
   public void method7476(Class9147 var1) {
      if (this.field9339 < 0) {
         if (this.field9324 != null) {
            Class1713 var4 = this.field9324.method1105(this.method7465());
            if (var4 != null) {
   ...
   public Class1713 method7494() {
      Class1713 var3 = new Class1713(this);
      var3.field9346 = true;
      return var3;
   }

   public Class1713 method7495(String var1, int var2) {
      ...
      if (this.field9359.method581(var6)) {
         try (Class1783 var8 = this.field9359.method580(var6)) {
            ...
            var7 = new Class1713(this.field9324, var14, this.field9348, this.field9342, this.field9343, this.field9331, this.field9332, var15);
      ...
      if (var7 == null) {
         ...
         var7 = new Class1713(this.field9324, var32, this.field9348, this.field9342, this.field9343, this.field9331, this.field9332, var30);
      }
   ...
   private void method7497(boolean var1) {
      ...
      if (this.field9357 && !this.field9346) {
         if (this.field9349 == null && Class8981.field40874) {
            this.field9349 = this.method7495("_n", -8421377);
         }

         if (this.field9350 == null && Class8981.field40875) {
            this.field9350 = this.method7495("_s", 0);
         }
      }
   }

   public void method7498(Class191 var1) {
      this.field9359 = var1;
   ...
   // $VF: synthetic method
   public static int method7505(Class1713 var0) {
      return var0.field9338;
   }

   // $VF: synthetic method
   public static int method7506(Class1713 var0) {
      return var0.field9337;
   }

   // $VF: synthetic method
   public static Class7788 method7507(Class1713 var0) {
      return var0.field9326;
   }

   // $VF: synthetic method
   public static Class9431 method7508(Class1713 var0) {
      return var0.field9325;
   }

   // $VF: synthetic method
   public static void method7509(Class1713 var0, int var1, int var2, Class1806[] var3) {
      var0.method7456(var1, var2, var3);
   }

   // $VF: synthetic method
   public static int[] method7510(Class1713 var0) {
      return var0.field9328;
   }

   // $VF: synthetic method
   public static int[] method7511(Class1713 var0) {
