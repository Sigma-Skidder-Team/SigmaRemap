...
public class Class6983 {
   ...
   public static boolean method21570(Class6947<?> var0, LivingEntity var1) {
      return var0.<List<LivingEntity>>method21410(Class8830.field39819).filter(var1x -> var1x.contains(var1)).isPresent();
   }

   public static boolean method21571(Class6947<?> var0, Class8830<? extends LivingEntity> var1, EntityType<?> var2) {
      return method21572(var0, var1, var1x -> var1x.getType() == var2);
   }

   private static boolean method21572(Class6947<?> var0, Class8830<? extends LivingEntity> var1, Predicate<LivingEntity> var2) {
   ...
   public static boolean method21582(LivingEntity var0, LivingEntity var1, double var2) {
      Optional var6 = var0.method2992().<LivingEntity>method21410(Class8830.field39826);
      if (var6.isPresent()) {
         double var7 = var0.method3278(((LivingEntity)var6.get()).getPositionVec());
