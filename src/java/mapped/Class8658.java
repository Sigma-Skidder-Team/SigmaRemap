   ...
   public static void method31159(CommandDispatcher<CommandSource> var0) {
      var0.register(
         (LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)Class6099.method18839("banlist")
                  ...
                  .executes(
                     var0x -> {
                        Class6395 var3 = ((CommandSource)var0x.getSource()).method20177().getPlayerList();
                        return method31160(
               ...
               .then(
                  Class6099.method18839("ips")
                     .executes(
                        var0x -> method31160(
                              (CommandSource)var0x.getSource(), ((CommandSource)var0x.getSource()).method20177().getPlayerList().method19462().method14443()
                           )
                     )
               ))
            .then(
               Class6099.method18839("players")
                  .executes(
                     var0x -> method31160((CommandSource)var0x.getSource(), ((CommandSource)var0x.getSource()).method20177().getPlayerList().method19461().method14443())
                  )
            )
      );
   }
