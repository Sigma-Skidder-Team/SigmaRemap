...
public class Class4526 {
   ...
   private final Class8965 field21833 = new Class8965(this, "System Details");
   private final List<Class8965> field21834 = Lists.newArrayList();
   ...
   public Class4526(String var1, Throwable var2) {
   ...
   private void method14401() {
      ...
      this.field21833.method32806("Java Version", () -> System.getProperty("java.version") + ", " + System.getProperty("java.vendor"));
      this.field21833
         .method32806(
            "Java VM Version",
            () -> System.getProperty("java.vm.name") + " (" + System.getProperty("java.vm.info") + "), " + System.getProperty("java.vm.vendor")
         );
      this.field21833.method32806("Memory", () -> {
      ...
      this.field21833.method32807("CPUs", Runtime.getRuntime().availableProcessors());
      this.field21833.method32806("JVM Flags", () -> {
   ...
   public void method14404(StringBuilder var1) {
      ...
      for (Class8965 var9 : this.field21834) {
   ...
   public File method14407() {
      return this.field21835;
   }

   public boolean method14408(File var1) {
   ...
   public Class8965 method14409() {
      return this.field21833;
   }

   public Class8965 method14410(String var1) {
      return this.method14411(var1, 1);
   }

   public Class8965 method14411(String var1, int var2) {
      Class8965 var5 = new Class8965(this, var1);
      ...
      try {
         if (this.field21836) {
            ...
            if (var6 > 0 && !this.field21834.isEmpty()) {
               Class8965 var11 = this.field21834.get(this.field21834.size() - 1);
   ...
   public static Class4526 method14413(Throwable var0, String var1) {
      while (var0 instanceof CompletionException && var0.getCause() != null) {
         var0 = var0.getCause();
      }

      Class4526 var4;
      if (!(var0 instanceof Class2506)) {
         var4 = new Class4526(var1, var0);
      } else {
         var4 = ((Class2506)var0).method10487();
      }
   ...
   public static void method14414() {
      new Class4526("Don't panic!", new Throwable()).method14406();
   }
}
