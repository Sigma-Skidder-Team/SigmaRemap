...
public class Class2845 extends Class2844 {
   ...
   private final Class7219 field17645 = new Class7219(this, 32, 0);

   public Class2845() {
      super(0, 0, 64, 64);
      this.field17645.method22675(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, 0.25F);
      this.field17645.method22679(0.0F, 0.0F, 0.0F);
   }

   @Override
   public void method11174(float var1, float var2, float var3) {
      super.method11174(var1, var2, var3);
      this.field17645.field31036 = this.field17644.field31036;
      this.field17645.field31035 = this.field17644.field31035;
   }
