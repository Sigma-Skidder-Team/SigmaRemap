...
public class Class4496 {
   ...
   private Consumer<Class39> field21707;

   public Class4496(ClientPlayNetHandler var1) {
      this.field21705 = var1;
   }

   public boolean method14176(int var1, Class39 var2) {
   ...
   private int method14177(Consumer<Class39> var1) {
      this.field21707 = var1;
      return ++this.field21706;
   }

   public void method14178(int var1, Consumer<Class39> var2) {
      int var5 = this.method14177(var2);
      this.field21705.sendPacket(new Class5559(var5, var1));
   }

   public void method14179(BlockPos var1, Consumer<Class39> var2) {
      int var5 = this.method14177(var2);
