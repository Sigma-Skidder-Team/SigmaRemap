   ...
   public void method22269(ISeedReader var1, Random var2, List<BlockPos> var3, List<BlockPos> var4, Set<BlockPos> var5, MutableBoundingBox var6) {
      if (!(var2.nextFloat() >= this.field30701)) {
         ...
         if (!var11.isEmpty()) {
            ...
            if (Class2898.method11221(var1, var13) && Class2898.method11221(var1, var13.offset(Direction.SOUTH))) {
               BlockState var14 = Blocks.field37117.getDefaultState().with(Class3366.field18935, Direction.SOUTH);
               ...
               if (var15 instanceof BeehiveTileEntity) {
                  ...
                  for (int var18 = 0; var18 < var17; var18++) {
                     BeeEntity var19 = new BeeEntity(EntityType.BEE, var1.method6970());
