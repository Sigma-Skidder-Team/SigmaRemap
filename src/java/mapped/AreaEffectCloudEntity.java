...
public class AreaEffectCloudEntity extends Entity {
   ...
   public AreaEffectCloudEntity(EntityType<? extends AreaEffectCloudEntity> var1, World var2) {
      super(var1, var2);
      this.noClip = true;
      this.method4097(3.0F);
   }

   public AreaEffectCloudEntity(World var1, double var2, double var4, double var6) {
