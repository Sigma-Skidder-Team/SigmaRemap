...
public class Class5267 extends PremiumModule {
    ...
    public void method15965() {
        ...
        if (Class5628.method17730(field23386.field1339, 0.001F)) {
            ...
            field23386.getClientPlayNetHandler().sendPacket(new Class5605(var3, -150.0, var7, false));
            Class9567.method37090(0.0);
    ...
    public void method16485(Class4435 var1) {
        if (this.method15996()) {
            ...
            if (this.field23696 != 1) {
                ...
                var1.method13995(!field23386.field1299.field44636.method8509() ? (!this.field23699 ? 1.0E-4 : -0.99) : (!this.field23699 ? 0.99 : 1.0E-4));
                Class9567.method37088(var1, !field23386.field1299.field44636.method8509() ? (!this.field23699 ? 3.7 : 2.8) : (!this.field23699 ? 2.8 : 3.7));
            }
