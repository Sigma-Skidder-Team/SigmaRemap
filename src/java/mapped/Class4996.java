...
public class Class4996 extends Class4975 {
   ...
   public void method15262(Class8827 var1) throws IOException {
      ...
      int var5;
      if (!var4) {
         var5 = (int)var1.method31863(4);
      } else {
         var1.method31870(3L);
         var5 = var1.method31861();
      }

      this.field22927 = var1.method31863(4);
   ...
   private void method15341(Class8827 var1, int var2) throws IOException {
      for (int var5 = 0; (long)var5 < this.field22927; var5++) {
         this.field22928[var5] = var1.method31863(var2);
      }
   }
