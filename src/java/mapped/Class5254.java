...
public class Class5254 extends PremiumModule {
    ...
    public static BlockPos method16376() {
        return new BlockPos(
                Math.floor(field23386.field1339.getPosX()), Math.floor(field23386.field1339.getPosY()), Math.floor(field23386.field1339.getPosZ())
        );
    }
    ...
    public static float method16380(double var0, double var2, double var4, Entity var6) {
        ...
        if (var6 instanceof Class880) {
            var18 = method16382(
                    (Class880) var6, method16381(var17), new Class7782(field23386.field1338, null, null, null, var0, var2, var4, 6.0F, false, Class2141.field14015)
            );
        }
    ...
    private static float method16381(float var0) {
        int var3 = field23386.field1338.method6997().method8905();
    ...
    private static void method16383() {
        if (field23631) {
            field23629 = field23386.field1339.field5031;
            field23630 = field23386.field1339.field5032;
            field23631 = false;
        }
    }
    ...
    public void method16374(Class4399 var1) {
        if (!var1.method13921()) {
            ...
            if ((float) this.field23636 >= 20.0F / this.method15977("CPS")) {
                Class1001 var5 = field23386.field1338
                        .method6772(
                        ...
                        .filter(var0 -> var0.method3275(field23386.field1339) < 6.0F)
    ...
    public void method16375(Class4420 var1) {
        ...
        for (BlockPos var6 : this.field23637) {
            double var7 = (double) var6.method8304() - field23386.field1295.method768().method37504().method11320();
            double var9 = (double) var6.getY() - field23386.field1295.method768().method37504().method11321();
            double var11 = (double) var6.method8306() - field23386.field1295.method768().method37504().method11322();
        ...
        if (this.field23633 != null) {
            double var14 = this.field23633.getPosX() - field23386.field1295.method768().method37504().method11320();
            double var19 = this.field23633.getPosY() - field23386.field1295.method768().method37504().method11321() + 0.5;
            double var20 = this.field23633.getPosZ() - field23386.field1295.method768().method37504().method11322();
            float var16 = 0.3F;
    ...
    private boolean method16378(BlockPos var1) {
        ...
        return (
                field23386.field1338.method6738(var1).method23383() == Class8487.field36412
                        || field23386.field1338.method6738(var1).method23383() == Class8487.field36527
        )
                && field23386.field1338.method6738(var4).method23383() == Class8487.field36387
                && field23386.field1338.method6738(var5).method23383() == Class8487.field36387
                && field23386.field1338.method7182(Entity.class, new Class6488(var4)).isEmpty();
    }
                ...
                if (!Client.getInstance().getFriendManager().method26997(var6)) {
                    if (var6 instanceof Class880) {
                        if (((Class880) var6).method3042() != 0.0F) {
                            if (!(field23386.field1339.method3275(var6) > var1)) {
                                if (field23386.field1339.method3026((Class880) var6)) {
