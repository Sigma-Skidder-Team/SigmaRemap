...
public class Class9234 {
   public static void method34726(CommandDispatcher<CommandSource> var0) {
      var0.register(
         (LiteralArgumentBuilder)((LiteralArgumentBuilder)Class6099.method18839("list").executes(var0x -> method34727((CommandSource)var0x.getSource())))
            .then(Class6099.method18839("uuids").executes(var0x -> method34728((CommandSource)var0x.getSource())))
      );
   }
