...
public class EntitySpawnPlacementRegistry {
   ...
   static {
      ...
      register(EntityType.HOGLIN, EntitySpawnPlacementRegistry$PlacementType.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, Class1091::method5081);
      register(EntityType.PIGLIN, EntitySpawnPlacementRegistry$PlacementType.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, Class1034::method4615);
      register(EntityType.PILLAGER, EntitySpawnPlacementRegistry$PlacementType.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, Class1028::method4572);
      register(EntityType.POLAR_BEAR, EntitySpawnPlacementRegistry$PlacementType.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, Class1096::method5181);
      register(EntityType.RABBIT, EntitySpawnPlacementRegistry$PlacementType.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, Class1094::method5117);
      ...
      register(EntityType.SILVERFISH, EntitySpawnPlacementRegistry$PlacementType.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, Class1107::method5317);
      ...
      register(EntityType.SLIME, EntitySpawnPlacementRegistry$PlacementType.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, Class1108::method5328);
