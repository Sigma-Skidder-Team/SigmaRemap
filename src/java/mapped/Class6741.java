...
public class Class6741 extends Class6717 {
   public Class6741(Schema var1, boolean var2) {
      super(var1, var2, "BlockEntityJukeboxFix", Class8239.field35386, "minecraft:jukebox");
   }

   @Override
   public Typed<?> method20508(Typed<?> var1) {
      Type<?> var4 = this.getInputSchema().getChoiceType(Class8239.field35386, "minecraft:jukebox");
