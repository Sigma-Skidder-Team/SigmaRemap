...
public class Class1183 extends Class1182 {
   private final Class1189 field6383;
   ...
   public Class1183(Class1127 c, ITextComponent var1, List<Class9125> var2, String var3, Class7464 var5) {
      super(c, var2, var1);
      this.field6384 = c;
      this.field6383 = new Class1189(c.field4562.field1294, 10, 5, 42, 20, var1.deepCopy().appendString("\n").appendString(var3).appendString("\n"));
   ...
   public void method5544(Class9332 var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, boolean var9, float var10) {
      ...
      this.field6383.field6477 = var4 + var5 - 44;
      this.field6383.field6478 = var3;
      this.field6383.method1923(var1, var7, var8, var10);
   }
}
