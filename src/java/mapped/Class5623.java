...
public class Class5623 extends MessageToByteEncoder<Packet<?>> {
   ...
   private static final Marker field24934 = MarkerManager.getMarker("PACKET_SENT", Class8586.field38641);
   ...
   public void encode(ChannelHandlerContext var1, Packet<?> var2, ByteBuf var3) throws Exception {
      Class1858 var6 = var1.channel().attr(Class8586.field38642).get();
      if (var6 == null) {
         ...
         if (field24933.isDebugEnabled()) {
            field24933.debug(field24934, "OUT: [{}:{}] {}", var1.channel().attr(Class8586.field38642).get(), var7, var2.getClass().getName());
         }
