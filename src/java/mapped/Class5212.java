...
public class Class5212 extends Module {
    ...
    public Class5212() {
        ...
        this.method15972(new Class6009<Float>("Time", "Time to set the world to", 12000.0F, Float.class, 0.0F, 24000.0F, 1.0F).method18616(var1 -> {
            if (this.method15974("Custom time") && this.method15996()) {
                field23386.field1338.method6834(-((long) this.method15977("Time")));
            }
        }));
    ...
    public void method15966() {
        this.field23538 = field23386.field1338.method6792(1.0F);
        if (field23386.field1338.method6792(1.0F) != 1.0F) {
            if (field23386.field1338.method6792(1.0F) == 0.0F) {
    ...
    private void method16230(Class4428 var1) {
        if (this.method15996()) {
            ...
            field23386.field1338.method6793(this.field23538);
            field23386.field1338.method6791(this.field23538);
        }
    }
