...
public class Class2926 extends Class2898<Class4712> {
   ...
   public boolean method11213(Class1658 var1, Class5646 var2, Random var3, BlockPos var4, Class4712 var5) {
      int var8 = 0;
      int var9 = var1.method6736(Class101.field298, var4.getX(), var4.getZ());
      BlockPos var10 = new BlockPos(var4.getX(), var9, var4.getZ());
      if (var1.getBlockState(var10).method23448(Blocks.WATER)) {
         ...
         for (int var14 = 0; var14 <= var13; var14++) {
            if (var1.getBlockState(var10).method23448(Blocks.WATER)
               && var1.getBlockState(var10.method8311()).method23448(Blocks.WATER)
               ...
               if (var11.method23443(var1, var15) && !var1.getBlockState(var15.method8313()).method23448(Blocks.field36961)) {
