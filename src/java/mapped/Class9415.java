...
public class Class9415 {
   ...
   public static Class9415 method36124(JsonElement var0) {
      if (var0 != null && !var0.isJsonNull()) {
         JsonObject var3 = JSONUtils.getJSONObject(var0, "effects");
         ...
         for (Entry var6 : var3.entrySet()) {
            ...
            Class8053 var9 = Class8053.method27659(JSONUtils.getJSONObject((JsonElement)var6.getValue(), (String)var6.getKey()));
            var4.put(var8, var9);
         }
