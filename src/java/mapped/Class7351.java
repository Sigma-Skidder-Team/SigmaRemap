...
public class Class7351 implements Class7352 {
   ...
   @Override
   public Collection<Class7744> method23305(CommandContext<CommandSource> var1) throws CommandSyntaxException {
      ITag var4 = Class7566.method24774(var1, this.field31468);
      return var4.getAllElements();
   }

   @Override
   public Pair<ResourceLocation, Either<Class7744, ITag<Class7744>>> method23306(CommandContext<CommandSource> var1) throws CommandSyntaxException {
