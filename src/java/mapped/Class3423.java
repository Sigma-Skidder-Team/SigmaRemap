...
public class Class3423 extends Block implements Class3207 {
   ...
   public static final BooleanProperty field19155 = BlockStateProperties.field39710;
   ...
   public Class3423(Properties var1) {
      super(var1);
      this.method11578(this.field18612.method35393().with(field19154, Direction.NORTH).with(field19155, Boolean.valueOf(false)));
   }
   ...
   public boolean method11492(BlockState var1, IWorldReader var2, BlockPos var3) {
      ...
      return this.method12078(var2, var3.method8349(var6.getOpposite()), var6);
   }
   ...
   public BlockState method11495(Class5909 var1) {
      if (!var1.method18347()) {
         BlockState var4 = var1.method18360().getBlockState(var1.method18345().method8349(var1.method18354().getOpposite()));
         if (var4.isIn(this) && var4.<Direction>get(field19154) == var1.method18354()) {
            return null;
         }
      }
      ...
      for (Direction var11 : var1.method18349()) {
         if (var11.getAxis().method324()) {
            ...
            if (var12.method23443(var5, var6)) {
               return var12.with(field19155, Boolean.valueOf(var7.method23472() == Class9479.field44066));
            }
         }
      }
   ...
   public FluidState method11498(BlockState var1) {
      return !var1.<Boolean>get(field19155) ? super.method11498(var1) : Class9479.field44066.method25078(false);
   }
}
