...
public class Class8168 extends Class8167 {
   private static final Map<String, String> field35148 = ImmutableMap.<String, String>builder()
   ...
   public Class8168(Schema var1, boolean var2) {
      super(var1, var2, "Recipes fix", var0 -> field35148.getOrDefault(var0, var0));
   }
}
