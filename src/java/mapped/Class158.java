...
public class Class158 implements ILootCondition {
   ...
   private final Enchantment field515;
   private final float[] field516;

   public Class158(Enchantment var1, float[] var2) {
      this.field515 = var1;
      this.field516 = var2;
   }
   ...
   public boolean test(LootContext var1) {
      ...
      int var5 = var4 == null ? 0 : EnchantmentHelper.getEnchantmentLevel(this.field515, var4);
      float var6 = this.field516[Math.min(var5, this.field516.length - 1)];
      return var1.method26088().nextFloat() < var6;
   }

   public static Class7519 method476(Enchantment var0, float... var1) {
      return () -> new Class158(var0, var1);
   }

   // $VF: synthetic method
   public static Enchantment method478(Class158 var0) {
