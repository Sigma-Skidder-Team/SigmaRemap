...
public class Class4335 extends Class4333 {
   ...
   public Class4335(IconPanel var1, String var2, int var3, int var4, ModuleCategory[] var5) {
      ...
      Class4361 var14;
      this.addToList(var14 = new Class4361(this, "exit", this.getWidth() - 47, 18));
      var14.doThis((var1x, var2x) -> {
         if (this.field21181 == null) {
            ((ClassicScreenk)this.getIconPanel()).method13417();
         } else {
      ...
      if (this.field21181 == null) {
         for (IconPanel var5 : this.method13241()) {
            if (var5 instanceof Class4368 && this.field21149.calcPercent() == 1.0F && var5.method13114(this.method13309(), this.method13310())) {
               ...
               RenderUtil.drawString(ClassicDecryption.regular17, 20.0F, (float)(this.getHeight() - 26), var6.field21351.getDescription(), -14540254);
               RenderUtil.startScissor(5.0F, (float)(this.getHeight() - 27), 12.0F, 24.0F);
               RenderUtil.method11455(5.0F, (float)(this.getHeight() - 27), 24.0F, 24.0F, Class4334.field21177);
