...
public class Class5365 extends Module {
    ...
    private Class5328 field23976 = null;
    ...
    public void method15953() {
        this.field23976 = (Class5328) this.method16004();
    }

    @Override
    public void method15966() {
        this.field23972 = field23386.field1339.field4902.field5443;
        ...
        if (field23386.field1339.field5036) {
            this.field23979 = field23386.field1339.getPosY();
        }
    ...
    public void method15965() {
        if (this.field23972 != -1 && this.method16004().method15978("ItemSpoof").equals("Switch")) {
            field23386.field1339.field4902.field5443 = this.field23972;
        }
    ...
    public void method16885(Class4417 var1) {
        if (this.method15996()) {
            ...
            } else if (field23386.field1339.field5036 && Client.getInstance().getModuleManager().method14662(Class5363.class).method15996()) {
                var1.method13966(true);
            }
        }
    }
        ...
        if (this.method15996() && this.field23976.method16735() != 0) {
            if (!var1.method13921()) {
                if (this.field23970 != 999.0F) {
                    ...
                    if (this.field23971 != null) {
                        ...
                        if (var13.method31424() == Direction.field673
                                && (double) var13.method31423().getY() <= field23386.field1339.getPosY() - 1.0
                        ...
                        Class8848 var15 = field23386.field1339.method3094(Class79.field182);
                        new Class5911(field23386.field1339, Class79.field182, var13);
                        int var17 = var15.method32179();
                        field23386.field1337.method23139(field23386.field1339, field23386.field1338, this.field23975, var13);
                        this.field23971 = null;
                        if (!this.method16004().method15974("NoSwing")) {
                            field23386.field1339.method2820(this.field23975);
                        } else {
                            field23386.getClientPlayNetHandler().sendPacket(new Class5511(this.field23975));
                        }
                ...
                if (Class5328.method16733(field23386.field1339.method3094(Class79.field183).method32107())
                        && (
                        field23386.field1339.method3094(this.field23975).method32105()
                                || !Class5328.method16733(field23386.field1339.method3094(this.field23975).method32107())
                )) {
    ...
    public void method16887(Class4435 var1) {
        if (this.method15996() && this.field23976.method16735() != 0) {
            ...
            switch (var4) {
                case "Jump":
                    if (field23386.field1339.field5036 && Class5628.method17686() && !field23386.field1339.method3331() && !this.field23977) {
                        this.field23978 = false;
                    ...
                    break;
                case "AAC":
                    if (this.field23973 == 0 && field23386.field1339.field5036) {
                        Class9567.method37088(var1, Class9567.method37075() * 0.82);
                    }
                    break;
                case "Cubecraft":
                    double var6 = 0.2;
                    float var8 = this.method16894(Class9679.method37792(field23386.field1339.field5031));
                    if (field23386.field1299.field44636.method8509()) {
                        field23386.field1284.field40360 = 1.0F;
                    } else if (field23386.field1339.field5036) {
                        if (Class5628.method17686() && !field23386.field1339.method3331() && !this.field23977) {
    ...
    public void method16890(Class4422 var1) {
        if (this.method15996() && this.method15978("Speed Mode").equals("Cubecraft") && this.field23974 >= 0) {
            if (!(field23386.field1339.field5045 > 1.2F)) {
                if (!(field23386.field1339.field4915 < this.field23979)) {
                    if (!field23386.field1339.field4981) {
                        field23386.field1339.field5028.field18049 = this.field23979;
                        field23386.field1339.field5049 = this.field23979;
                        field23386.field1339.field4915 = this.field23979;
                        field23386.field1339.field5026 = this.field23979;
