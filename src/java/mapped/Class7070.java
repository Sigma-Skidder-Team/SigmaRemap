   ...
   public ItemStack method21985() {
      if (this.field30453 == null) {
         ...
         if (!Class5377.method16937()
            .<Class920, Class4849>method1030(Class7207.field30936, new Class927(new ItemStack(Items.field37236)), Class5377.method16936().world)
            .isPresent()) {
            SimpleReloadableResourceManager var3 = new SimpleReloadableResourceManager(ResourcePackType.field12611);

            for (IResourcePack var6 : Class5377.method16938().resourcePackRepository.getEnabledPacks().stream().<IResourcePack>map(ResourcePackInfo::method7950).collect(Collectors.toList())) {
               var3.method588(var6);
            }

            Class7120 var9 = new Class7120(this);
            Class5377.method16937().method777(var9, var3, EmptyProfiler.INSTANCE, EmptyProfiler.INSTANCE, Util.getServerExecutor(), Class5377.method16939());
         }
