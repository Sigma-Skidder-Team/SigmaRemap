   ...
   public void method5544(MatrixStack var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, boolean var9, float var10) {
      ...
      this.field6310
         ...
         .method38805(
            ...
            (float)(this.field6310.currentScreen.field4564 / 2 - this.field6310.field1294.method38821(Class1279.method6084()) / 2),
            (float)var13,
            16777215
         );
      String var14;
      ...
      this.field6310
         .field1294
         .method38801(
            var1, var14, (float)(this.field6310.currentScreen.field4564 / 2 - this.field6310.field1294.method38820(var14) / 2), (float)(var13 + 9), 8421504
         );
   }
}
