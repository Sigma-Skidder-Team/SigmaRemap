...
public class Class7959 {
   public static final Codec<Class7959> field34223 = RecordCodecBuilder.create(
      var0 -> var0.group(
               Class9455.field43936.fieldOf("sound").forGetter(var0x -> var0x.field34225),
   ...
   public Class7959(Class9455 var1, int var2, int var3, double var4) {
