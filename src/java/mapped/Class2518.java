...
public class Class2518 extends JComponent {
   private static final DecimalFormat field16657 = Util.make(
   ...
   private void method10562() {
      ...
      this.field16660[0] = "Memory use: "
         ...
         + "% free)";
      this.field16660[1] = "Avg tick: " + field16657.format(this.method10563(this.field16661.tickTimeArray) * 1.0E-6) + " ms";
