...
public class Class5209 extends Module {
    ...
    public void method16220(TickEvent var1) {
        if (this.method15996()) {
            ...
            if (!(mc.field1339.method3433().field18049 < 0.08) || mc.field1339.field5036) {
                mc.field1339.method3349(7, false);
    ...
    public void method16221(Class4435 var1) {
        if (this.method15996()) {
            ...
            if (!this.method15974("NCP") && mc.field1339.method3331()) {
                var4 *= 2.5;
            }

            Class9567.method37088(var1, 0.0);
            if (!mc.field1339.method3165()) {
                this.field23528 = 0;
            } else {
            ...
            if (this.field23530 > 1.0001E-4F && mc.field1339.field4981) {
                Class9567.method37088(var1, var4 * 6.3F);
                var1.method13995(this.field23530);
            }

            int var7 = GLFW.glfwGetKey(mc.field1283.method8039(), mc.field1299.field44637.field13070.field34875);
            if (var7 == 1 && this.method15974("NCP")) {
                var1.method13995(-0.9F);
            } else if (!mc.field1339.method3331()) {
                if (mc.field1339.field4981 && !this.method15974("NCP")) {
    ...
    private void method16222(Class4396 var1) {
        if (this.method15996()) {
            if (mc.field1339 != null && var1.method13898() instanceof Class5590) {
                ...
                Entity var5 = mc.field1338.method6774(var4.method17565());
                if (var5 instanceof Class888) {
                    Class888 var6 = (Class888) var5;
                    if (var6.field5125 != null && var6.field5125.method3205() == mc.field1339.method3205()) {
    ...
    private void method16223(Class4399 var1) {
        if (this.method15996()) {
            ...
            if (this.field23533 != var4 - 1) {
                if (this.field23533 <= 0 && mc.field1339.field4981) {
