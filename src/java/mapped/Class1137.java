...
public class Class1137 extends Class1135 {
   ...
   public void method1921() {
      ...
      this.<Class1235>method2455(
         new Class1235(this.mc, this.field4564 / 2 - 155 + var3 % 2 * 160, this.field4565 / 6 - 12 + 24 * (var3 >> 1), Class2266.field14728, 310)
      );
      var3 += 2;
      ...
      for (Class2266 var7 : Class2266.values()) {
         if (var7 != Class2266.field14728) {
            this.<Class1235>method2455(
               new Class1235(this.mc, this.field4564 / 2 - 155 + var3 % 2 * 160, this.field4565 / 6 - 12 + 24 * (var3 >> 1), var7, 150)
            );
            var3++;
         }
      }
      ...
      this.<Class1228>method2455(
         new Class1228(var10, var11 + 24 * (++var3 >> 1), 150, 20, AbstractOption.field25364, AbstractOption.field25364.method18081(this.field6193), var1 -> {
            AbstractOption.field25364.method18078(this.mc.gameSettings);
            var1.method5743(AbstractOption.field25364.method18081(this.mc.gameSettings));
            this.mc.gameSettings.saveOptions();
         })
      );
      this.<Class1206>method2455(
         new Class1206(this.field4564 / 2 - 100, this.field4565 / 6 + 168, 200, 20, DialogTexts.field30658, var1 -> this.mc.displayGuiScreen(this.field6192))
      );
   }
