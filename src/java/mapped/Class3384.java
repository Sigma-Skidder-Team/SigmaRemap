...
public class Class3384 extends Class3383 {
   ...
   public Class7380 method11495(Class5909 var1) {
      Class7380 var4 = Blocks.WALL_TORCH.method11495(var1);
   ...
   public void method11512(Class7380 var1, Class1655 var2, BlockPos var3, Random var4) {
      if (var1.<Boolean>method23463(field18991)) {
         ...
         double var8 = 0.27;
         double var10 = (double)var3.method8304() + 0.5 + (var4.nextDouble() - 0.5) * 0.2 + 0.27 * (double)var7.method539();
         double var12 = (double)var3.getY() + 0.7 + (var4.nextDouble() - 0.5) * 0.2 + 0.22;
         double var14 = (double)var3.method8306() + 0.5 + (var4.nextDouble() - 0.5) * 0.2 + 0.27 * (double)var7.method541();
