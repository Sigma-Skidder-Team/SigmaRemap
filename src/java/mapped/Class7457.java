...
public class Class7457 {
   ...
   private final Set<Class4520> field32072 = new ObjectArraySet();
   private final Set<Class4520> field32073 = new ObjectArraySet();
   private boolean field32074 = true;
   private final List<Class944> field32075 = Lists.newArrayList();
   private Class9045 field32076 = new Class9045();
   private Class9244 field32077;
   private BitSet[] field32078 = new BitSet[Class4520.field21819.length];

   public boolean method24109() {
      return this.field32074;
   }

   public boolean method24110(Class4520 var1) {
      return !this.field32072.contains(var1);
   }

   public List<Class944> method24111() {
   ...
   public BitSet method24112(Class4520 var1) {
      return this.field32078[var1.method14297()];
   }

   public void method24108(Class4520 var1, BitSet var2) {
      this.field32078[var1.method14297()] = var2;
   }

   public boolean method24113(Class4520 var1) {
      return this.field32073.contains(var1);
   }

   public void method24114(Class4520 var1) {
      this.field32073.add(var1);
   }

   public void method24115(Class4520 var1) {
      this.field32072.add(var1);
   }

   // $VF: synthetic method
   public static Set<Class4520> method24116(Class7457 var0) {
