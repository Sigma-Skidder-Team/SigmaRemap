      ...
      for (int var8 = 0; var8 <= var3; var8++) {
         if (var0.method7007(var2)) {
            if (var8 == var3 || !var0.method7007(var2.down())) {
               var0.setBlockState(
                  var2, Blocks.WEEPING_VINES.getDefaultState().with(Class3452.field19267, Integer.valueOf(MathHelper.method37782(var1, var4, var5))), 2
               );
               break;
            }

            var0.setBlockState(var2, Blocks.WEEPING_VINES_PLANT.getDefaultState(), 2);
         }
