...
public class Class5327 extends Class5325 {
    ...
    public double method16730(int var1) {
        ...
        if (var1 < 0 || var1 >= var4.length) {
            return field23386.field1339.method3433().field18049;
        } else {
            return Class5628.method17686() && !field23386.field1339.field5037 ? var4[var1] : var5[var1];
        }
    }
    ...
    public double method16731(int var1) {
        ...
        var1--;
        return var1 >= 0 && var1 < var4.length ? var4[var1] : field23386.field1339.method3433().field18049;
    }
}
