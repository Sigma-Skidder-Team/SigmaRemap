...
public class Class3456 extends Class3194 {
   ...
   public Class3456(Properties var1) {
      super(var1);
      this.method11578(this.field18612.method35393().with(field19276, DoubleBlockHalf.field210));
   }
   ...
   public void method11563(World var1, BlockPos var2, BlockState var3, LivingEntity var4, ItemStack var5) {
      var1.setBlockState(var2.up(), this.method11579().with(field19276, DoubleBlockHalf.field209), 3);
   }
   ...
   public void method12129(Class1660 var1, BlockPos var2, int var3) {
      var1.setBlockState(var2, this.method11579().with(field19276, DoubleBlockHalf.field210), var3);
      var1.setBlockState(var2.up(), this.method11579().with(field19276, DoubleBlockHalf.field209), var3);
   }
