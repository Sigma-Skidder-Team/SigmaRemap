...
public class Class4370 extends Class4247 {
   ...
   public void draw(float var1) {
      RenderUtil.method11424((float)(this.x + this.width), (float)(this.y + 1), 1.0F, (float)(this.height - 2), -8882056);
      RenderUtil.method11424((float)(this.x + 1), (float)this.y, (float)(this.width - 1), (float)this.height, -8882056);
      RenderUtil.method11424((float)this.x, (float)(this.y + 1), 1.0F, (float)(this.height - 2), -6250336);
