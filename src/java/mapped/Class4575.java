...
public class Class4575 extends Class4566 {
   private static String[] field22017;

   public Class4575(ClientWorld var1, double var2, double var4, double var6, double var8, double var10, double var12) {
   ...
   public void method14500() {
      ...
      if (this.field22056-- > 0) {
         ...
         if (!this.field22037.getFluidState(new BlockPos(this.field22041, this.field22042, this.field22043)).method23486(FluidTags.field40469)) {
            this.method14518();
         }
      } else {
         this.method14518();
