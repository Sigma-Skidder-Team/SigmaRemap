...
public class Class3739 extends Class3676<Class1046> {
   ...
   private void method12681(ServerWorld var1, Class1046 var2, LivingEntity var3) {
   ...
   private Optional<LivingEntity> method12683(Class1046 var1) {
      return this.method12686(var1).stream().findAny();
   }

   private Optional<LivingEntity> method12684(Class1046 var1) {
   ...
   private Map<LivingEntity, Integer> method12685(Class1046 var1) {
