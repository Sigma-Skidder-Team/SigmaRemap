...
public class Class3739 extends Class3676<CreatureEntity> {
   ...
   private void method12681(ServerWorld var1, CreatureEntity var2, LivingEntity var3) {
      for (int var6 = 0; var6 < 10; var6++) {
         ...
         if (var7 != null && var1.method6952(new BlockPos(var7))) {
            var2.getBrain().method21406(MemoryModuleType.field39824, new Class8999(var7, 0.6F, 0));
            return;
         }
      }
   }
   ...
   private static void method12682(CreatureEntity var0, LivingEntity var1) {
      ...
      var4.method21406(MemoryModuleType.field39828, var1);
      var4.method21406(MemoryModuleType.field39825, new Class7865(var1, true));
      var4.method21406(MemoryModuleType.field39824, new Class8999(new Class7865(var1, false), 0.6F, 1));
   }
   ...
   private List<LivingEntity> method12686(CreatureEntity var1) {
      return var1.getBrain().<List<LivingEntity>>getMemory(MemoryModuleType.field39820).get();
   }

   private LivingEntity method12687(LivingEntity var1) {
      return var1.getBrain().<LivingEntity>getMemory(MemoryModuleType.field39828).get();
   }

   @Nullable
   private LivingEntity method12688(LivingEntity var1) {
      return var1.getBrain()
         .<List<LivingEntity>>getMemory(MemoryModuleType.field39820)
         .get()
         .stream()
   ...
   private boolean method12689(LivingEntity var1) {
      return var1.getBrain().<LivingEntity>getMemory(MemoryModuleType.field39828).isPresent();
   }

   private boolean method12690(LivingEntity var1, LivingEntity var2) {
      return var2.getBrain().<LivingEntity>getMemory(MemoryModuleType.field39828).filter(var1x -> var1x == var1).isPresent();
   }

   private boolean method12691(CreatureEntity var1) {
      return var1.getBrain().method21404(MemoryModuleType.field39820);
   }
}
