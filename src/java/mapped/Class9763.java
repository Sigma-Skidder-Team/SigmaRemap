...
public class Class9763 {
   ...
   public static final ImmutableMap<Structure<?>, Class8483> field45674 = ImmutableMap.<Structure<?>, Class8483>builder()
      ...
      .put(Structure.DESERT_PYRAMID, new Class8483(32, 8, 14357617))
      .put(Structure.IGLOO, new Class8483(32, 8, 14357618))
      .put(Structure.JUNGLE_PYRAMID, new Class8483(32, 8, 14357619))
      .put(Structure.SWAMP_HUT, new Class8483(32, 8, 14357620))
      .put(Structure.PILLAGER_OUTPOST, new Class8483(32, 8, 165745296))
      .put(Structure.STRONGHOLD, new Class8483(1, 0, 0))
      .put(Structure.MONUMENT, new Class8483(32, 5, 10387313))
      .put(Structure.field18071, new Class8483(20, 11, 10387313))
      .put(Structure.MANSION, new Class8483(80, 20, 10387319))
      .put(Structure.field18072, new Class8483(1, 0, 0))
      .put(Structure.MINESHAFT, new Class8483(1, 0, 0))
      .put(Structure.RUINED_PORTAL, new Class8483(40, 15, 34222645))
      .put(Structure.SHIPWRECK, new Class8483(24, 4, 165745295))
