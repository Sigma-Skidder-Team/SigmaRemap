...
public class Class9707 {
   ...
   public static void method38035(CommandDispatcher<Class6619> var0) {
      var0.register(
         (LiteralArgumentBuilder)((LiteralArgumentBuilder)Class6099.method18839("deop").requires(var0x -> var0x.method20129(3)))
            .then(
               Class6099.method18840("targets", Class7713.method25483())
                  .suggests((var0x, var1) -> Class6618.method20149(((Class6619)var0x.getSource()).method20177().getPlayerList().method19471(), var1))
                  .executes(var0x -> method38036((Class6619)var0x.getSource(), Class7713.method25482(var0x, "targets")))
            )
      );
   }

   private static int method38036(Class6619 var0, Collection<GameProfile> var1) throws CommandSyntaxException {
