...
public class WitherSkullEntity extends Class901 {
   ...
   public WitherSkullEntity(World var1, LivingEntity var2, double var3, double var5, double var7) {
      super(EntityType.WITHER_SKULL, var2, var3, var5, var7, var1);
   }

   public WitherSkullEntity(World var1, double var2, double var4, double var6, double var8, double var10, double var12) {
   ...
   public void method3464(RayTraceResult var1) {
      ...
      if (!this.world.isRemote) {
         Class2141 var4 = !this.world.getGameRules().getBoolean(GameRules.field24224) ? Class2141.field14014 : Class2141.field14016;
