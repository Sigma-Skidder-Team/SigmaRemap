   ...
   public boolean method12896(ISeedReader var1, Class7480 var2, ChunkGenerator var3, Random var4, Class9764 var5, ChunkPos var6, BlockPos var7) {
      ...
      switch (this.field20512) {
         case 0:
            ...
            this.method12923(var1, Blocks.WALL_TORCH.method11579().with(Class3382.field18985, Direction.WEST), 4, 3, 5, var5);
            this.method12923(var1, Blocks.WALL_TORCH.method11579().with(Class3382.field18985, Direction.EAST), 6, 3, 5, var5);
            this.method12923(var1, Blocks.WALL_TORCH.method11579().with(Class3382.field18985, Direction.SOUTH), 5, 3, 4, var5);
            this.method12923(var1, Blocks.WALL_TORCH.method11579().with(Class3382.field18985, Direction.NORTH), 5, 3, 6, var5);
         ...
         case 2:
            ...
            BlockState var14 = Blocks.LADDER.method11579().with(Class3423.field19154, Direction.WEST);
