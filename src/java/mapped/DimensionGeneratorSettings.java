...
public class DimensionGeneratorSettings {
   ...
   public DimensionGeneratorSettings(long var1, boolean var3, boolean var4, Class2350<Class9459> var5) {
   ...
   private DimensionGeneratorSettings(long var1, boolean var3, boolean var4, Class2350<Class9459> var5, Optional<String> var6) {
   ...
   public static DimensionGeneratorSettings method26256(DynamicRegistries var0) {
      ...
      return new DimensionGeneratorSettings((long)var4, true, true, method26262(var5, Class9535.method36871(var5, var3, var6, (long)var4), method26258(var3, var6, (long)var4)));
   }

   public static DimensionGeneratorSettings method26257(Registry<Class9535> var0, Registry<Biome> var1, Registry<Class9309> var2) {
      long var5 = new Random().nextLong();
      return new DimensionGeneratorSettings(var5, true, false, method26262(var0, Class9535.method36871(var0, var1, var2, var5), method26258(var1, var2, var5)));
   }
