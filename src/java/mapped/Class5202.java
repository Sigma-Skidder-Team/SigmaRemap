...
public class Class5202 extends Module {
    ...
    public void method16197(Class4399 var1) {
        if (this.method15996() && field23386.field1339 != null && var1.method13921() && field23386.method1528() != null) {
            this.field23517++;
            double var4 = -4.503599627370497E15;
            String var6 = this.method15978("Mode");
            switch (var6) {
                case "Basic1":
                    var4 = field23386.field1339.getPosY() - 20.0;
                    break;
                case "Basic2":
                    var4 = field23386.field1339.getPosY() - 1000.0 + Math.random() * 1000.0;
                    break;
                case "MinInfinity":
            ...
            if ((float) this.field23517 >= this.method15977("Delay")) {
                ...
                if (this.method15974("More Packets")) {
                    field23386.getClientPlayNetHandler().sendPacket(new Class5605(field23386.field1339.getPosX(), var4, field23386.field1339.getPosX(), var8));
                } else {
