...
public class Class7368 extends Class7361 {
   ...
   public Class7368(EnderDragonEntity var1) {
      super(var1);
   }
   ...
   public void method23360() {
      if (!this.field31535 && this.field31536 != null) {
         BlockPos var3 = this.field31519.world.getHeight(Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, Class2909.field17994);
         if (!var3.withinDistance(this.field31519.getPositionVec(), 10.0)) {
