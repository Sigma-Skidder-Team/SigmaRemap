...
public abstract class Class7261 extends Class7257
{
        ...
        if (class1847.method6701(method1137).method21706()) {
            if (!class1847.method6701(method1137).method21722(class1847, method1137)) {
                if (random.nextInt(100) == 0) {
                    final double n = class1848.method1074() + random.nextFloat();
                    final double n2 = class1848.method1075() + 1;
                    final double n3 = class1848.method1076() + random.nextFloat();
                ...
                if (random.nextInt(200) == 0) {
                    class1847.method6708(class1848.method1074(), class1848.method1075(), class1848.method1076(), Class8520.field35338, Class286.field1582, 0.2f + random.nextFloat() * 0.2f, 0.9f + random.nextFloat() * 0.15f, false);
                }
            }
        }
    }
    ...
    public void method22152(final Class1847 class1847, final Class354 class1848, final Class7099 class1849, final Random random) {
        if (class1847.method6765().method31216(Class8878.field37315)) {
            ...
            if (nextInt <= 0) {
                for (int i = 0; i < 3; ++i) {
                    final Class354 method1134 = class1848.method1134(random.nextInt(3) - 1, 0, random.nextInt(3) - 1);
    ...
    private boolean method22201(final Class1852 class1852, final Class354 class1853) {
    ...
    private boolean method22202(final Class1852 class1852, final Class354 class1853) {
    ...
    private void method22203(final Class1851 class1851, final Class354 class1852) {
    ...
    public void method22179(final Class1851 class1851, final Class354 class1852, final Class7096 class1853, final Class179 class1854, final Class7099 class1855) {
        if (class1854 == Class179.field511) {
