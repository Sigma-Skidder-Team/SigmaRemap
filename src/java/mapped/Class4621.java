...
public class Class4621 extends Class4566 {
   ...
   public Class4621(ClientWorld var1, double var2, double var4, double var6, double var8, double var10, double var12, Class7437 var14, Class8975 var15) {
      ...
      this.field22058 = ((float)(Math.random() * 0.2F) + 0.8F) * var14.method24012() * var18;
      this.field22059 = ((float)(Math.random() * 0.2F) + 0.8F) * var14.method24013() * var18;
      this.field22060 = ((float)(Math.random() * 0.2F) + 0.8F) * var14.method24014() * var18;
      this.field22035 = this.field22035 * 0.75F * var14.method24015();
      int var19 = (int)(8.0 / (Math.random() * 0.8 + 0.2));
      this.field22056 = (int)Math.max((float)var19 * var14.method24015(), 1.0F);
