...
public class Class2011 extends Class2009 {
      ...
      if (!this.field13076.get()) {
         if (this.field13078.method27709()) {
            if (!this.field13076.get()) {
               ...
               Set<Class944> var9 = this.method8532(var5, var6, var7, var8, var1);
               ...
               if (!this.field13076.get()) {
                  ...
                  return Util.gather(var10).handle((var2, var3) -> {
                     if (var3 != null && !(var3 instanceof CancellationException) && !(var3 instanceof InterruptedException)) {
                        Minecraft.getInstance().method1467(Class4526.method14413(var3, "Rendering chunk"));
                     }
   ...
   private Set<Class944> method8532(float var1, float var2, float var3, Class7457 var4, Class7828 var5) {
      boolean var8 = true;
      ...
      if (!Class8066.method27755(this.field13078, var9)) {
         ...
         var14.method7024();
         Class4520[] var15 = new Class4520[1];
         Class7551.method24692();
         Random var16 = new Random();
         Class217 var17 = Minecraft.getInstance().method1553();
         ...
         for (BlockPos var19 : Class2001.method8359(var9, var10)) {
            ...
            if (!var20.method23393()) {
               ...
               if (Class9561.method37045(var20)) {
                  Class944 var22 = var14.method7029(var19, Class2206.field14423);
                  if (var22 != null) {
                     this.method8533(var4, var12, var22);
                  }
               }

               Class7379 var37 = var20.method23449();
               Class7180 var23 = !Class9016.method33345() ? null : this.method8529(var19);
               if (!var37.method23474()) {
                  Class4520[] var24 = Class8066.method27757(this.field13078, var37, var15);

                  for (int var25 = 0; var25 < var24.length; var25++) {
                     Class4520 var26 = var24[var25];
                     if (!Class9016.method33348() || Class9299.method35056(Class9299.field42941, var37, var26)) {
                        ...
                        Class5425 var27 = var5.method26203(var26);
               ...
               if (var20.method23397() != Class1855.field9885) {
                  Class4520[] var38 = Class8066.method27759(this.field13078, var20, var15);

                  for (int var39 = 0; var39 < var38.length; var39++) {
                     Class4520 var40 = var38[var39];
                     if (!Class9016.method33349() || Class9299.method35056(Class9299.field42940, var20, var40)) {
                        ...
                        Class5425 var42 = var5.method26203(var40);
                        ...
                        var13.method35294();
                        var13.method35291(
                           (double)Class8066.method27761(this.field13078) + (double)(var19.method8304() & 15),
                           (double)Class8066.method27762(this.field13078) + (double)(var19.getY() & 15),
                           (double)Class8066.method27763(this.field13078) + (double)(var19.method8306() & 15)
                        );
         ...
         if (Class7457.method24118(var4).contains(Class4520.method14304())) {
            Class5425 var29 = var5.method26203(Class4520.method14304());
            var29.method17058(
               (float)Class8066.method27761(this.field13078) + var1 - (float)var9.method8304(),
               (float)Class8066.method27762(this.field13078) + var2 - (float)var9.getY(),
               (float)Class8066.method27763(this.field13078) + var3 - (float)var9.method8306()
            );
            Class7457.method24119(var4, var29.method17060());
         }

         Class7457.method24116(var4).stream().map(var5::method26203).forEach(Class5425::method17065);

         for (Class4520 var36 : Class9016.field41242) {
            var4.method24108(var36, (BitSet)null);
         }

         for (Class4520 var33 : Class7457.method24116(var4)) {
            if (Class7944.method26921()) {
               Class7698.method25386(var5.method26203(var33));
            }

            Class5425 var35 = var5.method26203(var33);
   ...
   private <E extends Class944> void method8533(Class7457 var1, Set<Class944> var2, E var3) {
      Class5942 var6 = Class8086.field34743.<Class944>method27960(var3);
      if (var6 != null) {
