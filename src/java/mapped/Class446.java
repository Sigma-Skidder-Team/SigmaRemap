...
public interface Class446 extends Class447
{
    ...
    Class8321 method2157(final int p0);
    
    Class8321 method2158(final int p0, final int p1);
    
    Class8321 method2159(final int p0);
    
    void method2160(final int p0, final Class8321 p1);
    ...
    default boolean method2264(final int n, final Class8321 class8321) {
        return true;
    }
