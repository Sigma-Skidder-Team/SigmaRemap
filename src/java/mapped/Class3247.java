...
public abstract class Class3247 extends Class3198 {
   public static final Class6408 field18707 = Class3209.method11539(0.0, 0.0, 0.0, 16.0, 2.0, 16.0);
   ...
   public void method11506(Class7380 var1, Class1655 var2, BlockPos var3, Class3209 var4, BlockPos var5, boolean var6) {
      if (!var1.method23443(var2, var3)) {
         Class944 var9 = !this.method11998() ? null : var2.method6759(var3);
   ...
   public int method11662(Class1655 var1, BlockPos var2, Class7380 var3) {
      ...
      if (var8 < 15) {
         ...
         return Math.max(var8, !var9.method23448(Class8487.field36535) ? 0 : var9.<Integer>method23463(Class3222.field18651));
      } else {
         return var8;
      }
   }

   public int method11668(Class1662 var1, BlockPos var2, Class7380 var3) {
      Direction var6 = var3.<Direction>method23463(field18484);
   ...
   public int method11669(Class1662 var1, BlockPos var2, Direction var3) {
      ...
      if (!this.method11671(var6)) {
         return 0;
      } else if (!var6.method23448(Class8487.field36721)) {
         return !var6.method23448(Class8487.field36535) ? var1.method7010(var2, var3) : var6.<Integer>method23463(Class3222.field18651);
      } else {
         return 15;
      }
   }
   ...
   public void method11670(Class1655 var1, BlockPos var2, Class7380 var3) {
      Direction var6 = var3.<Direction>method23463(field18484);
   ...
   public static boolean method11672(Class7380 var0) {
      return var0.method23383() instanceof Class3247;
   }

   public boolean method11673(Class1665 var1, BlockPos var2, Class7380 var3) {
      Direction var6 = var3.<Direction>method23463(field18484).method536();
      Class7380 var7 = var1.method6738(var2.method8349(var6));
      return method11672(var7) && var7.<Direction>method23463(field18484) != var6;
   }

   public abstract int method11658(Class7380 var1);
}
