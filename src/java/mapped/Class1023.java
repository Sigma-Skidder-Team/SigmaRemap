...
public interface Class1023 extends Class1022 {
   ...
   default void method4539(LivingEntity var1, LivingEntity var2, ProjectileEntity var3, float var4, float var5) {
      ...
      double var14 = var2.getPosYHeight(0.3333333333333333) - var3.getPosY() + var12 * 0.2F;
      ...
      var1.playSound(SoundEvents.field26494, 1.0F, 1.0F / (var1.getRNG().nextFloat() * 0.4F + 0.8F));
   }
