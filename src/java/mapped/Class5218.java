...
public class Class5218 extends Module {
    ...
    public void method16247(Class4430 var1) {
        if (this.method15996()) {
            int var4 = field23386.field1299.field44655.length;

            for (int var5 = 0; var5 < var4; var5++) {
                Class2007 var6 = field23386.field1299.field44655[var5];
                String var7 = var6.method8513();
                int var8 = Integer.parseInt(String.valueOf(var7.charAt(var7.length() - 1)));
                if (var1.method13977() == var6.field13070.field34875 && var8 - 1 != field23386.field1339.field4902.field5443) {
                    this.field23549 = -1;
                    this.field23551 = 0;
                }
            }
    ...
    public void method16248(Class4428 var1) {
        if (this.method15996()) {
            ...
            int var4 = -1;
            if (field23386.field1339.method3042() <= this.method16004().method15977("Health") * 2.0F) {
            ...
            if (var4 >= 0 || this.field23549 != -1) {
                if (this.field23549 >= 0) {
                    ...
                    if (this.field23549 != 1) {
                        if (this.field23549 > 1
                                && field23386.field1339.method3094(Class79.field182).method32107() != Class8514.field37872
                                && field23386.field1339.method3094(Class79.field182).method32107() != Class8514.field37873) {
                            field23386.field1339.field4902.field5443 = this.field23550;
                            this.field23550 = -1;
                            this.field23549 = -1;
                        }
                    } else {
                        this.field23550 = field23386.field1339.field4902.field5443;
                        field23386.field1339.field4902.field5443 = var4;
                        field23386.field1337.method23138();
                        field23386.field1337.method23140(field23386.field1339, field23386.field1338, Class79.field182);
                    }
                }
            }
        }
    ...
    public void method16249(Class4396 var1) {
        if (this.method15996() && this.field23549 > 1) {
            ...
            if (var4 instanceof Class5553) {
                ...
                if (var5.method17470() == field23386.field1339.method3205()) {
