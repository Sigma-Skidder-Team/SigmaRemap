   ...
   public void run(String var1, Class8623[] var2, Class6669 var3) throws CommandException {
      if (var2.length == 0) {
         ...
         switch (var7) {
            case "add":
               if (var2.length != 2) {
                  var3.method20327("Usage : .friend add <name>");
               } else {
                  Pattern var14 = Pattern.compile("[a-zA-Z0-9_]{2,16}");
                  boolean var15 = var14.matcher(var2[1].method30899()).matches();
                  if (var15) {
                     boolean var16 = Client.getInstance().getFriendManager().method27001(var2[1].method30899());
                     if (!var16) {
                        var3.method20327("\"" + var2[1].method30899() + "\" is already your friend.");
                     } else {
                        var3.method20327("\"" + var2[1].method30899() + "\" is now your friend.");
                     }
                  } else {
            ...
            case "remove":
               if (var2.length != 2) {
                  var3.method20327("Usage : .friend remove <name>");
               } else {
                  boolean var13 = Client.getInstance().getFriendManager().method27005(var2[1].method30899());
                  if (!var13) {
                     var3.method20327("\"" + var2[1].method30899() + "\" is not your friend :(.");
                  } else {
                     var3.method20327("\"" + var2[1].method30899() + "\" is no longer your friend.");
                  }
               }
               break;
            case "list":
               ...
               if (var9.isEmpty()) {
                  var3.method20327("You have no friends :(");
               } else {
                  var3.method20327("Friends : (" + var9.size() + ")");
                  String var10 = "";
            ...
            case "clear":
               if (Client.getInstance().getFriendManager().method27007()) {
                  var3.method20327("Cleared all your friends.");
               } else {
                  var3.method20327("You have no friends :(.");
               }
               break;
