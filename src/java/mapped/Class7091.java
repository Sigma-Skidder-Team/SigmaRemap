...
public class Class7091 extends Class7092 {
   ...
   private final Map<Block, Block> field30520 = Util.<Map<Block, Block>>make(Maps.newHashMap(), var0 -> {
      ...
      var0.put(Blocks.MOSSY_COBBLESTONE_STAIRS, Blocks.field37131);
      var0.put(Blocks.STONE_STAIRS, Blocks.field37142);
      var0.put(Blocks.STONE_BRICK_STAIRS, Blocks.field37139);
      var0.put(Blocks.MOSSY_STONE_BRICK_STAIRS, Blocks.field37139);
      var0.put(Blocks.COBBLESTONE_SLAB, Blocks.field37133);
      var0.put(Blocks.MOSSY_COBBLESTONE_SLAB, Blocks.field37133);
      var0.put(Blocks.SMOOTH_STONE_SLAB, Blocks.field37143);
      var0.put(Blocks.STONE_SLAB, Blocks.field37143);
      var0.put(Blocks.STONE_BRICK_SLAB, Blocks.field37138);
      var0.put(Blocks.MOSSY_STONE_BRICK_SLAB, Blocks.field37138);
      var0.put(Blocks.STONE_BRICK_WALL, Blocks.field37140);
      var0.put(Blocks.MOSSY_STONE_BRICK_WALL, Blocks.field37140);
