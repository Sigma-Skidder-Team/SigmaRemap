...
public class JelloClickGUI extends Screen {
   ...
   public JelloClickGUI() {
      ...
      for (Module module : Client.getInstance().getModuleManager().getModuleMap().values()) {
         if (!this.categoryPanel.containsKey(module.getAdjustedCategoryBasedOnClientMode())) {
            ...
            clickGUIPanels.method13507(var2 -> var5.method13222(() -> {
                  var5.addToList(this.field20949 = new ModuleSettingUI(var5, "settings", 0, 0, this.width, this.height, var2));
      ...
      Class4235 var9;
      this.addToList(var9 = new Class4235(this, "more", this.getWidth() - 69, this.getHeight() - 55, 55, 41, ResourcesDecrypter.optionsPNG1));
      ...
      var9.doThis((var1, var2) -> this.method13222(() -> {
            if (this.configButton != null && this.method13239(this.configButton)) {
               ...
               this.addToList(this.configButton = new ConfigButtonOnClickGui(this, "morepopover", this.getWidth() - 14, this.getHeight() - 14));
   ...
   public void method13028(int var1, int var2) {
      this.musicPlayer.method13288(this.musicPlayer.getWidth() < this.getWidth() && this.musicPlayer.getHeight() < this.getHeight());
   ...
   public void draw(float var1) {
      ...
      if (Client.getInstance().getModuleManager().method14667().method20770() != null) {
         ...
         RenderUtil.drawString(
            ...
            (float)(this.width - ResourceRegistry.JelloLightFont20.method23942(var12) - 80),
      ...
      for (IconPanel var9 : this.method13241()) {
         float var10 = (float)(var9.getY() + var9.getHeight() / 2 - mc.mainWindow.getHeight() / 2) * (1.0F - var4) * 0.5F;
         float var11 = (float)(var9.getX() + var9.getWidth() / 2 - mc.mainWindow.getWidth() / 2) * (1.0F - var4) * 0.5F;
