...
public class Class9614 {
   ...
   private static final Map<EntityType<? extends LivingEntity>, Class9767> field44943 = ImmutableMap.<EntityType<? extends LivingEntity>, Class9767>builder()
      ...
      .put(EntityType.field41021, ZombieEntity.method4653().method21850())
      ...
      .put(EntityType.field41039, ZombieEntity.method4653().method21850())
      ...
      .put(EntityType.field41100, MobEntity.method4220().method21850())
      ...
      .put(EntityType.field41107, ZombieEntity.method4653().method21850())
      .put(EntityType.field41108, Class1075.method4998().method21850())
      .put(EntityType.field41109, ZombieEntity.method4653().method21850())
      .put(EntityType.field41110, ZombifiedPiglinEntity.func_234352_eU_().method21850())
      .build();
