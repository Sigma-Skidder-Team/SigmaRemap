...
public class Class4241 extends ButtonPanel {
   public static final ColorHelper field20587 = new ColorHelper(ClientColors.LIGHT_GREYISH_BLUE.color, MultiUtilities.method17691(ClientColors.LIGHT_GREYISH_BLUE.color, 0.1F));
   ...
   public void draw(float var1) {
      ...
      RenderUtil.drawString(
         this.getFont(), (float)this.getXA(), (float)this.getYA(), "" + this.field20589.calcPercent(), ClientColors.DEEP_TEAL.color
      );
      GL11.glPushMatrix();
