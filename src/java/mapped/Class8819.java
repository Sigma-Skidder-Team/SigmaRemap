...
public class Class8819 {
   ...
   public static byte[] method31848(String var0) throws IOException {
      ...
      try {
         ...
         var3 = (HttpURLConnection)var4.openConnection(Minecraft.getInstance().method1535());
   ...
   public static String method31849(String var0, Map<String, String> var1, byte[] var2) throws IOException {
      ...
      try {
         ...
         var5 = (HttpURLConnection)var6.openConnection(Minecraft.getInstance().method1535());
   ...
   public static synchronized String method31850() {
      if (field39679 == null) {
         try {
            ...
            if (var2) {
               File var3 = Minecraft.getInstance().field1303;
