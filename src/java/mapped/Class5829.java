...
public class Class5829 extends Class5828<Class926> {
   ...
   public static void method18228(int var0, Class1655 var1, PlayerEntity var2, Class926 var3, Class921 var4) {
      if (!var1.field9020) {
         ...
         var7.field4855.method15671(new Class5501(var0, 0, var8));
      }
   }
   ...
   public boolean method18103(PlayerEntity var1) {
      return method18121(this.field25537, var1, Class8487.field36538);
   }
   ...
   public Class8848 method18112(PlayerEntity var1, int var2) {
      ...
      if (var6 != null && var6.method18266()) {
         ...
         Class8848 var8 = var6.method18264(var1, var7);
         if (var2 == 0) {
