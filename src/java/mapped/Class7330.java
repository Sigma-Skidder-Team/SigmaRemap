...
public class Class7330 implements Class7329 {
   ...
   public Vector3d method23228(Class6619 var1) {
      ...
      float var6 = MathHelper.method37764((var4.field37221 + 90.0F) * (float) (Math.PI / 180.0));
      float var7 = MathHelper.method37763((var4.field37221 + 90.0F) * (float) (Math.PI / 180.0));
      float var8 = MathHelper.method37764(-var4.field37220 * (float) (Math.PI / 180.0));
      float var9 = MathHelper.method37763(-var4.field37220 * (float) (Math.PI / 180.0));
      float var10 = MathHelper.method37764((-var4.field37220 + 90.0F) * (float) (Math.PI / 180.0));
      float var11 = MathHelper.method37763((-var4.field37220 + 90.0F) * (float) (Math.PI / 180.0));
