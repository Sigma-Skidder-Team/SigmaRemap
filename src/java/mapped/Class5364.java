...
public class Class5364 extends Module {
    ...
    public void method16883(Class4411 var1) {
        if (this.method15996()) {
            var1.method13959(var1.method13958().replaceAll(field23386.method1533().method21526(), this.method15978("Username")));
        }
    }
        ...
        if (this.method15996()) {
            ...
            if (var4 instanceof Class5556) {
                ...
                if (var5.method17476() == Class2073.field13503) {
                    ...
                    if (var6.contains(field23386.method1533().method21526())) {
                        var6 = var6.replaceAll(field23386.method1533().method21526(), this.method15978("Username"));
            ...
            if (var4 instanceof Class5503) {
                ...
                for (int var7 = 0; var7 < var15.size(); var7++) {
                    ...
                    if (var8.method31729() != null) {
                        ...
                        if (var9.contains(field23386.method1533().method21526())) {
                            var9 = var9.replaceAll(field23386.method1533().method21526(), this.method15978("Username"));
            ...
            if (var4 instanceof Class5472) {
                ...
                if (var16.contains(field23386.method1533().method21526())) {
                    var16 = var16.replaceAll(field23386.method1533().method21526(), this.method15978("Username"));
            ...
            if (var4 instanceof Class5591) {
                ...
                if (var18.contains(field23386.method1533().method21526())) {
                    var18 = var18.replaceAll(field23386.method1533().method21526(), this.method15978("Username"));
