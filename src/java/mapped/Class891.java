...
public class Class891 extends Class890 {
   ...
   public Class891(Class8992<? extends Class891> var1, World var2) {
      super(var1, var2);
   }

   public Class891(World var1, Class880 var2) {
      super(Class8992.field41091, var2, var1);
   }

   public Class891(World var1, double var2, double var4, double var6) {
   ...
   public void method3464(Class8710 var1) {
      ...
      if (!this.field5024.field9020) {
         ...
         while (var4 > 0) {
            ...
            var4 -= var5;
            this.field5024.method6916(new ExperienceOrbEntity(this.field5024, this.getPosX(), this.getPosY(), this.getPosZ(), var5));
         }
