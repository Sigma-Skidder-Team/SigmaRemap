...
public class CommandBlockMinecartEntity extends AbstractMinecartEntity {
   private static final DataParameter<String> field5232 = EntityDataManager.<String>createKey(CommandBlockMinecartEntity.class, DataSerializers.field33393);
   private static final DataParameter<ITextComponent> field5233 = EntityDataManager.<ITextComponent>createKey(CommandBlockMinecartEntity.class, DataSerializers.field33394);
   private final CommandBlockLogic field5234 = new Class912(this);
   private int field5235;

   public CommandBlockMinecartEntity(EntityType<? extends CommandBlockMinecartEntity> var1, World var2) {
      super(var1, var2);
   }

   public CommandBlockMinecartEntity(World var1, double var2, double var4, double var6) {
