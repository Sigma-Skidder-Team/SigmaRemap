   ...
   public void method20810() {
      if (this.field29714 == Class2335.field15967) {
         ...
         if (!(var4 < this.field29727.getBoundingBox().getAverageEdgeLength())) {
            this.field29727.method3434(this.field29727.getVec().method11338(var3.method11344(this.field29711 * 0.05 / var4)));
            if (this.field29727.method4232() != null) {
               ...
               Vector3d var10 = this.field29727.getVec();
            ...
            this.field29727.method3434(this.field29727.getVec().method11344(0.5));
         }
      }
   }
}
