...
public class Class6201 implements Class6196 {
   ...
   public void method19097() {
      this.field27677++;
      if (this.field27675.method37036() == GameType.field11102) {
         if (this.field27677 == 1) {
            ClientPlayerEntity var3 = this.field27675.method37035().player;
            if (var3 != null) {
               if (var3.inventory.method4059(ItemTags.PLANKS)) {
                  this.field27675.method37034(Class2200.field14381);
                  return;
               }

               if (method19106(var3, ItemTags.PLANKS)) {
                  this.field27675.method37034(Class2200.field14381);
                  return;
               }
            }
   ...
   public void method19104(ItemStack var1) {
      ...
      if (ItemTags.PLANKS.contains(var4)) {
         this.field27675.method37034(Class2200.field14381);
      }
   }

   public static boolean method19106(ClientPlayerEntity var0, ITag<Item> var1) {
      for (Item var5 : var1.getAllElements()) {
         if (var0.method5396().method28961(Stats.field40097.method172(var5)) > 0) {
            return true;
         }
      }
