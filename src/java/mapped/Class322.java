...
public class Class322<T> implements Class321<T>, AutoCloseable, Runnable {
   ...
   public static Class322<Runnable> method1650(Executor var0, String var1) {
      return new Class322<Runnable>(new Class7382<Runnable>(new ConcurrentLinkedQueue<Runnable>()), var0, var1);
   }

   public Class322(Class7383<? super T, ? extends Runnable> var1, Executor var2, String var3) {
      this.field1387 = var2;
      this.field1386 = var1;
      this.field1388 = var3;
   }
