...
public class Class3706 extends Class3676<Class1042> {
   ...
   public boolean method12508(Class1657 var1, Class1042 var2) {
      if (var1.method6783() - this.field19770 >= 300L) {
         if (var1.field9016.nextInt(2) != 0) {
            ...
            return var5.method35578() == var1.method6813() && var5.method35579().method8317(var2.method3431(), 1.73);
         }
      } else {
         return false;
      }
   ...
   public boolean method12499(Class1657 var1, Class1042 var2, long var3) {
      ...
      if (!var7.isPresent()) {
         ...
         return var8.method35578() == var1.method6813() && var8.method35579().method8317(var2.method3431(), 1.73);
      }
   }
}
