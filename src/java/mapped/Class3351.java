...
public class Class3351 extends Class3350 {
   private static String[] field18877;

   public Class3351(AbstractBlock var1) {
      super(var1);
   }
   ...
   public void method11918(World var1, BlockPos var2, PlayerEntity var3) {
      ...
      if (var6 instanceof Class987) {
         ...
         var3.method2911(Class8876.field40165);
      }
   }
   ...
   public void method11512(BlockState var1, World var2, BlockPos var3, Random var4) {
      if (var1.<Boolean>method23463(field18876)) {
         ...
         if (var4.nextDouble() < 0.1) {
            var2.method6745(var7, var9, var11, Class6067.field26416, Class2266.field14732, 1.0F, 1.0F, false);
         }
