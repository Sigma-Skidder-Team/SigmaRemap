...
public class CustomResourceLoadProgressGui extends LoadingGui {
   ...
   public CustomResourceLoadProgressGui(Minecraft var1, Class8335 var2, Consumer<Optional<Throwable>> var3,
         boolean var4) {
      this.field6767 = var1;
      this.field6768 = var2;
      this.field6769 = var3;
   ...
   public static void method6014() {
      ...
      field6780 = ResourceList.createScaledAndProcessedTexture2("com/mentalfrostbyte/gui/resources/loading/back.png",
            0.25F, 25);
   }
   ...
   public void render(MatrixStack var1, int var2, int var3, float var4) {
      ...
      if (this.field6770 && (this.field6768.method29225() || this.field6767.currentScreen != null)
            && this.field6773 == -1L) {
         this.field6773 = var9;
      }
      ...
      float var18 = (float) this.field6767.mainWindow.calcGuiScale(this.field6767.gameSettings.guiScale,
            this.field6767.getForceUnicodeFont()) * var17;
      ...
      if (this.field6772 == -1L && this.field6768.method29226() && (!this.field6770 || var12 >= 2.0F)) {
         ...
         if (this.field6767.currentScreen != null) {
            this.field6767.currentScreen.init(this.field6767, this.field6767.getMainWindow().getScaledWidth(),
                  this.field6767.getMainWindow().getScaledHeight());
         }
      }
   }
   ...
   public static void method6015(float var0, float var1) {
      ...
      RenderUtil.drawImage(
            0.0F, 0.0F, (float) Minecraft.getInstance().mainWindow.getWidth(),
            (float) Minecraft.getInstance().mainWindow.getHeight(), field6780, var0);
      RenderUtil.renderBackgroundBox(
            0.0F, 0.0F, (float) Minecraft.getInstance().mainWindow.getWidth(),
            (float) Minecraft.getInstance().mainWindow.getHeight(), MultiUtilities.applyAlpha(0, 0.75F));
      short var4 = 455;
      byte var5 = 78;
      ...
      GL11.glPushMatrix();
      GL11.glTranslatef((float) (Minecraft.getInstance().mainWindow.getWidth() / 2),
            (float) (Minecraft.getInstance().mainWindow.getHeight() / 2), 0.0F);
      GL11.glScalef(var8, var8, 0.0F);
      GL11.glTranslatef((float) (-Minecraft.getInstance().mainWindow.getWidth() / 2),
            (float) (-Minecraft.getInstance().mainWindow.getHeight() / 2), 0.0F);
      RenderUtil.drawImage((float) var6, (float) var7, (float) var4, (float) var5, field6778,
            MultiUtilities.applyAlpha(ClientColors.LIGHT_GREYISH_BLUE.getColor(), var0));
      ...
      if (var0 == 1.0F) {
         RenderUtil.drawRect(
               ...
               MultiUtilities.applyAlpha(ClientColors.LIGHT_GREYISH_BLUE.getColor(), 0.3F * var0));
         RenderUtil.drawRect(
               (float) (var6 + 1),
