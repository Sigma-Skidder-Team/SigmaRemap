...
public class Class7026 implements ArgumentType<Class9688> {
   ...
   public static ITextComponent method21756(CommandContext<CommandSource> var0, String var1) throws CommandSyntaxException {
      return ((Class9688)var0.getArgument(var1, Class9688.class)).method37928((CommandSource)var0.getSource(), ((CommandSource)var0.getSource()).method20129(2));
   }
