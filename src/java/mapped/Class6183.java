...
public class Class6183 extends Class6159
{
    private static String[] field24992;
    
    private Class6183(final Class1847 class1847, final double n, final double n2, final double n3, final double n4, final double n5, final double n6) {
        ...
        this.field24951 = (int)(40.0 / (Math.random() * 0.8 + 0.2));
    }
