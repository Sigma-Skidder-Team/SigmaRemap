...
public final class Class9777 {
   ...
   private final TemplateManager field45737;
   ...
   public Class9777(Registry<Class9369> var1, int var2, Class6989 var3, ChunkGenerator var4, TemplateManager var5, List<? super Class4193> var6, Random var7) {
            ...
            if (var26.isPresent() && (((Class9369)var26.get()).method35538() != 0 || Objects.equals(var25, Class9837.field45937.getLocation()))) {
               ...
               if (!var27) {
                  ...
                  if (var13.getValue() == null) {
                     var13.setValue(VoxelShapes.create(AxisAlignedBB.toImmutable(var14)));
                  }
               }
                     ...
                     for (Class8266 var39 : var35) {
                        if (JigsawBlock.method11674(var17, var39)) {
                           ...
                           if (var12 && var45) {
                              ...
                              if (var22 == -1) {
                                 var22 = this.field45736.getNoiseHeight(var19.getX(), var19.getZ(), Heightmap.Type.WORLD_SURFACE_WG);
                              }
                           ...
                           if (var37 > 0) {
                              ...
                              var50.maxY = var50.minY + var52;
                           }

                           if (! VoxelShapes.compare(
                              (VoxelShape)var28.getValue(), VoxelShapes.create(AxisAlignedBB.toImmutable(var50).shrink(0.25)), IBooleanFunction.field44039
                           )) {
                              var28.setValue(
                                 VoxelShapes.method27434((VoxelShape)var28.getValue(), VoxelShapes.create(AxisAlignedBB.toImmutable(var50)), IBooleanFunction.ONLY_FIRST)
                              );
