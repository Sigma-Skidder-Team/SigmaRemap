      ...
      var0.register(
         (LiteralArgumentBuilder)((LiteralArgumentBuilder)Class6099.method18839("say").requires(var0x -> var0x.method20129(2)))
            .then(Class6099.method18840("message", Class7026.method21755()).executes(var0x -> {
               ...
               if (var5 == null) {
                  ((CommandSource)var0x.getSource()).method20177().getPlayerList().method19484(var4, ChatType.SYSTEM, Util.DUMMY_UUID);
               } else {
                  ((CommandSource)var0x.getSource()).method20177().getPlayerList().method19484(var4, ChatType.CHAT, var5.getUniqueID());
               }
