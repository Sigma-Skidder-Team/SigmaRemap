...
public abstract class LanguageMap {
   ...
   public abstract Class9125 func_241870_a(ITextProperties var1);

   public List<Class9125> func_244260_a(List<ITextProperties> p_244260_1_) {
      return p_244260_1_.stream().<Class9125>map(getInstance()::func_241870_a).collect(ImmutableList.toImmutableList());
   }
}
