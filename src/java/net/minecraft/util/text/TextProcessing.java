...
public class TextProcessing {
   ...
   public static boolean func_238341_a_(String p_238341_0_, Style p_238341_1_, Class2545 p_238341_2_) {
      ...
      for (int c0 = 0; c0 < j; c0++) {
         ...
         if (Character.isHighSurrogate(c1)) {
            if (c0 + 1 >= j) {
               if (!p_238341_2_.method10739(c0, p_238341_1_, 65533)) {
                  return false;
               }
               break;
            }
            ...
            if (Character.isLowSurrogate(var8)) {
               if (!p_238341_2_.method10739(c0, p_238341_1_, Character.toCodePoint(c1, var8))) {
                  return false;
               }

               c0++;
            } else if (!p_238341_2_.method10739(c0, p_238341_1_, 65533)) {
               return false;
            }
   ...
   public static boolean func_238345_b_(String p_238345_0_, Style p_238345_1_, Class2545 p_238345_2_) {
      ...
      for (int c0 = j - 1; c0 >= 0; c0--) {
         ...
         if (Character.isLowSurrogate(c1)) {
            if (c0 - 1 < 0) {
               if (!p_238345_2_.method10739(0, p_238345_1_, 65533)) {
                  return false;
               }
               break;
            }
            ...
            if (Character.isHighSurrogate(var8)) {
               if (!p_238345_2_.method10739(--c0, p_238345_1_, Character.toCodePoint(var8, c1))) {
                  return false;
               }
            } else if (!p_238345_2_.method10739(c0, p_238345_1_, 65533)) {
               return false;
            }
   ...
   public static boolean func_238346_c_(String p_238346_0_, Style p_238346_1_, Class2545 p_238346_2_) {
   ...
   public static boolean drawString(String p_238340_0_, int p_238340_1_, Style p_238340_2_, Style p_238340_3_, Class2545 p_238340_4_) {
      ...
      for (int c0 = p_238340_1_; c0 < style; c0++) {
         ...
         if (c2 == 167) {
            ...
            if (c0 + 1 >= style) {
               if (!p_238340_4_.method10739(c0, j, 65533)) {
                  return false;
               }
               break;
            }
            ...
            if (Character.isLowSurrogate(var15)) {
               if (!p_238340_4_.method10739(c0, j, Character.toCodePoint(c2, var15))) {
                  return false;
               }

               c0++;
            } else if (!p_238340_4_.method10739(c0, j, 65533)) {
               return false;
            }
