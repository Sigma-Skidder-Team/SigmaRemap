...
public class IngameGui extends AbstractGui {
    ...
    public void method5961(MatrixStack var1, float var2) {
        ...
        if (this.field6716.gameSettings.getPointOfView().func_243192_a() && var6.getItem() == Blocks.CARVED_PUMPKIN.asItem()) {
            this.method5978();
        }
    ...
    private void method5981(float var1) {
        ...
        TextureAtlasSprite var4 = this.field6716.getBlockRendererDispatcher().getBlockModelShapes().getTexture(Blocks.NETHER_PORTAL.getDefaultState());
