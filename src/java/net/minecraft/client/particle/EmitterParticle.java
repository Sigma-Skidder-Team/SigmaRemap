   ...
   public void method14500() {
      for (int var3 = 0; var3 < 16; var3++) {
         ...
         if (!(var4 * var4 + var6 * var6 + var8 * var8 > 1.0)) {
            double var10 = this.field22066.getPosXWidth(var4 / 4.0);
            double var12 = this.field22066.getPosYHeight(0.5 + var6 / 4.0);
            double var14 = this.field22066.getPosZWidth(var8 / 4.0);
