...
public abstract class DimensionRenderInfo {
   private static final Object2ObjectMap<ResourceLocation, DimensionRenderInfo> field27884 = Util.<Object2ObjectMap<ResourceLocation, DimensionRenderInfo>>make(
   ...
   public DimensionRenderInfo(float var1, boolean var2, Class2078 var3, boolean var4, boolean var5) {
   ...
   public static DimensionRenderInfo method19301(DimensionType var0) {
      return (DimensionRenderInfo)field27884.get(var0.getEffects());
   }
