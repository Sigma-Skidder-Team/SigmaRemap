...
public class Blocks {
   ...
   public static final Block OAK_WOOD = register(
      "oak_wood", new StrippedCrimsonHyphaeBlock(AbstractBlock.Properties.withMaterialAndColor(Material.PLANKS, MaterialColor.OAK_PLANK).method26623(2.0F).method26619(SoundType.WOOD))
   );
   public static final Block SPRUCE_WOOD = register(
      "spruce_wood", new StrippedCrimsonHyphaeBlock(AbstractBlock.Properties.withMaterialAndColor(Material.PLANKS, MaterialColor.PODZOL).method26623(2.0F).method26619(SoundType.WOOD))
   );
   public static final Block BIRCH_WOOD = register(
      "birch_wood", new StrippedCrimsonHyphaeBlock(AbstractBlock.Properties.withMaterialAndColor(Material.PLANKS, MaterialColor.field30949).method26623(2.0F).method26619(SoundType.WOOD))
   );
   public static final Block JUNGLE_WOOD = register(
      "jungle_wood", new StrippedCrimsonHyphaeBlock(AbstractBlock.Properties.withMaterialAndColor(Material.PLANKS, MaterialColor.GRANITE).method26623(2.0F).method26619(SoundType.WOOD))
   );
   public static final Block ACACIA_WOOD = register(
      "acacia_wood", new StrippedCrimsonHyphaeBlock(AbstractBlock.Properties.withMaterialAndColor(Material.PLANKS, MaterialColor.field30968).method26623(2.0F).method26619(SoundType.WOOD))
   );
   public static final Block DARK_OAK_WOOD = register(
      "dark_oak_wood", new StrippedCrimsonHyphaeBlock(AbstractBlock.Properties.withMaterialAndColor(Material.PLANKS, MaterialColor.field30973).method26623(2.0F).method26619(SoundType.WOOD))
   );
   public static final Block STRIPPED_OAK_WOOD = register(
      "stripped_oak_wood", new StrippedCrimsonHyphaeBlock(AbstractBlock.Properties.withMaterialAndColor(Material.PLANKS, MaterialColor.OAK_PLANK).method26623(2.0F).method26619(SoundType.WOOD))
   );
   public static final Block STRIPPED_SPRUCE_WOOD = register(
      "stripped_spruce_wood",
      new StrippedCrimsonHyphaeBlock(AbstractBlock.Properties.withMaterialAndColor(Material.PLANKS, MaterialColor.PODZOL).method26623(2.0F).method26619(SoundType.WOOD))
   );
   public static final Block STRIPPED_BIRCH_WOOD = register(
      "stripped_birch_wood",
      new StrippedCrimsonHyphaeBlock(AbstractBlock.Properties.withMaterialAndColor(Material.PLANKS, MaterialColor.field30949).method26623(2.0F).method26619(SoundType.WOOD))
   );
   public static final Block STRIPPED_JUNGLE_WOOD = register(
      "stripped_jungle_wood",
      new StrippedCrimsonHyphaeBlock(AbstractBlock.Properties.withMaterialAndColor(Material.PLANKS, MaterialColor.GRANITE).method26623(2.0F).method26619(SoundType.WOOD))
   );
   public static final Block STRIPPED_ACACIA_WOOD = register(
      "stripped_acacia_wood",
      new StrippedCrimsonHyphaeBlock(AbstractBlock.Properties.withMaterialAndColor(Material.PLANKS, MaterialColor.field30962).method26623(2.0F).method26619(SoundType.WOOD))
   );
   public static final Block STRIPPED_DARK_OAK_WOOD = register(
      "stripped_dark_oak_wood",
      new StrippedCrimsonHyphaeBlock(AbstractBlock.Properties.withMaterialAndColor(Material.PLANKS, MaterialColor.field30973).method26623(2.0F).method26619(SoundType.WOOD))
   );
   ...
   public static final Block DISPENSER = register(
      "dispenser", new Class3357(AbstractBlock.Properties.withMaterial(Material.STONE).method26635().method26623(3.5F))
   );
   ...
   public static final Block POWERED_RAIL = register(
      "powered_rail", new ActivatorRailBlock(AbstractBlock.Properties.withMaterial(Material.field38946).method26614().method26623(0.7F).method26619(SoundType.METAL))
   );
   ...
   public static final Block SPAWNER = register(
      "spawner", new SpawnerBlock(AbstractBlock.Properties.withMaterial(Material.STONE).method26635().method26623(5.0F).method26619(SoundType.METAL).method26615())
   );
   public static final Block field36533 = register("oak_stairs", new StairsBlock(OAK_PLANKS.getDefaultState(), AbstractBlock.Properties.method26613(OAK_PLANKS)));
   ...
   public static final Block CRAFTING_TABLE = register(
      "crafting_table", new Class3438(AbstractBlock.Properties.withMaterial(Material.PLANKS).method26623(2.5F).method26619(SoundType.WOOD))
   );
   ...
   public static final Block FURNACE = register(
      "furnace", new Class3353(AbstractBlock.Properties.withMaterial(Material.STONE).method26635().method26623(3.5F).method26620(method30011(13)))
   );
   public static final Block OAK_SIGN = register(
      "oak_sign",
      new CrimsonSignBlock(AbstractBlock.Properties.withMaterial(Material.PLANKS).method26614().method26623(1.0F).method26619(SoundType.WOOD), Class9673.field45166)
   );
   ...
   public static final Block STONE_PRESSURE_PLATE = register(
      "stone_pressure_plate", new WarpedPressurePlateBlock(Class2275.field14824, AbstractBlock.Properties.withMaterial(Material.STONE).method26635().method26614().method26623(0.5F))
   );
   ...
   public static final Block REDSTONE_TORCH = register(
      "redstone_torch",
      new RedstoneTorchBlock(AbstractBlock.Properties.withMaterial(Material.field38946).method26614().method26622().method26620(method30011(7)).method26619(SoundType.WOOD))
   );
   ...
   public static final Block OAK_FENCE = register(
      "oak_fence",
      new WarpedFenceBlock(AbstractBlock.Properties.withMaterialAndColor(Material.PLANKS, OAK_PLANKS.method12000()).method26621(2.0F, 3.0F).method26619(SoundType.WOOD))
   );
   ...
   public static final Block BASALT = register(
      "basalt",
      new StrippedCrimsonHyphaeBlock(AbstractBlock.Properties.withMaterialAndColor(Material.STONE, MaterialColor.field30976).method26635().method26621(1.25F, 4.2F).method26619(SoundType.WART_BLOCK))
   );
   ...
   public static final Block REPEATER = register(
      "repeater", new Class3248(AbstractBlock.Properties.withMaterial(Material.field38946).method26622().method26619(SoundType.WOOD))
   );
   ...
   public static final Block INFESTED_STONE = register(
      "infested_stone", new InfestedChiseledStoneBricksBlock(STONE, AbstractBlock.Properties.withMaterial(Material.field38949).method26621(0.0F, 0.75F))
   );
   public static final Block INFESTED_COBBLESTONE = register(
      "infested_cobblestone", new InfestedChiseledStoneBricksBlock(COBBLESTONE, AbstractBlock.Properties.withMaterial(Material.field38949).method26621(0.0F, 0.75F))
   );
   public static final Block INFESTED_STONE_BRICKS = register(
      "infested_stone_bricks", new InfestedChiseledStoneBricksBlock(field36615, AbstractBlock.Properties.withMaterial(Material.field38949).method26621(0.0F, 0.75F))
   );
   public static final Block INFESTED_MOSSY_STONE_BRICKS = register(
      "infested_mossy_stone_bricks", new InfestedChiseledStoneBricksBlock(field36616, AbstractBlock.Properties.withMaterial(Material.field38949).method26621(0.0F, 0.75F))
   );
   public static final Block INFESTED_CRACKED_STONE_BRICKS = register(
      "infested_cracked_stone_bricks", new InfestedChiseledStoneBricksBlock(field36617, AbstractBlock.Properties.withMaterial(Material.field38949).method26621(0.0F, 0.75F))
   );
   public static final Block INFESTED_CHISELED_STONE_BRICKS = register(
      "infested_chiseled_stone_bricks", new InfestedChiseledStoneBricksBlock(field36618, AbstractBlock.Properties.withMaterial(Material.field38949).method26621(0.0F, 0.75F))
   );
   ...
   public static final Block NETHER_BRICK_FENCE = register(
      "nether_brick_fence",
      new WarpedFenceBlock(AbstractBlock.Properties.withMaterialAndColor(Material.STONE, MaterialColor.field30982).method26635().method26621(2.0F, 6.0F).method26619(SoundType.NETHER_SPROUTS))
   );
   ...
   public static final Block BREWING_STAND = register(
      "brewing_stand", new BrewingStandBlock(AbstractBlock.Properties.withMaterial(Material.field38967).method26635().method26623(0.5F).method26620(var0 -> 1).method26615())
   );
   public static final Block CAULDRON = register(
      "cauldron", new CauldronBlock(AbstractBlock.Properties.withMaterialAndColor(Material.field38967, MaterialColor.STONE).method26635().method26623(2.0F).method26615())
   );
   ...
   public static final Block DRAGON_EGG = register(
      "dragon_egg",
      new DragonEggBlock(AbstractBlock.Properties.withMaterialAndColor(Material.DRAGON_EGG, MaterialColor.field30976).method26621(3.0F, 9.0F).method26620(var0 -> 1).method26615())
   );
   ...
   public static final Block COBBLESTONE_WALL = register("cobblestone_wall", new PolishedBlackstoneWallBlock(AbstractBlock.Properties.method26613(COBBLESTONE)));
   public static final Block MOSSY_COBBLESTONE_WALL = register("mossy_cobblestone_wall", new PolishedBlackstoneWallBlock(AbstractBlock.Properties.method26613(COBBLESTONE)));
   public static final Block FLOWER_POT = register(
      "flower_pot", new PottedWarpedRootsBlock(AIR, AbstractBlock.Properties.withMaterial(Material.field38946).method26622().method26615())
   );
   public static final Block POTTED_OAK_SAPLING = register(
      "potted_oak_sapling", new PottedWarpedRootsBlock(OAK_SAPLING, AbstractBlock.Properties.withMaterial(Material.field38946).method26622().method26615())
   );
   public static final Block POTTED_SPRUCE_SAPLING = register(
      "potted_spruce_sapling", new PottedWarpedRootsBlock(SPRUCE_SAPLING, AbstractBlock.Properties.withMaterial(Material.field38946).method26622().method26615())
   );
   public static final Block POTTED_BIRCH_SAPLING = register(
      "potted_birch_sapling", new PottedWarpedRootsBlock(BIRCH_SAPLING, AbstractBlock.Properties.withMaterial(Material.field38946).method26622().method26615())
   );
   public static final Block POTTED_JUNGLE_SAPLING = register(
      "potted_jungle_sapling", new PottedWarpedRootsBlock(JUNGLE_SAPLING, AbstractBlock.Properties.withMaterial(Material.field38946).method26622().method26615())
   );
   public static final Block POTTED_ACACIA_SAPLING = register(
      "potted_acacia_sapling", new PottedWarpedRootsBlock(ACACIA_SAPLING, AbstractBlock.Properties.withMaterial(Material.field38946).method26622().method26615())
   );
   public static final Block POTTED_DARK_OAK_SAPLING = register(
      "potted_dark_oak_sapling", new PottedWarpedRootsBlock(DARK_OAK_SAPLING, AbstractBlock.Properties.withMaterial(Material.field38946).method26622().method26615())
   );
   public static final Block POTTED_FERN = register(
      "potted_fern", new PottedWarpedRootsBlock(FERN, AbstractBlock.Properties.withMaterial(Material.field38946).method26622().method26615())
   );
   public static final Block POTTED_DANDELION = register(
      "potted_dandelion", new PottedWarpedRootsBlock(DANDELION, AbstractBlock.Properties.withMaterial(Material.field38946).method26622().method26615())
   );
   public static final Block POTTED_POPPY = register(
      "potted_poppy", new PottedWarpedRootsBlock(POPPY, AbstractBlock.Properties.withMaterial(Material.field38946).method26622().method26615())
   );
   public static final Block POTTED_BLUE_ORCHID = register(
      "potted_blue_orchid", new PottedWarpedRootsBlock(BLUE_ORCHID, AbstractBlock.Properties.withMaterial(Material.field38946).method26622().method26615())
   );
   public static final Block POTTED_ALLIUM = register(
      "potted_allium", new PottedWarpedRootsBlock(ALLIUM, AbstractBlock.Properties.withMaterial(Material.field38946).method26622().method26615())
   );
   public static final Block POTTED_AZURE_BLUET = register(
      "potted_azure_bluet", new PottedWarpedRootsBlock(AZURE_BLUET, AbstractBlock.Properties.withMaterial(Material.field38946).method26622().method26615())
   );
   public static final Block POTTED_RED_TULIP = register(
      "potted_red_tulip", new PottedWarpedRootsBlock(RED_TULIP, AbstractBlock.Properties.withMaterial(Material.field38946).method26622().method26615())
   );
   public static final Block POTTED_ORANGE_TULIP = register(
      "potted_orange_tulip", new PottedWarpedRootsBlock(ORANGE_TULIP, AbstractBlock.Properties.withMaterial(Material.field38946).method26622().method26615())
   );
   public static final Block POTTED_WHITE_TULIP = register(
      "potted_white_tulip", new PottedWarpedRootsBlock(WHITE_TULIP, AbstractBlock.Properties.withMaterial(Material.field38946).method26622().method26615())
   );
   public static final Block POTTED_PINK_TULIP = register(
      "potted_pink_tulip", new PottedWarpedRootsBlock(PINK_TULIP, AbstractBlock.Properties.withMaterial(Material.field38946).method26622().method26615())
   );
   public static final Block POTTED_OXEYE_DAISY = register(
      "potted_oxeye_daisy", new PottedWarpedRootsBlock(OXEYE_DAISY, AbstractBlock.Properties.withMaterial(Material.field38946).method26622().method26615())
   );
   public static final Block POTTED_CORNFLOWER = register(
      "potted_cornflower", new PottedWarpedRootsBlock(CORNFLOWER, AbstractBlock.Properties.withMaterial(Material.field38946).method26622().method26615())
   );
   public static final Block POTTED_LILY_OF_THE_VALLEY = register(
      "potted_lily_of_the_valley", new PottedWarpedRootsBlock(LILY_OF_THE_VALLEY, AbstractBlock.Properties.withMaterial(Material.field38946).method26622().method26615())
   );
   public static final Block POTTED_WITHER_ROSE = register(
      "potted_wither_rose", new PottedWarpedRootsBlock(WITHER_ROSE, AbstractBlock.Properties.withMaterial(Material.field38946).method26622().method26615())
   );
   public static final Block POTTED_RED_MUSHROOM = register(
      "potted_red_mushroom", new PottedWarpedRootsBlock(RED_MUSHROOM, AbstractBlock.Properties.withMaterial(Material.field38946).method26622().method26615())
   );
   public static final Block POTTED_BROWN_MUSHROOM = register(
      "potted_brown_mushroom", new PottedWarpedRootsBlock(BROWN_MUSHROOM, AbstractBlock.Properties.withMaterial(Material.field38946).method26622().method26615())
   );
   public static final Block POTTED_DEAD_BUSH = register(
      "potted_dead_bush", new PottedWarpedRootsBlock(DEAD_BUSH, AbstractBlock.Properties.withMaterial(Material.field38946).method26622().method26615())
   );
   public static final Block POTTED_CACTUS = register(
      "potted_cactus", new PottedWarpedRootsBlock(CACTUS, AbstractBlock.Properties.withMaterial(Material.field38946).method26622().method26615())
   );
   public static final Block CARROTS = register(
      "carrots", new CarrotsBlock(AbstractBlock.Properties.withMaterial(Material.PLANTS).method26614().method26624().method26622().method26619(SoundType.CROP))
   );
   public static final Block POTATOES = register(
      "potatoes", new PotatoesBlock(AbstractBlock.Properties.withMaterial(Material.PLANTS).method26614().method26624().method26622().method26619(SoundType.CROP))
   );
   ...
   public static final Block SKELETON_SKULL = register(
      "skeleton_skull", new CreeperHeadBlock(Class2136.field13989, AbstractBlock.Properties.withMaterial(Material.field38946).method26623(1.0F))
   );
   public static final Block SKELETON_WALL_SKULL = register(
      "skeleton_wall_skull", new CreeperWallHeadBlock(Class2136.field13989, AbstractBlock.Properties.withMaterial(Material.field38946).method26623(1.0F).method26627(SKELETON_SKULL))
   );
   public static final Block WITHER_SKELETON_SKULL = register("wither_skeleton_skull", new WitherSkeletonSkullBlock(AbstractBlock.Properties.withMaterial(Material.field38946).method26623(1.0F)));
   public static final Block WITHER_SKELETON_WALL_SKULL = register(
      "wither_skeleton_wall_skull", new WitherSkeletonWallSkullBlock(AbstractBlock.Properties.withMaterial(Material.field38946).method26623(1.0F).method26627(WITHER_SKELETON_SKULL))
   );
   public static final Block ZOMBIE_HEAD = register(
      "zombie_head", new CreeperHeadBlock(Class2136.field13992, AbstractBlock.Properties.withMaterial(Material.field38946).method26623(1.0F))
   );
   public static final Block ZOMBIE_WALL_HEAD = register(
      "zombie_wall_head", new CreeperWallHeadBlock(Class2136.field13992, AbstractBlock.Properties.withMaterial(Material.field38946).method26623(1.0F).method26627(ZOMBIE_HEAD))
   );
   ...
   public static final Block PLAYER_WALL_HEAD = register(
      "player_wall_head", new PlayerWallHeadBlock(AbstractBlock.Properties.withMaterial(Material.field38946).method26623(1.0F).method26627(PLAYER_HEAD))
   );
   public static final Block CREEPER_HEAD = register(
      "creeper_head", new CreeperHeadBlock(Class2136.field13993, AbstractBlock.Properties.withMaterial(Material.field38946).method26623(1.0F))
   );
   public static final Block CREEPER_WALL_HEAD = register(
      "creeper_wall_head", new CreeperWallHeadBlock(Class2136.field13993, AbstractBlock.Properties.withMaterial(Material.field38946).method26623(1.0F).method26627(CREEPER_HEAD))
   );
   public static final Block DRAGON_HEAD = register(
      "dragon_head", new CreeperHeadBlock(Class2136.field13994, AbstractBlock.Properties.withMaterial(Material.field38946).method26623(1.0F))
   );
   public static final Block DRAGON_WALL_HEAD = register(
      "dragon_wall_head", new CreeperWallHeadBlock(Class2136.field13994, AbstractBlock.Properties.withMaterial(Material.field38946).method26623(1.0F).method26627(DRAGON_HEAD))
   );
   ...
   public static final Block DAYLIGHT_DETECTOR = register(
      "daylight_detector", new DaylightDetectorBlock(AbstractBlock.Properties.withMaterial(Material.PLANKS).method26623(0.2F).method26619(SoundType.WOOD))
   );
   ...
   public static final Block QUARTZ_PILLAR = register(
      "quartz_pillar", new StrippedCrimsonHyphaeBlock(AbstractBlock.Properties.withMaterialAndColor(Material.STONE, MaterialColor.DIORITE).method26635().method26623(0.8F))
   );
   ...
   public static final Block ACTIVATOR_RAIL = register(
      "activator_rail", new ActivatorRailBlock(AbstractBlock.Properties.withMaterial(Material.field38946).method26614().method26623(0.7F).method26619(SoundType.METAL))
   );
   ...
   public static final Block WHITE_STAINED_GLASS_PANE = register(
      ...
      new BlackStainedGlassPaneBlock(Class112.field386, AbstractBlock.Properties.withMaterial(Material.field38963).method26623(0.3F).method26619(SoundType.GLASS).method26615())
   );
   public static final Block ORANGE_STAINED_GLASS_PANE = register(
      "orange_stained_glass_pane",
      new BlackStainedGlassPaneBlock(Class112.field387, AbstractBlock.Properties.withMaterial(Material.field38963).method26623(0.3F).method26619(SoundType.GLASS).method26615())
   );
   public static final Block MAGENTA_STAINED_GLASS_PANE = register(
      "magenta_stained_glass_pane",
      new BlackStainedGlassPaneBlock(Class112.field388, AbstractBlock.Properties.withMaterial(Material.field38963).method26623(0.3F).method26619(SoundType.GLASS).method26615())
   );
   public static final Block LIGHT_BLUE_STAINED_GLASS_PANE = register(
      "light_blue_stained_glass_pane",
      new BlackStainedGlassPaneBlock(Class112.field389, AbstractBlock.Properties.withMaterial(Material.field38963).method26623(0.3F).method26619(SoundType.GLASS).method26615())
   );
   public static final Block YELLOW_STAINED_GLASS_PANE = register(
      "yellow_stained_glass_pane",
      new BlackStainedGlassPaneBlock(Class112.field390, AbstractBlock.Properties.withMaterial(Material.field38963).method26623(0.3F).method26619(SoundType.GLASS).method26615())
   );
   public static final Block LIME_STAINED_GLASS_PANE = register(
      "lime_stained_glass_pane",
      new BlackStainedGlassPaneBlock(Class112.field391, AbstractBlock.Properties.withMaterial(Material.field38963).method26623(0.3F).method26619(SoundType.GLASS).method26615())
   );
   public static final Block PINK_STAINED_GLASS_PANE = register(
      "pink_stained_glass_pane",
      new BlackStainedGlassPaneBlock(Class112.field392, AbstractBlock.Properties.withMaterial(Material.field38963).method26623(0.3F).method26619(SoundType.GLASS).method26615())
   );
   public static final Block GRAY_STAINED_GLASS_PANE = register(
      "gray_stained_glass_pane",
      new BlackStainedGlassPaneBlock(Class112.field393, AbstractBlock.Properties.withMaterial(Material.field38963).method26623(0.3F).method26619(SoundType.GLASS).method26615())
   );
   public static final Block LIGHT_GRAY_STAINED_GLASS_PANE = register(
      "light_gray_stained_glass_pane",
      new BlackStainedGlassPaneBlock(Class112.field394, AbstractBlock.Properties.withMaterial(Material.field38963).method26623(0.3F).method26619(SoundType.GLASS).method26615())
   );
   public static final Block CYAN_STAINED_GLASS_PANE = register(
      "cyan_stained_glass_pane",
      new BlackStainedGlassPaneBlock(Class112.field395, AbstractBlock.Properties.withMaterial(Material.field38963).method26623(0.3F).method26619(SoundType.GLASS).method26615())
   );
   public static final Block PURPLE_STAINED_GLASS_PANE = register(
      "purple_stained_glass_pane",
      new BlackStainedGlassPaneBlock(Class112.field396, AbstractBlock.Properties.withMaterial(Material.field38963).method26623(0.3F).method26619(SoundType.GLASS).method26615())
   );
   public static final Block BLUE_STAINED_GLASS_PANE = register(
      "blue_stained_glass_pane",
      new BlackStainedGlassPaneBlock(Class112.field397, AbstractBlock.Properties.withMaterial(Material.field38963).method26623(0.3F).method26619(SoundType.GLASS).method26615())
   );
   public static final Block BROWN_STAINED_GLASS_PANE = register(
      "brown_stained_glass_pane",
      new BlackStainedGlassPaneBlock(Class112.field398, AbstractBlock.Properties.withMaterial(Material.field38963).method26623(0.3F).method26619(SoundType.GLASS).method26615())
   );
   public static final Block GREEN_STAINED_GLASS_PANE = register(
      "green_stained_glass_pane",
      new BlackStainedGlassPaneBlock(Class112.field399, AbstractBlock.Properties.withMaterial(Material.field38963).method26623(0.3F).method26619(SoundType.GLASS).method26615())
   );
   public static final Block RED_STAINED_GLASS_PANE = register(
      "red_stained_glass_pane",
      new BlackStainedGlassPaneBlock(Class112.field400, AbstractBlock.Properties.withMaterial(Material.field38963).method26623(0.3F).method26619(SoundType.GLASS).method26615())
   );
   public static final Block BLACK_STAINED_GLASS_PANE = register(
      "black_stained_glass_pane",
      new BlackStainedGlassPaneBlock(Class112.field401, AbstractBlock.Properties.withMaterial(Material.field38963).method26623(0.3F).method26619(SoundType.GLASS).method26615())
   );
   ...
   public static final Block SLIME_BLOCK = register(
      "slime_block",
      new SlimeBlock(AbstractBlock.Properties.withMaterialAndColor(Material.field38949, MaterialColor.field30948).method26616(0.8F).method26619(SoundType.SLIME).method26615())
   );
   ...
   public static final Block HAY_BLOCK = register(
      "hay_block", new HayBlock(AbstractBlock.Properties.withMaterialAndColor(Material.GRASS, MaterialColor.field30965).method26623(0.5F).method26619(SoundType.GRASS))
   );
   ...
   public static final Block SUNFLOWER = register(
      "sunflower", new PeonyBlock(AbstractBlock.Properties.withMaterial(Material.TALL_PLANTS).method26614().method26622().method26619(SoundType.GRASS))
   );
   public static final Block LILAC = register(
      "lilac", new PeonyBlock(AbstractBlock.Properties.withMaterial(Material.TALL_PLANTS).method26614().method26622().method26619(SoundType.GRASS))
   );
   public static final Block ROSE_BUSH = register(
      "rose_bush", new PeonyBlock(AbstractBlock.Properties.withMaterial(Material.TALL_PLANTS).method26614().method26622().method26619(SoundType.GRASS))
   );
   public static final Block PEONY = register(
      "peony", new PeonyBlock(AbstractBlock.Properties.withMaterial(Material.TALL_PLANTS).method26614().method26622().method26619(SoundType.GRASS))
   );
   public static final Block TALL_GRASS = register(
      "tall_grass", new LargeFernBlock(AbstractBlock.Properties.withMaterial(Material.TALL_PLANTS).method26614().method26622().method26619(SoundType.GRASS))
   );
   public static final Block LARGE_FERN = register(
      "large_fern", new LargeFernBlock(AbstractBlock.Properties.withMaterial(Material.TALL_PLANTS).method26614().method26622().method26619(SoundType.GRASS))
   );
   public static final Block WHITE_BANNER = register(
      "white_banner",
      new BlackBannerBlock(Class112.field386, AbstractBlock.Properties.withMaterial(Material.PLANKS).method26614().method26623(1.0F).method26619(SoundType.WOOD))
   );
   public static final Block ORANGE_BANNER = register(
      "orange_banner",
      new BlackBannerBlock(Class112.field387, AbstractBlock.Properties.withMaterial(Material.PLANKS).method26614().method26623(1.0F).method26619(SoundType.WOOD))
   );
   public static final Block MAGENTA_BANNER = register(
      "magenta_banner",
      new BlackBannerBlock(Class112.field388, AbstractBlock.Properties.withMaterial(Material.PLANKS).method26614().method26623(1.0F).method26619(SoundType.WOOD))
   );
   public static final Block LIGHT_BLUE_BANNER = register(
      "light_blue_banner",
      new BlackBannerBlock(Class112.field389, AbstractBlock.Properties.withMaterial(Material.PLANKS).method26614().method26623(1.0F).method26619(SoundType.WOOD))
   );
   public static final Block YELLOW_BANNER = register(
      "yellow_banner",
      new BlackBannerBlock(Class112.field390, AbstractBlock.Properties.withMaterial(Material.PLANKS).method26614().method26623(1.0F).method26619(SoundType.WOOD))
   );
   public static final Block LIME_BANNER = register(
      "lime_banner",
      new BlackBannerBlock(Class112.field391, AbstractBlock.Properties.withMaterial(Material.PLANKS).method26614().method26623(1.0F).method26619(SoundType.WOOD))
   );
   public static final Block PINK_BANNER = register(
      "pink_banner",
      new BlackBannerBlock(Class112.field392, AbstractBlock.Properties.withMaterial(Material.PLANKS).method26614().method26623(1.0F).method26619(SoundType.WOOD))
   );
   public static final Block GRAY_BANNER = register(
      "gray_banner",
      new BlackBannerBlock(Class112.field393, AbstractBlock.Properties.withMaterial(Material.PLANKS).method26614().method26623(1.0F).method26619(SoundType.WOOD))
   );
   public static final Block LIGHT_GRAY_BANNER = register(
      "light_gray_banner",
      new BlackBannerBlock(Class112.field394, AbstractBlock.Properties.withMaterial(Material.PLANKS).method26614().method26623(1.0F).method26619(SoundType.WOOD))
   );
   public static final Block CYAN_BANNER = register(
      "cyan_banner",
      new BlackBannerBlock(Class112.field395, AbstractBlock.Properties.withMaterial(Material.PLANKS).method26614().method26623(1.0F).method26619(SoundType.WOOD))
   );
   public static final Block PURPLE_BANNER = register(
      "purple_banner",
      new BlackBannerBlock(Class112.field396, AbstractBlock.Properties.withMaterial(Material.PLANKS).method26614().method26623(1.0F).method26619(SoundType.WOOD))
   );
   public static final Block BLUE_BANNER = register(
      "blue_banner",
      new BlackBannerBlock(Class112.field397, AbstractBlock.Properties.withMaterial(Material.PLANKS).method26614().method26623(1.0F).method26619(SoundType.WOOD))
   );
   public static final Block BROWN_BANNER = register(
      "brown_banner",
      new BlackBannerBlock(Class112.field398, AbstractBlock.Properties.withMaterial(Material.PLANKS).method26614().method26623(1.0F).method26619(SoundType.WOOD))
   );
   public static final Block GREEN_BANNER = register(
      "green_banner",
      new BlackBannerBlock(Class112.field399, AbstractBlock.Properties.withMaterial(Material.PLANKS).method26614().method26623(1.0F).method26619(SoundType.WOOD))
   );
   public static final Block RED_BANNER = register(
      "red_banner",
      new BlackBannerBlock(Class112.field400, AbstractBlock.Properties.withMaterial(Material.PLANKS).method26614().method26623(1.0F).method26619(SoundType.WOOD))
   );
   public static final Block BLACK_BANNER = register(
      "black_banner",
      new BlackBannerBlock(Class112.field401, AbstractBlock.Properties.withMaterial(Material.PLANKS).method26614().method26623(1.0F).method26619(SoundType.WOOD))
   );
   public static final Block WHITE_WALL_BANNER = register(
      "white_wall_banner",
      new BlackWallBannerBlock(
         Class112.field386,
         AbstractBlock.Properties.withMaterial(Material.PLANKS).method26614().method26623(1.0F).method26619(SoundType.WOOD).method26627(WHITE_BANNER)
      )
   );
   public static final Block ORANGE_WALL_BANNER = register(
      ...
      new BlackWallBannerBlock(
         Class112.field387,
         AbstractBlock.Properties.withMaterial(Material.PLANKS).method26614().method26623(1.0F).method26619(SoundType.WOOD).method26627(ORANGE_BANNER)
      )
   );
   public static final Block MAGENTA_WALL_BANNER = register(
      ...
      new BlackWallBannerBlock(
         Class112.field388,
         AbstractBlock.Properties.withMaterial(Material.PLANKS).method26614().method26623(1.0F).method26619(SoundType.WOOD).method26627(MAGENTA_BANNER)
      )
   );
   public static final Block LIGHT_BLUE_WALL_BANNER = register(
      ...
      new BlackWallBannerBlock(
         Class112.field389,
         AbstractBlock.Properties.withMaterial(Material.PLANKS).method26614().method26623(1.0F).method26619(SoundType.WOOD).method26627(LIGHT_BLUE_BANNER)
      )
   );
   public static final Block YELLOW_WALL_BANNER = register(
      ...
      new BlackWallBannerBlock(
         Class112.field390,
         AbstractBlock.Properties.withMaterial(Material.PLANKS).method26614().method26623(1.0F).method26619(SoundType.WOOD).method26627(YELLOW_BANNER)
      )
   );
   public static final Block LIME_WALL_BANNER = register(
      ...
      new BlackWallBannerBlock(
         Class112.field391,
         AbstractBlock.Properties.withMaterial(Material.PLANKS).method26614().method26623(1.0F).method26619(SoundType.WOOD).method26627(LIME_BANNER)
      )
   );
   public static final Block PINK_WALL_BANNER = register(
      ...
      new BlackWallBannerBlock(
         Class112.field392,
         AbstractBlock.Properties.withMaterial(Material.PLANKS).method26614().method26623(1.0F).method26619(SoundType.WOOD).method26627(PINK_BANNER)
      )
   );
   public static final Block GRAY_WALL_BANNER = register(
      ...
      new BlackWallBannerBlock(
         Class112.field393,
         AbstractBlock.Properties.withMaterial(Material.PLANKS).method26614().method26623(1.0F).method26619(SoundType.WOOD).method26627(GRAY_BANNER)
      )
   );
   public static final Block LIGHT_GRAY_WALL_BANNER = register(
      ...
      new BlackWallBannerBlock(
         Class112.field394,
         AbstractBlock.Properties.withMaterial(Material.PLANKS).method26614().method26623(1.0F).method26619(SoundType.WOOD).method26627(LIGHT_GRAY_BANNER)
      )
   );
   public static final Block CYAN_WALL_BANNER = register(
      ...
      new BlackWallBannerBlock(
         Class112.field395,
         AbstractBlock.Properties.withMaterial(Material.PLANKS).method26614().method26623(1.0F).method26619(SoundType.WOOD).method26627(CYAN_BANNER)
      )
   );
   public static final Block PURPLE_WALL_BANNER = register(
      ...
      new BlackWallBannerBlock(
         Class112.field396,
         AbstractBlock.Properties.withMaterial(Material.PLANKS).method26614().method26623(1.0F).method26619(SoundType.WOOD).method26627(PURPLE_BANNER)
      )
   );
   public static final Block BLUE_WALL_BANNER = register(
      ...
      new BlackWallBannerBlock(
         Class112.field397,
         AbstractBlock.Properties.withMaterial(Material.PLANKS).method26614().method26623(1.0F).method26619(SoundType.WOOD).method26627(BLUE_BANNER)
      )
   );
   public static final Block BROWN_WALL_BANNER = register(
      ...
      new BlackWallBannerBlock(
         Class112.field398,
         AbstractBlock.Properties.withMaterial(Material.PLANKS).method26614().method26623(1.0F).method26619(SoundType.WOOD).method26627(BROWN_BANNER)
      )
   );
   public static final Block GREEN_WALL_BANNER = register(
      ...
      new BlackWallBannerBlock(
         Class112.field399,
         AbstractBlock.Properties.withMaterial(Material.PLANKS).method26614().method26623(1.0F).method26619(SoundType.WOOD).method26627(GREEN_BANNER)
      )
   );
   public static final Block RED_WALL_BANNER = register(
      ...
      new BlackWallBannerBlock(
         Class112.field400,
         AbstractBlock.Properties.withMaterial(Material.PLANKS).method26614().method26623(1.0F).method26619(SoundType.WOOD).method26627(RED_BANNER)
      )
   );
   public static final Block BLACK_WALL_BANNER = register(
      ...
      new BlackWallBannerBlock(
         Class112.field401,
         AbstractBlock.Properties.withMaterial(Material.PLANKS).method26614().method26623(1.0F).method26619(SoundType.WOOD).method26627(BLACK_BANNER)
      )
   );
   ...
   public static final Block SPRUCE_FENCE = register(
      "spruce_fence",
      new WarpedFenceBlock(AbstractBlock.Properties.withMaterialAndColor(Material.PLANKS, SPRUCE_PLANKS.method12000()).method26621(2.0F, 3.0F).method26619(SoundType.WOOD))
   );
   public static final Block BIRCH_FENCE = register(
      "birch_fence",
      new WarpedFenceBlock(AbstractBlock.Properties.withMaterialAndColor(Material.PLANKS, BIRCH_PLANKS.method12000()).method26621(2.0F, 3.0F).method26619(SoundType.WOOD))
   );
   public static final Block JUNGLE_FENCE = register(
      "jungle_fence",
      new WarpedFenceBlock(AbstractBlock.Properties.withMaterialAndColor(Material.PLANKS, JUNGLE_PLANKS.method12000()).method26621(2.0F, 3.0F).method26619(SoundType.WOOD))
   );
   public static final Block ACACIA_FENCE = register(
      "acacia_fence",
      new WarpedFenceBlock(AbstractBlock.Properties.withMaterialAndColor(Material.PLANKS, ACACIA_PLANKS.method12000()).method26621(2.0F, 3.0F).method26619(SoundType.WOOD))
   );
   public static final Block DARK_OAK_FENCE = register(
      "dark_oak_fence",
      new WarpedFenceBlock(AbstractBlock.Properties.withMaterialAndColor(Material.PLANKS, DARK_OAK_PLANKS.method12000()).method26621(2.0F, 3.0F).method26619(SoundType.WOOD))
   );
   ...
   public static final Block END_ROD = register(
      "end_rod",
      new EndRodBlock(AbstractBlock.Properties.withMaterial(Material.field38946).method26622().method26620(var0 -> 14).method26619(SoundType.WOOD).method26615())
   );
   public static final Block CHORUS_PLANT = register(
      "chorus_plant",
      new ChorusPlantBlock(AbstractBlock.Properties.withMaterialAndColor(Material.PLANTS, MaterialColor.field30971).method26623(0.4F).method26619(SoundType.WOOD).method26615())
   );
   ...
   public static final Block PURPUR_PILLAR = register(
      "purpur_pillar", new StrippedCrimsonHyphaeBlock(AbstractBlock.Properties.withMaterialAndColor(Material.STONE, MaterialColor.field30963).method26635().method26621(1.5F, 6.0F))
   );
   ...
   public static final Block BEETROOTS = register(
      "beetroots", new BeetrootsBlock(AbstractBlock.Properties.withMaterial(Material.PLANTS).method26614().method26624().method26622().method26619(SoundType.CROP))
   );
   ...
   public static final Block BONE_BLOCK = register(
      "bone_block",
      new StrippedCrimsonHyphaeBlock(AbstractBlock.Properties.withMaterialAndColor(Material.STONE, MaterialColor.field30949).method26635().method26623(2.0F).method26619(SoundType.NETHERITE))
   );
   public static final Block STRUCTURE_VOID = register(
      "structure_void", new StructureVoidBlock(AbstractBlock.Properties.withMaterial(Material.field38933).method26614().method26626())
   );
   ...
   public static final Block WHITE_GLAZED_TERRACOTTA = register(
      "white_glazed_terracotta", new BlackGlazedTerracottaBlock(AbstractBlock.Properties.method26610(Material.STONE, Class112.field386).method26635().method26623(1.4F))
   );
   public static final Block ORANGE_GLAZED_TERRACOTTA = register(
      "orange_glazed_terracotta", new BlackGlazedTerracottaBlock(AbstractBlock.Properties.method26610(Material.STONE, Class112.field387).method26635().method26623(1.4F))
   );
   public static final Block MAGENTA_GLAZED_TERRACOTTA = register(
      "magenta_glazed_terracotta", new BlackGlazedTerracottaBlock(AbstractBlock.Properties.method26610(Material.STONE, Class112.field388).method26635().method26623(1.4F))
   );
   public static final Block LIGHT_BLUE_GLAZED_TERRACOTTA = register(
      "light_blue_glazed_terracotta", new BlackGlazedTerracottaBlock(AbstractBlock.Properties.method26610(Material.STONE, Class112.field389).method26635().method26623(1.4F))
   );
   public static final Block YELLOW_GLAZED_TERRACOTTA = register(
      "yellow_glazed_terracotta", new BlackGlazedTerracottaBlock(AbstractBlock.Properties.method26610(Material.STONE, Class112.field390).method26635().method26623(1.4F))
   );
   public static final Block LIME_GLAZED_TERRACOTTA = register(
      "lime_glazed_terracotta", new BlackGlazedTerracottaBlock(AbstractBlock.Properties.method26610(Material.STONE, Class112.field391).method26635().method26623(1.4F))
   );
   public static final Block PINK_GLAZED_TERRACOTTA = register(
      "pink_glazed_terracotta", new BlackGlazedTerracottaBlock(AbstractBlock.Properties.method26610(Material.STONE, Class112.field392).method26635().method26623(1.4F))
   );
   public static final Block GRAY_GLAZED_TERRACOTTA = register(
      "gray_glazed_terracotta", new BlackGlazedTerracottaBlock(AbstractBlock.Properties.method26610(Material.STONE, Class112.field393).method26635().method26623(1.4F))
   );
   public static final Block LIGHT_GRAY_GLAZED_TERRACOTTA = register(
      "light_gray_glazed_terracotta", new BlackGlazedTerracottaBlock(AbstractBlock.Properties.method26610(Material.STONE, Class112.field394).method26635().method26623(1.4F))
   );
   public static final Block CYAN_GLAZED_TERRACOTTA = register(
      "cyan_glazed_terracotta", new BlackGlazedTerracottaBlock(AbstractBlock.Properties.method26610(Material.STONE, Class112.field395).method26635().method26623(1.4F))
   );
   public static final Block PURPLE_GLAZED_TERRACOTTA = register(
      "purple_glazed_terracotta", new BlackGlazedTerracottaBlock(AbstractBlock.Properties.method26610(Material.STONE, Class112.field396).method26635().method26623(1.4F))
   );
   public static final Block BLUE_GLAZED_TERRACOTTA = register(
      "blue_glazed_terracotta", new BlackGlazedTerracottaBlock(AbstractBlock.Properties.method26610(Material.STONE, Class112.field397).method26635().method26623(1.4F))
   );
   public static final Block BROWN_GLAZED_TERRACOTTA = register(
      "brown_glazed_terracotta", new BlackGlazedTerracottaBlock(AbstractBlock.Properties.method26610(Material.STONE, Class112.field398).method26635().method26623(1.4F))
   );
   public static final Block GREEN_GLAZED_TERRACOTTA = register(
      "green_glazed_terracotta", new BlackGlazedTerracottaBlock(AbstractBlock.Properties.method26610(Material.STONE, Class112.field399).method26635().method26623(1.4F))
   );
   public static final Block RED_GLAZED_TERRACOTTA = register(
      "red_glazed_terracotta", new BlackGlazedTerracottaBlock(AbstractBlock.Properties.method26610(Material.STONE, Class112.field400).method26635().method26623(1.4F))
   );
   public static final Block BLACK_GLAZED_TERRACOTTA = register(
      "black_glazed_terracotta", new BlackGlazedTerracottaBlock(AbstractBlock.Properties.method26610(Material.STONE, Class112.field401).method26635().method26623(1.4F))
   );
   ...
   public static final Block DEAD_TUBE_CORAL = register(
      "dead_tube_coral", new DeadHornCoralBlock(AbstractBlock.Properties.withMaterialAndColor(Material.STONE, MaterialColor.field30968).method26635().method26614().method26622())
   );
   public static final Block DEAD_BRAIN_CORAL = register(
      "dead_brain_coral", new DeadHornCoralBlock(AbstractBlock.Properties.withMaterialAndColor(Material.STONE, MaterialColor.field30968).method26635().method26614().method26622())
   );
   public static final Block DEAD_BUBBLE_CORAL = register(
      "dead_bubble_coral", new DeadHornCoralBlock(AbstractBlock.Properties.withMaterialAndColor(Material.STONE, MaterialColor.field30968).method26635().method26614().method26622())
   );
   public static final Block DEAD_FIRE_CORAL = register(
      "dead_fire_coral", new DeadHornCoralBlock(AbstractBlock.Properties.withMaterialAndColor(Material.STONE, MaterialColor.field30968).method26635().method26614().method26622())
   );
   public static final Block DEAD_HORN_CORAL = register(
      "dead_horn_coral", new DeadHornCoralBlock(AbstractBlock.Properties.withMaterialAndColor(Material.STONE, MaterialColor.field30968).method26635().method26614().method26622())
   );
   public static final Block TUBE_CORAL = register(
      "tube_coral",
      new FireCoralBlock(DEAD_TUBE_CORAL, AbstractBlock.Properties.withMaterialAndColor(Material.field38937, MaterialColor.field30972).method26614().method26622().method26619(SoundType.WET_GRASS))
   );
   public static final Block BRAIN_CORAL = register(
      "brain_coral",
      new FireCoralBlock(DEAD_BRAIN_CORAL, AbstractBlock.Properties.withMaterialAndColor(Material.field38937, MaterialColor.field30967).method26614().method26622().method26619(SoundType.WET_GRASS))
   );
   public static final Block BUBBLE_CORAL = register(
      "bubble_coral",
      new FireCoralBlock(DEAD_BUBBLE_CORAL, AbstractBlock.Properties.withMaterialAndColor(Material.field38937, MaterialColor.field30971).method26614().method26622().method26619(SoundType.WET_GRASS))
   );
   public static final Block FIRE_CORAL = register(
      "fire_coral",
      new FireCoralBlock(DEAD_FIRE_CORAL, AbstractBlock.Properties.withMaterialAndColor(Material.field38937, MaterialColor.field30975).method26614().method26622().method26619(SoundType.WET_GRASS))
   );
   public static final Block HORN_CORAL = register(
      "horn_coral",
      new FireCoralBlock(DEAD_HORN_CORAL, AbstractBlock.Properties.withMaterialAndColor(Material.field38937, MaterialColor.field30965).method26614().method26622().method26619(SoundType.WET_GRASS))
   );
   public static final Block DEAD_TUBE_CORAL_FAN = register(
      "dead_tube_coral_fan", new DeadHornCoralFanBlock(AbstractBlock.Properties.withMaterialAndColor(Material.STONE, MaterialColor.field30968).method26635().method26614().method26622())
   );
   public static final Block DEAD_BRAIN_CORAL_FAN = register(
      "dead_brain_coral_fan", new DeadHornCoralFanBlock(AbstractBlock.Properties.withMaterialAndColor(Material.STONE, MaterialColor.field30968).method26635().method26614().method26622())
   );
   public static final Block DEAD_BUBBLE_CORAL_FAN = register(
      "dead_bubble_coral_fan", new DeadHornCoralFanBlock(AbstractBlock.Properties.withMaterialAndColor(Material.STONE, MaterialColor.field30968).method26635().method26614().method26622())
   );
   public static final Block DEAD_FIRE_CORAL_FAN = register(
      "dead_fire_coral_fan", new DeadHornCoralFanBlock(AbstractBlock.Properties.withMaterialAndColor(Material.STONE, MaterialColor.field30968).method26635().method26614().method26622())
   );
   public static final Block DEAD_HORN_CORAL_FAN = register(
      "dead_horn_coral_fan", new DeadHornCoralFanBlock(AbstractBlock.Properties.withMaterialAndColor(Material.STONE, MaterialColor.field30968).method26635().method26614().method26622())
   );
   public static final Block TUBE_CORAL_FAN = register(
      "tube_coral_fan",
      new HornCoralFanBlock(DEAD_TUBE_CORAL_FAN, AbstractBlock.Properties.withMaterialAndColor(Material.field38937, MaterialColor.field30972).method26614().method26622().method26619(SoundType.WET_GRASS))
   );
   public static final Block BRAIN_CORAL_FAN = register(
      "brain_coral_fan",
      new HornCoralFanBlock(DEAD_BRAIN_CORAL_FAN, AbstractBlock.Properties.withMaterialAndColor(Material.field38937, MaterialColor.field30967).method26614().method26622().method26619(SoundType.WET_GRASS))
   );
   public static final Block BUBBLE_CORAL_FAN = register(
      "bubble_coral_fan",
      new HornCoralFanBlock(DEAD_BUBBLE_CORAL_FAN, AbstractBlock.Properties.withMaterialAndColor(Material.field38937, MaterialColor.field30971).method26614().method26622().method26619(SoundType.WET_GRASS))
   );
   public static final Block FIRE_CORAL_FAN = register(
      "fire_coral_fan",
      new HornCoralFanBlock(DEAD_FIRE_CORAL_FAN, AbstractBlock.Properties.withMaterialAndColor(Material.field38937, MaterialColor.field30975).method26614().method26622().method26619(SoundType.WET_GRASS))
   );
   public static final Block HORN_CORAL_FAN = register(
      "horn_coral_fan",
      new HornCoralFanBlock(DEAD_HORN_CORAL_FAN, AbstractBlock.Properties.withMaterialAndColor(Material.field38937, MaterialColor.field30965).method26614().method26622().method26619(SoundType.WET_GRASS))
   );
   public static final Block DEAD_TUBE_CORAL_WALL_FAN = register(
      "dead_tube_coral_wall_fan",
      new DeadHornCoralWallFanBlock(AbstractBlock.Properties.withMaterialAndColor(Material.STONE, MaterialColor.field30968).method26635().method26614().method26622().method26627(DEAD_TUBE_CORAL_FAN))
   );
   public static final Block DEAD_BRAIN_CORAL_WALL_FAN = register(
      "dead_brain_coral_wall_fan",
      new DeadHornCoralWallFanBlock(AbstractBlock.Properties.withMaterialAndColor(Material.STONE, MaterialColor.field30968).method26635().method26614().method26622().method26627(DEAD_BRAIN_CORAL_FAN))
   );
   public static final Block DEAD_BUBBLE_CORAL_WALL_FAN = register(
      "dead_bubble_coral_wall_fan",
      new DeadHornCoralWallFanBlock(AbstractBlock.Properties.withMaterialAndColor(Material.STONE, MaterialColor.field30968).method26635().method26614().method26622().method26627(DEAD_BUBBLE_CORAL_FAN))
   );
   public static final Block DEAD_FIRE_CORAL_WALL_FAN = register(
      "dead_fire_coral_wall_fan",
      new DeadHornCoralWallFanBlock(AbstractBlock.Properties.withMaterialAndColor(Material.STONE, MaterialColor.field30968).method26635().method26614().method26622().method26627(DEAD_FIRE_CORAL_FAN))
   );
   public static final Block DEAD_HORN_CORAL_WALL_FAN = register(
      "dead_horn_coral_wall_fan",
      new DeadHornCoralWallFanBlock(AbstractBlock.Properties.withMaterialAndColor(Material.STONE, MaterialColor.field30968).method26635().method26614().method26622().method26627(DEAD_HORN_CORAL_FAN))
   );
   ...
   public static final Block BLUE_ICE = register(
      "blue_ice", new HalfTransparentBlock(AbstractBlock.Properties.withMaterial(Material.field38952).method26623(2.8F).method26616(0.989F).method26619(SoundType.GLASS))
   );
   public static final Block CONDUIT = register(
      "conduit", new ConduitBlock(AbstractBlock.Properties.withMaterialAndColor(Material.field38963, MaterialColor.field30978).method26623(3.0F).method26620(var0 -> 15).method26615())
   );
   public static final Block BAMBOO_SAPLING = register(
      "bamboo_sapling",
      new BambooSaplingBlock(AbstractBlock.Properties.withMaterial(Material.field38958).method26624().method26622().method26614().method26623(1.0F).method26619(SoundType.BAMBOO_SAPLING))
   );
   ...
   public static final Block POTTED_BAMBOO = register(
      "potted_bamboo", new PottedWarpedRootsBlock(BAMBOO, AbstractBlock.Properties.withMaterial(Material.field38946).method26622().method26615())
   );
   ...
   public static final Block BUBBLE_COLUMN = register(
      "bubble_column", new BubbleColumnBlock(AbstractBlock.Properties.withMaterial(Material.field38942).method26614().method26626())
   );
   ...
   public static final Block SCAFFOLDING = register(
      "scaffolding",
      new ScaffoldingBlock(AbstractBlock.Properties.withMaterialAndColor(Material.field38946, MaterialColor.field30949).method26614().method26619(SoundType.SCAFFOLDING).method26625())
   );
   ...
   public static final Block WARPED_HYPHAE = register(
      "warped_hyphae", new StrippedCrimsonHyphaeBlock(AbstractBlock.Properties.withMaterialAndColor(Material.field38957, MaterialColor.field31004).method26623(2.0F).method26619(SoundType.STEM))
   );
   public static final Block STRIPPED_WARPED_HYPHAE = register(
      "stripped_warped_hyphae",
      new StrippedCrimsonHyphaeBlock(AbstractBlock.Properties.withMaterialAndColor(Material.field38957, MaterialColor.field31004).method26623(2.0F).method26619(SoundType.STEM))
   );
   ...
   public static final Block WARPED_ROOTS = register(
      "warped_roots",
      new CrimsonRootsBlock(AbstractBlock.Properties.withMaterialAndColor(Material.field38939, MaterialColor.field30970).method26614().method26622().method26619(SoundType.ROOTS))
   );
   public static final Block NETHER_SPROUTS = register(
      "nether_sprouts",
      new NetherSproutsBlock(AbstractBlock.Properties.withMaterialAndColor(Material.field38939, MaterialColor.field30970).method26614().method26622().method26619(SoundType.NETHER_ORE))
   );
   ...
   public static final Block CRIMSON_HYPHAE = register(
      "crimson_hyphae", new StrippedCrimsonHyphaeBlock(AbstractBlock.Properties.withMaterialAndColor(Material.field38957, MaterialColor.field31001).method26623(2.0F).method26619(SoundType.STEM))
   );
   public static final Block STRIPPED_CRIMSON_HYPHAE = register(
      "stripped_crimson_hyphae",
      new StrippedCrimsonHyphaeBlock(AbstractBlock.Properties.withMaterialAndColor(Material.field38957, MaterialColor.field31001).method26623(2.0F).method26619(SoundType.STEM))
   );
   ...
   public static final Block WEEPING_VINES_PLANT = register(
      "weeping_vines_plant",
      new WeepingVinesPlantBlock(AbstractBlock.Properties.withMaterialAndColor(Material.PLANTS, MaterialColor.field30982).method26614().method26622().method26619(SoundType.TWISTING_VINES))
   );
   ...
   public static final Block TWISTING_VINES_PLANT = register(
      ...
      new TwistingVinesPlantBlock(AbstractBlock.Properties.withMaterialAndColor(Material.PLANTS, MaterialColor.field30970).method26614().method26622().method26619(SoundType.TWISTING_VINES))
   );
   public static final Block CRIMSON_ROOTS = register(
      "crimson_roots",
      new CrimsonRootsBlock(AbstractBlock.Properties.withMaterialAndColor(Material.field38939, MaterialColor.field30982).method26614().method26622().method26619(SoundType.ROOTS))
   );
   ...
   public static final Block CRIMSON_FENCE = register(
      "crimson_fence",
      new WarpedFenceBlock(AbstractBlock.Properties.withMaterialAndColor(Material.field38957, field37091.method12000()).method26621(2.0F, 3.0F).method26619(SoundType.WOOD))
   );
   public static final Block WARPED_FENCE = register(
      "warped_fence",
      new WarpedFenceBlock(AbstractBlock.Properties.withMaterialAndColor(Material.field38957, field37092.method12000()).method26621(2.0F, 3.0F).method26619(SoundType.WOOD))
   );
   ...
   public static final Block COMPOSTER = register(
      "composter", new ComposterBlock(AbstractBlock.Properties.withMaterial(Material.PLANKS).method26623(0.6F).method26619(SoundType.WOOD))
   );
   public static final Block TARGET = register(
      "target", new TargetBlock(AbstractBlock.Properties.withMaterialAndColor(Material.GRASS, MaterialColor.DIORITE).method26623(0.5F).method26619(SoundType.GRASS))
   );
   public static final Block BEE_NEST = register(
      "bee_nest", new BeehiveBlock(AbstractBlock.Properties.withMaterialAndColor(Material.PLANKS, MaterialColor.field30965).method26623(0.3F).method26619(SoundType.WOOD))
   );
   public static final Block BEEHIVE = register(
      "beehive", new BeehiveBlock(AbstractBlock.Properties.withMaterial(Material.PLANKS).method26623(0.6F).method26619(SoundType.WOOD))
   );
   ...
   public static final Block CRYING_OBSIDIAN = register(
      "crying_obsidian",
      new CryingObsidianBlock(AbstractBlock.Properties.withMaterialAndColor(Material.STONE, MaterialColor.field30976).method26635().method26621(50.0F, 1200.0F).method26620(var0 -> 10))
   );
   ...
   public static final Block POTTED_CRIMSON_FUNGUS = register(
      "potted_crimson_fungus", new PottedWarpedRootsBlock(CRIMSON_FUNGUS, AbstractBlock.Properties.withMaterial(Material.field38946).method26622().method26615())
   );
   public static final Block POTTED_WARPED_FUNGUS = register(
      "potted_warped_fungus", new PottedWarpedRootsBlock(WARPED_FUNGUS, AbstractBlock.Properties.withMaterial(Material.field38946).method26622().method26615())
   );
   public static final Block POTTED_CRIMSON_ROOTS = register(
      "potted_crimson_roots", new PottedWarpedRootsBlock(CRIMSON_ROOTS, AbstractBlock.Properties.withMaterial(Material.field38946).method26622().method26615())
   );
   public static final Block POTTED_WARPED_ROOTS = register(
      "potted_warped_roots", new PottedWarpedRootsBlock(WARPED_ROOTS, AbstractBlock.Properties.withMaterial(Material.field38946).method26622().method26615())
   );
   ...
   public static final Block POLISHED_BLACKSTONE_PRESSURE_PLATE = register(
      ...
      new WarpedPressurePlateBlock(Class2275.field14824, AbstractBlock.Properties.withMaterialAndColor(Material.STONE, MaterialColor.field30976).method26635().method26614().method26623(0.5F))
   );
   ...
   private static StrippedCrimsonHyphaeBlock createLogBlock(MaterialColor var0, MaterialColor var1) {
      return new StrippedCrimsonHyphaeBlock(
         AbstractBlock.Properties.method26612(Material.PLANKS, var2 -> var2.get(StrippedCrimsonHyphaeBlock.field18994) != Direction.Axis.Y ? var1 : var0)
            .method26623(2.0F)
            .method26619(SoundType.WOOD)
      );
   }
