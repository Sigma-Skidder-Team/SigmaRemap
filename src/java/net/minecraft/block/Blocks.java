...
public class Blocks {
   ...
   public static final Block CHEST = register(
      "chest", new Class3348(AbstractBlock.Properties.method26609(Material.field38956).method26623(2.5F).method26619(SoundType.field36200), () -> TileEntityType.field21422)
   );
