...
public class WitherSkeletonSkullBlock extends CreeperHeadBlock {
   private static Class9803 field18857;
   private static Class9803 field18858;

   public WitherSkeletonSkullBlock(Properties var1) {
   ...
   public static void method11898(World var0, BlockPos var1, SkullTileEntity var2) {
      if (!var0.isRemote) {
         ...
         boolean var6 = var5.isIn(Blocks.WITHER_SKELETON_SKULL) || var5.isIn(Blocks.WITHER_SKELETON_WALL_SKULL);
