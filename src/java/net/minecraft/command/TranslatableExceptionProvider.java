...
public class TranslatableExceptionProvider implements BuiltInExceptionProvider
{
   ...
   private static final Dynamic2CommandExceptionType LONG_TOO_LOW = new Dynamic2CommandExceptionType((p_218034_0_, p_218034_1_) ->
   {
      return new TranslationTextComponent("argument.long.low", p_218034_1_, p_218034_0_);
   });
   private static final Dynamic2CommandExceptionType LONG_TOO_HIGH = new Dynamic2CommandExceptionType((p_218032_0_, p_218032_1_) ->
   {
