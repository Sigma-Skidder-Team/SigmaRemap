...
public class StructureSeparationSettings {
   public static final Codec<StructureSeparationSettings> field36361 = RecordCodecBuilder.<StructureSeparationSettings>create(
         var0 -> var0.group(
               ...
               .apply(var0, StructureSeparationSettings::new)
      )
      .comapFlatMap(
   ...
   public StructureSeparationSettings(int var1, int var2, int var3) {
