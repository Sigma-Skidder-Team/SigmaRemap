...
public class TicketType<T> {
   ...
   public static final TicketType<Unit> START = method30544("start", (var0, var1) -> 0);
   public static final TicketType<Unit> DRAGON = method30544("dragon", (var0, var1) -> 0);
   public static final TicketType<ChunkPos> PLAYER = method30544("player", Comparator.<ChunkPos>comparingLong(ChunkPos::asLong));
   public static final TicketType<ChunkPos> FORCED = method30544("forced", Comparator.<ChunkPos>comparingLong(ChunkPos::asLong));
   public static final TicketType<ChunkPos> LIGHT = method30544("light", Comparator.<ChunkPos>comparingLong(ChunkPos::asLong));
   public static final TicketType<BlockPos> PORTAL = method30545("portal", Vector3i::compareTo, 300);
   public static final TicketType<Integer> POST_TELEPORT = method30545("post_teleport", Integer::compareTo, 5);
   public static final TicketType<ChunkPos> UNKNOWN = method30545("unknown", Comparator.<ChunkPos>comparingLong(ChunkPos::asLong), 1);
