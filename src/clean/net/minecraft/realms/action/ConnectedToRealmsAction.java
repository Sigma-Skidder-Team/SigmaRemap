...
public class ConnectedToRealmsAction extends LongRunningTask
{
    ...
    public ConnectedToRealmsAction(Screen p_i242121_1_, RealmsServer p_i242121_2_, RealmsServerAddress p_i242121_3_)
    {
        this.field_244784_d = p_i242121_2_;
        this.field_238110_d_ = p_i242121_3_;
        this.field_238109_c_ = new RealmsConnect(p_i242121_1_);
    }
