...
public class SEncryptionRequestPacket implements IPacket<IClientLoginNetHandler>
{
    ...
    public SEncryptionRequestPacket(String p_i242136_1_, byte[] p_i242136_2_, byte[] p_i242136_3_)
    {
        this.hashedServerId = p_i242136_1_;
        this.publicKey = p_i242136_2_;
        this.verifyToken = p_i242136_3_;
    }
