...
public class CEditBookPacket implements IPacket<IServerPlayNetHandler>
{
    ...
    public CEditBookPacket(ItemStack p_i242137_1_, boolean p_i242137_2_, int p_i242137_3_)
    {
        this.stack = p_i242137_1_.copy();
        this.updateAll = p_i242137_2_;
        this.field_244707_c = p_i242137_3_;
    }
