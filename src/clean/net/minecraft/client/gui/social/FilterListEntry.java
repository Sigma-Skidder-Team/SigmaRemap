...
public class FilterListEntry extends AbstractOptionList.Entry<FilterListEntry>
{
    ...
    public FilterListEntry(Minecraft p_i242123_1_, SocialInteractionsScreen p_i242123_2_, UUID p_i242123_3_, String p_i242123_4_, Supplier<ResourceLocation> p_i242123_5_)
    {
        this.field_244620_e = p_i242123_1_;
        this.field_244622_g = p_i242123_3_;
        this.field_244623_h = p_i242123_4_;
        this.field_244742_j = p_i242123_5_;
        this.field_244628_m = p_i242123_1_.fontRenderer.trimStringToWidth(new TranslationTextComponent("gui.socialInteractions.tooltip.hide", p_i242123_4_), 150);
        this.field_244629_n = p_i242123_1_.fontRenderer.trimStringToWidth(new TranslationTextComponent("gui.socialInteractions.tooltip.show", p_i242123_4_), 150);
        FilterManager filtermanager = p_i242123_1_.func_244599_aA();

        if (!p_i242123_1_.player.getGameProfile().getId().equals(p_i242123_3_) && !filtermanager.func_244757_e(p_i242123_3_))
        {
            this.field_244626_k = new ImageButton(0, 0, 20, 20, 0, 38, 20, SocialInteractionsScreen.field_244666_a, 256, 256, (p_244751_4_) ->
            {
                filtermanager.func_244646_a(p_i242123_3_);
                this.func_244635_a(true, new TranslationTextComponent("gui.socialInteractions.hidden_in_chat", p_i242123_4_));
            }, (p_244637_3_, p_244637_4_, p_244637_5_, p_244637_6_) ->
            {
                this.field_244630_o += p_i242123_1_.getTickLength();

                if (this.field_244630_o >= 10.0F)
                {
                    p_i242123_2_.func_244684_a(() ->
                    {
                        func_244634_a(p_i242123_2_, p_244637_4_, this.field_244628_m, p_244637_5_, p_244637_6_);
                    });
                }
            ...
            {
                filtermanager.func_244647_b(p_i242123_3_);
                this.func_244635_a(false, new TranslationTextComponent("gui.socialInteractions.shown_in_chat", p_i242123_4_));
            }, (p_244631_3_, p_244631_4_, p_244631_5_, p_244631_6_) ->
            {
                ...
                if (this.field_244630_o >= 10.0F)
                {
                    p_i242123_2_.func_244684_a(() ->
                    {
                        func_244634_a(p_i242123_2_, p_244631_4_, this.field_244629_n, p_244631_5_, p_244631_6_);
                    });
                }
            ...
            this.field_244627_l.visible = filtermanager.func_244648_c(p_i242123_3_);
