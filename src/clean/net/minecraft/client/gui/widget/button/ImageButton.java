...
public class ImageButton extends Button
{
    ...
    public ImageButton(int p_i242131_1_, int p_i242131_2_, int p_i242131_3_, int p_i242131_4_, int p_i242131_5_, int p_i242131_6_, int p_i242131_7_, ResourceLocation p_i242131_8_, int p_i242131_9_, int p_i242131_10_, Button.IPressable p_i242131_11_, Button.ITooltip p_i242131_12_, ITextComponent p_i242131_13_)
    {
        super(p_i242131_1_, p_i242131_2_, p_i242131_3_, p_i242131_4_, p_i242131_13_, p_i242131_11_, p_i242131_12_);
        this.textureWidth = p_i242131_9_;
        this.textureHeight = p_i242131_10_;
        this.xTexStart = p_i242131_5_;
        this.yTexStart = p_i242131_6_;
        this.yDiffText = p_i242131_7_;
        this.resourceLocation = p_i242131_8_;
    }
