...
public class ItemOverrideList
{
    ...
    public ItemOverrideList(ModelBakery p_i242108_1_, IUnbakedModel p_i242108_2_, Function<ResourceLocation, IUnbakedModel> p_i242108_3_, Function<RenderMaterial, TextureAtlasSprite> p_i242108_4_, List<ItemOverride> p_i242108_5_)
    {
        this.overrideBakedModels = p_i242108_5_.stream().map((p_lambda$new$0_4_) ->
        {
            IUnbakedModel iunbakedmodel = p_i242108_3_.apply(p_lambda$new$0_4_.getLocation());
            return Objects.equals(iunbakedmodel, p_i242108_2_) ? null : p_i242108_1_.getBakedModel(p_lambda$new$0_4_.getLocation(), ModelRotation.X0_Y0, p_i242108_4_);
        }).collect(Collectors.toList());
        Collections.reverse(this.overrideBakedModels);

        for (int i = p_i242108_5_.size() - 1; i >= 0; --i)
        {
            this.overrides.add(p_i242108_5_.get(i));
        }
