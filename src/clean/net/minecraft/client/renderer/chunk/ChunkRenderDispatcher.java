...
public class ChunkRenderDispatcher
{
    ...
    public ChunkRenderDispatcher(World p_i242107_1_, WorldRenderer p_i242107_2_, Executor p_i242107_3_, boolean p_i242107_4_, RegionRenderCacheBuilder p_i242107_5_, int p_i242107_6_)
    {
        this.world = p_i242107_1_;
        this.worldRenderer = p_i242107_2_;
        ...
        int k = p_i242107_4_ ? j : Math.min(j, 4);
        ...
        this.fixedBuilder = p_i242107_5_;
        ...
        this.executor = p_i242107_3_;
        this.delegatedTaskExecutor = DelegatedTaskExecutor.create(p_i242107_3_, "Chunk Renderer");
    ...
    public class ChunkRender implements IForgeRenderChunk
    {
        ...
        abstract class ChunkRenderTask implements Comparable<ChunkRenderDispatcher.ChunkRender.ChunkRenderTask>
        {
            ...
            public ChunkRenderTask(ChunkPos p_i242113_2_, double p_i242113_3_)
            {
                this.distanceSq = p_i242113_3_;

                if (p_i242113_2_ == null)
                {
                    this.modelData = Collections.emptyMap();
                }
                else
                {
                    this.modelData = ModelDataManager.getModelData(Minecraft.getInstance().world, p_i242113_2_);
                }
            }
        ...
        class RebuildTask extends ChunkRenderDispatcher.ChunkRender.ChunkRenderTask
        {
            ...
            public RebuildTask(ChunkPos p_i242106_2_, @Nullable double p_i242106_3_, ChunkRenderCache p_i242106_5_)
            {
                super(p_i242106_2_, p_i242106_3_);
                this.chunkRenderCache = p_i242106_5_;
            }
        ...
        class SortTransparencyTask extends ChunkRenderDispatcher.ChunkRender.ChunkRenderTask
        {
            ...
            public SortTransparencyTask(ChunkPos p_i242101_2_, double p_i242101_3_, ChunkRenderDispatcher.CompiledChunk p_i242101_5_)
            {
                super(p_i242101_2_, p_i242101_3_);
                this.sortCompiledChunk = p_i242101_5_;
            }
