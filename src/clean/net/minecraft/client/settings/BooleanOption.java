...
public class BooleanOption extends AbstractOption
{
    ...
    public BooleanOption(String p_i242124_1_, @Nullable ITextComponent p_i242124_2_, Predicate<GameSettings> p_i242124_3_, BiConsumer<GameSettings, Boolean> p_i242124_4_)
    {
        super(p_i242124_1_);
        this.getter = p_i242124_3_;
        this.setter = p_i242124_4_;
        this.field_244785_aa = p_i242124_2_;
    }
