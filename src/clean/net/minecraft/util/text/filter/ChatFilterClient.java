...
public class ChatFilterClient implements AutoCloseable
{
    ...
    {
        private ConnectionException(String p_i242132_1_)
        {
            super(p_i242132_1_);
        }
    }
    ...
    class ProfileFilter implements IChatFilter
    {
        ...
        private ProfileFilter(GameProfile p_i242138_2_)
        {
            this.field_244585_b = p_i242138_2_;
            DelegatedTaskExecutor<Runnable> delegatedtaskexecutor = DelegatedTaskExecutor.create(ChatFilterClient.this.field_244559_k, "chat stream for " + p_i242138_2_.getName());
