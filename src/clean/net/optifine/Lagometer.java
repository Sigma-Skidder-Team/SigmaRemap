    ...
    public static void showLagometer(MatrixStack matrixStackIn, int scaleFactor)
    {
        if (gameSettings != null)
        {
            if (gameSettings.ofLagometer || gameSettings.showLagometer)
            {
                ...
                int l2 = k - 80;
                int i3 = k - 160;
                mc.fontRenderer.drawString(matrixStackIn, "30", 2.0F, (float)(i3 + 1), -8947849);
                mc.fontRenderer.drawString(matrixStackIn, "30", 1.0F, (float)i3, -3881788);
                mc.fontRenderer.drawString(matrixStackIn, "60", 2.0F, (float)(l2 + 1), -8947849);
                mc.fontRenderer.drawString(matrixStackIn, "60", 1.0F, (float)l2, -3881788);
                GlStateManager.matrixMode(5889);
                ...
                int j3 = (int)(170.0F + f1 * 85.0F);
                int k1 = (int)(100.0F + f1 * 55.0F);
                int l1 = (int)(10.0F + f1 * 10.0F);
                int i2 = j3 << 16 | k1 << 8 | l1;
                int j2 = 512 / scaleFactor + 2;
                int k2 = k / scaleFactor - 8;
                IngameGui ingamegui = mc.ingameGUI;
                IngameGui.fill(matrixStackIn, j2 - 1, k2 - 1, j2 + 50, k2 + 10, -1605349296);
                mc.fontRenderer.drawString(matrixStackIn, " " + MemoryMonitor.getAllocationRateMb() + " MB/s", (float)j2, (float)k2, i2);
