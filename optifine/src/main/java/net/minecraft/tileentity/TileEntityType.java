...
public class TileEntityType<T extends TileEntity>
{
    ...
    public TileEntityType(Supplier <? extends T > worldIn, Set<Block> xCoordIn, Type<?> p_i1230_3_)
    {
        this.factory = worldIn;
        this.validBlocks = xCoordIn;
        this.datafixerType = p_i1230_3_;
    }
    ...
    public static final class Builder<T extends TileEntity>
    {
        ...
        private Builder(Supplier <? extends T > p_i3924_1_, Set<Block> p_i3924_2_)
        {
            this.factory = p_i3924_1_;
            this.blocks = p_i3924_2_;
        }
