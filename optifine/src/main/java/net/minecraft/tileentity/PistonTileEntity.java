...
public class PistonTileEntity extends TileEntity implements ITickableTileEntity
{
    ...
    public PistonTileEntity(BlockState p_i3067_1_, Direction p_i3067_2_, boolean p_i3067_3_, boolean p_i3067_4_)
    {
        this();
        this.pistonState = p_i3067_1_;
        this.pistonFacing = p_i3067_2_;
        this.extending = p_i3067_3_;
        this.shouldHeadBeRendered = p_i3067_4_;
    }
