...
public class FluidPredicate
{
    ...
    public FluidPredicate(@Nullable Tag<Fluid> p_i2086_1_, @Nullable Fluid p_i2086_2_, StatePropertiesPredicate p_i2086_3_)
    {
        this.field_226644_b_ = p_i2086_1_;
        this.field_226645_c_ = p_i2086_2_;
        this.field_226646_d_ = p_i2086_3_;
    }
