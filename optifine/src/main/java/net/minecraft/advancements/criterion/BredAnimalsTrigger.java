...
public class BredAnimalsTrigger extends AbstractCriterionTrigger<BredAnimalsTrigger.Instance>
{
    ...
    public static class Instance extends CriterionInstance
    {
        ...
        public Instance(EntityPredicate p_i3642_1_, EntityPredicate p_i3642_2_, EntityPredicate p_i3642_3_)
        {
            super(BredAnimalsTrigger.ID);
            this.parent = p_i3642_1_;
            this.partner = p_i3642_2_;
            this.child = p_i3642_3_;
        }
