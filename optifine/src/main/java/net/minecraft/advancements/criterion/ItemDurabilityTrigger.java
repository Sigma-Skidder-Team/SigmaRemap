...
public class ItemDurabilityTrigger extends AbstractCriterionTrigger<ItemDurabilityTrigger.Instance>
{
    ...
    public static class Instance extends CriterionInstance
    {
        ...
        public Instance(ItemPredicate p_i1082_1_, MinMaxBounds.IntBound p_i1082_2_, MinMaxBounds.IntBound p_i1082_3_)
        {
            super(ItemDurabilityTrigger.ID);
            this.item = p_i1082_1_;
            this.durability = p_i1082_2_;
            this.delta = p_i1082_3_;
        }
