...
public class RightClickBlockWithItemTrigger extends AbstractCriterionTrigger<RightClickBlockWithItemTrigger.Instance>
{
    ...
    public RightClickBlockWithItemTrigger(ResourceLocation p_i2635_1_)
    {
        this.field_226692_a_ = p_i2635_1_;
    }
    ...
    public static class Instance extends CriterionInstance
    {
        ...
        public Instance(ResourceLocation p_i1820_1_, BlockPredicate p_i1820_2_, StatePropertiesPredicate p_i1820_3_, ItemPredicate p_i1820_4_)
        {
            super(p_i1820_1_);
            this.field_226696_a_ = p_i1820_2_;
            this.field_226697_b_ = p_i1820_3_;
            this.field_226698_c_ = p_i1820_4_;
        }
