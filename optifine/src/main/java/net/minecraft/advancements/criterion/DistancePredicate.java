...
public class DistancePredicate
{
    ...
    public DistancePredicate(MinMaxBounds.FloatBound p_i4028_1_, MinMaxBounds.FloatBound p_i4028_2_, MinMaxBounds.FloatBound p_i4028_3_, MinMaxBounds.FloatBound p_i4028_4_, MinMaxBounds.FloatBound p_i4028_5_)
    {
        this.x = p_i4028_1_;
        this.y = p_i4028_2_;
        this.z = p_i4028_3_;
        this.horizontal = p_i4028_4_;
        this.absolute = p_i4028_5_;
    }
