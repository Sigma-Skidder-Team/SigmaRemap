...
public class ItemPredicate
{
    ...
    public ItemPredicate(@Nullable Tag<Item> p_i3153_1_, @Nullable Item p_i3153_2_, MinMaxBounds.IntBound p_i3153_3_, MinMaxBounds.IntBound p_i3153_4_, EnchantmentPredicate[] p_i3153_5_, EnchantmentPredicate[] p_i3153_6_, @Nullable Potion p_i3153_7_, NBTPredicate p_i3153_8_)
    {
        this.tag = p_i3153_1_;
        this.item = p_i3153_2_;
        this.count = p_i3153_3_;
        this.durability = p_i3153_4_;
        this.enchantments = p_i3153_5_;
        this.field_226656_g_ = p_i3153_6_;
        this.potion = p_i3153_7_;
        this.nbt = p_i3153_8_;
    }
