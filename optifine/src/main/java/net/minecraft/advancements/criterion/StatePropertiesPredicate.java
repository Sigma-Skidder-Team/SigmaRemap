...
public class StatePropertiesPredicate
{
    ...
    private StatePropertiesPredicate(List<StatePropertiesPredicate.Matcher> p_i1313_1_)
    {
        this.matchers = ImmutableList.copyOf(p_i1313_1_);
    }
    ...
    static class ExactMatcher extends StatePropertiesPredicate.Matcher
    {
        ...
        public ExactMatcher(String p_i3608_1_, String p_i3608_2_)
        {
            super(p_i3608_1_);
            this.valueToMatch = p_i3608_2_;
        }
    ...
    abstract static class Matcher
    {
        ...
        public Matcher(String p_i287_1_)
        {
            this.propertyName = p_i287_1_;
        }
    ...
    static class RangedMacher extends StatePropertiesPredicate.Matcher
    {
        ...
        public RangedMacher(String p_i690_1_, @Nullable String p_i690_2_, @Nullable String p_i690_3_)
        {
            super(p_i690_1_);
            this.minimum = p_i690_2_;
            this.field_227203_b_ = p_i690_3_;
        }
