...
public class InventoryChangeTrigger extends AbstractCriterionTrigger<InventoryChangeTrigger.Instance>
{
    ...
    public static class Instance extends CriterionInstance
    {
        ...
        public Instance(MinMaxBounds.IntBound p_i2329_1_, MinMaxBounds.IntBound p_i2329_2_, MinMaxBounds.IntBound p_i2329_3_, ItemPredicate[] p_i2329_4_)
        {
            super(InventoryChangeTrigger.ID);
            this.occupied = p_i2329_1_;
            this.full = p_i2329_2_;
            this.empty = p_i2329_3_;
            this.items = p_i2329_4_;
        }
