...
public class MobEffectsPredicate
{
    ...
    public MobEffectsPredicate(Map<Effect, MobEffectsPredicate.InstancePredicate> p_i2527_1_)
    {
        this.effects = p_i2527_1_;
    }
    ...
    public static class InstancePredicate
    {
        ...
        public InstancePredicate(MinMaxBounds.IntBound p_i726_1_, MinMaxBounds.IntBound p_i726_2_, @Nullable Boolean p_i726_3_, @Nullable Boolean p_i726_4_)
        {
            this.amplifier = p_i726_1_;
            this.duration = p_i726_2_;
            this.ambient = p_i726_3_;
            this.visible = p_i726_4_;
        }
