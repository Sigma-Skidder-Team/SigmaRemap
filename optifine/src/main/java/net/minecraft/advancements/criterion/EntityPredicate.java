...
public class EntityPredicate
{
    ...
    private EntityPredicate(EntityTypePredicate p_i3859_1_, DistancePredicate p_i3859_2_, LocationPredicate p_i3859_3_, MobEffectsPredicate p_i3859_4_, NBTPredicate p_i3859_5_, EntityFlagsPredicate p_i3859_6_, EntityEquipmentPredicate p_i3859_7_, PlayerPredicate p_i3859_8_, @Nullable String p_i3859_9_, @Nullable ResourceLocation p_i3859_10_)
    {
        this.type = p_i3859_1_;
        this.distance = p_i3859_2_;
        this.location = p_i3859_3_;
        this.effects = p_i3859_4_;
        this.nbt = p_i3859_5_;
        this.flags = p_i3859_6_;
        this.equipment = p_i3859_7_;
        this.field_226609_j_ = p_i3859_8_;
        this.field_226610_k_ = p_i3859_9_;
        this.catType = p_i3859_10_;
    }
