...
public class LocationPredicate
{
    ...
    public LocationPredicate(MinMaxBounds.FloatBound p_i2486_1_, MinMaxBounds.FloatBound p_i2486_2_, MinMaxBounds.FloatBound p_i2486_3_, @Nullable Biome p_i2486_4_, @Nullable Structure<?> p_i2486_5_, @Nullable DimensionType p_i2486_6_, LightPredicate p_i2486_7_, BlockPredicate p_i2486_8_, FluidPredicate p_i2486_9_)
    {
        this.x = p_i2486_1_;
        this.y = p_i2486_2_;
        this.z = p_i2486_3_;
        this.biome = p_i2486_4_;
        this.feature = p_i2486_5_;
        this.dimension = p_i2486_6_;
        this.field_226864_h_ = p_i2486_7_;
        this.field_226865_i_ = p_i2486_8_;
        this.field_226866_j_ = p_i2486_9_;
    }
