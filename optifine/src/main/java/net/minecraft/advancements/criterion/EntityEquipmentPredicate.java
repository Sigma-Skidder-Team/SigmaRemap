...
public class EntityEquipmentPredicate
{
    ...
    public EntityEquipmentPredicate(ItemPredicate p_i976_1_, ItemPredicate p_i976_2_, ItemPredicate p_i976_3_, ItemPredicate p_i976_4_, ItemPredicate p_i976_5_, ItemPredicate p_i976_6_)
    {
        this.head = p_i976_1_;
        this.chest = p_i976_2_;
        this.legs = p_i976_3_;
        this.feet = p_i976_4_;
        this.mainHand = p_i976_5_;
        this.offHand = p_i976_6_;
    }
