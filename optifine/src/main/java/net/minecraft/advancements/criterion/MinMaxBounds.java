...
public abstract class MinMaxBounds<T extends Number>
{
    ...
    protected MinMaxBounds(@Nullable T p_i3932_1_, @Nullable T p_i3932_2_)
    {
        this.min = p_i3932_1_;
        this.max = p_i3932_2_;
    }
    ...
    public static class FloatBound extends MinMaxBounds<Float>
    {
        ...
        private FloatBound(@Nullable Float p_i3335_1_, @Nullable Float p_i3335_2_)
        {
            super(p_i3335_1_, p_i3335_2_);
            this.minSquared = square(p_i3335_1_);
            this.maxSquared = square(p_i3335_2_);
        }
    ...
    public static class IntBound extends MinMaxBounds<Integer>
    {
        ...
        private IntBound(@Nullable Integer p_i2769_1_, @Nullable Integer p_i2769_2_)
        {
            super(p_i2769_1_, p_i2769_2_);
            this.minSquared = square(p_i2769_1_);
            this.maxSquared = square(p_i2769_2_);
        }
