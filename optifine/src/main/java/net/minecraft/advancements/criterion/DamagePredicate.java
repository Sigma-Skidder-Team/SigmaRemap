...
public class DamagePredicate
{
    ...
    public DamagePredicate(MinMaxBounds.FloatBound p_i2225_1_, MinMaxBounds.FloatBound p_i2225_2_, EntityPredicate p_i2225_3_, @Nullable Boolean p_i2225_4_, DamageSourcePredicate p_i2225_5_)
    {
        this.dealt = p_i2225_1_;
        this.taken = p_i2225_2_;
        this.sourceEntity = p_i2225_3_;
        this.blocked = p_i2225_4_;
        this.type = p_i2225_5_;
    }
