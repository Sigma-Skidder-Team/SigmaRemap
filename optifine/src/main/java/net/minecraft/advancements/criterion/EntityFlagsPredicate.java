...
public class EntityFlagsPredicate
{
    ...
    public EntityFlagsPredicate(@Nullable Boolean p_i397_1_, @Nullable Boolean p_i397_2_, @Nullable Boolean p_i397_3_, @Nullable Boolean p_i397_4_, @Nullable Boolean p_i397_5_)
    {
        this.onFire = p_i397_1_;
        this.field_226569_c_ = p_i397_2_;
        this.sprinting = p_i397_3_;
        this.swimming = p_i397_4_;
        this.baby = p_i397_5_;
    }
