...
public class PlayerPredicate
{
    ...
    private PlayerPredicate(MinMaxBounds.IntBound p_i4252_1_, GameType p_i4252_2_, Map < Stat<?>, MinMaxBounds.IntBound > p_i4252_3_, Object2BooleanMap<ResourceLocation> p_i4252_4_, Map<ResourceLocation, PlayerPredicate.IAdvancementPredicate> p_i4252_5_)
    {
        this.field_226990_b_ = p_i4252_1_;
        this.field_226991_c_ = p_i4252_2_;
        this.field_226992_d_ = p_i4252_3_;
        this.field_226993_e_ = p_i4252_4_;
        this.field_226994_f_ = p_i4252_5_;
    }
    ...
    static class CompletedAdvancementPredicate implements PlayerPredicate.IAdvancementPredicate
    {
        ...
        public CompletedAdvancementPredicate(boolean p_i2833_1_)
        {
            this.field_227006_a_ = p_i2833_1_;
        }
    ...
    static class CriteriaPredicate implements PlayerPredicate.IAdvancementPredicate
    {
        ...
        public CriteriaPredicate(Object2BooleanMap<String> p_i1660_1_)
        {
            this.field_227005_a_ = p_i1660_1_;
        }
