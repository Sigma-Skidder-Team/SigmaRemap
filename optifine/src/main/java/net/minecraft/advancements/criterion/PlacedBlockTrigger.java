...
public class PlacedBlockTrigger extends AbstractCriterionTrigger<PlacedBlockTrigger.Instance>
{
    ...
    public static class Instance extends CriterionInstance
    {
        ...
        public Instance(@Nullable Block p_i335_1_, StatePropertiesPredicate p_i335_2_, LocationPredicate p_i335_3_, ItemPredicate p_i335_4_)
        {
            super(PlacedBlockTrigger.ID);
            this.block = p_i335_1_;
            this.properties = p_i335_2_;
            this.location = p_i335_3_;
            this.item = p_i335_4_;
        }
