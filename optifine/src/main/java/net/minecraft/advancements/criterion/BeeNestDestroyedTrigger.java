...
public class BeeNestDestroyedTrigger extends AbstractCriterionTrigger<BeeNestDestroyedTrigger.Instance>
{
    ...
    public static class Instance extends CriterionInstance
    {
        ...
        public Instance(Block p_i1464_1_, ItemPredicate p_i1464_2_, MinMaxBounds.IntBound p_i1464_3_)
        {
            super(BeeNestDestroyedTrigger.field_226219_a_);
            this.field_226225_a_ = p_i1464_1_;
            this.field_226226_b_ = p_i1464_2_;
            this.field_226227_c_ = p_i1464_3_;
        }
