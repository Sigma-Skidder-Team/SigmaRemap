...
public class DamageSourcePredicate
{
    ...
    public DamageSourcePredicate(@Nullable Boolean hostIn, @Nullable Boolean portIn, @Nullable Boolean p_i1121_3_, @Nullable Boolean p_i1121_4_, @Nullable Boolean p_i1121_5_, @Nullable Boolean p_i1121_6_, @Nullable Boolean p_i1121_7_, @Nullable Boolean p_i1121_8_, EntityPredicate p_i1121_9_, EntityPredicate p_i1121_10_)
    {
        this.isProjectile = hostIn;
        this.isExplosion = portIn;
        this.bypassesArmor = p_i1121_3_;
        this.bypassesInvulnerability = p_i1121_4_;
        this.bypassesMagic = p_i1121_5_;
        this.isFire = p_i1121_6_;
        this.isMagic = p_i1121_7_;
        this.field_217953_i = p_i1121_8_;
        this.directEntity = p_i1121_9_;
        this.sourceEntity = p_i1121_10_;
    }
