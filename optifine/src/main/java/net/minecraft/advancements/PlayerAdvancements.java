...
public class PlayerAdvancements
{
    ...
    public PlayerAdvancements(MinecraftServer p_i640_1_, File p_i640_2_, ServerPlayerEntity p_i640_3_)
    {
        this.server = p_i640_1_;
        this.progressFile = p_i640_2_;
        this.player = p_i640_3_;
        this.load();
    }
