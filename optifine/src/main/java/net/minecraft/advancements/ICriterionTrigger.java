...
public interface ICriterionTrigger<T extends ICriterionInstance>
{
    ...
    public static class Listener<T extends ICriterionInstance>
    {
        ...
        public Listener(T p_i3307_1_, Advancement p_i3307_2_, String p_i3307_3_)
        {
            this.criterionInstance = p_i3307_1_;
            this.advancement = p_i3307_2_;
            this.criterionName = p_i3307_3_;
        }
