...
public class RedstoneParticleData implements IParticleData
{
    ...
    public RedstoneParticleData(float p_i1128_1_, float p_i1128_2_, float p_i1128_3_, float p_i1128_4_)
    {
        this.red = p_i1128_1_;
        this.green = p_i1128_2_;
        this.blue = p_i1128_3_;
        this.alpha = MathHelper.clamp(p_i1128_4_, 0.01F, 4.0F);
    }
