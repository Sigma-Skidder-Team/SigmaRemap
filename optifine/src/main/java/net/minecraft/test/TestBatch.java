...
public class TestBatch
{
    ...
    public TestBatch(String p_i3033_1_, Collection<TestFunctionInfo> p_i3033_2_, @Nullable Consumer<ServerWorld> p_i3033_3_)
    {
        if (p_i3033_2_.isEmpty())
        {
            throw new IllegalArgumentException("A GameTestBatch must include at least one TestFunction!");
        }
        else
        {
            this.field_229460_a_ = p_i3033_1_;
            this.field_229461_b_ = p_i3033_2_;
            this.field_229462_c_ = p_i3033_3_;
        }
    }
