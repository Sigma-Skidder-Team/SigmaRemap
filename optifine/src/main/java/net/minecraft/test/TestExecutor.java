...
public class TestExecutor
{
    ...
    public TestExecutor(Collection<TestBatch> p_i420_1_, BlockPos p_i420_2_, ServerWorld p_i420_3_, TestCollection p_i420_4_)
    {
        this.field_229474_i_ = new BlockPos.Mutable(p_i420_2_);
        this.field_229467_b_ = p_i420_2_;
        this.field_229468_c_ = p_i420_3_;
        this.field_229469_d_ = p_i420_4_;
        p_i420_1_.forEach((p_229481_2_) ->
        {
            Collection<TestTracker> collection = Lists.newArrayList();

            for (TestFunctionInfo testfunctioninfo : p_229481_2_.func_229465_b_())
            {
                TestTracker testtracker = new TestTracker(testfunctioninfo, p_i420_3_);
