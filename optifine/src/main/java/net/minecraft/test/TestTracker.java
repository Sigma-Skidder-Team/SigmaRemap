...
public class TestTracker
{
    ...
    public TestTracker(TestFunctionInfo p_i2719_1_, ServerWorld p_i2719_2_)
    {
        this.field_229488_a_ = p_i2719_1_;
        this.field_229490_c_ = p_i2719_2_;
        this.field_229492_e_ = p_i2719_1_.func_229660_c_();
    }

    public TestTracker(TestFunctionInfo p_i2720_1_, BlockPos p_i2720_2_, ServerWorld p_i2720_3_)
    {
        this(p_i2720_1_, p_i2720_3_);
        this.func_229503_a_(p_i2720_2_);
    }
