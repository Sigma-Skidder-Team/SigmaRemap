...
public class SoundType
{
    ...
    public SoundType(float p_i1442_1_, float p_i1442_2_, SoundEvent p_i1442_3_, SoundEvent p_i1442_4_, SoundEvent p_i1442_5_, SoundEvent p_i1442_6_, SoundEvent p_i1442_7_)
    {
        this.volume = p_i1442_1_;
        this.pitch = p_i1442_2_;
        this.breakSound = p_i1442_3_;
        this.stepSound = p_i1442_4_;
        this.placeSound = p_i1442_5_;
        this.hitSound = p_i1442_6_;
        this.fallSound = p_i1442_7_;
    }
