...
public class RailState
{
    ...
    public RailState(World p_i3058_1_, BlockPos p_i3058_2_, BlockState p_i3058_3_)
    {
        this.world = p_i3058_1_;
        this.pos = p_i3058_2_;
        this.newState = p_i3058_3_;
        this.block = (AbstractRailBlock)p_i3058_3_.getBlock();
        RailShape railshape = p_i3058_3_.get(this.block.getShapeProperty());
