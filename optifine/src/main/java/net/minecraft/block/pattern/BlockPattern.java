...
public class BlockPattern
{
    ...
    public BlockPattern(Predicate<CachedBlockInfo>[][][] p_i3941_1_)
    {
        this.blockMatches = p_i3941_1_;
        this.fingerLength = p_i3941_1_.length;

        if (this.fingerLength > 0)
        {
            this.thumbLength = p_i3941_1_[0].length;

            if (this.thumbLength > 0)
            {
                this.palmLength = p_i3941_1_[0][0].length;
            }
            else
            {
                this.palmLength = 0;
    ...
    static class CacheLoader extends com.google.common.cache.CacheLoader<BlockPos, CachedBlockInfo>
    {
        ...
        public CacheLoader(IWorldReader p_i2281_1_, boolean p_i2281_2_)
        {
            this.world = p_i2281_1_;
            this.forceLoad = p_i2281_2_;
        }
    ...
    public static class PatternHelper
    {
        ...
        public PatternHelper(BlockPos p_i1834_1_, Direction p_i1834_2_, Direction p_i1834_3_, LoadingCache<BlockPos, CachedBlockInfo> p_i1834_4_, int p_i1834_5_, int p_i1834_6_, int p_i1834_7_)
        {
            this.frontTopLeft = p_i1834_1_;
            this.forwards = p_i1834_2_;
            this.up = p_i1834_3_;
            this.lcache = p_i1834_4_;
            this.width = p_i1834_5_;
            this.height = p_i1834_6_;
            this.depth = p_i1834_7_;
        }
    ...
    public static class PortalInfo
    {
        ...
        public PortalInfo(Vec3d p_i916_1_, Vec3d p_i916_2_, int p_i916_3_)
        {
            this.pos = p_i916_1_;
            this.motion = p_i916_2_;
            this.rotation = p_i916_3_;
        }
    }
}
