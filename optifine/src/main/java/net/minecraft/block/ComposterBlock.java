...
public class ComposterBlock extends Block implements ISidedInventoryProvider
{
    ...
    public ComposterBlock(Block.Properties p_i1754_1_)
    {
        super(p_i1754_1_);
    ...
    static class FullInventory extends Inventory implements ISidedInventory
    {
        ...
        public FullInventory(BlockState p_i2523_1_, IWorld p_i2523_2_, BlockPos p_i2523_3_, ItemStack p_i2523_4_)
        {
            super(p_i2523_4_);
            this.state = p_i2523_1_;
            this.world = p_i2523_2_;
            this.pos = p_i2523_3_;
        }
    ...
    static class PartialInventory extends Inventory implements ISidedInventory
    {
        ...
        public PartialInventory(BlockState p_i3031_1_, IWorld p_i3031_2_, BlockPos p_i3031_3_)
        {
            super(1);
            this.state = p_i3031_1_;
            this.world = p_i3031_2_;
            this.pos = p_i3031_3_;
        }
