...
public class FourWayBlock extends Block implements IWaterLoggable
{
    ...
    protected FourWayBlock(float p_i3375_1_, float p_i3375_2_, float p_i3375_3_, float p_i3375_4_, float p_i3375_5_, Block.Properties p_i3375_6_)
    {
        super(p_i3375_6_);
        this.collisionShapes = this.makeShapes(p_i3375_1_, p_i3375_2_, p_i3375_5_, 0.0F, p_i3375_5_);
        this.shapes = this.makeShapes(p_i3375_1_, p_i3375_2_, p_i3375_3_, 0.0F, p_i3375_4_);
    }
