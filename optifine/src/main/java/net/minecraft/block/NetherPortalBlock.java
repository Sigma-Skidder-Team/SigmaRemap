...
public class NetherPortalBlock extends Block
{
    ...
    public NetherPortalBlock(Block.Properties p_i2104_1_)
    {
        super(p_i2104_1_);
    ...
    public static class Size
    {
        ...
        public Size(IWorld p_i711_1_, BlockPos p_i711_2_, Direction.Axis p_i711_3_)
        {
            this.world = p_i711_1_;
            this.axis = p_i711_3_;

            if (p_i711_3_ == Direction.Axis.X)
            {
            ...
            for (BlockPos blockpos = p_i711_2_; p_i711_2_.getY() > blockpos.getY() - 21 && p_i711_2_.getY() > 0 && this.func_196900_a(p_i711_1_.getBlockState(p_i711_2_.down())); p_i711_2_ = p_i711_2_.down())
            {
                ;
            }

            int i = this.getDistanceUntilEdge(p_i711_2_, this.leftDir) - 1;

            if (i >= 0)
            {
                this.bottomLeft = p_i711_2_.offset(this.leftDir, i);
