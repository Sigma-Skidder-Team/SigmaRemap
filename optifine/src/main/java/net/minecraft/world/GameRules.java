...
public class GameRules
{
    ...
    private static <T extends GameRules.RuleValue<T>> GameRules.RuleKey<T> register(String gameRuleName, GameRules.RuleType<T> type)
    {
    ...
    public static class BooleanValue extends GameRules.RuleValue<GameRules.BooleanValue>
    {
        ...
        public BooleanValue(GameRules.RuleType<GameRules.BooleanValue> saveFile, boolean p_i1144_2_)
        {
            super(saveFile);
            this.value = p_i1144_2_;
        }
    ...
    public static class IntegerValue extends GameRules.RuleValue<GameRules.IntegerValue>
    {
        ...
        public IntegerValue(GameRules.RuleType<GameRules.IntegerValue> p_i4229_1_, int p_i4229_2_)
        {
            super(p_i4229_1_);
            this.value = p_i4229_2_;
        }
    ...
    public static final class RuleKey<T extends GameRules.RuleValue<T>>
    {
        ...
        public RuleKey(String p_i1912_1_)
        {
            this.gameRuleName = p_i1912_1_;
        }
    ...
    public static class RuleType<T extends GameRules.RuleValue<T>>
    {
        ...
        private RuleType(Supplier < ArgumentType<? >> p_i642_1_, Function<GameRules.RuleType<T>, T> p_i642_2_, BiConsumer<MinecraftServer, T> p_i642_3_)
        {
            this.argTypeSupplier = p_i642_1_;
            this.valueCreator = p_i642_2_;
            this.changeListener = p_i642_3_;
        }
    ...
    public abstract static class RuleValue<T extends GameRules.RuleValue<T>>
    {
        ...
        public RuleValue(GameRules.RuleType<T> p_i2097_1_)
        {
            this.type = p_i2097_1_;
        }
