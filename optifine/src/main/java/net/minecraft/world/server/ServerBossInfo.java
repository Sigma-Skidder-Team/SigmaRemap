...
public class ServerBossInfo extends BossInfo
{
    ...
    public ServerBossInfo(ITextComponent p_i1283_1_, BossInfo.Color p_i1283_2_, BossInfo.Overlay p_i1283_3_)
    {
        super(MathHelper.getRandomUUID(), p_i1283_1_, p_i1283_2_, p_i1283_3_);
    }
