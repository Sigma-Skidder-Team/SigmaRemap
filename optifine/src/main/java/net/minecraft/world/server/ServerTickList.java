...
public class ServerTickList<T> implements ITickList<T>
{
    ...
    public ServerTickList(ServerWorld p_i3942_1_, Predicate<T> p_i3942_2_, Function<T, ResourceLocation> p_i3942_3_, Function<ResourceLocation, T> p_i3942_4_, Consumer<NextTickListEntry<T>> p_i3942_5_)
    {
        this.filter = p_i3942_2_;
        this.serializer = p_i3942_3_;
        this.deserializer = p_i3942_4_;
        this.world = p_i3942_1_;
        this.tickFunction = p_i3942_5_;
    }
