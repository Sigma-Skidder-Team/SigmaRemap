...
public class ChunkHolder
{
    ...
    public ChunkHolder(ChunkPos p_i3176_1_, int p_i3176_2_, WorldLightManager p_i3176_3_, ChunkHolder.IListener p_i3176_4_, ChunkHolder.IPlayerProvider p_i3176_5_)
    {
        this.pos = p_i3176_1_;
        this.lightManager = p_i3176_3_;
        this.field_219327_v = p_i3176_4_;
        this.playerProvider = p_i3176_5_;
