...
public class ServerWorldLightManager extends WorldLightManager implements AutoCloseable
{
    ...
    public ServerWorldLightManager(IChunkLightProvider p_i2931_1_, ChunkManager p_i2931_2_, boolean p_i2931_3_, DelegatedTaskExecutor<Runnable> p_i2931_4_, ITaskExecutor<ChunkTaskPriorityQueueSorter.FunctionEntry<Runnable>> p_i2931_5_)
    {
        super(p_i2931_1_, true, p_i2931_3_);
        this.chunkManager = p_i2931_2_;
        this.field_215608_e = p_i2931_5_;
        this.field_215605_b = p_i2931_4_;
    }
