...
public class ChunkManager extends ChunkLoader implements ChunkHolder.IPlayerProvider
{
    ...
    public ChunkManager(ServerWorld p_i32_1_, File p_i32_2_, DataFixer p_i32_3_, TemplateManager p_i32_4_, Executor p_i32_5_, ThreadTaskExecutor<Runnable> p_i32_6_, IChunkLightProvider p_i32_7_, ChunkGenerator<?> p_i32_8_, IChunkStatusListener p_i32_9_, Supplier<DimensionSavedDataManager> p_i32_10_, int p_i32_11_)
    {
        super(new File(p_i32_1_.getDimension().getType().getDirectory(p_i32_2_), "region"), p_i32_3_);
        this.templateManager = p_i32_4_;
        this.field_219270_x = p_i32_1_.getDimension().getType().getDirectory(p_i32_2_);
        this.world = p_i32_1_;
        this.generator = p_i32_8_;
        this.mainThread = p_i32_6_;
        DelegatedTaskExecutor<Runnable> delegatedtaskexecutor = DelegatedTaskExecutor.create(p_i32_5_, "worldgen");
        ITaskExecutor<Runnable> itaskexecutor = ITaskExecutor.inline("main", p_i32_6_::enqueue);
        this.field_219266_t = p_i32_9_;
        DelegatedTaskExecutor<Runnable> delegatedtaskexecutor1 = DelegatedTaskExecutor.create(p_i32_5_, "light");
        this.field_219263_q = new ChunkTaskPriorityQueueSorter(ImmutableList.of(delegatedtaskexecutor, itaskexecutor, delegatedtaskexecutor1), p_i32_5_, Integer.MAX_VALUE);
        ...
        this.lightManager = new ServerWorldLightManager(p_i32_7_, this, this.world.getDimension().hasSkyLight(), delegatedtaskexecutor1, this.field_219263_q.func_219087_a(delegatedtaskexecutor1, false));
        this.ticketManager = new ChunkManager.ProxyTicketManager(p_i32_5_, p_i32_6_);
        this.field_219259_m = p_i32_10_;
        this.pointOfInterestManager = new PointOfInterestManager(new File(this.field_219270_x, "poi"), p_i32_3_);
        this.setViewDistance(p_i32_11_);
    }
            ...
            while (true)
            {
                ...
                list.stream().map((p_lambda$save$5_1_) ->
                {
                    ...
                    while (true)
                    {
                        ...
                        if (completablefuture == p_lambda$save$5_1_.func_219302_f())
                        {
                            break;
                        }
                    }
    ...
    protected void tick(BooleanSupplier hasMoreTime)
    {
        ...
        if (!this.world.isSaveDisabled())
        {
            ...
            if (Reflector.DimensionManager_unloadWorld.exists() && this.loadedChunks.isEmpty())
            {
                Reflector.DimensionManager_unloadWorld.call(this.world);
            }
        }
        ...
        completablefuture.thenAcceptAsync((p_lambda$scheduleSave$10_5_) ->
        {
            ...
            else if (this.chunksToUnload.remove(chunkPosIn, chunkHolderIn) && p_lambda$scheduleSave$10_5_ != null)
            {
                if (p_lambda$scheduleSave$10_5_ instanceof Chunk)
                {
                    ...
                    {
                        Reflector.postForgeBusEvent(Reflector.ChunkEvent_Unload_Constructor, (Chunk)p_lambda$scheduleSave$10_5_);
                    }
                }
            ...
            return completablefuture.thenComposeAsync((p_lambda$func_219244_a$13_4_) ->
            {
                ...
                if (!optional.isPresent())
                {
                    ...
                    if (ichunk.getStatus().isAtLeast(p_219244_2_))
                    {
                        ...
                        {
                            completablefuture1 = p_219244_2_.doLoadingWork(this.world, this.templateManager, this.lightManager, (p_lambda$null$12_2_) ->
                            {
    ...
    private CompletableFuture<Either<IChunk, ChunkHolder.IChunkLoadingError>> func_223172_f(ChunkPos p_223172_1_)
    {
        return CompletableFuture.supplyAsync(() ->
        {
            ...
            {
                LOGGER.error("Couldn't load chunk {}", p_223172_1_, exception1);
            }
    ...
    private CompletableFuture<Either<IChunk, ChunkHolder.IChunkLoadingError>> func_223156_b(ChunkHolder p_223156_1_, ChunkStatus p_223156_2_)
    {
        ...
        {
            return p_lambda$func_223156_b$20_4_.map((p_lambda$null$18_4_) -> {
                try {
                    CompletableFuture<Either<IChunk, ChunkHolder.IChunkLoadingError>> completablefuture1 = p_223156_2_.doGenerationWork(this.world, this.generator, this.templateManager, this.lightManager, (p_lambda$null$17_2_) -> {
    ...
    private CompletableFuture<Either<IChunk, ChunkHolder.IChunkLoadingError>> func_219200_b(ChunkHolder p_219200_1_)
    {
        ...
        {
            this.field_219265_s.enqueue(ChunkTaskPriorityQueueSorter.func_219069_a(p_lambda$func_219200_b$27_2_, p_219200_1_.getPosition().asLong(), p_219200_1_::func_219299_i));
        });
    }
        ...
        else
        {
            ...
            try
            {
                ...
                if (Reflector.ChunkDataEvent_Save_Constructor.exists())
                {
                    ...
                    Reflector.postForgeBusEvent(Reflector.ChunkDataEvent_Save_Constructor, chunkIn, world != null ? world : this.world, compoundnbt1);
                }
    ...
    private static String func_225402_a(CompletableFuture<Either<Chunk, ChunkHolder.IChunkLoadingError>> p_225402_0_)
    {
        ...
        catch (CancellationException var31)
        {
            return "cancelled";
        }
    }
    ...
    class EntityTracker
    {
        ...
        public EntityTracker(Entity p_i154_2_, int p_i154_3_, int p_i154_4_, boolean p_i154_5_)
        {
            this.entry = new TrackedEntity(ChunkManager.this.world, p_i154_2_, p_i154_4_, p_i154_5_, this::sendToAllTracking);
            this.entity = p_i154_2_;
            this.range = p_i154_3_;
            this.pos = SectionPos.from(p_i154_2_);
        }
    ...
    {
        protected ProxyTicketManager(Executor p_i130_2_, Executor p_i130_3_)
        {
            super(p_i130_2_, p_i130_3_);
        }
