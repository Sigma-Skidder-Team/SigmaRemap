...
public class ServerChunkProvider extends AbstractChunkProvider
{
    ...
    public ServerChunkProvider(ServerWorld p_i1093_1_, File p_i1093_2_, DataFixer p_i1093_3_, TemplateManager p_i1093_4_, Executor p_i1093_5_, ChunkGenerator<?> p_i1093_6_, int p_i1093_7_, IChunkStatusListener p_i1093_8_, Supplier<DimensionSavedDataManager> p_i1093_9_)
    {
        this.world = p_i1093_1_;
        this.executor = new ServerChunkProvider.ChunkExecutor(p_i1093_1_);
        this.generator = p_i1093_6_;
        this.mainThread = Thread.currentThread();
        File file1 = p_i1093_1_.getDimension().getType().getDirectory(p_i1093_2_);
        File file2 = new File(file1, "data");
        file2.mkdirs();
        this.savedData = new DimensionSavedDataManager(file2, p_i1093_3_);
        this.chunkManager = new ChunkManager(p_i1093_1_, p_i1093_2_, p_i1093_3_, p_i1093_4_, p_i1093_5_, this.executor, this, this.getChunkGenerator(), p_i1093_8_, p_i1093_9_, p_i1093_7_);
    ...
    {
        private ChunkExecutor(World p_i3952_2_)
        {
            super("Chunk source main thread executor for " + Registry.DIMENSION_TYPE.getKey(p_i3952_2_.getDimension().getType()));
        }
