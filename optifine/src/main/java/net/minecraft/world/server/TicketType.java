...
public class TicketType<T>
{
    ...
    protected TicketType(String p_i3910_1_, Comparator<T> p_i3910_2_, long p_i3910_3_)
    {
        this.name = p_i3910_1_;
        this.typeComparator = p_i3910_2_;
        this.lifespan = p_i3910_3_;
    }
