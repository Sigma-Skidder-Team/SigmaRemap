...
public class StrongholdStructure extends Structure<NoFeatureConfig>
{
    ...
    public StrongholdStructure(Function < Dynamic<?>, ? extends NoFeatureConfig > p_i1462_1_)
    {
        super(p_i1462_1_);
    }
    ...
    {
        public Start(Structure<?> buttonId, int x, int y, MutableBoundingBox text, int p_i1177_5_, long p_i1177_6_)
        {
            super(buttonId, x, y, text, p_i1177_5_, p_i1177_6_);
        }
