...
public class SingleJigsawPiece extends JigsawPiece
{
    ...
    @Deprecated
    public SingleJigsawPiece(String p_i552_1_, List<StructureProcessor> p_i552_2_)
    {
        this(p_i552_1_, p_i552_2_, JigsawPattern.PlacementBehaviour.RIGID);
    }

    public SingleJigsawPiece(String p_i553_1_, List<StructureProcessor> p_i553_2_, JigsawPattern.PlacementBehaviour p_i553_3_)
    {
        super(p_i553_3_);
        this.location = new ResourceLocation(p_i553_1_);
        this.processors = ImmutableList.copyOf(p_i553_2_);
    }

    @Deprecated
    public SingleJigsawPiece(String p_i554_1_)
    {
        this(p_i554_1_, ImmutableList.of());
    }

    public SingleJigsawPiece(Dynamic<?> p_i555_1_)
    {
        super(p_i555_1_);
        this.location = new ResourceLocation(p_i555_1_.get("location").asString(""));
        this.processors = ImmutableList.copyOf(p_i555_1_.get("processors").asList((p_214858_0_) ->
        {
