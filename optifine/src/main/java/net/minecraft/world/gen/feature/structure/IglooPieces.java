...
public class IglooPieces
{
    ...
    public static class Piece extends TemplateStructurePiece
    {
        ...
        public Piece(TemplateManager p_i3353_1_, ResourceLocation p_i3353_2_, BlockPos p_i3353_3_, Rotation p_i3353_4_, int p_i3353_5_)
        {
            super(IStructurePieceType.IGLU, 0);
            this.field_207615_d = p_i3353_2_;
            BlockPos blockpos = IglooPieces.field_207622_e.get(p_i3353_2_);
            this.templatePosition = p_i3353_3_.add(blockpos.getX(), blockpos.getY() - p_i3353_5_, blockpos.getZ());
            this.field_207616_e = p_i3353_4_;
            this.func_207614_a(p_i3353_1_);
        }

        public Piece(TemplateManager p_i3354_1_, CompoundNBT p_i3354_2_)
        {
            super(IStructurePieceType.IGLU, p_i3354_2_);
            this.field_207615_d = new ResourceLocation(p_i3354_2_.getString("Template"));
            this.field_207616_e = Rotation.valueOf(p_i3354_2_.getString("Rot"));
            this.func_207614_a(p_i3354_1_);
        }
