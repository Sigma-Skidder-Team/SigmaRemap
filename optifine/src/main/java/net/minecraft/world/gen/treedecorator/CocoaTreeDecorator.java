...
public class CocoaTreeDecorator extends TreeDecorator
{
    ...
    public CocoaTreeDecorator(float p_i1367_1_)
    {
        super(TreeDecoratorType.field_227427_c_);
        this.field_227417_b_ = p_i1367_1_;
    }

    public <T> CocoaTreeDecorator(Dynamic<T> xCoord)
    {
        this(xCoord.get("probability").asFloat(0.0F));
    }
