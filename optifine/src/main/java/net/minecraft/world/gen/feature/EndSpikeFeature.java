...
public class EndSpikeFeature extends Feature<EndSpikeFeatureConfig>
{
    ...
    public EndSpikeFeature(Function < Dynamic<?>, ? extends EndSpikeFeatureConfig > p_i1989_1_)
    {
        super(p_i1989_1_);
    }
    ...
    public static class EndSpike
    {
        ...
        public EndSpike(int p_i2862_1_, int p_i2862_2_, int p_i2862_3_, int p_i2862_4_, boolean p_i2862_5_)
        {
            this.centerX = p_i2862_1_;
            this.centerZ = p_i2862_2_;
            this.radius = p_i2862_3_;
            this.height = p_i2862_4_;
            this.guarded = p_i2862_5_;
            this.topBoundingBox = new AxisAlignedBB((double)(p_i2862_1_ - p_i2862_3_), 0.0D, (double)(p_i2862_2_ - p_i2862_3_), (double)(p_i2862_1_ + p_i2862_3_), 256.0D, (double)(p_i2862_2_ + p_i2862_3_));
        }
