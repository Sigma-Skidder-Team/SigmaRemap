...
public class BlockIgnoreStructureProcessor extends StructureProcessor
{
    ...
    public BlockIgnoreStructureProcessor(List<Block> p_i4079_1_)
    {
        this.blocks = ImmutableList.copyOf(p_i4079_1_);
    }

    public BlockIgnoreStructureProcessor(Dynamic<?> p_i4080_1_)
    {
        this(p_i4080_1_.get("blocks").asList((p_215203_0_) ->
        {
