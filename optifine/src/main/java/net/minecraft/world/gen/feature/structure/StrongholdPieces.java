...
public class StrongholdPieces
{
    ...
    public static class ChestCorridor extends StrongholdPieces.Stronghold
    {
        ...
        public ChestCorridor(int p_i2185_1_, Random p_i2185_2_, MutableBoundingBox p_i2185_3_, Direction p_i2185_4_)
        {
            super(IStructurePieceType.SHCC, p_i2185_1_);
            this.setCoordBaseMode(p_i2185_4_);
            this.entryDoor = this.getRandomDoor(p_i2185_2_);
            this.boundingBox = p_i2185_3_;
        }

        public ChestCorridor(TemplateManager p_i2186_1_, CompoundNBT p_i2186_2_)
        {
            super(IStructurePieceType.SHCC, p_i2186_2_);
            this.hasMadeChest = p_i2186_2_.getBoolean("Chest");
        }
    ...
    public static class Corridor extends StrongholdPieces.Stronghold
    {
        ...
        public Corridor(int p_i1841_1_, MutableBoundingBox p_i1841_2_, Direction p_i1841_3_)
        {
            super(IStructurePieceType.SHFC, p_i1841_1_);
            this.setCoordBaseMode(p_i1841_3_);
            this.boundingBox = p_i1841_2_;
            this.steps = p_i1841_3_ != Direction.NORTH && p_i1841_3_ != Direction.SOUTH ? p_i1841_2_.getXSize() : p_i1841_2_.getZSize();
        }

        public Corridor(TemplateManager p_i1842_1_, CompoundNBT p_i1842_2_)
        {
            super(IStructurePieceType.SHFC, p_i1842_2_);
            this.steps = p_i1842_2_.getInt("Steps");
        }
    ...
    public static class Crossing extends StrongholdPieces.Stronghold
    {
        ...
        public Crossing(int p_i1718_1_, Random p_i1718_2_, MutableBoundingBox p_i1718_3_, Direction p_i1718_4_)
        {
            super(IStructurePieceType.SH5C, p_i1718_1_);
            this.setCoordBaseMode(p_i1718_4_);
            this.entryDoor = this.getRandomDoor(p_i1718_2_);
            this.boundingBox = p_i1718_3_;
            this.leftLow = p_i1718_2_.nextBoolean();
            this.leftHigh = p_i1718_2_.nextBoolean();
            this.rightLow = p_i1718_2_.nextBoolean();
            this.rightHigh = p_i1718_2_.nextInt(3) > 0;
        }

        public Crossing(TemplateManager worldIn, CompoundNBT x)
        {
            super(IStructurePieceType.SH5C, x);
            this.leftLow = x.getBoolean("leftLow");
            this.leftHigh = x.getBoolean("leftHigh");
            this.rightLow = x.getBoolean("rightLow");
            this.rightHigh = x.getBoolean("rightHigh");
        }
    ...
    {
        public LeftTurn(int p_i2484_1_, Random p_i2484_2_, MutableBoundingBox p_i2484_3_, Direction p_i2484_4_)
        {
            super(IStructurePieceType.SHLT, p_i2484_1_);
            this.setCoordBaseMode(p_i2484_4_);
            this.entryDoor = this.getRandomDoor(p_i2484_2_);
            this.boundingBox = p_i2484_3_;
        }

        public LeftTurn(TemplateManager p_i2485_1_, CompoundNBT p_i2485_2_)
        {
            super(IStructurePieceType.SHLT, p_i2485_2_);
        }
    ...
    public static class Library extends StrongholdPieces.Stronghold
    {
        ...
        public Library(int p_i3395_1_, Random p_i3395_2_, MutableBoundingBox p_i3395_3_, Direction p_i3395_4_)
        {
            super(IStructurePieceType.SHLI, p_i3395_1_);
            this.setCoordBaseMode(p_i3395_4_);
            this.entryDoor = this.getRandomDoor(p_i3395_2_);
            this.boundingBox = p_i3395_3_;
            this.isLargeRoom = p_i3395_3_.getYSize() > 6;
        }

        public Library(TemplateManager p_i3396_1_, CompoundNBT p_i3396_2_)
        {
            super(IStructurePieceType.SHLI, p_i3396_2_);
            this.isLargeRoom = p_i3396_2_.getBoolean("Tall");
        }
    ...
    static class PieceWeight
    {
        ...
        public PieceWeight(Class <? extends StrongholdPieces.Stronghold > p_i2895_1_, int p_i2895_2_, int p_i2895_3_)
        {
            this.pieceClass = p_i2895_1_;
            this.pieceWeight = p_i2895_2_;
            this.instancesLimit = p_i2895_3_;
        }
    ...
    public static class PortalRoom extends StrongholdPieces.Stronghold
    {
        ...
        public PortalRoom(int p_i2311_1_, MutableBoundingBox p_i2311_2_, Direction p_i2311_3_)
        {
            super(IStructurePieceType.SHPR, p_i2311_1_);
            this.setCoordBaseMode(p_i2311_3_);
            this.boundingBox = p_i2311_2_;
        }

        public PortalRoom(TemplateManager p_i2312_1_, CompoundNBT p_i2312_2_)
        {
            super(IStructurePieceType.SHPR, p_i2312_2_);
            this.hasSpawner = p_i2312_2_.getBoolean("Mob");
        }
    ...
    {
        public Prison(int p_i3809_1_, Random p_i3809_2_, MutableBoundingBox p_i3809_3_, Direction p_i3809_4_)
        {
            super(IStructurePieceType.SHPH, p_i3809_1_);
            this.setCoordBaseMode(p_i3809_4_);
            this.entryDoor = this.getRandomDoor(p_i3809_2_);
            this.boundingBox = p_i3809_3_;
        }

        public Prison(TemplateManager p_i3810_1_, CompoundNBT p_i3810_2_)
        {
            super(IStructurePieceType.SHPH, p_i3810_2_);
        }
    ...
    {
        public RightTurn(int p_i3350_1_, Random p_i3350_2_, MutableBoundingBox p_i3350_3_, Direction p_i3350_4_)
        {
            super(IStructurePieceType.SHRT, p_i3350_1_);
            this.setCoordBaseMode(p_i3350_4_);
            this.entryDoor = this.getRandomDoor(p_i3350_2_);
            this.boundingBox = p_i3350_3_;
        }

        public RightTurn(TemplateManager p_i3351_1_, CompoundNBT p_i3351_2_)
        {
            super(IStructurePieceType.SHRT, p_i3351_2_);
        }
    ...
    public static class RoomCrossing extends StrongholdPieces.Stronghold
    {
        ...
        public RoomCrossing(int p_i3437_1_, Random p_i3437_2_, MutableBoundingBox p_i3437_3_, Direction p_i3437_4_)
        {
            super(IStructurePieceType.SHRC, p_i3437_1_);
            this.setCoordBaseMode(p_i3437_4_);
            this.entryDoor = this.getRandomDoor(p_i3437_2_);
            this.boundingBox = p_i3437_3_;
            this.roomType = p_i3437_2_.nextInt(5);
        }

        public RoomCrossing(TemplateManager p_i3438_1_, CompoundNBT p_i3438_2_)
        {
            super(IStructurePieceType.SHRC, p_i3438_2_);
            this.roomType = p_i3438_2_.getInt("Type");
        }
    ...
    public static class Stairs extends StrongholdPieces.Stronghold
    {
        ...
        public Stairs(IStructurePieceType p_i3498_1_, int p_i3498_2_, Random p_i3498_3_, int p_i3498_4_, int p_i3498_5_)
        {
            super(p_i3498_1_, p_i3498_2_);
            this.source = true;
            this.setCoordBaseMode(Direction.Plane.HORIZONTAL.random(p_i3498_3_));
            this.entryDoor = StrongholdPieces.Stronghold.Door.OPENING;

            if (this.getCoordBaseMode().getAxis() == Direction.Axis.Z)
            {
                this.boundingBox = new MutableBoundingBox(p_i3498_4_, 64, p_i3498_5_, p_i3498_4_ + 5 - 1, 74, p_i3498_5_ + 5 - 1);
            }
            else
            {
                this.boundingBox = new MutableBoundingBox(p_i3498_4_, 64, p_i3498_5_, p_i3498_4_ + 5 - 1, 74, p_i3498_5_ + 5 - 1);
        ...
        public Stairs(int p_i3499_1_, Random p_i3499_2_, MutableBoundingBox p_i3499_3_, Direction p_i3499_4_)
        {
            super(IStructurePieceType.SHSD, p_i3499_1_);
            this.source = false;
            this.setCoordBaseMode(p_i3499_4_);
            this.entryDoor = this.getRandomDoor(p_i3499_2_);
            this.boundingBox = p_i3499_3_;
        }

        public Stairs(IStructurePieceType p_i3500_1_, CompoundNBT p_i3500_2_)
        {
            super(p_i3500_1_, p_i3500_2_);
            this.source = p_i3500_2_.getBoolean("Source");
        }

        public Stairs(TemplateManager p_i3501_1_, CompoundNBT p_i3501_2_)
        {
            this(IStructurePieceType.SHSD, p_i3501_2_);
        }
    ...
    public static class Stairs2 extends StrongholdPieces.Stairs
    {
        ...
        public Stairs2(Random p_i2026_1_, int p_i2026_2_, int p_i2026_3_)
        {
            super(IStructurePieceType.SHSTART, 0, p_i2026_1_, p_i2026_2_, p_i2026_3_);
        }

        public Stairs2(TemplateManager p_i2027_1_, CompoundNBT p_i2027_2_)
        {
            super(IStructurePieceType.SHSTART, p_i2027_2_);
        }
    }

    public static class StairsStraight extends StrongholdPieces.Stronghold
    {
        public StairsStraight(int p_i800_1_, Random p_i800_2_, MutableBoundingBox p_i800_3_, Direction p_i800_4_)
        {
            super(IStructurePieceType.SHSSD, p_i800_1_);
            this.setCoordBaseMode(p_i800_4_);
            this.entryDoor = this.getRandomDoor(p_i800_2_);
            this.boundingBox = p_i800_3_;
        }

        public StairsStraight(TemplateManager p_i801_1_, CompoundNBT p_i801_2_)
        {
            super(IStructurePieceType.SHSSD, p_i801_2_);
        }
    ...
    public static class Straight extends StrongholdPieces.Stronghold
    {
        ...
        public Straight(int p_i1785_1_, Random p_i1785_2_, MutableBoundingBox p_i1785_3_, Direction p_i1785_4_)
        {
            super(IStructurePieceType.SHS, p_i1785_1_);
            this.setCoordBaseMode(p_i1785_4_);
            this.entryDoor = this.getRandomDoor(p_i1785_2_);
            this.boundingBox = p_i1785_3_;
            this.expandsX = p_i1785_2_.nextInt(2) == 0;
            this.expandsZ = p_i1785_2_.nextInt(2) == 0;
        }

        public Straight(TemplateManager worldIn, CompoundNBT throwerIn)
        {
            super(IStructurePieceType.SHS, throwerIn);
            this.expandsX = throwerIn.getBoolean("Left");
            this.expandsZ = throwerIn.getBoolean("Right");
        }
    ...
    abstract static class Stronghold extends StructurePiece
    {
        ...
        protected Stronghold(IStructurePieceType p_i3544_1_, int p_i3544_2_)
        {
            super(p_i3544_1_, p_i3544_2_);
        }

        public Stronghold(IStructurePieceType p_i3545_1_, CompoundNBT p_i3545_2_)
        {
            super(p_i3545_1_, p_i3545_2_);
            this.entryDoor = StrongholdPieces.Stronghold.Door.valueOf(p_i3545_2_.getString("EntryDoor"));
        }
    ...
    {
        protected Turn(IStructurePieceType p_i3948_1_, int p_i3948_2_)
        {
            super(p_i3948_1_, p_i3948_2_);
        }

        public Turn(IStructurePieceType p_i3949_1_, CompoundNBT p_i3949_2_)
        {
            super(p_i3949_1_, p_i3949_2_);
        }
    }
}
