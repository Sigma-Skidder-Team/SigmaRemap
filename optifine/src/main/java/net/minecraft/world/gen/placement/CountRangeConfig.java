...
public class CountRangeConfig implements IPlacementConfig
{
    ...
    public CountRangeConfig(int p_i3637_1_, int p_i3637_2_, int p_i3637_3_, int p_i3637_4_)
    {
        this.count = p_i3637_1_;
        this.bottomOffset = p_i3637_2_;
        this.topOffset = p_i3637_3_;
        this.maximum = p_i3637_4_;
    }
