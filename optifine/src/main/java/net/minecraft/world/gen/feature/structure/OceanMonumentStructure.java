...
public class OceanMonumentStructure extends Structure<NoFeatureConfig>
{
    ...
    public OceanMonumentStructure(Function < Dynamic<?>, ? extends NoFeatureConfig > p_i436_1_)
    {
        super(p_i436_1_);
    }
    ...
    public static class Start extends StructureStart
    {
        ...
        public Start(Structure<?> p_i3490_1_, int p_i3490_2_, int p_i3490_3_, MutableBoundingBox p_i3490_4_, int p_i3490_5_, long p_i3490_6_)
        {
            super(p_i3490_1_, p_i3490_2_, p_i3490_3_, p_i3490_4_, p_i3490_5_, p_i3490_6_);
        }
