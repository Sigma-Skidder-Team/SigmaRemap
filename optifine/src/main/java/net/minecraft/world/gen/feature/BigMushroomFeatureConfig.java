...
public class BigMushroomFeatureConfig implements IFeatureConfig
{
    ...
    public BigMushroomFeatureConfig(BlockStateProvider p_i2531_1_, BlockStateProvider p_i2531_2_, int p_i2531_3_)
    {
        this.field_227272_a_ = p_i2531_1_;
        this.field_227273_b_ = p_i2531_2_;
        this.field_227274_c_ = p_i2531_3_;
    }
