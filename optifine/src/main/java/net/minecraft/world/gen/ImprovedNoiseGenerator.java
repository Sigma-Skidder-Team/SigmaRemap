...
public final class ImprovedNoiseGenerator
{
    ...
    public ImprovedNoiseGenerator(Random p_i3086_1_)
    {
        this.xCoord = p_i3086_1_.nextDouble() * 256.0D;
        this.yCoord = p_i3086_1_.nextDouble() * 256.0D;
        this.zCoord = p_i3086_1_.nextDouble() * 256.0D;
        ...
        for (int k = 0; k < 256; ++k)
        {
            int j = p_i3086_1_.nextInt(256 - k);
