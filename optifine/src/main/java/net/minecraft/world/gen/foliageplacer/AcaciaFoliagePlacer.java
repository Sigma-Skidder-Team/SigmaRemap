...
{
    public AcaciaFoliagePlacer(int p_i4152_1_, int p_i4152_2_)
    {
        super(p_i4152_1_, p_i4152_2_, FoliagePlacerType.field_227389_d_);
    }

    public <T> AcaciaFoliagePlacer(Dynamic<T> p_i4153_1_)
    {
        this(p_i4153_1_.get("radius").asInt(0), p_i4153_1_.get("radius_random").asInt(0));
    }
