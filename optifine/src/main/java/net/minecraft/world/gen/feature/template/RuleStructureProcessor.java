...
public class RuleStructureProcessor extends StructureProcessor
{
    ...
    public RuleStructureProcessor(List<RuleEntry> p_i3474_1_)
    {
        this.rules = ImmutableList.copyOf(p_i3474_1_);
    }

    public RuleStructureProcessor(Dynamic<?> p_i3475_1_)
    {
        this(p_i3475_1_.get("rules").asList(RuleEntry::deserialize));
    }
