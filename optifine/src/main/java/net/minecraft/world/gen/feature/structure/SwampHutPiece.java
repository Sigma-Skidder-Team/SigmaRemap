...
public class SwampHutPiece extends ScatteredStructurePiece
{
    ...
    public SwampHutPiece(Random p_i2509_1_, int p_i2509_2_, int p_i2509_3_)
    {
        super(IStructurePieceType.TESH, p_i2509_1_, p_i2509_2_, 64, p_i2509_3_, 7, 7, 9);
    }

    public SwampHutPiece(TemplateManager p_i2510_1_, CompoundNBT p_i2510_2_)
    {
        super(IStructurePieceType.TESH, p_i2510_2_);
        this.witch = p_i2510_2_.getBoolean("Witch");
        this.field_214822_f = p_i2510_2_.getBoolean("Cat");
    }
