...
public class EndSpikeFeatureConfig implements IFeatureConfig
{
    ...
    public EndSpikeFeatureConfig(boolean p_i1569_1_, List<EndSpikeFeature.EndSpike> p_i1569_2_, @Nullable BlockPos p_i1569_3_)
    {
        this.crystalInvulnerable = p_i1569_1_;
        this.spikes = p_i1569_2_;
        this.crystalBeamTarget = p_i1569_3_;
    }
