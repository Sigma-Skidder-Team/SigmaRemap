...
public class ColumnBlockPlacer extends BlockPlacer
{
    ...
    public ColumnBlockPlacer(int p_i1551_1_, int p_i1551_2_)
    {
        super(BlockPlacerType.field_227261_c_);
        this.field_227265_b_ = p_i1551_1_;
        this.field_227266_c_ = p_i1551_2_;
    }

    public <T> ColumnBlockPlacer(Dynamic<T> p_i1552_1_)
    {
        this(p_i1552_1_.get("min_size").asInt(1), p_i1552_1_.get("extra_size").asInt(2));
    }
