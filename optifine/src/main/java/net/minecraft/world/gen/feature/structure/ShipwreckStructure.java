...
{
    public ShipwreckStructure(Function < Dynamic<?>, ? extends ShipwreckConfig > p_i3384_1_)
    {
        super(p_i3384_1_);
    }
    ...
    {
        public Start(Structure<?> p_i610_1_, int p_i610_2_, int p_i610_3_, MutableBoundingBox p_i610_4_, int p_i610_5_, long p_i610_6_)
        {
            super(p_i610_1_, p_i610_2_, p_i610_3_, p_i610_4_, p_i610_5_, p_i610_6_);
        }
