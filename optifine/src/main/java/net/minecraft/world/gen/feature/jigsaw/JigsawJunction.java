...
public class JigsawJunction
{
    ...
    public JigsawJunction(int p_i1856_1_, int p_i1856_2_, int p_i1856_3_, int p_i1856_4_, JigsawPattern.PlacementBehaviour p_i1856_5_)
    {
        this.sourceX = p_i1856_1_;
        this.sourceGroundY = p_i1856_2_;
        this.sourceZ = p_i1856_3_;
        this.deltaY = p_i1856_4_;
        this.destProjection = p_i1856_5_;
    }
