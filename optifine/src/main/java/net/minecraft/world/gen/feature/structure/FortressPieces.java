...
public class FortressPieces
{
    ...
    public static class Corridor extends FortressPieces.Piece
    {
        ...
        public Corridor(int p_i2591_1_, Random p_i2591_2_, MutableBoundingBox p_i2591_3_, Direction p_i2591_4_)
        {
            super(IStructurePieceType.NESCLT, p_i2591_1_);
            this.setCoordBaseMode(p_i2591_4_);
            this.boundingBox = p_i2591_3_;
            this.chest = p_i2591_2_.nextInt(3) == 0;
        }

        public Corridor(TemplateManager p_i2592_1_, CompoundNBT p_i2592_2_)
        {
            super(IStructurePieceType.NESCLT, p_i2592_2_);
            this.chest = p_i2592_2_.getBoolean("Chest");
        }
    ...
    public static class Corridor2 extends FortressPieces.Piece
    {
        ...
        public Corridor2(int p_i4209_1_, Random p_i4209_2_, MutableBoundingBox p_i4209_3_, Direction p_i4209_4_)
        {
            super(IStructurePieceType.NESCRT, p_i4209_1_);
            this.setCoordBaseMode(p_i4209_4_);
            this.boundingBox = p_i4209_3_;
            this.chest = p_i4209_2_.nextInt(3) == 0;
        }

        public Corridor2(TemplateManager p_i4210_1_, CompoundNBT p_i4210_2_)
        {
            super(IStructurePieceType.NESCRT, p_i4210_2_);
            this.chest = p_i4210_2_.getBoolean("Chest");
        }
    ...
    {
        public Corridor3(int p_i917_1_, MutableBoundingBox p_i917_2_, Direction p_i917_3_)
        {
            super(IStructurePieceType.NECCS, p_i917_1_);
            this.setCoordBaseMode(p_i917_3_);
            this.boundingBox = p_i917_2_;
        }

        public Corridor3(TemplateManager p_i918_1_, CompoundNBT p_i918_2_)
        {
            super(IStructurePieceType.NECCS, p_i918_2_);
        }
    ...
    {
        public Corridor4(int p_i3887_1_, MutableBoundingBox p_i3887_2_, Direction p_i3887_3_)
        {
            super(IStructurePieceType.NECTB, p_i3887_1_);
            this.setCoordBaseMode(p_i3887_3_);
            this.boundingBox = p_i3887_2_;
        }

        public Corridor4(TemplateManager p_i3888_1_, CompoundNBT p_i3888_2_)
        {
            super(IStructurePieceType.NECTB, p_i3888_2_);
        }
    ...
    {
        public Corridor5(int p_i4014_1_, MutableBoundingBox p_i4014_2_, Direction p_i4014_3_)
        {
            super(IStructurePieceType.NESC, p_i4014_1_);
            this.setCoordBaseMode(p_i4014_3_);
            this.boundingBox = p_i4014_2_;
        }

        public Corridor5(TemplateManager p_i4015_1_, CompoundNBT p_i4015_2_)
        {
            super(IStructurePieceType.NESC, p_i4015_2_);
        }
    ...
    {
        public Crossing(int usernameIn, MutableBoundingBox playerIDIn, Direction tokenIn)
        {
            super(IStructurePieceType.NERC, usernameIn);
            this.setCoordBaseMode(tokenIn);
            this.boundingBox = playerIDIn;
        }

        public Crossing(TemplateManager p_i1099_1_, CompoundNBT p_i1099_2_)
        {
            super(IStructurePieceType.NERC, p_i1099_2_);
        }
    ...
    {
        public Crossing2(int p_i3312_1_, MutableBoundingBox p_i3312_2_, Direction p_i3312_3_)
        {
            super(IStructurePieceType.NESCSC, p_i3312_1_);
            this.setCoordBaseMode(p_i3312_3_);
            this.boundingBox = p_i3312_2_;
        }

        public Crossing2(TemplateManager p_i3313_1_, CompoundNBT p_i3313_2_)
        {
            super(IStructurePieceType.NESCSC, p_i3313_2_);
        }
    ...
    {
        public Crossing3(int p_i2775_1_, MutableBoundingBox p_i2775_2_, Direction p_i2775_3_)
        {
            super(IStructurePieceType.NEBCR, p_i2775_1_);
            this.setCoordBaseMode(p_i2775_3_);
            this.boundingBox = p_i2775_2_;
        }

        protected Crossing3(Random p_i2776_1_, int p_i2776_2_, int p_i2776_3_)
        {
            super(IStructurePieceType.NEBCR, 0);
            this.setCoordBaseMode(Direction.Plane.HORIZONTAL.random(p_i2776_1_));

            if (this.getCoordBaseMode().getAxis() == Direction.Axis.Z)
            {
                this.boundingBox = new MutableBoundingBox(p_i2776_2_, 64, p_i2776_3_, p_i2776_2_ + 19 - 1, 73, p_i2776_3_ + 19 - 1);
            }
            else
            {
                this.boundingBox = new MutableBoundingBox(p_i2776_2_, 64, p_i2776_3_, p_i2776_2_ + 19 - 1, 73, p_i2776_3_ + 19 - 1);
        ...
        protected Crossing3(IStructurePieceType p_i2777_1_, CompoundNBT p_i2777_2_)
        {
            super(p_i2777_1_, p_i2777_2_);
        }

        public Crossing3(TemplateManager p_i2778_1_, CompoundNBT p_i2778_2_)
        {
            this(IStructurePieceType.NEBCR, p_i2778_2_);
        }
    ...
    public static class End extends FortressPieces.Piece
    {
        ...
        public End(int p_i3406_1_, Random p_i3406_2_, MutableBoundingBox p_i3406_3_, Direction p_i3406_4_)
        {
            super(IStructurePieceType.NEBEF, p_i3406_1_);
            this.setCoordBaseMode(p_i3406_4_);
            this.boundingBox = p_i3406_3_;
            this.fillSeed = p_i3406_2_.nextInt();
        }

        public End(TemplateManager p_i3407_1_, CompoundNBT p_i3407_2_)
        {
            super(IStructurePieceType.NEBEF, p_i3407_2_);
            this.fillSeed = p_i3407_2_.getInt("Seed");
        }
    ...
    {
        public Entrance(int p_i2243_1_, Random p_i2243_2_, MutableBoundingBox p_i2243_3_, Direction p_i2243_4_)
        {
            super(IStructurePieceType.NECE, p_i2243_1_);
            this.setCoordBaseMode(p_i2243_4_);
            this.boundingBox = p_i2243_3_;
        }

        public Entrance(TemplateManager p_i2244_1_, CompoundNBT p_i2244_2_)
        {
            super(IStructurePieceType.NECE, p_i2244_2_);
        }
    ...
    {
        public NetherStalkRoom(int side, MutableBoundingBox playerStatCollector, Direction startTime)
        {
            super(IStructurePieceType.NECSR, side);
            this.setCoordBaseMode(startTime);
            this.boundingBox = playerStatCollector;
        }

        public NetherStalkRoom(TemplateManager damageSrcIn, CompoundNBT timeIn)
        {
            super(IStructurePieceType.NECSR, timeIn);
        }
    ...
    {
        protected Piece(IStructurePieceType p_i2285_1_, int p_i2285_2_)
        {
            super(p_i2285_1_, p_i2285_2_);
        }

        public Piece(IStructurePieceType p_i2286_1_, CompoundNBT p_i2286_2_)
        {
            super(p_i2286_1_, p_i2286_2_);
        }
    ...
    static class PieceWeight
    {
        ...
        public PieceWeight(Class <? extends FortressPieces.Piece > p_i351_1_, int p_i351_2_, int p_i351_3_, boolean p_i351_4_)
        {
            this.weightClass = p_i351_1_;
            this.weight = p_i351_2_;
            this.maxPlaceCount = p_i351_3_;
            this.allowInRow = p_i351_4_;
        }

        public PieceWeight(Class <? extends FortressPieces.Piece > p_i352_1_, int p_i352_2_, int p_i352_3_)
        {
            this(p_i352_1_, p_i352_2_, p_i352_3_, false);
        }
    ...
    {
        public Stairs(int p_i4199_1_, MutableBoundingBox p_i4199_2_, Direction p_i4199_3_)
        {
            super(IStructurePieceType.NESR, p_i4199_1_);
            this.setCoordBaseMode(p_i4199_3_);
            this.boundingBox = p_i4199_2_;
        }

        public Stairs(TemplateManager p_i4200_1_, CompoundNBT p_i4200_2_)
        {
            super(IStructurePieceType.NESR, p_i4200_2_);
        }
    ...
    public static class Start extends FortressPieces.Crossing3
    {
        ...
        public Start(Random p_i2945_1_, int p_i2945_2_, int p_i2945_3_)
        {
            super(p_i2945_1_, p_i2945_2_, p_i2945_3_);
        ...
        public Start(TemplateManager p_i2946_1_, CompoundNBT p_i2946_2_)
        {
            super(IStructurePieceType.NESTART, p_i2946_2_);
        }
    }

    public static class Straight extends FortressPieces.Piece
    {
        public Straight(int p_i299_1_, Random p_i299_2_, MutableBoundingBox p_i299_3_, Direction p_i299_4_)
        {
            super(IStructurePieceType.NEBS, p_i299_1_);
            this.setCoordBaseMode(p_i299_4_);
            this.boundingBox = p_i299_3_;
        }

        public Straight(TemplateManager p_i300_1_, CompoundNBT p_i300_2_)
        {
            super(IStructurePieceType.NEBS, p_i300_2_);
        }
    ...
    public static class Throne extends FortressPieces.Piece
    {
        ...
        public Throne(int p_i3428_1_, MutableBoundingBox p_i3428_2_, Direction p_i3428_3_)
        {
            super(IStructurePieceType.NEMT, p_i3428_1_);
            this.setCoordBaseMode(p_i3428_3_);
            this.boundingBox = p_i3428_2_;
        }

        public Throne(TemplateManager p_i3429_1_, CompoundNBT p_i3429_2_)
        {
            super(IStructurePieceType.NEMT, p_i3429_2_);
            this.hasSpawner = p_i3429_2_.getBoolean("Mob");
        }
