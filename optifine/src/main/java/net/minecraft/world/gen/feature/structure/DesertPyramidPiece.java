...
public class DesertPyramidPiece extends ScatteredStructurePiece
{
    ...
    public DesertPyramidPiece(Random p_i1056_1_, int p_i1056_2_, int p_i1056_3_)
    {
        super(IStructurePieceType.TEDP, p_i1056_1_, p_i1056_2_, 64, p_i1056_3_, 21, 15, 21);
    }

    public DesertPyramidPiece(TemplateManager p_i1057_1_, CompoundNBT p_i1057_2_)
    {
        super(IStructurePieceType.TEDP, p_i1057_2_);
        this.hasPlacedChest[0] = p_i1057_2_.getBoolean("hasPlacedChest0");
        this.hasPlacedChest[1] = p_i1057_2_.getBoolean("hasPlacedChest1");
        this.hasPlacedChest[2] = p_i1057_2_.getBoolean("hasPlacedChest2");
        this.hasPlacedChest[3] = p_i1057_2_.getBoolean("hasPlacedChest3");
    }
