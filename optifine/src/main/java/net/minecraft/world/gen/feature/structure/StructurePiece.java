...
public abstract class StructurePiece
{
    ...
    protected StructurePiece(IStructurePieceType p_i2409_1_, int p_i2409_2_)
    {
        this.structurePieceType = p_i2409_1_;
        this.componentType = p_i2409_2_;
    }

    public StructurePiece(IStructurePieceType p_i2410_1_, CompoundNBT p_i2410_2_)
    {
        this(p_i2410_1_, p_i2410_2_.getInt("GD"));

        if (p_i2410_2_.contains("BB"))
        {
            this.boundingBox = new MutableBoundingBox(p_i2410_2_.getIntArray("BB"));
        }

        int i = p_i2410_2_.getInt("O");
