...
public abstract class ChunkGenerator<C extends GenerationSettings>
{
    ...
    public ChunkGenerator(IWorld p_i3839_1_, BiomeProvider p_i3839_2_, C p_i3839_3_)
    {
        this.world = p_i3839_1_;
        this.seed = p_i3839_1_.getSeed();
        this.biomeProvider = p_i3839_2_;
        this.settings = p_i3839_3_;
    }
