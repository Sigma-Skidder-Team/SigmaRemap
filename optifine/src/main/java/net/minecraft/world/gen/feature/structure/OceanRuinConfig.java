...
public class OceanRuinConfig implements IFeatureConfig
{
    ...
    public OceanRuinConfig(OceanRuinStructure.Type p_i268_1_, float p_i268_2_, float p_i268_3_)
    {
        this.field_204031_a = p_i268_1_;
        this.largeProbability = p_i268_2_;
        this.clusterProbability = p_i268_3_;
    }
