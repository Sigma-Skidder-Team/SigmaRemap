...
public class ShipwreckPieces
{
    ...
    public static class Piece extends TemplateStructurePiece
    {
        ...
        public Piece(TemplateManager p_i2562_1_, ResourceLocation p_i2562_2_, BlockPos p_i2562_3_, Rotation p_i2562_4_, boolean p_i2562_5_)
        {
            super(IStructurePieceType.SHIPWRECK, 0);
            this.templatePosition = p_i2562_3_;
            this.rotation = p_i2562_4_;
            this.field_204756_e = p_i2562_2_;
            this.isBeached = p_i2562_5_;
            this.func_204754_a(p_i2562_1_);
        }

        public Piece(TemplateManager p_i2563_1_, CompoundNBT p_i2563_2_)
        {
            super(IStructurePieceType.SHIPWRECK, p_i2563_2_);
            this.field_204756_e = new ResourceLocation(p_i2563_2_.getString("Template"));
            this.isBeached = p_i2563_2_.getBoolean("isBeached");
            this.rotation = Rotation.valueOf(p_i2563_2_.getString("Rot"));
            this.func_204754_a(p_i2563_1_);
        }
