...
public class FeatureJigsawPiece extends JigsawPiece
{
    ...
    @Deprecated
    public FeatureJigsawPiece(ConfiguredFeature <? , ? > p_i4149_1_)
    {
        this(p_i4149_1_, JigsawPattern.PlacementBehaviour.RIGID);
    }

    public FeatureJigsawPiece(ConfiguredFeature <? , ? > p_i4150_1_, JigsawPattern.PlacementBehaviour p_i4150_2_)
    {
        super(p_i4150_2_);
        this.configuredFeature = p_i4150_1_;
        this.nbt = this.writeNBT();
    }

    public <T> FeatureJigsawPiece(Dynamic<T> p_i4151_1_)
    {
        super(p_i4151_1_);
        this.configuredFeature = ConfiguredFeature.deserialize(p_i4151_1_.get("feature").orElseEmptyMap());
        this.nbt = this.writeNBT();
    }
