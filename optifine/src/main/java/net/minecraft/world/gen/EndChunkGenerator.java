...
public class EndChunkGenerator extends NoiseChunkGenerator<EndGenerationSettings>
{
    ...
    public EndChunkGenerator(IWorld p_i3771_1_, BiomeProvider p_i3771_2_, EndGenerationSettings p_i3771_3_)
    {
        super(p_i3771_1_, p_i3771_2_, 8, 4, 128, p_i3771_3_, true);
        this.spawnPoint = p_i3771_3_.getSpawnPos();
    }
