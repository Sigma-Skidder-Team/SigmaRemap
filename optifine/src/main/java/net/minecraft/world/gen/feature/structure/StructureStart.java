...
public abstract class StructureStart
{
    ...
    public StructureStart(Structure<?> p_i438_1_, int p_i438_2_, int p_i438_3_, MutableBoundingBox p_i438_4_, int p_i438_5_, long p_i438_6_)
    {
        this.structure = p_i438_1_;
        this.chunkPosX = p_i438_2_;
        this.chunkPosZ = p_i438_3_;
        this.references = p_i438_5_;
        this.rand = new SharedSeedRandom();
        this.rand.setLargeFeatureSeed(p_i438_6_, p_i438_2_, p_i438_3_);
        this.bounds = p_i438_4_;
    }
