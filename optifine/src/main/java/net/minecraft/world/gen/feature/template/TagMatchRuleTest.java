...
public class TagMatchRuleTest extends RuleTest
{
    ...
    public TagMatchRuleTest(Tag<Block> p_i2162_1_)
    {
        this.tag = p_i2162_1_;
    }

    public <T> TagMatchRuleTest(Dynamic<T> p_i2163_1_)
    {
        this(BlockTags.getCollection().get(new ResourceLocation(p_i2163_1_.get("tag").asString(""))));
    }
