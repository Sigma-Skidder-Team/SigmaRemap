...
public class BeehiveTreeDecorator extends TreeDecorator
{
    ...
    public BeehiveTreeDecorator(float p_i1288_1_)
    {
        super(TreeDecoratorType.field_227428_d_);
        this.probability = p_i1288_1_;
    }

    public <T> BeehiveTreeDecorator(Dynamic<T> p_i1289_1_)
    {
        this(p_i1289_1_.get("probability").asFloat(0.0F));
    }
