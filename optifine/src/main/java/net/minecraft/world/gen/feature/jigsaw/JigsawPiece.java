...
public abstract class JigsawPiece
{
    ...
    protected JigsawPiece(JigsawPattern.PlacementBehaviour p_i574_1_)
    {
        this.projection = p_i574_1_;
    }

    protected JigsawPiece(Dynamic<?> p_i575_1_)
    {
        this.projection = JigsawPattern.PlacementBehaviour.getBehaviour(p_i575_1_.get("projection").asString(JigsawPattern.PlacementBehaviour.RIGID.getName()));
    }
