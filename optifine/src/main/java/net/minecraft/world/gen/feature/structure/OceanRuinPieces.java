...
public class OceanRuinPieces
{
    ...
    public static class Piece extends TemplateStructurePiece
    {
        ...
        public Piece(TemplateManager p_i3080_1_, ResourceLocation p_i3080_2_, BlockPos p_i3080_3_, Rotation p_i3080_4_, float p_i3080_5_, OceanRuinStructure.Type p_i3080_6_, boolean p_i3080_7_)
        {
            super(IStructurePieceType.ORP, 0);
            this.templateName = p_i3080_2_;
            this.templatePosition = p_i3080_3_;
            this.rotation = p_i3080_4_;
            this.integrity = p_i3080_5_;
            this.biomeType = p_i3080_6_;
            this.isLarge = p_i3080_7_;
            this.setup(p_i3080_1_);
        }

        public Piece(TemplateManager p_i3081_1_, CompoundNBT p_i3081_2_)
        {
            super(IStructurePieceType.ORP, p_i3081_2_);
            this.templateName = new ResourceLocation(p_i3081_2_.getString("Template"));
            this.rotation = Rotation.valueOf(p_i3081_2_.getString("Rot"));
            this.integrity = p_i3081_2_.getFloat("Integrity");
            this.biomeType = OceanRuinStructure.Type.valueOf(p_i3081_2_.getString("BiomeType"));
            this.isLarge = p_i3081_2_.getBoolean("IsLarge");
            this.setup(p_i3081_1_);
        }
