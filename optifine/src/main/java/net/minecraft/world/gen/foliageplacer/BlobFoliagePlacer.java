...
{
    public BlobFoliagePlacer(int p_i3246_1_, int p_i3246_2_)
    {
        super(p_i3246_1_, p_i3246_2_, FoliagePlacerType.field_227386_a_);
    }

    public <T> BlobFoliagePlacer(Dynamic<T> p_i3247_1_)
    {
        this(p_i3247_1_.get("radius").asInt(0), p_i3247_1_.get("radius_random").asInt(0));
    }
