...
public class Template
{
    ...
    public static class BlockInfo
    {
        ...
        public BlockInfo(BlockPos p_i1058_1_, BlockState p_i1058_2_, @Nullable CompoundNBT p_i1058_3_)
        {
            this.pos = p_i1058_1_;
            this.state = p_i1058_2_;
            this.nbt = p_i1058_3_;
        }
    ...
    public static class EntityInfo
    {
        ...
        public EntityInfo(Vec3d p_i3613_1_, BlockPos p_i3613_2_, CompoundNBT p_i3613_3_)
        {
            this.pos = p_i3613_1_;
            this.blockPos = p_i3613_2_;
            this.nbt = p_i3613_3_;
        }
    }
}
