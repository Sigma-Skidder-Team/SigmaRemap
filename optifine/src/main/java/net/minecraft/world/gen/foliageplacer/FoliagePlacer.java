...
public abstract class FoliagePlacer implements IDynamicSerializable
{
    ...
    public FoliagePlacer(int p_i4190_1_, int p_i4190_2_, FoliagePlacerType<?> p_i4190_3_)
    {
        this.field_227381_a_ = p_i4190_1_;
        this.field_227382_b_ = p_i4190_2_;
        this.field_227383_c_ = p_i4190_3_;
    }
