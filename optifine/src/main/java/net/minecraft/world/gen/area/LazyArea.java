...
public final class LazyArea implements IArea
{
    ...
    public LazyArea(Long2IntLinkedOpenHashMap p_i709_1_, int p_i709_2_, IPixelTransformer p_i709_3_)
    {
        this.cachedValues = p_i709_1_;
        this.maxCacheSize = p_i709_2_;
        this.pixelTransformer = p_i709_3_;
    }
