...
public abstract class NoiseChunkGenerator<T extends GenerationSettings> extends ChunkGenerator<T>
{
    ...
    public NoiseChunkGenerator(IWorld worldIn, BiomeProvider xCoordIn, int p_i1204_3_, int yCoordIn, int p_i1204_5_, T zCoordIn, boolean p_i1204_7_)
    {
        super(worldIn, xCoordIn, zCoordIn);
        this.verticalNoiseGranularity = yCoordIn;
        this.horizontalNoiseGranularity = p_i1204_3_;
        this.defaultBlock = zCoordIn.getDefaultBlock();
        this.defaultFluid = zCoordIn.getDefaultFluid();
        this.noiseSizeX = 16 / this.horizontalNoiseGranularity;
        this.noiseSizeY = p_i1204_5_ / this.verticalNoiseGranularity;
        ...
        this.surfaceDepthNoise = (INoiseGenerator)(p_i1204_7_ ? new PerlinNoiseGenerator(this.randomSeed, 3, 0) : new OctavesNoiseGenerator(this.randomSeed, 3, 0));
    }
