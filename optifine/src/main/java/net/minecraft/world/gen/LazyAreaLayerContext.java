...
public class LazyAreaLayerContext implements IExtendedNoiseRandom<LazyArea>
{
    ...
    public LazyAreaLayerContext(int p_i2202_1_, long p_i2202_2_, long p_i2202_4_)
    {
        this.field_215719_e = func_227471_b_(p_i2202_2_, p_i2202_4_);
        this.field_215718_b = new ImprovedNoiseGenerator(new Random(p_i2202_2_));
        this.cache = new Long2IntLinkedOpenHashMap(16, 0.25F);
        this.cache.defaultReturnValue(Integer.MIN_VALUE);
        this.maxCacheSize = p_i2202_1_;
    }
