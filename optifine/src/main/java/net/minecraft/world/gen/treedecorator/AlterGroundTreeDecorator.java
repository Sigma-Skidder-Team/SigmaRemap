...
public class AlterGroundTreeDecorator extends TreeDecorator
{
    ...
    public AlterGroundTreeDecorator(BlockStateProvider p_i3381_1_)
    {
        super(TreeDecoratorType.field_227429_e_);
        this.field_227410_b_ = p_i3381_1_;
    }

    public <T> AlterGroundTreeDecorator(Dynamic<T> p_i3382_1_)
    {
        this(Registry.BLOCK_STATE_PROVIDER_TYPE.getOrDefault(new ResourceLocation(p_i3382_1_.get("provider").get("type").asString().orElseThrow(RuntimeException::new))).func_227399_a_(p_i3382_1_.get("provider").orElseEmptyMap()));
    }
