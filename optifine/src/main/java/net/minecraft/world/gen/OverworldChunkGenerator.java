...
public class OverworldChunkGenerator extends NoiseChunkGenerator<OverworldGenSettings>
{
    ...
    public OverworldChunkGenerator(IWorld p_i3372_1_, BiomeProvider p_i3372_2_, OverworldGenSettings p_i3372_3_)
    {
        super(p_i3372_1_, p_i3372_2_, 4, 8, 256, p_i3372_3_, true);
        this.randomSeed.skip(2620);
        this.depthNoise = new OctavesNoiseGenerator(this.randomSeed, 15, 0);
        this.isAmplified = p_i3372_1_.getWorldInfo().getGenerator() == WorldType.AMPLIFIED;
    }
