...
public class WoodlandMansionPieces
{
    ...
    static class Grid
    {
        ...
        public Grid(Random p_i2184_1_)
        {
            this.random = p_i2184_1_;
            int i = 11;
            this.entranceX = 7;
            this.entranceY = 4;
    ...
    public static class MansionTemplate extends TemplateStructurePiece
    {
        ...
        public MansionTemplate(TemplateManager p_i1628_1_, String p_i1628_2_, BlockPos p_i1628_3_, Rotation p_i1628_4_)
        {
            this(p_i1628_1_, p_i1628_2_, p_i1628_3_, p_i1628_4_, Mirror.NONE);
        }

        public MansionTemplate(TemplateManager entitylivingIn, String watchTargetClass, BlockPos maxDistance, Rotation chanceIn, Mirror p_i1629_5_)
        {
            super(IStructurePieceType.WMP, 0);
            this.templateName = watchTargetClass;
            this.templatePosition = maxDistance;
            this.rotation = chanceIn;
            this.mirror = p_i1629_5_;
            this.loadTemplate(entitylivingIn);
        }

        public MansionTemplate(TemplateManager leapingEntity, CompoundNBT leapMotionYIn)
        {
            super(IStructurePieceType.WMP, leapMotionYIn);
            this.templateName = leapMotionYIn.getString("Template");
            this.rotation = Rotation.valueOf(leapMotionYIn.getString("Rot"));
            this.mirror = Mirror.valueOf(leapMotionYIn.getString("Mi"));
            this.loadTemplate(leapingEntity);
        }
    ...
    static class Placer
    {
        ...
        public Placer(TemplateManager p_i2754_1_, Random p_i2754_2_)
        {
            this.templateManager = p_i2754_1_;
            this.random = p_i2754_2_;
        }
    ...
    static class SimpleGrid
    {
        ...
        public SimpleGrid(int p_i578_1_, int p_i578_2_, int p_i578_3_)
        {
            this.width = p_i578_1_;
            this.height = p_i578_2_;
            this.valueIfOutside = p_i578_3_;
            this.grid = new int[p_i578_1_][p_i578_2_];
        }
