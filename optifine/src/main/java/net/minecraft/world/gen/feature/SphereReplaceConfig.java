...
public class SphereReplaceConfig implements IFeatureConfig
{
    ...
    public SphereReplaceConfig(BlockState p_i3668_1_, int p_i3668_2_, int p_i3668_3_, List<BlockState> p_i3668_4_)
    {
        this.state = p_i3668_1_;
        this.radius = p_i3668_2_;
        this.ySize = p_i3668_3_;
        this.targets = p_i3668_4_;
    }
