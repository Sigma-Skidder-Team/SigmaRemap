...
{
    public PineFoliagePlacer(int p_i3150_1_, int p_i3150_2_)
    {
        super(p_i3150_1_, p_i3150_2_, FoliagePlacerType.field_227388_c_);
    }

    public <T> PineFoliagePlacer(Dynamic<T> p_i3151_1_)
    {
        this(p_i3151_1_.get("radius").asInt(0), p_i3151_1_.get("radius_random").asInt(0));
    }
