...
public class MineshaftPieces
{
    ...
    public static class Corridor extends MineshaftPieces.Piece
    {
        ...
        public Corridor(TemplateManager p_i2359_1_, CompoundNBT p_i2359_2_)
        {
            super(IStructurePieceType.MSCORRIDOR, p_i2359_2_);
            this.hasRails = p_i2359_2_.getBoolean("hr");
            this.hasSpiders = p_i2359_2_.getBoolean("sc");
            this.spawnerPlaced = p_i2359_2_.getBoolean("hps");
            this.sectionCount = p_i2359_2_.getInt("Num");
        }
        ...
        public Corridor(int p_i2360_1_, Random p_i2360_2_, MutableBoundingBox p_i2360_3_, Direction p_i2360_4_, MineshaftStructure.Type p_i2360_5_)
        {
            super(IStructurePieceType.MSCORRIDOR, p_i2360_1_, p_i2360_5_);
            this.setCoordBaseMode(p_i2360_4_);
            this.boundingBox = p_i2360_3_;
            this.hasRails = p_i2360_2_.nextInt(3) == 0;
            this.hasSpiders = !this.hasRails && p_i2360_2_.nextInt(23) == 0;

            if (this.getCoordBaseMode().getAxis() == Direction.Axis.Z)
            {
                this.sectionCount = p_i2360_3_.getZSize() / 5;
            }
            else
            {
                this.sectionCount = p_i2360_3_.getXSize() / 5;
            }
        }
    ...
    public static class Cross extends MineshaftPieces.Piece
    {
        ...
        public Cross(TemplateManager p_i862_1_, CompoundNBT p_i862_2_)
        {
            super(IStructurePieceType.MSCROSSING, p_i862_2_);
            this.isMultipleFloors = p_i862_2_.getBoolean("tf");
            this.corridorDirection = Direction.byHorizontalIndex(p_i862_2_.getInt("D"));
        }
        ...
        public Cross(int p_i863_1_, MutableBoundingBox p_i863_2_, @Nullable Direction p_i863_3_, MineshaftStructure.Type p_i863_4_)
        {
            super(IStructurePieceType.MSCROSSING, p_i863_1_, p_i863_4_);
            this.corridorDirection = p_i863_3_;
            this.boundingBox = p_i863_2_;
            this.isMultipleFloors = p_i863_2_.getYSize() > 3;
        }
    ...
    abstract static class Piece extends StructurePiece
    {
        ...
        public Piece(IStructurePieceType p_i1484_1_, int p_i1484_2_, MineshaftStructure.Type p_i1484_3_)
        {
            super(p_i1484_1_, p_i1484_2_);
            this.mineShaftType = p_i1484_3_;
        }

        public Piece(IStructurePieceType p_i1485_1_, CompoundNBT p_i1485_2_)
        {
            super(p_i1485_1_, p_i1485_2_);
            this.mineShaftType = MineshaftStructure.Type.byId(p_i1485_2_.getInt("MST"));
        }
    ...
    public static class Room extends MineshaftPieces.Piece
    {
        ...
        public Room(int p_i2422_1_, Random p_i2422_2_, int p_i2422_3_, int p_i2422_4_, MineshaftStructure.Type p_i2422_5_)
        {
            super(IStructurePieceType.MSROOM, p_i2422_1_, p_i2422_5_);
            this.mineShaftType = p_i2422_5_;
            this.boundingBox = new MutableBoundingBox(p_i2422_3_, 50, p_i2422_4_, p_i2422_3_ + 7 + p_i2422_2_.nextInt(6), 54 + p_i2422_2_.nextInt(6), p_i2422_4_ + 7 + p_i2422_2_.nextInt(6));
        }

        public Room(TemplateManager p_i2423_1_, CompoundNBT p_i2423_2_)
        {
            super(IStructurePieceType.MSROOM, p_i2423_2_);
            ListNBT listnbt = p_i2423_2_.getList("Entrances", 11);
    ...
    {
        public Stairs(int p_i1340_1_, MutableBoundingBox p_i1340_2_, Direction p_i1340_3_, MineshaftStructure.Type p_i1340_4_)
        {
            super(IStructurePieceType.MSSTAIRS, p_i1340_1_, p_i1340_4_);
            this.setCoordBaseMode(p_i1340_3_);
            this.boundingBox = p_i1340_2_;
        }

        public Stairs(TemplateManager p_i1341_1_, CompoundNBT p_i1341_2_)
        {
            super(IStructurePieceType.MSSTAIRS, p_i1341_2_);
        }
