...
public class FortressStructure extends Structure<NoFeatureConfig>
{
    ...
    public FortressStructure(Function < Dynamic<?>, ? extends NoFeatureConfig > p_i3550_1_)
    {
        super(p_i3550_1_);
    }
    ...
    {
        public Start(Structure<?> p_i616_1_, int p_i616_2_, int p_i616_3_, MutableBoundingBox p_i616_4_, int p_i616_5_, long p_i616_6_)
        {
            super(p_i616_1_, p_i616_2_, p_i616_3_, p_i616_4_, p_i616_5_, p_i616_6_);
        }
