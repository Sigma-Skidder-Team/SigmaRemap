...
public class LegacyStructureDataUtil
{
    ...
    public LegacyStructureDataUtil(@Nullable DimensionSavedDataManager p_i1208_1_, List<String> p_i1208_2_, List<String> p_i1208_3_)
    {
        this.field_215132_f = p_i1208_2_;
        this.field_215133_g = p_i1208_3_;
        this.func_212184_a(p_i1208_1_);
        boolean flag = false;
