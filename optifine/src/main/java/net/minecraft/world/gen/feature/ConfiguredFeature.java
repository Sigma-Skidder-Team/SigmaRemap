...
public class ConfiguredFeature<FC extends IFeatureConfig, F extends Feature<FC>>
{
    ...
    public ConfiguredFeature(F p_i1480_1_, FC p_i1480_2_)
    {
        this.feature = p_i1480_1_;
        this.config = p_i1480_2_;
    }

    public ConfiguredFeature(F p_i1481_1_, Dynamic<?> p_i1481_2_)
    {
        this(p_i1481_1_, (FC)p_i1481_1_.createConfig(p_i1481_2_));
    }
