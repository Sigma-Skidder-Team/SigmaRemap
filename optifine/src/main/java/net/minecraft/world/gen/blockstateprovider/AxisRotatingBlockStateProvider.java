...
public class AxisRotatingBlockStateProvider extends BlockStateProvider
{
    ...
    public AxisRotatingBlockStateProvider(Block p_i1876_1_)
    {
        super(BlockStateProviderType.SIMPLE_STATE_PROVIDER);
        this.field_227404_b_ = p_i1876_1_;
    }

    public <T> AxisRotatingBlockStateProvider(Dynamic<T> p_i1877_1_)
    {
        this(BlockState.deserialize(p_i1877_1_.get("state").orElseEmptyMap()).getBlock());
    }
