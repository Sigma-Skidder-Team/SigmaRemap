...
public class OceanMonumentPieces
{
    ...
    {
        public DoubleXRoom(Direction p_i2495_1_, OceanMonumentPieces.RoomDefinition p_i2495_2_)
        {
            super(IStructurePieceType.OMDXR, 1, p_i2495_1_, p_i2495_2_, 2, 1, 1);
        }

        public DoubleXRoom(TemplateManager p_i2496_1_, CompoundNBT p_i2496_2_)
        {
            super(IStructurePieceType.OMDXR, p_i2496_2_);
        }
    ...
    {
        public DoubleXYRoom(Direction p_i2924_1_, OceanMonumentPieces.RoomDefinition p_i2924_2_)
        {
            super(IStructurePieceType.OMDXYR, 1, p_i2924_1_, p_i2924_2_, 2, 2, 1);
        }

        public DoubleXYRoom(TemplateManager p_i2925_1_, CompoundNBT p_i2925_2_)
        {
            super(IStructurePieceType.OMDXYR, p_i2925_2_);
        }
    ...
    {
        public DoubleYRoom(Direction p_i3962_1_, OceanMonumentPieces.RoomDefinition p_i3962_2_)
        {
            super(IStructurePieceType.OMDYR, 1, p_i3962_1_, p_i3962_2_, 1, 2, 1);
        }

        public DoubleYRoom(TemplateManager p_i3963_1_, CompoundNBT p_i3963_2_)
        {
            super(IStructurePieceType.OMDYR, p_i3963_2_);
        }
    ...
    {
        public DoubleYZRoom(Direction p_i1905_1_, OceanMonumentPieces.RoomDefinition p_i1905_2_)
        {
            super(IStructurePieceType.OMDYZR, 1, p_i1905_1_, p_i1905_2_, 1, 2, 2);
        }

        public DoubleYZRoom(TemplateManager p_i1906_1_, CompoundNBT p_i1906_2_)
        {
            super(IStructurePieceType.OMDYZR, p_i1906_2_);
        }
    ...
    {
        public DoubleZRoom(Direction p_i2240_1_, OceanMonumentPieces.RoomDefinition p_i2240_2_)
        {
            super(IStructurePieceType.OMDZR, 1, p_i2240_1_, p_i2240_2_, 1, 1, 2);
        }

        public DoubleZRoom(TemplateManager p_i2241_1_, CompoundNBT p_i2241_2_)
        {
            super(IStructurePieceType.OMDZR, p_i2241_2_);
        }
    ...
    {
        public EntryRoom(Direction p_i1596_1_, OceanMonumentPieces.RoomDefinition p_i1596_2_)
        {
            super(IStructurePieceType.OMENTRY, 1, p_i1596_1_, p_i1596_2_, 1, 1, 1);
        }

        public EntryRoom(TemplateManager p_i1597_1_, CompoundNBT p_i1597_2_)
        {
            super(IStructurePieceType.OMENTRY, p_i1597_2_);
        }
    ...
    public static class MonumentBuilding extends OceanMonumentPieces.Piece
    {
        ...
        public MonumentBuilding(Random p_i3332_1_, int p_i3332_2_, int p_i3332_3_, Direction p_i3332_4_)
        {
            super(IStructurePieceType.OMB, 0);
            this.setCoordBaseMode(p_i3332_4_);
            Direction direction = this.getCoordBaseMode();

            if (direction.getAxis() == Direction.Axis.Z)
            {
                this.boundingBox = new MutableBoundingBox(p_i3332_2_, 39, p_i3332_3_, p_i3332_2_ + 58 - 1, 61, p_i3332_3_ + 58 - 1);
            }
            else
            {
                this.boundingBox = new MutableBoundingBox(p_i3332_2_, 39, p_i3332_3_, p_i3332_2_ + 58 - 1, 61, p_i3332_3_ + 58 - 1);
            ...
            List<OceanMonumentPieces.RoomDefinition> list = this.generateRoomGraph(p_i3332_1_);
            ...
            for (OceanMonumentPieces.RoomDefinition oceanmonumentpieces$roomdefinition : list)
            {
                if (!oceanmonumentpieces$roomdefinition.claimed && !oceanmonumentpieces$roomdefinition.isSpecial())
                {
                    ...
                    this.childPieces.add(oceanmonumentpieces$imonumentroomfithelper.create(direction, oceanmonumentpieces$roomdefinition, p_i3332_1_));
                }
            }
        ...
        public MonumentBuilding(TemplateManager p_i3333_1_, CompoundNBT p_i3333_2_)
        {
            super(IStructurePieceType.OMB, p_i3333_2_);
        }
    ...
    {
        public MonumentCoreRoom(Direction p_i3453_1_, OceanMonumentPieces.RoomDefinition p_i3453_2_)
        {
            super(IStructurePieceType.OMCR, 1, p_i3453_1_, p_i3453_2_, 2, 2, 2);
        }

        public MonumentCoreRoom(TemplateManager p_i3454_1_, CompoundNBT p_i3454_2_)
        {
            super(IStructurePieceType.OMCR, p_i3454_2_);
        }
    ...
    {
        public Penthouse(Direction p_i962_1_, MutableBoundingBox p_i962_2_)
        {
            super(IStructurePieceType.OMPENTHOUSE, p_i962_1_, p_i962_2_);
        }

        public Penthouse(TemplateManager p_i963_1_, CompoundNBT p_i963_2_)
        {
            super(IStructurePieceType.OMPENTHOUSE, p_i963_2_);
        }
    ...
    public abstract static class Piece extends StructurePiece
    {
        ...
        public Piece(IStructurePieceType p_i836_1_, int p_i836_2_)
        {
            super(p_i836_1_, p_i836_2_);
        }

        public Piece(IStructurePieceType p_i837_1_, Direction p_i837_2_, MutableBoundingBox p_i837_3_)
        {
            super(p_i837_1_, 1);
            this.setCoordBaseMode(p_i837_2_);
            this.boundingBox = p_i837_3_;
        }

        protected Piece(IStructurePieceType p_i838_1_, int p_i838_2_, Direction p_i838_3_, OceanMonumentPieces.RoomDefinition p_i838_4_, int p_i838_5_, int p_i838_6_, int p_i838_7_)
        {
            super(p_i838_1_, p_i838_2_);
            this.setCoordBaseMode(p_i838_3_);
            this.roomDefinition = p_i838_4_;
            int i = p_i838_4_.index;
            int j = i % 5;
            int k = i / 5 % 5;
            int l = i / 25;

            if (p_i838_3_ != Direction.NORTH && p_i838_3_ != Direction.SOUTH)
            {
                this.boundingBox = new MutableBoundingBox(0, 0, 0, p_i838_7_ * 8 - 1, p_i838_6_ * 4 - 1, p_i838_5_ * 8 - 1);
            }
            else
            {
                this.boundingBox = new MutableBoundingBox(0, 0, 0, p_i838_5_ * 8 - 1, p_i838_6_ * 4 - 1, p_i838_7_ * 8 - 1);
            }

            switch (p_i838_3_)
            {
                case NORTH:
                    this.boundingBox.offset(j * 8, l * 4, -(k + p_i838_7_) * 8 + 1);
                    break;
                ...
                case WEST:
                    this.boundingBox.offset(-(k + p_i838_7_) * 8 + 1, l * 4, j * 8);
                    break;
        ...
        public Piece(IStructurePieceType p_i839_1_, CompoundNBT p_i839_2_)
        {
            super(p_i839_1_, p_i839_2_);
        }
    ...
    static class RoomDefinition
    {
        ...
        public RoomDefinition(int p_i3287_1_)
        {
            this.index = p_i3287_1_;
        }
    ...
    public static class SimpleRoom extends OceanMonumentPieces.Piece
    {
        ...
        public SimpleRoom(Direction p_i3400_1_, OceanMonumentPieces.RoomDefinition p_i3400_2_, Random p_i3400_3_)
        {
            super(IStructurePieceType.OMSIMPLE, 1, p_i3400_1_, p_i3400_2_, 1, 1, 1);
            this.mainDesign = p_i3400_3_.nextInt(3);
        }

        public SimpleRoom(TemplateManager p_i3401_1_, CompoundNBT p_i3401_2_)
        {
            super(IStructurePieceType.OMSIMPLE, p_i3401_2_);
        }
    ...
    {
        public SimpleTopRoom(Direction p_i3413_1_, OceanMonumentPieces.RoomDefinition p_i3413_2_)
        {
            super(IStructurePieceType.OMSIMPLET, 1, p_i3413_1_, p_i3413_2_, 1, 1, 1);
        }

        public SimpleTopRoom(TemplateManager p_i3414_1_, CompoundNBT p_i3414_2_)
        {
            super(IStructurePieceType.OMSIMPLET, p_i3414_2_);
        }
    ...
    public static class WingRoom extends OceanMonumentPieces.Piece
    {
        ...
        public WingRoom(Direction p_i2129_1_, MutableBoundingBox p_i2129_2_, int p_i2129_3_)
        {
            super(IStructurePieceType.OMWR, p_i2129_1_, p_i2129_2_);
            this.mainDesign = p_i2129_3_ & 1;
        }

        public WingRoom(TemplateManager p_i2130_1_, CompoundNBT p_i2130_2_)
        {
            super(IStructurePieceType.OMWR, p_i2130_2_);
        }
