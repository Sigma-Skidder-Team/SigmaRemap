...
public class BlockStateMatchRuleTest extends RuleTest
{
    ...
    public BlockStateMatchRuleTest(BlockState p_i3303_1_)
    {
        this.state = p_i3303_1_;
    }

    public <T> BlockStateMatchRuleTest(Dynamic<T> p_i3304_1_)
    {
        this(BlockState.deserialize(p_i3304_1_.get("blockstate").orElseEmptyMap()));
    }
