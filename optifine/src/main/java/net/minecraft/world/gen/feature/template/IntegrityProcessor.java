...
public class IntegrityProcessor extends StructureProcessor
{
    ...
    public IntegrityProcessor(float p_i1695_1_)
    {
        this.integrity = p_i1695_1_;
    }

    public IntegrityProcessor(Dynamic<?> p_i1696_1_)
    {
        this(p_i1696_1_.get("integrity").asFloat(1.0F));
    }
