...
{
    public FancyTreeFeature(Function < Dynamic<?>, ? extends TreeFeatureConfig > p_i2608_1_)
    {
        super(p_i2608_1_);
    }
    ...
    static class ExtendedPos extends BlockPos
    {
        ...
        public ExtendedPos(BlockPos p_i2349_1_, int p_i2349_2_)
        {
            super(p_i2349_1_.getX(), p_i2349_1_.getY(), p_i2349_1_.getZ());
            this.field_227242_b_ = p_i2349_2_;
        }
