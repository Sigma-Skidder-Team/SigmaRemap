...
{
    public SpruceFoliagePlacer(int p_i2973_1_, int p_i2973_2_)
    {
        super(p_i2973_1_, p_i2973_2_, FoliagePlacerType.field_227387_b_);
    }

    public <T> SpruceFoliagePlacer(Dynamic<T> p_i2974_1_)
    {
        this(p_i2974_1_.get("radius").asInt(0), p_i2974_1_.get("radius_random").asInt(0));
    }
