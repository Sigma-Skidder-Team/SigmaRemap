...
public class JunglePyramidPiece extends ScatteredStructurePiece
{
    ...
    public JunglePyramidPiece(Random p_i3390_1_, int p_i3390_2_, int p_i3390_3_)
    {
        super(IStructurePieceType.TEJP, p_i3390_1_, p_i3390_2_, 64, p_i3390_3_, 12, 10, 15);
    }

    public JunglePyramidPiece(TemplateManager p_i3391_1_, CompoundNBT p_i3391_2_)
    {
        super(IStructurePieceType.TEJP, p_i3391_2_);
        this.placedMainChest = p_i3391_2_.getBoolean("placedMainChest");
        this.placedHiddenChest = p_i3391_2_.getBoolean("placedHiddenChest");
        this.placedTrap1 = p_i3391_2_.getBoolean("placedTrap1");
        this.placedTrap2 = p_i3391_2_.getBoolean("placedTrap2");
    }
