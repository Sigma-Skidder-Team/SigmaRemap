...
{
    public WoodlandMansionStructure(Function < Dynamic<?>, ? extends NoFeatureConfig > p_i4132_1_)
    {
        super(p_i4132_1_);
    }
    ...
    {
        public Start(Structure<?> p_i3370_1_, int p_i3370_2_, int p_i3370_3_, MutableBoundingBox p_i3370_4_, int p_i3370_5_, long p_i3370_6_)
        {
            super(p_i3370_1_, p_i3370_2_, p_i3370_3_, p_i3370_4_, p_i3370_5_, p_i3370_6_);
        }
