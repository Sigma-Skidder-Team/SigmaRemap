...
public class ConfiguredPlacement<DC extends IPlacementConfig>
{
    ...
    public ConfiguredPlacement(Placement<DC> p_i442_1_, Dynamic<?> p_i442_2_)
    {
        this(p_i442_1_, p_i442_1_.createConfig(p_i442_2_));
    }

    public ConfiguredPlacement(Placement<DC> p_i443_1_, DC p_i443_2_)
    {
        this.decorator = p_i443_1_;
        this.config = p_i443_2_;
    }
