...
public class EndCityPieces
{
    ...
    public static class CityTemplate extends TemplateStructurePiece
    {
        ...
        public CityTemplate(TemplateManager p_i2645_1_, String p_i2645_2_, BlockPos p_i2645_3_, Rotation p_i2645_4_, boolean p_i2645_5_)
        {
            super(IStructurePieceType.ECP, 0);
            this.pieceName = p_i2645_2_;
            this.templatePosition = p_i2645_3_;
            this.rotation = p_i2645_4_;
            this.overwrite = p_i2645_5_;
            this.loadTemplate(p_i2645_1_);
        }

        public CityTemplate(TemplateManager p_i2646_1_, CompoundNBT p_i2646_2_)
        {
            super(IStructurePieceType.ECP, p_i2646_2_);
            this.pieceName = p_i2646_2_.getString("Template");
            this.rotation = Rotation.valueOf(p_i2646_2_.getString("Rot"));
            this.overwrite = p_i2646_2_.getBoolean("OW");
            this.loadTemplate(p_i2646_1_);
        }
