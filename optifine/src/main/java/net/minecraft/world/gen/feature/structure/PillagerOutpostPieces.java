...
public class PillagerOutpostPieces
{
    ...
    {
        public PillageOutpost(TemplateManager p_i2842_1_, JigsawPiece p_i2842_2_, BlockPos p_i2842_3_, int p_i2842_4_, Rotation p_i2842_5_, MutableBoundingBox p_i2842_6_)
        {
            super(IStructurePieceType.PCP, p_i2842_1_, p_i2842_2_, p_i2842_3_, p_i2842_4_, p_i2842_5_, p_i2842_6_);
        }

        public PillageOutpost(TemplateManager p_i2843_1_, CompoundNBT p_i2843_2_)
        {
            super(p_i2843_1_, p_i2843_2_, IStructurePieceType.PCP);
        }
    }
}
