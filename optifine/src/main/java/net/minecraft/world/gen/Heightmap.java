...
public class Heightmap
{
    ...
    public Heightmap(IChunk p_i955_1_, Heightmap.Type p_i955_2_)
    {
        this.heightLimitPredicate = p_i955_2_.getHeightLimitPredicate();
        this.chunk = p_i955_1_;
    }
    ...
    public static enum Type
    {
        ...
        private Type(String p_i2654_3_, Heightmap.Usage p_i2654_4_, Predicate<BlockState> p_i2654_5_)
        {
            this.id = p_i2654_3_;
            this.usage = p_i2654_4_;
            this.heightLimitPredicate = p_i2654_5_;
        }
