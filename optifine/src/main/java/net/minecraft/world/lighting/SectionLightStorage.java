...
public abstract class SectionLightStorage<M extends LightDataMap<M>> extends SectionDistanceGraph
{
    ...
    protected SectionLightStorage(LightType p_i3531_1_, IChunkLightProvider p_i3531_2_, M p_i3531_3_)
    {
        super(3, 16, 256);
        this.type = p_i3531_1_;
        this.chunkProvider = p_i3531_2_;
        this.cachedLightData = p_i3531_3_;
        this.uncachedLightData = p_i3531_3_.copy();
