...
{
    protected BlockLightStorage(IChunkLightProvider p_i2652_1_)
    {
        super(LightType.BLOCK, p_i2652_1_, new BlockLightStorage.StorageMap(new Long2ObjectOpenHashMap<>()));
    }
    ...
    {
        public StorageMap(Long2ObjectOpenHashMap<NibbleArray> p_i1439_1_)
        {
            super(p_i1439_1_);
        }
