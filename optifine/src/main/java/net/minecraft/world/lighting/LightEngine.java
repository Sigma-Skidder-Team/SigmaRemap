...
public abstract class LightEngine<M extends LightDataMap<M>, S extends SectionLightStorage<M>> extends LevelBasedGraph implements IWorldLightListener
{
    ...
    public LightEngine(IChunkLightProvider p_i3415_1_, LightType p_i3415_2_, S p_i3415_3_)
    {
        super(16, 256, 8192);
        this.chunkProvider = p_i3415_1_;
        this.type = p_i3415_2_;
        this.storage = p_i3415_3_;
