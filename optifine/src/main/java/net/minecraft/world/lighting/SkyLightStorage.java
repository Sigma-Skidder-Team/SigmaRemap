...
public class SkyLightStorage extends SectionLightStorage<SkyLightStorage.StorageMap>
{
    ...
    protected SkyLightStorage(IChunkLightProvider p_i1504_1_)
    {
        super(LightType.SKY, p_i1504_1_, new SkyLightStorage.StorageMap(new Long2ObjectOpenHashMap<>(), new Long2IntOpenHashMap(), Integer.MAX_VALUE));
    }
    ...
    public static final class StorageMap extends LightDataMap<SkyLightStorage.StorageMap>
    {
        ...
        public StorageMap(Long2ObjectOpenHashMap<NibbleArray> p_i3408_1_, Long2IntOpenHashMap p_i3408_2_, int p_i3408_3_)
        {
            super(p_i3408_1_);
            this.field_215653_c = p_i3408_2_;
            p_i3408_2_.defaultReturnValue(p_i3408_3_);
            this.field_215652_b = p_i3408_3_;
        }
