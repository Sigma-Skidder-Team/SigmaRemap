...
public class WorldLightManager implements ILightListener
{
    ...
    public WorldLightManager(IChunkLightProvider p_i979_1_, boolean p_i979_2_, boolean p_i979_3_)
    {
        this.blockLight = p_i979_2_ ? new BlockLightEngine(p_i979_1_) : null;
        this.skyLight = p_i979_3_ ? new SkyLightEngine(p_i979_1_) : null;
    }
