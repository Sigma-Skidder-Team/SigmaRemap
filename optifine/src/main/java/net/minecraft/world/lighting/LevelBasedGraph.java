...
public abstract class LevelBasedGraph
{
    ...
    protected LevelBasedGraph(int p_i1321_1_, final int p_i1321_2_, final int p_i1321_3_)
    {
        if (p_i1321_1_ >= 254)
        {
        ...
        {
            this.levelCount = p_i1321_1_;
            this.updatesByLevel = new LongLinkedOpenHashSet[p_i1321_1_];

            for (int i = 0; i < p_i1321_1_; ++i)
            {
                this.updatesByLevel[i] = new LongLinkedOpenHashSet(p_i1321_2_, 0.5F)
                {
                    protected void rehash(int p_rehash_1_)
                    {
                        if (p_rehash_1_ > p_i1321_2_)
                        {
            ...
            this.propagationLevels = new Long2ByteOpenHashMap(p_i1321_3_, 0.5F)
            {
                protected void rehash(int p_rehash_1_)
                {
                    if (p_rehash_1_ > p_i1321_3_)
                    {
                        super.rehash(p_rehash_1_);
                    }
                }
            ...
            this.minLevelToUpdate = p_i1321_1_;
        }
    }
