...
public class TrackedEntity
{
    ...
    public TrackedEntity(ServerWorld p_i2762_1_, Entity p_i2762_2_, int p_i2762_3_, boolean p_i2762_4_, Consumer < IPacket<? >> p_i2762_5_)
    {
        this.world = p_i2762_1_;
        this.packetConsumer = p_i2762_5_;
        this.trackedEntity = p_i2762_2_;
        this.updateFrequency = p_i2762_3_;
        this.sendVelocityUpdates = p_i2762_4_;
        this.updateEncodedPosition();
        this.encodedRotationYaw = MathHelper.floor(p_i2762_2_.rotationYaw * 256.0F / 360.0F);
        this.encodedRotationPitch = MathHelper.floor(p_i2762_2_.rotationPitch * 256.0F / 360.0F);
        this.encodedRotationYawHead = MathHelper.floor(p_i2762_2_.getRotationYawHead() * 256.0F / 360.0F);
        this.onGround = p_i2762_2_.onGround;
    }
