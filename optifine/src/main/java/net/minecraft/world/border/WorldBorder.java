...
public class WorldBorder
{
    ...
    class MovingBorderInfo implements WorldBorder.IBorderInfo
    {
        ...
        private MovingBorderInfo(double p_i559_2_, double p_i559_4_, long p_i559_6_)
        {
            this.oldSize = p_i559_2_;
            this.newSize = p_i559_4_;
            this.transitionTime = (double)p_i559_6_;
            this.startTime = Util.milliTime();
            this.endTime = this.startTime + p_i559_6_;
        }
    ...
    class StationaryBorderInfo implements WorldBorder.IBorderInfo
    {
        ...
        public StationaryBorderInfo(double p_i4195_2_)
        {
            this.size = p_i4195_2_;
            this.updateBox();
        }
