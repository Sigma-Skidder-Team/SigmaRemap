...
public class SerializableTickList<T> implements ITickList<T>
{
    ...
    public SerializableTickList(Function<T, ResourceLocation> worldIn, List<NextTickListEntry<T>> xCoordIn)
    {
        this(worldIn, Sets.newHashSet(xCoordIn));
    }

    private SerializableTickList(Function<T, ResourceLocation> p_i1199_1_, Set<NextTickListEntry<T>> p_i1199_2_)
    {
        this.ticks = p_i1199_2_;
        this.toId = p_i1199_1_;
    }
