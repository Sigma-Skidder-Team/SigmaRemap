...
public class ChunkTaskPriorityQueueSorter implements AutoCloseable, ChunkHolder.IListener
{
    ...
    public ChunkTaskPriorityQueueSorter(List < ITaskExecutor<? >> p_i2521_1_, Executor p_i2521_2_, int p_i2521_3_)
    {
        this.queues = p_i2521_1_.stream().collect(Collectors.toMap(Function.identity(), (p_219084_1_) ->
        {
            return new ChunkTaskPriorityQueue(p_219084_1_.getName() + "_queue", p_i2521_3_);
        }));
        this.field_219095_c = Sets.newHashSet(p_i2521_1_);
        this.sorter = new DelegatedTaskExecutor<>(new ITaskQueue.Priority(4), p_i2521_2_, "sorter");
    }
    ...
    public static final class FunctionEntry<T>
    {
        ...
        private FunctionEntry(Function<ITaskExecutor<Unit>, T> p_i2627_1_, long p_i2627_2_, IntSupplier p_i2627_4_)
        {
            this.task = p_i2627_1_;
            this.chunkPos = p_i2627_2_;
            this.field_219430_c = p_i2627_4_;
        }
    }
    ...
    public static final class RunnableEntry
    {
        ...
        private RunnableEntry(Runnable p_i1469_1_, long p_i1469_2_, boolean p_i1469_4_)
        {
            this.field_219434_a = p_i1469_1_;
            this.field_219435_b = p_i1469_2_;
            this.field_219436_c = p_i1469_4_;
        }
    }
}
