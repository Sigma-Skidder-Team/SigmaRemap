...
public class RegionFileVersion
{
    ...
    private RegionFileVersion(int p_i1014_1_, RegionFileVersion.IWrapper<InputStream> p_i1014_2_, RegionFileVersion.IWrapper<OutputStream> p_i1014_3_)
    {
        this.field_227162_e_ = p_i1014_1_;
        this.field_227163_f_ = p_i1014_2_;
        this.field_227164_g_ = p_i1014_3_;
    }
