...
public class ChunkLoader implements AutoCloseable
{
    ...
    public ChunkLoader(File p_i4101_1_, DataFixer p_i4101_2_)
    {
        this.dataFixer = p_i4101_2_;
        this.field_227077_a_ = new IOWorker(new RegionFileCache(p_i4101_1_), "chunk");
    }
