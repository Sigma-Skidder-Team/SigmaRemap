...
public class TrackingChunkStatusListener implements IChunkStatusListener
{
    ...
    public TrackingChunkStatusListener(int p_i4076_1_)
    {
        this.loggingListener = new LoggingChunkStatusListener(p_i4076_1_);
        this.diameter = p_i4076_1_ * 2 + 1;
        this.positionOffset = p_i4076_1_ + ChunkStatus.maxDistance();
