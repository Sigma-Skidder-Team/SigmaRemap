...
public class NibbleArray
{
    ...
    public NibbleArray(byte[] p_i4035_1_)
    {
        this.data = p_i4035_1_;

        if (p_i4035_1_.length != 2048)
        {
            throw(IllegalArgumentException)Util.pauseDevMode(new IllegalArgumentException("ChunkNibbleArrays should be 2048 bytes not: " + p_i4035_1_.length));
        }
    }

    protected NibbleArray(int p_i4036_1_)
    {
        this.data = new byte[p_i4036_1_];
    }
