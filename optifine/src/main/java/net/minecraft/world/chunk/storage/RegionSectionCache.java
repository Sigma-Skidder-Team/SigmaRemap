...
public class RegionSectionCache<R extends IDynamicSerializable> implements AutoCloseable
{
    ...
    public RegionSectionCache(File p_i3574_1_, BiFunction < Runnable, Dynamic<?>, R > p_i3574_2_, Function<Runnable, R> p_i3574_3_, DataFixer p_i3574_4_, DefaultTypeReferences p_i3574_5_)
    {
        this.field_219123_e = p_i3574_2_;
        this.field_219124_f = p_i3574_3_;
        this.field_219125_g = p_i3574_4_;
        this.field_219126_h = p_i3574_5_;
        this.field_227173_b_ = new IOWorker(new RegionFileCache(p_i3574_1_), p_i3574_1_.getName());
    }
