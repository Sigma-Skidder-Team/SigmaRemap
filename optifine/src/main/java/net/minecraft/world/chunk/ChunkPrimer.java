...
public class ChunkPrimer implements IChunk
{
    ...
    public ChunkPrimer(ChunkPos p_i1945_1_, UpgradeData p_i1945_2_)
    {
        this(p_i1945_1_, p_i1945_2_, (ChunkSection[])null, new ChunkPrimerTickList<>((p_205332_0_) ->
        {
            return p_205332_0_ == null || p_205332_0_.getDefaultState().isAir();
        }, p_i1945_1_), new ChunkPrimerTickList<>((p_205766_0_) ->
        {
            return p_205766_0_ == null || p_205766_0_ == Fluids.EMPTY;
        }, p_i1945_1_));
    }

    public ChunkPrimer(ChunkPos p_i1946_1_, UpgradeData p_i1946_2_, @Nullable ChunkSection[] p_i1946_3_, ChunkPrimerTickList<Block> p_i1946_4_, ChunkPrimerTickList<Fluid> p_i1946_5_)
    {
        this.pos = p_i1946_1_;
        this.upgradeData = p_i1946_2_;
        this.pendingBlockTicks = p_i1946_4_;
        this.pendingFluidTicks = p_i1946_5_;

        if (p_i1946_3_ != null)
        {
            if (this.sections.length == p_i1946_3_.length)
            {
                System.arraycopy(p_i1946_3_, 0, this.sections, 0, this.sections.length);
            }
            else
            {
                LOGGER.warn("Could not set level chunk sections, array length is {} instead of {}", p_i1946_3_.length, this.sections.length);
            }
        }
    }
