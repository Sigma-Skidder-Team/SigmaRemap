...
public class ChunkStatus
{
    ...
    ChunkStatus(String p_i2547_1_, @Nullable ChunkStatus p_i2547_2_, int p_i2547_3_, EnumSet<Heightmap.Type> p_i2547_4_, ChunkStatus.Type p_i2547_5_, ChunkStatus.IGenerationWorker p_i2547_6_, ChunkStatus.ILoadingWorker p_i2547_7_)
    {
        this.name = p_i2547_1_;
        this.parent = p_i2547_2_ == null ? this : p_i2547_2_;
        this.generationWorker = p_i2547_6_;
        this.loadingWorker = p_i2547_7_;
        this.taskRange = p_i2547_3_;
        this.type = p_i2547_5_;
        this.heightmaps = p_i2547_4_;
        this.ordinal = p_i2547_2_ == null ? 0 : p_i2547_2_.ordinal() + 1;
    }
