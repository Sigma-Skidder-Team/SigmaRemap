...
public class ChunkPrimerTickList<T> implements ITickList<T>
{
    ...
    public ChunkPrimerTickList(Predicate<T> p_i2883_1_, ChunkPos p_i2883_2_)
    {
        this(p_i2883_1_, p_i2883_2_, new ListNBT());
    }

    public ChunkPrimerTickList(Predicate<T> p_i2884_1_, ChunkPos p_i2884_2_, ListNBT p_i2884_3_)
    {
        this.filter = p_i2884_1_;
        this.pos = p_i2884_2_;

        for (int i = 0; i < p_i2884_3_.size(); ++i)
        {
            ListNBT listnbt = p_i2884_3_.getList(i);
