...
public class CheckerboardBiomeProvider extends BiomeProvider
{
    ...
    public CheckerboardBiomeProvider(CheckerboardBiomeProviderSettings p_i2891_1_)
    {
        super(ImmutableSet.copyOf(p_i2891_1_.getBiomes()));
        this.field_205320_b = p_i2891_1_.getBiomes();
        this.field_205321_c = p_i2891_1_.getSize() + 2;
    }
