...
public enum FuzzedBiomeMagnifier implements IBiomeMagnifier
{
    ...
    {
        long i = FastRandom.mix(p_226845_0_, (long)p_226845_2_);
        i = FastRandom.mix(i, (long)p_226845_3_);
        i = FastRandom.mix(i, (long)p_226845_4_);
        i = FastRandom.mix(i, (long)p_226845_2_);
        i = FastRandom.mix(i, (long)p_226845_3_);
        i = FastRandom.mix(i, (long)p_226845_4_);
        double d0 = func_226844_a_(i);
        i = FastRandom.mix(i, p_226845_0_);
        double d1 = func_226844_a_(i);
        i = FastRandom.mix(i, p_226845_0_);
        double d2 = func_226844_a_(i);
