...
public class OverworldBiomeProvider extends BiomeProvider
{
    ...
    public OverworldBiomeProvider(OverworldBiomeProviderSettings p_i466_1_)
    {
        super(field_226847_e_);
        this.genBiomes = LayerUtil.func_227474_a_(p_i466_1_.func_226850_a_(), p_i466_1_.func_226851_b_(), p_i466_1_.getGeneratorSettings());
    }
