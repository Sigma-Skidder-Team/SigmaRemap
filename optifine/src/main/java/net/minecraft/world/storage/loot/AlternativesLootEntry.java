...
{
    AlternativesLootEntry(LootEntry[] p_i2284_1_, ILootCondition[] p_i2284_2_)
    {
        super(p_i2284_1_, p_i2284_2_);
    }
    ...
    public static class Builder extends LootEntry.Builder<AlternativesLootEntry.Builder>
    {
        ...
        public Builder(LootEntry.Builder<?>... p_i3730_1_)
        {
            for (LootEntry.Builder<?> builder : p_i3730_1_)
            {
