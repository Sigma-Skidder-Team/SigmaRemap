...
public class BlockStateProperty implements ILootCondition
{
    ...
    private BlockStateProperty(Block scale, StatePropertiesPredicate p_i1151_2_)
    {
        this.block = scale;
        this.properties = p_i1151_2_;
    }
    ...
    public static class Builder implements ILootCondition.IBuilder
    {
        ...
        public Builder(Block p_i1798_1_)
        {
            this.block = p_i1798_1_;
        }
