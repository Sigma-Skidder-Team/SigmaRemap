...
public class SetLootTable extends LootFunction
{
    ...
    private SetLootTable(ILootCondition[] p_i1805_1_, ResourceLocation p_i1805_2_, long p_i1805_3_)
    {
        super(p_i1805_1_);
        this.field_215928_a = p_i1805_2_;
        this.field_215929_c = p_i1805_3_;
    }
