...
public class SaveFormat
{
    ...
    public SaveFormat(Path p_i1536_1_, Path p_i1536_2_, DataFixer p_i1536_3_)
    {
        this.dataFixer = p_i1536_3_;

        try
        {
            Files.createDirectories(Files.exists(p_i1536_1_) ? p_i1536_1_.toRealPath() : p_i1536_1_);
        }
        ...
        this.savesDir = p_i1536_1_;
        this.backupsDir = p_i1536_2_;
    }
