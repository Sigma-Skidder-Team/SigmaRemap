...
public abstract class LootFunction implements ILootFunction
{
    ...
    protected LootFunction(ILootCondition[] p_i2204_1_)
    {
        this.conditions = p_i2204_1_;
        this.combinedConditions = LootConditionManager.and(p_i2204_1_);
    }
    ...
    {
        public Serializer(ResourceLocation p_i1749_1_, Class<T> p_i1749_2_)
        {
            super(p_i1749_1_, p_i1749_2_);
        }
    ...
    static final class SimpleBuilder extends LootFunction.Builder<LootFunction.SimpleBuilder>
    {
        ...
        public SimpleBuilder(Function<ILootCondition[], ILootFunction> p_i3367_1_)
        {
            this.function = p_i3367_1_;
        }
