...
public class CopyNbt extends LootFunction
{
    ...
    private CopyNbt(ILootCondition[] creature, CopyNbt.Source speedIn, List<CopyNbt.Operation> p_i1636_3_)
    {
        super(creature);
        this.field_215887_a = speedIn;
        this.field_215888_c = ImmutableList.copyOf(p_i1636_3_);
    }
    ...
    public static enum Action
    {
        ...
        private Action(String p_i2365_3_)
        {
            this.op = p_i2365_3_;
        }
    ...
    public static class Builder extends LootFunction.Builder<CopyNbt.Builder>
    {
        ...
        private Builder(CopyNbt.Source p_i2996_1_)
        {
            this.source = p_i2996_1_;
        }
    ...
    static class Operation
    {
        ...
        private Operation(String p_i2911_1_, String p_i2911_2_, CopyNbt.Action p_i2911_3_)
        {
            this.source = p_i2911_1_;
            this.field_216218_b = CopyNbt.parsePath(p_i2911_1_);
            this.target = p_i2911_2_;
            this.field_216220_d = CopyNbt.parsePath(p_i2911_2_);
            this.action = p_i2911_3_;
        }
    ...
    public static enum Source
    {
        ...
        private <T> Source(String p_i3374_3_, LootParameter<T> p_i3374_4_, Function <? super T, INBT > p_i3374_5_)
        {
            this.field_216224_e = p_i3374_3_;
            this.field_216225_f = p_i3374_4_;
            this.field_216226_g = (p_216222_2_) ->
            {
                T t = p_216222_2_.get(p_i3374_4_);
                return t != null ? p_i3374_5_.apply(t) : null;
            };
        }
