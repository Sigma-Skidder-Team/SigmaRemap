...
public class SetAttributes extends LootFunction
{
    ...
    private SetAttributes(ILootCondition[] p_i1244_1_, List<SetAttributes.Modifier> p_i1244_2_)
    {
        super(p_i1244_1_);
        this.modifiers = ImmutableList.copyOf(p_i1244_2_);
    }
    ...
    static class Modifier
    {
        ...
        private Modifier(String p_i2356_1_, String p_i2356_2_, AttributeModifier.Operation p_i2356_3_, RandomValueRange p_i2356_4_, EquipmentSlotType[] p_i2356_5_, @Nullable UUID p_i2356_6_)
        {
            this.modifierName = p_i2356_1_;
            this.attributeName = p_i2356_2_;
            this.operation = p_i2356_3_;
            this.amount = p_i2356_4_;
            this.uuid = p_i2356_6_;
            this.slots = p_i2356_5_;
        }
