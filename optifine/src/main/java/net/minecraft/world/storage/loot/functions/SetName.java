...
public class SetName extends LootFunction
{
    ...
    private SetName(ILootCondition[] p_i1379_1_, @Nullable ITextComponent p_i1379_2_, @Nullable LootContext.EntityTarget p_i1379_3_)
    {
        super(p_i1379_1_);
        this.name = p_i1379_2_;
        this.field_215940_d = p_i1379_3_;
    }
