...
public class LootPool
{
    ...
    private LootPool(LootEntry[] p_i266_1_, ILootCondition[] p_i266_2_, ILootFunction[] p_i266_3_, IRandomRange p_i266_4_, RandomValueRange p_i266_5_)
    {
        this.lootEntries = p_i266_1_;
        this.conditions = p_i266_2_;
        this.combinedConditions = LootConditionManager.and(p_i266_2_);
        this.functions = p_i266_3_;
        this.combinedFunctions = LootFunctionManager.combine(p_i266_3_);
        this.rolls = p_i266_4_;
        this.bonusRolls = p_i266_5_;
    }
