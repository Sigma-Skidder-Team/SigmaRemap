...
public class CopyBlockState extends LootFunction
{
    ...
    private CopyBlockState(ILootCondition[] p_i2062_1_, Block p_i2062_2_, Set < IProperty<? >> p_i2062_3_)
    {
        super(p_i2062_1_);
        this.field_227543_a_ = p_i2062_2_;
        this.field_227544_c_ = p_i2062_3_;
    }
    ...
    public static class Builder extends LootFunction.Builder<CopyBlockState.Builder>
    {
        ...
        private Builder(Block p_i1026_1_)
        {
            this.field_227550_a_ = p_i1026_1_;
        }
