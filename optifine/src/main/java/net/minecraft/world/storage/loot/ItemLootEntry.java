...
public class ItemLootEntry extends StandaloneLootEntry
{
    ...
    private ItemLootEntry(Item p_i702_1_, int p_i702_2_, int p_i702_3_, ILootCondition[] p_i702_4_, ILootFunction[] p_i702_5_)
    {
        super(p_i702_2_, p_i702_3_, p_i702_4_, p_i702_5_);
        this.item = p_i702_1_;
    }
