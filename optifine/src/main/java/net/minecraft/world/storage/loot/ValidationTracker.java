...
public class ValidationTracker
{
    ...
    public ValidationTracker(LootParameterSet p_i797_1_, Function<ResourceLocation, ILootCondition> p_i797_2_, Function<ResourceLocation, LootTable> p_i797_3_)
    {
        this(HashMultimap.create(), () ->
        {
            return "";
        }, p_i797_1_, p_i797_2_, ImmutableSet.of(), p_i797_3_, ImmutableSet.of());
    }

    public ValidationTracker(Multimap<String, String> p_i798_1_, Supplier<String> p_i798_2_, LootParameterSet p_i798_3_, Function<ResourceLocation, ILootCondition> p_i798_4_, Set<ResourceLocation> p_i798_5_, Function<ResourceLocation, LootTable> p_i798_6_, Set<ResourceLocation> p_i798_7_)
    {
        this.field_227519_a_ = p_i798_1_;
        this.field_227520_b_ = p_i798_2_;
        this.field_227521_c_ = p_i798_3_;
        this.field_227522_d_ = p_i798_4_;
        this.field_227523_e_ = p_i798_5_;
        this.field_227524_f_ = p_i798_6_;
        this.field_227525_g_ = p_i798_7_;
    }
