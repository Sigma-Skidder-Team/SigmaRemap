...
{
    private EmptyLootEntry(int p_i3956_1_, int p_i3956_2_, ILootCondition[] p_i3956_3_, ILootFunction[] p_i3956_4_)
    {
        super(p_i3956_1_, p_i3956_2_, p_i3956_3_, p_i3956_4_);
    }
