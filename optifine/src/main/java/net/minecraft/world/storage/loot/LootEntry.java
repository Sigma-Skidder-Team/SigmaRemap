...
public abstract class LootEntry implements ILootEntry
{
    ...
    protected LootEntry(ILootCondition[] p_i1940_1_)
    {
        this.conditions = p_i1940_1_;
        this.field_216143_c = LootConditionManager.and(p_i1940_1_);
    }
    ...
    public abstract static class Serializer<T extends LootEntry>
    {
        ...
        protected Serializer(ResourceLocation p_i3178_1_, Class<T> p_i3178_2_)
        {
            this.field_216184_a = p_i3178_1_;
            this.field_216185_b = p_i3178_2_;
        }
