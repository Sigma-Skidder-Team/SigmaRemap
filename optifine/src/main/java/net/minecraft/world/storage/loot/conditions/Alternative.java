...
public class Alternative implements ILootCondition
{
    ...
    private Alternative(ILootCondition[] p_i3106_1_)
    {
        this.conditions = p_i3106_1_;
        this.field_215963_b = LootConditionManager.or(p_i3106_1_);
    }
    ...
    public static class Builder implements ILootCondition.IBuilder
    {
        ...
        public Builder(ILootCondition.IBuilder... p_i3752_1_)
        {
            for (ILootCondition.IBuilder ilootcondition$ibuilder : p_i3752_1_)
            {
