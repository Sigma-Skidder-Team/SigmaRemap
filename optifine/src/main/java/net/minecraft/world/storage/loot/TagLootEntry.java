...
public class TagLootEntry extends StandaloneLootEntry
{
    ...
    private TagLootEntry(Tag<Item> p_i452_1_, boolean p_i452_2_, int p_i452_3_, int p_i452_4_, ILootCondition[] p_i452_5_, ILootFunction[] p_i452_6_)
    {
        super(p_i452_3_, p_i452_4_, p_i452_5_, p_i452_6_);
        this.field_216180_c = p_i452_1_;
        this.field_216181_h = p_i452_2_;
    }
