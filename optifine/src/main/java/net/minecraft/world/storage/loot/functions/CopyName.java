...
public class CopyName extends LootFunction
{
    ...
    private CopyName(ILootCondition[] p_i2712_1_, CopyName.Source p_i2712_2_)
    {
        super(p_i2712_1_);
        this.source = p_i2712_2_;
    }
    ...
    public static enum Source
    {
        ...
        private Source(String p_i965_3_, LootParameter<?> p_i965_4_)
        {
            this.name = p_i965_3_;
            this.parameter = p_i965_4_;
        }
