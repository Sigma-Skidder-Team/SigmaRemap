...
public class LootingEnchantBonus extends LootFunction
{
    ...
    private LootingEnchantBonus(ILootCondition[] p_i2905_1_, RandomValueRange p_i2905_2_, int p_i2905_3_)
    {
        super(p_i2905_1_);
        this.count = p_i2905_2_;
        this.limit = p_i2905_3_;
    }
    ...
    public static class Builder extends LootFunction.Builder<LootingEnchantBonus.Builder>
    {
        ...
        public Builder(RandomValueRange p_i751_1_)
        {
            this.field_216073_a = p_i751_1_;
        }
