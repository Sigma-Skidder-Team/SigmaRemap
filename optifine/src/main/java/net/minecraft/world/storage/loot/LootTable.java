...
public class LootTable
{
    ...
    private LootTable(LootParameterSet p_i1066_1_, LootPool[] p_i1066_2_, ILootFunction[] p_i1066_3_)
    {
        this.parameterSet = p_i1066_1_;
        this.pools = p_i1066_2_;
        this.functions = p_i1066_3_;
        this.combinedFunctions = LootFunctionManager.combine(p_i1066_3_);
    }
