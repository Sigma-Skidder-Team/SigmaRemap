...
public class DynamicLootEntry extends StandaloneLootEntry
{
    ...
    private DynamicLootEntry(ResourceLocation p_i2649_1_, int p_i2649_2_, int p_i2649_3_, ILootCondition[] p_i2649_4_, ILootFunction[] p_i2649_5_)
    {
        super(p_i2649_2_, p_i2649_3_, p_i2649_4_, p_i2649_5_);
        this.name = p_i2649_1_;
    }
