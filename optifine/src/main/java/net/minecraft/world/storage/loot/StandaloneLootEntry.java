...
public abstract class StandaloneLootEntry extends LootEntry
{
    ...
    protected StandaloneLootEntry(int p_i2846_1_, int p_i2846_2_, ILootCondition[] p_i2846_3_, ILootFunction[] p_i2846_4_)
    {
        super(p_i2846_3_);
        this.weight = p_i2846_1_;
        this.quality = p_i2846_2_;
        this.functions = p_i2846_4_;
        this.field_216157_c = LootFunctionManager.combine(p_i2846_4_);
    }
    ...
    static class BuilderImpl extends StandaloneLootEntry.Builder<StandaloneLootEntry.BuilderImpl>
    {
        ...
        public BuilderImpl(StandaloneLootEntry.ILootEntryBuilder p_i3219_1_)
        {
            this.field_216090_c = p_i3219_1_;
        }
    ...
    {
        public Serializer(ResourceLocation p_i2326_1_, Class<T> p_i2326_2_)
        {
            super(p_i2326_1_, p_i2326_2_);
        }
