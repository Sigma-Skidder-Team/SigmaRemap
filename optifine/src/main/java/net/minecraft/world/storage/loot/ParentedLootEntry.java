...
public abstract class ParentedLootEntry extends LootEntry
{
    ...
    protected ParentedLootEntry(LootEntry[] p_i549_1_, ILootCondition[] p_i549_2_)
    {
        super(p_i549_2_);
        this.field_216147_c = p_i549_1_;
        this.field_216148_e = this.combineChildren(p_i549_1_);
    }
    ...
    {
        public AbstractSerializer(ResourceLocation p_i1687_1_, Class<T> p_i1687_2_)
        {
            super(p_i1687_1_, p_i1687_2_);
        }
