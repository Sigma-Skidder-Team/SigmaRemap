...
public class ApplyBonus extends LootFunction
{
    ...
    private ApplyBonus(ILootCondition[] p_i2383_1_, Enchantment p_i2383_2_, ApplyBonus.IFormula p_i2383_3_)
    {
        super(p_i2383_1_);
        this.enchantment = p_i2383_2_;
        this.field_215877_d = p_i2383_3_;
    }
    ...
    static final class BinomialWithBonusCountFormula implements ApplyBonus.IFormula
    {
        ...
        public BinomialWithBonusCountFormula(int p_i725_1_, float p_i725_2_)
        {
            this.extra = p_i725_1_;
            this.probability = p_i725_2_;
        }
    ...
    static final class UniformBonusCountFormula implements ApplyBonus.IFormula
    {
        ...
        public UniformBonusCountFormula(int p_i583_1_)
        {
            this.bonusMultiplier = p_i583_1_;
        }
