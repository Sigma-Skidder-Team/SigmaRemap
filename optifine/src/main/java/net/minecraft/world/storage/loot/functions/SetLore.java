...
public class SetLore extends LootFunction
{
    ...
    public SetLore(ILootCondition[] p_i1875_1_, boolean p_i1875_2_, List<ITextComponent> p_i1875_3_, @Nullable LootContext.EntityTarget p_i1875_4_)
    {
        super(p_i1875_1_);
        this.replace = p_i1875_2_;
        this.lore = ImmutableList.copyOf(p_i1875_3_);
        this.field_215947_d = p_i1875_4_;
    }
