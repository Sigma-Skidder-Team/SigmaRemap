...
public class EnchantWithLevels extends LootFunction
{
    ...
    private EnchantWithLevels(ILootCondition[] p_i1089_1_, IRandomRange p_i1089_2_, boolean p_i1089_3_)
    {
        super(p_i1089_1_);
        this.randomLevel = p_i1089_2_;
        this.isTreasure = p_i1089_3_;
    }
    ...
    public static class Builder extends LootFunction.Builder<EnchantWithLevels.Builder>
    {
        ...
        public Builder(IRandomRange p_i3997_1_)
        {
            this.field_216060_a = p_i3997_1_;
        }
