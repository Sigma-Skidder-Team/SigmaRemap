...
public class ExplorationMap extends LootFunction
{
    ...
    private ExplorationMap(ILootCondition[] p_i3660_1_, String p_i3660_2_, MapDecoration.Type p_i3660_3_, byte p_i3660_4_, int p_i3660_5_, boolean p_i3660_6_)
    {
        super(p_i3660_1_);
        this.destination = p_i3660_2_;
        this.decoration = p_i3660_3_;
        this.zoom = p_i3660_4_;
        this.searchRadius = p_i3660_5_;
        this.skipExistingChunks = p_i3660_6_;
    }
