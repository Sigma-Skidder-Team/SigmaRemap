...
public class EntityHasScore implements ILootCondition
{
    ...
    private EntityHasScore(Map<String, RandomValueRange> p_i3403_1_, LootContext.EntityTarget p_i3403_2_)
    {
        this.scores = ImmutableMap.copyOf(p_i3403_1_);
        this.target = p_i3403_2_;
    }
