...
public class TableLootEntry extends StandaloneLootEntry
{
    ...
    private TableLootEntry(ResourceLocation p_i3619_1_, int p_i3619_2_, int p_i3619_3_, ILootCondition[] p_i3619_4_, ILootFunction[] p_i3619_5_)
    {
        super(p_i3619_2_, p_i3619_3_, p_i3619_4_, p_i3619_5_);
        this.table = p_i3619_1_;
    }
