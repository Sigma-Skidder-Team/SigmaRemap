...
public class DragonFightManager
{
    ...
    public DragonFightManager(ServerWorld p_i3618_1_, CompoundNBT p_i3618_2_)
    {
        this.world = p_i3618_1_;

        if (p_i3618_2_.contains("DragonKilled", 99))
        {
            if (p_i3618_2_.hasUniqueId("DragonUUID"))
            {
                this.dragonUniqueId = p_i3618_2_.getUniqueId("DragonUUID");
            }

            this.dragonKilled = p_i3618_2_.getBoolean("DragonKilled");
            this.previouslyKilled = p_i3618_2_.getBoolean("PreviouslyKilled");

            if (p_i3618_2_.getBoolean("IsRespawning"))
            {
                this.respawnState = DragonSpawnState.START;
            }

            if (p_i3618_2_.contains("ExitPortalLocation", 10))
            {
                this.exitPortalLocation = NBTUtil.readBlockPos(p_i3618_2_.getCompound("ExitPortalLocation"));
            }
        }
        else
        {
        ...
        if (p_i3618_2_.contains("Gateways", 9))
        {
            ListNBT listnbt = p_i3618_2_.getList("Gateways", 3);
        ...
        else
        {
            ...
            Collections.shuffle(this.gateways, new Random(p_i3618_1_.getSeed()));
        }
