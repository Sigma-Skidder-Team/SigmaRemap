...
public class BitArray
{
    ...
    public BitArray(int p_i297_1_, int p_i297_2_)
    {
        this(p_i297_1_, p_i297_2_, new long[MathHelper.roundUp(p_i297_2_ * p_i297_1_, 64) / 64]);
    }

    public BitArray(int p_i298_1_, int p_i298_2_, long[] p_i298_3_)
    {
        Validate.inclusiveBetween(1L, 32L, (long)p_i298_1_);
        this.arraySize = p_i298_2_;
        this.bitsPerEntry = p_i298_1_;
        this.longArray = p_i298_3_;
        this.maxEntryValue = (1L << p_i298_1_) - 1L;
        int i = MathHelper.roundUp(p_i298_2_ * p_i298_1_, 64) / 64;

        if (p_i298_3_.length != i)
        {
            throw(RuntimeException)Util.pauseDevMode(new RuntimeException("Invalid length given for storage, got: " + p_i298_3_.length + " but expected: " + i));
        }
    }
