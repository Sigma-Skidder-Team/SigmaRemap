...
public class CSVWriter
{
    ...
    private CSVWriter(Writer p_i489_1_, List<String> p_i489_2_) throws IOException
    {
        this.field_225429_a = p_i489_1_;
        this.field_225430_b = p_i489_2_.size();
        this.func_225427_a(p_i489_2_.stream());
    }
