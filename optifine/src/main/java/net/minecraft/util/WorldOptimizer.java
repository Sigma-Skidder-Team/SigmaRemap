...
public class WorldOptimizer
{
    ...
    public WorldOptimizer(String p_i3571_1_, SaveFormat p_i3571_2_, WorldInfo p_i3571_3_, boolean p_i3571_4_)
    {
        this.worldName = p_i3571_3_.getWorldName();
        this.field_219957_d = p_i3571_4_;
        this.worldStorage = p_i3571_2_.getSaveLoader(p_i3571_1_, (MinecraftServer)null);
        this.worldStorage.saveWorldInfo(p_i3571_3_);
