...
public class RayTraceContext
{
    ...
    public RayTraceContext(Vec3d p_i1860_1_, Vec3d p_i1860_2_, RayTraceContext.BlockMode p_i1860_3_, RayTraceContext.FluidMode p_i1860_4_, Entity p_i1860_5_)
    {
        this.startVec = p_i1860_1_;
        this.endVec = p_i1860_2_;
        this.blockMode = p_i1860_3_;
        this.fluidMode = p_i1860_4_;
    ...
    public static enum BlockMode implements RayTraceContext.IVoxelProvider
    {
        ...
        private BlockMode(RayTraceContext.IVoxelProvider p_i1682_3_)
        {
            this.provider = p_i1682_3_;
        }
    ...
    public static enum FluidMode
    {
        ...
        private FluidMode(Predicate<IFluidState> p_i523_3_)
        {
            this.fluidTest = p_i523_3_;
        }
