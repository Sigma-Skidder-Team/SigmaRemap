...
public class Vec3i implements Comparable<Vec3i>
{
    ...
    public Vec3i(int p_i676_1_, int p_i676_2_, int p_i676_3_)
    {
        this.x = p_i676_1_;
        this.y = p_i676_2_;
        this.z = p_i676_3_;
    ...
    public Vec3i(double p_i677_1_, double p_i677_3_, double p_i677_5_)
    {
        this(MathHelper.floor(p_i677_1_), MathHelper.floor(p_i677_3_), MathHelper.floor(p_i677_5_));
    }
