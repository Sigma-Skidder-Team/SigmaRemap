...
public class NonOverlappingMerger extends AbstractDoubleList implements IDoubleListMerger
{
    ...
    public NonOverlappingMerger(DoubleList p_i1335_1_, DoubleList p_i1335_2_, boolean p_i1335_3_)
    {
        this.list1 = p_i1335_1_;
        this.list2 = p_i1335_2_;
        this.field_199640_c = p_i1335_3_;
    }
