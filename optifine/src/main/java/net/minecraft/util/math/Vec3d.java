...
public class Vec3d implements IPosition
{
    ...
    public Vec3d(double p_i2304_1_, double p_i2304_3_, double p_i2304_5_)
    {
        this.x = p_i2304_1_;
        this.y = p_i2304_3_;
        this.z = p_i2304_5_;
    ...
    public Vec3d(Vector3f p_i2305_1_)
    {
        this((double)p_i2305_1_.getX(), (double)p_i2305_1_.getY(), (double)p_i2305_1_.getZ());
    }

    public Vec3d(Vec3i p_i2306_1_)
    {
        this((double)p_i2306_1_.getX(), (double)p_i2306_1_.getY(), (double)p_i2306_1_.getZ());
    }
