...
public class BlockPosWrapper implements IPosWrapper
{
    ...
    public BlockPosWrapper(BlockPos p_i3261_1_)
    {
        this.field_220612_a = p_i3261_1_;
        this.field_220613_b = new Vec3d((double)p_i3261_1_.getX() + 0.5D, (double)p_i3261_1_.getY() + 0.5D, (double)p_i3261_1_.getZ() + 0.5D);
    }
