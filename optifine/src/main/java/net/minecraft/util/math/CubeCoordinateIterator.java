...
public class CubeCoordinateIterator
{
    ...
    public CubeCoordinateIterator(int p_i1491_1_, int p_i1491_2_, int p_i1491_3_, int p_i1491_4_, int p_i1491_5_, int p_i1491_6_)
    {
        this.startX = p_i1491_1_;
        this.startY = p_i1491_2_;
        this.startZ = p_i1491_3_;
        this.endX = p_i1491_4_;
        this.endY = p_i1491_5_;
        this.endZ = p_i1491_6_;
    }
