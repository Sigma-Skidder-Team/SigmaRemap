...
public class WeightedList<U>
{
    ...
    public WeightedList(Random p_i2983_1_)
    {
        this.random = p_i2983_1_;
    }
    ...
    public <T> WeightedList(Dynamic<T> p_i2984_1_, Function<Dynamic<T>, U> p_i2984_2_)
    {
        this();
        p_i2984_1_.asStream().forEach((p_226316_2_) ->
        {
            p_226316_2_.get("data").map((p_226317_3_) -> {
                U u = p_i2984_2_.apply(p_226317_3_);
    ...
    public class Entry<T>
    {
        ...
        private Entry(T p_i1191_2_, int p_i1191_3_)
        {
            this.field_220652_c = p_i1191_3_;
            this.field_220651_b = p_i1191_2_;
        }
