...
public class ClickEvent
{
    ...
    public ClickEvent(ClickEvent.Action p_i2915_1_, String p_i2915_2_)
    {
        this.action = p_i2915_1_;
        this.value = p_i2915_2_;
    }
    ...
    public static enum Action
    {
        ...
        private Action(String p_i2552_3_, boolean p_i2552_4_)
        {
            this.canonicalName = p_i2552_3_;
            this.allowedInChat = p_i2552_4_;
        }
