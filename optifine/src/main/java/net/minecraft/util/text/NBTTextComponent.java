...
public abstract class NBTTextComponent extends TextComponent implements ITargetedTextComponent
{
    ...
    public NBTTextComponent(String p_i755_1_, boolean p_i755_2_)
    {
        this(p_i755_1_, func_218672_b(p_i755_1_), p_i755_2_);
    }

    protected NBTTextComponent(String p_i756_1_, @Nullable NBTPathArgument.NBTPath p_i756_2_, boolean p_i756_3_)
    {
        this.field_218679_c = p_i756_1_;
        this.field_218680_d = p_i756_2_;
        this.field_218678_b = p_i756_3_;
    }
    ...
    public static class Block extends NBTTextComponent
    {
        ...
        public Block(String p_i2192_1_, boolean p_i2192_2_, String p_i2192_3_)
        {
            super(p_i2192_1_, p_i2192_2_);
            this.field_218684_e = p_i2192_3_;
        ...
        private Block(String p_i2193_1_, @Nullable NBTPathArgument.NBTPath p_i2193_2_, boolean p_i2193_3_, String p_i2193_4_, @Nullable ILocationArgument p_i2193_5_)
        {
            super(p_i2193_1_, p_i2193_2_, p_i2193_3_);
            this.field_218684_e = p_i2193_4_;
            this.field_218685_f = p_i2193_5_;
        }
    ...
    public static class Entity extends NBTTextComponent
    {
        ...
        public Entity(String p_i1537_1_, boolean p_i1537_2_, String p_i1537_3_)
        {
            super(p_i1537_1_, p_i1537_2_);
            this.field_218688_e = p_i1537_3_;
            this.field_218689_f = func_218686_b(p_i1537_3_);
        }
        ...
        private Entity(String p_i1538_1_, @Nullable NBTPathArgument.NBTPath p_i1538_2_, boolean p_i1538_3_, String p_i1538_4_, @Nullable EntitySelector p_i1538_5_)
        {
            super(p_i1538_1_, p_i1538_2_, p_i1538_3_);
            this.field_218688_e = p_i1538_4_;
            this.field_218689_f = p_i1538_5_;
        }
    ...
    public static class Storage extends NBTTextComponent
    {
        ...
        public Storage(String p_i3592_1_, boolean p_i3592_2_, ResourceLocation p_i3592_3_)
        {
            super(p_i3592_1_, p_i3592_2_);
            this.field_229725_e_ = p_i3592_3_;
        }

        public Storage(String p_i3593_1_, @Nullable NBTPathArgument.NBTPath p_i3593_2_, boolean p_i3593_3_, ResourceLocation p_i3593_4_)
        {
            super(p_i3593_1_, p_i3593_2_, p_i3593_3_);
            this.field_229725_e_ = p_i3593_4_;
        }
