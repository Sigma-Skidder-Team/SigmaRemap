...
public class ResourceLocation implements Comparable<ResourceLocation>
{
    ...
    protected ResourceLocation(String[] p_i67_1_)
    {
        this.namespace = org.apache.commons.lang3.StringUtils.isEmpty(p_i67_1_[0]) ? "minecraft" : p_i67_1_[0];
        this.path = p_i67_1_[1];
    ...
    public ResourceLocation(String p_i68_1_)
    {
        this(decompose(p_i68_1_, ':'));
    }

    public ResourceLocation(String p_i69_1_, String p_i69_2_)
    {
        this(new String[] {p_i69_1_, p_i69_2_});
    }
    ...
    {
        return pathIn.chars().allMatch((p_lambda$isPathValid$0_0_) ->
        {
            return p_lambda$isPathValid$0_0_ == 95 || p_lambda$isPathValid$0_0_ == 45 || p_lambda$isPathValid$0_0_ >= 97 && p_lambda$isPathValid$0_0_ <= 122 || p_lambda$isPathValid$0_0_ >= 48 && p_lambda$isPathValid$0_0_ <= 57 || p_lambda$isPathValid$0_0_ == 47 || p_lambda$isPathValid$0_0_ == 46;
        });
    }

    private static boolean isValidNamespace(String namespaceIn)
    {
        return namespaceIn.chars().allMatch((p_lambda$isValidNamespace$1_0_) ->
        {
            return p_lambda$isValidNamespace$1_0_ == 95 || p_lambda$isValidNamespace$1_0_ == 45 || p_lambda$isValidNamespace$1_0_ >= 97 && p_lambda$isValidNamespace$1_0_ <= 122 || p_lambda$isValidNamespace$1_0_ >= 48 && p_lambda$isValidNamespace$1_0_ <= 57 || p_lambda$isValidNamespace$1_0_ == 46;
        });
    }
