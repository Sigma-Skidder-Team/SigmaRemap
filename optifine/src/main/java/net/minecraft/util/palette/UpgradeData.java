...
public class UpgradeData
{
    ...
    public UpgradeData(CompoundNBT p_i1015_1_)
    {
        this();

        if (p_i1015_1_.contains("Indices", 10))
        {
            CompoundNBT compoundnbt = p_i1015_1_.getCompound("Indices");
    ...
    static enum BlockFixers implements UpgradeData.IBlockFixer
    {
        ...
        private BlockFixers(Block... p_i2595_3_)
        {
            this(false, p_i2595_3_);
        }

        private BlockFixers(boolean p_i2596_3_, Block... p_i2596_4_)
        {
            for (Block block : p_i2596_4_)
            {
