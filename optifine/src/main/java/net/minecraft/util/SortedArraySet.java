...
public class SortedArraySet<T> extends AbstractSet<T>
{
    ...
    private SortedArraySet(int p_i4040_1_, Comparator<T> p_i4040_2_)
    {
        this.comparator = p_i4040_2_;

        if (p_i4040_1_ < 0)
        {
            throw new IllegalArgumentException("Initial capacity (" + p_i4040_1_ + ") is negative");
        }
        else
        {
            this.storage = (T[])cast(new Object[p_i4040_1_]);
        }
    }
