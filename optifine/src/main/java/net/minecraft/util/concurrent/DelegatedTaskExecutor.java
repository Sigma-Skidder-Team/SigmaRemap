...
public class DelegatedTaskExecutor<T> implements ITaskExecutor<T>, AutoCloseable, Runnable
{
    ...
    public DelegatedTaskExecutor(ITaskQueue <? super T, ? extends Runnable > p_i3741_1_, Executor p_i3741_2_, String p_i3741_3_)
    {
        this.delegate = p_i3741_2_;
        this.queue = p_i3741_1_;
        this.name = p_i3741_3_;
    }
