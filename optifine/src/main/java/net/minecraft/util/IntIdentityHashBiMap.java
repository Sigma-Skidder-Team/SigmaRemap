...
public class IntIdentityHashBiMap<K> implements IObjectIntIterable<K>
{
    ...
    public IntIdentityHashBiMap(int p_i3978_1_)
    {
        p_i3978_1_ = (int)((float)p_i3978_1_ / 0.8F);
        this.values = (K[])(new Object[p_i3978_1_]);
        this.intKeys = new int[p_i3978_1_];
        this.byId = (K[])(new Object[p_i3978_1_]);
    }
