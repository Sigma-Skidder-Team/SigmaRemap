...
public class TrappedChestTileEntitySplit extends DataFix
{
    ...
    public TrappedChestTileEntitySplit(Schema p_i1818_1_, boolean p_i1818_2_)
    {
        super(p_i1818_1_, p_i1818_2_);
    }
    ...
    public static final class Section extends LeavesFix.Section
    {
        ...
        public Section(Typed<?> p_i966_1_, Schema p_i966_2_)
        {
            super(p_i966_1_, p_i966_2_);
        }
