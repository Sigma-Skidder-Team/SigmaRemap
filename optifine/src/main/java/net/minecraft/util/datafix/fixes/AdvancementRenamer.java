...
public class AdvancementRenamer extends DataFix
{
    ...
    public AdvancementRenamer(Schema p_i861_1_, boolean p_i861_2_, String p_i861_3_, Function<String, String> p_i861_4_)
    {
        super(p_i861_1_, p_i861_2_);
        this.field_230066_a_ = p_i861_3_;
        this.field_230067_b_ = p_i861_4_;
    }
