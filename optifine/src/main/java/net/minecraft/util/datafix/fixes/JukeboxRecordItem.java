...
{
    public JukeboxRecordItem(Schema p_i3851_1_, boolean p_i3851_2_)
    {
        super(p_i3851_1_, p_i3851_2_, "BlockEntityJukeboxFix", TypeReferences.BLOCK_ENTITY, "minecraft:jukebox");
    }
