...
{
    public ArmorStandSilent(Schema descriptionIn, boolean causeThrowable)
    {
        super(descriptionIn, causeThrowable, "EntityArmorStandSilentFix", TypeReferences.ENTITY, "ArmorStand");
    }
