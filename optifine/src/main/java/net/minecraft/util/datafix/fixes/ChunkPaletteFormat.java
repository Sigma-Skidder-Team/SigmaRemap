...
public class ChunkPaletteFormat extends DataFix
{
    ...
    public ChunkPaletteFormat(Schema p_i4174_1_, boolean p_i4174_2_)
    {
        super(p_i4174_1_, p_i4174_2_);
    }
    ...
    public static enum Direction
    {
        ...
        private Direction(ChunkPaletteFormat.Direction.Offset p_i1455_3_, ChunkPaletteFormat.Direction.Axis p_i1455_4_)
        {
            this.axis = p_i1455_4_;
            this.axisDirection = p_i1455_3_;
        }
        ...
        public static enum Offset {
            ...
            private Offset(int p_i2159_3_)
            {
                this.step = p_i2159_3_;
            }
    ...
    static class NibbleArray
    {
        ...
        public NibbleArray(byte[] p_i1246_1_)
        {
            this.data = p_i1246_1_;

            if (p_i1246_1_.length != 2048)
            {
                throw new IllegalArgumentException("ChunkNibbleArrays should be 2048 bytes not: " + p_i1246_1_.length);
            }
        }
    ...
    static class Section
    {
        ...
        public Section(Dynamic<?> p_i4218_1_)
        {
            this.listTag = p_i4218_1_.emptyList();
            this.section = p_i4218_1_;
            this.y = p_i4218_1_.get("Y").asInt(0);
            this.hasData = p_i4218_1_.get("Blocks").get().isPresent();
        }
    ...
    static final class UpgradeChunk
    {
        ...
        public UpgradeChunk(Dynamic<?> p_i3480_1_)
        {
            this.level = p_i3480_1_;
            this.x = p_i3480_1_.get("xPos").asInt(0) << 4;
            this.z = p_i3480_1_.get("zPos").asInt(0) << 4;
            p_i3480_1_.get("TileEntities").asStreamOpt().ifPresent((p_210061_1_) ->
            {
            ...
            boolean flag = p_i3480_1_.get("convertedFromAlphaFormat").asBoolean(false);
            p_i3480_1_.get("Sections").asStreamOpt().ifPresent((p_210062_1_) ->
            {
