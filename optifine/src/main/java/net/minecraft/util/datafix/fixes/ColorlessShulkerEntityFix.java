...
{
    public ColorlessShulkerEntityFix(Schema p_i1560_1_, boolean p_i1560_2_)
    {
        super(p_i1560_1_, p_i1560_2_, "Colorless shulker entity fix", TypeReferences.ENTITY, "minecraft:shulker");
    }
