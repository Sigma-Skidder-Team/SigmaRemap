...
{
    public PistonPushedBlock(Schema p_i3786_1_, boolean p_i3786_2_)
    {
        super(p_i3786_1_, p_i3786_2_, "BlockEntityBlockStateFix", TypeReferences.BLOCK_ENTITY, "minecraft:piston");
    }
