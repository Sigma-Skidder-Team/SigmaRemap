...
public class RecipeRenamer extends DataFix
{
    ...
    public RecipeRenamer(Schema p_i2561_1_, boolean p_i2561_2_, String p_i2561_3_, Function<String, String> p_i2561_4_)
    {
        super(p_i2561_1_, p_i2561_2_);
        this.field_230073_a_ = p_i2561_3_;
        this.field_230074_b_ = p_i2561_4_;
    }
