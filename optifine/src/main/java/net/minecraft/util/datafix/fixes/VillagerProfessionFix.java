...
{
    public VillagerProfessionFix(Schema p_i572_1_, String p_i572_2_)
    {
        super(p_i572_1_, false, "Villager profession data fix (" + p_i572_2_ + ")", TypeReferences.ENTITY, p_i572_2_);
    }
