...
public enum Direction implements IStringSerializable
{
    ...
    private Direction(int p_i235_3_, int p_i235_4_, int p_i235_5_, String p_i235_6_, Direction.AxisDirection p_i235_7_, Direction.Axis p_i235_8_, Vec3i p_i235_9_)
    {
        this.index = p_i235_3_;
        this.horizontalIndex = p_i235_5_;
        this.opposite = p_i235_4_;
        this.name = p_i235_6_;
        this.axis = p_i235_8_;
        this.axisDirection = p_i235_7_;
        this.directionVec = p_i235_9_;
    }
    ...
    public static enum AxisDirection {
        ...
        private AxisDirection(int p_i104_3_, String p_i104_4_)
        {
            this.offset = p_i104_3_;
            this.description = p_i104_4_;
        }
    ...
    public static enum Plane implements Iterable<Direction>, Predicate<Direction> {
        ...
        private Plane(Direction[] p_i209_3_, Direction.Axis[] p_i209_4_)
        {
            this.facingValues = p_i209_3_;
            this.axisValues = p_i209_4_;
        }
