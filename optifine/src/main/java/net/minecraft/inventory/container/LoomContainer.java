...
public class LoomContainer extends Container
{
    ...
    public LoomContainer(int p_i374_1_, PlayerInventory p_i374_2_)
    {
        this(p_i374_1_, p_i374_2_, IWorldPosCallable.DUMMY);
    }

    public LoomContainer(int p_i375_1_, PlayerInventory p_i375_2_, final IWorldPosCallable p_i375_3_)
    {
        super(ContainerType.LOOM, p_i375_1_);
        this.worldPos = p_i375_3_;
        ...
        this.output = this.addSlot(new Slot(this.field_217041_k, 0, 143, 58)
        {
            ...
            public ItemStack onTake(PlayerEntity thePlayer, ItemStack stack)
            {
                ...
                p_i375_3_.consume((p_216951_1_, p_216951_2_) ->
                {
        ...
        for (int i = 0; i < 3; ++i)
        {
            for (int j = 0; j < 9; ++j)
            {
                this.addSlot(new Slot(p_i375_2_, j + i * 9 + 9, 8 + j * 18, 84 + i * 18));
            }
        }

        for (int k = 0; k < 9; ++k)
        {
            this.addSlot(new Slot(p_i375_2_, k, 8 + k * 18, 142));
        }
