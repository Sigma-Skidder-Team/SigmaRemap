...
public class WorkbenchContainer extends RecipeBookContainer<CraftingInventory>
{
    ...
    public WorkbenchContainer(int p_i1888_1_, PlayerInventory p_i1888_2_)
    {
        this(p_i1888_1_, p_i1888_2_, IWorldPosCallable.DUMMY);
    }

    public WorkbenchContainer(int p_i1889_1_, PlayerInventory p_i1889_2_, IWorldPosCallable p_i1889_3_)
    {
        super(ContainerType.CRAFTING, p_i1889_1_);
        this.field_217070_e = p_i1889_3_;
        this.player = p_i1889_2_.player;
        this.addSlot(new CraftingResultSlot(p_i1889_2_.player, this.craftMatrix, this.craftResult, 0, 124, 35));
        ...
        for (int k = 0; k < 3; ++k)
        {
            ...
            {
                this.addSlot(new Slot(p_i1889_2_, i1 + k * 9 + 9, 8 + i1 * 18, 84 + k * 18));
            }
        }

        for (int l = 0; l < 9; ++l)
        {
            this.addSlot(new Slot(p_i1889_2_, l, 8 + l * 18, 142));
        }
    }
