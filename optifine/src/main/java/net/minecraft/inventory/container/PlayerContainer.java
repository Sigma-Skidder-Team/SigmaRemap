...
public class PlayerContainer extends RecipeBookContainer<CraftingInventory>
{
    ...
    public PlayerContainer(PlayerInventory p_i4038_1_, boolean p_i4038_2_, PlayerEntity p_i4038_3_)
    {
        super((ContainerType<?>)null, 0);
        this.isLocalWorld = p_i4038_2_;
        this.player = p_i4038_3_;
        this.addSlot(new CraftingResultSlot(p_i4038_1_.player, this.craftMatrix, this.craftResult, 0, 154, 28));
        ...
        for (int k = 0; k < 4; ++k)
        {
            ...
            this.addSlot(new Slot(p_i4038_1_, 39 - k, 8, 8 + k * 18)
            {
        ...
        for (int l = 0; l < 3; ++l)
        {
            ...
            {
                this.addSlot(new Slot(p_i4038_1_, j1 + (l + 1) * 9, 8 + j1 * 18, 84 + l * 18));
            }
        }

        for (int i1 = 0; i1 < 9; ++i1)
        {
            this.addSlot(new Slot(p_i4038_1_, i1, 8 + i1 * 18, 142));
        }

        this.addSlot(new Slot(p_i4038_1_, 40, 77, 62)
        {
            public Pair<ResourceLocation, ResourceLocation> func_225517_c_()
            {
