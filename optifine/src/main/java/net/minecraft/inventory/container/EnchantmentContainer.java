...
public class EnchantmentContainer extends Container
{
    ...
    public EnchantmentContainer(int p_i2389_1_, PlayerInventory p_i2389_2_)
    {
        this(p_i2389_1_, p_i2389_2_, IWorldPosCallable.DUMMY);
    }

    public EnchantmentContainer(int p_i2390_1_, PlayerInventory p_i2390_2_, IWorldPosCallable p_i2390_3_)
    {
        super(ContainerType.ENCHANTMENT, p_i2390_1_);
        this.field_217006_g = p_i2390_3_;
        ...
        for (int i = 0; i < 3; ++i)
        {
            for (int j = 0; j < 9; ++j)
            {
                this.addSlot(new Slot(p_i2390_2_, j + i * 9 + 9, 8 + j * 18, 84 + i * 18));
            }
        }

        for (int k = 0; k < 9; ++k)
        {
            this.addSlot(new Slot(p_i2390_2_, k, 8 + k * 18, 142));
        }
        ...
        this.trackInt(this.xpSeed).set(p_i2390_2_.player.getXPSeed());
