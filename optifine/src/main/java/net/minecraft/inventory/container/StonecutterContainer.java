...
public class StonecutterContainer extends Container
{
    ...
    public StonecutterContainer(int p_i1115_1_, PlayerInventory p_i1115_2_)
    {
        this(p_i1115_1_, p_i1115_2_, IWorldPosCallable.DUMMY);
    }

    public StonecutterContainer(int p_i1116_1_, PlayerInventory p_i1116_2_, final IWorldPosCallable p_i1116_3_)
    {
        super(ContainerType.STONECUTTER, p_i1116_1_);
        this.worldPosCallable = p_i1116_3_;
        this.world = p_i1116_2_.player.world;
        ...
        this.outputInventorySlot = this.addSlot(new Slot(this.inventory, 1, 143, 33)
        {
            ...
            public ItemStack onTake(PlayerEntity thePlayer, ItemStack stack)
            {
                ...
                p_i1116_3_.consume((p_216954_1_, p_216954_2_) ->
                {
        ...
        for (int i = 0; i < 3; ++i)
        {
            for (int j = 0; j < 9; ++j)
            {
                this.addSlot(new Slot(p_i1116_2_, j + i * 9 + 9, 8 + j * 18, 84 + i * 18));
            }
        }

        for (int k = 0; k < 9; ++k)
        {
            this.addSlot(new Slot(p_i1116_2_, k, 8 + k * 18, 142));
        }
