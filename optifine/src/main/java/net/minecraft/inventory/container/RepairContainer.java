...
public class RepairContainer extends Container
{
    ...
    public RepairContainer(int p_i1295_1_, PlayerInventory p_i1295_2_)
    {
        this(p_i1295_1_, p_i1295_2_, IWorldPosCallable.DUMMY);
    }

    public RepairContainer(int p_i1296_1_, PlayerInventory p_i1296_2_, final IWorldPosCallable p_i1296_3_)
    {
        super(ContainerType.ANVIL, p_i1296_1_);
        this.field_216980_g = p_i1296_3_;
        this.player = p_i1296_2_.player;
        ...
        this.addSlot(new Slot(this.outputSlot, 2, 134, 47)
        {
            ...
            public ItemStack onTake(PlayerEntity thePlayer, ItemStack stack)
            {
                ...
                p_i1296_3_.consume((p_216931_1_, p_216931_2_) ->
                {
        ...
        for (int i = 0; i < 3; ++i)
        {
            for (int j = 0; j < 9; ++j)
            {
                this.addSlot(new Slot(p_i1296_2_, j + i * 9 + 9, 8 + j * 18, 84 + i * 18));
            }
        }

        for (int k = 0; k < 9; ++k)
        {
            this.addSlot(new Slot(p_i1296_2_, k, 8 + k * 18, 142));
        }
    }
