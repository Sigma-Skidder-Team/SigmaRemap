...
public abstract class PathNavigator
{
    ...
    public PathNavigator(MobEntity p_i835_1_, World p_i835_2_)
    {
        this.entity = p_i835_1_;
        this.world = p_i835_2_;
        this.field_226333_p_ = p_i835_1_.getAttribute(SharedMonsterAttributes.FOLLOW_RANGE);
