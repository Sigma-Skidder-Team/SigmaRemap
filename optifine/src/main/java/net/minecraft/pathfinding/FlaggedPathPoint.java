...
public class FlaggedPathPoint extends PathPoint
{
    ...
    public FlaggedPathPoint(PathPoint p_i3047_1_)
    {
        super(p_i3047_1_.x, p_i3047_1_.y, p_i3047_1_.z);
    }

    public FlaggedPathPoint(int p_i3048_1_, int p_i3048_2_, int p_i3048_3_)
    {
        super(p_i3048_1_, p_i3048_2_, p_i3048_3_);
    }
