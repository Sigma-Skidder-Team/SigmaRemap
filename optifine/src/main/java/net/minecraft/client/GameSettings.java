...
public class GameSettings
{
    ...
    public GameSettings(Minecraft p_i230_1_, File p_i230_2_)
    {
        this.setForgeKeybindProperties();
        this.mc = p_i230_1_;
        this.optionsFile = new File(p_i230_2_, "options.txt");

        if (p_i230_1_.isJava64bit() && Runtime.getRuntime().maxMemory() >= 1000000000L)
        {
        ...
        this.renderDistanceChunks = p_i230_1_.isJava64bit() ? 12 : 8;
        this.optionsFileOF = new File(p_i230_2_, "optionsof.txt");
    ...
    public void setOptionValueOF(AbstractOption p_setOptionValueOF_1_, int p_setOptionValueOF_2_)
    {
        ...
        if (p_setOptionValueOF_1_ == AbstractOption.USE_VBO)
        {
    ...
    public String getKeyBindingOF(AbstractOption p_getKeyBindingOF_1_)
    {
        ...
        else if (p_getKeyBindingOF_1_ == AbstractOption.USE_VBO)
        {
            return this.ofUseVbo ? s + Lang.getOn() : s + Lang.getOff();
        }
        ...
        try
        {
            ...
            while ((s = bufferedreader.readLine()) != null)
            {
                try
                {
                    ...
                    {
                        this.ofAoLevel = (double)Float.valueOf(astring[1]);
                    ...
                    {
                        this.ofCloudsHeight = (double)Float.valueOf(astring[1]);
                    ...
                    if (astring[0].equals("ofUseVbo") && astring.length >= 2)
                    {
                        this.ofUseVbo = Boolean.valueOf(astring[1]);
                    }
