...
public class SearchTreeReloadable<T> implements IMutableSearchTree<T>
{
    ...
    public SearchTreeReloadable(Function<T, Stream<ResourceLocation>> p_i3174_1_)
    {
        this.field_217877_c = p_i3174_1_;
    }
    ...
    public static class JoinedIterator<T> extends AbstractIterator<T>
    {
        ...
        public JoinedIterator(Iterator<T> p_i4186_1_, Iterator<T> p_i4186_2_, Comparator<T> p_i4186_3_)
        {
            this.field_217881_a = Iterators.peekingIterator(p_i4186_1_);
            this.field_217882_b = Iterators.peekingIterator(p_i4186_2_);
            this.field_217883_c = p_i4186_3_;
        }
