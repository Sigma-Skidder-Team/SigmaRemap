...
public class InputMappings
{
    ...
    public static final class Input
    {
        ...
        private Input(String p_i3290_1_, InputMappings.Type p_i3290_2_, int p_i3290_3_)
        {
            this.name = p_i3290_1_;
            this.type = p_i3290_2_;
            this.keyCode = p_i3290_3_;
            REGISTRY.put(p_i3290_1_, this);
        }
    ...
    public static enum Type
    {
        ...
        private Type(String p_i2470_3_)
        {
            this.name = p_i2470_3_;
        }
