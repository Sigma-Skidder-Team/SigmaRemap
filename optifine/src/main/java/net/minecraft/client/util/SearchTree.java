...
public class SearchTree<T> extends SearchTreeReloadable<T>
{
    ...
    public SearchTree(Function<T, Stream<String>> p_i4242_1_, Function<T, Stream<ResourceLocation>> p_i4242_2_)
    {
        super(p_i4242_2_);
        this.nameFunc = p_i4242_1_;
    }
    ...
    static class MergingIterator<T> extends AbstractIterator<T>
    {
        ...
        public MergingIterator(Iterator<T> p_i2662_1_, Iterator<T> p_i2662_2_, Comparator<T> p_i2662_3_)
        {
            this.leftItr = Iterators.peekingIterator(p_i2662_1_);
            this.rightItr = Iterators.peekingIterator(p_i2662_2_);
            this.numbers = p_i2662_3_;
        }
