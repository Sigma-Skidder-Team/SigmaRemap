...
public abstract class LocatableSound implements ISound
{
    ...
    protected LocatableSound(SoundEvent p_i1932_1_, SoundCategory p_i1932_2_)
    {
        this(p_i1932_1_.getName(), p_i1932_2_);
    }

    protected LocatableSound(ResourceLocation p_i1933_1_, SoundCategory p_i1933_2_)
    {
        this.positionedSoundLocation = p_i1933_1_;
        this.category = p_i1933_2_;
    }
