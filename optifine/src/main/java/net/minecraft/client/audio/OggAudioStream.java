...
public class OggAudioStream implements IAudioStream
{
    ...
    public OggAudioStream(InputStream p_i313_1_) throws IOException
    {
        this.field_216463_c = p_i313_1_;
    ...
    static class Buffer
    {
        ...
        public Buffer(int p_i1020_1_)
        {
            this.field_216450_b = p_i1020_1_ + 1 & -2;
            this.func_216447_b();
        }
