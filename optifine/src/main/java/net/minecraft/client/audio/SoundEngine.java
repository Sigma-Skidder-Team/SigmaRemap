...
public class SoundEngine
{
    ...
    public SoundEngine(SoundHandler p_i1901_1_, GameSettings p_i1901_2_, IResourceManager p_i1901_3_)
    {
        this.sndHandler = p_i1901_1_;
        this.options = p_i1901_2_;
        this.audioStreamManager = new AudioStreamManager(p_i1901_3_);
    }
