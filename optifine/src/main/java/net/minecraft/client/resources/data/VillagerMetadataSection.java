...
public class VillagerMetadataSection
{
    ...
    public VillagerMetadataSection(VillagerMetadataSection.HatType p_i1407_1_)
    {
        this.field_217828_b = p_i1407_1_;
    }
    ...
    public static enum HatType
    {
        ...
        private HatType(String p_i723_3_)
        {
            this.field_217825_e = p_i723_3_;
        }
