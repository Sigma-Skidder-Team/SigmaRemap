...
public class AnimationMetadataSection
{
    ...
    public AnimationMetadataSection(List<AnimationFrame> p_i1713_1_, int p_i1713_2_, int p_i1713_3_, int p_i1713_4_, boolean p_i1713_5_)
    {
        this.animationFrames = p_i1713_1_;
        this.frameWidth = p_i1713_2_;
        this.frameHeight = p_i1713_3_;
        this.frameTime = p_i1713_4_;
        this.interpolate = p_i1713_5_;
    }
