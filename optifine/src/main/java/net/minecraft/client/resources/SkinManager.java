...
public class SkinManager
{
    ...
    public SkinManager(TextureManager entityIn, File p_i1654_2_, MinecraftSessionService p_i1654_3_)
    {
        this.textureManager = entityIn;
        this.skinCacheDir = p_i1654_2_;
        this.sessionService = p_i1654_3_;
