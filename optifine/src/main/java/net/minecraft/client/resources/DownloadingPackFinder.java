...
public class DownloadingPackFinder implements IPackFinder
{
    ...
    public DownloadingPackFinder(File p_i851_1_, ResourceIndex p_i851_2_)
    {
        this.serverPackDir = p_i851_1_;
        this.resourceIndex = p_i851_2_;
        this.vanillaPack = new VirtualAssetsPack(p_i851_2_);
    }
