...
public class ShaderGroup implements AutoCloseable
{
    ...
    public ShaderGroup(TextureManager p_i499_1_, IResourceManager p_i499_2_, Framebuffer p_i499_3_, ResourceLocation p_i499_4_) throws IOException, JsonSyntaxException
    {
        this.resourceManager = p_i499_2_;
        this.mainFramebuffer = p_i499_3_;
        this.time = 0.0F;
        this.lastStamp = 0.0F;
        this.mainFramebufferWidth = p_i499_3_.framebufferWidth;
        this.mainFramebufferHeight = p_i499_3_.framebufferHeight;
        this.shaderGroupName = p_i499_4_.toString();
        this.resetProjectionMatrix();
        this.parseGroup(p_i499_1_, p_i499_4_);
    }
