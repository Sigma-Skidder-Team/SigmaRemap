...
public class Shader implements AutoCloseable
{
    ...
    public Shader(IResourceManager p_i868_1_, String p_i868_2_, Framebuffer p_i868_3_, Framebuffer p_i868_4_) throws IOException
    {
        this.manager = new ShaderInstance(p_i868_1_, p_i868_2_);
        this.framebufferIn = p_i868_3_;
        this.framebufferOut = p_i868_4_;
    }
