...
public class ShaderInstance implements IShaderManager, AutoCloseable
{
    ...
    public ShaderInstance(IResourceManager p_i2574_1_, String p_i2574_2_) throws IOException
    {
        ResourceLocation resourcelocation = new ResourceLocation("shaders/program/" + p_i2574_2_ + ".json");
        this.field_216556_l = p_i2574_2_;
        IResource iresource = null;

        try
        {
            iresource = p_i2574_1_.getResource(resourcelocation);
            ...
            this.field_216562_r = func_216542_a(p_i2574_1_, ShaderLoader.ShaderType.VERTEX, s);
            this.field_216563_s = func_216542_a(p_i2574_1_, ShaderLoader.ShaderType.FRAGMENT, s1);
