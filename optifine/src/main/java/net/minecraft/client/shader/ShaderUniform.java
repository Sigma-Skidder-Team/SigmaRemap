...
public class ShaderUniform extends ShaderDefault implements AutoCloseable
{
    ...
    public ShaderUniform(String p_i2709_1_, int p_i2709_2_, int p_i2709_3_, IShaderManager p_i2709_4_)
    {
        this.shaderName = p_i2709_1_;
        this.uniformCount = p_i2709_3_;
        this.uniformType = p_i2709_2_;
        this.shaderManager = p_i2709_4_;

        if (p_i2709_2_ <= 3)
        {
            this.uniformIntBuffer = MemoryUtil.memAllocInt(p_i2709_3_);
            this.uniformFloatBuffer = null;
        }
        else
        {
            this.uniformIntBuffer = null;
            this.uniformFloatBuffer = MemoryUtil.memAllocFloat(p_i2709_3_);
        }
