...
public class Framebuffer
{
    ...
    public Framebuffer(int p_i1737_1_, int p_i1737_2_, boolean p_i1737_3_, boolean p_i1737_4_)
    {
        RenderSystem.assertThread(RenderSystem::isOnRenderThreadOrInit);
        this.useDepth = p_i1737_3_;
        ...
        this.resize(p_i1737_1_, p_i1737_2_, p_i1737_4_);
    }
