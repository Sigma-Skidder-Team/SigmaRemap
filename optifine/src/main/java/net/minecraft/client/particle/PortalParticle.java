...
public class PortalParticle extends SpriteTexturedParticle
{
    ...
    private PortalParticle(World p_i1166_1_, double p_i1166_2_, double p_i1166_4_, double p_i1166_6_, double p_i1166_8_, double p_i1166_10_, double p_i1166_12_)
    {
        super(p_i1166_1_, p_i1166_2_, p_i1166_4_, p_i1166_6_);
        this.motionX = p_i1166_8_;
        this.motionY = p_i1166_10_;
        this.motionZ = p_i1166_12_;
        this.posX = p_i1166_2_;
        this.posY = p_i1166_4_;
        this.posZ = p_i1166_6_;
    ...
    public static class Factory implements IParticleFactory<BasicParticleType>
    {
        ...
        public Factory(IAnimatedSprite p_i1013_1_)
        {
            this.spriteSet = p_i1013_1_;
        }
