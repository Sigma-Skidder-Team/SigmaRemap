...
{
    protected RainParticle(World p_i2885_1_, double p_i2885_2_, double p_i2885_4_, double p_i2885_6_)
    {
        super(p_i2885_1_, p_i2885_2_, p_i2885_4_, p_i2885_6_, 0.0D, 0.0D, 0.0D);
    ...
    public static class Factory implements IParticleFactory<BasicParticleType>
    {
        ...
        public Factory(IAnimatedSprite p_i1606_1_)
        {
            this.spriteSet = p_i1606_1_;
        }
