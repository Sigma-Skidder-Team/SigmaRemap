...
{
    private LavaParticle(World p_i1792_1_, double p_i1792_2_, double p_i1792_4_, double p_i1792_6_)
    {
        super(p_i1792_1_, p_i1792_2_, p_i1792_4_, p_i1792_6_, 0.0D, 0.0D, 0.0D);
    ...
    public static class Factory implements IParticleFactory<BasicParticleType>
    {
        ...
        public Factory(IAnimatedSprite p_i2721_1_)
        {
            this.spriteSet = p_i2721_1_;
        }
