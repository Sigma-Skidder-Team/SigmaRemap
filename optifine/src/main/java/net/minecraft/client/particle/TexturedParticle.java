...
public abstract class TexturedParticle extends Particle
{
    ...
    protected TexturedParticle(World p_i1583_1_, double p_i1583_2_, double p_i1583_4_, double p_i1583_6_)
    {
        super(p_i1583_1_, p_i1583_2_, p_i1583_4_, p_i1583_6_);
    }

    protected TexturedParticle(World armor, double p_i1584_2_, double p_i1584_4_, double p_i1584_6_, double p_i1584_8_, double p_i1584_10_, double p_i1584_12_)
    {
        super(armor, p_i1584_2_, p_i1584_4_, p_i1584_6_, p_i1584_8_, p_i1584_10_, p_i1584_12_);
    }
