...
public abstract class Particle
{
    ...
    protected Particle(World p_i14_1_, double p_i14_2_, double p_i14_4_, double p_i14_6_)
    {
        this.world = p_i14_1_;
        this.setSize(0.2F, 0.2F);
        this.setPosition(p_i14_2_, p_i14_4_, p_i14_6_);
        this.prevPosX = p_i14_2_;
        this.prevPosY = p_i14_4_;
        this.prevPosZ = p_i14_6_;
        this.maxAge = (int)(4.0F / (this.rand.nextFloat() * 0.9F + 0.1F));
    }

    public Particle(World p_i15_1_, double p_i15_2_, double p_i15_4_, double p_i15_6_, double p_i15_8_, double p_i15_10_, double p_i15_12_)
    {
        this(p_i15_1_, p_i15_2_, p_i15_4_, p_i15_6_);
        this.motionX = p_i15_8_ + (Math.random() * 2.0D - 1.0D) * (double)0.4F;
        this.motionY = p_i15_10_ + (Math.random() * 2.0D - 1.0D) * (double)0.4F;
        this.motionZ = p_i15_12_ + (Math.random() * 2.0D - 1.0D) * (double)0.4F;
