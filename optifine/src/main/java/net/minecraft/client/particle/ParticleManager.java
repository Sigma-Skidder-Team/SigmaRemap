...
public class ParticleManager implements IFutureReloadListener
{
    ...
    public ParticleManager(World p_i208_1_, TextureManager p_i208_2_)
    {
        p_i208_2_.loadTexture(this.atlas.getTextureLocation(), this.atlas);
        this.world = p_i208_1_;
        this.renderer = p_i208_2_;
    ...
    public void renderParticles(MatrixStack matrixStackIn, IRenderTypeBuffer.Impl bufferIn, LightTexture lightTextureIn, ActiveRenderInfo activeRenderInfoIn, float partialTicks)
    {
        ...
        boolean flag = ifluidstate.isTagged(FluidTags.WATER);
            ...
            if (iparticlerendertype != IParticleRenderType.NO_RENDER)
            {
                ...
                if (iterable != null)
                {
                    ...
                    for (Particle particle : iterable)
                    {
                        try
                        {
                            if (flag || !(particle instanceof UnderwaterParticle))
                            {
