...
public class FireworkParticle
{
    ...
    {
        private Overlay(World p_i3534_1_, double p_i3534_2_, double p_i3534_4_, double p_i3534_6_)
        {
            super(p_i3534_1_, p_i3534_2_, p_i3534_4_, p_i3534_6_);
            this.maxAge = 4;
        }
    ...
    public static class OverlayFactory implements IParticleFactory<BasicParticleType>
    {
        ...
        public OverlayFactory(IAnimatedSprite p_i1741_1_)
        {
            this.spriteSet = p_i1741_1_;
        }
    ...
    static class Spark extends SimpleAnimatedParticle
    {
        ...
        private Spark(World p_i2059_1_, double p_i2059_2_, double p_i2059_4_, double p_i2059_6_, double p_i2059_8_, double p_i2059_10_, double p_i2059_12_, ParticleManager p_i2059_14_, IAnimatedSprite p_i2059_15_)
        {
            super(p_i2059_1_, p_i2059_2_, p_i2059_4_, p_i2059_6_, p_i2059_15_, -0.004F);
            this.motionX = p_i2059_8_;
            this.motionY = p_i2059_10_;
            this.motionZ = p_i2059_12_;
            this.effectRenderer = p_i2059_14_;
            this.particleScale *= 0.75F;
            this.maxAge = 48 + this.rand.nextInt(12);
            this.selectSpriteWithAge(p_i2059_15_);
        }
    ...
    public static class SparkFactory implements IParticleFactory<BasicParticleType>
    {
        ...
        public SparkFactory(IAnimatedSprite p_i734_1_)
        {
            this.spriteSet = p_i734_1_;
        }
    ...
    public static class Starter extends MetaParticle
    {
        ...
        public Starter(World p_i1743_1_, double p_i1743_2_, double p_i1743_4_, double p_i1743_6_, double p_i1743_8_, double p_i1743_10_, double p_i1743_12_, ParticleManager p_i1743_14_, @Nullable CompoundNBT p_i1743_15_)
        {
            super(p_i1743_1_, p_i1743_2_, p_i1743_4_, p_i1743_6_);
            this.motionX = p_i1743_8_;
            this.motionY = p_i1743_10_;
            this.motionZ = p_i1743_12_;
            this.manager = p_i1743_14_;
            this.maxAge = 8;

            if (p_i1743_15_ != null)
            {
                this.fireworkExplosions = p_i1743_15_.getList("Explosions", 10);
