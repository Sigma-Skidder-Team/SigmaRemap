...
public class ClientPlayerEntity extends AbstractClientPlayerEntity
{
    ...
    public ClientPlayerEntity(Minecraft p_i752_1_, ClientWorld p_i752_2_, ClientPlayNetHandler p_i752_3_, StatisticsManager p_i752_4_, ClientRecipeBook p_i752_5_)
    {
        super(p_i752_2_, p_i752_3_.getGameProfile());
        this.connection = p_i752_3_;
        this.stats = p_i752_4_;
        this.recipeBook = p_i752_5_;
        this.mc = p_i752_1_;
        this.dimension = DimensionType.OVERWORLD;
        this.ambientSoundHandlers.add(new UnderwaterAmbientSoundHandler(this, p_i752_1_.getSoundHandler()));
