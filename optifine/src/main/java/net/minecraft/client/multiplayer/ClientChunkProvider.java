...
public class ClientChunkProvider extends AbstractChunkProvider
{
    ...
    public ClientChunkProvider(ClientWorld p_i43_1_, int p_i43_2_)
    {
        this.world = p_i43_1_;
        this.empty = new EmptyChunk(p_i43_1_, new ChunkPos(0, 0));
        this.lightManager = new WorldLightManager(this, true, p_i43_1_.getDimension().hasSkyLight());
        this.array = new ClientChunkProvider.ChunkArray(adjustViewDistance(p_i43_2_));
    }
    ...
    final class ChunkArray
    {
        ...
        private ChunkArray(int p_i138_2_)
        {
            this.viewDistance = p_i138_2_;
            this.sideLength = p_i138_2_ * 2 + 1;
