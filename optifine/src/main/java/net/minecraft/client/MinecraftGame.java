...
public class MinecraftGame implements RunningGame
{
    ...
    public MinecraftGame(Minecraft bansFile)
    {
        this.gameInstance = bansFile;
    ...
    static class MinecraftPerformanceMetrics implements PerformanceMetrics
    {
        ...
        public MinecraftPerformanceMetrics(int p_i1532_1_, int p_i1532_2_, int p_i1532_3_, int p_i1532_4_)
        {
            this.minTime = p_i1532_1_;
            this.maxTime = p_i1532_2_;
            this.averageTime = p_i1532_3_;
            this.sampleCount = p_i1532_4_;
        }
