...
public class Minecraft extends RecursiveEventLoop<Runnable> implements ISnooperInfo, IWindowEventListener
{
    ...
    public Minecraft(GameConfiguration p_i807_1_)
    {
        super("Client");
        instance = this;
        this.gameDir = p_i807_1_.folderInfo.gameDir;
        File file1 = p_i807_1_.folderInfo.assetsDir;
        this.fileResourcepacks = p_i807_1_.folderInfo.resourcePacksDir;
        this.launchedVersion = p_i807_1_.gameInfo.version;
        this.versionType = p_i807_1_.gameInfo.versionType;
        this.profileProperties = p_i807_1_.userInfo.profileProperties;
        this.packFinder = new DownloadingPackFinder(new File(this.gameDir, "server-resource-packs"), p_i807_1_.folderInfo.getAssetsIndex());
        ...
        this.proxy = p_i807_1_.userInfo.proxy;
        this.sessionService = (new YggdrasilAuthenticationService(this.proxy, UUID.randomUUID().toString())).createMinecraftSessionService();
        this.session = p_i807_1_.userInfo.session;
        LOGGER.info("Setting user: {}", (Object)this.session.getUsername());
        LOGGER.debug("(Session ID is {})", (Object)this.session.getSessionID());
        this.isDemo = p_i807_1_.gameInfo.isDemo;
        this.jvm64bit = isJvm64bit();
        this.integratedServer = null;
        String s;
        int i;

        if (p_i807_1_.serverInfo.serverName != null)
        {
            s = p_i807_1_.serverInfo.serverName;
            i = p_i807_1_.serverInfo.serverPort;
        }
        else
        {
            s = null;
        ...
        {
            screensize = new ScreenSize(this.gameSettings.overrideWidth, this.gameSettings.overrideHeight, p_i807_1_.displayInfo.fullscreenWidth, p_i807_1_.displayInfo.fullscreenHeight, p_i807_1_.displayInfo.fullscreen);
        }
        else
        {
            screensize = p_i807_1_.displayInfo;
        }
