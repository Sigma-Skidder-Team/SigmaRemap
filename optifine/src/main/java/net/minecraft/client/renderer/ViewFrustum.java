...
public class ViewFrustum
{
    ...
    public ViewFrustum(ChunkRenderDispatcher p_i114_1_, World p_i114_2_, int p_i114_3_, WorldRenderer p_i114_4_)
    {
        this.renderGlobal = p_i114_4_;
        this.world = p_i114_2_;
        this.setCountChunksXYZ(p_i114_3_);
        this.createRenderChunks(p_i114_1_);
    }
