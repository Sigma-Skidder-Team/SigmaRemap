...
public class BufferBuilder extends DefaultColorVertexBuilder implements IVertexConsumer
{
    ...
    public BufferBuilder(int p_i264_1_)
    {
        this.byteBuffer = GLAllocation.createDirectByteBuffer(p_i264_1_ * 4);
        ...
        for (int l = bitset.nextClearBit(0); l < aint.length; l = bitset.nextClearBit(l + 1))
        {
            ...
            if (i1 != l)
            {
                ...
                for (int k1 = aint[i1]; j1 != l; k1 = aint[k1])
                {
                    ...
                    floatbuffer1.clear();
                    floatbuffer1.position(floatbuffer.position());
                    floatbuffer1.limit(floatbuffer.limit());
    ...
    {
        int i = this.byteBuffer.capacity() / this.vertexFormat.getSize();
        return i;
    }
    ...
    public static final class DrawState
    {
        ...
        private DrawState(VertexFormat p_i162_1_, int p_i162_2_, int p_i162_3_)
        {
            this.format = p_i162_1_;
            this.vertexCount = p_i162_2_;
            this.drawMode = p_i162_3_;
        }
    ...
    public static class State
    {
        ...
        public State(ByteBuffer p_i145_1_, VertexFormat p_i145_2_, TextureAtlasSprite[] p_i145_3_)
        {
            this(p_i145_1_, p_i145_2_);
            this.stateQuadSprites = p_i145_3_;
        }

        private State(ByteBuffer p_i146_1_, VertexFormat p_i146_2_)
        {
            this.stateByteBuffer = p_i146_1_;
            this.stateVertexFormat = p_i146_2_;
        }
    }
}
