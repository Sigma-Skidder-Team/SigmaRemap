...
public enum ModelRotation implements IModelTransform
{
    ...
    private ModelRotation(int p_i398_3_, int p_i398_4_)
    {
        this.combinedXY = combineXY(p_i398_3_, p_i398_4_);
        Quaternion quaternion = new Quaternion(new Vector3f(0.0F, 1.0F, 0.0F), (float)(-p_i398_4_), true);
        quaternion.multiply(new Quaternion(new Vector3f(1.0F, 0.0F, 0.0F), (float)(-p_i398_3_), true));
        this.matrix = quaternion;
        this.quartersX = MathHelper.abs(p_i398_3_ / 90);
        this.quartersY = MathHelper.abs(p_i398_4_ / 90);
    }
