...
public class GameRenderer implements AutoCloseable, IResourceManagerReloadListener
{
    ...
    {
        this.mc = p_i107_1_;
        this.resourceManager = p_i107_2_;
        this.itemRenderer = p_i107_1_.getFirstPersonRenderer();
        this.mapItemRenderer = new MapItemRenderer(p_i107_1_.getTextureManager());
    ...
    private void frameInit()
    {
        ...
        if (world != null)
        {
            if (Config.getNewRelease() != null)
            {
                ...
                stringtextcomponent.setStyle((new Style()).setClickEvent(new ClickEvent(ClickEvent.Action.OPEN_URL, "https://optifine.net/downloads")));
