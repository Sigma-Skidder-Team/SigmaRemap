...
public class ItemModelGenerator
{
    ...
    static class Span
    {
        ...
        public Span(ItemModelGenerator.SpanFacing p_i3311_1_, int p_i3311_2_, int p_i3311_3_)
        {
            this.spanFacing = p_i3311_1_;
            this.min = p_i3311_2_;
            this.max = p_i3311_2_;
            this.anchor = p_i3311_3_;
        }
    ...
    static enum SpanFacing
    {
        ...
        private SpanFacing(Direction p_i2464_3_, int p_i2464_4_, int p_i2464_5_)
        {
            this.facing = p_i2464_3_;
            this.xOffset = p_i2464_4_;
            this.yOffset = p_i2464_5_;
        }
