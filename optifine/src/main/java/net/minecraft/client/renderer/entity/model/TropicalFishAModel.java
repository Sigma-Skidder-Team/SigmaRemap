...
public class TropicalFishAModel<T extends Entity> extends AbstractTropicalFishModel<T>
{
    ...
    public TropicalFishAModel(float p_i2242_1_)
    {
        this.textureWidth = 32;
        this.textureHeight = 32;
        int i = 22;
        this.body = new ModelRenderer(this, 0, 0);
        this.body.addBox(-1.0F, -1.5F, -3.0F, 2.0F, 3.0F, 6.0F, p_i2242_1_);
        this.body.setRotationPoint(0.0F, 22.0F, 0.0F);
        this.tail = new ModelRenderer(this, 22, -6);
        this.tail.addBox(0.0F, -1.5F, 0.0F, 0.0F, 3.0F, 6.0F, p_i2242_1_);
        this.tail.setRotationPoint(0.0F, 22.0F, 3.0F);
        this.finRight = new ModelRenderer(this, 2, 16);
        this.finRight.addBox(-2.0F, -1.0F, 0.0F, 2.0F, 2.0F, 0.0F, p_i2242_1_);
        ...
        this.finLeft.addBox(0.0F, -1.0F, 0.0F, 2.0F, 2.0F, 0.0F, p_i2242_1_);
        ...
        this.finTop.addBox(0.0F, -3.0F, 0.0F, 0.0F, 3.0F, 6.0F, p_i2242_1_);
