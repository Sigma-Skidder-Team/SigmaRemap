...
public class SignTileEntityRenderer extends TileEntityRenderer<SignTileEntity>
{
    ...
    public SignTileEntityRenderer(TileEntityRendererDispatcher p_i254_1_)
    {
        super(p_i254_1_);
    }
    ...
    public void render(SignTileEntity tileEntityIn, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int combinedLightIn, int combinedOverlayIn)
    {
        ...
        if (isRenderText(tileEntityIn))
        {
            ...
            {
                String s = tileEntityIn.getRenderText(j1, (p_lambda$render$0_1_) ->
                {
                    List<ITextComponent> list = RenderComponentsUtil.splitText(p_lambda$render$0_1_, 90, fontrenderer, false, true);
    ...
    private static boolean isRenderText(SignTileEntity p_isRenderText_0_)
    {
        ...
        else
        {
            if (!Config.zoomMode)
            {
                ...
                double d0 = p_isRenderText_0_.getDistanceSq(entity.getPosX(), entity.getPosY(), entity.getPosZ());
