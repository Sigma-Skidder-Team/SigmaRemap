...
public class Multipart implements IUnbakedModel
{
    ...
    public Multipart(StateContainer<Block, BlockState> p_i3011_1_, List<Selector> p_i3011_2_)
    {
        this.stateContainer = p_i3011_1_;
        this.selectors = p_i3011_2_;
    }
    ...
    public static class Deserializer implements JsonDeserializer<Multipart>
    {
        ...
        public Deserializer(BlockModelDefinition.ContainerHolder p_i3939_1_)
        {
            this.containerHolder = p_i3939_1_;
        }
