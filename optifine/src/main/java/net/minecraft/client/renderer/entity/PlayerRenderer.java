...
{
    public PlayerRenderer(EntityRendererManager p_i1302_1_)
    {
        this(p_i1302_1_, false);
    }

    public PlayerRenderer(EntityRendererManager languageCodeIn, boolean regionIn)
    {
        super(languageCodeIn, new PlayerModel<>(0.0F, regionIn), 0.5F);
