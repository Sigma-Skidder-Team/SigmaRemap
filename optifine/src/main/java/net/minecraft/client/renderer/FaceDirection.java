...
public enum FaceDirection
{
    ...
    private FaceDirection(FaceDirection.VertexInformation... p_i4237_3_)
    {
        this.vertexInfos = p_i4237_3_;
    }
    ...
    public static class VertexInformation {
        ...
        private VertexInformation(int p_i332_1_, int p_i332_2_, int p_i332_3_)
        {
            this.xIndex = p_i332_1_;
            this.yIndex = p_i332_2_;
            this.zIndex = p_i332_3_;
        }
    }
}
