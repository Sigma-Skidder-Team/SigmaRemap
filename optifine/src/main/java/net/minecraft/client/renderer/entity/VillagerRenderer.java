...
public class VillagerRenderer extends MobRenderer<VillagerEntity, VillagerModel<VillagerEntity>>
{
    ...
    public VillagerRenderer(EntityRendererManager p_i3703_1_, IReloadableResourceManager p_i3703_2_)
    {
        super(p_i3703_1_, new VillagerModel<>(0.0F), 0.5F);
        this.addLayer(new HeadLayer<>(this));
        this.addLayer(new VillagerLevelPendantLayer<>(this, p_i3703_2_, "villager"));
