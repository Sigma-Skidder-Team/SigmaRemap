...
public class ChunkRenderDispatcher
{
    ...
    public ChunkRenderDispatcher(World p_i40_1_, WorldRenderer p_i40_2_, Executor p_i40_3_, boolean p_i40_4_, RegionRenderCacheBuilder p_i40_5_)
    {
        this(p_i40_1_, p_i40_2_, p_i40_3_, p_i40_4_, p_i40_5_, -1);
    }

    public ChunkRenderDispatcher(World p_i41_1_, WorldRenderer p_i41_2_, Executor p_i41_3_, boolean p_i41_4_, RegionRenderCacheBuilder p_i41_5_, int p_i41_6_)
    {
        this.world = p_i41_1_;
        this.worldRenderer = p_i41_2_;
        ...
        this.executor = p_i41_3_;
        this.delegatedTaskExecutor = DelegatedTaskExecutor.create(p_i41_3_, "Chunk Renderer");
    ...
    public class ChunkRender implements IForgeRenderChunk
    {
        ...
        private RenderType[] getFluidRenderLayers(IFluidState p_getFluidRenderLayers_1_, RenderType[] p_getFluidRenderLayers_2_)
        {
        ...
        private ChunkCacheOF makeChunkCacheOF(BlockPos p_makeChunkCacheOF_1_)
        {
            ...
            ChunkCacheOF chunkcacheof = new ChunkCacheOF(chunkrendercache, blockpos, blockpos1, 1);
            return chunkcacheof;
        }
        ...
        abstract class ChunkRenderTask implements Comparable<ChunkRenderDispatcher.ChunkRender.ChunkRenderTask>
        {
            ...
            public ChunkRenderTask(double p_i94_2_)
            {
                this((ChunkPos)null, p_i94_2_);
            }

            public ChunkRenderTask(ChunkPos p_i95_2_, double p_i95_3_)
            {
                this.distanceSq = p_i95_3_;
                ...
                {
                    this.modelData = ModelDataManager.getModelData(Minecraft.getInstance().world, p_i95_2_);
                }
            }
        ...
        class RebuildTask extends ChunkRenderDispatcher.ChunkRender.ChunkRenderTask
        {
            ...
            public RebuildTask(@Nullable double p_i55_2_, ChunkRenderCache p_i55_4_)
            {
                this((ChunkPos)null, p_i55_2_, p_i55_4_);
            }

            public RebuildTask(ChunkPos p_i56_2_, @Nullable double p_i56_3_, ChunkRenderCache p_i56_5_)
            {
                super(p_i56_2_, p_i56_3_);
                this.chunkRenderCache = p_i56_5_;
            }
            ...
            private Set<TileEntity> compile(float xIn, float yIn, float zIn, ChunkRenderDispatcher.CompiledChunk compiledChunkIn, RegionRenderCacheBuilder builderIn)
            {
                ...
                if (!ChunkRender.this.isChunkRegionEmpty(blockpos))
                {
                    ...
                    for (BlockPosM blockposm : (Iterable<BlockPosM>)BlockPosM.getAllInBoxMutable(blockpos, blockpos1))
                    {
                        ...
                        IModelData imodeldata = this.getModelData(blockposm);

                        if (!ifluidstate.isEmpty())
                        {
                            RenderType[] arendertype1 = ChunkRender.this.getFluidRenderLayers(ifluidstate, arendertype);

                            for (int j = 0; j < arendertype1.length; ++j)
                            {
                                RenderType rendertype = arendertype1[j];

                                if (!ChunkRenderDispatcher.FORGE_CAN_RENDER_IN_LAYER_FS || Reflector.callBoolean(Reflector.ForgeRenderTypeLookup_canRenderInLayerFs, ifluidstate, rendertype))
                                {
                                    ...
                                    if (blockrendererdispatcher.renderFluid(blockposm, chunkcacheof, bufferbuilder, ifluidstate))
                                    {
                        ...
                        if (blockstate.getRenderType() != BlockRenderType.INVISIBLE)
                        {
                            ...
                            for (int k = 0; k < arendertype2.length; ++k)
                            {
                                ...
                                if (!ChunkRenderDispatcher.FORGE_CAN_RENDER_IN_LAYER_BS || Reflector.callBoolean(Reflector.ForgeRenderTypeLookup_canRenderInLayerBs, blockstate, rendertype3))
                                {
                                    ...
                                    matrixstack.push();
                                    matrixstack.translate((double)(blockposm.getX() & 15), (double)(blockposm.getY() & 15), (double)(blockposm.getZ() & 15));
        ...
        class SortTransparencyTask extends ChunkRenderDispatcher.ChunkRender.ChunkRenderTask
        {
            ...
            public SortTransparencyTask(double p_i147_2_, ChunkRenderDispatcher.CompiledChunk p_i147_4_)
            {
                this((ChunkPos)null, p_i147_2_, p_i147_4_);
            }

            public SortTransparencyTask(ChunkPos p_i148_2_, double p_i148_3_, ChunkRenderDispatcher.CompiledChunk p_i148_5_)
            {
                super(p_i148_2_, p_i148_3_);
                this.sortCompiledChunk = p_i148_5_;
            }
