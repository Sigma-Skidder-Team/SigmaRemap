...
public class BakedQuad implements IVertexProducer
{
    ...
    public BakedQuad(int[] p_i53_1_, int p_i53_2_, Direction p_i53_3_, TextureAtlasSprite p_i53_4_, boolean p_i53_5_)
    {
        this.vertexData = p_i53_1_;
        this.tintIndex = p_i53_2_;
        this.face = p_i53_3_;
        this.sprite = p_i53_4_;
        this.applyDiffuseLighting = p_i53_5_;
        this.fixVertexData();
    }

    public BakedQuad(int[] p_i54_1_, int p_i54_2_, Direction p_i54_3_, TextureAtlasSprite p_i54_4_)
    {
        this.vertexData = p_i54_1_;
        this.tintIndex = p_i54_2_;
        this.face = p_i54_3_;
        this.sprite = p_i54_4_;
        this.fixVertexData();
    }
    ...
    private static TextureAtlasSprite getSpriteByUv(int[] p_getSpriteByUv_0_)
    {
        ...
        float f6 = (f + f2) / 2.0F;
        float f7 = (f1 + f3) / 2.0F;
        TextureAtlasSprite textureatlassprite = Config.getTextureMap().getIconByUV((double)f6, (double)f7);
