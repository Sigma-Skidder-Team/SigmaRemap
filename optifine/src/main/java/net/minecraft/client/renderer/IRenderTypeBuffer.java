...
default void flushRenderBuffers()
    ...
    public static class Impl implements IRenderTypeBuffer
    {
        ...
        protected Impl(BufferBuilder p_i256_1_, Map<RenderType, BufferBuilder> p_i256_2_)
        {
            this.buffer = p_i256_1_;
            this.fixedBuffers = p_i256_2_;
            this.buffer.setRenderTypeBuffer(this);

            for (BufferBuilder bufferbuilder : p_i256_2_.values())
            {
        ...
        public IVertexBuilder getBuffer(ResourceLocation p_getBuffer_1_)
        {
            ...
            else
            {
                ...
                {
                    p_getBuffer_1_ = RandomEntities.getTextureLocation(p_getBuffer_1_);
                }
                ...
                IVertexBuilder ivertexbuilder = this.getBuffer(rendertype$type1);
