...
public class GenericHeadModel extends Model
{
    ...
    public GenericHeadModel(int p_i2641_1_, int p_i2641_2_, int p_i2641_3_, int p_i2641_4_)
    {
        super(RenderType::getEntityTranslucent);
        this.textureWidth = p_i2641_3_;
        this.textureHeight = p_i2641_4_;
        this.field_217105_a = new ModelRenderer(this, p_i2641_1_, p_i2641_2_);
