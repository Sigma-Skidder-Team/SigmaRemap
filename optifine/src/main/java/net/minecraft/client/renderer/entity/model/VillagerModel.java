...
public class VillagerModel<T extends Entity> extends SegmentedModel<T> implements IHasHead, IHeadToggle
{
    ...
    public VillagerModel(float p_i3098_1_)
    {
        this(p_i3098_1_, 64, 64);
    }

    public VillagerModel(float p_i3099_1_, int p_i3099_2_, int p_i3099_3_)
    {
        float f = 0.5F;
        this.villagerHead = (new ModelRenderer(this)).setTextureSize(p_i3099_2_, p_i3099_3_);
        this.villagerHead.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.villagerHead.setTextureOffset(0, 0).addBox(-4.0F, -10.0F, -4.0F, 8.0F, 10.0F, 8.0F, p_i3099_1_);
        this.field_217151_b = (new ModelRenderer(this)).setTextureSize(p_i3099_2_, p_i3099_3_);
        this.field_217151_b.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.field_217151_b.setTextureOffset(32, 0).addBox(-4.0F, -10.0F, -4.0F, 8.0F, 10.0F, 8.0F, p_i3099_1_ + 0.5F);
        this.villagerHead.addChild(this.field_217151_b);
        this.field_217152_f = (new ModelRenderer(this)).setTextureSize(p_i3099_2_, p_i3099_3_);
        this.field_217152_f.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.field_217152_f.setTextureOffset(30, 47).addBox(-8.0F, -8.0F, -6.0F, 16.0F, 16.0F, 1.0F, p_i3099_1_);
        this.field_217152_f.rotateAngleX = (-(float)Math.PI / 2F);
        this.field_217151_b.addChild(this.field_217152_f);
        this.villagerNose = (new ModelRenderer(this)).setTextureSize(p_i3099_2_, p_i3099_3_);
        this.villagerNose.setRotationPoint(0.0F, -2.0F, 0.0F);
        this.villagerNose.setTextureOffset(24, 0).addBox(-1.0F, -1.0F, -6.0F, 2.0F, 4.0F, 2.0F, p_i3099_1_);
        this.villagerHead.addChild(this.villagerNose);
        this.villagerBody = (new ModelRenderer(this)).setTextureSize(p_i3099_2_, p_i3099_3_);
        this.villagerBody.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.villagerBody.setTextureOffset(16, 20).addBox(-4.0F, 0.0F, -3.0F, 8.0F, 12.0F, 6.0F, p_i3099_1_);
        this.field_217153_h = (new ModelRenderer(this)).setTextureSize(p_i3099_2_, p_i3099_3_);
        this.field_217153_h.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.field_217153_h.setTextureOffset(0, 38).addBox(-4.0F, 0.0F, -3.0F, 8.0F, 18.0F, 6.0F, p_i3099_1_ + 0.5F);
        this.villagerBody.addChild(this.field_217153_h);
        this.villagerArms = (new ModelRenderer(this)).setTextureSize(p_i3099_2_, p_i3099_3_);
        this.villagerArms.setRotationPoint(0.0F, 2.0F, 0.0F);
        this.villagerArms.setTextureOffset(44, 22).addBox(-8.0F, -2.0F, -2.0F, 4.0F, 8.0F, 4.0F, p_i3099_1_);
        this.villagerArms.setTextureOffset(44, 22).addBox(4.0F, -2.0F, -2.0F, 4.0F, 8.0F, 4.0F, p_i3099_1_, true);
        this.villagerArms.setTextureOffset(40, 38).addBox(-4.0F, 2.0F, -2.0F, 8.0F, 4.0F, 4.0F, p_i3099_1_);
        this.rightVillagerLeg = (new ModelRenderer(this, 0, 22)).setTextureSize(p_i3099_2_, p_i3099_3_);
        this.rightVillagerLeg.setRotationPoint(-2.0F, 12.0F, 0.0F);
        this.rightVillagerLeg.addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, p_i3099_1_);
        this.leftVillagerLeg = (new ModelRenderer(this, 0, 22)).setTextureSize(p_i3099_2_, p_i3099_3_);
        this.leftVillagerLeg.mirror = true;
        this.leftVillagerLeg.setRotationPoint(2.0F, 12.0F, 0.0F);
        this.leftVillagerLeg.addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, p_i3099_1_);
    }
