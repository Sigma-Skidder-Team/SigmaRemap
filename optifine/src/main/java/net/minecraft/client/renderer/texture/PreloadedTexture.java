...
public class PreloadedTexture extends SimpleTexture
{
    ...
    public PreloadedTexture(IResourceManager p_i1270_1_, ResourceLocation p_i1270_2_, Executor p_i1270_3_)
    {
        super(p_i1270_2_);
        this.textureDataFuture = CompletableFuture.supplyAsync(() ->
        {
            return SimpleTexture.TextureData.getTextureData(p_i1270_1_, p_i1270_2_);
        }, p_i1270_3_);
    }
