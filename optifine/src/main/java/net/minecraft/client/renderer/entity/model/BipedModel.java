...
public class BipedModel<T extends LivingEntity> extends AgeableModel<T> implements IHasArm, IHasHead
{
    ...
    public BipedModel(float p_i314_1_)
    {
        this(RenderType::getEntityCutoutNoCull, p_i314_1_, 0.0F, 64, 32);
    }

    protected BipedModel(float p_i315_1_, float p_i315_2_, int p_i315_3_, int p_i315_4_)
    {
        this(RenderType::getEntityCutoutNoCull, p_i315_1_, p_i315_2_, p_i315_3_, p_i315_4_);
    }

    public BipedModel(Function<ResourceLocation, RenderType> p_i316_1_, float p_i316_2_, float p_i316_3_, int p_i316_4_, int p_i316_5_)
    {
        super(p_i316_1_, true, 16.0F, 0.0F, 2.0F, 2.0F, 24.0F);
        this.textureWidth = p_i316_4_;
        this.textureHeight = p_i316_5_;
        this.bipedHead = new ModelRenderer(this, 0, 0);
        this.bipedHead.addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, p_i316_2_);
        this.bipedHead.setRotationPoint(0.0F, 0.0F + p_i316_3_, 0.0F);
        this.bipedHeadwear = new ModelRenderer(this, 32, 0);
        this.bipedHeadwear.addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, p_i316_2_ + 0.5F);
        this.bipedHeadwear.setRotationPoint(0.0F, 0.0F + p_i316_3_, 0.0F);
        this.bipedBody = new ModelRenderer(this, 16, 16);
        this.bipedBody.addBox(-4.0F, 0.0F, -2.0F, 8.0F, 12.0F, 4.0F, p_i316_2_);
        this.bipedBody.setRotationPoint(0.0F, 0.0F + p_i316_3_, 0.0F);
        this.bipedRightArm = new ModelRenderer(this, 40, 16);
        this.bipedRightArm.addBox(-3.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, p_i316_2_);
        this.bipedRightArm.setRotationPoint(-5.0F, 2.0F + p_i316_3_, 0.0F);
        this.bipedLeftArm = new ModelRenderer(this, 40, 16);
        this.bipedLeftArm.mirror = true;
        this.bipedLeftArm.addBox(-1.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, p_i316_2_);
        this.bipedLeftArm.setRotationPoint(5.0F, 2.0F + p_i316_3_, 0.0F);
        this.bipedRightLeg = new ModelRenderer(this, 0, 16);
        this.bipedRightLeg.addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, p_i316_2_);
        this.bipedRightLeg.setRotationPoint(-1.9F, 12.0F + p_i316_3_, 0.0F);
        this.bipedLeftLeg = new ModelRenderer(this, 0, 16);
        this.bipedLeftLeg.mirror = true;
        this.bipedLeftLeg.addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, p_i316_2_);
        this.bipedLeftLeg.setRotationPoint(1.9F, 12.0F + p_i316_3_, 0.0F);
    }
