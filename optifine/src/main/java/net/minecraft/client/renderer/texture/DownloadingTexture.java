...
public class DownloadingTexture extends SimpleTexture
{
    ...
    public DownloadingTexture(@Nullable File p_i2_1_, String p_i2_2_, ResourceLocation p_i2_3_, boolean p_i2_4_, @Nullable Runnable p_i2_5_)
    {
        super(p_i2_3_);
        this.cacheFile = p_i2_1_;
        this.imageUrl = p_i2_2_;
        this.legacySkin = p_i2_4_;
        this.processTask = p_i2_5_;
    }
