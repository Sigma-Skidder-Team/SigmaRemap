...
public class BlockPartFace
{
    ...
    public BlockPartFace(@Nullable Direction p_i3027_1_, int p_i3027_2_, String p_i3027_3_, BlockFaceUV p_i3027_4_)
    {
        this.cullFace = p_i3027_1_;
        this.tintIndex = p_i3027_2_;
        this.texture = p_i3027_3_;
        this.blockFaceUV = p_i3027_4_;
    }
