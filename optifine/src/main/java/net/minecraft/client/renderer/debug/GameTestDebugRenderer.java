...
public class GameTestDebugRenderer implements DebugRenderer.IDebugRenderer
{
    ...
    static class Marker
    {
        ...
        public Marker(int p_i3525_1_, String p_i3525_2_, long p_i3525_3_)
        {
            this.field_229024_a_ = p_i3525_1_;
            this.field_229025_b_ = p_i3525_2_;
            this.field_229026_c_ = p_i3525_3_;
        }
