...
public class ZombieVillagerRenderer extends BipedRenderer<ZombieVillagerEntity, ZombieVillagerModel<ZombieVillagerEntity>>
{
    ...
    public ZombieVillagerRenderer(EntityRendererManager p_i1871_1_, IReloadableResourceManager p_i1871_2_)
    {
        super(p_i1871_1_, new ZombieVillagerModel<>(0.0F, false), 0.5F);
        this.addLayer(new BipedArmorLayer<>(this, new ZombieVillagerModel(0.5F, true), new ZombieVillagerModel(1.0F, true)));
        this.addLayer(new VillagerLevelPendantLayer<>(this, p_i1871_2_, "zombie_villager"));
    }
