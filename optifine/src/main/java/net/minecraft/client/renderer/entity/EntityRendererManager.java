...
public class EntityRendererManager
{
    ...
    public EntityRendererManager(TextureManager p_i253_1_, net.minecraft.client.renderer.ItemRenderer p_i253_2_, IReloadableResourceManager p_i253_3_, FontRenderer p_i253_4_, GameSettings p_i253_5_)
    {
        this.textureManager = p_i253_1_;
        this.textRenderer = p_i253_4_;
        this.options = p_i253_5_;
        this.registerRenderers(p_i253_2_, p_i253_3_);
    ...
    private static void renderBlockShadow(MatrixStack.Entry matrixEntryIn, IVertexBuilder bufferIn, IWorldReader worldIn, BlockPos blockPosIn, double xIn, double yIn, double zIn, float sizeIn, float weightIn)
    {
        ...
        if (blockstate.getRenderType() != BlockRenderType.INVISIBLE && worldIn.getLight(blockPosIn) > 3 && blockstate.isCollisionShapeOpaque(worldIn, blockpos))
        {
