...
{
    public ArmorStandArmorModel(float p_i614_1_)
    {
        this(p_i614_1_, 64, 32);
    }

    protected ArmorStandArmorModel(float p_i615_1_, int p_i615_2_, int p_i615_3_)
    {
        super(p_i615_1_, 0.0F, p_i615_2_, p_i615_3_);
    }
