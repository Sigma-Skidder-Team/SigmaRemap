...
public class BlockModelRenderer
{
    ...
    public BlockModelRenderer(BlockColors p_i173_1_)
    {
        this.blockColors = p_i173_1_;
    }
    ...
    public boolean renderModel(ILightReader p_renderModel_1_, IBakedModel p_renderModel_2_, BlockState p_renderModel_3_, BlockPos p_renderModel_4_, MatrixStack p_renderModel_5_, IVertexBuilder p_renderModel_6_, boolean p_renderModel_7_, Random p_renderModel_8_, long p_renderModel_9_, int p_renderModel_11_, IModelData p_renderModel_12_)
    {
        ...
        p_renderModel_5_.translate(vec3d.x, vec3d.y, vec3d.z);
        ...
        try
        {
            ...
            if (flag1)
            {
                this.renderOverlayModels(p_renderModel_1_, p_renderModel_2_, p_renderModel_3_, p_renderModel_4_, p_renderModel_5_, p_renderModel_6_, p_renderModel_11_, p_renderModel_7_, p_renderModel_8_, p_renderModel_9_, renderenv, flag, vec3d);
            }
    ...
    private void renderQuadSmooth(ILightReader p_renderQuadSmooth_1_, BlockState p_renderQuadSmooth_2_, BlockPos p_renderQuadSmooth_3_, IVertexBuilder p_renderQuadSmooth_4_, MatrixStack.Entry p_renderQuadSmooth_5_, BakedQuad p_renderQuadSmooth_6_, float p_renderQuadSmooth_7_, float p_renderQuadSmooth_8_, float p_renderQuadSmooth_9_, float p_renderQuadSmooth_10_, int p_renderQuadSmooth_11_, int p_renderQuadSmooth_12_, int p_renderQuadSmooth_13_, int p_renderQuadSmooth_14_, int p_renderQuadSmooth_15_, RenderEnv p_renderQuadSmooth_16_)
    {
        ...
        if (p_renderQuadSmooth_6_.shouldApplyDiffuseLighting())
        {
            float f3 = FaceBakery.getFaceBrightness(p_renderQuadSmooth_6_.getFace());
            f *= f3;
            f1 *= f3;
            f2 *= f3;
        }
    ...
    private void renderQuadsFlat(ILightReader p_renderQuadsFlat_1_, BlockState p_renderQuadsFlat_2_, BlockPos p_renderQuadsFlat_3_, int p_renderQuadsFlat_4_, int p_renderQuadsFlat_5_, boolean p_renderQuadsFlat_6_, MatrixStack p_renderQuadsFlat_7_, IVertexBuilder p_renderQuadsFlat_8_, List<BakedQuad> p_renderQuadsFlat_9_, RenderEnv p_renderQuadsFlat_10_)
    {
        ...
        for (int j = 0; j < i; ++j)
        {
            ...
            this.renderQuadSmooth(p_renderQuadsFlat_1_, p_renderQuadsFlat_2_, p_renderQuadsFlat_3_, p_renderQuadsFlat_8_, p_renderQuadsFlat_7_.getLast(), bakedquad, 1.0F, 1.0F, 1.0F, 1.0F, p_renderQuadsFlat_4_, p_renderQuadsFlat_4_, p_renderQuadsFlat_4_, p_renderQuadsFlat_4_, p_renderQuadsFlat_5_, p_renderQuadsFlat_10_);
        }
    }
    ...
    private void renderOverlayModels(ILightReader p_renderOverlayModels_1_, IBakedModel p_renderOverlayModels_2_, BlockState p_renderOverlayModels_3_, BlockPos p_renderOverlayModels_4_, MatrixStack p_renderOverlayModels_5_, IVertexBuilder p_renderOverlayModels_6_, int p_renderOverlayModels_7_, boolean p_renderOverlayModels_8_, Random p_renderOverlayModels_9_, long p_renderOverlayModels_10_, RenderEnv p_renderOverlayModels_12_, boolean p_renderOverlayModels_13_, Vec3d p_renderOverlayModels_14_)
    {
    ...
    public static class AmbientOcclusionFace
    {
        ...
        public AmbientOcclusionFace(BlockModelRenderer p_i1_1_)
        {
        }
        ...
        public void updateVertexBrightness(ILightReader worldIn, BlockState state, BlockPos centerPos, Direction directionIn, float[] faceShape, BitSet shapeState)
        {
            ...
            blockposm.setPosMove(blockpos, blockmodelrenderer$neighborinfo.corners[0]);
            BlockState blockstate = worldIn.getBlockState(blockposm);
            int i = LightCacheOF.getPackedLight(blockstate, worldIn, blockposm);
            float f = LightCacheOF.getBrightness(blockstate, worldIn, blockposm);
            blockposm.setPosMove(blockpos, blockmodelrenderer$neighborinfo.corners[1]);
            BlockState blockstate1 = worldIn.getBlockState(blockposm);
            int j = LightCacheOF.getPackedLight(blockstate1, worldIn, blockposm);
            float f1 = LightCacheOF.getBrightness(blockstate1, worldIn, blockposm);
            blockposm.setPosMove(blockpos, blockmodelrenderer$neighborinfo.corners[2]);
            BlockState blockstate2 = worldIn.getBlockState(blockposm);
            int k = LightCacheOF.getPackedLight(blockstate2, worldIn, blockposm);
            float f2 = LightCacheOF.getBrightness(blockstate2, worldIn, blockposm);
            blockposm.setPosMove(blockpos, blockmodelrenderer$neighborinfo.corners[3]);
            BlockState blockstate3 = worldIn.getBlockState(blockposm);
            int l = LightCacheOF.getPackedLight(blockstate3, worldIn, blockposm);
            float f3 = LightCacheOF.getBrightness(blockstate3, worldIn, blockposm);
            blockposm.setPosMove(blockpos, blockmodelrenderer$neighborinfo.corners[0], directionIn);
            boolean flag = worldIn.getBlockState(blockposm).getOpacity(worldIn, blockposm) == 0;
            blockposm.setPosMove(blockpos, blockmodelrenderer$neighborinfo.corners[1], directionIn);
            boolean flag1 = worldIn.getBlockState(blockposm).getOpacity(worldIn, blockposm) == 0;
            blockposm.setPosMove(blockpos, blockmodelrenderer$neighborinfo.corners[2], directionIn);
            boolean flag2 = worldIn.getBlockState(blockposm).getOpacity(worldIn, blockposm) == 0;
            blockposm.setPosMove(blockpos, blockmodelrenderer$neighborinfo.corners[3], directionIn);
            boolean flag3 = worldIn.getBlockState(blockposm).getOpacity(worldIn, blockposm) == 0;
            float f4;
            int i1;
            ...
            {
                blockposm.setPosMove(blockpos, blockmodelrenderer$neighborinfo.corners[0], blockmodelrenderer$neighborinfo.corners[2]);
                BlockState blockstate4 = worldIn.getBlockState(blockposm);
                f4 = LightCacheOF.getBrightness(blockstate4, worldIn, blockposm);
                i1 = LightCacheOF.getPackedLight(blockstate4, worldIn, blockposm);
            }
            ...
            {
                blockposm.setPosMove(blockpos, blockmodelrenderer$neighborinfo.corners[0], blockmodelrenderer$neighborinfo.corners[3]);
                BlockState blockstate5 = worldIn.getBlockState(blockposm);
                f26 = LightCacheOF.getBrightness(blockstate5, worldIn, blockposm);
                j1 = LightCacheOF.getPackedLight(blockstate5, worldIn, blockposm);
            }
            ...
            {
                blockposm.setPosMove(blockpos, blockmodelrenderer$neighborinfo.corners[1], blockmodelrenderer$neighborinfo.corners[2]);
                BlockState blockstate6 = worldIn.getBlockState(blockposm);
                f27 = LightCacheOF.getBrightness(blockstate6, worldIn, blockposm);
                k1 = LightCacheOF.getPackedLight(blockstate6, worldIn, blockposm);
            }
            ...
            {
                blockposm.setPosMove(blockpos, blockmodelrenderer$neighborinfo.corners[1], blockmodelrenderer$neighborinfo.corners[3]);
                BlockState blockstate7 = worldIn.getBlockState(blockposm);
                f28 = LightCacheOF.getBrightness(blockstate7, worldIn, blockposm);
                l1 = LightCacheOF.getPackedLight(blockstate7, worldIn, blockposm);
            }

            int i3 = LightCacheOF.getPackedLight(state, worldIn, centerPos);
            blockposm.setPosMove(centerPos, directionIn);
            BlockState blockstate8 = worldIn.getBlockState(blockposm);

            if (shapeState.get(0) || !blockstate8.isOpaqueCube(worldIn, blockposm))
            {
                i3 = LightCacheOF.getPackedLight(blockstate8, worldIn, blockposm);
            }

            float f5 = shapeState.get(0) ? LightCacheOF.getBrightness(worldIn.getBlockState(blockpos), worldIn, blockpos) : LightCacheOF.getBrightness(worldIn.getBlockState(centerPos), worldIn, centerPos);
            ...
            if (shapeState.get(1) && blockmodelrenderer$neighborinfo.doNonCubicWeight)
            {
                ...
                float f10 = faceShape[blockmodelrenderer$neighborinfo.vert0Weights[0].shape] * faceShape[blockmodelrenderer$neighborinfo.vert0Weights[1].shape];
                float f11 = faceShape[blockmodelrenderer$neighborinfo.vert0Weights[2].shape] * faceShape[blockmodelrenderer$neighborinfo.vert0Weights[3].shape];
                float f12 = faceShape[blockmodelrenderer$neighborinfo.vert0Weights[4].shape] * faceShape[blockmodelrenderer$neighborinfo.vert0Weights[5].shape];
                float f13 = faceShape[blockmodelrenderer$neighborinfo.vert0Weights[6].shape] * faceShape[blockmodelrenderer$neighborinfo.vert0Weights[7].shape];
                float f14 = faceShape[blockmodelrenderer$neighborinfo.vert1Weights[0].shape] * faceShape[blockmodelrenderer$neighborinfo.vert1Weights[1].shape];
                float f15 = faceShape[blockmodelrenderer$neighborinfo.vert1Weights[2].shape] * faceShape[blockmodelrenderer$neighborinfo.vert1Weights[3].shape];
                float f16 = faceShape[blockmodelrenderer$neighborinfo.vert1Weights[4].shape] * faceShape[blockmodelrenderer$neighborinfo.vert1Weights[5].shape];
                float f17 = faceShape[blockmodelrenderer$neighborinfo.vert1Weights[6].shape] * faceShape[blockmodelrenderer$neighborinfo.vert1Weights[7].shape];
                float f18 = faceShape[blockmodelrenderer$neighborinfo.vert2Weights[0].shape] * faceShape[blockmodelrenderer$neighborinfo.vert2Weights[1].shape];
                float f19 = faceShape[blockmodelrenderer$neighborinfo.vert2Weights[2].shape] * faceShape[blockmodelrenderer$neighborinfo.vert2Weights[3].shape];
                float f20 = faceShape[blockmodelrenderer$neighborinfo.vert2Weights[4].shape] * faceShape[blockmodelrenderer$neighborinfo.vert2Weights[5].shape];
                float f21 = faceShape[blockmodelrenderer$neighborinfo.vert2Weights[6].shape] * faceShape[blockmodelrenderer$neighborinfo.vert2Weights[7].shape];
                float f22 = faceShape[blockmodelrenderer$neighborinfo.vert3Weights[0].shape] * faceShape[blockmodelrenderer$neighborinfo.vert3Weights[1].shape];
                float f23 = faceShape[blockmodelrenderer$neighborinfo.vert3Weights[2].shape] * faceShape[blockmodelrenderer$neighborinfo.vert3Weights[3].shape];
                float f24 = faceShape[blockmodelrenderer$neighborinfo.vert3Weights[4].shape] * faceShape[blockmodelrenderer$neighborinfo.vert3Weights[5].shape];
                float f25 = faceShape[blockmodelrenderer$neighborinfo.vert3Weights[6].shape] * faceShape[blockmodelrenderer$neighborinfo.vert3Weights[7].shape];
    ...
    public static enum NeighborInfo
    {
        ...
        private NeighborInfo(Direction[] p_i159_3_, float p_i159_4_, boolean p_i159_5_, BlockModelRenderer.Orientation[] p_i159_6_, BlockModelRenderer.Orientation[] p_i159_7_, BlockModelRenderer.Orientation[] p_i159_8_, BlockModelRenderer.Orientation[] p_i159_9_)
        {
            this.corners = p_i159_3_;
            this.doNonCubicWeight = p_i159_5_;
            this.vert0Weights = p_i159_6_;
            this.vert1Weights = p_i159_7_;
            this.vert2Weights = p_i159_8_;
            this.vert3Weights = p_i159_9_;
        }
    ...
    public static enum Orientation
    {
        ...
        private Orientation(Direction p_i143_3_, boolean p_i143_4_)
        {
            this.shape = p_i143_3_.getIndex() + (p_i143_4_ ? Direction.values().length : 0);
        }
    }
    ...
    static enum VertexTranslations
    {
        ...
        private VertexTranslations(int p_i101_3_, int p_i101_4_, int p_i101_5_, int p_i101_6_)
        {
            this.vert0 = p_i101_3_;
            this.vert1 = p_i101_4_;
            this.vert2 = p_i101_5_;
            this.vert3 = p_i101_6_;
        }
