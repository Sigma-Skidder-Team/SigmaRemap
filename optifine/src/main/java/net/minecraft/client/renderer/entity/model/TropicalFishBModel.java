...
public class TropicalFishBModel<T extends Entity> extends AbstractTropicalFishModel<T>
{
    ...
    public TropicalFishBModel(float p_i292_1_)
    {
        this.textureWidth = 32;
        this.textureHeight = 32;
        int i = 19;
        this.body = new ModelRenderer(this, 0, 20);
        this.body.addBox(-1.0F, -3.0F, -3.0F, 2.0F, 6.0F, 6.0F, p_i292_1_);
        this.body.setRotationPoint(0.0F, 19.0F, 0.0F);
        this.tail = new ModelRenderer(this, 21, 16);
        this.tail.addBox(0.0F, -3.0F, 0.0F, 0.0F, 6.0F, 5.0F, p_i292_1_);
        this.tail.setRotationPoint(0.0F, 19.0F, 3.0F);
        this.finRight = new ModelRenderer(this, 2, 16);
        this.finRight.addBox(-2.0F, 0.0F, 0.0F, 2.0F, 2.0F, 0.0F, p_i292_1_);
        ...
        this.finLeft.addBox(0.0F, 0.0F, 0.0F, 2.0F, 2.0F, 0.0F, p_i292_1_);
        ...
        this.finTop.addBox(0.0F, -4.0F, 0.0F, 0.0F, 4.0F, 6.0F, p_i292_1_);
        this.finTop.setRotationPoint(0.0F, 16.0F, -3.0F);
        this.finBottom = new ModelRenderer(this, 20, 21);
        this.finBottom.addBox(0.0F, 0.0F, 0.0F, 0.0F, 4.0F, 6.0F, p_i292_1_);
