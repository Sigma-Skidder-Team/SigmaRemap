...
public class SimpleTexture extends Texture
{
    ...
    public SimpleTexture(ResourceLocation p_i167_1_)
    {
        this.textureLocation = p_i167_1_;
    }
    ...
    public static class TextureData implements Closeable
    {
        ...
        public TextureData(IOException p_i8_1_)
        {
            this.exception = p_i8_1_;
            this.metadata = null;
            this.nativeImage = null;
        }

        public TextureData(@Nullable TextureMetadataSection p_i9_1_, NativeImage p_i9_2_)
        {
            this.exception = null;
            this.metadata = p_i9_1_;
            this.nativeImage = p_i9_2_;
        }
        ...
        public static SimpleTexture.TextureData getTextureData(IResourceManager resourceManagerIn, ResourceLocation locationIn)
        {
            try (IResource iresource = resourceManagerIn.getResource(locationIn))
            {
                ...
                SimpleTexture.TextureData simpletexture$texturedata = new SimpleTexture.TextureData(texturemetadatasection, nativeimage);
