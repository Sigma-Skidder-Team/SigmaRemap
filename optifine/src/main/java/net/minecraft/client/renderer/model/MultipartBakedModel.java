...
public class MultipartBakedModel implements IBakedModel
{
    ...
    public MultipartBakedModel(List<Pair<Predicate<BlockState>, IBakedModel>> p_i2197_1_)
    {
        this.selectors = p_i2197_1_;
        IBakedModel ibakedmodel = p_i2197_1_.iterator().next().getRight();
