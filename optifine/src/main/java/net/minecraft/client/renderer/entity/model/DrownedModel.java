...
{
    public DrownedModel(float p_i382_1_, float p_i382_2_, int p_i382_3_, int p_i382_4_)
    {
        super(p_i382_1_, p_i382_2_, p_i382_3_, p_i382_4_);
        this.bipedRightArm = new ModelRenderer(this, 32, 48);
        this.bipedRightArm.addBox(-3.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, p_i382_1_);
        this.bipedRightArm.setRotationPoint(-5.0F, 2.0F + p_i382_2_, 0.0F);
        this.bipedRightLeg = new ModelRenderer(this, 16, 48);
        this.bipedRightLeg.addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, p_i382_1_);
        this.bipedRightLeg.setRotationPoint(-1.9F, 12.0F + p_i382_2_, 0.0F);
    }

    public DrownedModel(float p_i383_1_, boolean p_i383_2_)
    {
        super(p_i383_1_, 0.0F, 64, p_i383_2_ ? 32 : 64);
    }
