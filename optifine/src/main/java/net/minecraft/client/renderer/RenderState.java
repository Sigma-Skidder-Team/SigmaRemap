...
public abstract class RenderState
{
    ...
    public RenderState(String p_i108_1_, Runnable p_i108_2_, Runnable p_i108_3_)
    {
        this.name = p_i108_1_;
        this.setupTask = p_i108_2_;
        this.clearTask = p_i108_3_;
    }
    ...
    public static class AlphaState extends RenderState
    {
        ...
        public AlphaState(float p_i198_1_)
        {
            super("alpha", () ->
            {
                if (p_i198_1_ > 0.0F)
                {
                    ...
                    RenderSystem.alphaFunc(516, p_i198_1_);
                }
                else {
    ...
    static class BooleanState extends RenderState
    {
        ...
        public BooleanState(String p_i126_1_, Runnable p_i126_2_, Runnable p_i126_3_, boolean p_i126_4_)
        {
            super(p_i126_1_, p_i126_2_, p_i126_3_);
            this.enabled = p_i126_4_;
        }
    ...
    {
        public CullState(boolean p_i19_1_)
        {
            super("cull", () ->
            {
                if (p_i19_1_)
    ...
    public static class DepthTestState extends RenderState
    {
        ...
        public DepthTestState(int p_i52_1_)
        {
            super("depth_test", () ->
            {
                if (p_i52_1_ != 519)
                {
                    ...
                    RenderSystem.depthFunc(p_i52_1_);
                }
            }, () ->
            {
                if (p_i52_1_ != 519)
    ...
    {
        public DiffuseLightingState(boolean p_i124_1_)
        {
    ...
    {
        public FogState(String p_i18_1_, Runnable p_i18_2_, Runnable p_i18_3_)
        {
            super(p_i18_1_, p_i18_2_, p_i18_3_);
        }
    }

    public static class LayerState extends RenderState
    {
        public LayerState(String p_i210_1_, Runnable p_i210_2_, Runnable p_i210_3_)
        {
            super(p_i210_1_, p_i210_2_, p_i210_3_);
        }
    }

    public static class LightmapState extends RenderState.BooleanState
    {
        public LightmapState(boolean p_i222_1_)
        {
            super("lightmap", () ->
            {
                if (p_i222_1_)
    ...
    public static class LineState extends RenderState
    {
        ...
        public LineState(OptionalDouble p_i233_1_)
        {
            super("line_width", () ->
            {
                if (!Objects.equals(p_i233_1_, OptionalDouble.of(1.0D)))
                {
                    if (p_i233_1_.isPresent())
                    {
                        RenderSystem.lineWidth((float)p_i233_1_.getAsDouble());
                    }
                    else
                    {
    ...
    public static final class OffsetTexturingState extends RenderState.TexturingState
    {
        ...
        public OffsetTexturingState(float p_i81_1_, float p_i81_2_)
        {
            super("offset_texturing", () ->
            {
                ...
                RenderSystem.pushMatrix();
                RenderSystem.loadIdentity();
                RenderSystem.translatef(p_i81_1_, p_i81_2_, 0.0F);
                RenderSystem.matrixMode(5888);
            }, () ->
            {
                RenderSystem.matrixMode(5890);
            ...
            this.offsetU = p_i81_1_;
            this.offsetV = p_i81_2_;
        }
    ...
    {
        public OverlayState(boolean p_i181_1_)
        {
            super("overlay", () ->
            {
                if (p_i181_1_)
    ...
    public static final class PortalTexturingState extends RenderState.TexturingState
    {
        ...
        public PortalTexturingState(int p_i25_1_)
        {
    ...
    public static class ShadeModelState extends RenderState
    {
        ...
        public ShadeModelState(boolean p_i226_1_)
        {
            super("shade_model", () ->
            {
                RenderSystem.shadeModel(p_i226_1_ ? 7425 : 7424);
            }, () ->
            {
                RenderSystem.shadeModel(7424);
            });
            this.smooth = p_i226_1_;
        }
    ...
    {
        public TargetState(String p_i36_1_, Runnable p_i36_2_, Runnable p_i36_3_)
        {
            super(p_i36_1_, p_i36_2_, p_i36_3_);
        }
    }
    ...
    public static class TextureState extends RenderState
    {
        ...
        public TextureState(ResourceLocation p_i34_1_, boolean p_i34_2_, boolean p_i34_3_)
        {
            super("texture", () ->
            {
                RenderSystem.enableTexture();
                TextureManager texturemanager = Minecraft.getInstance().getTextureManager();
                texturemanager.bindTexture(p_i34_1_);
                texturemanager.getBoundTexture().setBlurMipmapDirect(p_i34_2_, p_i34_3_);
            }, () ->
            {
            });
            this.texture = Optional.of(p_i34_1_);
            this.blur = p_i34_2_;
            this.mipmap = p_i34_3_;
        }
    ...
    {
        public TexturingState(String p_i261_1_, Runnable p_i261_2_, Runnable p_i261_3_)
        {
            super(p_i261_1_, p_i261_2_, p_i261_3_);
        }
    }

    public static class TransparencyState extends RenderState
    {
        public TransparencyState(String p_i229_1_, Runnable p_i229_2_, Runnable p_i229_3_)
        {
            super(p_i229_1_, p_i229_2_, p_i229_3_);
        }
    }
    ...
    public static class WriteMaskState extends RenderState
    {
        ...
        public WriteMaskState(boolean p_i47_1_, boolean p_i47_2_)
        {
            super("write_mask_state", () ->
            {
                if (!p_i47_2_)
                {
                    RenderSystem.depthMask(p_i47_2_);
                }

                if (!p_i47_1_)
                {
                    RenderSystem.colorMask(p_i47_1_, p_i47_1_, p_i47_1_, p_i47_1_);
                }
            }, () ->
            {
                if (!p_i47_2_)
            ...
            this.colorMask = p_i47_1_;
            this.depthMask = p_i47_2_;
        }
