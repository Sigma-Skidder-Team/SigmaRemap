...
public class GuardianRenderer extends MobRenderer<GuardianEntity, GuardianModel>
{
    ...
    public GuardianRenderer(EntityRendererManager p_i566_1_)
    {
        this(p_i566_1_, 0.5F);
    }

    protected GuardianRenderer(EntityRendererManager p_i567_1_, float p_i567_2_)
    {
        super(p_i567_1_, new GuardianModel(), p_i567_2_);
    }
