...
public class Stitcher
{
    ...
    public Stitcher(int p_i80_1_, int p_i80_2_, int p_i80_3_)
    {
        this.mipmapLevelStitcher = p_i80_3_;
        this.maxWidth = p_i80_1_;
        this.maxHeight = p_i80_2_;
    }
    ...
    public void getStichSlots(Stitcher.ISpriteLoader spriteLoaderIn)
    {
        ...
        {
            stitcher$slot.getAllStitchSlots((p_lambda$getStichSlots$4_2_) ->
            {
                Stitcher.Holder stitcher$holder = p_lambda$getStichSlots$4_2_.getStitchHolder();
                TextureAtlasSprite.Info textureatlassprite$info = stitcher$holder.spriteInfo;
                spriteLoaderIn.load(textureatlassprite$info, this.currentWidth, this.currentHeight, p_lambda$getStichSlots$4_2_.getOriginX(), p_lambda$getStichSlots$4_2_.getOriginY());
            });
        }
    }
    ...
    static class Holder
    {
        ...
        public Holder(TextureAtlasSprite.Info p_i16_1_, int p_i16_2_)
        {
            this.spriteInfo = p_i16_1_;
            this.width = Stitcher.getMipmapDimension(p_i16_1_.getSpriteWidth(), p_i16_2_);
            this.height = Stitcher.getMipmapDimension(p_i16_1_.getSpriteHeight(), p_i16_2_);
        }
    ...
    public static class Slot
    {
        ...
        public Slot(int p_i61_1_, int p_i61_2_, int p_i61_3_, int p_i61_4_)
        {
            this.originX = p_i61_1_;
            this.originY = p_i61_2_;
            this.width = p_i61_3_;
            this.height = p_i61_4_;
        }
