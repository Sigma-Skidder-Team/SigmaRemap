...
public class LightTexture implements AutoCloseable
{
    ...
    public LightTexture(GameRenderer p_i28_1_, Minecraft p_i28_2_)
    {
        this.entityRenderer = p_i28_1_;
        this.client = p_i28_2_;
            ...
            if (clientworld != null)
            {
                ...
                for (int i = 0; i < 16; ++i)
                {
                    for (int j = 0; j < 16; ++j)
                    {
                        ...
                        {
                            Reflector.call(clientworld.getDimension(), Reflector.IForgeDimension_getLightmapColors, partialTicks, f9, f3, f4, vector3f1);
                        }
