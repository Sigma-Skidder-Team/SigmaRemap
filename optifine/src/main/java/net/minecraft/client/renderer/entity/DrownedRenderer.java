...
public class DrownedRenderer extends AbstractZombieRenderer<DrownedEntity, DrownedModel<DrownedEntity>>
{
    ...
    public DrownedRenderer(EntityRendererManager p_i1387_1_)
    {
        super(p_i1387_1_, new DrownedModel<>(0.0F, 0.0F, 64, 64), new DrownedModel<>(0.5F, true), new DrownedModel<>(1.0F, true));
