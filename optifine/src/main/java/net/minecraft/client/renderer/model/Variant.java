...
public class Variant implements IModelTransform
{
    ...
    public Variant(ResourceLocation p_i961_1_, TransformationMatrix p_i961_2_, boolean p_i961_3_, int p_i961_4_)
    {
        this.modelLocation = p_i961_1_;
        this.rotation = p_i961_2_;
        this.uvLock = p_i961_3_;
        this.weight = p_i961_4_;
    }
