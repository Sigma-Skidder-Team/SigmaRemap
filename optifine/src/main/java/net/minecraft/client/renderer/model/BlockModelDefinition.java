...
public class BlockModelDefinition
{
    ...
    public BlockModelDefinition(Map<String, VariantList> p_i2313_1_, Multipart p_i2313_2_)
    {
        this.multipart = p_i2313_2_;
        this.mapVariants.putAll(p_i2313_1_);
    }

    public BlockModelDefinition(List<BlockModelDefinition> p_i2314_1_)
    {
        BlockModelDefinition blockmodeldefinition = null;

        for (BlockModelDefinition blockmodeldefinition1 : p_i2314_1_)
        {
