...
public class PngSizeInfo
{
    ...
    public PngSizeInfo(String p_i110_1_, InputStream p_i110_2_) throws IOException
    {
        synchronized (STATIC_MONITOR)
        {
            try (
                    MemoryStack memorystack = MemoryStack.stackPush();
                    PngSizeInfo.Reader pngsizeinfo$reader = func_195695_a(p_i110_2_);
                ...
                )
            {
                ...
                {
                    throw new IOException("Could not read info from the PNG file " + p_i110_1_ + " " + STBImage.stbi_failure_reason());
                }
    ...
    static class ReaderBuffer extends PngSizeInfo.Reader
    {
        ...
        private ReaderBuffer(ReadableByteChannel p_i75_1_)
        {
            this.channel = p_i75_1_;
        }
    ...
    static class ReaderSeekable extends PngSizeInfo.Reader
    {
        ...
        private ReaderSeekable(SeekableByteChannel p_i105_1_)
        {
            this.channel = p_i105_1_;
        }
