...
public final class MissingTextureSprite extends TextureAtlasSprite
{
    ...
    public MissingTextureSprite(AtlasTexture p_i206_1_, TextureAtlasSprite.Info p_i206_2_, int p_i206_3_, int p_i206_4_, int p_i206_5_, int p_i206_6_, int p_i206_7_)
    {
        super(p_i206_1_, p_i206_2_, p_i206_3_, p_i206_4_, p_i206_5_, p_i206_6_, p_i206_7_, makeMissingImage(p_i206_2_.getSpriteWidth(), p_i206_2_.getSpriteHeight()));
    }

    private MissingTextureSprite(AtlasTexture p_i207_1_, int p_i207_2_, int p_i207_3_, int p_i207_4_, int p_i207_5_, int p_i207_6_)
    {
        super(p_i207_1_, spriteInfo, p_i207_2_, p_i207_3_, p_i207_4_, p_i207_5_, p_i207_6_, IMAGE.getValue());
    }
