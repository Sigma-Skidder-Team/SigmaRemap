...
public class ChunkInfoDebugRenderer implements DebugRenderer.IDebugRenderer
{
    ...
    public ChunkInfoDebugRenderer(Minecraft animal)
    {
        this.client = animal;
    }
    ...
    final class Entry
    {
        ...
        private Entry(IntegratedServer p_i2479_2_, double p_i2479_3_, double p_i2479_5_)
        {
            ...
            if (p_i2479_2_.getWorld(dimensiontype) != null)
            {
                serverworld = p_i2479_2_.getWorld(dimensiontype);
            }
            else
            {
                serverworld = null;
            ...
            int i = (int)p_i2479_3_ >> 4;
            int j = (int)p_i2479_5_ >> 4;
            ...
            this.field_217722_c = p_i2479_2_.supplyAsync(() ->
            {
