...
public final class NativeImage implements AutoCloseable
{
    ...
    public NativeImage(int p_i199_1_, int p_i199_2_, boolean p_i199_3_)
    {
        this(NativeImage.PixelFormat.RGBA, p_i199_1_, p_i199_2_, p_i199_3_);
    }

    public NativeImage(NativeImage.PixelFormat p_i200_1_, int p_i200_2_, int p_i200_3_, boolean p_i200_4_)
    {
        this.pixelFormat = p_i200_1_;
        this.width = p_i200_2_;
        this.height = p_i200_3_;
        this.size = (long)p_i200_2_ * (long)p_i200_3_ * (long)p_i200_1_.getPixelSize();
    ...
    private NativeImage(NativeImage.PixelFormat p_i201_1_, int p_i201_2_, int p_i201_3_, boolean p_i201_4_, long p_i201_5_)
    {
        this.pixelFormat = p_i201_1_;
        this.width = p_i201_2_;
        this.height = p_i201_3_;
        this.stbiPointer = p_i201_4_;
        this.imagePointer = p_i201_5_;
        this.size = (long)(p_i201_2_ * p_i201_3_ * p_i201_1_.getPixelSize());
    }
    ...
    public static enum PixelFormat
    {
        ...
        private PixelFormat(int p_i136_3_, int p_i136_4_, boolean p_i136_5_, boolean p_i136_6_, boolean p_i136_7_, boolean p_i136_8_, boolean p_i136_9_, int p_i136_10_, int p_i136_11_, int p_i136_12_, int p_i136_13_, int p_i136_14_, boolean p_i136_15_)
        {
            this.pixelSize = p_i136_3_;
            this.glFormat = p_i136_4_;
            this.red = p_i136_5_;
            this.green = p_i136_6_;
            this.blue = p_i136_7_;
            this.hasLuminance = p_i136_8_;
            this.hasAlpha = p_i136_9_;
            this.offsetRed = p_i136_10_;
            this.offsetGreen = p_i136_11_;
            this.offsetBlue = p_i136_12_;
            this.offsetLuminance = p_i136_13_;
            this.offsetAlpha = p_i136_14_;
            this.serializable = p_i136_15_;
        }
    ...
    public static enum PixelFormatGLCode
    {
        ...
        private PixelFormatGLCode(int p_i249_3_)
        {
            this.glConstant = p_i249_3_;
        }
    ...
    static class WriteCallback extends STBIWriteCallback
    {
        ...
        private WriteCallback(WritableByteChannel p_i220_1_)
        {
            this.channel = p_i220_1_;
        }
