...
public class TextureAtlasSprite implements AutoCloseable, IForgeTextureAtlasSprite
{
    ...
    public TextureAtlasSprite(ResourceLocation p_i168_1_)
    {
        this.atlasTexture = null;
        this.spriteInfo = new TextureAtlasSprite.Info(p_i168_1_, 0, 0, (AnimationMetadataSection)null);
    ...
    private TextureAtlasSprite(TextureAtlasSprite p_i169_1_)
    {
        this.atlasTexture = p_i169_1_.atlasTexture;
        TextureAtlasSprite.Info textureatlassprite$info = p_i169_1_.spriteInfo;
        ...
        this.animationMetadata = p_i169_1_.animationMetadata;
        this.frames = p_i169_1_.frames;
        this.framesX = p_i169_1_.framesX;
        this.framesY = p_i169_1_.framesY;
        this.interpolationData = p_i169_1_.interpolationData;
        this.x = 0;
        this.y = 0;
        this.minU = 0.0F;
        this.maxU = 1.0F;
        this.minV = 0.0F;
        this.maxV = 1.0F;
        this.frameCounter = p_i169_1_.frameCounter;
        this.tickCounter = p_i169_1_.tickCounter;
        this.indexInMap = p_i169_1_.indexInMap;
        this.baseU = p_i169_1_.baseU;
        this.baseV = p_i169_1_.baseV;
        this.sheetWidth = p_i169_1_.sheetWidth;
        this.sheetHeight = p_i169_1_.sheetHeight;
        this.isSpriteSingle = true;
        this.mipmapLevels = p_i169_1_.mipmapLevels;
        this.animationIndex = p_i169_1_.animationIndex;
        this.animationActive = p_i169_1_.animationActive;
    }

    protected TextureAtlasSprite(AtlasTexture p_i170_1_, TextureAtlasSprite.Info p_i170_2_, int p_i170_3_, int p_i170_4_, int p_i170_5_, int p_i170_6_, int p_i170_7_, NativeImage p_i170_8_)
    {
        this.atlasTexture = p_i170_1_;
        AnimationMetadataSection animationmetadatasection = p_i170_2_.spriteAnimationMetadata;
        int i = p_i170_2_.spriteWidth;
        int j = p_i170_2_.spriteHeight;
        this.x = p_i170_6_;
        this.y = p_i170_7_;
        this.minU = (float)p_i170_6_ / (float)p_i170_4_;
        this.maxU = (float)(p_i170_6_ + i) / (float)p_i170_4_;
        this.minV = (float)p_i170_7_ / (float)p_i170_5_;
        this.maxV = (float)(p_i170_7_ + j) / (float)p_i170_5_;

        if (p_i170_2_.scaleFactor > 1.0D)
        {
            int k = (int)Math.round((double)p_i170_8_.getWidth() * p_i170_2_.scaleFactor);
            NativeImage nativeimage = TextureUtils.scaleImage(p_i170_8_, k);

            if (nativeimage != p_i170_8_)
            {
                p_i170_8_.close();
                p_i170_8_ = nativeimage;
            }
        }

        if (!this.isSpriteShaders && !p_i170_2_.getSpriteLocation().getPath().endsWith("_leaves"))
        {
            this.fixTransparentColor(p_i170_8_);
        }

        NativeImage nativeimage1 = p_i170_8_;
        int i2 = p_i170_8_.getWidth() / animationmetadatasection.getFrameWidth(i);
        int l = p_i170_8_.getHeight() / animationmetadatasection.getFrameHeight(j);
        ...
        this.spriteInfo = new TextureAtlasSprite.Info(p_i170_2_.spriteLocation, i, j, animationmetadatasection);
        ...
        try
        {
            try
            {
                this.frames = MipmapGenerator.generateMipmaps(p_i170_8_, p_i170_3_);
            }
        ...
        catch (Throwable throwable11)
        {
            ...
            crashreportcategory.addDetail("Mipmap levels", p_i170_3_);
            throw new ReportedException(crashreport);
        }

        if (animationmetadatasection.isInterpolate())
        {
            this.interpolationData = new TextureAtlasSprite.InterpolationData(p_i170_2_, p_i170_3_);
        }
        else
        {
            this.interpolationData = null;
        ...
        this.mipmapLevels = p_i170_3_;
        this.baseU = Math.min(this.minU, this.maxU);
        this.baseV = Math.min(this.minV, this.maxV);
        this.sheetWidth = p_i170_4_;
        this.sheetHeight = p_i170_5_;
    }
            ...
            try (IResource iresource = this.resourceManager.getResource(resourcelocation1))
            {
                ...
                if (nativeimage.getWidth() != this.getWidth())
                {
                    ...
                    if (nativeimage1 != nativeimage)
                    {
                        ...
                        textureatlassprite$info = new TextureAtlasSprite.Info(resourcelocation, (int)((double)pair.getFirst() * d0), (int)((double)pair.getSecond() * d0), animationmetadatasection);
                    }
                }
    ...
    public static final class Info
    {
        ...
        public Info(ResourceLocation p_i118_1_, int p_i118_2_, int p_i118_3_, AnimationMetadataSection p_i118_4_)
        {
            this.spriteLocation = p_i118_1_;
            this.spriteWidth = p_i118_2_;
            this.spriteHeight = p_i118_3_;
            this.spriteAnimationMetadata = p_i118_4_;
        }
    ...
    final class InterpolationData implements AutoCloseable
    {
        ...
        private InterpolationData(TextureAtlasSprite.Info p_i97_2_, int p_i97_3_)
        {
            this.images = new NativeImage[p_i97_3_ + 1];

            for (int i = 0; i < this.images.length; ++i)
            {
                int j = p_i97_2_.spriteWidth >> i;
                int k = p_i97_2_.spriteHeight >> i;
