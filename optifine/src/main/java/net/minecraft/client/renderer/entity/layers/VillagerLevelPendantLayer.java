...
public class VillagerLevelPendantLayer<T extends LivingEntity & IVillagerDataHolder, M extends EntityModel<T> & IHeadToggle> extends LayerRenderer<T, M> implements IResourceManagerReloadListener
{
    ...
    public VillagerLevelPendantLayer(IEntityRenderer<T, M> p_i1263_1_, IReloadableResourceManager p_i1263_2_, String p_i1263_3_)
    {
        super(p_i1263_1_);
        this.field_215355_d = p_i1263_2_;
        this.field_215356_e = p_i1263_3_;
        p_i1263_2_.addReloadListener(this);
    }
