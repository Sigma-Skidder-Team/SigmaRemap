...
public class EntityAIDebugRenderer implements DebugRenderer.IDebugRenderer
{
    ...
    public EntityAIDebugRenderer(Minecraft p_i3841_1_)
    {
        this.client = p_i3841_1_;
    }
    ...
    public static class Entry
    {
        ...
        public Entry(BlockPos p_i3611_1_, int p_i3611_2_, String p_i3611_3_, boolean p_i3611_4_)
        {
            this.field_217723_a = p_i3611_1_;
            this.field_217724_b = p_i3611_2_;
            this.field_217725_c = p_i3611_3_;
            this.field_217726_d = p_i3611_4_;
        }
    }
}
