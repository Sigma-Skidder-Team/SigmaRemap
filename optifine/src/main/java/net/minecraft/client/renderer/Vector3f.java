...
public final class Vector3f
{
    ...
    public Vector3f(float p_i2533_1_, float p_i2533_2_, float p_i2533_3_)
    {
        this.x = p_i2533_1_;
        this.y = p_i2533_2_;
        this.z = p_i2533_3_;
    ...
    public Vector3f(Vec3d p_i2534_1_)
    {
        this((float)p_i2534_1_.x, (float)p_i2534_1_.y, (float)p_i2534_1_.z);
    }
