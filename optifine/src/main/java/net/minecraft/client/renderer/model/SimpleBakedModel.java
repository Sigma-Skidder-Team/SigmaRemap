...
public class SimpleBakedModel implements IBakedModel
{
    ...
    public SimpleBakedModel(List<BakedQuad> p_i2009_1_, Map<Direction, List<BakedQuad>> p_i2009_2_, boolean p_i2009_3_, boolean p_i2009_4_, boolean p_i2009_5_, TextureAtlasSprite p_i2009_6_, ItemCameraTransforms p_i2009_7_, ItemOverrideList p_i2009_8_)
    {
        this.generalQuads = p_i2009_1_;
        this.faceQuads = p_i2009_2_;
        this.ambientOcclusion = p_i2009_3_;
        this.gui3d = p_i2009_5_;
        this.field_230186_e_ = p_i2009_4_;
        this.texture = p_i2009_6_;
        this.cameraTransforms = p_i2009_7_;
        this.itemOverrideList = p_i2009_8_;
    }
    ...
    public static class Builder
    {
        ...
        public Builder(BlockModel p_i909_1_, ItemOverrideList p_i909_2_, boolean p_i909_3_)
        {
            this(p_i909_1_.isAmbientOcclusion(), p_i909_1_.func_230176_c_().func_230178_a_(), p_i909_3_, p_i909_1_.getAllTransforms(), p_i909_2_);
        }

        private Builder(boolean p_i910_1_, boolean p_i910_2_, boolean p_i910_3_, ItemCameraTransforms p_i910_4_, ItemOverrideList p_i910_5_)
        {
            ...
            this.builderItemOverrideList = p_i910_5_;
            this.builderAmbientOcclusion = p_i910_1_;
            this.field_230187_f_ = p_i910_2_;
            this.builderGui3d = p_i910_3_;
            this.builderCameraTransforms = p_i910_4_;
        }
