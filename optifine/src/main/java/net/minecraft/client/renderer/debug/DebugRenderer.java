...
public class DebugRenderer
{
    ...
    public DebugRenderer(Minecraft p_i678_1_)
    {
        this.water = new WaterDebugRenderer(p_i678_1_);
        this.chunkBorder = new ChunkBorderDebugRenderer(p_i678_1_);
        this.heightMap = new HeightMapDebugRenderer(p_i678_1_);
        this.collisionBox = new CollisionBoxDebugRenderer(p_i678_1_);
        this.neighborsUpdate = new NeighborsUpdateDebugRenderer(p_i678_1_);
        this.cave = new CaveDebugRenderer();
        this.structure = new StructureDebugRenderer(p_i678_1_);
        this.light = new LightDebugRenderer(p_i678_1_);
        this.worldGenAttempts = new WorldGenAttemptsDebugRenderer();
        this.solidFace = new SolidFaceDebugRenderer(p_i678_1_);
        this.field_217740_l = new ChunkInfoDebugRenderer(p_i678_1_);
        this.field_217741_m = new PointOfInterestDebugRenderer(p_i678_1_);
        this.field_229017_n_ = new BeeDebugRenderer(p_i678_1_);
        this.field_222927_n = new RaidDebugRenderer(p_i678_1_);
        this.field_217742_n = new EntityAIDebugRenderer(p_i678_1_);
