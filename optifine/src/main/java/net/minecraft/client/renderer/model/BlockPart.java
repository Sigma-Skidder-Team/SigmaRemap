...
public class BlockPart
{
    ...
    public BlockPart(Vector3f p_i3383_1_, Vector3f p_i3383_2_, Map<Direction, BlockPartFace> p_i3383_3_, @Nullable BlockPartRotation p_i3383_4_, boolean p_i3383_5_)
    {
        this.positionFrom = p_i3383_1_;
        this.positionTo = p_i3383_2_;
        this.mapFaces = p_i3383_3_;
        this.partRotation = p_i3383_4_;
        this.shade = p_i3383_5_;
        this.setDefaultUvs();
    }
