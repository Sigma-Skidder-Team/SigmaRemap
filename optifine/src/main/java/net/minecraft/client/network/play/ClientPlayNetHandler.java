...
public class ClientPlayNetHandler implements IClientPlayNetHandler
{
    ...
    public ClientPlayNetHandler(Minecraft p_i1821_1_, Screen p_i1821_2_, NetworkManager p_i1821_3_, GameProfile p_i1821_4_)
    {
        this.client = p_i1821_1_;
        this.guiScreenServer = p_i1821_2_;
        this.netManager = p_i1821_3_;
        this.profile = p_i1821_4_;
        this.advancementManager = new ClientAdvancementManager(p_i1821_1_);
        this.clientSuggestionProvider = new ClientSuggestionProvider(this, p_i1821_1_);
    }
