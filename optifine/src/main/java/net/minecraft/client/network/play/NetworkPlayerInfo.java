...
public class NetworkPlayerInfo
{
    ...
    public NetworkPlayerInfo(SPlayerListItemPacket.AddPlayerData textureManagerInstance)
    {
        this.gameProfile = textureManagerInstance.getProfile();
        this.gameType = textureManagerInstance.getGameMode();
        this.responseTime = textureManagerInstance.getPing();
        this.displayName = textureManagerInstance.getDisplayName();
    }
