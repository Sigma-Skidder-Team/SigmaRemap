...
public final class MainWindow implements AutoCloseable
{
    ...
    public MainWindow(IWindowEventListener p_i187_1_, MonitorHandler p_i187_2_, ScreenSize p_i187_3_, @Nullable String p_i187_4_, String p_i187_5_)
    {
        RenderSystem.assertThread(RenderSystem::isInInitPhase);
        this.monitorHandler = p_i187_2_;
        this.setThrowExceptionOnGlError();
        this.setRenderPhase("Pre startup");
        this.mc = p_i187_1_;
        Optional<VideoMode> optional = VideoMode.parseFromSettings(p_i187_4_);

        if (optional.isPresent())
        {
            this.videoMode = optional;
        }
        else if (p_i187_3_.fullscreenWidth.isPresent() && p_i187_3_.fullscreenHeight.isPresent())
        {
            this.videoMode = Optional.of(new VideoMode(p_i187_3_.fullscreenWidth.getAsInt(), p_i187_3_.fullscreenHeight.getAsInt(), 8, 8, 8, 60));
        }
        else
        {
        ...
        this.lastFullscreen = this.fullscreen = p_i187_3_.fullscreen;
        Monitor monitor = p_i187_2_.getMonitor(GLFW.glfwGetPrimaryMonitor());
        this.prevWindowWidth = this.width = p_i187_3_.width > 0 ? p_i187_3_.width : 1;
        this.prevWindowHeight = this.height = p_i187_3_.height > 0 ? p_i187_3_.height : 1;
        ...
        {
            this.handle = GLFW.glfwCreateWindow(this.width, this.height, p_i187_5_, this.fullscreen && monitor != null ? monitor.getMonitorPointer() : 0L, 0L);
        }
    ...
    {
        private GlException(String p_i70_1_)
        {
            super(p_i70_1_);
        }
    }
