...
public class FontTexture extends Texture implements Closeable
{
    ...
    public FontTexture(ResourceLocation p_i772_1_, boolean p_i772_2_)
    {
        this.textureLocation = p_i772_1_;
        this.colored = p_i772_2_;
        this.entry = new FontTexture.Entry(0, 0, 256, 256);
        TextureUtil.prepareImage(p_i772_2_ ? NativeImage.PixelFormatGLCode.RGBA : NativeImage.PixelFormatGLCode.INTENSITY, this.getGlTextureId(), 256, 256);
        this.field_228158_e_ = RenderType.getText(p_i772_1_);
        this.field_228159_f_ = RenderType.getTextSeeThrough(p_i772_1_);
    }
    ...
    static class Entry
    {
        ...
        private Entry(int p_i3599_1_, int p_i3599_2_, int p_i3599_3_, int p_i3599_4_)
        {
            this.xOffset = p_i3599_1_;
            this.yOffset = p_i3599_2_;
            this.field_211227_c = p_i3599_3_;
            this.field_211228_d = p_i3599_4_;
        }
