...
public enum GlyphProviderTypes
{
    ...
    private GlyphProviderTypes(String p_i3614_3_, Function<JsonObject, IGlyphProviderFactory> p_i3614_4_)
    {
        this.name = p_i3614_3_;
        this.factoryDeserializer = p_i3614_4_;
    }
