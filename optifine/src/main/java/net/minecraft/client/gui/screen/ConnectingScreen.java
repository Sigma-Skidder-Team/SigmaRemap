...
public class ConnectingScreen extends Screen
{
    ...
    public ConnectingScreen(Screen p_i3844_1_, Minecraft p_i3844_2_, ServerData p_i3844_3_)
    {
        super(NarratorChatListener.EMPTY);
        this.minecraft = p_i3844_2_;
        this.previousGuiScreen = p_i3844_1_;
        ServerAddress serveraddress = ServerAddress.fromString(p_i3844_3_.serverIP);
        p_i3844_2_.unloadWorld();
        p_i3844_2_.setServerData(p_i3844_3_);
        this.connect(serveraddress.getIP(), serveraddress.getPort());
    }

    public ConnectingScreen(Screen p_i3845_1_, Minecraft p_i3845_2_, String p_i3845_3_, int p_i3845_4_)
    {
        super(NarratorChatListener.EMPTY);
        this.minecraft = p_i3845_2_;
        this.previousGuiScreen = p_i3845_1_;
        p_i3845_2_.unloadWorld();
        this.connect(p_i3845_3_, p_i3845_4_);
    }
