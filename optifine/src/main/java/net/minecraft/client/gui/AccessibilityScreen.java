...
public class AccessibilityScreen extends SettingsScreen
{
    ...
    public AccessibilityScreen(Screen p_i1221_1_, GameSettings p_i1221_2_)
    {
        super(p_i1221_1_, p_i1221_2_, new TranslationTextComponent("options.accessibility.title"));
    }
