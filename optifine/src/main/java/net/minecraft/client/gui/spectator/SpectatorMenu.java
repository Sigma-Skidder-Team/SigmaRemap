...
public class SpectatorMenu
{
    ...
    public SpectatorMenu(ISpectatorMenuRecipient p_i652_1_)
    {
        this.category = new BaseSpectatorGroup();
        this.listener = p_i652_1_;
    }
    ...
    static class MoveMenuObject implements ISpectatorMenuObject
    {
        ...
        public MoveMenuObject(int p_i1742_1_, boolean p_i1742_2_)
        {
            this.direction = p_i1742_1_;
            this.enabled = p_i1742_2_;
        }
