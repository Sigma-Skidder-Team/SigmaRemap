...
public class TutorialToast implements IToast
{
    ...
    public TutorialToast(TutorialToast.Icons p_i2049_1_, ITextComponent p_i2049_2_, @Nullable ITextComponent p_i2049_3_, boolean p_i2049_4_)
    {
        this.icon = p_i2049_1_;
        this.title = p_i2049_2_.getFormattedText();
        this.subtitle = p_i2049_3_ == null ? null : p_i2049_3_.getFormattedText();
        this.hasProgressBar = p_i2049_4_;
    }
    ...
    public static enum Icons
    {
        ...
        private Icons(int p_i3735_3_, int p_i3735_4_)
        {
            this.column = p_i3735_3_;
            this.row = p_i3735_4_;
        }
