...
public class UnicodeTextureGlyphProvider implements IGlyphProvider
{
    ...
    public UnicodeTextureGlyphProvider(IResourceManager p_i1982_1_, byte[] p_i1982_2_, String p_i1982_3_)
    {
        this.resourceManager = p_i1982_1_;
        this.sizes = p_i1982_2_;
        this.template = p_i1982_3_;
        label322:
        ...
        for (int i = 0; i < 256; ++i)
        {
            ...
            Arrays.fill(p_i1982_2_, c0, c0 + 256, (byte)0);
        }
    }
    ...
    public static class Factory implements IGlyphProviderFactory
    {
        ...
        public Factory(ResourceLocation server, String p_i1503_2_)
        {
            this.sizes = server;
            this.template = p_i1503_2_;
        }
    ...
    static class GlpyhInfo implements IGlyphInfo
    {
        ...
        private GlpyhInfo(int p_i699_1_, int p_i699_2_, int p_i699_3_, int p_i699_4_, NativeImage p_i699_5_)
        {
            this.width = p_i699_3_;
            this.height = p_i699_4_;
            this.unpackSkipPixels = p_i699_1_;
            this.unpackSkipRows = p_i699_2_;
            this.texture = p_i699_5_;
        }
