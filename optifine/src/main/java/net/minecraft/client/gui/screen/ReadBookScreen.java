...
public class ReadBookScreen extends Screen
{
    ...
    public ReadBookScreen(ReadBookScreen.IBookInfo p_i3773_1_)
    {
        this(p_i3773_1_, true);
    }
    ...
    private ReadBookScreen(ReadBookScreen.IBookInfo p_i3774_1_, boolean p_i3774_2_)
    {
        super(NarratorChatListener.EMPTY);
        this.bookInfo = p_i3774_1_;
        this.pageTurnSounds = p_i3774_2_;
    }
    ...
    public static class UnwrittenBookInfo implements ReadBookScreen.IBookInfo
    {
        ...
        public UnwrittenBookInfo(ItemStack p_i1382_1_)
        {
            this.pages = func_216919_b(p_i1382_1_);
        }
    ...
    public static class WrittenBookInfo implements ReadBookScreen.IBookInfo
    {
        ...
        public WrittenBookInfo(ItemStack p_i2947_1_)
        {
            this.pages = func_216921_b(p_i2947_1_);
        }
