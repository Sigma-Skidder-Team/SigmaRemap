...
public class OptimizeWorldScreen extends Screen
{
    ...
    public OptimizeWorldScreen(BooleanConsumer p_i2039_1_, String p_i2039_2_, SaveFormat p_i2039_3_, boolean p_i2039_4_)
    {
        super(new TranslationTextComponent("optimizeWorld.title", p_i2039_3_.getWorldInfo(p_i2039_2_).getWorldName()));
        this.field_214332_b = p_i2039_1_;
        this.optimizer = new WorldOptimizer(p_i2039_2_, p_i2039_3_, p_i2039_3_.getWorldInfo(p_i2039_2_), p_i2039_4_);
    }
