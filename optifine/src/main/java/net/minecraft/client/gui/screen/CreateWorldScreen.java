...
public class CreateWorldScreen extends Screen
{
    ...
    public CreateWorldScreen(Screen p_i1658_1_)
    {
        super(new TranslationTextComponent("selectWorld.create"));
        this.parentScreen = p_i1658_1_;
        this.worldSeed = "";
    ...
    static enum GameMode
    {
        ...
        private GameMode(String p_i1996_3_, GameType p_i1996_4_)
        {
            this.field_228217_e_ = p_i1996_3_;
            this.field_228218_f_ = p_i1996_4_;
        }
    }
}
