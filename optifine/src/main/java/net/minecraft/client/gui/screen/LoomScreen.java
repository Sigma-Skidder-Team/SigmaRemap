...
public class LoomScreen extends ContainerScreen<LoomContainer>
{
    ...
    public LoomScreen(LoomContainer p_i3088_1_, PlayerInventory p_i3088_2_, ITextComponent p_i3088_3_)
    {
        super(p_i3088_1_, p_i3088_2_, p_i3088_3_);
        this.field_228188_m_ = BannerTileEntityRenderer.func_228836_a_();
        p_i3088_1_.func_217020_a(this::func_214111_b);
    }
