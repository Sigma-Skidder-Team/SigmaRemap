...
public class ConfirmBackupScreen extends Screen
{
    ...
    public ConfirmBackupScreen(Screen p_i817_1_, ConfirmBackupScreen.ICallback p_i817_2_, ITextComponent p_i817_3_, ITextComponent p_i817_4_, boolean p_i817_5_)
    {
        super(p_i817_3_);
        this.parentScreen = p_i817_1_;
        this.callback = p_i817_2_;
        this.message = p_i817_4_;
        this.field_212994_d = p_i817_5_;
