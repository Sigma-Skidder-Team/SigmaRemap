...
public class FontRenderer implements AutoCloseable
{
    ...
    public FontRenderer(TextureManager p_i83_1_, Font p_i83_2_)
    {
        this.textureManager = p_i83_1_;
        this.font = p_i83_2_;
    }
    ...
    public void setGlyphProviders(List<IGlyphProvider> gliphProviders)
    {
        ...
        for (IGlyphProvider iglyphprovider : gliphProviders)
        {
            ...
            if (c0 == 167 && i + 1 < text.length())
            {
                ...
                if (textformatting != null)
                {
                    ...
                    if (textformatting.getColor() != null)
                    {
                        ...
                        {
                            j = CustomColors.getTextColor(textformatting.getColorIndex(), j);
                        }
    ...
    {
        return character == 167 ? 0.0F : this.findGlyph(character).getAdvance(false);
    }
    ...
    private IGlyph findGlyph(char p_findGlyph_1_)
    {
        return p_findGlyph_1_ == ' ' ? this.glyphAdvanceSpace : this.font.findGlyph(p_findGlyph_1_);
    }
}
