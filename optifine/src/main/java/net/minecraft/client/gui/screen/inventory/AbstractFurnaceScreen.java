...
public abstract class AbstractFurnaceScreen<T extends AbstractFurnaceContainer> extends ContainerScreen<T> implements IRecipeShownListener
{
    ...
    public AbstractFurnaceScreen(T p_i1688_1_, AbstractRecipeBookGui p_i1688_2_, PlayerInventory p_i1688_3_, ITextComponent p_i1688_4_, ResourceLocation p_i1688_5_)
    {
        super(p_i1688_1_, p_i1688_3_, p_i1688_4_);
        this.recipeGui = p_i1688_2_;
        this.guiTexture = p_i1688_5_;
    }
