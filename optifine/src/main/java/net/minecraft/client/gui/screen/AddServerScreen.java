...
public class AddServerScreen extends Screen
{
    ...
    public AddServerScreen(Screen p_i3137_1_, BooleanConsumer p_i3137_2_, ServerData p_i3137_3_)
    {
        super(new TranslationTextComponent("addServer.title"));
        this.field_228179_g_ = p_i3137_1_;
        this.field_213032_b = p_i3137_2_;
        this.serverData = p_i3137_3_;
    }
