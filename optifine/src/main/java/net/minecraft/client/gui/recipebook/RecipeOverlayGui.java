...
public class RecipeOverlayGui extends AbstractGui implements IRenderable, IGuiEventListener
{
    ...
    {
        public FurnaceRecipeButtonWidget(int p_i2858_2_, int p_i2858_3_, IRecipe<?> p_i2858_4_, boolean p_i2858_5_)
        {
            super(p_i2858_2_, p_i2858_3_, p_i2858_4_, p_i2858_5_);
        }
    ...
    class RecipeButtonWidget extends Widget implements IRecipePlacer<Ingredient>
    {
        ...
        public RecipeButtonWidget(int p_i766_2_, int p_i766_3_, IRecipe<?> p_i766_4_, boolean p_i766_5_)
        {
            super(p_i766_2_, p_i766_3_, 200, 20, "");
            this.width = 24;
            this.height = 24;
            this.recipe = p_i766_4_;
            this.isCraftable = p_i766_5_;
            this.func_201505_a(p_i766_4_);
        }
        ...
        public class Child
        {
            ...
            public Child(int p_i387_2_, int p_i387_3_, ItemStack[] p_i387_4_)
            {
                this.field_201706_b = p_i387_2_;
                this.field_201707_c = p_i387_3_;
                this.field_201705_a = p_i387_4_;
            }
        }
    }
}
