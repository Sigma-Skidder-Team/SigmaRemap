...
public class DeathScreen extends Screen
{
    ...
    public DeathScreen(@Nullable ITextComponent p_i688_1_, boolean p_i688_2_)
    {
        super(new TranslationTextComponent(p_i688_2_ ? "deathScreen.title.hardcore" : "deathScreen.title"));
        this.causeOfDeath = p_i688_1_;
        this.isHardcoreMode = p_i688_2_;
    }
