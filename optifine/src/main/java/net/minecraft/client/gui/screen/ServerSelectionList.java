...
public class ServerSelectionList extends ExtendedList<ServerSelectionList.Entry>
{
    ...
    public ServerSelectionList(MultiplayerScreen p_i421_1_, Minecraft p_i421_2_, int p_i421_3_, int p_i421_4_, int p_i421_5_, int p_i421_6_, int p_i421_7_)
    {
        super(p_i421_2_, p_i421_3_, p_i421_4_, p_i421_5_, p_i421_6_, p_i421_7_);
        this.owner = p_i421_1_;
    }
    ...
    public static class LanDetectedEntry extends ServerSelectionList.Entry
    {
        ...
        protected LanDetectedEntry(MultiplayerScreen p_i794_1_, LanServerInfo p_i794_2_)
        {
            this.screen = p_i794_1_;
            this.serverData = p_i794_2_;
    ...
    public class NormalEntry extends ServerSelectionList.Entry
    {
        ...
        protected NormalEntry(MultiplayerScreen p_i3363_2_, ServerData p_i3363_3_)
        {
            this.owner = p_i3363_2_;
            this.server = p_i3363_3_;
            this.mc = Minecraft.getInstance();
            this.serverIcon = new ResourceLocation("servers/" + Hashing.sha1().hashUnencodedChars(p_i3363_3_.serverIP) + "/icon");
