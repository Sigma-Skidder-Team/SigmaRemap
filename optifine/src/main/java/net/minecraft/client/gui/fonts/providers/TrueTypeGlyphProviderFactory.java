...
public class TrueTypeGlyphProviderFactory implements IGlyphProviderFactory
{
    ...
    public TrueTypeGlyphProviderFactory(ResourceLocation p_i3472_1_, float p_i3472_2_, float p_i3472_3_, float p_i3472_4_, float p_i3472_5_, String p_i3472_6_)
    {
        this.file = p_i3472_1_;
        this.size = p_i3472_2_;
        this.oversample = p_i3472_3_;
        this.shiftX = p_i3472_4_;
        this.shiftY = p_i3472_5_;
        this.chars = p_i3472_6_;
    }
