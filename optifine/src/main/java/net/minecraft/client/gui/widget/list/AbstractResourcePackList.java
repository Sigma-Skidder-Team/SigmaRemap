...
public abstract class AbstractResourcePackList extends ExtendedList<AbstractResourcePackList.ResourcePackEntry>
{
    ...
    public AbstractResourcePackList(Minecraft p_i3921_1_, int p_i3921_2_, int p_i3921_3_, ITextComponent p_i3921_4_)
    {
        super(p_i3921_1_, p_i3921_2_, p_i3921_3_, 32, p_i3921_3_ - 55 + 4, 36);
        this.mc = p_i3921_1_;
        this.centerListVertically = false;
        this.setRenderHeader(true, (int)(9.0F * 1.5F));
        this.field_214370_e = p_i3921_4_;
    }
    ...
    public static class ResourcePackEntry extends ExtendedList.AbstractListEntry<AbstractResourcePackList.ResourcePackEntry>
    {
        ...
        public ResourcePackEntry(AbstractResourcePackList p_i3268_1_, ResourcePacksScreen p_i3268_2_, ClientResourcePackInfo p_i3268_3_)
        {
            this.field_214429_b = p_i3268_2_;
            this.field_214428_a = Minecraft.getInstance();
            this.field_214431_d = p_i3268_3_;
            this.field_214430_c = p_i3268_1_;
        }
