...
public class HorseInventoryScreen extends ContainerScreen<HorseInventoryContainer>
{
    ...
    public HorseInventoryScreen(HorseInventoryContainer p_i291_1_, PlayerInventory p_i291_2_, AbstractHorseEntity p_i291_3_)
    {
        super(p_i291_1_, p_i291_2_, p_i291_3_.getDisplayName());
        this.horseEntity = p_i291_3_;
