...
public class StonecutterScreen extends ContainerScreen<StonecutterContainer>
{
    ...
    public StonecutterScreen(StonecutterContainer p_i323_1_, PlayerInventory p_i323_2_, ITextComponent p_i323_3_)
    {
        super(p_i323_1_, p_i323_2_, p_i323_3_);
        p_i323_1_.setInventoryUpdateListener(this::onInventoryUpdate);
    }
