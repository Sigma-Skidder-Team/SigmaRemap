...
public class TextInputUtil
{
    ...
    public TextInputUtil(Minecraft p_i2707_1_, Supplier<String> p_i2707_2_, Consumer<String> p_i2707_3_, int p_i2707_4_)
    {
        this.minecraft = p_i2707_1_;
        this.fontRenderer = p_i2707_1_.fontRenderer;
        this.textSupplier = p_i2707_2_;
        this.textConsumer = p_i2707_3_;
        this.textWidth = p_i2707_4_;
        this.func_216899_b();
    }
