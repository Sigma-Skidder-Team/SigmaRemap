...
public class AdvancementEntryGui extends AbstractGui
{
    ...
    public AdvancementEntryGui(AdvancementTabGui p_i359_1_, Minecraft p_i359_2_, Advancement p_i359_3_, DisplayInfo p_i359_4_)
    {
        this.guiAdvancementTab = p_i359_1_;
        this.advancement = p_i359_3_;
        this.displayInfo = p_i359_4_;
        this.minecraft = p_i359_2_;
        this.title = p_i359_2_.fontRenderer.trimStringToWidth(p_i359_4_.getTitle().getFormattedText(), 163);
        this.x = MathHelper.floor(p_i359_4_.getX() * 28.0F);
        this.y = MathHelper.floor(p_i359_4_.getY() * 27.0F);
        int i = p_i359_3_.getRequirementCount();
        int j = String.valueOf(i).length();
        int k = i > 1 ? p_i359_2_.fontRenderer.getStringWidth("  ") + p_i359_2_.fontRenderer.getStringWidth("0") * j * 2 + p_i359_2_.fontRenderer.getStringWidth("/") : 0;
        int l = 29 + p_i359_2_.fontRenderer.getStringWidth(this.title) + k;
        String s = p_i359_4_.getDescription().getFormattedText();
        this.description = this.findOptimalLines(s, l);

        for (String s1 : this.description)
        {
            l = Math.max(l, p_i359_2_.fontRenderer.getStringWidth(s1));
        }
