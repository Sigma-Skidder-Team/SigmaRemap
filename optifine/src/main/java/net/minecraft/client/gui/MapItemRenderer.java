...
public class MapItemRenderer implements AutoCloseable
{
    ...
    public MapItemRenderer(TextureManager p_i2847_1_)
    {
        this.textureManager = p_i2847_1_;
    }
    ...
    class Instance implements AutoCloseable
    {
        ...
        private Instance(MapData p_i2726_2_)
        {
            this.mapData = p_i2726_2_;
            this.mapTexture = new DynamicTexture(128, 128, true);
            ResourceLocation resourcelocation = MapItemRenderer.this.textureManager.getDynamicTextureLocation("map/" + p_i2726_2_.getName(), this.mapTexture);
