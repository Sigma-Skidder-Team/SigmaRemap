...
public class AdvancementTabGui extends AbstractGui
{
    ...
    public AdvancementTabGui(Minecraft p_i3244_1_, AdvancementsScreen p_i3244_2_, AdvancementTabType p_i3244_3_, int p_i3244_4_, Advancement p_i3244_5_, DisplayInfo p_i3244_6_)
    {
        this.minecraft = p_i3244_1_;
        this.screen = p_i3244_2_;
        this.type = p_i3244_3_;
        this.index = p_i3244_4_;
        this.advancement = p_i3244_5_;
        this.display = p_i3244_6_;
        this.icon = p_i3244_6_.getIcon();
        this.title = p_i3244_6_.getTitle().getFormattedText();
        this.root = new AdvancementEntryGui(this, p_i3244_1_, p_i3244_5_, p_i3244_6_);
        this.addGuiAdvancement(this.root, p_i3244_5_);
    }
