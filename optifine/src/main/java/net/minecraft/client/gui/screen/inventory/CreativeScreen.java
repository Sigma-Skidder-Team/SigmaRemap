...
public class CreativeScreen extends DisplayEffectsScreen<CreativeScreen.CreativeContainer>
{
    ...
    public CreativeScreen(PlayerEntity p_i3342_1_)
    {
        super(new CreativeScreen.CreativeContainer(p_i3342_1_), p_i3342_1_.inventory, new StringTextComponent(""));
        p_i3342_1_.openContainer = this.container;
    ...
    public static class CreativeContainer extends Container
    {
        ...
        public CreativeContainer(PlayerEntity p_i3329_1_)
        {
            super((ContainerType<?>)null, 0);
            PlayerInventory playerinventory = p_i3329_1_.inventory;
    ...
    static class CreativeSlot extends Slot
    {
        ...
        public CreativeSlot(Slot p_i2789_1_, int p_i2789_2_, int p_i2789_3_, int p_i2789_4_)
        {
            super(p_i2789_1_.inventory, p_i2789_2_, p_i2789_3_, p_i2789_4_);
            this.slot = p_i2789_1_;
        }
    ...
    {
        public LockedSlot(IInventory p_i3755_1_, int p_i3755_2_, int p_i3755_3_, int p_i3755_4_)
        {
            super(p_i3755_1_, p_i3755_2_, p_i3755_3_, p_i3755_4_);
        }
