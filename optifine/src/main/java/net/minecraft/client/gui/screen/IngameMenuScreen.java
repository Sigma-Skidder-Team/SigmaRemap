...
public class IngameMenuScreen extends Screen
{
    ...
    public IngameMenuScreen(boolean p_i4120_1_)
    {
        super(p_i4120_1_ ? new TranslationTextComponent("menu.game") : new TranslationTextComponent("menu.paused"));
        this.isFullMenu = p_i4120_1_;
    }
