...
public class CartographyTableScreen extends ContainerScreen<CartographyContainer>
{
    ...
    public CartographyTableScreen(CartographyContainer p_i2034_1_, PlayerInventory p_i2034_2_, ITextComponent p_i2034_3_)
    {
        super(p_i2034_1_, p_i2034_2_, p_i2034_3_);
    }
