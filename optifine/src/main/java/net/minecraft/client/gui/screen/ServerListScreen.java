...
public class ServerListScreen extends Screen
{
    ...
    public ServerListScreen(Screen p_i394_1_, BooleanConsumer p_i394_2_, ServerData p_i394_3_)
    {
        super(new TranslationTextComponent("selectServer.direct"));
        this.field_228178_e_ = p_i394_1_;
        this.serverData = p_i394_3_;
        this.field_213027_d = p_i394_2_;
    }
