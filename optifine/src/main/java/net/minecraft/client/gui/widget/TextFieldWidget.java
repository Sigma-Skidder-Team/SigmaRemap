...
public class TextFieldWidget extends Widget implements IRenderable, IGuiEventListener
{
    ...
    public TextFieldWidget(FontRenderer msg, int p_i1955_2_, int p_i1955_3_, int p_i1955_4_, int p_i1955_5_, String p_i1955_6_)
    {
        this(msg, p_i1955_2_, p_i1955_3_, p_i1955_4_, p_i1955_5_, (TextFieldWidget)null, p_i1955_6_);
    }

    public TextFieldWidget(FontRenderer p_i1956_1_, int p_i1956_2_, int p_i1956_3_, int p_i1956_4_, int p_i1956_5_, @Nullable TextFieldWidget p_i1956_6_, String p_i1956_7_)
    {
        super(p_i1956_2_, p_i1956_3_, p_i1956_4_, p_i1956_5_, p_i1956_7_);
        this.fontRenderer = p_i1956_1_;
