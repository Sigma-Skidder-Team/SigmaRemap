...
public class DisconnectedScreen extends Screen
{
    ...
    public DisconnectedScreen(Screen p_i929_1_, String p_i929_2_, ITextComponent p_i929_3_)
    {
        super(new TranslationTextComponent(p_i929_2_));
        this.nextScreen = p_i929_1_;
        this.message = p_i929_3_;
    }
