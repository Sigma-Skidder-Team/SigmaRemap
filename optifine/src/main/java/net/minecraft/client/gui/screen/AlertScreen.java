...
public class AlertScreen extends Screen
{
    ...
    public AlertScreen(Runnable p_i1248_1_, ITextComponent p_i1248_2_, ITextComponent p_i1248_3_)
    {
        this(p_i1248_1_, p_i1248_2_, p_i1248_3_, "gui.back");
    }

    public AlertScreen(Runnable p_i1249_1_, ITextComponent p_i1249_2_, ITextComponent p_i1249_3_, String p_i1249_4_)
    {
        super(p_i1249_2_);
        this.field_201552_h = p_i1249_1_;
        this.field_201550_f = p_i1249_3_;
        this.field_201551_g = I18n.format(p_i1249_4_);
    }
