...
public class StatsScreen extends Screen implements IProgressMeter
{
    ...
    public StatsScreen(Screen p_i1689_1_, StatisticsManager p_i1689_2_)
    {
        super(new TranslationTextComponent("gui.stats"));
        this.parentScreen = p_i1689_1_;
        this.stats = p_i1689_2_;
    }
    ...
    {
        public CustomStatsList(Minecraft p_i494_2_)
        {
            super(p_i494_2_, StatsScreen.this.width, StatsScreen.this.height, 32, StatsScreen.this.height - 64, 10);
        ...
        class Entry extends ExtendedList.AbstractListEntry<StatsScreen.CustomStatsList.Entry>
        {
            ...
            private Entry(Stat<ResourceLocation> p_i1291_2_)
            {
                this.field_214405_b = p_i1291_2_;
            }
    ...
    {
        public MobStatsList(Minecraft p_i2577_2_)
        {
            super(p_i2577_2_, StatsScreen.this.width, StatsScreen.this.height, 32, StatsScreen.this.height - 64, 9 * 4);
        ...
        class Entry extends ExtendedList.AbstractListEntry<StatsScreen.MobStatsList.Entry>
        {
            ...
            public Entry(EntityType<?> p_i1668_2_)
            {
                this.field_214411_b = p_i1668_2_;
            }
    ...
    class StatsList extends ExtendedList<StatsScreen.StatsList.Entry>
    {
        ...
        public StatsList(Minecraft p_i1931_2_)
        {
            super(p_i1931_2_, StatsScreen.this.width, StatsScreen.this.height, 32, StatsScreen.this.height - 64, 20);
