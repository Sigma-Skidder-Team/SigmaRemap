...
public class SubtitleOverlayGui extends AbstractGui implements ISoundEventListener
{
    ...
    public SubtitleOverlayGui(Minecraft p_i3478_1_)
    {
        this.client = p_i3478_1_;
    }
    ...
    public class Subtitle
    {
        ...
        public Subtitle(String p_i3971_2_, Vec3d p_i3971_3_)
        {
            this.subtitle = p_i3971_2_;
            this.location = p_i3971_3_;
