...
public abstract class AbstractSlider extends Widget
{
    ...
    protected AbstractSlider(int p_i482_1_, int p_i482_2_, int p_i482_3_, int p_i482_4_, double p_i482_5_)
    {
        this(Minecraft.getInstance().gameSettings, p_i482_1_, p_i482_2_, p_i482_3_, p_i482_4_, p_i482_5_);
    }

    protected AbstractSlider(GameSettings p_i483_1_, int p_i483_2_, int p_i483_3_, int p_i483_4_, int p_i483_5_, double p_i483_6_)
    {
        super(p_i483_2_, p_i483_3_, p_i483_4_, p_i483_5_, "");
        this.options = p_i483_1_;
        this.value = p_i483_6_;
    }
