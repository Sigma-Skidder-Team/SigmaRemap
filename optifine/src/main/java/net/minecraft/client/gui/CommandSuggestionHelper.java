...
public class CommandSuggestionHelper
{
    ...
    public CommandSuggestionHelper(Minecraft p_i2848_1_, Screen p_i2848_2_, TextFieldWidget p_i2848_3_, FontRenderer p_i2848_4_, boolean p_i2848_5_, boolean p_i2848_6_, int p_i2848_7_, int p_i2848_8_, boolean p_i2848_9_, int p_i2848_10_)
    {
        this.field_228093_b_ = p_i2848_1_;
        this.field_228094_c_ = p_i2848_2_;
        this.field_228095_d_ = p_i2848_3_;
        this.field_228096_e_ = p_i2848_4_;
        this.field_228097_f_ = p_i2848_5_;
        this.field_228098_g_ = p_i2848_6_;
        this.field_228099_h_ = p_i2848_7_;
        this.field_228100_i_ = p_i2848_8_;
        this.field_228101_j_ = p_i2848_9_;
        this.field_228102_k_ = p_i2848_10_;
        p_i2848_3_.setTextFormatter(this::func_228122_a_);
    }
    ...
    public class Suggestions
    {
        ...
        private Suggestions(int p_i4094_2_, int p_i4094_3_, int p_i4094_4_, com.mojang.brigadier.suggestion.Suggestions p_i4094_5_, boolean p_i4094_6_)
        {
            int i = p_i4094_2_ - 1;
            int j = CommandSuggestionHelper.this.field_228101_j_ ? p_i4094_3_ - 3 - Math.min(p_i4094_5_.getList().size(), CommandSuggestionHelper.this.field_228100_i_) * 12 : p_i4094_3_;
            this.field_228138_b_ = new Rectangle2d(i, j, p_i4094_4_ + 1, Math.min(p_i4094_5_.getList().size(), CommandSuggestionHelper.this.field_228100_i_) * 12);
            this.field_228139_c_ = p_i4094_5_;
            this.field_228140_d_ = CommandSuggestionHelper.this.field_228095_d_.getText();
            this.field_228145_i_ = p_i4094_6_ ? -1 : 0;
