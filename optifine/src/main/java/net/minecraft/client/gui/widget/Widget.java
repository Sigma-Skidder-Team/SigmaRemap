...
public abstract class Widget extends AbstractGui implements IRenderable, IGuiEventListener
{
    ...
    public Widget(int p_i1609_1_, int p_i1609_2_, String p_i1609_3_)
    {
        this(p_i1609_1_, p_i1609_2_, 200, 20, p_i1609_3_);
    }

    public Widget(int p_i1610_1_, int p_i1610_2_, int p_i1610_3_, int p_i1610_4_, String p_i1610_5_)
    {
        this.x = p_i1610_1_;
        this.y = p_i1610_2_;
        this.width = p_i1610_3_;
        this.height = p_i1610_4_;
        this.message = p_i1610_5_;
    }
