...
public class EditBookScreen extends Screen
{
    ...
    public EditBookScreen(PlayerEntity p_i4187_1_, ItemStack p_i4187_2_, Hand p_i4187_3_)
    {
        super(NarratorChatListener.EMPTY);
        this.editingPlayer = p_i4187_1_;
        this.book = p_i4187_2_;
        this.hand = p_i4187_3_;
        CompoundNBT compoundnbt = p_i4187_2_.getTag();
    ...
    class Point
    {
        ...
        Point(int p_i538_2_, int p_i538_3_)
        {
            this.x = p_i538_2_;
            this.y = p_i538_3_;
        }
