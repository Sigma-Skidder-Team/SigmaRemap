...
public class ConfirmOpenLinkScreen extends ConfirmScreen
{
    ...
    public ConfirmOpenLinkScreen(BooleanConsumer p_i1347_1_, String p_i1347_2_, boolean p_i1347_3_)
    {
        super(p_i1347_1_, new TranslationTextComponent(p_i1347_3_ ? "chat.link.confirmTrusted" : "chat.link.confirm"), new StringTextComponent(p_i1347_2_));
        this.confirmButtonText = I18n.format(p_i1347_3_ ? "chat.link.open" : "gui.yes");
        this.cancelButtonText = I18n.format(p_i1347_3_ ? "gui.cancel" : "gui.no");
        this.copyLinkButtonText = I18n.format("chat.copy");
        this.openLinkWarning = I18n.format("chat.link.warning");
        this.showSecurityWarning = !p_i1347_3_;
        this.linkText = p_i1347_2_;
    }
