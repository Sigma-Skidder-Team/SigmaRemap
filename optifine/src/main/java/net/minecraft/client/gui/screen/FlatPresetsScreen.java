...
public class FlatPresetsScreen extends Screen
{
    ...
    public FlatPresetsScreen(CreateFlatWorldScreen p_i2065_1_)
    {
        super(new TranslationTextComponent("createWorld.customize.presets.title"));
        this.parentScreen = p_i2065_1_;
    }
    ...
    static class LayerItem
    {
        ...
        public LayerItem(Item p_i484_1_, String p_i484_2_, String p_i484_3_)
        {
            this.icon = p_i484_1_;
            this.name = p_i484_2_;
            this.generatorInfo = p_i484_3_;
        }
    }
