...
enum AdvancementTabType
{
    ...
    private AdvancementTabType(int p_i2297_3_, int p_i2297_4_, int p_i2297_5_, int p_i2297_6_, int p_i2297_7_)
    {
        this.textureX = p_i2297_3_;
        this.textureY = p_i2297_4_;
        this.width = p_i2297_5_;
        this.height = p_i2297_6_;
        this.max = p_i2297_7_;
    }
