...
{
    public OptionsRowList(Minecraft p_i454_1_, int p_i454_2_, int p_i454_3_, int p_i454_4_, int p_i454_5_, int p_i454_6_)
    {
        super(p_i454_1_, p_i454_2_, p_i454_3_, p_i454_4_, p_i454_5_, p_i454_6_);
    ...
    public static class Row extends AbstractOptionList.Entry<OptionsRowList.Row>
    {
        ...
        private Row(List<Widget> p_i1265_1_)
        {
            this.widgets = p_i1265_1_;
        }
