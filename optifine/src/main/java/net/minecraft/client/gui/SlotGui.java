...
public abstract class SlotGui extends FocusableGui implements IRenderable
{
    ...
    public SlotGui(Minecraft p_i4112_1_, int p_i4112_2_, int p_i4112_3_, int p_i4112_4_, int p_i4112_5_, int p_i4112_6_)
    {
        this.minecraft = p_i4112_1_;
        this.width = p_i4112_2_;
        this.height = p_i4112_3_;
        this.y0 = p_i4112_4_;
        this.y1 = p_i4112_5_;
        this.itemHeight = p_i4112_6_;
        this.x0 = 0;
        this.x1 = p_i4112_2_;
    }
