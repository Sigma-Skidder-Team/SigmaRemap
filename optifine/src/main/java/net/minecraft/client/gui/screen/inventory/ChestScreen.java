...
public class ChestScreen extends ContainerScreen<ChestContainer> implements IHasContainer<ChestContainer>
{
    ...
    public ChestScreen(ChestContainer p_i2735_1_, PlayerInventory p_i2735_2_, ITextComponent p_i2735_3_)
    {
        super(p_i2735_1_, p_i2735_2_, p_i2735_3_);
        this.passEvents = false;
        int i = 222;
        int j = 114;
        this.inventoryRows = p_i2735_1_.getNumRows();
