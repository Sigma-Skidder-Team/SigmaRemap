...
public class PlayerMenuObject implements ISpectatorMenuObject
{
    ...
    public PlayerMenuObject(GameProfile p_i4087_1_)
    {
        this.profile = p_i4087_1_;
        Minecraft minecraft = Minecraft.getInstance();
        Map<Type, MinecraftProfileTexture> map = minecraft.getSkinManager().loadSkinFromCache(p_i4087_1_);
        ...
        {
            this.resourceLocation = DefaultPlayerSkin.getDefaultSkin(PlayerEntity.getUUID(p_i4087_1_));
        }
    }
