...
public class MerchantScreen extends ContainerScreen<MerchantContainer>
{
    ...
    public MerchantScreen(MerchantContainer p_i1127_1_, PlayerInventory p_i1127_2_, ITextComponent p_i1127_3_)
    {
        super(p_i1127_1_, p_i1127_2_, p_i1127_3_);
        this.xSize = 276;
    }
    ...
    class TradeButton extends Button
    {
        ...
        public TradeButton(int p_i2953_2_, int p_i2953_3_, int p_i2953_4_, Button.IPressable p_i2953_5_)
        {
            super(p_i2953_2_, p_i2953_3_, 89, 20, "", p_i2953_5_);
            this.field_212938_a = p_i2953_4_;
            this.visible = false;
        }
