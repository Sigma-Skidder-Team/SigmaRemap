...
public abstract class AbstractList<E extends AbstractList.AbstractListEntry<E>> extends FocusableGui implements IRenderable
{
    ...
    public AbstractList(Minecraft p_i928_1_, int p_i928_2_, int p_i928_3_, int p_i928_4_, int p_i928_5_, int p_i928_6_)
    {
        this.minecraft = p_i928_1_;
        this.width = p_i928_2_;
        this.height = p_i928_3_;
        this.y0 = p_i928_4_;
        this.y1 = p_i928_5_;
        this.itemHeight = p_i928_6_;
        this.x0 = 0;
        this.x1 = p_i928_2_;
    }
