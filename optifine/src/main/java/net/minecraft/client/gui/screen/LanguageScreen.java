...
public class LanguageScreen extends SettingsScreen
{
    ...
    public LanguageScreen(Screen p_i905_1_, GameSettings p_i905_2_, LanguageManager p_i905_3_)
    {
        super(p_i905_1_, p_i905_2_, new TranslationTextComponent("options.language"));
        this.languageManager = p_i905_3_;
    }
    ...
    {
        public List(Minecraft p_i4026_2_)
        {
            super(p_i4026_2_, LanguageScreen.this.width, LanguageScreen.this.height, 32, LanguageScreen.this.height - 65 + 4, 18);
        ...
        public class LanguageEntry extends ExtendedList.AbstractListEntry<LanguageScreen.List.LanguageEntry>
        {
            ...
            public LanguageEntry(Language p_i2803_2_)
            {
                this.field_214398_b = p_i2803_2_;
            }
