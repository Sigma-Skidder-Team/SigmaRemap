...
public class MouseSettingsScreen extends SettingsScreen
{
    ...
    public MouseSettingsScreen(Screen p_i2046_1_, GameSettings p_i2046_2_)
    {
        super(p_i2046_1_, p_i2046_2_, new TranslationTextComponent("options.mouse_settings.title"));
    }
