...
public class ClientWorld extends World
{
    ...
    public ClientWorld(ClientPlayNetHandler p_i192_1_, WorldSettings p_i192_2_, DimensionType p_i192_3_, int p_i192_4_, IProfiler p_i192_5_, WorldRenderer p_i192_6_)
    {
        super(new WorldInfo(p_i192_2_, "MpServer"), p_i192_3_, (p_lambda$new$1_1_, p_lambda$new$1_2_) ->
        {
            return new ClientChunkProvider((ClientWorld)p_lambda$new$1_1_, p_i192_4_);
        }, p_i192_5_, true);
        this.connection = p_i192_1_;
        this.worldRenderer = p_i192_6_;
        this.setSpawnPoint(new BlockPos(8, 64, 8));
        this.calculateInitialSkylight();
        this.calculateInitialWeather();

        if (Reflector.IForgeDimension_initCapabilities.exists())
        {
            Object object = Reflector.call(this.dimension, Reflector.IForgeDimension_initCapabilities);
            Reflector.call(this, Reflector.CapabilityProvider_gatherCapabilities, object);
        }
    ...
    public void tickEntities()
    {
        ...
        for (int i = 0; i < this.globalEntities.size(); ++i)
        {
            ...
            this.guardEntityTick((p_lambda$tickEntities$2_0_) ->
            {
                ++p_lambda$tickEntities$2_0_.ticksExisted;

                if (ReflectorForge.canUpdate(p_lambda$tickEntities$2_0_))
                {
    ...
    {
        this.colorCaches.forEach((p_lambda$onChunkLoaded$4_2_, p_lambda$onChunkLoaded$4_3_) ->
        {
            p_lambda$onChunkLoaded$4_3_.invalidateChunk(chunkX, chunkZ);
        });
    }

    public void clearColorCaches()
    {
        this.colorCaches.forEach((p_lambda$clearColorCaches$5_0_, p_lambda$clearColorCaches$5_1_) ->
        {
            p_lambda$clearColorCaches$5_1_.invalidateAll();
        });
    }
