...
public abstract class PropertyManager<T extends PropertyManager<T>>
{
    ...
    public PropertyManager(Properties p_i2681_1_)
    {
        this.serverProperties = p_i2681_1_;
    }
    ...
    public class Property<V> implements Supplier<V>
    {
        ...
        private Property(String p_i1975_2_, V p_i1975_3_, Function<V, String> p_i1975_4_)
        {
            this.name = p_i1975_2_;
            this.field_219041_c = p_i1975_3_;
            this.field_219042_d = p_i1975_4_;
        }
