...
public class DedicatedPlayerList extends PlayerList
{
    ...
    public DedicatedPlayerList(DedicatedServer p_i576_1_)
    {
        super(p_i576_1_, p_i576_1_.getServerProperties().maxPlayers);
        ServerProperties serverproperties = p_i576_1_.getServerProperties();
        this.setViewDistance(serverproperties.viewDistance);
        super.setWhiteListEnabled(serverproperties.whitelistEnabled.get());

        if (!p_i576_1_.isSinglePlayer())
        {
