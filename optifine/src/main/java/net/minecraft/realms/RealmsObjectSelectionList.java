...
public abstract class RealmsObjectSelectionList<E extends RealmListEntry> extends RealmsGuiEventListener
{
    ...
    public RealmsObjectSelectionList(int p_i1553_1_, int p_i1553_2_, int p_i1553_3_, int p_i1553_4_, int p_i1553_5_)
    {
        this.proxy = new RealmsObjectSelectionListProxy(this, p_i1553_1_, p_i1553_2_, p_i1553_3_, p_i1553_4_, p_i1553_5_);
    }
