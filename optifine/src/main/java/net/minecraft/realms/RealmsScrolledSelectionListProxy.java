...
public class RealmsScrolledSelectionListProxy extends SlotGui
{
    ...
    public RealmsScrolledSelectionListProxy(RealmsScrolledSelectionList p_i2593_1_, int p_i2593_2_, int p_i2593_3_, int p_i2593_4_, int p_i2593_5_, int p_i2593_6_)
    {
        super(Minecraft.getInstance(), p_i2593_2_, p_i2593_3_, p_i2593_4_, p_i2593_5_, p_i2593_6_);
        this.realmsScrolledSelectionList = p_i2593_1_;
    }
