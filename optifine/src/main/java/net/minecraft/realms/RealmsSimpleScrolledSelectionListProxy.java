...
public class RealmsSimpleScrolledSelectionListProxy extends SlotGui
{
    ...
    public RealmsSimpleScrolledSelectionListProxy(RealmsSimpleScrolledSelectionList p_i4138_1_, int p_i4138_2_, int p_i4138_3_, int p_i4138_4_, int p_i4138_5_, int p_i4138_6_)
    {
        super(Minecraft.getInstance(), p_i4138_2_, p_i4138_3_, p_i4138_4_, p_i4138_5_, p_i4138_6_);
        this.realmsSimpleScrolledSelectionList = p_i4138_1_;
    }
