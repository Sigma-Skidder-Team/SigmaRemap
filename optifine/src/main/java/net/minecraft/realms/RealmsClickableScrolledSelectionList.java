...
public abstract class RealmsClickableScrolledSelectionList extends RealmsGuiEventListener
{
    ...
    public RealmsClickableScrolledSelectionList(int p_i2780_1_, int p_i2780_2_, int p_i2780_3_, int p_i2780_4_, int p_i2780_5_)
    {
        this.proxy = new RealmsClickableScrolledSelectionListProxy(this, p_i2780_1_, p_i2780_2_, p_i2780_3_, p_i2780_4_, p_i2780_5_);
    }
