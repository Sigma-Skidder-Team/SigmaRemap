...
public abstract class RealmsSimpleScrolledSelectionList extends RealmsGuiEventListener
{
    ...
    public RealmsSimpleScrolledSelectionList(int p_i1003_1_, int p_i1003_2_, int p_i1003_3_, int p_i1003_4_, int p_i1003_5_)
    {
        this.proxy = new RealmsSimpleScrolledSelectionListProxy(this, p_i1003_1_, p_i1003_2_, p_i1003_3_, p_i1003_4_, p_i1003_5_);
    }
