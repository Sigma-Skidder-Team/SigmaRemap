...
public class RealmsEditBox extends RealmsGuiEventListener
{
    ...
    public RealmsEditBox(int p_i973_1_, int p_i973_2_, int p_i973_3_, int p_i973_4_, int p_i973_5_, String p_i973_6_)
    {
        this.editBox = new TextFieldWidget(Minecraft.getInstance().fontRenderer, p_i973_2_, p_i973_3_, p_i973_4_, p_i973_5_, (TextFieldWidget)null, p_i973_6_);
    }
