...
public class DisconnectedRealmsScreen extends RealmsScreen
{
    ...
    public DisconnectedRealmsScreen(RealmsScreen p_i655_1_, String p_i655_2_, ITextComponent p_i655_3_)
    {
        this.parent = p_i655_1_;
        this.title = getLocalizedString(p_i655_2_);
        this.reason = p_i655_3_;
    }
