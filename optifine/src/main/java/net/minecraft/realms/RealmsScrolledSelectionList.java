...
public abstract class RealmsScrolledSelectionList extends RealmsGuiEventListener
{
    ...
    public RealmsScrolledSelectionList(int p_i669_1_, int p_i669_2_, int p_i669_3_, int p_i669_4_, int p_i669_5_)
    {
        this.proxy = new RealmsScrolledSelectionListProxy(this, p_i669_1_, p_i669_2_, p_i669_3_, p_i669_4_, p_i669_5_);
    }
