...
public class RealmsObjectSelectionListProxy<E extends ExtendedList.AbstractListEntry<E>> extends ExtendedList<E>
{
    ...
    public RealmsObjectSelectionListProxy(RealmsObjectSelectionList p_i3301_1_, int p_i3301_2_, int p_i3301_3_, int p_i3301_4_, int p_i3301_5_, int p_i3301_6_)
    {
        super(Minecraft.getInstance(), p_i3301_2_, p_i3301_3_, p_i3301_4_, p_i3301_5_, p_i3301_6_);
        this.realmsObjectSelectionList = p_i3301_1_;
    }
