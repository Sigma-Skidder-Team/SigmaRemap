...
public abstract class RealmsSliderButton extends AbstractRealmsButton<RealmsSliderButtonProxy>
{
    ...
    public RealmsSliderButton(int p_i395_1_, int p_i395_2_, int p_i395_3_, int p_i395_4_, int p_i395_5_, double p_i395_6_, double p_i395_8_)
    {
        this.id = p_i395_1_;
        this.minValue = p_i395_6_;
        this.maxValue = p_i395_8_;
        this.proxy = new RealmsSliderButtonProxy(this, p_i395_2_, p_i395_3_, p_i395_4_, 20, this.toPct((double)p_i395_5_));
