...
public class RealmsClickableScrolledSelectionListProxy extends SlotGui
{
    ...
    public RealmsClickableScrolledSelectionListProxy(RealmsClickableScrolledSelectionList p_i3175_1_, int p_i3175_2_, int p_i3175_3_, int p_i3175_4_, int p_i3175_5_, int p_i3175_6_)
    {
        super(Minecraft.getInstance(), p_i3175_2_, p_i3175_3_, p_i3175_4_, p_i3175_5_, p_i3175_6_);
        this.realmsClickableScrolledSelectionList = p_i3175_1_;
    }
