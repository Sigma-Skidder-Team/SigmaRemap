...
public class RepeatedNarrator
{
    ...
    public RepeatedNarrator(Duration p_i2783_1_)
    {
        this.repeatDelay = p_i2783_1_;
        this.params = new AtomicReference<>();
        float f = (float)p_i2783_1_.toMillis() / 1000.0F;
    ...
    static class Parameter
    {
        ...
        Parameter(String p_i2299_1_, RateLimiter p_i2299_2_)
        {
            this.field_214462_a = p_i2299_1_;
            this.field_214463_b = p_i2299_2_;
        }
    }
}
