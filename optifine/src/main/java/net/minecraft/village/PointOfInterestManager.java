...
public class PointOfInterestManager extends RegionSectionCache<PointOfInterestData>
{
    ...
    public PointOfInterestManager(File parentScreenIn, DataFixer gameSettingsIn)
    {
        super(parentScreenIn, PointOfInterestData::new, PointOfInterestData::new, gameSettingsIn, DefaultTypeReferences.POI_CHUNK);
    ...
    public static enum Status
    {
        ...
        private Status(Predicate <? super PointOfInterest > p_i2809_3_)
        {
            this.field_221037_d = p_i2809_3_;
        }
