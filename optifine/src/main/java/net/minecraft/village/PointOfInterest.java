...
public class PointOfInterest implements IDynamicSerializable
{
    ...
    private PointOfInterest(BlockPos p_i529_1_, PointOfInterestType p_i529_2_, int p_i529_3_, Runnable p_i529_4_)
    {
        this.pos = p_i529_1_.toImmutable();
        this.type = p_i529_2_;
        this.freeTickets = p_i529_3_;
        this.onChange = p_i529_4_;
    }

    public PointOfInterest(BlockPos p_i530_1_, PointOfInterestType p_i530_2_, Runnable p_i530_3_)
    {
        this(p_i530_1_, p_i530_2_, p_i530_2_.getMaxFreeTickets(), p_i530_3_);
    }

    public <T> PointOfInterest(Dynamic<T> p_i531_1_, Runnable p_i531_2_)
    {
        this(p_i531_1_.get("pos").map(BlockPos::deserialize).orElse(new BlockPos(0, 0, 0)), Registry.POINT_OF_INTEREST_TYPE.getOrDefault(new ResourceLocation(p_i531_1_.get("type").asString(""))), p_i531_1_.get("free_tickets").asInt(0), p_i531_2_);
    }
