...
public class TimerCallbackManager<T>
{
    ...
    public TimerCallbackManager(TimerCallbackSerializers<T> p_i2541_1_)
    {
        this.field_216334_b = p_i2541_1_;
    }
    ...
    public static class Entry<T>
    {
        ...
        private Entry(long p_i889_1_, UnsignedLong p_i889_3_, String p_i889_4_, ITimerCallback<T> p_i889_5_)
        {
            this.triggerTime = p_i889_1_;
            this.uniqueId = p_i889_3_;
            this.name = p_i889_4_;
            this.callback = p_i889_5_;
        }
    }
}
