...
public class CommandSource implements ISuggestionProvider
{
    ...
    public CommandSource(ICommandSource p_i3855_1_, Vec3d p_i3855_2_, Vec2f p_i3855_3_, ServerWorld p_i3855_4_, int p_i3855_5_, String p_i3855_6_, ITextComponent p_i3855_7_, MinecraftServer p_i3855_8_, @Nullable Entity p_i3855_9_)
    {
        this(p_i3855_1_, p_i3855_2_, p_i3855_3_, p_i3855_4_, p_i3855_5_, p_i3855_6_, p_i3855_7_, p_i3855_8_, p_i3855_9_, false, (p_197032_0_, p_197032_1_, p_197032_2_) ->
        {
        }, EntityAnchorArgument.Type.FEET);
    }

    protected CommandSource(ICommandSource p_i3856_1_, Vec3d p_i3856_2_, Vec2f p_i3856_3_, ServerWorld p_i3856_4_, int p_i3856_5_, String p_i3856_6_, ITextComponent p_i3856_7_, MinecraftServer p_i3856_8_, @Nullable Entity p_i3856_9_, boolean p_i3856_10_, ResultConsumer<CommandSource> p_i3856_11_, EntityAnchorArgument.Type p_i3856_12_)
    {
        this.source = p_i3856_1_;
        this.pos = p_i3856_2_;
        this.world = p_i3856_4_;
        this.feedbackDisabled = p_i3856_10_;
        this.entity = p_i3856_9_;
        this.permissionLevel = p_i3856_5_;
        this.name = p_i3856_6_;
        this.displayName = p_i3856_7_;
        this.server = p_i3856_8_;
        this.resultConsumer = p_i3856_11_;
        this.entityAnchorType = p_i3856_12_;
        this.rotation = p_i3856_3_;
    }
