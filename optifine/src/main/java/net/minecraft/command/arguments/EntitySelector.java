...
public class EntitySelector
{
    ...
    public EntitySelector(int p_i2594_1_, boolean p_i2594_2_, boolean p_i2594_3_, Predicate<Entity> p_i2594_4_, MinMaxBounds.FloatBound p_i2594_5_, Function<Vec3d, Vec3d> p_i2594_6_, @Nullable AxisAlignedBB p_i2594_7_, BiConsumer < Vec3d, List <? extends Entity >> p_i2594_8_, boolean p_i2594_9_, @Nullable String p_i2594_10_, @Nullable UUID p_i2594_11_, @Nullable EntityType<?> p_i2594_12_, boolean p_i2594_13_)
    {
        this.limit = p_i2594_1_;
        this.includeNonPlayers = p_i2594_2_;
        this.currentWorldOnly = p_i2594_3_;
        this.filter = p_i2594_4_;
        this.distance = p_i2594_5_;
        this.positionGetter = p_i2594_6_;
        this.aabb = p_i2594_7_;
        this.sorter = p_i2594_8_;
        this.self = p_i2594_9_;
        this.username = p_i2594_10_;
        this.uuid = p_i2594_11_;
        this.type = p_i2594_12_;
        this.checkPermission = p_i2594_13_;
    }
