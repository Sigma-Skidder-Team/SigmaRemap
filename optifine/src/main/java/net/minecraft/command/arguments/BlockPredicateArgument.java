...
public class BlockPredicateArgument implements ArgumentType<BlockPredicateArgument.IResult>
{
    ...
    static class BlockPredicate implements Predicate<CachedBlockInfo>
    {
        ...
        public BlockPredicate(BlockState p_i563_1_, Set < IProperty<? >> p_i563_2_, @Nullable CompoundNBT p_i563_3_)
        {
            this.state = p_i563_1_;
            this.properties = p_i563_2_;
            this.nbt = p_i563_3_;
        }
    ...
    static class TagPredicate implements Predicate<CachedBlockInfo>
    {
        ...
        private TagPredicate(Tag<Block> p_i2146_1_, Map<String, String> p_i2146_2_, @Nullable CompoundNBT p_i2146_3_)
        {
            this.tag = p_i2146_1_;
            this.properties = p_i2146_2_;
            this.nbt = p_i2146_3_;
        }
