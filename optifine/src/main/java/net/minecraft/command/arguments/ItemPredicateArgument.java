...
public class ItemPredicateArgument implements ArgumentType<ItemPredicateArgument.IResult>
{
    ...
    static class ItemPredicate implements Predicate<ItemStack>
    {
        ...
        public ItemPredicate(Item p_i2497_1_, @Nullable CompoundNBT p_i2497_2_)
        {
            this.item = p_i2497_1_;
            this.nbt = p_i2497_2_;
        }
    ...
    static class TagPredicate implements Predicate<ItemStack>
    {
        ...
        public TagPredicate(Tag<Item> p_i2743_1_, @Nullable CompoundNBT p_i2743_2_)
        {
            this.tag = p_i2743_1_;
            this.nbt = p_i2743_2_;
        }
