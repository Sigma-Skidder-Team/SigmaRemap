...
public class EntitySelectorParser
{
    ...
    public EntitySelectorParser(StringReader p_i3337_1_)
    {
        this(p_i3337_1_, true);
    }

    public EntitySelectorParser(StringReader p_i3338_1_, boolean p_i3338_2_)
    {
        this.reader = p_i3338_1_;
        this.hasPermission = p_i3338_2_;
    }
