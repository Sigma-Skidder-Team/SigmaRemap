...
public class EntityOptions
{
    ...
    static class OptionHandler
    {
        ...
        private OptionHandler(EntityOptions.IFilter p_i900_1_, Predicate<EntitySelectorParser> p_i900_2_, ITextComponent p_i900_3_)
        {
            this.handler = p_i900_1_;
            this.canHandle = p_i900_2_;
            this.tooltip = p_i900_3_;
        }
    }
}
