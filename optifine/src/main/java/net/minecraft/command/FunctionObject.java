...
public class FunctionObject
{
    ...
    public FunctionObject(ResourceLocation p_i2008_1_, FunctionObject.IEntry[] p_i2008_2_)
    {
        this.id = p_i2008_1_;
        this.entries = p_i2008_2_;
    }
    ...
    public static class CacheableFunction
    {
        ...
        public CacheableFunction(@Nullable ResourceLocation p_i2223_1_)
        {
            this.id = p_i2223_1_;
        }

        public CacheableFunction(FunctionObject p_i2224_1_)
        {
            this.isValid = true;
            this.id = null;
            this.function = Optional.of(p_i2224_1_);
        }
    ...
    public static class CommandEntry implements FunctionObject.IEntry
    {
        ...
        public CommandEntry(ParseResults<CommandSource> p_i2077_1_)
        {
            this.field_196999_a = p_i2077_1_;
        }
    ...
    public static class FunctionEntry implements FunctionObject.IEntry
    {
        ...
        public FunctionEntry(FunctionObject p_i2183_1_)
        {
            this.function = new FunctionObject.CacheableFunction(p_i2183_1_);
        }
