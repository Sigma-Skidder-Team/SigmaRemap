...
public class ExperienceCommand
{
    ...
    static enum Type
    {
        ...
        private Type(String p_i2115_3_, BiConsumer<ServerPlayerEntity, Integer> p_i2115_4_, BiPredicate<ServerPlayerEntity, Integer> p_i2115_5_, ToIntFunction<ServerPlayerEntity> p_i2115_6_)
        {
            this.xpAdder = p_i2115_4_;
            this.name = p_i2115_3_;
            this.xpSetter = p_i2115_5_;
            this.xpGetter = p_i2115_6_;
        }
    }
}
