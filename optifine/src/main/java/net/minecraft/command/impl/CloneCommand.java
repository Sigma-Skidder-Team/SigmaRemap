...
public class CloneCommand
{
    ...
    static class BlockInfo
    {
        ...
        public BlockInfo(BlockPos p_i4044_1_, BlockState p_i4044_2_, @Nullable CompoundNBT p_i4044_3_)
        {
            this.pos = p_i4044_1_;
            this.state = p_i4044_2_;
            this.tag = p_i4044_3_;
        }
    }
    ...
    static enum Mode
    {
        ...
        private Mode(boolean p_i3576_3_)
        {
            this.allowOverlap = p_i3576_3_;
        }
