...
public class AdvancementCommand
{
    ...
    static enum Action
    {
        ...
        private Action(String p_i759_3_)
        {
            this.prefix = "commands.advancement." + p_i759_3_;
        }
    ...
    static enum Mode
    {
        ...
        private Mode(boolean p_i906_3_, boolean p_i906_4_)
        {
            this.includesParents = p_i906_3_;
            this.includesChildren = p_i906_4_;
        }
    }
}
