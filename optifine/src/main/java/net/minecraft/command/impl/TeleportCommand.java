...
public class TeleportCommand
{
    ...
    static class Facing
    {
        ...
        public Facing(Entity p_i1616_1_, EntityAnchorArgument.Type p_i1616_2_)
        {
            this.entity = p_i1616_1_;
            this.anchor = p_i1616_2_;
            this.position = p_i1616_2_.apply(p_i1616_1_);
        }

        public Facing(Vec3d wolf)
        {
            this.entity = null;
            this.position = wolf;
            this.anchor = null;
