...
public class StateContainer<O, S extends IStateHolder<S>>
{
    ...
    protected <A extends StateHolder<O, S>> StateContainer(O p_i2364_1_, StateContainer.IFactory<O, S, A> p_i2364_2_, Map < String, IProperty<? >> p_i2364_3_)
    {
        this.owner = p_i2364_1_;
        this.properties = ImmutableSortedMap.copyOf(p_i2364_3_);
        ...
        stream.forEach((p_201000_5_) ->
        {
            ...
            A a1 = p_i2364_2_.create(p_i2364_1_, ImmutableMap.copyOf(map1));
            map.put(map1, a1);
            list.add(a1);
        });
    ...
    public static class Builder<O, S extends IStateHolder<S>>
    {
        ...
        public Builder(O p_i3850_1_)
        {
            this.owner = p_i3850_1_;
        }
