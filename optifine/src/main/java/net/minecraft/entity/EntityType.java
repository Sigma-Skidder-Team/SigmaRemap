...
public class EntityType<T extends Entity>
{
    ...
    public EntityType(EntityType.IFactory<T> p_i3274_1_, EntityClassification p_i3274_2_, boolean p_i3274_3_, boolean p_i3274_4_, boolean p_i3274_5_, boolean p_i3274_6_, EntitySize p_i3274_7_)
    {
        this.factory = p_i3274_1_;
        this.classification = p_i3274_2_;
        this.field_225438_be = p_i3274_6_;
        this.serializable = p_i3274_3_;
        this.summonable = p_i3274_4_;
        this.immuneToFire = p_i3274_5_;
        this.size = p_i3274_7_;
    }
    ...
    public static class Builder<T extends Entity>
    {
        ...
        private Builder(EntityType.IFactory<T> p_i936_1_, EntityClassification p_i936_2_)
        {
            this.factory = p_i936_1_;
            this.classification = p_i936_2_;
            this.field_225436_f = p_i936_2_ == EntityClassification.CREATURE || p_i936_2_ == EntityClassification.MISC;
        }
