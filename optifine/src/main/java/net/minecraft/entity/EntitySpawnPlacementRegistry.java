...
public class EntitySpawnPlacementRegistry
{
    ...
    static class Entry
    {
        ...
        public Entry(Heightmap.Type p_i480_1_, EntitySpawnPlacementRegistry.PlacementType p_i480_2_, EntitySpawnPlacementRegistry.IPlacementPredicate<?> p_i480_3_)
        {
            this.type = p_i480_1_;
            this.placementType = p_i480_2_;
            this.placementPredicate = p_i480_3_;
        }
    }
