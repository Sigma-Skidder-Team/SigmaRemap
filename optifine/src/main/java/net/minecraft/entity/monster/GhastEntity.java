...
public class GhastEntity extends FlyingEntity implements IMob
{
    ...
    public GhastEntity(EntityType <? extends GhastEntity > p_i2643_1_, World p_i2643_2_)
    {
        super(p_i2643_1_, p_i2643_2_);
    ...
    static class FireballAttackGoal extends Goal
    {
        ...
        public FireballAttackGoal(GhastEntity p_i3233_1_)
        {
            this.parentEntity = p_i3233_1_;
        }
    ...
    static class LookAroundGoal extends Goal
    {
        ...
        public LookAroundGoal(GhastEntity p_i3650_1_)
        {
            this.parentEntity = p_i3650_1_;
    ...
    static class MoveHelperController extends MovementController
    {
        ...
        public MoveHelperController(GhastEntity p_i1691_1_)
        {
            super(p_i1691_1_);
            this.parentEntity = p_i1691_1_;
        }
    ...
    static class RandomFlyGoal extends Goal
    {
        ...
        public RandomFlyGoal(GhastEntity p_i3605_1_)
        {
            this.parentEntity = p_i3605_1_;
