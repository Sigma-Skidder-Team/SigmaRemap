...
public class VexEntity extends MonsterEntity
{
    ...
    public VexEntity(EntityType <? extends VexEntity > p_i3191_1_, World p_i3191_2_)
    {
        super(p_i3191_1_, p_i3191_2_);
    ...
    class CopyOwnerTargetGoal extends TargetGoal
    {
        ...
        public CopyOwnerTargetGoal(CreatureEntity p_i3070_2_)
        {
            super(p_i3070_2_, false);
        }
    ...
    {
        public MoveHelperController(VexEntity p_i4136_2_)
        {
            super(p_i4136_2_);
        }
