...
public class BlazeEntity extends MonsterEntity
{
    ...
    public BlazeEntity(EntityType <? extends BlazeEntity > p_i2716_1_, World p_i2716_2_)
    {
        super(p_i2716_1_, p_i2716_2_);
    ...
    static class FireballAttackGoal extends Goal
    {
        ...
        public FireballAttackGoal(BlazeEntity p_i2610_1_)
        {
            this.blaze = p_i2610_1_;
