...
public class ZombieEntity extends MonsterEntity
{
    ...
    public ZombieEntity(EntityType <? extends ZombieEntity > p_i1893_1_, World p_i1893_2_)
    {
        super(p_i1893_1_, p_i1893_2_);
    }

    public ZombieEntity(World p_i1894_1_)
    {
        this(EntityType.ZOMBIE, p_i1894_1_);
    }
    ...
    {
        AttackTurtleEggGoal(CreatureEntity p_i2441_2_, double p_i2441_3_, int p_i2441_5_)
        {
            super(Blocks.TURTLE_EGG, p_i2441_2_, p_i2441_3_, p_i2441_5_);
        }
    ...
    public class GroupData implements ILivingEntityData
    {
        ...
        private GroupData(boolean p_i2943_2_)
        {
            this.isChild = p_i2943_2_;
        }
    }
}
