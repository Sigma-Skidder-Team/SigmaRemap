...
public abstract class PatrollerEntity extends MonsterEntity
{
    ...
    protected PatrollerEntity(EntityType <? extends PatrollerEntity > p_i2668_1_, World p_i2668_2_)
    {
        super(p_i2668_1_, p_i2668_2_);
    }
    ...
    public static class PatrolGoal<T extends PatrollerEntity> extends Goal
    {
        ...
        public PatrolGoal(T p_i3623_1_, double p_i3623_2_, double p_i3623_4_)
        {
            this.owner = p_i3623_1_;
            this.field_220840_b = p_i3623_2_;
            this.field_220841_c = p_i3623_4_;
