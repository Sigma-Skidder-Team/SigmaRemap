...
public class ShulkerEntity extends GolemEntity implements IMob
{
    ...
    public ShulkerEntity(EntityType <? extends ShulkerEntity > p_i970_1_, World p_i970_2_)
    {
        super(p_i970_1_, p_i970_2_);
    ...
    {
        public AttackNearestGoal(ShulkerEntity p_i3103_2_)
        {
            super(p_i3103_2_, PlayerEntity.class, true);
        }
    ...
    {
        public BodyHelperController(MobEntity p_i2287_2_)
        {
            super(p_i2287_2_);
        }
    ...
    {
        public DefenseAttackGoal(ShulkerEntity p_i331_1_)
        {
            super(p_i331_1_, LivingEntity.class, 10, true, false, (p_200826_0_) ->
            {
