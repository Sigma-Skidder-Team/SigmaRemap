...
public class GuardianEntity extends MonsterEntity
{
    ...
    public GuardianEntity(EntityType <? extends GuardianEntity > p_i4020_1_, World p_i4020_2_)
    {
    ...
    static class AttackGoal extends Goal
    {
        ...
        public AttackGoal(GuardianEntity p_i3281_1_)
        {
            this.guardian = p_i3281_1_;
            this.isElder = p_i3281_1_ instanceof ElderGuardianEntity;
    ...
    static class MoveHelperController extends MovementController
    {
        ...
        public MoveHelperController(GuardianEntity p_i3368_1_)
        {
            super(p_i3368_1_);
            this.entityGuardian = p_i3368_1_;
        }
    ...
    static class TargetPredicate implements Predicate<LivingEntity>
    {
        ...
        public TargetPredicate(GuardianEntity p_i1102_1_)
        {
            this.parentEntity = p_i1102_1_;
        }
