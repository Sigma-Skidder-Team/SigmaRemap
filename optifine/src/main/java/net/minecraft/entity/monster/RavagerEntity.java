...
public class RavagerEntity extends AbstractRaiderEntity
{
    ...
    public RavagerEntity(EntityType <? extends RavagerEntity > p_i1383_1_, World p_i1383_2_)
    {
        super(p_i1383_1_, p_i1383_2_);
    ...
    {
        public Navigator(MobEntity p_i956_1_, World p_i956_2_)
        {
            super(p_i956_1_, p_i956_2_);
        }
