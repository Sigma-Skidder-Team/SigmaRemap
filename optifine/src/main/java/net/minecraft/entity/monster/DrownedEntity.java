...
public class DrownedEntity extends ZombieEntity implements IRangedAttackMob
{
    ...
    public DrownedEntity(EntityType <? extends DrownedEntity > p_i2481_1_, World p_i2481_2_)
    {
        super(p_i2481_1_, p_i2481_2_);
        this.stepHeight = 1.0F;
        this.moveController = new DrownedEntity.MoveHelperController(this);
        this.setPathPriority(PathNodeType.WATER, 0.0F);
        this.waterNavigator = new SwimmerPathNavigator(this, p_i2481_2_);
        this.groundNavigator = new GroundPathNavigator(this, p_i2481_2_);
    }
    ...
    static class AttackGoal extends ZombieAttackGoal
    {
        ...
        public AttackGoal(DrownedEntity p_i389_1_, double p_i389_2_, boolean p_i389_4_)
        {
            super(p_i389_1_, p_i389_2_, p_i389_4_);
            this.field_204726_g = p_i389_1_;
        }
    ...
    static class GoToBeachGoal extends MoveToBlockGoal
    {
        ...
        public GoToBeachGoal(DrownedEntity p_i1211_1_, double p_i1211_2_)
        {
            super(p_i1211_1_, p_i1211_2_, 8, 2);
            this.drowned = p_i1211_1_;
        }
    ...
    static class GoToWaterGoal extends Goal
    {
        ...
        public GoToWaterGoal(CreatureEntity p_i2888_1_, double p_i2888_2_)
        {
            this.field_204730_a = p_i2888_1_;
            this.field_204734_e = p_i2888_2_;
            this.field_204735_f = p_i2888_1_.world;
    ...
    static class MoveHelperController extends MovementController
    {
        ...
        public MoveHelperController(DrownedEntity p_i2350_1_)
        {
            super(p_i2350_1_);
            this.drowned = p_i2350_1_;
        }
    ...
    static class SwimUpGoal extends Goal
    {
        ...
        public SwimUpGoal(DrownedEntity p_i2067_1_, double p_i2067_2_, int p_i2067_4_)
        {
            this.field_204736_a = p_i2067_1_;
            this.field_204737_b = p_i2067_2_;
            this.targetY = p_i2067_4_;
        }
    ...
    static class TridentAttackGoal extends RangedAttackGoal
    {
        ...
        public TridentAttackGoal(IRangedAttackMob p_i988_1_, double p_i988_2_, int p_i988_4_, float p_i988_5_)
        {
            super(p_i988_1_, p_i988_2_, p_i988_4_, p_i988_5_);
            this.field_204728_a = (DrownedEntity)p_i988_1_;
        }
