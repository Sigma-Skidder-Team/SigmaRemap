...
public class SlimeEntity extends MobEntity implements IMob
{
    ...
    public SlimeEntity(EntityType <? extends SlimeEntity > ironGolemIn, World p_i1659_2_)
    {
        super(ironGolemIn, p_i1659_2_);
    ...
    static class AttackGoal extends Goal
    {
        ...
        public AttackGoal(SlimeEntity p_i1443_1_)
        {
            this.slime = p_i1443_1_;
    ...
    static class FaceRandomGoal extends Goal
    {
        ...
        public FaceRandomGoal(SlimeEntity p_i3825_1_)
        {
            this.slime = p_i3825_1_;
            this.setMutexFlags(EnumSet.of(Goal.Flag.LOOK));
        }
    ...
    static class FloatGoal extends Goal
    {
        ...
        public FloatGoal(SlimeEntity p_i3432_1_)
        {
            this.slime = p_i3432_1_;
            this.setMutexFlags(EnumSet.of(Goal.Flag.JUMP, Goal.Flag.MOVE));
            p_i3432_1_.getNavigator().setCanSwim(true);
        }
    ...
    static class HopGoal extends Goal
    {
        ...
        public HopGoal(SlimeEntity p_i361_1_)
        {
            this.slime = p_i361_1_;
            this.setMutexFlags(EnumSet.of(Goal.Flag.JUMP, Goal.Flag.MOVE));
        }
    ...
    static class MoveHelperController extends MovementController
    {
        ...
        public MoveHelperController(SlimeEntity p_i1712_1_)
        {
            super(p_i1712_1_);
            this.slime = p_i1712_1_;
            this.yRot = 180.0F * p_i1712_1_.rotationYaw / (float)Math.PI;
        }
