...
public abstract class SpellcastingIllagerEntity extends AbstractIllagerEntity
{
    ...
    protected SpellcastingIllagerEntity(EntityType <? extends SpellcastingIllagerEntity > p_i842_1_, World p_i842_2_)
    {
        super(p_i842_1_, p_i842_2_);
    }
    ...
    public static enum SpellType
    {
        ...
        private SpellType(int p_i1928_3_, double p_i1928_4_, double p_i1928_6_, double p_i1928_8_)
        {
            this.id = p_i1928_3_;
            this.particleSpeed = new double[] {p_i1928_4_, p_i1928_6_, p_i1928_8_};
        }
