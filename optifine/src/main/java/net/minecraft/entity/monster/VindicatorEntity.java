...
public class VindicatorEntity extends AbstractIllagerEntity
{
    ...
    public VindicatorEntity(EntityType <? extends VindicatorEntity > p_i3831_1_, World p_i3831_2_)
    {
        super(p_i3831_1_, p_i3831_2_);
    }
    ...
    {
        public AttackGoal(VindicatorEntity p_i4263_2_)
        {
            super(p_i4263_2_, 1.0D, false);
        }
    ...
    {
        public BreakDoorGoal(MobEntity p_i3346_1_)
        {
            super(p_i3346_1_, 6, VindicatorEntity.field_213681_b);
    ...
    {
        public JohnnyAttackGoal(VindicatorEntity p_i986_1_)
        {
            super(p_i986_1_, LivingEntity.class, 0, true, true, LivingEntity::attackable);
        }
