...
public class PhantomEntity extends FlyingEntity implements IMob
{
    ...
    public PhantomEntity(EntityType <? extends PhantomEntity > p_i3109_1_, World p_i3109_2_)
    {
        super(p_i3109_1_, p_i3109_2_);
    ...
    {
        public BodyHelperController(MobEntity p_i2757_2_)
        {
            super(p_i2757_2_);
        }
    ...
    {
        public LookHelperController(MobEntity p_i1139_2_)
        {
            super(p_i1139_2_);
        }
    ...
    class MoveHelperController extends MovementController
    {
        ...
        public MoveHelperController(MobEntity p_i2913_2_)
        {
            super(p_i2913_2_);
        }
