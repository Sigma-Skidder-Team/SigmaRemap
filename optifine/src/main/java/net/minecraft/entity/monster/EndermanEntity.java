...
public class EndermanEntity extends MonsterEntity
{
    ...
    public EndermanEntity(EntityType <? extends EndermanEntity > p_i501_1_, World p_i501_2_)
    {
        super(p_i501_1_, p_i501_2_);
    ...
    static class FindPlayerGoal extends NearestAttackableTargetGoal<PlayerEntity>
    {
        ...
        public FindPlayerGoal(EndermanEntity p_i975_1_)
        {
            super(p_i975_1_, PlayerEntity.class, false);
            this.enderman = p_i975_1_;
            this.field_220791_m = (new EntityPredicate()).setDistance(this.getTargetDistance()).setCustomPredicate((p_220790_1_) ->
            {
                return p_i975_1_.shouldAttackPlayer((PlayerEntity)p_220790_1_);
            });
        }
    ...
    static class PlaceBlockGoal extends Goal
    {
        ...
        public PlaceBlockGoal(EndermanEntity p_i2829_1_)
        {
            this.enderman = p_i2829_1_;
        }
    ...
    static class StareGoal extends Goal
    {
        ...
        public StareGoal(EndermanEntity p_i4133_1_)
        {
            this.field_220835_a = p_i4133_1_;
    ...
    static class TakeBlockGoal extends Goal
    {
        ...
        public TakeBlockGoal(EndermanEntity p_i2860_1_)
        {
            this.enderman = p_i2860_1_;
        }
