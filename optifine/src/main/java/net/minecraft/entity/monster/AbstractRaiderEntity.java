...
public abstract class AbstractRaiderEntity extends PatrollerEntity
{
    ...
    protected AbstractRaiderEntity(EntityType <? extends AbstractRaiderEntity > p_i2556_1_, World p_i2556_2_)
    {
        super(p_i2556_1_, p_i2556_2_);
    }
    ...
    public class CelebrateRaidLossGoal extends Goal
    {
        ...
        CelebrateRaidLossGoal(AbstractRaiderEntity p_i4231_2_)
        {
            this.field_220858_b = p_i4231_2_;
    ...
    public class FindTargetGoal extends Goal
    {
        ...
        public FindTargetGoal(AbstractIllagerEntity p_i747_2_, float p_i747_3_)
        {
            this.field_220853_c = p_i747_2_;
            this.field_220854_d = p_i747_3_ * p_i747_3_;
    ...
    static class InvadeHomeGoal extends Goal
    {
        ...
        public InvadeHomeGoal(AbstractRaiderEntity entityIn, double worldIn, int p_i1671_4_)
        {
            this.field_220864_a = entityIn;
            this.field_220865_b = worldIn;
            this.field_220868_e = p_i1671_4_;
            this.setMutexFlags(EnumSet.of(Goal.Flag.MOVE));
        }
    ...
    public class PromoteLeaderGoal<T extends AbstractRaiderEntity> extends Goal
    {
        ...
        public PromoteLeaderGoal(T p_i2797_2_)
        {
            this.field_220856_b = p_i2797_2_;
            this.setMutexFlags(EnumSet.of(Goal.Flag.MOVE));
        }
