...
public class ZombiePigmanEntity extends ZombieEntity
{
    ...
    public ZombiePigmanEntity(EntityType <? extends ZombiePigmanEntity > p_i1456_1_, World p_i1456_2_)
    {
        super(p_i1456_1_, p_i1456_2_);
    ...
    {
        public HurtByAggressorGoal(ZombiePigmanEntity p_i3904_1_)
        {
            super(p_i3904_1_);
    ...
    {
        public TargetAggressorGoal(ZombiePigmanEntity p_i3201_1_)
        {
            super(p_i3201_1_, PlayerEntity.class, true);
        }
