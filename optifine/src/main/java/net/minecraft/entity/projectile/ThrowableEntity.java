...
public abstract class ThrowableEntity extends Entity implements IProjectile
{
    ...
    protected ThrowableEntity(EntityType <? extends ThrowableEntity > p_i412_1_, World p_i412_2_)
    {
        super(p_i412_1_, p_i412_2_);
    }

    protected ThrowableEntity(EntityType <? extends ThrowableEntity > p_i413_1_, double p_i413_2_, double p_i413_4_, double p_i413_6_, World p_i413_8_)
    {
        this(p_i413_1_, p_i413_8_);
        this.setPosition(p_i413_2_, p_i413_4_, p_i413_6_);
    }

    protected ThrowableEntity(EntityType <? extends ThrowableEntity > p_i414_1_, LivingEntity p_i414_2_, World p_i414_3_)
    {
        this(p_i414_1_, p_i414_2_.getPosX(), p_i414_2_.getPosYEye() - (double)0.1F, p_i414_2_.getPosZ(), p_i414_3_);
        this.owner = p_i414_2_;
        this.ownerId = p_i414_2_.getUniqueID();
    }
