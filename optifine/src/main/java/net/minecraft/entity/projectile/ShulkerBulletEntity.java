...
public class ShulkerBulletEntity extends Entity
{
    ...
    public ShulkerBulletEntity(EntityType <? extends ShulkerBulletEntity > p_i4062_1_, World p_i4062_2_)
    {
        super(p_i4062_1_, p_i4062_2_);
        this.noClip = true;
    }

    public ShulkerBulletEntity(World p_i4063_1_, double p_i4063_2_, double p_i4063_4_, double p_i4063_6_, double p_i4063_8_, double p_i4063_10_, double p_i4063_12_)
    {
        this(EntityType.SHULKER_BULLET, p_i4063_1_);
        this.setLocationAndAngles(p_i4063_2_, p_i4063_4_, p_i4063_6_, this.rotationYaw, this.rotationPitch);
        this.setMotion(p_i4063_8_, p_i4063_10_, p_i4063_12_);
    }

    public ShulkerBulletEntity(World p_i4064_1_, LivingEntity p_i4064_2_, Entity p_i4064_3_, Direction.Axis p_i4064_4_)
    {
        this(EntityType.SHULKER_BULLET, p_i4064_1_);
        this.owner = p_i4064_2_;
        BlockPos blockpos = new BlockPos(p_i4064_2_);
        double d0 = (double)blockpos.getX() + 0.5D;
        double d1 = (double)blockpos.getY() + 0.5D;
        double d2 = (double)blockpos.getZ() + 0.5D;
        this.setLocationAndAngles(d0, d1, d2, this.rotationYaw, this.rotationPitch);
        this.target = p_i4064_3_;
        this.direction = Direction.UP;
        this.selectNextMoveDirection(p_i4064_4_);
    }
