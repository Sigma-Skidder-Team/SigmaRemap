...
public class FishingBobberEntity extends Entity
{
    ...
    private FishingBobberEntity(World p_i4183_1_, PlayerEntity p_i4183_2_, int p_i4183_3_, int p_i4183_4_)
    {
        super(EntityType.FISHING_BOBBER, p_i4183_1_);
        this.ignoreFrustumCheck = true;
        this.angler = p_i4183_2_;
        this.angler.fishingBobber = this;
        this.luck = Math.max(0, p_i4183_3_);
        this.lureSpeed = Math.max(0, p_i4183_4_);
    }

    public FishingBobberEntity(World p_i4184_1_, PlayerEntity p_i4184_2_, double p_i4184_3_, double p_i4184_5_, double p_i4184_7_)
    {
        this(p_i4184_1_, p_i4184_2_, 0, 0);
        this.setPosition(p_i4184_3_, p_i4184_5_, p_i4184_7_);
        this.prevPosX = this.getPosX();
        this.prevPosY = this.getPosY();
        this.prevPosZ = this.getPosZ();
    }

    public FishingBobberEntity(PlayerEntity p_i4185_1_, World p_i4185_2_, int p_i4185_3_, int p_i4185_4_)
    {
        this(p_i4185_2_, p_i4185_1_, p_i4185_3_, p_i4185_4_);
