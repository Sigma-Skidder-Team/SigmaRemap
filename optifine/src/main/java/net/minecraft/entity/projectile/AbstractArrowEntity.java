...
public abstract class AbstractArrowEntity extends Entity implements IProjectile
{
    ...
    protected AbstractArrowEntity(EntityType <? extends AbstractArrowEntity > p_i1000_1_, World p_i1000_2_)
    {
        super(p_i1000_1_, p_i1000_2_);
    }

    protected AbstractArrowEntity(EntityType <? extends AbstractArrowEntity > p_i1001_1_, double p_i1001_2_, double p_i1001_4_, double p_i1001_6_, World p_i1001_8_)
    {
        this(p_i1001_1_, p_i1001_8_);
        this.setPosition(p_i1001_2_, p_i1001_4_, p_i1001_6_);
    }

    protected AbstractArrowEntity(EntityType <? extends AbstractArrowEntity > p_i1002_1_, LivingEntity p_i1002_2_, World p_i1002_3_)
    {
        this(p_i1002_1_, p_i1002_2_.getPosX(), p_i1002_2_.getPosYEye() - (double)0.1F, p_i1002_2_.getPosZ(), p_i1002_3_);
        this.setShooter(p_i1002_2_);

        if (p_i1002_2_ instanceof PlayerEntity)
        {
