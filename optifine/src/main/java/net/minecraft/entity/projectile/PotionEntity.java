...
public class PotionEntity extends ThrowableEntity implements IRendersAsItem
{
    ...
    public PotionEntity(EntityType <? extends PotionEntity > p_i1392_1_, World p_i1392_2_)
    {
        super(p_i1392_1_, p_i1392_2_);
    }

    public PotionEntity(World p_i1393_1_, LivingEntity p_i1393_2_)
    {
        super(EntityType.POTION, p_i1393_2_, p_i1393_1_);
    }

    public PotionEntity(World p_i1394_1_, double p_i1394_2_, double p_i1394_4_, double p_i1394_6_)
    {
        super(EntityType.POTION, p_i1394_2_, p_i1394_4_, p_i1394_6_, p_i1394_1_);
    }
