...
public class LlamaSpitEntity extends Entity implements IProjectile
{
    ...
    public LlamaSpitEntity(EntityType <? extends LlamaSpitEntity > p_i2080_1_, World p_i2080_2_)
    {
        super(p_i2080_1_, p_i2080_2_);
    }

    public LlamaSpitEntity(World p_i2081_1_, LlamaEntity p_i2081_2_)
    {
        this(EntityType.LLAMA_SPIT, p_i2081_1_);
        this.owner = p_i2081_2_;
        this.setPosition(p_i2081_2_.getPosX() - (double)(p_i2081_2_.getWidth() + 1.0F) * 0.5D * (double)MathHelper.sin(p_i2081_2_.renderYawOffset * ((float)Math.PI / 180F)), p_i2081_2_.getPosYEye() - (double)0.1F, p_i2081_2_.getPosZ() + (double)(p_i2081_2_.getWidth() + 1.0F) * 0.5D * (double)MathHelper.cos(p_i2081_2_.renderYawOffset * ((float)Math.PI / 180F)));
    }

    public LlamaSpitEntity(World p_i2082_1_, double p_i2082_2_, double p_i2082_4_, double p_i2082_6_, double p_i2082_8_, double p_i2082_10_, double p_i2082_12_)
    {
        this(EntityType.LLAMA_SPIT, p_i2082_1_);
        this.setPosition(p_i2082_2_, p_i2082_4_, p_i2082_6_);

        for (int i = 0; i < 7; ++i)
        {
            double d0 = 0.4D + 0.1D * (double)i;
            p_i2082_1_.addParticle(ParticleTypes.SPIT, p_i2082_2_, p_i2082_4_, p_i2082_6_, p_i2082_8_ * d0, p_i2082_10_, p_i2082_12_ * d0);
        }

        this.setMotion(p_i2082_8_, p_i2082_10_, p_i2082_12_);
    }
