...
public class ArrowEntity extends AbstractArrowEntity
{
    ...
    public ArrowEntity(EntityType <? extends ArrowEntity > p_i2992_1_, World p_i2992_2_)
    {
        super(p_i2992_1_, p_i2992_2_);
    }

    public ArrowEntity(World p_i2993_1_, double p_i2993_2_, double p_i2993_4_, double p_i2993_6_)
    {
        super(EntityType.ARROW, p_i2993_2_, p_i2993_4_, p_i2993_6_, p_i2993_1_);
    }

    public ArrowEntity(World p_i2994_1_, LivingEntity p_i2994_2_)
    {
        super(EntityType.ARROW, p_i2994_2_, p_i2994_1_);
    }
