...
public class FoxEntity extends AnimalEntity
{
    ...
    public FoxEntity(EntityType <? extends FoxEntity > p_i1874_1_, World p_i1874_2_)
    {
        super(p_i1874_1_, p_i1874_2_);
    ...
    {
        public BiteGoal(double p_i3188_2_, boolean p_i3188_4_)
        {
            super(FoxEntity.this, p_i3188_2_, p_i3188_4_);
        }
    ...
    public class EatBerriesGoal extends MoveToBlockGoal
    {
        ...
        public EatBerriesGoal(double p_i2616_2_, int p_i2616_4_, int p_i2616_5_)
        {
            super(FoxEntity.this, p_i2616_2_, p_i2616_4_, p_i2616_5_);
        }
    ...
    class FindShelterGoal extends FleeSunGoal
    {
        ...
        public FindShelterGoal(double p_i1855_2_)
        {
            super(FoxEntity.this, p_i1855_2_);
        }
    ...
    class FollowGoal extends FollowParentGoal
    {
        ...
        public FollowGoal(FoxEntity p_i3430_2_, double p_i3430_3_)
        {
            super(p_i3430_2_, p_i3430_3_);
            this.owner = p_i3430_2_;
        }
    ...
    public static class FoxData extends AgeableEntity.AgeableData
    {
        ...
        public FoxData(FoxEntity.Type p_i2379_1_)
        {
            this.func_226259_a_(false);
            this.field_220366_a = p_i2379_1_;
        }
    }
    ...
    {
        public MateGoal(double p_i2487_2_)
        {
            super(FoxEntity.this, p_i2487_2_);
        }
    ...
    {
        public PanicGoal(double p_i4021_2_)
        {
            super(FoxEntity.this, p_i4021_2_);
        }
    ...
    class RevengeGoal extends NearestAttackableTargetGoal<LivingEntity>
    {
        ...
        public RevengeGoal(Class<LivingEntity> p_i2607_2_, boolean p_i2607_3_, boolean p_i2607_4_, @Nullable Predicate<LivingEntity> p_i2607_5_)
        {
            super(FoxEntity.this, p_i2607_2_, 10, p_i2607_3_, p_i2607_4_, p_i2607_5_);
        }
    ...
    {
        public StrollGoal(int p_i3898_2_, int p_i3898_3_)
        {
            super(FoxEntity.this, p_i3898_3_);
        }
    ...
    public static enum Type
    {
        ...
        private Type(int p_i2247_3_, String p_i2247_4_, Biome... p_i2247_5_)
        {
            this.index = p_i2247_3_;
            this.name = p_i2247_4_;
            this.spawnBiomes = Arrays.asList(p_i2247_5_);
        }
    ...
    {
        public WatchGoal(MobEntity p_i4223_2_, Class <? extends LivingEntity > p_i4223_3_, float p_i4223_4_)
        {
            super(p_i4223_2_, p_i4223_3_, p_i4223_4_);
        }
