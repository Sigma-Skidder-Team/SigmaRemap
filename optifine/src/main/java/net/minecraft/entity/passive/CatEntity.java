...
public class CatEntity extends TameableEntity
{
    ...
    public CatEntity(EntityType <? extends CatEntity > p_i1326_1_, World p_i1326_2_)
    {
        super(p_i1326_1_, p_i1326_2_);
    }
    ...
    static class AvoidPlayerGoal<T extends LivingEntity> extends AvoidEntityGoal<T>
    {
        ...
        public AvoidPlayerGoal(CatEntity p_i3069_1_, Class<T> p_i3069_2_, float p_i3069_3_, double p_i3069_4_, double p_i3069_6_)
        {
            super(p_i3069_1_, p_i3069_2_, p_i3069_3_, p_i3069_4_, p_i3069_6_, EntityPredicates.CAN_AI_TARGET::test);
            this.field_220873_i = p_i3069_1_;
        }
    ...
    static class MorningGiftGoal extends Goal
    {
        ...
        public MorningGiftGoal(CatEntity valueIn)
        {
            this.cat = valueIn;
        }
    ...
    static class TemptGoal extends net.minecraft.entity.ai.goal.TemptGoal
    {
        ...
        public TemptGoal(CatEntity p_i446_1_, double p_i446_2_, Ingredient p_i446_4_, boolean p_i446_5_)
        {
            super(p_i446_1_, p_i446_2_, p_i446_4_, p_i446_5_);
            this.cat = p_i446_1_;
        }
