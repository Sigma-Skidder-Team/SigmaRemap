...
public class HorseEntity extends AbstractHorseEntity
{
    ...
    public HorseEntity(EntityType <? extends HorseEntity > p_i1948_1_, World p_i1948_2_)
    {
        super(p_i1948_1_, p_i1948_2_);
    }
    ...
    public AgeableEntity createChild(AgeableEntity ageable)
    {
        ...
        else
        {
            ...
            {
                i = i | horseentity.getHorseVariant() & 65280;
            }
            else
            {
    ...
    public static class HorseData extends AgeableEntity.AgeableData
    {
        ...
        public HorseData(int p_i3803_1_)
        {
            this.variant = p_i3803_1_;
        }
    }
}
