...
public class IronGolemEntity extends GolemEntity
{
    ...
    public IronGolemEntity(EntityType <? extends IronGolemEntity > p_i1193_1_, World p_i1193_2_)
    {
        super(p_i1193_1_, p_i1193_2_);
    ...
    public static enum Cracks
    {
        ...
        private Cracks(float p_i4198_3_)
        {
            this.field_226514_f_ = p_i4198_3_;
        }
