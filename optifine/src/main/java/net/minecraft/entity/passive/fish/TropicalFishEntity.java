...
public class TropicalFishEntity extends AbstractGroupFishEntity
{
    ...
    public TropicalFishEntity(EntityType <? extends TropicalFishEntity > p_i1074_1_, World p_i1074_2_)
    {
        super(p_i1074_1_, p_i1074_2_);
    }
    ...
    static class TropicalFishData extends AbstractGroupFishEntity.GroupData
    {
        ...
        private TropicalFishData(TropicalFishEntity p_i706_1_, int p_i706_2_, int p_i706_3_, int p_i706_4_, int p_i706_5_)
        {
            super(p_i706_1_);
            this.size = p_i706_2_;
            this.pattern = p_i706_3_;
            this.bodyColor = p_i706_4_;
            this.patternColor = p_i706_5_;
        }
    }
    ...
    static enum Type
    {
        ...
        private Type(int p_i2882_3_, int p_i2882_4_)
        {
            this.field_212552_m = p_i2882_3_;
            this.field_212553_n = p_i2882_4_;
        }
