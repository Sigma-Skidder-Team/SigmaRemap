...
public class DolphinEntity extends WaterMobEntity
{
    ...
    public DolphinEntity(EntityType <? extends DolphinEntity > p_i2926_1_, World p_i2926_2_)
    {
        super(p_i2926_1_, p_i2926_2_);
    ...
    static class MoveHelperController extends MovementController
    {
        ...
        public MoveHelperController(DolphinEntity p_i3378_1_)
        {
            super(p_i3378_1_);
            this.dolphin = p_i3378_1_;
        }
    ...
    static class SwimToTreasureGoal extends Goal
    {
        ...
        SwimToTreasureGoal(DolphinEntity p_i2901_1_)
        {
            this.dolphin = p_i2901_1_;
    ...
    static class SwimWithPlayerGoal extends Goal
    {
        ...
        SwimWithPlayerGoal(DolphinEntity p_i4058_1_, double p_i4058_2_)
        {
            this.dolphin = p_i4058_1_;
            this.speed = p_i4058_2_;
            this.setMutexFlags(EnumSet.of(Goal.Flag.MOVE, Goal.Flag.LOOK));
        }
