...
public class PandaEntity extends AnimalEntity
{
    ...
    public PandaEntity(EntityType <? extends PandaEntity > p_i4131_1_, World p_i4131_2_)
    {
        super(p_i4131_1_, p_i4131_2_);
    ...
    static class AttackGoal extends MeleeAttackGoal
    {
        ...
        public AttackGoal(PandaEntity p_i1105_1_, double p_i1105_2_, boolean p_i1105_4_)
        {
            super(p_i1105_1_, p_i1105_2_, p_i1105_4_);
            this.field_220722_d = p_i1105_1_;
        }
    ...
    static class AvoidGoal<T extends LivingEntity> extends AvoidEntityGoal<T>
    {
        ...
        public AvoidGoal(PandaEntity p_i2907_1_, Class<T> p_i2907_2_, float p_i2907_3_, double p_i2907_4_, double p_i2907_6_)
        {
            super(p_i2907_1_, p_i2907_2_, p_i2907_3_, p_i2907_4_, p_i2907_6_, EntityPredicates.NOT_SPECTATING::test);
            this.field_220875_i = p_i2907_1_;
        }
    ...
    static class ChildPlayGoal extends Goal
    {
        ...
        public ChildPlayGoal(PandaEntity p_i1753_1_)
        {
            this.panda = p_i1753_1_;
        }
    ...
    static class LieBackGoal extends Goal
    {
        ...
        public LieBackGoal(PandaEntity p_i3448_1_)
        {
            this.panda = p_i3448_1_;
        }
    ...
    class MateGoal extends BreedGoal
    {
        ...
        public MateGoal(PandaEntity p_i2517_2_, double p_i2517_3_)
        {
            super(p_i2517_2_, p_i2517_3_);
            this.panda = p_i2517_2_;
        }
    ...
    static class MoveHelperController extends MovementController
    {
        ...
        public MoveHelperController(PandaEntity p_i3857_1_)
        {
            super(p_i3857_1_);
            this.panda = p_i3857_1_;
        }
    ...
    static class PanicGoal extends net.minecraft.entity.ai.goal.PanicGoal
    {
        ...
        public PanicGoal(PandaEntity p_i927_1_, double p_i927_2_)
        {
            super(p_i927_1_, p_i927_2_);
            this.panda = p_i927_1_;
        }
    ...
    static class RevengeGoal extends HurtByTargetGoal
    {
        ...
        public RevengeGoal(PandaEntity teSign, Class<?>... p_i1097_2_)
        {
            super(teSign, p_i1097_2_);
            this.panda = teSign;
        }
    ...
    static class RollGoal extends Goal
    {
        ...
        public RollGoal(PandaEntity p_i2351_1_)
        {
            this.panda = p_i2351_1_;
    ...
    public static enum Type
    {
        ...
        private Type(int p_i3014_3_, String p_i3014_4_, boolean p_i3014_5_)
        {
            this.index = p_i3014_3_;
            this.name = p_i3014_4_;
            this.field_221112_k = p_i3014_5_;
        }
    ...
    static class WatchGoal extends LookAtGoal
    {
        ...
        public WatchGoal(PandaEntity p_i2680_1_, Class <? extends LivingEntity > p_i2680_2_, float p_i2680_3_)
        {
            super(p_i2680_1_, p_i2680_2_, p_i2680_3_);
            this.field_220718_f = p_i2680_1_;
        }
