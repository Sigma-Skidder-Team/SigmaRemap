...
public class PufferfishEntity extends AbstractFishEntity
{
    ...
    public PufferfishEntity(EntityType <? extends PufferfishEntity > p_i2989_1_, World p_i2989_2_)
    {
        super(p_i2989_1_, p_i2989_2_);
    }
    ...
    static class PuffGoal extends Goal
    {
        ...
        public PuffGoal(PufferfishEntity p_i403_1_)
        {
            this.fish = p_i403_1_;
        }
