...
public class TurtleEntity extends AnimalEntity
{
    ...
    public TurtleEntity(EntityType <? extends TurtleEntity > p_i2230_1_, World p_i2230_2_)
    {
        super(p_i2230_1_, p_i2230_2_);
    ...
    static class GoHomeGoal extends Goal
    {
        ...
        GoHomeGoal(TurtleEntity p_i3877_1_, double p_i3877_2_)
        {
            this.turtle = p_i3877_1_;
            this.speed = p_i3877_2_;
        }
    ...
    static class GoToWaterGoal extends MoveToBlockGoal
    {
        ...
        private GoToWaterGoal(TurtleEntity p_i3631_1_, double p_i3631_2_)
        {
            super(p_i3631_1_, p_i3631_1_.isChild() ? 2.0D : p_i3631_2_, 24);
            this.turtle = p_i3631_1_;
    ...
    static class LayEggGoal extends MoveToBlockGoal
    {
        ...
        LayEggGoal(TurtleEntity p_i3653_1_, double p_i3653_2_)
        {
            super(p_i3653_1_, p_i3653_2_, 16);
            this.turtle = p_i3653_1_;
        }
    ...
    static class MateGoal extends BreedGoal
    {
        ...
        MateGoal(TurtleEntity p_i488_1_, double p_i488_2_)
        {
            super(p_i488_1_, p_i488_2_);
            this.turtle = p_i488_1_;
        }
    ...
    static class MoveHelperController extends MovementController
    {
        ...
        MoveHelperController(TurtleEntity p_i1776_1_)
        {
            super(p_i1776_1_);
            this.turtle = p_i1776_1_;
        }
    ...
    {
        Navigator(TurtleEntity p_i1411_1_, World p_i1411_2_)
        {
            super(p_i1411_1_, p_i1411_2_);
        }
    ...
    {
        PanicGoal(TurtleEntity p_i4163_1_, double p_i4163_2_)
        {
            super(p_i4163_1_, p_i4163_2_);
        }
    ...
    static class PlayerTemptGoal extends Goal
    {
        ...
        PlayerTemptGoal(TurtleEntity p_i4119_1_, double p_i4119_2_, Item p_i4119_4_)
        {
            this.turtle = p_i4119_1_;
            this.speed = p_i4119_2_;
            this.temptItems = Sets.newHashSet(p_i4119_4_);
    ...
    static class TravelGoal extends Goal
    {
        ...
        TravelGoal(TurtleEntity p_i3359_1_, double p_i3359_2_)
        {
            this.turtle = p_i3359_1_;
            this.field_203138_b = p_i3359_2_;
        }
    ...
    static class WanderGoal extends RandomWalkingGoal
    {
        ...
        private WanderGoal(TurtleEntity p_i3171_1_, double p_i3171_2_, int p_i3171_4_)
        {
            super(p_i3171_1_, p_i3171_2_, p_i3171_4_);
            this.turtle = p_i3171_1_;
        }
