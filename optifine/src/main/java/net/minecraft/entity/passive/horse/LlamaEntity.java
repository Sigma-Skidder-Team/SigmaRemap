...
public class LlamaEntity extends AbstractChestedHorseEntity implements IRangedAttackMob
{
    ...
    public LlamaEntity(EntityType <? extends LlamaEntity > p_i4031_1_, World p_i4031_2_)
    {
        super(p_i4031_1_, p_i4031_2_);
    }
    ...
    {
        public DefendTargetGoal(LlamaEntity p_i3688_1_)
        {
            super(p_i3688_1_, WolfEntity.class, 16, false, true, (p_220789_0_) ->
            {
    ...
    {
        public HurtByTargetGoal(LlamaEntity p_i1155_1_)
        {
            super(p_i1155_1_);
        }
    ...
    static class LlamaData extends AgeableEntity.AgeableData
    {
        ...
        private LlamaData(int p_i1396_1_)
        {
            this.variant = p_i1396_1_;
        }
    }
}
