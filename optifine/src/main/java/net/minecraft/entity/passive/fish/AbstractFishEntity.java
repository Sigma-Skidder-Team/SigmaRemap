...
public abstract class AbstractFishEntity extends WaterMobEntity
{
    ...
    public AbstractFishEntity(EntityType <? extends AbstractFishEntity > p_i2522_1_, World p_i2522_2_)
    {
        super(p_i2522_1_, p_i2522_2_);
    ...
    static class MoveHelperController extends MovementController
    {
        ...
        MoveHelperController(AbstractFishEntity p_i3071_1_)
        {
            super(p_i3071_1_);
            this.fish = p_i3071_1_;
        }
    ...
    static class SwimGoal extends RandomSwimmingGoal
    {
        ...
        public SwimGoal(AbstractFishEntity p_i1142_1_)
        {
            super(p_i1142_1_, 1.0D, 40);
            this.fish = p_i1142_1_;
        }
