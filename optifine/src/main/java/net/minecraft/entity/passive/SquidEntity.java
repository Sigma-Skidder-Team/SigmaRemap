...
public class SquidEntity extends WaterMobEntity
{
    ...
    public SquidEntity(EntityType <? extends SquidEntity > p_i1657_1_, World p_i1657_2_)
    {
        super(p_i1657_1_, p_i1657_2_);
    ...
    class MoveRandomGoal extends Goal
    {
        ...
        public MoveRandomGoal(SquidEntity p_i3780_2_)
        {
            this.squid = p_i3780_2_;
        }
