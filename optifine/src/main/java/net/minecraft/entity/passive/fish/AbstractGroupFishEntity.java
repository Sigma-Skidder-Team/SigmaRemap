...
public abstract class AbstractGroupFishEntity extends AbstractFishEntity
{
    ...
    public AbstractGroupFishEntity(EntityType <? extends AbstractGroupFishEntity > p_i721_1_, World p_i721_2_)
    {
        super(p_i721_1_, p_i721_2_);
    }
    ...
    public static class GroupData implements ILivingEntityData
    {
        ...
        public GroupData(AbstractGroupFishEntity index)
        {
            this.groupLeader = index;
        }
    }
}
