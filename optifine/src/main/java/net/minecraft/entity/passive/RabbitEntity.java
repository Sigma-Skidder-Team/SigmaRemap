...
public class RabbitEntity extends AnimalEntity
{
    ...
    public RabbitEntity(EntityType <? extends RabbitEntity > p_i714_1_, World p_i714_2_)
    {
    ...
    static class AvoidEntityGoal<T extends LivingEntity> extends net.minecraft.entity.ai.goal.AvoidEntityGoal<T>
    {
        ...
        public AvoidEntityGoal(RabbitEntity animal, Class<T> speed, float p_i1626_3_, double p_i1626_4_, double p_i1626_6_)
        {
            super(animal, speed, p_i1626_3_, p_i1626_4_, p_i1626_6_);
            this.rabbit = animal;
        }
    ...
    {
        public EvilAttackGoal(RabbitEntity p_i3209_1_)
        {
            super(p_i3209_1_, 1.4D, true);
        }
    ...
    public class JumpHelperController extends JumpController
    {
        ...
        public JumpHelperController(RabbitEntity p_i2657_2_)
        {
            super(p_i2657_2_);
            this.rabbit = p_i2657_2_;
        }
    ...
    static class MoveHelperController extends MovementController
    {
        ...
        public MoveHelperController(RabbitEntity p_i2109_1_)
        {
            super(p_i2109_1_);
            this.rabbit = p_i2109_1_;
        }
    ...
    static class PanicGoal extends net.minecraft.entity.ai.goal.PanicGoal
    {
        ...
        public PanicGoal(RabbitEntity p_i4168_1_, double p_i4168_2_)
        {
            super(p_i4168_1_, p_i4168_2_);
            this.rabbit = p_i4168_1_;
        }
    ...
    public static class RabbitData extends AgeableEntity.AgeableData
    {
        ...
        public RabbitData(int p_i2618_1_)
        {
            this.typeData = p_i2618_1_;
    ...
    static class RaidFarmGoal extends MoveToBlockGoal
    {
        ...
        public RaidFarmGoal(RabbitEntity p_i3636_1_)
        {
            super(p_i3636_1_, (double)0.7F, 16);
            this.rabbit = p_i3636_1_;
        }
