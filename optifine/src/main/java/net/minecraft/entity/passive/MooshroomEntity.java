...
public class MooshroomEntity extends CowEntity
{
    ...
    public MooshroomEntity(EntityType <? extends MooshroomEntity > p_i1467_1_, World p_i1467_2_)
    {
        super(p_i1467_1_, p_i1467_2_);
    }
    ...
    public static enum Type
    {
        ...
        private Type(String p_i880_3_, BlockState p_i880_4_)
        {
            this.name = p_i880_3_;
            this.renderState = p_i880_4_;
        }
