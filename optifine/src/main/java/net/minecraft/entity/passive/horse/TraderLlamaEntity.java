...
public class TraderLlamaEntity extends LlamaEntity
{
    ...
    public TraderLlamaEntity(EntityType <? extends TraderLlamaEntity > p_i2340_1_, World p_i2340_2_)
    {
        super(p_i2340_1_, p_i2340_2_);
    }
    ...
    public class FollowTraderGoal extends TargetGoal
    {
        ...
        public FollowTraderGoal(LlamaEntity p_i3584_2_)
        {
            super(p_i3584_2_, false);
            this.field_220800_b = p_i3584_2_;
