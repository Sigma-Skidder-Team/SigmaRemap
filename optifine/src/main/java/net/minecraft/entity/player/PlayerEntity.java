...
public abstract class PlayerEntity extends LivingEntity
{
    ...
    public PlayerEntity(World p_i857_1_, GameProfile p_i857_2_)
    {
        super(EntityType.PLAYER, p_i857_1_);
        this.setUniqueId(getUUID(p_i857_2_));
        this.gameProfile = p_i857_2_;
        this.container = new PlayerContainer(this.inventory, !p_i857_1_.isRemote, this);
        this.openContainer = this.container;
        BlockPos blockpos = p_i857_1_.getSpawnPoint();
    ...
    public static enum SleepResult
    {
        ...
        private SleepResult(ITextComponent p_i419_3_)
        {
            this.message = p_i419_3_;
        }
