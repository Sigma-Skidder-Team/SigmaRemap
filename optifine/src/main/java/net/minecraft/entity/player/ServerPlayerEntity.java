...
public class ServerPlayerEntity extends PlayerEntity implements IContainerListener
{
    ...
    public ServerPlayerEntity(MinecraftServer p_i3125_1_, ServerWorld p_i3125_2_, GameProfile p_i3125_3_, PlayerInteractionManager p_i3125_4_)
    {
        super(p_i3125_2_, p_i3125_3_);
        p_i3125_4_.player = this;
        this.interactionManager = p_i3125_4_;
        this.server = p_i3125_1_;
        this.recipeBook = new ServerRecipeBook(p_i3125_1_.getRecipeManager());
        this.stats = p_i3125_1_.getPlayerList().getPlayerStats(this);
        this.advancements = p_i3125_1_.getPlayerList().getPlayerAdvancements(this);
        this.stepHeight = 1.0F;
        this.func_205734_a(p_i3125_2_);
    }
