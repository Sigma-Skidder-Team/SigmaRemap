...
public class VillagerData
{
    ...
    public VillagerData(IVillagerType p_i829_1_, VillagerProfession p_i829_2_, int p_i829_3_)
    {
        this.type = p_i829_1_;
        this.profession = p_i829_2_;
        this.level = Math.max(1, p_i829_3_);
    }

    public VillagerData(Dynamic<?> p_i830_1_)
    {
        this(Registry.VILLAGER_TYPE.getOrDefault(ResourceLocation.tryCreate(p_i830_1_.get("type").asString(""))), Registry.VILLAGER_PROFESSION.getOrDefault(ResourceLocation.tryCreate(p_i830_1_.get("profession").asString(""))), p_i830_1_.get("level").asInt(1));
    }
