...
public class VillagerTrades
{
    ...
    static class DyedArmorForEmeraldsTrade implements VillagerTrades.ITrade
    {
        ...
        public DyedArmorForEmeraldsTrade(Item p_i1516_1_, int p_i1516_2_)
        {
            this(p_i1516_1_, p_i1516_2_, 12, 1);
        }

        public DyedArmorForEmeraldsTrade(Item p_i1517_1_, int p_i1517_2_, int p_i1517_3_, int p_i1517_4_)
        {
            this.tradeItem = p_i1517_1_;
            this.price = p_i1517_2_;
            this.maxUses = p_i1517_3_;
            this.xpValue = p_i1517_4_;
        }
    ...
    static class EmeraldForItemsTrade implements VillagerTrades.ITrade
    {
        ...
        public EmeraldForItemsTrade(IItemProvider p_i4178_1_, int p_i4178_2_, int p_i4178_3_, int p_i4178_4_)
        {
            this.tradeItem = p_i4178_1_.asItem();
            this.count = p_i4178_2_;
            this.maxUses = p_i4178_3_;
            this.xpValue = p_i4178_4_;
    ...
    static class EmeraldForMapTrade implements VillagerTrades.ITrade
    {
        ...
        public EmeraldForMapTrade(int p_i1299_1_, String p_i1299_2_, MapDecoration.Type p_i1299_3_, int p_i1299_4_, int p_i1299_5_)
        {
            this.count = p_i1299_1_;
            this.structureName = p_i1299_2_;
            this.mapDecorationType = p_i1299_3_;
            this.maxUses = p_i1299_4_;
            this.xpValue = p_i1299_5_;
        }
    ...
    static class EmeraldForVillageTypeItemTrade implements VillagerTrades.ITrade
    {
        ...
        public EmeraldForVillageTypeItemTrade(int p_i1944_1_, int p_i1944_2_, int p_i1944_3_, Map<IVillagerType, Item> p_i1944_4_)
        {
            Registry.VILLAGER_TYPE.stream().filter((p_221188_1_) ->
            {
                return !p_i1944_4_.containsKey(p_221188_1_);
            ...
            this.villagerTypeItems = p_i1944_4_;
            this.field_221191_b = p_i1944_1_;
            this.maxUses = p_i1944_2_;
            this.xpValue = p_i1944_3_;
        }
    ...
    static class EnchantedBookForEmeraldsTrade implements VillagerTrades.ITrade
    {
        ...
        public EnchantedBookForEmeraldsTrade(int p_i3348_1_)
        {
            this.xpValue = p_i3348_1_;
        }
    ...
    static class EnchantedItemForEmeraldsTrade implements VillagerTrades.ITrade
    {
        ...
        public EnchantedItemForEmeraldsTrade(Item p_i4060_1_, int p_i4060_2_, int p_i4060_3_, int p_i4060_4_)
        {
            this(p_i4060_1_, p_i4060_2_, p_i4060_3_, p_i4060_4_, 0.05F);
        }

        public EnchantedItemForEmeraldsTrade(Item p_i4061_1_, int p_i4061_2_, int p_i4061_3_, int p_i4061_4_, float p_i4061_5_)
        {
            this.sellingStack = new ItemStack(p_i4061_1_);
            this.emeraldCount = p_i4061_2_;
            this.maxUses = p_i4061_3_;
            this.xpValue = p_i4061_4_;
            this.priceMultiplier = p_i4061_5_;
        }
    ...
    static class ItemWithPotionForEmeraldsAndItemsTrade implements VillagerTrades.ITrade
    {
        ...
        public ItemWithPotionForEmeraldsAndItemsTrade(Item p_i1997_1_, int p_i1997_2_, Item p_i1997_3_, int p_i1997_4_, int p_i1997_5_, int p_i1997_6_, int p_i1997_7_)
        {
            this.potionStack = new ItemStack(p_i1997_3_);
            this.emeraldCount = p_i1997_5_;
            this.maxUses = p_i1997_6_;
            this.xpValue = p_i1997_7_;
            this.buyingItem = p_i1997_1_;
            this.buyingItemCount = p_i1997_2_;
            this.potionCount = p_i1997_4_;
            this.priceMultiplier = 0.05F;
        }
    ...
    static class ItemsForEmeraldsAndItemsTrade implements VillagerTrades.ITrade
    {
        ...
        public ItemsForEmeraldsAndItemsTrade(IItemProvider p_i2213_1_, int p_i2213_2_, Item p_i2213_3_, int p_i2213_4_, int p_i2213_5_, int p_i2213_6_)
        {
            this(p_i2213_1_, p_i2213_2_, 1, p_i2213_3_, p_i2213_4_, p_i2213_5_, p_i2213_6_);
        }

        public ItemsForEmeraldsAndItemsTrade(IItemProvider p_i2214_1_, int p_i2214_2_, int p_i2214_3_, Item p_i2214_4_, int p_i2214_5_, int p_i2214_6_, int p_i2214_7_)
        {
            this.buyingItem = new ItemStack(p_i2214_1_);
            this.buyingItemCount = p_i2214_2_;
            this.emeraldCount = p_i2214_3_;
            this.sellingItem = new ItemStack(p_i2214_4_);
            this.sellingItemCount = p_i2214_5_;
            this.maxUses = p_i2214_6_;
            this.xpValue = p_i2214_7_;
            this.priceMultiplier = 0.05F;
        }
    ...
    static class ItemsForEmeraldsTrade implements VillagerTrades.ITrade
    {
        ...
        public ItemsForEmeraldsTrade(Block p_i2896_1_, int p_i2896_2_, int p_i2896_3_, int p_i2896_4_, int p_i2896_5_)
        {
            this(new ItemStack(p_i2896_1_), p_i2896_2_, p_i2896_3_, p_i2896_4_, p_i2896_5_);
        }

        public ItemsForEmeraldsTrade(Item p_i2897_1_, int p_i2897_2_, int p_i2897_3_, int p_i2897_4_)
        {
            this(new ItemStack(p_i2897_1_), p_i2897_2_, p_i2897_3_, 12, p_i2897_4_);
        }

        public ItemsForEmeraldsTrade(Item p_i2898_1_, int p_i2898_2_, int p_i2898_3_, int p_i2898_4_, int p_i2898_5_)
        {
            this(new ItemStack(p_i2898_1_), p_i2898_2_, p_i2898_3_, p_i2898_4_, p_i2898_5_);
        }

        public ItemsForEmeraldsTrade(ItemStack p_i2899_1_, int p_i2899_2_, int p_i2899_3_, int p_i2899_4_, int p_i2899_5_)
        {
            this(p_i2899_1_, p_i2899_2_, p_i2899_3_, p_i2899_4_, p_i2899_5_, 0.05F);
        }

        public ItemsForEmeraldsTrade(ItemStack p_i2900_1_, int p_i2900_2_, int p_i2900_3_, int p_i2900_4_, int p_i2900_5_, float p_i2900_6_)
        {
            this.field_221208_a = p_i2900_1_;
            this.emeraldCount = p_i2900_2_;
            this.field_221210_c = p_i2900_3_;
            this.field_221211_d = p_i2900_4_;
            this.field_221212_e = p_i2900_5_;
            this.field_221213_f = p_i2900_6_;
        }
    ...
    static class SuspiciousStewForEmeraldTrade implements VillagerTrades.ITrade
    {
        ...
        public SuspiciousStewForEmeraldTrade(Effect p_i3806_1_, int p_i3806_2_, int p_i3806_3_)
        {
            this.effect = p_i3806_1_;
            this.duration = p_i3806_2_;
            this.xpValue = p_i3806_3_;
            this.priceMultiplier = 0.05F;
        }
