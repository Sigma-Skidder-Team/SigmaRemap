...
public class VillagerEntity extends AbstractVillagerEntity implements IReputationTracking, IVillagerDataHolder
{
    ...
    public VillagerEntity(EntityType <? extends VillagerEntity > p_i4166_1_, World p_i4166_2_)
    {
        this(p_i4166_1_, p_i4166_2_, IVillagerType.PLAINS);
    }

    public VillagerEntity(EntityType <? extends VillagerEntity > p_i4167_1_, World p_i4167_2_, IVillagerType p_i4167_3_)
    {
        super(p_i4167_1_, p_i4167_2_);
        ((GroundPathNavigator)this.getNavigator()).setBreakDoors(true);
        this.getNavigator().setCanSwim(true);
        this.setCanPickUpLoot(true);
        this.setVillagerData(this.getVillagerData().withType(p_i4167_3_).withProfession(VillagerProfession.NONE));
