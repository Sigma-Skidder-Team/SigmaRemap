...
public class WanderingTraderEntity extends AbstractVillagerEntity
{
    ...
    public WanderingTraderEntity(EntityType <? extends WanderingTraderEntity > p_i321_1_, World p_i321_2_)
    {
        super(p_i321_1_, p_i321_2_);
    ...
    class MoveToGoal extends Goal
    {
        ...
        MoveToGoal(WanderingTraderEntity p_i1736_2_, double p_i1736_3_, double p_i1736_5_)
        {
            this.traderEntity = p_i1736_2_;
            this.maxDistance = p_i1736_3_;
            this.speed = p_i1736_5_;
