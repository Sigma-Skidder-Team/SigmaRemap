...
public abstract class MobEntity extends LivingEntity
{
    ...
    protected MobEntity(EntityType <? extends MobEntity > p_i216_1_, World p_i216_2_)
    {
        super(p_i216_1_, p_i216_2_);
        this.goalSelector = new GoalSelector(p_i216_2_ != null && p_i216_2_.getProfiler() != null ? p_i216_2_.getProfiler() : null);
        this.targetSelector = new GoalSelector(p_i216_2_ != null && p_i216_2_.getProfiler() != null ? p_i216_2_.getProfiler() : null);
    ...
    public void checkDespawn()
    {
        ...
        else if (!this.isNoDespawnRequired() && !this.preventDespawn())
        {
            ...
            {
                Object object = Reflector.ForgeEventFactory_canEntityDespawn.call(this);
    ...
    public boolean attackEntityAsMob(Entity entityIn)
    {
        ...
        if (flag)
        {
            ...
            if (entityIn instanceof PlayerEntity)
            {
                ...
                boolean flag1 = ReflectorForge.canDisableShield(itemstack, itemstack1, playerentity, this);
                boolean flag2 = ReflectorForge.isShield(itemstack1, playerentity);

                if (!itemstack.isEmpty() && !itemstack1.isEmpty() && flag1 && flag2)
                {
                    float f2 = 0.25F + (float)EnchantmentHelper.getEfficiencyModifier(this) * 0.05F;

                    if (this.rand.nextFloat() < f2)
                    {
                        playerentity.getCooldownTracker().setCooldown(itemstack1.getItem(), 100);
