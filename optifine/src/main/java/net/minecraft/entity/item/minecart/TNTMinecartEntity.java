...
public class TNTMinecartEntity extends AbstractMinecartEntity
{
    ...
    public TNTMinecartEntity(EntityType <? extends TNTMinecartEntity > p_i2528_1_, World p_i2528_2_)
    {
        super(p_i2528_1_, p_i2528_2_);
    }

    public TNTMinecartEntity(World p_i2529_1_, double p_i2529_2_, double p_i2529_4_, double p_i2529_6_)
    {
        super(EntityType.TNT_MINECART, p_i2529_1_, p_i2529_2_, p_i2529_4_, p_i2529_6_);
    }
