...
public class FireworkRocketEntity extends Entity implements IRendersAsItem, IProjectile
{
    ...
    public FireworkRocketEntity(EntityType <? extends FireworkRocketEntity > p_i3624_1_, World p_i3624_2_)
    {
        super(p_i3624_1_, p_i3624_2_);
    }
    ...
    public FireworkRocketEntity(World p_i3625_1_, double p_i3625_2_, double p_i3625_4_, double p_i3625_6_, ItemStack p_i3625_8_)
    {
        super(EntityType.FIREWORK_ROCKET, p_i3625_1_);
        this.fireworkAge = 0;
        this.setPosition(p_i3625_2_, p_i3625_4_, p_i3625_6_);
        int i = 1;

        if (!p_i3625_8_.isEmpty() && p_i3625_8_.hasTag())
        {
            this.dataManager.set(FIREWORK_ITEM, p_i3625_8_.copy());
            i += p_i3625_8_.getOrCreateChildTag("Fireworks").getByte("Flight");
        }
    ...
    public FireworkRocketEntity(World p_i3626_1_, ItemStack p_i3626_2_, LivingEntity p_i3626_3_)
    {
        this(p_i3626_1_, p_i3626_3_.getPosX(), p_i3626_3_.getPosY(), p_i3626_3_.getPosZ(), p_i3626_2_);
        this.dataManager.set(BOOSTED_ENTITY_ID, OptionalInt.of(p_i3626_3_.getEntityId()));
        this.boostedEntity = p_i3626_3_;
    }

    public FireworkRocketEntity(World p_i3627_1_, ItemStack p_i3627_2_, double p_i3627_3_, double p_i3627_5_, double p_i3627_7_, boolean p_i3627_9_)
    {
        this(p_i3627_1_, p_i3627_3_, p_i3627_5_, p_i3627_7_, p_i3627_2_);
        this.dataManager.set(field_213895_d, p_i3627_9_);
    }
