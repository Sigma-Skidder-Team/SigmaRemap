...
public class BoatEntity extends Entity
{
    ...
    public BoatEntity(EntityType <? extends BoatEntity > p_i2266_1_, World p_i2266_2_)
    {
        super(p_i2266_1_, p_i2266_2_);
        this.preventEntitySpawning = true;
    }

    public BoatEntity(World p_i2267_1_, double p_i2267_2_, double p_i2267_4_, double p_i2267_6_)
    {
        this(EntityType.BOAT, p_i2267_1_);
        this.setPosition(p_i2267_2_, p_i2267_4_, p_i2267_6_);
        this.setMotion(Vec3d.ZERO);
        this.prevPosX = p_i2267_2_;
        this.prevPosY = p_i2267_4_;
        this.prevPosZ = p_i2267_6_;
    }
    ...
    public static enum Type
    {
        ...
        private Type(Block p_i424_3_, String p_i424_4_)
        {
            this.name = p_i424_4_;
            this.block = p_i424_3_;
        }
