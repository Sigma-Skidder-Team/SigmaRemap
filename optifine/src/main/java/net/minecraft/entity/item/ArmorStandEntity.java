...
public class ArmorStandEntity extends LivingEntity
{
    ...
    public ArmorStandEntity(EntityType <? extends ArmorStandEntity > p_i4234_1_, World p_i4234_2_)
    {
        super(p_i4234_1_, p_i4234_2_);
        this.stepHeight = 0.0F;
    }

    public ArmorStandEntity(World p_i4235_1_, double p_i4235_2_, double p_i4235_4_, double p_i4235_6_)
    {
        this(EntityType.ARMOR_STAND, p_i4235_1_);
        this.setPosition(p_i4235_2_, p_i4235_4_, p_i4235_6_);
    }
