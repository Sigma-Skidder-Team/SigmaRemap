...
public class ItemFrameEntity extends HangingEntity
{
    ...
    public ItemFrameEntity(EntityType <? extends ItemFrameEntity > p_i632_1_, World p_i632_2_)
    {
        super(p_i632_1_, p_i632_2_);
    }

    public ItemFrameEntity(World p_i633_1_, BlockPos p_i633_2_, Direction p_i633_3_)
    {
        super(EntityType.ITEM_FRAME, p_i633_1_, p_i633_2_);
        this.updateFacingWithBoundingBox(p_i633_3_);
    }
