...
public class ItemEntity extends Entity
{
    ...
    public ItemEntity(EntityType <? extends ItemEntity > p_i3055_1_, World p_i3055_2_)
    {
        super(p_i3055_1_, p_i3055_2_);
    }

    public ItemEntity(World p_i3056_1_, double p_i3056_2_, double p_i3056_4_, double p_i3056_6_)
    {
        this(EntityType.ITEM, p_i3056_1_);
        this.setPosition(p_i3056_2_, p_i3056_4_, p_i3056_6_);
        this.rotationYaw = this.rand.nextFloat() * 360.0F;
        this.setMotion(this.rand.nextDouble() * 0.2D - 0.1D, 0.2D, this.rand.nextDouble() * 0.2D - 0.1D);
    }

    public ItemEntity(World p_i3057_1_, double p_i3057_2_, double p_i3057_4_, double p_i3057_6_, ItemStack p_i3057_8_)
    {
        this(p_i3057_1_, p_i3057_2_, p_i3057_4_, p_i3057_6_);
        this.setItem(p_i3057_8_);
    }
