...
public class EnderCrystalEntity extends Entity
{
    ...
    public EnderCrystalEntity(EntityType <? extends EnderCrystalEntity > p_i1543_1_, World p_i1543_2_)
    {
    ...
    public EnderCrystalEntity(World p_i1544_1_, double p_i1544_2_, double p_i1544_4_, double p_i1544_6_)
    {
        this(EntityType.END_CRYSTAL, p_i1544_1_);
        this.setPosition(p_i1544_2_, p_i1544_4_, p_i1544_6_);
    }
