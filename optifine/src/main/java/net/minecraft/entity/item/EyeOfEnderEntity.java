...
public class EyeOfEnderEntity extends Entity implements IRendersAsItem
{
    ...
    public EyeOfEnderEntity(EntityType <? extends EyeOfEnderEntity > p_i3992_1_, World p_i3992_2_)
    {
        super(p_i3992_1_, p_i3992_2_);
    }

    public EyeOfEnderEntity(World p_i3993_1_, double p_i3993_2_, double p_i3993_4_, double p_i3993_6_)
    {
        this(EntityType.EYE_OF_ENDER, p_i3993_1_);
        this.despawnTimer = 0;
        this.setPosition(p_i3993_2_, p_i3993_4_, p_i3993_6_);
    }
