...
public class FurnaceMinecartEntity extends AbstractMinecartEntity
{
    ...
    public FurnaceMinecartEntity(EntityType <? extends FurnaceMinecartEntity > p_i2819_1_, World p_i2819_2_)
    {
        super(p_i2819_1_, p_i2819_2_);
    }

    public FurnaceMinecartEntity(World p_i2820_1_, double p_i2820_2_, double p_i2820_4_, double p_i2820_6_)
    {
        super(EntityType.FURNACE_MINECART, p_i2820_1_, p_i2820_2_, p_i2820_4_, p_i2820_6_);
    }
