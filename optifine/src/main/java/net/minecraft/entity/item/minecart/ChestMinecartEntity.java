...
{
    public ChestMinecartEntity(EntityType <? extends ChestMinecartEntity > p_i2488_1_, World p_i2488_2_)
    {
        super(p_i2488_1_, p_i2488_2_);
    }

    public ChestMinecartEntity(World p_i2489_1_, double p_i2489_2_, double p_i2489_4_, double p_i2489_6_)
    {
        super(EntityType.CHEST_MINECART, p_i2489_2_, p_i2489_4_, p_i2489_6_, p_i2489_1_);
    }
