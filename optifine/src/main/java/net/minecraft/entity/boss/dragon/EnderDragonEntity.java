...
public class EnderDragonEntity extends MobEntity implements IMob
{
    ...
    public EnderDragonEntity(EntityType <? extends EnderDragonEntity > p_i1974_1_, World p_i1974_2_)
    {
        super(EntityType.ENDER_DRAGON, p_i1974_2_);
        ...
        if (!p_i1974_2_.isRemote && p_i1974_2_.dimension instanceof EndDimension)
        {
            this.fightManager = ((EndDimension)p_i1974_2_.dimension).getDragonFightManager();
        }
        else
        {
