...
public class GatherPOITask extends Task<CreatureEntity>
{
    ...
    public GatherPOITask(PointOfInterestType p_i437_1_, MemoryModuleType<GlobalPos> p_i437_2_, boolean p_i437_3_)
    {
        super(ImmutableMap.of(p_i437_2_, MemoryModuleStatus.VALUE_ABSENT));
        this.field_220604_a = p_i437_1_;
        this.field_220605_b = p_i437_2_;
        this.field_220606_c = p_i437_3_;
    }
