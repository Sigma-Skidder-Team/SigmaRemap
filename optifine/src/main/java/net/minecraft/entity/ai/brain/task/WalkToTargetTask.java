...
public class WalkToTargetTask extends Task<MobEntity>
{
    ...
    public WalkToTargetTask(int p_i596_1_)
    {
        super(ImmutableMap.of(MemoryModuleType.PATH, MemoryModuleStatus.VALUE_ABSENT, MemoryModuleType.WALK_TARGET, MemoryModuleStatus.VALUE_PRESENT), p_i596_1_);
    }
