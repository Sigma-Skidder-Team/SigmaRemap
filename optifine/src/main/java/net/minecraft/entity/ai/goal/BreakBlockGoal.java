...
public class BreakBlockGoal extends MoveToBlockGoal
{
    ...
    public BreakBlockGoal(Block p_i3064_1_, CreatureEntity p_i3064_2_, double p_i3064_3_, int p_i3064_5_)
    {
        super(p_i3064_2_, p_i3064_3_, 24, p_i3064_5_);
        this.block = p_i3064_1_;
        this.entity = p_i3064_2_;
    }
