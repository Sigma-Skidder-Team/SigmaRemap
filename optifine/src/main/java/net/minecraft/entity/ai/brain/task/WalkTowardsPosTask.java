...
public class WalkTowardsPosTask extends Task<CreatureEntity>
{
    ...
    public WalkTowardsPosTask(MemoryModuleType<GlobalPos> p_i1539_1_, int p_i1539_2_, int p_i1539_3_)
    {
        super(ImmutableMap.of(MemoryModuleType.WALK_TARGET, MemoryModuleStatus.REGISTERED, p_i1539_1_, MemoryModuleStatus.VALUE_PRESENT));
        this.field_220581_a = p_i1539_1_;
        this.field_220582_b = p_i1539_2_;
        this.field_220583_c = p_i1539_3_;
    }
