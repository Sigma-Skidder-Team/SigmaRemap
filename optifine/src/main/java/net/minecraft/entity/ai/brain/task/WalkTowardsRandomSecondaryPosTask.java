...
public class WalkTowardsRandomSecondaryPosTask extends Task<VillagerEntity>
{
    ...
    public WalkTowardsRandomSecondaryPosTask(MemoryModuleType<List<GlobalPos>> p_i3546_1_, float p_i3546_2_, int p_i3546_3_, int p_i3546_4_, MemoryModuleType<GlobalPos> p_i3546_5_)
    {
        super(ImmutableMap.of(MemoryModuleType.WALK_TARGET, MemoryModuleStatus.REGISTERED, p_i3546_1_, MemoryModuleStatus.VALUE_PRESENT, p_i3546_5_, MemoryModuleStatus.VALUE_PRESENT));
        this.field_220573_a = p_i3546_1_;
        this.field_220575_c = p_i3546_2_;
        this.field_220576_d = p_i3546_3_;
        this.field_220577_e = p_i3546_4_;
        this.field_220574_b = p_i3546_5_;
    }
