...
public class MultiTask<E extends LivingEntity> extends Task<E>
{
    ...
    public MultiTask(Map < MemoryModuleType<?>, MemoryModuleStatus > p_i634_1_, Set < MemoryModuleType<? >> p_i634_2_, MultiTask.Ordering p_i634_3_, MultiTask.RunType p_i634_4_, List < Pair < Task <? super E > , Integer >> p_i634_5_)
    {
        super(p_i634_1_);
        this.field_220416_b = p_i634_2_;
        this.field_220417_c = p_i634_3_;
        this.field_220418_d = p_i634_4_;
        p_i634_5_.forEach((p_220411_1_) ->
        {
    ...
    static enum Ordering
    {
        ...
        private Ordering(Consumer < WeightedList<? >> p_i4164_3_)
        {
            this.field_220629_c = p_i4164_3_;
        }
