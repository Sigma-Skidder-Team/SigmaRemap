...
public class ShowWaresTask extends Task<VillagerEntity>
{
    ...
    public ShowWaresTask(int p_i753_1_, int p_i753_2_)
    {
        super(ImmutableMap.of(MemoryModuleType.INTERACTION_TARGET, MemoryModuleStatus.VALUE_PRESENT), p_i753_1_, p_i753_2_);
    }
