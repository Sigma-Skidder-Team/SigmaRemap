...
public class FleeTask extends Task<CreatureEntity>
{
    ...
    public FleeTask(MemoryModuleType <? extends Entity > p_i519_1_, float p_i519_2_)
    {
        super(ImmutableMap.of(MemoryModuleType.WALK_TARGET, MemoryModuleStatus.VALUE_ABSENT, p_i519_1_, MemoryModuleStatus.VALUE_PRESENT));
        this.field_220541_a = p_i519_1_;
        this.field_220542_b = p_i519_2_;
    }
