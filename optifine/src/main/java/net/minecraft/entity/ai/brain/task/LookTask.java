...
{
    public LookTask(int p_i1445_1_, int p_i1445_2_)
    {
        super(ImmutableMap.of(MemoryModuleType.LOOK_TARGET, MemoryModuleStatus.VALUE_PRESENT), p_i1445_1_, p_i1445_2_);
    }
