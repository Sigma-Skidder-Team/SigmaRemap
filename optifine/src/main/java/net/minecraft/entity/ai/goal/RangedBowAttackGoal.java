...
public class RangedBowAttackGoal<T extends MonsterEntity & IRangedAttackMob> extends Goal
{
    ...
    public RangedBowAttackGoal(T p_i3970_1_, double p_i3970_2_, int p_i3970_4_, float p_i3970_5_)
    {
        this.entity = p_i3970_1_;
        this.moveSpeedAmp = p_i3970_2_;
        this.attackCooldown = p_i3970_4_;
        this.maxAttackDistance = p_i3970_5_ * p_i3970_5_;
