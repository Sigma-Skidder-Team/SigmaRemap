...
public class ModifiableAttributeInstance implements IAttributeInstance
{
    ...
    public ModifiableAttributeInstance(AbstractAttributeMap p_i477_1_, IAttribute p_i477_2_)
    {
        this.attributeMap = p_i477_1_;
        this.genericAttribute = p_i477_2_;
        this.baseValue = p_i477_2_.getDefaultValue();
