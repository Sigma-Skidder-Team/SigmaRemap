...
public class LookAtEntityTask extends Task<LivingEntity>
{
    ...
    public LookAtEntityTask(EntityClassification p_i895_1_, float p_i895_2_)
    {
        this((p_220514_1_) ->
        {
            return p_i895_1_.equals(p_220514_1_.getType().getClassification());
        }, p_i895_2_);
    }

    public LookAtEntityTask(EntityType<?> p_i896_1_, float p_i896_2_)
    {
        this((p_220518_1_) ->
        {
            return p_i896_1_.equals(p_220518_1_.getType());
        }, p_i896_2_);
    }

    public LookAtEntityTask(Predicate<LivingEntity> p_i897_1_, float p_i897_2_)
    {
        ...
        this.field_220519_a = p_i897_1_;
        this.field_220520_b = p_i897_2_ * p_i897_2_;
    }
