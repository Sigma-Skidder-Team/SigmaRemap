...
public class FindInteractionAndLookTargetTask extends Task<LivingEntity>
{
    ...
    public FindInteractionAndLookTargetTask(EntityType<?> p_i3215_1_, int p_i3215_2_, Predicate<LivingEntity> p_i3215_3_, Predicate<LivingEntity> p_i3215_4_)
    {
        ...
        this.field_220533_a = p_i3215_1_;
        this.field_220534_b = p_i3215_2_ * p_i3215_2_;
        this.field_220535_c = p_i3215_4_;
        this.field_220536_d = p_i3215_3_;
    }

    public FindInteractionAndLookTargetTask(EntityType<?> p_i3216_1_, int p_i3216_2_)
    {
        this(p_i3216_1_, p_i3216_2_, (p_220528_0_) ->
        {
            return true;
        }, (p_220531_0_) ->
        {
