...
public class FollowOwnerGoal extends Goal
{
    ...
    public FollowOwnerGoal(TameableEntity p_i2908_1_, double p_i2908_2_, float p_i2908_4_, float p_i2908_5_, boolean p_i2908_6_)
    {
        this.tameable = p_i2908_1_;
        this.world = p_i2908_1_.world;
        this.followSpeed = p_i2908_2_;
        this.navigator = p_i2908_1_.getNavigator();
        this.minDist = p_i2908_4_;
        this.maxDist = p_i2908_5_;
        this.field_226326_j_ = p_i2908_6_;
        this.setMutexFlags(EnumSet.of(Goal.Flag.MOVE, Goal.Flag.LOOK));

        if (!(p_i2908_1_.getNavigator() instanceof GroundPathNavigator) && !(p_i2908_1_.getNavigator() instanceof FlyingPathNavigator))
        {
