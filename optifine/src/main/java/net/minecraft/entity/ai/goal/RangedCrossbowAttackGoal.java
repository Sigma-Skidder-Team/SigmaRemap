...
public class RangedCrossbowAttackGoal<T extends MonsterEntity & IRangedAttackMob & ICrossbowUser> extends Goal
{
    ...
    public RangedCrossbowAttackGoal(T p_i2474_1_, double p_i2474_2_, float p_i2474_4_)
    {
        this.field_220748_a = p_i2474_1_;
        this.field_220750_c = p_i2474_2_;
        this.field_220751_d = p_i2474_4_ * p_i2474_4_;
