...
public class ExpirePOITask extends Task<LivingEntity>
{
    ...
    public ExpirePOITask(PointOfInterestType p_i1018_1_, MemoryModuleType<GlobalPos> p_i1018_2_)
    {
        super(ImmutableMap.of(p_i1018_2_, MemoryModuleStatus.VALUE_PRESENT));
        this.field_220592_b = p_i1018_1_.func_221045_c();
        this.field_220591_a = p_i1018_2_;
    }
