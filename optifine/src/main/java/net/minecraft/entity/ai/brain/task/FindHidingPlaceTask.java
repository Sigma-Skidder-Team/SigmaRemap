...
public class FindHidingPlaceTask extends Task<LivingEntity>
{
    ...
    public FindHidingPlaceTask(int p_i1028_1_, float p_i1028_2_, int p_i1028_3_)
    {
        ...
        this.field_220458_b = p_i1028_1_;
        this.field_220457_a = p_i1028_2_;
        this.field_220459_c = p_i1028_3_;
    }
