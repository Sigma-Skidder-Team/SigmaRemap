...
public class MoveThroughVillageGoal extends Goal
{
    ...
    public MoveThroughVillageGoal(CreatureEntity p_i2711_1_, double p_i2711_2_, boolean p_i2711_4_, int p_i2711_5_, BooleanSupplier p_i2711_6_)
    {
        this.entity = p_i2711_1_;
        this.movementSpeed = p_i2711_2_;
        this.isNocturnal = p_i2711_4_;
        this.maxDistance = p_i2711_5_;
        this.booleanSupplier = p_i2711_6_;
        this.setMutexFlags(EnumSet.of(Goal.Flag.MOVE));

        if (!(p_i2711_1_.getNavigator() instanceof GroundPathNavigator))
        {
