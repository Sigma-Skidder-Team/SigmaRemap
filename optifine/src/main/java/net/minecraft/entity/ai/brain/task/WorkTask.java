...
public class WorkTask extends Task<CreatureEntity>
{
    ...
    public WorkTask(MemoryModuleType<GlobalPos> p_i3227_1_, int p_i3227_2_)
    {
        super(ImmutableMap.of(MemoryModuleType.WALK_TARGET, MemoryModuleStatus.REGISTERED, p_i3227_1_, MemoryModuleStatus.VALUE_PRESENT));
        this.field_220565_a = p_i3227_1_;
        this.field_220567_c = p_i3227_2_;
    }
