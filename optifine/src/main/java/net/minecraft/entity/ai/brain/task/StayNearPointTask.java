...
public class StayNearPointTask extends Task<VillagerEntity>
{
    ...
    public StayNearPointTask(MemoryModuleType<GlobalPos> p_i2112_1_, float p_i2112_2_, int p_i2112_3_, int p_i2112_4_, int p_i2112_5_)
    {
        super(ImmutableMap.of(MemoryModuleType.CANT_REACH_WALK_TARGET_SINCE, MemoryModuleStatus.REGISTERED, MemoryModuleType.WALK_TARGET, MemoryModuleStatus.VALUE_ABSENT, p_i2112_1_, MemoryModuleStatus.VALUE_PRESENT));
        this.field_220548_a = p_i2112_1_;
        this.field_220549_b = p_i2112_2_;
        this.field_220550_c = p_i2112_3_;
        this.field_220551_d = p_i2112_4_;
        this.field_223018_e = p_i2112_5_;
    }
