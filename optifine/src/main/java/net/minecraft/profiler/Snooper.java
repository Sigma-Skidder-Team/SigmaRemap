...
public class Snooper
{
    ...
    public Snooper(String p_i784_1_, ISnooperInfo p_i784_2_, long p_i784_3_)
    {
        try
        {
            this.serverUrl = new URL("http://snoop.minecraft.net/" + p_i784_1_ + "?version=" + 2);
        }
        ...
        this.playerStatsCollector = p_i784_2_;
        this.minecraftStartTimeMilis = p_i784_3_;
    }
