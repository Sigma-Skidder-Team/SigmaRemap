...
public final class DataPoint implements Comparable<DataPoint>
{
    ...
    public DataPoint(String p_i1038_1_, double p_i1038_2_, double p_i1038_4_, long p_i1038_6_)
    {
        this.name = p_i1038_1_;
        this.relTime = p_i1038_2_;
        this.rootRelTime = p_i1038_4_;
        this.field_223511_c = p_i1038_6_;
    }
