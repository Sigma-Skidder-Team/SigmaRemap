...
public class Profiler implements IResultableProfiler
{
    ...
    public Profiler(long p_i215_1_, IntSupplier p_i215_3_, boolean p_i215_4_)
    {
        this.startTime = p_i215_1_;
        this.startTicks = p_i215_3_.getAsInt();
        this.currentTicks = p_i215_3_;
        this.field_226230_l_ = p_i215_4_;
    }
