...
public class FilledProfileResult implements IProfileResult
{
    ...
    public FilledProfileResult(Map < String, ? extends IProfilerSection > p_i3947_1_, long p_i3947_2_, int p_i3947_4_, long p_i3947_5_, int p_i3947_7_)
    {
        this.field_230093_e_ = p_i3947_1_;
        this.timeStop = p_i3947_2_;
        this.ticksStop = p_i3947_4_;
        this.timeStart = p_i3947_5_;
        this.ticksStart = p_i3947_7_;
        this.field_223509_h = p_i3947_7_ - p_i3947_4_;
    }
