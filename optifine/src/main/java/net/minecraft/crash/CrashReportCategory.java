...
public class CrashReportCategory
{
    ...
    public CrashReportCategory(CrashReport p_i3570_1_, String p_i3570_2_)
    {
        this.crashReport = p_i3570_1_;
        this.name = p_i3570_2_;
    }
    ...
    static class Entry
    {
        ...
        public Entry(String p_i1588_1_, Object p_i1588_2_)
        {
            this.key = p_i1588_1_;
            ...
            else if (p_i1588_2_ instanceof Throwable)
            {
                Throwable throwable = (Throwable)p_i1588_2_;
                this.value = "~~ERROR~~ " + throwable.getClass().getSimpleName() + ": " + throwable.getMessage();
            }
            else
            {
                this.value = p_i1588_2_.toString();
            }
        }
