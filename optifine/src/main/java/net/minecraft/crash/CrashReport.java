...
public class CrashReport
{
    ...
    public CrashReport(String p_i240_1_, Throwable p_i240_2_)
    {
        this.description = p_i240_1_;
        this.cause = p_i240_2_;
    ...
    public String getCauseStackTraceOrString()
    {
        ...
        if (Reflector.CrashReportExtender_generateEnhancedStackTrace.exists())
        {
            return Reflector.CrashReportExtender_generateEnhancedStackTrace.callString(throwable);
        }
        else
        {
            String s;
