...
public class ClientThread extends RConThread
{
    ...
    ClientThread(IServer p_i877_1_, String p_i877_2_, Socket p_i877_3_)
    {
        super(p_i877_1_, "RCON Client");
        this.clientSocket = p_i877_3_;
        ...
        this.rconPassword = p_i877_2_;
        this.logInfo("Rcon connection from: " + p_i877_3_.getInetAddress());
    }
