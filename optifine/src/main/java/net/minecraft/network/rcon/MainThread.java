...
public class MainThread extends RConThread
{
    ...
    public MainThread(IServer p_i3972_1_)
    {
        super(p_i3972_1_, "RCON Listener");
        ServerProperties serverproperties = p_i3972_1_.getServerProperties();
        this.rconPort = serverproperties.rconPort;
        this.rconPassword = serverproperties.rconPassword;
        this.hostname = p_i3972_1_.getHostname();
