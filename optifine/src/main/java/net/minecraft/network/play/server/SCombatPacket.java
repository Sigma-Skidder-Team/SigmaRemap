...
public class SCombatPacket implements IPacket<IClientPlayNetHandler>
{
    ...
    public SCombatPacket(CombatTracker p_i3895_1_, SCombatPacket.Event p_i3895_2_)
    {
        this(p_i3895_1_, p_i3895_2_, new StringTextComponent(""));
    }

    public SCombatPacket(CombatTracker p_i3896_1_, SCombatPacket.Event p_i3896_2_, ITextComponent p_i3896_3_)
    {
        this.eventType = p_i3896_2_;
        LivingEntity livingentity = p_i3896_1_.getBestAttacker();

        switch (p_i3896_2_)
        {
            case END_COMBAT:
                this.duration = p_i3896_1_.getCombatDuration();
                this.entityId = livingentity == null ? -1 : livingentity.getEntityId();
                break;

            case ENTITY_DIED:
                this.playerId = p_i3896_1_.getFighter().getEntityId();
                this.entityId = livingentity == null ? -1 : livingentity.getEntityId();
                this.deathMessage = p_i3896_3_;
        }
    }
