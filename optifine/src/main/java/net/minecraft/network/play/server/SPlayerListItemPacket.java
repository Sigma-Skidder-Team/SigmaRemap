...
public class SPlayerListItemPacket implements IPacket<IClientPlayNetHandler>
{
    ...
    public SPlayerListItemPacket(SPlayerListItemPacket.Action p_i3210_1_, ServerPlayerEntity... p_i3210_2_)
    {
        this.action = p_i3210_1_;

        for (ServerPlayerEntity serverplayerentity : p_i3210_2_)
        {
    ...
    public SPlayerListItemPacket(SPlayerListItemPacket.Action p_i3211_1_, Iterable<ServerPlayerEntity> p_i3211_2_)
    {
        this.action = p_i3211_1_;

        for (ServerPlayerEntity serverplayerentity : p_i3211_2_)
        {
            this.players.add(new SPlayerListItemPacket.AddPlayerData(serverplayerentity.getGameProfile(), serverplayerentity.ping, serverplayerentity.interactionManager.getGameType(), serverplayerentity.getTabListDisplayName()));
        }
    }
    ...
    public class AddPlayerData
    {
        ...
        public AddPlayerData(GameProfile p_i2637_2_, int p_i2637_3_, @Nullable GameType p_i2637_4_, @Nullable ITextComponent p_i2637_5_)
        {
            this.profile = p_i2637_2_;
            this.ping = p_i2637_3_;
            this.gamemode = p_i2637_4_;
            this.displayName = p_i2637_5_;
        }
