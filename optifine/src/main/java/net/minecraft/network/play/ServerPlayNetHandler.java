...
public class ServerPlayNetHandler implements IServerPlayNetHandler
{
    ...
    public ServerPlayNetHandler(MinecraftServer p_i736_1_, NetworkManager p_i736_2_, ServerPlayerEntity p_i736_3_)
    {
        this.server = p_i736_1_;
        this.netManager = p_i736_2_;
        p_i736_2_.setNetHandler(this);
        this.player = p_i736_3_;
        p_i736_3_.connection = this;
    }
