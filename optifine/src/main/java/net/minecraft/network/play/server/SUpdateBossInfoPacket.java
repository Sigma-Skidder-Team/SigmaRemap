...
public class SUpdateBossInfoPacket implements IPacket<IClientPlayNetHandler>
{
    ...
    public SUpdateBossInfoPacket(SUpdateBossInfoPacket.Operation p_i1693_1_, BossInfo p_i1693_2_)
    {
        this.operation = p_i1693_1_;
        this.uniqueId = p_i1693_2_.getUniqueId();
        this.name = p_i1693_2_.getName();
        this.percent = p_i1693_2_.getPercent();
        this.color = p_i1693_2_.getColor();
        this.overlay = p_i1693_2_.getOverlay();
        this.darkenSky = p_i1693_2_.shouldDarkenSky();
        this.playEndBossMusic = p_i1693_2_.shouldPlayEndBossMusic();
        this.createFog = p_i1693_2_.shouldCreateFog();
    }
