...
public class SCommandListPacket implements IPacket<IClientPlayNetHandler>
{
    ...
    public SCommandListPacket(RootCommandNode<ISuggestionProvider> p_i3217_1_)
    {
        this.root = p_i3217_1_;
    }
    ...
    static class Entry
    {
        ...
        private Entry(@Nullable ArgumentBuilder < ISuggestionProvider, ? > gameSettingsIn, byte p_i1237_2_, int p_i1237_3_, int[] p_i1237_4_)
        {
            this.argBuilder = gameSettingsIn;
            this.flags = p_i1237_2_;
            this.redirectTarget = p_i1237_3_;
            this.children = p_i1237_4_;
        }
