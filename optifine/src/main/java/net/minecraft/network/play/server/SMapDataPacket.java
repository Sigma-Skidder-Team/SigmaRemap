...
public class SMapDataPacket implements IPacket<IClientPlayNetHandler>
{
    ...
    public SMapDataPacket(int p_i1994_1_, byte p_i1994_2_, boolean p_i1994_3_, boolean p_i1994_4_, Collection<MapDecoration> p_i1994_5_, byte[] p_i1994_6_, int p_i1994_7_, int p_i1994_8_, int p_i1994_9_, int p_i1994_10_)
    {
        this.mapId = p_i1994_1_;
        this.mapScale = p_i1994_2_;
        this.trackingPosition = p_i1994_3_;
        this.field_218730_d = p_i1994_4_;
        this.icons = p_i1994_5_.toArray(new MapDecoration[p_i1994_5_.size()]);
        this.minX = p_i1994_7_;
        this.minZ = p_i1994_8_;
        this.columns = p_i1994_9_;
        this.rows = p_i1994_10_;
        this.mapDataBytes = new byte[p_i1994_9_ * p_i1994_10_];

        for (int i = 0; i < p_i1994_9_; ++i)
        {
            for (int j = 0; j < p_i1994_10_; ++j)
            {
                this.mapDataBytes[i + j * p_i1994_9_] = p_i1994_6_[p_i1994_7_ + i + (p_i1994_8_ + j) * 128];
            }
        }
    }
