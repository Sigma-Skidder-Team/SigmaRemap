...
public class SPlayerAbilitiesPacket implements IPacket<IClientPlayNetHandler>
{
    ...
    public SPlayerAbilitiesPacket(PlayerAbilities p_i3708_1_)
    {
        this.setInvulnerable(p_i3708_1_.disableDamage);
        this.setFlying(p_i3708_1_.isFlying);
        this.setAllowFlying(p_i3708_1_.allowFlying);
        this.setCreativeMode(p_i3708_1_.isCreativeMode);
        this.setFlySpeed(p_i3708_1_.getFlySpeed());
        this.setWalkSpeed(p_i3708_1_.getWalkSpeed());
    }
