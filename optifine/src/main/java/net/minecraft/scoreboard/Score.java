...
public class Score
{
    ...
    public Score(Scoreboard p_i3805_1_, ScoreObjective p_i3805_2_, String p_i3805_3_)
    {
        this.scoreboard = p_i3805_1_;
        this.objective = p_i3805_2_;
        this.scorePlayerName = p_i3805_3_;
        this.locked = true;
