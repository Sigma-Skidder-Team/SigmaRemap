...
public class ScoreCriteria
{
    ...
    public ScoreCriteria(String p_i1915_1_)
    {
        this(p_i1915_1_, false, ScoreCriteria.RenderType.INTEGER);
    }

    protected ScoreCriteria(String p_i1916_1_, boolean p_i1916_2_, ScoreCriteria.RenderType p_i1916_3_)
    {
        this.name = p_i1916_1_;
        this.readOnly = p_i1916_2_;
        this.renderType = p_i1916_3_;
        INSTANCES.put(p_i1916_1_, this);
    }
    ...
    public static enum RenderType
    {
        ...
        private RenderType(String p_i3111_3_)
        {
            this.field_211840_c = p_i3111_3_;
        }
