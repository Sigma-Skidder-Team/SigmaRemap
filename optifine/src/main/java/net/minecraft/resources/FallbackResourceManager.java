...
public class FallbackResourceManager implements IResourceManager
{
    ...
    public FallbackResourceManager(ResourcePackType p_i3714_1_, String p_i3714_2_)
    {
        this.type = p_i3714_1_;
        this.namespace = p_i3714_2_;
    }
    ...
    static class LeakComplainerInputStream extends FilterInputStream
    {
        ...
        public LeakComplainerInputStream(InputStream p_i3782_1_, ResourceLocation p_i3782_2_, String p_i3782_3_)
        {
            super(p_i3782_1_);
            ByteArrayOutputStream bytearrayoutputstream = new ByteArrayOutputStream();
            (new Exception()).printStackTrace(new PrintStream(bytearrayoutputstream));
            this.message = "Leaked resource: '" + p_i3782_2_ + "' loaded from pack: '" + p_i3782_3_ + "'\n" + bytearrayoutputstream;
        }
