...
public class SimpleResource implements IResource
{
    ...
    public SimpleResource(String p_i841_1_, ResourceLocation p_i841_2_, InputStream p_i841_3_, @Nullable InputStream p_i841_4_)
    {
        this.packName = p_i841_1_;
        this.location = p_i841_2_;
        this.inputStream = p_i841_3_;
        this.metadataInputStream = p_i841_4_;
    }
