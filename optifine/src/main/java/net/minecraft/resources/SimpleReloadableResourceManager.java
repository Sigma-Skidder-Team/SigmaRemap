...
public class SimpleReloadableResourceManager implements IReloadableResourceManager
{
    ...
    public SimpleReloadableResourceManager(ResourcePackType p_i2871_1_, Thread p_i2871_2_)
    {
        this.type = p_i2871_1_;
        this.mainThread = p_i2871_2_;
    }
    ...
    public static class FailedPackException extends RuntimeException
    {
        ...
        public FailedPackException(IResourcePack p_i3989_1_, Throwable p_i3989_2_)
        {
            super(p_i3989_1_.getName(), p_i3989_2_);
            this.field_230021_a_ = p_i3989_1_;
        }
    ...
    static class FailedPackReloader implements IAsyncReloader
    {
        ...
        public FailedPackReloader(SimpleReloadableResourceManager.FailedPackException p_i2599_1_)
        {
            this.field_230019_a_ = p_i2599_1_;
            this.field_230020_b_ = new CompletableFuture<>();
            this.field_230020_b_.completeExceptionally(p_i2599_1_);
        }
