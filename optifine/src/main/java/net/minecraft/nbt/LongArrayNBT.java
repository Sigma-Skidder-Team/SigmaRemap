...
public class LongArrayNBT extends CollectionNBT<LongNBT>
{
    ...
    public LongArrayNBT(long[] p_i2629_1_)
    {
        this.data = p_i2629_1_;
    }

    public LongArrayNBT(LongSet p_i2630_1_)
    {
        this.data = p_i2630_1_.toLongArray();
    }

    public LongArrayNBT(List<Long> p_i2631_1_)
    {
        this(toArray(p_i2631_1_));
    }
