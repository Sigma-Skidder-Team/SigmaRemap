...
public class NetworkTagManager implements IFutureReloadListener
{
    ...
    public static class ReloadResults
    {
        ...
        public ReloadResults(Map<ResourceLocation, Tag.Builder<Block>> p_i2788_1_, Map<ResourceLocation, Tag.Builder<Item>> p_i2788_2_, Map<ResourceLocation, Tag.Builder<Fluid>> p_i2788_3_, Map < ResourceLocation, Tag.Builder < EntityType<? >>> p_i2788_4_)
        {
            this.blocks = p_i2788_1_;
            this.items = p_i2788_2_;
            this.fluids = p_i2788_3_;
            this.entityTypes = p_i2788_4_;
        }
    }
}
