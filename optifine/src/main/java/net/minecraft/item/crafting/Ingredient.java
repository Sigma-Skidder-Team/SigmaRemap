...
public final class Ingredient implements Predicate<ItemStack>
{
    ...
    private Ingredient(Stream <? extends Ingredient.IItemList > p_i989_1_)
    {
        this.acceptedItems = p_i989_1_.filter(IS_EMPTY).toArray((p_209360_0_) ->
        {
    ...
    static class SingleItemList implements Ingredient.IItemList
    {
        ...
        private SingleItemList(ItemStack p_i3492_1_)
        {
            this.stack = p_i3492_1_;
        }
    ...
    static class TagList implements Ingredient.IItemList
    {
        ...
        private TagList(Tag<Item> p_i2830_1_)
        {
            this.tag = p_i2830_1_;
        }
