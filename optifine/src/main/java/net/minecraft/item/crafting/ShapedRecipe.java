...
public class ShapedRecipe implements ICraftingRecipe
{
    ...
    public ShapedRecipe(ResourceLocation p_i1227_1_, String p_i1227_2_, int p_i1227_3_, int p_i1227_4_, NonNullList<Ingredient> p_i1227_5_, ItemStack p_i1227_6_)
    {
        this.id = p_i1227_1_;
        this.group = p_i1227_2_;
        this.recipeWidth = p_i1227_3_;
        this.recipeHeight = p_i1227_4_;
        this.recipeItems = p_i1227_5_;
        this.recipeOutput = p_i1227_6_;
    }
