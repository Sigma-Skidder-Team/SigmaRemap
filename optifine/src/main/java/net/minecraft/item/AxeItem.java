...
public class AxeItem extends ToolItem
{
    ...
    protected AxeItem(IItemTier p_i2970_1_, float p_i2970_2_, float p_i2970_3_, Item.Properties p_i2970_4_)
    {
        super(p_i2970_2_, p_i2970_3_, p_i2970_1_, EFFECTIVE_ON, p_i2970_4_);
    }
