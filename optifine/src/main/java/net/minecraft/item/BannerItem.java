...
{
    public BannerItem(Block p_i4241_1_, Block p_i4241_2_, Item.Properties p_i4241_3_)
    {
        super(p_i4241_1_, p_i4241_2_, p_i4241_3_);
        Validate.isInstanceOf(AbstractBannerBlock.class, p_i4241_1_);
        Validate.isInstanceOf(AbstractBannerBlock.class, p_i4241_2_);
    }
