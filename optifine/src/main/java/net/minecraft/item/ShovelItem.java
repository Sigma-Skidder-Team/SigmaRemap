...
public class ShovelItem extends ToolItem
{
    ...
    public ShovelItem(IItemTier p_i1375_1_, float p_i1375_2_, float p_i1375_3_, Item.Properties p_i1375_4_)
    {
        super(p_i1375_2_, p_i1375_3_, p_i1375_1_, EFFECTIVE_ON, p_i1375_4_);
    }
