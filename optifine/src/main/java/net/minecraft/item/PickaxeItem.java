...
public class PickaxeItem extends ToolItem
{
    ...
    protected PickaxeItem(IItemTier p_i1962_1_, int p_i1962_2_, float p_i1962_3_, Item.Properties p_i1962_4_)
    {
        super((float)p_i1962_2_, p_i1962_3_, p_i1962_1_, EFFECTIVE_ON, p_i1962_4_);
    }
