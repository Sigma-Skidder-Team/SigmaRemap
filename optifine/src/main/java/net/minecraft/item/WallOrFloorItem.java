...
public class WallOrFloorItem extends BlockItem
{
    ...
    public WallOrFloorItem(Block parentScreenIn, Block gameSettingsIn, Item.Properties p_i1023_3_)
    {
        super(parentScreenIn, p_i1023_3_);
        this.wallBlock = gameSettingsIn;
    }
