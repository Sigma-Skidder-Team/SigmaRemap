...
public class TooltipManager
{
    ...
    public void drawTooltips(int x, int y, List<Widget> buttonList)
    {
            ...
            if (System.currentTimeMillis() >= this.mouseStillTime + (long)i)
            {
                ...
                if (widget != null)
                {
                    ...
                    if (astring != null)
                    {
                        ...
                        AbstractGui.fill(rectangle.x, rectangle.y, rectangle.x + rectangle.width, rectangle.y + rectangle.height, -536870912);
    ...
    {
        AbstractGui.fill(x1, y1 - 1, x2, y1, col);
        AbstractGui.fill(x1, y2, x2, y2 + 1, col);
        AbstractGui.fill(x1 - 1, y1, x1, y2, col);
        AbstractGui.fill(x2, y1, x2 + 1, y2, col);
    }
}
