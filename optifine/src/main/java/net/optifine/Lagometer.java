...
public class Lagometer
{
    ...
    public static void showLagometer(int scaleFactor)
    {
        if (gameSettings != null)
        {
            if (gameSettings.ofLagometer || gameSettings.showLagometer)
            {
                ...
                int l2 = k - 80;
                int i3 = k - 160;
                mc.fontRenderer.drawString("30", 2.0F, (float)(i3 + 1), -8947849);
                mc.fontRenderer.drawString("30", 1.0F, (float)i3, -3881788);
                mc.fontRenderer.drawString("60", 2.0F, (float)(l2 + 1), -8947849);
                mc.fontRenderer.drawString("60", 1.0F, (float)l2, -3881788);
                GlStateManager.matrixMode(5889);
                ...
                IngameGui.fill(j2 - 1, k2 - 1, j2 + 50, k2 + 10, -1605349296);
                mc.fontRenderer.drawString(" " + MemoryMonitor.getAllocationRateMb() + " MB/s", (float)j2, (float)k2, i2);
