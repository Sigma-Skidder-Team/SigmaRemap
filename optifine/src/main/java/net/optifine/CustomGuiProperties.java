...
public class CustomGuiProperties
{
    ...
    private boolean matchesBeacon(BlockPos pos, ILightReader blockAccess)
    {
    ...
    private boolean matchesChest(BlockPos pos, ILightReader blockAccess)
    {
        TileEntity tileentity = blockAccess.getTileEntity(pos);
    ...
    private boolean matchesChest(ChestTileEntity tec, BlockPos pos, ILightReader blockAccess)
    {
    ...
    private boolean matchesEnderChest(EnderChestTileEntity teec, BlockPos pos, ILightReader blockAccess)
    {
    ...
    private boolean matchesDispenser(BlockPos pos, ILightReader blockAccess)
    {
        TileEntity tileentity = blockAccess.getTileEntity(pos);
    ...
    private boolean matchesShulker(BlockPos pos, ILightReader blockAccess)
    {
        TileEntity tileentity = blockAccess.getTileEntity(pos);
    ...
    private boolean matchesVillager(Entity entity, ILightReader blockAccess)
    {
    ...
    private boolean matchesHorse(Entity entity, ILightReader blockAccess)
    {
