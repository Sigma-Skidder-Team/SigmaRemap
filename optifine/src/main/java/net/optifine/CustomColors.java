...
public class CustomColors
{
    ...
    {
        public int getColor(BlockState blockState, ILightReader blockAccess, BlockPos blockPos)
        {
            Biome biome = CustomColors.getColorBiome(blockAccess, blockPos);
            return CustomColors.swampGrassColors != null && biome == Biomes.SWAMP ? CustomColors.swampGrassColors.getColor(biome, blockPos) : biome.getGrassColor((double)blockPos.getX(), (double)blockPos.getZ());
        }
    ...
    private static final CustomColors.IColorizer COLORIZER_FOLIAGE = new CustomColors.IColorizer()
    {
        ...
        {
            Biome biome = CustomColors.getColorBiome(blockAccess, blockPos);
            return CustomColors.swampFoliageColors != null && biome == Biomes.SWAMP ? CustomColors.swampFoliageColors.getColor(biome, blockPos) : biome.getFoliageColor();
        }
        public boolean isColorConstant()
        {
            return false;
    ...
    public static int getColorMultiplier(BakedQuad quad, BlockState blockState, ILightReader blockAccess, BlockPos blockPos, RenderEnv renderEnv)
    {
    ...
    protected static Biome getColorBiome(ILightReader blockAccess, BlockPos blockPos)
    {
        Biome biome = BiomeUtils.getBiome(blockAccess, blockPos);

        if ((biome == Biomes.SWAMP || biome == Biomes.SWAMP_HILLS) && !Config.isSwampColors())
        {
            biome = Biomes.PLAINS;
        }
    ...
    private static int getSmoothColorMultiplier(BlockState blockState, ILightReader blockAccess, BlockPos blockPos, CustomColors.IColorizer colorizer, BlockPosM blockPosM)
    {
        int i = 0;
        int j = 0;
        int k = 0;
    ...
    public static int getFluidColor(ILightReader blockAccess, BlockState blockState, BlockPos blockPos, RenderEnv renderEnv)
    {
        Block block = blockState.getBlock();
    ...
    public static void updateReddustFX(Particle fx, ILightReader blockAccess, double x, double y, double z)
    {
        if (redstoneColors != null)
        {
    ...
    public static void updateWaterFX(Particle fx, ILightReader blockAccess, double x, double y, double z, RenderEnv renderEnv)
    {
    ...
    private static int getLilypadColorMultiplier(ILightReader blockAccess, BlockPos blockPos)
    {
    ...
    public static Vec3d getSkyColor(Vec3d skyColor3d, ILightReader blockAccess, double x, double y, double z)
    {
        if (skyColors == null)
        {
            return skyColor3d;
    ...
    private static Vec3d getFogColor(Vec3d fogColor3d, ILightReader blockAccess, double x, double y, double z)
    {
        if (fogColors == null)
        {
            return fogColor3d;
    ...
    public static Vec3d getUnderwaterColor(ILightReader blockAccess, double x, double y, double z)
    {
        return getUnderFluidColor(blockAccess, x, y, z, underwaterColors, underwaterColorFader);
    }

    public static Vec3d getUnderlavaColor(ILightReader blockAccess, double x, double y, double z)
    {
        return getUnderFluidColor(blockAccess, x, y, z, underlavaColors, underlavaColorFader);
    }

    public static Vec3d getUnderFluidColor(ILightReader blockAccess, double x, double y, double z, CustomColormap underFluidColors, CustomColorFader underFluidColorFader)
    {
    ...
    {
        int getColor(BlockState var1, ILightReader var2, BlockPos var3);
