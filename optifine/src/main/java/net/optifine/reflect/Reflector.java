...
public class Reflector
{
    ...
    public static ReflectorMethod CapabilityProvider_gatherCapabilities = new ReflectorMethod(CapabilityProvider, "gatherCapabilities", new Class[] {ICapabilityProvider.getTargetClass()});
    ...
    public static ReflectorMethod CrashReportExtender_generateEnhancedStackTrace = new ReflectorMethod(CrashReportExtender, "generateEnhancedStackTrace");
    public static ReflectorClass DimensionManager = new ReflectorClass("net.minecraftforge.common.DimensionManager");
    public static ReflectorMethod DimensionManager_unloadWorld = new ReflectorMethod(DimensionManager, "unloadWorld");
    ...
    public static ReflectorMethod IForgeBlock_getExtendedState = new ReflectorMethod(IForgeBlock, "getExtendedState");
    ...
    public static ReflectorMethod FluidAttributes_getColor = new ReflectorMethod(FluidAttributes, "getColor", new Class[] {ILightReader.class, BlockPos.class});
    ...
    public static ReflectorClass ForgeEntityLivingBase = new ReflectorClass(LivingEntity.class);
    public static ReflectorField ForgeEntityLivingBase_NAMETAG_DISTANCE = new ReflectorField(ForgeEntityLivingBase, "NAMETAG_DISTANCE");
    ...
    public static ReflectorClass ForgeIModel = new ReflectorClass("net.minecraftforge.client.model.IModel");
    public static ReflectorMethod ForgeIModel_bake = new ReflectorMethod(ForgeIModel, "bake");
    public static ReflectorMethod ForgeIModel_getTextures = new ReflectorMethod(ForgeIModel, "getTextures");
    ...
    public static ReflectorMethod ForgeRenderTypeLookup_canRenderInLayerFs = new ReflectorMethod(ForgeRenderTypeLookup, "canRenderInLayer", new Class[] {IFluidState.class, RenderType.class});
    public static ReflectorClass IForgeTileEntity = new ReflectorClass("net.minecraftforge.common.extensions.IForgeTileEntity");
    public static ReflectorMethod IForgeTileEntity_canRenderBreaking = new ReflectorMethod(IForgeTileEntity, "canRenderBreaking");
    ...
    public static ReflectorConstructor RenderNameplateEvent_Constructor = new ReflectorConstructor(RenderNameplateEvent, new Class[] {Entity.class, String.class, EntityRenderer.class, MatrixStack.class, IRenderTypeBuffer.class, Integer.TYPE});
