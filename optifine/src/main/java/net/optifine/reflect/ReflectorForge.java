...
public class ReflectorForge
{
    ...
    public static InputStream getOptiFineResourceStream(String path)
    {
        ...
        else
        {
            ...
            InputStream inputstream = (InputStream)Reflector.call(Reflector.OptiFineResourceLocator_getOptiFineResourceStream, path);
            return inputstream;
        }
    }
    ...
    {
        return FORGE_BLOCKSTATE_HAS_TILE_ENTITY ? Reflector.callBoolean(state, Reflector.IForgeBlockState_hasTileEntity) : state.getBlock().hasTileEntity();
    }
    ...
    public static int getLightValue(BlockState stateIn, ILightReader worldIn, BlockPos posIn)
    {
    ...
    public static Button makeButtonMods(MainMenuScreen guiMainMenu, int yIn, int rowHeightIn)
    {
        ...
        {
            Button button = new Button(guiMainMenu.width / 2 - 100, yIn + rowHeightIn * 2, 98, 20, I18n.format("fml.menu.mods"), (buttonq) ->
            {
    ...
    public static boolean getConfigClientBoolean(ReflectorField configField, boolean def)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                {
                    boolean flag = Reflector.callBoolean(object1, Reflector.ForgeConfigSpec_ConfigValue_get);
                    return flag;
                }
            }
        }
