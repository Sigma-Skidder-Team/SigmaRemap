...
public class ConnectedTextures
{
    ...
    public static BakedQuad[] getConnectedTexture(ILightReader blockAccess, BlockState blockState, BlockPos blockPos, BakedQuad quad, RenderEnv renderEnv)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                BakedQuad[] abakedquad = getConnectedTextureMultiPass(blockAccess, blockState, blockPos, direction, quad, renderEnv);
                return abakedquad;
            }
        }
    }
    ...
    private static BakedQuad[] getConnectedTextureMultiPass(ILightReader blockAccess, BlockState blockState, BlockPos blockPos, Direction side, BakedQuad quad, RenderEnv renderEnv)
    {
    ...
    public static BakedQuad[] getConnectedTextureSingle(ILightReader blockAccess, BlockState blockState, BlockPos blockPos, Direction facing, BakedQuad quad, boolean checkBlocks, int pass, RenderEnv renderEnv)
    {
        Block block = blockState.getBlock();
        TextureAtlasSprite textureatlassprite = quad.getSprite();
    ...
    private static BakedQuad[] getConnectedTexture(ConnectedProperties cp, ILightReader blockAccess, BlockState blockState, BlockPos blockPos, int side, BakedQuad quad, int pass, RenderEnv renderEnv)
    {
        int i = 0;
    ...
    private static TextureAtlasSprite getNeighbourIcon(IBlockReader worldReader, BlockState blockState, BlockPos blockPos, BlockState neighbourState, int side)
    {
        ...
        else
        {
            ...
            {
                neighbourState = (BlockState)Reflector.call(neighbourState.getBlock(), Reflector.IForgeBlock_getExtendedState, neighbourState, worldReader, blockPos);
            }
