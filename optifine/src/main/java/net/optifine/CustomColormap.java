...
public class CustomColormap implements CustomColors.IColorizer
{
    ...
    public int getColor(ILightReader blockAccess, BlockPos blockPos)
    {
    ...
    public int getColorSmooth(ILightReader blockAccess, double x, double y, double z, int radius)
    {
        if (this.format == 2)
        {
            return this.color;
    ...
    {
        int i = Registry.BIOME.getId(biome);
