...
public class Config
{
    ...
    public static final String OF_RELEASE = "G1_pre30";
    public static final String VERSION = "OptiFine_1.15.2_HD_U_G1_pre30";
    ...
    public static final ResourceLocation LOCATION_MOJANG_LOGO = new ResourceLocation("textures/gui/title/mojang.png");
    ...
    {
        return "OptiFine_1.15.2_HD_U_G1_pre30";
    }
    ...
    public static String getVersionDebug()
    {
        ...
        stringbuffer.append("OptiFine_1.15.2_HD_U_G1_pre30");
    ...
    public static int getMinecraftVersionInt()
    {
        ...
        {
            String[] astring = tokenize("1.15.2", ".");
            int i = 0;
    ...
    {
        ResourcePackList<ClientResourcePackInfo> resourcepacklist = minecraft.getResourcePackList();
        Collection<ClientResourcePackInfo> collection = resourcepacklist.getEnabledPacks();
        List list = new ArrayList();

        for (ClientResourcePackInfo clientresourcepackinfo : collection)
        {
            IResourcePack iresourcepack = clientresourcepackinfo.getResourcePack();
    ...
    public static IResourcePack getDefiningResourcePack(ResourceLocation location)
    {
        ...
        Collection<ClientResourcePackInfo> collection = resourcepacklist.getEnabledPacks();
        List<ClientResourcePackInfo> list = (List)collection;

        for (int i = list.size() - 1; i >= 0; --i)
        {
            ClientResourcePackInfo clientresourcepackinfo = list.get(i);
            IResourcePack iresourcepack = clientresourcepackinfo.getResourcePack();
    ...
    public static void drawFps()
    {
        ...
        minecraft.fontRenderer.drawString(s1, 2.0F, 2.0F, -2039584);
    }
    ...
    private static String getUpdates(String str)
    {
        ...
        {
            int j = str.indexOf(32, i);
            return j < 0 ? "" : str.substring(i + 1, j);
        }
    }
    ...
    {
        float f = (float)getAverageFrameTimeMs() / 1000.0F;
        return f;
    }

    public static long getAverageFrameFps()
    {
        long i = 1000L / getAverageFrameTimeMs();
        return i;
    }
}
