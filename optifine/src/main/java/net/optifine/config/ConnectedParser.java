...
public class ConnectedParser
{
    ...
    private static Map<ResourceLocation, Biome> MAP_BIOMES_COMPACT = null;
        ...
        else
        {
            ...
            for (int i = 0; i < params.length; ++i)
            {
                ...
                if (s.length() > 0)
                {
                    ...
                    String s1 = astring[0];
                    String s2 = astring[1];
                    IProperty iproperty = ConnectedProperties.getProperty(s1, collection);
                    ...
                    for (int j = 0; j < astring1.length; ++j)
                    {
                        ...
                        Comparable comparable = parsePropertyValue(iproperty, s3);
    ...
    public boolean matchState(BlockState bs, Map<IProperty, List<Comparable>> mapPropValues)
    {
        for (IProperty iproperty : mapPropValues.keySet())
        {
            List<Comparable> list = mapPropValues.get(iproperty);
            Comparable comparable = bs.get(iproperty);
    ...
    public Biome[] parseBiomes(String str)
    {
        ...
        else
        {
            ...
            if (flag)
            {
                List<Biome> list1 = Lists.newArrayList(Registry.BIOME.iterator());
    ...
    public Biome findBiome(String biomeName)
    {
        ...
        else
        {
            ...
            if (MAP_BIOMES_COMPACT == null)
            {
                ...
                {
                    Biome biome1 = BiomeUtils.getBiome(resourcelocation2);
                    ...
                    MAP_BIOMES_COMPACT.put(resourcelocation3, biome1);
                }
            }

            biome = MAP_BIOMES_COMPACT.get(resourcelocation1);
    ...
    public MatchProfession[] parseProfessions(String profStr)
    {
        ...
        else
        {
            ...
            {
                MatchProfession[] amatchprofession = list.toArray(new MatchProfession[list.size()]);
                return amatchprofession;
            }
        }
    }
    ...
    private MatchProfession parseProfession(String str)
    {
        ...
        else
        {
            ...
            MatchProfession matchprofession = new MatchProfession(villagerprofession, aint);
            return matchprofession;
        }
    }
