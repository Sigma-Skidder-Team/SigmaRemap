...
public class IteratableOptionOF extends IteratableOption
{
    ...
    {
        super(nameIn, (BiConsumer<GameSettings, Integer>)null, (BiFunction<GameSettings, IteratableOption, String>)null);
    ...
    public String getOptionText(GameSettings gameSettings, IteratableOption option)
    {
        return gameSettings.getKeyBindingOF(option);
    }
}
