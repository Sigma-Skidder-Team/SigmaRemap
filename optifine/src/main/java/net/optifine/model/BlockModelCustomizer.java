...
public class BlockModelCustomizer
{
    ...
    public static List<BakedQuad> getRenderQuads(List<BakedQuad> quads, ILightReader worldIn, BlockState stateIn, BlockPos posIn, Direction enumfacing, RenderType layer, long rand, RenderEnv renderEnv)
    {
        if (enumfacing != null)
        {
    ...
    private static BakedQuad[] getRenderQuads(BakedQuad quad, ILightReader worldIn, BlockState stateIn, BlockPos posIn, Direction enumfacing, long rand, RenderEnv renderEnv)
    {
