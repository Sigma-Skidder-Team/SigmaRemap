...
public class ModelUtils
{
    ...
    public static void dbgModel(IBakedModel model)
    {
        if (model != null)
        {
            ...
            for (int i = 0; i < adirection.length; ++i)
            {
                ...
                dbgQuads(direction.getName(), list, "  ");
            }
    ...
    public static IBakedModel duplicateModel(IBakedModel model)
    {
        ...
        SimpleBakedModel simplebakedmodel = new SimpleBakedModel(list, map, model.isAmbientOcclusion(), model.isGui3d(), true, model.getParticleTexture(), model.getItemCameraTransforms(), model.getOverrides());
