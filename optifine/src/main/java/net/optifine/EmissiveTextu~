...
public class EmissiveTextures
{
    ...
    private static final ResourceLocation LOCATION_EMPTY = new ResourceLocation("optifine/ctm/default/empty.png");
    private static ResourceLocation LOCATION_SPRITE_EMPTY;
        ...
        if (s != null)
        {
            if (!locSprite.getPath().endsWith(s))
            {
                ...
                if (Config.hasResource(resourcelocation1))
                {
                    ...
                    textureMap.registerSprite(LOCATION_EMPTY);
                }
            }
        }
    }
    ...
    static
    {
        LOCATION_SPRITE_EMPTY = ConnectedTextures.LOCATION_SPRITE_EMPTY;
    }
}
