...
public class BetterSnow
{
    ...
    public static boolean shouldRender(ILightReader lightReader, BlockState blockState, BlockPos blockPos)
    {
    ...
    {
        if (BlockUtils.isFullCube(blockState, blockAccess, blockPos))
        {
            return false;
        }
        else if (blockState.isOpaqueCube(blockAccess, blockPos))
        {
            return false;
        }
        else
