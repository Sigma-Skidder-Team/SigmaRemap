...
public class VersionCheckThread extends Thread
{
    ...
    public void run()
    {
        ...
        try
        {
            ...
            URL url = new URL("http://optifine.net/version/1.15.2/HD_U.txt");
            ...
            if (Config.getGameSettings().snooper)
            {
                ...
                httpurlconnection.setRequestProperty("OF-Release", "G1_pre30");
            ...
            try
            {
                ...
                if (astring.length >= 1)
                {
                    ...
                    if (Config.compareRelease(s1, "G1_pre30") <= 0)
                    {
                        return;
                    }
