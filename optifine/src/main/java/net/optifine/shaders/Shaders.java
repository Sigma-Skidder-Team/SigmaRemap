...
public class Shaders
{
    ...
    public static void init()
    {
        ...
        if (!isShaderPackInitialized)
        {
            ...
            {
                int i = currentWorld.dimension.getType().getId();
    ...
    private static void setupFrameBuffer()
    {
        ...
        GL32.glGenTextures((IntBuffer)dfbDepthTextures.clear().limit(usedDepthBuffers));
        GL32.glGenTextures((IntBuffer)dfbColorTextures.clear().limit(16));
    ...
    private static void setupShadowFrameBuffer()
    {
        if (usedShadowDepthBuffers != 0)
        {
            ...
            GL32.glDrawBuffer(0);
            GL32.glReadBuffer(0);
            GL32.glGenTextures((IntBuffer)sfbDepthTextures.clear().limit(usedShadowDepthBuffers));
            GL32.glGenTextures((IntBuffer)sfbColorTextures.clear().limit(usedShadowColorBuffers));
    ...
    public static void beginRender(Minecraft minecraft, ActiveRenderInfo activeRenderInfo, float partialTicks, long finishTimeNano)
    {
        ...
        if (clientworld != null)
        {
            ...
            if (entity != null)
            {
                ...
                IFluidState ifluidstate = activeRenderInfo.getFluidState();
                ...
                Vec3d vec3d = clientworld.getSkyColor(entity.getPosition(), partialTicks);
                vec3d = CustomColors.getWorldSkyColor(vec3d, clientworld, entity, partialTicks);
    ...
    {
        return world == null ? Integer.MIN_VALUE : world.dimension.getType().getId();
    }
    ...
    public static void setCamera(MatrixStack matrixStackIn, ActiveRenderInfo activeRenderInfo, float partialTicks)
    {
        ...
        GL32.glGetFloatv(2983, (FloatBuffer)projection.position(0));
    ...
    public static void setCameraShadow(MatrixStack matrixStack, ActiveRenderInfo activeRenderInfo, float partialTicks)
    {
        ...
        GL32.glGetFloatv(2983, (FloatBuffer)shadowProjection.position(0));
    ...
    private static void renderFinal()
    {
        ...
        GlStateManager.framebufferTexture2D(FramebufferConstants.GL_FRAMEBUFFER, FramebufferConstants.GL_COLOR_ATTACHMENT0, 3553, mc.getFramebuffer().framebufferTexture, 0);
    ...
    public static void drawHorizon(MatrixStack matrixStackIn)
    {
        ...
        double d3 = -d0;
        double d4 = 16.0D;
        double d5 = -cameraPositionY + currentWorld.getHorizonHeight() + 12.0D - 16.0D;

        if (cameraPositionY < currentWorld.getHorizonHeight())
        {
            d5 = -4.0D;
        }
    ...
    private static String getLocaleUppercase(String name)
    {
        ...
        {
            String s = name.substring(0, i) + name.substring(i).toUpperCase(Locale.ROOT);
            return s;
        }
    }
