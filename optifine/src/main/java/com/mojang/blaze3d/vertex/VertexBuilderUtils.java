...
public class VertexBuilderUtils
{
    ...
    static class DelegatingVertexBuilder implements IVertexBuilder
    {
        ...
        public DelegatingVertexBuilder(IVertexBuilder p_i569_1_, IVertexBuilder p_i569_2_)
        {
            if (p_i569_1_ == p_i569_2_)
            {
                throw new IllegalArgumentException("Duplicate delegates");
            }
            else
            {
                this.field_227916_a_ = p_i569_1_;
                this.field_227917_b_ = p_i569_2_;
            }
        }
