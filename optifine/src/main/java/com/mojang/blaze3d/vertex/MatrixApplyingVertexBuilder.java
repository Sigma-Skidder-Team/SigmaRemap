...
public class MatrixApplyingVertexBuilder extends DefaultColorVertexBuilder
{
    ...
    public MatrixApplyingVertexBuilder(IVertexBuilder p_i4160_1_, MatrixStack.Entry p_i4160_2_)
    {
        this.field_227808_g_ = p_i4160_1_;
        this.field_227809_h_ = p_i4160_2_.getMatrix().copy();
        this.field_227809_h_.invert();
        this.field_227810_i_ = p_i4160_2_.getNormal().copy();
