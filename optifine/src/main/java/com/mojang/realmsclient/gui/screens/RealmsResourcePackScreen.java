...
public class RealmsResourcePackScreen extends RealmsScreen
{
    ...
    public RealmsResourcePackScreen(RealmsScreen p_i1808_1_, RealmsServerAddress p_i1808_2_, ReentrantLock p_i1808_3_)
    {
        this.field_224480_b = p_i1808_1_;
        this.field_224481_c = p_i1808_2_;
        this.field_224482_d = p_i1808_3_;
    }
