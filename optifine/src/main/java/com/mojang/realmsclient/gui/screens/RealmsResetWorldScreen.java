...
public class RealmsResetWorldScreen extends RealmsScreenWithCallback<WorldTemplate>
{
    ...
    public RealmsResetWorldScreen(RealmsScreen mob, RealmsServer p_i1613_2_, RealmsScreen p_i1613_3_)
    {
        this.field_224457_c = mob;
        this.field_224458_d = p_i1613_2_;
        this.field_224459_e = p_i1613_3_;
    }

    public RealmsResetWorldScreen(RealmsScreen mob, RealmsServer p_i1614_2_, RealmsScreen p_i1614_3_, String p_i1614_4_, String p_i1614_5_, int p_i1614_6_, String p_i1614_7_)
    {
        this(mob, p_i1614_2_, p_i1614_3_);
        this.field_224462_h = p_i1614_4_;
        this.field_224463_i = p_i1614_5_;
        this.field_224465_k = p_i1614_6_;
        this.field_224464_j = p_i1614_7_;
    }
    ...
    public static class ResetWorldInfo
    {
        ...
        public ResetWorldInfo(String p_i3628_1_, int p_i3628_2_, boolean p_i3628_3_)
        {
            this.field_225157_a = p_i3628_1_;
            this.field_225158_b = p_i3628_2_;
            this.field_225159_c = p_i3628_3_;
        }
    }
    ...
    abstract class TexturedButton extends RealmsButton
    {
        ...
        public TexturedButton(int p_i3405_2_, int p_i3405_3_, String p_i3405_4_, long p_i3405_5_, String p_i3405_7_, RealmsResetWorldScreen.ResetType p_i3405_8_)
        {
            super(100 + p_i3405_8_.ordinal(), p_i3405_2_, p_i3405_3_, 60, 72, p_i3405_4_);
            this.field_223822_a = p_i3405_5_;
            this.field_223824_c = p_i3405_7_;
            this.field_223825_d = p_i3405_8_;
        }
