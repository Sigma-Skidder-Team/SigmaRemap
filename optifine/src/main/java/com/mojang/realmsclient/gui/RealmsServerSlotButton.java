...
public class RealmsServerSlotButton extends RealmsButton
{
    ...
    public RealmsServerSlotButton(int p_i2603_1_, int p_i2603_2_, int p_i2603_3_, int p_i2603_4_, Supplier<RealmsServer> p_i2603_5_, Consumer<String> p_i2603_6_, int p_i2603_7_, int p_i2603_8_, RealmsServerSlotButton.IHandler p_i2603_9_)
    {
        super(p_i2603_7_, p_i2603_1_, p_i2603_2_, p_i2603_3_, p_i2603_4_, "");
        this.field_223773_a = p_i2603_5_;
        this.field_223776_d = p_i2603_8_;
        this.field_223774_b = p_i2603_6_;
        this.field_223775_c = p_i2603_9_;
    }
    ...
    public static class ServerData
    {
        ...
        ServerData(boolean p_i3789_1_, String p_i3789_2_, long p_i3789_3_, @Nullable String p_i3789_5_, boolean p_i3789_6_, boolean p_i3789_7_, RealmsServerSlotButton.Action p_i3789_8_, @Nullable String p_i3789_9_)
        {
            this.field_225110_a = p_i3789_1_;
            this.field_225111_b = p_i3789_2_;
            this.field_225112_c = p_i3789_3_;
            this.field_225113_d = p_i3789_5_;
            this.field_225114_e = p_i3789_6_;
            this.field_225115_f = p_i3789_7_;
            this.field_225116_g = p_i3789_8_;
            this.field_225117_h = p_i3789_9_;
        }
    }
}
