...
public class RealmsConfirmScreen extends RealmsScreen
{
    ...
    public RealmsConfirmScreen(RealmsScreen p_i3760_1_, String p_i3760_2_, String p_i3760_3_, int p_i3760_4_)
    {
        this.field_224141_a = p_i3760_1_;
        this.field_224142_b = p_i3760_2_;
        this.field_224146_f = p_i3760_3_;
        this.field_224145_e = p_i3760_4_;
