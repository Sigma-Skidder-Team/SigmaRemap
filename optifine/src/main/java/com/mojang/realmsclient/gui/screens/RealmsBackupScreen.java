...
public class RealmsBackupScreen extends RealmsScreen
{
    ...
    public RealmsBackupScreen(RealmsConfigureWorldScreen p_i1832_1_, RealmsServer p_i1832_2_, int p_i1832_3_)
    {
        this.field_224116_c = p_i1832_1_;
        this.field_224126_m = p_i1832_2_;
        this.field_224121_h = p_i1832_3_;
    }
    ...
    class BackupObjectSelectionListEntry extends RealmListEntry
    {
        ...
        public BackupObjectSelectionListEntry(Backup p_i2698_2_)
        {
            this.field_223742_a = p_i2698_2_;
        }
