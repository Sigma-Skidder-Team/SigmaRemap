...
public class RealmsSlotOptionsScreen extends RealmsScreen
{
    ...
    public RealmsSlotOptionsScreen(RealmsConfigureWorldScreen p_i3166_1_, RealmsWorldOptions p_i3166_2_, RealmsServer.ServerType p_i3166_3_, int p_i3166_4_)
    {
        this.field_224638_a = p_i3166_1_;
        this.field_224646_i = p_i3166_2_;
        this.field_224647_j = p_i3166_3_;
        this.field_224648_k = p_i3166_4_;
    }
    ...
    {
        public SettingsSlider(int p_i1059_2_, int p_i1059_3_, int p_i1059_4_, int p_i1059_5_, int p_i1059_6_, float p_i1059_7_, float p_i1059_8_)
        {
            super(p_i1059_2_, p_i1059_3_, p_i1059_4_, p_i1059_5_, p_i1059_6_, (double)p_i1059_7_, (double)p_i1059_8_);
        }
