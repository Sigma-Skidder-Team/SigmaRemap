...
public class RealmsPendingInvitesScreen extends RealmsScreen
{
    ...
    public RealmsPendingInvitesScreen(RealmsScreen p_i3580_1_)
    {
        this.field_224334_b = p_i3580_1_;
    }
    ...
    class InvitationEntry extends RealmListEntry
    {
        ...
        InvitationEntry(PendingInvite p_i3158_2_)
        {
            this.field_223750_a = p_i3158_2_;
