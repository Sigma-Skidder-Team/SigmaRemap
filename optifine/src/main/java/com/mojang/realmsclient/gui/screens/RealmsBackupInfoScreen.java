...
public class RealmsBackupInfoScreen extends RealmsScreen
{
    ...
    public RealmsBackupInfoScreen(RealmsScreen p_i478_1_, Backup p_i478_2_)
    {
        this.field_224047_c = p_i478_1_;
        this.field_224049_e = p_i478_2_;

        if (p_i478_2_.changeList != null)
        {
            for (Entry<String, String> entry : p_i478_2_.changeList.entrySet())
            {
