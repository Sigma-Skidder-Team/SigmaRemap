...
public class RealmsLongConfirmationScreen extends RealmsScreen
{
    ...
    public RealmsLongConfirmationScreen(RealmsConfirmResultListener p_i3861_1_, RealmsLongConfirmationScreen.Type p_i3861_2_, String p_i3861_3_, String p_i3861_4_, boolean p_i3861_5_, int p_i3861_6_)
    {
        this.field_224250_a = p_i3861_1_;
        this.field_224253_d = p_i3861_6_;
        this.field_224254_e = p_i3861_2_;
        this.field_224255_f = p_i3861_3_;
        this.field_224256_g = p_i3861_4_;
        this.field_224258_i = p_i3861_5_;
    ...
    public static enum Type
    {
        ...
        private Type(String p_i439_3_, int p_i439_4_)
        {
            this.field_225144_d = p_i439_3_;
            this.field_225143_c = p_i439_4_;
        }
    }
}
