...
public class RealmsSelectFileToUploadScreen extends RealmsScreen
{
    ...
    public RealmsSelectFileToUploadScreen(long p_i1547_1_, int p_i1547_3_, RealmsResetWorldScreen p_i1547_4_)
    {
        this.field_224548_b = p_i1547_4_;
        this.field_224549_c = p_i1547_1_;
        this.field_224550_d = p_i1547_3_;
    }
    ...
    class WorldSelectionEntry extends RealmListEntry
    {
        ...
        public WorldSelectionEntry(RealmsLevelSummary p_i3294_2_)
        {
            this.field_223759_a = p_i3294_2_;
        }
