...
public class RealmsResetNormalWorldScreen extends RealmsScreen
{
    ...
    public RealmsResetNormalWorldScreen(RealmsResetWorldScreen p_i2936_1_)
    {
        this.field_224354_b = p_i2936_1_;
    }

    public RealmsResetNormalWorldScreen(RealmsResetWorldScreen p_i2937_1_, String p_i2937_2_)
    {
        this(p_i2937_1_);
        this.field_224365_m = p_i2937_2_;
    }
