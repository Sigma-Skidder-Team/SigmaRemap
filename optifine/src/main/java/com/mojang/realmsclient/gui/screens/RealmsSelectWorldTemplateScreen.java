...
public class RealmsSelectWorldTemplateScreen extends RealmsScreen
{
    ...
    public RealmsSelectWorldTemplateScreen(RealmsScreenWithCallback<WorldTemplate> p_i3556_1_, RealmsServer.ServerType p_i3556_2_)
    {
        this(p_i3556_1_, p_i3556_2_, (WorldTemplatePaginatedList)null);
    }

    public RealmsSelectWorldTemplateScreen(RealmsScreenWithCallback<WorldTemplate> p_i3557_1_, RealmsServer.ServerType p_i3557_2_, @Nullable WorldTemplatePaginatedList p_i3557_3_)
    {
        this.field_224516_b = p_i3557_1_;
        this.field_224525_k = p_i3557_2_;
        ...
        {
            this.field_224517_c = new RealmsSelectWorldTemplateScreen.WorldTemplateSelectionList(Lists.newArrayList(p_i3557_3_.templates));
            this.func_224497_a(p_i3557_3_);
        }
    ...
    class WorldTemplateSelectionEntry extends RealmListEntry
    {
        ...
        public WorldTemplateSelectionEntry(WorldTemplate p_i3238_2_)
        {
            this.field_223756_a = p_i3238_2_;
        }
    ...
    class WorldTemplateSelectionList extends RealmsObjectSelectionList<RealmsSelectWorldTemplateScreen.WorldTemplateSelectionEntry>
    {
        ...
        public WorldTemplateSelectionList(Iterable<WorldTemplate> p_i363_2_)
        {
            ...
            p_i363_2_.forEach(this::func_223876_a);
        }
