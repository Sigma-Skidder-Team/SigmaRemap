...
public class RealmsUploadScreen extends RealmsScreen
{
    ...
    public RealmsUploadScreen(long p_i2195_1_, int p_i2195_3_, RealmsResetWorldScreen p_i2195_4_, RealmsLevelSummary p_i2195_5_)
    {
        this.field_224699_d = p_i2195_1_;
        this.field_224700_e = p_i2195_3_;
        this.field_224697_b = p_i2195_4_;
        this.field_224698_c = p_i2195_5_;
