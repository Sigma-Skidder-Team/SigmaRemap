...
public enum ChatFormatting
{
    ...
    private ChatFormatting(char p_i2141_3_)
    {
        this(p_i2141_3_, false);
    }

    private ChatFormatting(char p_i2142_3_, boolean p_i2142_4_)
    {
        this.field_225047_z = p_i2142_3_;
        this.field_225042_A = p_i2142_4_;
        this.field_225043_B = "\u00a7" + p_i2142_3_;
    }
