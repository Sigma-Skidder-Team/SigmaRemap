...
public abstract class ListButton
{
    ...
    public ListButton(int p_i1276_1_, int p_i1276_2_, int p_i1276_3_, int p_i1276_4_)
    {
        this.field_225125_a = p_i1276_1_;
        this.field_225126_b = p_i1276_2_;
        this.field_225127_c = p_i1276_3_;
        this.field_225128_d = p_i1276_4_;
    }
