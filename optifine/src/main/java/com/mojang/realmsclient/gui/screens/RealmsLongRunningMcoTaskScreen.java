...
public class RealmsLongRunningMcoTaskScreen extends RealmsScreen
{
    ...
    public RealmsLongRunningMcoTaskScreen(RealmsScreen p_i4030_1_, LongRunningTask p_i4030_2_)
    {
        this.field_224241_e = p_i4030_1_;
        this.field_224248_l = p_i4030_2_;
        p_i4030_2_.func_224987_a(this);
        this.field_224242_f = p_i4030_2_;
    }
