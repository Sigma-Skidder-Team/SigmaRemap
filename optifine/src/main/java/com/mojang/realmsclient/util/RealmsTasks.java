...
public class RealmsTasks
{
    ...
    public static class CloseServerTask extends LongRunningTask
    {
        ...
        public CloseServerTask(RealmsServer p_i740_1_, RealmsConfigureWorldScreen p_i740_2_)
        {
            this.field_224994_b = p_i740_1_;
            this.field_224995_c = p_i740_2_;
        }
    ...
    public static class DownloadTask extends LongRunningTask
    {
        ...
        public DownloadTask(long p_i2929_1_, int p_i2929_3_, String p_i2929_4_, RealmsScreen p_i2929_5_)
        {
            this.field_224996_b = p_i2929_1_;
            this.field_224997_c = p_i2929_3_;
            this.field_224998_d = p_i2929_5_;
            this.field_224999_e = p_i2929_4_;
        }
    ...
    public static class OpenServerTask extends LongRunningTask
    {
        ...
        public OpenServerTask(RealmsServer p_i2950_1_, RealmsScreen p_i2950_2_, RealmsScreen p_i2950_3_, boolean p_i2950_4_)
        {
            this.field_225000_b = p_i2950_1_;
            this.field_225001_c = p_i2950_2_;
            this.field_225002_d = p_i2950_4_;
            this.field_225003_e = p_i2950_3_;
        }
    ...
    public static class RealmsConnectTask extends LongRunningTask
    {
        ...
        public RealmsConnectTask(RealmsScreen p_i1578_1_, RealmsServerAddress p_i1578_2_)
        {
            this.field_225005_c = p_i1578_2_;
            this.field_225004_b = new RealmsConnect(p_i1578_1_);
        }
    ...
    public static class RealmsGetServerDetailsTask extends LongRunningTask
    {
        ...
        public RealmsGetServerDetailsTask(RealmsMainScreen p_i2902_1_, RealmsScreen p_i2902_2_, RealmsServer p_i2902_3_, ReentrantLock p_i2902_4_)
        {
            this.field_225008_c = p_i2902_2_;
            this.field_225009_d = p_i2902_1_;
            this.field_225007_b = p_i2902_3_;
            this.field_225010_e = p_i2902_4_;
        }
    ...
    public static class ResettingWorldTask extends LongRunningTask
    {
        ...
        public ResettingWorldTask(long p_i1358_1_, RealmsScreen p_i1358_3_, WorldTemplate p_i1358_4_)
        {
            this.field_225013_b = null;
            this.field_225014_c = p_i1358_4_;
            this.field_225015_d = -1;
            this.field_225016_e = true;
            this.field_225017_f = p_i1358_1_;
            this.field_225018_g = p_i1358_3_;
        }

        public ResettingWorldTask(long p_i1359_1_, RealmsScreen p_i1359_3_, String p_i1359_4_, int p_i1359_5_, boolean p_i1359_6_)
        {
            this.field_225013_b = p_i1359_4_;
            this.field_225014_c = null;
            this.field_225015_d = p_i1359_5_;
            this.field_225016_e = p_i1359_6_;
            this.field_225017_f = p_i1359_1_;
            this.field_225018_g = p_i1359_3_;
        }
    ...
    public static class RestoreTask extends LongRunningTask
    {
        ...
        public RestoreTask(Backup p_i641_1_, long p_i641_2_, RealmsConfigureWorldScreen p_i641_4_)
        {
            this.field_225021_b = p_i641_1_;
            this.field_225022_c = p_i641_2_;
            this.field_225023_d = p_i641_4_;
        }
    ...
    public static class SwitchMinigameTask extends LongRunningTask
    {
        ...
        public SwitchMinigameTask(long p_i875_1_, WorldTemplate p_i875_3_, RealmsConfigureWorldScreen p_i875_4_)
        {
            this.field_225024_b = p_i875_1_;
            this.field_225025_c = p_i875_3_;
            this.field_225026_d = p_i875_4_;
        }
    ...
    public static class SwitchSlotTask extends LongRunningTask
    {
        ...
        public SwitchSlotTask(long p_i491_1_, int p_i491_3_, RealmsConfirmResultListener p_i491_4_, int p_i491_5_)
        {
            this.field_225027_b = p_i491_1_;
            this.field_225028_c = p_i491_3_;
            this.field_225029_d = p_i491_4_;
            this.field_225030_e = p_i491_5_;
        }
    ...
    public static class WorldCreationTask extends LongRunningTask
    {
        ...
        public WorldCreationTask(long p_i2893_1_, String p_i2893_3_, String p_i2893_4_, RealmsScreen p_i2893_5_)
        {
            this.field_225036_d = p_i2893_1_;
            this.field_225034_b = p_i2893_3_;
            this.field_225035_c = p_i2893_4_;
            this.field_225037_e = p_i2893_5_;
        }
