...
public class TextRenderingUtils
{
    ...
    public static class Line
    {
        ...
        Line(List<TextRenderingUtils.LineSegment> playerInventory)
        {
            this.field_225213_a = playerInventory;
        }
    ...
    public static class LineSegment
    {
        ...
        private LineSegment(String p_i4017_1_)
        {
            this.field_225219_a = p_i4017_1_;
            this.field_225220_b = null;
            this.field_225221_c = null;
        }

        private LineSegment(String p_i4018_1_, String p_i4018_2_, String p_i4018_3_)
        {
            this.field_225219_a = p_i4018_1_;
            this.field_225220_b = p_i4018_2_;
            this.field_225221_c = p_i4018_3_;
        }
