...
public class RealmsWorldOptions extends ValueObject
{
    ...
    public RealmsWorldOptions(Boolean p_i1797_1_, Boolean p_i1797_2_, Boolean p_i1797_3_, Boolean p_i1797_4_, Integer p_i1797_5_, Boolean p_i1797_6_, Integer p_i1797_7_, Integer p_i1797_8_, Boolean p_i1797_9_, String p_i1797_10_)
    {
        this.pvp = p_i1797_1_;
        this.spawnAnimals = p_i1797_2_;
        this.spawnMonsters = p_i1797_3_;
        this.spawnNPCs = p_i1797_4_;
        this.spawnProtection = p_i1797_5_;
        this.commandBlocks = p_i1797_6_;
        this.difficulty = p_i1797_7_;
        this.gameMode = p_i1797_8_;
        this.forceGameMode = p_i1797_9_;
        this.slotName = p_i1797_10_;
    }
