...
public class RealmsClient
{
    ...
    public RealmsClient(String p_i3852_1_, String p_i3852_2_, Proxy p_i3852_3_)
    {
        this.field_224947_d = p_i3852_1_;
        this.field_224948_e = p_i3852_2_;
        RealmsClientConfig.func_224896_a(p_i3852_3_);
    }
    ...
    public static enum Environment
    {
        ...
        private Environment(String p_i2938_3_, String p_i2938_4_)
        {
            this.field_224898_d = p_i2938_3_;
            this.field_224899_e = p_i2938_4_;
        }
    }
}
