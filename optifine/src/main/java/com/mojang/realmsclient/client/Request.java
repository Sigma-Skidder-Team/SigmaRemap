...
public abstract class Request<T extends Request<T>>
{
    ...
    public Request(String p_i1041_1_, int p_i1041_2_, int p_i1041_3_)
    {
        try
        {
            this.field_224969_b = p_i1041_1_;
            Proxy proxy = RealmsClientConfig.func_224895_a();

            if (proxy != null)
            {
                this.field_224968_a = (HttpURLConnection)(new URL(p_i1041_1_)).openConnection(proxy);
            }
            else
            {
                this.field_224968_a = (HttpURLConnection)(new URL(p_i1041_1_)).openConnection();
            }

            this.field_224968_a.setConnectTimeout(p_i1041_2_);
            this.field_224968_a.setReadTimeout(p_i1041_3_);
        }
    ...
    {
        public Delete(String p_i2824_1_, int p_i2824_2_, int p_i2824_3_)
        {
            super(p_i2824_1_, p_i2824_2_, p_i2824_3_);
        }
    ...
    {
        public Get(String p_i3832_1_, int p_i3832_2_, int p_i3832_3_)
        {
            super(p_i3832_1_, p_i3832_2_, p_i3832_3_);
        }
    ...
    public static class Post extends Request<Request.Post>
    {
        ...
        public Post(String p_i1528_1_, String p_i1528_2_, int p_i1528_3_, int p_i1528_4_)
        {
            super(p_i1528_1_, p_i1528_3_, p_i1528_4_);
            this.field_224971_c = p_i1528_2_;
        }
    ...
    public static class Put extends Request<Request.Put>
    {
        ...
        public Put(String p_i636_1_, String p_i636_2_, int p_i636_3_, int p_i636_4_)
        {
            super(p_i636_1_, p_i636_3_, p_i636_4_);
            this.field_224972_c = p_i636_2_;
        }
