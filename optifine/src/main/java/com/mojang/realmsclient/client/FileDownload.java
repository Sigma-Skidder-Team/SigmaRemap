...
public class FileDownload
{
    ...
    class DownloadCountingOutputStream extends CountingOutputStream
    {
        ...
        public DownloadCountingOutputStream(OutputStream p_i4251_2_)
        {
            super(p_i4251_2_);
        }
    ...
    class ProgressListener implements ActionListener
    {
        ...
        private ProgressListener(String p_i2174_2_, File p_i2174_3_, RealmsAnvilLevelStorageSource p_i2174_4_, RealmsDownloadLatestWorldScreen.DownloadStatus p_i2174_5_, WorldDownload p_i2174_6_)
        {
            this.field_224813_b = p_i2174_2_;
            this.field_224814_c = p_i2174_3_;
            this.field_224815_d = p_i2174_4_;
            this.field_224816_e = p_i2174_5_;
            this.field_224817_f = p_i2174_6_;
        }
    ...
    class ResourcePackProgressListener implements ActionListener
    {
        ...
        private ResourcePackProgressListener(File p_i667_2_, RealmsDownloadLatestWorldScreen.DownloadStatus p_i667_3_, WorldDownload p_i667_4_)
        {
            this.field_224819_b = p_i667_2_;
            this.field_224820_c = p_i667_3_;
            this.field_224821_d = p_i667_4_;
        }
