...
public class AxisAlignedBB
{
    ...
    public boolean method18502(final AxisAlignedBB class6221) {
        return this.method18503(class6221.minX, class6221.minY, class6221.minZ, class6221.maxX, class6221.maxY, class6221.maxZ);
    }
    ...
    private static Direction method18514(final AxisAlignedBB class6221, final Vec3d class6222, final double[] array, Direction class6223, final double n, final double n2, final double n3) {
        if (n <= 1.0E-7) {
            if (n < -1.0E-7) {
                class6223 = method18515(array, class6223, n, n2, n3, class6221.maxX, class6221.minY, class6221.maxY, class6221.minZ, class6221.maxZ, Direction.EAST, class6222.x, class6222.y, class6222.z);
            }
        }
        else {
            class6223 = method18515(array, class6223, n, n2, n3, class6221.minX, class6221.minY, class6221.maxY, class6221.minZ, class6221.maxZ, Direction.WEST, class6222.x, class6222.y, class6222.z);
        }
        if (n2 <= 1.0E-7) {
            if (n2 < -1.0E-7) {
                class6223 = method18515(array, class6223, n2, n3, n, class6221.maxY, class6221.minZ, class6221.maxZ, class6221.minX, class6221.maxX, Direction.UP, class6222.y, class6222.z, class6222.x);
            }
        }
        else {
            class6223 = method18515(array, class6223, n2, n3, n, class6221.minY, class6221.minZ, class6221.maxZ, class6221.minX, class6221.maxX, Direction.DOWN, class6222.y, class6222.z, class6222.x);
        }
        if (n3 <= 1.0E-7) {
            if (n3 < -1.0E-7) {
                class6223 = method18515(array, class6223, n3, n, n2, class6221.maxZ, class6221.minX, class6221.maxX, class6221.minY, class6221.maxY, Direction.SOUTH, class6222.z, class6222.x, class6222.y);
            }
        }
        else {
            class6223 = method18515(array, class6223, n3, n, n2, class6221.minZ, class6221.minX, class6221.maxX, class6221.minY, class6221.maxY, Direction.NORTH, class6222.z, class6222.x, class6222.y);
        }
        return class6223;
    }
    ...
    public Vec3d method18517() {
        return new Vec3d(MathHelper.method35701(0.5, this.minX, this.maxX), MathHelper.method35701(0.5, this.minY, this.maxY), MathHelper.method35701(0.5, this.minZ, this.maxZ));
    }
}
