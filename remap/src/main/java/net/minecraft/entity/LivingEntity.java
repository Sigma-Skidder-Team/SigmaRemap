...
public abstract class LivingEntity extends Entity
{
    ...
    private final NonNullList<ItemStack> field2931;
    private final NonNullList<ItemStack> field2932;
    ...
    public LivingEntity(final EntityType<? extends LivingEntity> class7499, final World class7500) {
        ...
        this.field2931 = NonNullList.withSize(2, ItemStack.EMPTY);
        this.field2932 = NonNullList.withSize(4, ItemStack.EMPTY);
    ...
    public void method2725() {
        ...
        if (this instanceof ClientPlayerEntity) {
            Client.getInstance().getEventBus().post(class5722);
        }
