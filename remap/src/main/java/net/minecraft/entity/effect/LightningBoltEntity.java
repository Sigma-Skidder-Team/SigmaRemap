    ...
    public void method1659() {
        ...
        if (this.field2537 >= 0) {
            if (!this.world.isRemote) {
                if (!this.field2540) {
                    final List<Entity> method6737 = this.world.getEntitiesInAABBexcluding(this, new AxisAlignedBB(this.getPosX() - 3.0, this.getPosY() - 3.0, this.getPosZ() - 3.0, this.getPosX() + 3.0, this.getPosY() + 6.0 + 3.0, this.getPosZ() + 3.0), Entity::isAlive);
        ...
        if (!this.field2540) {
            if (!this.world.isRemote) {
                if (this.world.method6765().method31216(Class8878.field37315)) {
                    final Class7096 method11878 = Blocks.FIRE.getDefaultState();
