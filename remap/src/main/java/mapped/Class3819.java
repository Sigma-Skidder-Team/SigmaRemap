...
{
    public Class3819(final Properties properties) {
        super(properties);
    }
    ...
    public Class2201 method11694(final Class7075 class7075) {
        ...
        if (!method21654.isRemote) {
            ...
            method21654.method6783(method21655, Blocks.field29402);
            ...
            if (method21657 != null) {
                ...
                for (int i = 0; i < 3; ++i) {
                    for (int j = 0; j < 3; ++j) {
                        method21654.setBlockState(method21658.add(i, 0, j), Blocks.field29401.getDefaultState(), 2);
                    }
                }
    ...
    public Class9355<ItemStack> method11695(final World class1847, final PlayerEntity class1848, final Class316 class1849) {
        ...
        if (method2716.getType() == RayTraceResult.Type.BLOCK && class1847.getBlockState(((BlockRayTraceResult)method2716).getPos()).method21696() == Blocks.field29402) {
