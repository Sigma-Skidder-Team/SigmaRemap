...
public class Class4531 extends Class4469
{
    ...
    public Class4531(final Direction class179, final Class8123 class180) {
        super(Class9520.field40983, 1, class179, class180, 2, 2, 2);
    }
    
    public Class4531(final Class1795 class1795, final CompoundNBT class1796) {
    ...
    public boolean method13421(final Class1851 class1851, final Class6346<?> class1852, final Random random, final MutableBoundingBox class1853, final ChunkPos class1854) {
        ...
        final BlockState field19830 = Class4531.field19830;
        ...
        for (int i = 1; i <= 6; ++i) {
            BlockState class1855 = Class4531.field19830;
            if (i == 2 || i == 6) {
        ...
        this.method13444(class1851, class1853, 7, 4, 7, 8, 5, 8, Blocks.GOLD_BLOCK.getDefaultState(), Blocks.GOLD_BLOCK.getDefaultState(), false);
        for (int k = 3; k <= 6; k += 3) {
            for (int l = 6; l <= 9; l += 3) {
