...
public class Class5992 implements JsonDeserializer<Class9032>
{
    public Class9032 deserialize(final JsonElement jsonElement, final Type type, final JsonDeserializationContext jsonDeserializationContext) throws JsonParseException {
        ...
        final ResourceLocation[] array = new ResourceLocation[method35915.size()];
        for (int i = 0; i < array.length; ++i) {
            array[i] = new ResourceLocation(Class9583.method35894(method35915.get(i), "loot[" + i + "]"));
        }
        final JsonArray method35916 = Class9583.method35918(method35913, "recipes", new JsonArray());
        final ResourceLocation[] array2 = new ResourceLocation[method35916.size()];
        for (int j = 0; j < array2.length; ++j) {
            array2[j] = new ResourceLocation(Class9583.method35894(method35916.get(j), "recipes[" + j + "]"));
        }
        ...
        if (!method35913.has("function")) {
            ...
            field40145 = new Class9360(new ResourceLocation(Class9583.method35895(method35913, "function")));
        }
