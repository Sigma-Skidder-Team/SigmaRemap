...
public class Class4490 extends Class4484
{
    ...
    public Class4490(final Class1795 class1795, final CompoundNBT class1796) {
    ...
    public boolean method13421(final Class1851 class1851, final Class6346<?> class1852, final Random random, final MutableBoundingBox class1853, final ChunkPos class1854) {
        final BlockState class1855 = ((StateHolder<O, BlockState>) Blocks.field29396.getDefaultState()).with((IProperty<Comparable>)Class3916.field17732, Direction.SOUTH);
        ...
        for (int i = 0; i <= 9; ++i) {
            ...
            final int n = i;
            this.method13444(class1851, class1853, 0, 0, i, 4, max, i, Blocks.field29394.getDefaultState(), Blocks.field29394.getDefaultState(), false);
            this.method13444(class1851, class1853, 1, max + 1, i, 3, min - 1, i, Blocks.AIR.getDefaultState(), Blocks.AIR.getDefaultState(), false);
            if (i <= 6) {
            ...
            this.method13444(class1851, class1853, 0, min, i, 4, min, i, Blocks.field29394.getDefaultState(), Blocks.field29394.getDefaultState(), false);
            this.method13444(class1851, class1853, 0, max + 1, i, 0, min - 1, i, Blocks.field29394.getDefaultState(), Blocks.field29394.getDefaultState(), false);
            this.method13444(class1851, class1853, 4, max + 1, i, 4, min - 1, i, Blocks.field29394.getDefaultState(), Blocks.field29394.getDefaultState(), false);
            if ((i & 0x1) == 0x0) {
            ...
            for (int j = 0; j <= 4; ++j) {
                this.method13449(class1851, Blocks.field29394.getDefaultState(), j, -1, n, class1853);
            }
        }
        return true;
    }
