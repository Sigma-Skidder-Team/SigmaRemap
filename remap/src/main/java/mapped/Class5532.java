...
public class Class5532 extends Class5509
{
    public Class5532() {
        super(Class5412.field22555, "head_humanoid", 0.0f);
    }
    
    @Override
    public Class5901 method16811() {
        return new Class5920();
    }
    
    @Override
    public Class6300 method16812(final Class5901 class5901, final String s) {
        if (class5901 instanceof Class5920) {
            final Class5920 class5902 = (Class5920)class5901;
            return s.equals("head") ? ((Class6300)Class9570.field41446.method22631(class5902)) : null;
        }
        return null;
    }
    ...
    public Class9559 method16814(final Class5901 class5901, final float n) {
        ...
        if (map != null) {
            map.put(Class298.field1713, class5901);
