...
public class Class4784 extends Class4703<LightningBoltEntity>
{
    ...
    public void method14149(final LightningBoltEntity class422, final float n, final float n2, final MatrixStack class423, final IRenderTypeBuffer class424, final int n3) {
        ...
        final Matrix4f method25215 = class423.getLast().getMatrix();
        for (int j = 0; j < 4; ++j) {
    ...
    private static void method14150(final Matrix4f class6789, final Class4150 class6790, final float n, final float n2, final int n3, final float n4, final float n5, final float n6, final float n7, final float n8, final float n9, final float n10, final boolean b, final boolean b2, final boolean b3, final boolean b4) {
        class6790.pos(class6789, n + (b ? n10 : (-n10)), (float)(n3 * 16), n2 + (b2 ? n10 : (-n10))).color(n6, n7, n8, 0.3f).endVertex();
        class6790.pos(class6789, n4 + (b ? n9 : (-n9)), (float)((n3 + 1) * 16), n5 + (b2 ? n9 : (-n9))).color(n6, n7, n8, 0.3f).endVertex();
        class6790.pos(class6789, n4 + (b3 ? n9 : (-n9)), (float)((n3 + 1) * 16), n5 + (b4 ? n9 : (-n9))).color(n6, n7, n8, 0.3f).endVertex();
        class6790.pos(class6789, n + (b3 ? n10 : (-n10)), (float)(n3 * 16), n2 + (b4 ? n10 : (-n10))).color(n6, n7, n8, 0.3f).endVertex();
    }
