...
public class Class7948
{
    ...
    private final Map<Item, Class7731> field32626;
    ...
    public boolean method25769(final Item class3820) {
        return this.method25770(class3820, 0.0f) > 0.0f;
    }
    
    public float method25770(final Item class3820, final float n) {
    ...
    public void method25771() {
        ...
        if (!this.field32626.isEmpty()) {
            final Iterator<Map.Entry<Item, Class7731>> iterator = this.field32626.entrySet().iterator();
            while (iterator.hasNext()) {
                ...
                iterator.remove();
                this.method25775((Item)entry.getKey());
            }
        }
    }
    
    public void method25772(final Item class3820, final int n) {
        this.field32626.put(class3820, new Class7731(this, this.field32627, this.field32627 + n, null));
        this.method25774(class3820, n);
    }
    
    public void method25773(final Item class3820) {
