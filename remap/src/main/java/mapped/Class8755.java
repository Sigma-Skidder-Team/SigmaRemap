...
public class Class8755 extends Class8754
{
    ...
    public Class8755(final Class8754 class8754, final TextureAtlasSprite class8755) {
    ...
    private static int[] method30314(final int[] original, final TextureAtlasSprite class1912, final TextureAtlasSprite class1913) {
        final int[] copy = Arrays.copyOf(original, original.length);
        for (int i = 0; i < 4; ++i) {
            final Class9272 field39607 = DefaultVertexFormats.field39607;
