...
public class Class5295 extends Class5291
{
    private static String[] field22349;
    
    public Class7276 method16427(final ByteBuf byteBuf) throws Exception {
        final short unsignedByte = byteBuf.readUnsignedByte();
        if (unsignedByte != 255) {
            final Class1969 method7971 = Class1969.method7971(byteBuf.readByte());
            return new Class7276(unsignedByte, method7971, method7971.method7969().method16378(byteBuf));
        }
        return null;
    }
