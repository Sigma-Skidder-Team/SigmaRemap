...
public class Class8667
{
    public static void method29672(final CommandDispatcher<Class7492> commandDispatcher) {
        commandDispatcher.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)Class7788.method25001("setworldspawn").requires(class7492 -> class7492.method23210(2))).executes(commandContext -> method29673((Class7492)commandContext.getSource(), new BlockPos(((Class7492)commandContext.getSource()).method23249())))).then(Class7788.method25002("pos", (com.mojang.brigadier.arguments.ArgumentType<Object>)Class8330.method27767()).executes(commandContext -> method29673((Class7492)commandContext.getSource(), Class8330.method27769((CommandContext<Class7492>)commandContext, "pos")))));
    }
