            ...
            Label_0628: {
                if (this.field20283.field35909 == null || this.field20283.field35909.field23465 <= 0) {
                    if (method2079 == Class869.method5277().field4684) {
                        ...
                        final Vec3d method2085 = new Vec3d(n4 * -0.36 * n9, -0.045 * n9, 0.4).rotatePitch(-MathHelper.method35700(n2, method2079.field2402, method2079.field2400) * 0.017453292f).rotateYaw(-MathHelper.method35700(n2, method2079.field2401, method2079.field2399) * 0.017453292f).rotateYaw(method2084 * 0.5f).rotatePitch(-method2084 * 0.7f);
                        n10 = MathHelper.method35701(n2, method2079.field2392, method2079.getPosX()) + method2085.x;
                        n11 = MathHelper.method35701(n2, method2079.field2393, method2079.getPosY()) + method2085.y;
                        n12 = MathHelper.method35701(n2, method2079.field2394, method2079.getPosZ()) + method2085.z;
                        method2086 = method2079.method1892();
                        break Label_0628;
                    }
                }
                n10 = MathHelper.method35701(n2, method2079.field2392, method2079.getPosX()) - n7 * n8 - n6 * 0.8;
                n11 = method2079.field2393 + method2079.method1892() + (method2079.getPosY() - method2079.field2393) * n2 - 0.45;
                n12 = MathHelper.method35701(n2, method2079.field2394, method2079.getPosZ()) - n6 * n8 + n7 * 0.8;
                method2086 = (method2079.method1814() ? -0.1875f : 0.0f);
            }
            final double method2087 = MathHelper.method35701(n2, class425.field2392, class425.getPosX());
            final double n13 = MathHelper.method35701(n2, class425.field2393, class425.getPosY()) + 0.25;
            final double method2088 = MathHelper.method35701(n2, class425.field2394, class425.getPosZ());
