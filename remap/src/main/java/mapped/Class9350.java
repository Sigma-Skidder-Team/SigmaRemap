...
public class Class9350
{
    ...
    public static void method34660(final CommandDispatcher<Class7492> commandDispatcher) {
        ...
        for (final Class2113 class2113 : Class2113.values()) {
            method25001.then(Class7788.method25001(class2113.method8239()).executes(commandContext -> method34661(commandContext.getSource(), class2113)));
        }
        commandDispatcher.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)method25001.requires(class2114 -> class2114.method23210(2))).executes(commandContext -> {
            ...
            ((Class7492)commandContext.getSource()).method23257(new Class2259("commands.difficulty.query", method6954.method8236()), false);
    ...
    public static int method34661(final Class7492 class7492, final Class2113 class7493) throws CommandSyntaxException {
        ...
        if (method23255.method1481(DimensionType.field2223).method6954() != class7493) {
            ...
            class7492.method23257(new Class2259("commands.difficulty.success", class7493.method8236()), true);
            return 0;
        }
        throw Class9350.field40127.create(class7493.method8239());
    }
    
    static {
        field40127 = new DynamicCommandExceptionType(o -> {
            new Class2259("commands.difficulty.failure", o);
            return;
        });
    }
}
