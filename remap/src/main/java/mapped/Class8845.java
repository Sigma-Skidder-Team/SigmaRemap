...
public class Class8845
{
    ...
    public static float[] method30911(final LivingEntity class511, final double n, final double n2, final double n3) {
        ...
        final double y = class511.posY - Class8845.field37174.player.method1892() - 0.019999999552965164 + class511.method1892() - n2;
        final double y2 = method33307[2] - n3;
        return new float[] { method30910(Class8845.field37174.player.rotationYaw, (float)(Math.atan2(y2, x) * 180.0 / 3.141592653589793) - 90.0f, 360.0f), method30910(Class8845.field37174.player.rotationPitch, (float)(-(Math.atan2(y, MathHelper.sqrt(x * x + y2 * y2)) * 180.0 / 3.141592653589793)), 360.0f) };
    }
    
    public static float[] method30912(final Entity class399) {
        return method30913(class399, Class8845.field37174.player.posX + (Class8845.field37174.player.posX - Class8845.field37174.player.lastTickPosX) * Class8845.field37174.method5314(), Class8845.field37174.player.posY + (Class8845.field37174.player.posY - Class8845.field37174.player.lastTickPosY) * Class8845.field37174.method5314(), Class8845.field37174.player.posZ + (Class8845.field37174.player.posZ - Class8845.field37174.player.lastTickPosZ) * Class8845.field37174.method5314());
    }
    ...
    public static float[] method30913(final Entity class399, final double n, final double n2, final double n3) {
        ...
        final double x = n4 - n;
        final double y = n6 - Class8845.field37174.player.method1892() - 0.019999999552965164 + class399.method1892() - n2;
    ...
    public static float[] method30914(final LivingEntity class511, final double n, final double n2, final double n3) {
        ...
        final double y = class511.posY - Class8845.field37174.player.method1892() - 0.019999999552965164 + class511.method1892() - n2 - Math.random();
    ...
    public static float[] method30915(final LivingEntity class511, final double n, final double n2, final double n3) {
        ...
        final double y = class511.posY - n2 - Class8845.field37174.player.method1892() + class511.method1892() - 0.019999999552965164 - 0.6000000238418579 - n5;
    ...
    public static float[] method30916(final LivingEntity class511, final double n, final double n2, final double n3, final float n4) {
        if (ColorUtils.getEntityFromRayTrace(Class8845.field37175, Class8845.field37176, n4, 0.0) != null) {
        ...
        if (Class8845.field37177 <= new Date().getTime() - 500L) {
            ...
            final double y = class511.posY - n2 - Class8845.field37174.player.method1892() + class511.method1892() - 0.019999999552965164 - 0.6000000238418579 - n6;
            final double y2 = class511.posZ - n3 + n7;
            final double x2 = MathHelper.sqrt(x * x + y2 * y2);
            Class8845.field37175 = method30910(Class8845.field37174.player.rotationYaw, (float)(Math.atan2(y2, x) * 180.0 / 3.141592653589793) - 90.0f, 360.0f);
            Class8845.field37176 = method30910(Class8845.field37174.player.rotationPitch, (float)(-(Math.atan2(y, x2) * 180.0 / 3.141592653589793)), 360.0f);
            return new float[] { Class8845.field37175, Class8845.field37176 };
        }
        return new float[] { Class8845.field37175, Class8845.field37176 };
    }
    ...
    public static float[] method30919(final double n, final double n2, final double n3) {
        final double x = n - Class8845.field37174.player.posX;
        final double y = n2 - Class8845.field37174.player.posZ;
        return new float[] { (float)(Math.atan2(y, x) * 180.0 / 3.141592653589793) - 90.0f, (float)(-(Math.atan2(n3 - Class8845.field37174.player.posY - 1.2, MathHelper.sqrt(x * x + y * y)) * 180.0 / 3.141592653589793)) };
    }
    ...
    public static float[] method30920(final Vec3d class5487, final Vec3d class5488) {
        ...
        return new float[] { method30910(0.0f, (float)(Math.atan2(y, x) * 180.0 / 3.141592653589793) - 90.0f, 360.0f), method30910(Class8845.field37174.player.rotationPitch, (float)(-(Math.atan2(class5488.y - class5487.y, MathHelper.sqrt(x * x + y * y)) * 180.0 / 3.141592653589793)), 360.0f) };
    }
    
    public static float[] method30921(final LivingEntity class511) {
        final double n = Class8845.field37174.player.posX + (Class8845.field37174.player.posX - Class8845.field37174.player.lastTickPosX) * Class8845.field37174.method5314();
        final double n2 = Class8845.field37174.player.posZ + (Class8845.field37174.player.posZ - Class8845.field37174.player.lastTickPosZ) * Class8845.field37174.method5314();
        final double n3 = Class8845.field37174.player.posY + (Class8845.field37174.player.posY - Class8845.field37174.player.lastTickPosY) * Class8845.field37174.method5314();
        ...
        final double n9 = Class8845.field37174.player.method1732(class511);
        ...
        return new float[] { (float)Math.toDegrees(Math.atan2(y, x)) - 90.0f, -((float)(-(Math.atan2(n3 + Class8845.field37174.player.method1892() - (n6 + class511.method1931()), MathHelper.sqrt(x * x + y * y)) * 180.0 / 3.141592653589793)) + Class8845.field37174.player.method1732(class511) * 0.14f) };
    }
    
    public static Class7988 method30922(final Entity class399) {
        final float[] method30913 = method30913(class399, Class8845.field37174.player.posX, Class8845.field37174.player.posY, Class8845.field37174.player.posZ);
        return new Class7988(method30913[0], method30913[1]);
    }
    
    public static boolean method30923(final Vec3d class5487) {
        final BlockRayTraceResult method6987 = Class8845.field37174.world.rayTraceBlocks(new RayTraceContext(new Vec3d(Class8845.field37174.player.posX, Class8845.field37174.player.posY + Class8845.field37174.player.method1892(), Class8845.field37174.player.posZ), class5487, RayTraceContext.BlockMode.OUTLINE, RayTraceContext.FluidMode.NONE, Class8845.field37174.player));
    ...
    public static Class7988 method30924(final Entity class399) {
        for (int i = -1; i < 2; ++i) {
            ...
            final double x = field2395 - Class8845.field37174.player.posX;
            final double y = n3 - Class8845.field37174.player.method1892() - 0.019999999552965164 - Class8845.field37174.player.posY;
            final double y2 = field2396 - Class8845.field37174.player.posZ;
            final double x2 = MathHelper.sqrt(x * x + y2 * y2);
            final float method30910 = method30910(Class8845.field37174.player.rotationYaw, (float)(Math.atan2(y2, x) * 180.0 / 3.141592653589793) - 90.0f, 360.0f);
            final float method30911 = method30910(Class8845.field37174.player.rotationPitch, (float)(-(Math.atan2(y, x2) * 180.0 / 3.141592653589793)), 360.0f);
            ...
            for (int j = -1; j < 2; j += 2) {
                ...
                if (Class8845.field37174.player.posX >= n4 + n7) {
                    if (Class8845.field37174.player.posX > n4 + n7) {
                        if (Class8845.field37174.player.posZ >= n5 - n8) {
                            n4 += n7;
                        }
                        else {
                            n4 -= n7;
                ...
                final double x3 = n4 - Class8845.field37174.player.posX;
                final double y3 = n6 - Class8845.field37174.player.method1892() - 0.02 - Class8845.field37174.player.posY;
                final double y4 = n5 - Class8845.field37174.player.posZ;
                final double x4 = MathHelper.sqrt(x3 * x3 + y4 * y4);
                final float method30912 = method30910(Class8845.field37174.player.rotationYaw, (float)(Math.atan2(y4, x3) * 180.0 / 3.141592653589793) - 90.0f, 360.0f);
                final float method30913 = method30910(Class8845.field37174.player.rotationPitch, (float)(-(Math.atan2(y3, x4) * 180.0 / 3.141592653589793)), 360.0f);
    ...
    public static float method30925(final float n, final double n2, final double n3) {
        final double n4 = n2 - Class8845.field37174.player.posX;
        final double n5 = n3 - Class8845.field37174.player.posZ;
        double degrees = 0.0;
        if (n5 < 0.0 && n4 < 0.0) {
            if (n4 != 0.0) {
    ...
    public static float method30927(final float n, final Entity class399, final double n2) {
        final double n3 = class399.posX - Class8845.field37174.player.posX;
        final double n4 = class399.posZ - Class8845.field37174.player.posZ;
        return -MathHelper.method35668(n - (float)(-Math.toDegrees(Math.atan((n2 - 2.2 + class399.method1892() - Class8845.field37174.player.posY) / MathHelper.sqrt(n3 * n3 + n4 * n4))))) - 2.5f;
    }
