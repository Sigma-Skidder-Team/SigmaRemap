...
public class Class3330 extends Class3167
{
    ...
    public void method10542(final Class5717 class5717) {
        if (this.method9906()) {
            if (this.field15927 >= this.method9886("Flags")) {
                ...
                Class3330.field15514.player.setMotion(0.0, 0.0, 0.0);
            }
        }
    }
    ...
    public void method10544(final Class5744 class5744) {
        if (this.method9906() && class5744.method17046()) {
            if (!Class3330.field15514.player.onGround && !Class6430.method19160(Class3330.field15514.player, 0.001f)) {
                if (this.field15927 >= this.method9886("Flags")) {
    ...
    public void method10545(final Class5723 class5723) {
        ...
        if (Class3330.field15514.player != null) {
            if (class5723.method16998() instanceof Class4328) {
                if (!Class6430.method19160(Class3330.field15514.player, 0.3f)) {
                    if (Class3330.field15514.player.ticksExisted > 10) {
                        ++this.field15927;
                        if (this.field15927 > this.method9886("Flags")) {
