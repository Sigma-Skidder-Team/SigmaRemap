...
public abstract class Biome
{
    ...
    public static final Set<Biome> field15439;
    public static final Class94<Biome> field15440;
    ...
    @Nullable
    public static Biome method9834(final Biome biome) {
        return Biome.field15440.method499(Registry.field217.getId(biome));
    }
    ...
    public Biome(final Class8927 obj) {
    ...
    public float method9844(final BlockPos class354) {
        ...
        return this.method9867() - ((float)(Biome.field15441.method29027(class354.getX() / 8.0f, class354.getZ() / 8.0f, false) * 4.0) + class354.getY() - 64.0f) * 0.05f / 30.0f;
    }
