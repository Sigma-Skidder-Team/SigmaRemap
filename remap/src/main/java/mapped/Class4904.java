...
public class Class4904 extends Panel
{
    ...
    public void draw(final float partialTicks) {
        final int method19118 = AllUtils.applyAlpha(Color.HSBtoRGB(this.field20979, 0.0f, 1.0f), partialTicks);
        final int method19119 = AllUtils.applyAlpha(Color.HSBtoRGB(this.field20979, 1.0f, 1.0f), partialTicks);
        final int method19120 = AllUtils.applyAlpha(ClientColors.DEEP_TEAL.color, partialTicks);
        ...
        RenderUtil.method26882(this.method14272(), this.method14274(), this.method14272() + this.method14276(), this.method14274() + this.method14278(), AllUtils.applyAlpha(ClientColors.DEEP_TEAL.color, 0.0f), AllUtils.applyAlpha(ClientColors.DEEP_TEAL.color, 0.0f), method19120, method19120);
        Class4885.method14626(this.x + Math.round(this.field20480 * this.method14730()), this.y + Math.round(this.field20481 * (1.0f - this.method14733())), Color.HSBtoRGB(this.field20979, this.field20980, this.field20981), partialTicks);
        RenderUtil.method26878((float)this.method14272(), (float)this.method14274(), (float)(this.method14272() + this.method14276()), (float)(this.method14274() + this.method14278()), AllUtils.applyAlpha(ClientColors.DEEP_TEAL.color, 0.25f * partialTicks));
