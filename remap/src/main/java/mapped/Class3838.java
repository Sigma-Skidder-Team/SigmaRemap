...
public class Class3838 extends Class3834
{
    ...
    public Class3838(final Class9288 class9288) {
        super(class9288);
        this.method11877(((Class7097<O, BlockState>)((Class7097<O, BlockState>)this.field17406.method32903()).method21773((Class7111<Comparable>)Class3838.field17415, Direction.SOUTH)).method21773((Class7111<Comparable>)Class3838.field17451, false));
    }
    ...
    public BlockState method11790(final BlockState class7096, final Class2052 class7097) {
        return ((Class7097<O, BlockState>)class7096).method21773((Class7111<Comparable>)Class3838.field17415, class7097.method8142(class7096.method21772((Class7111<Direction>)Class3838.field17415)));
    }
    ...
    public void method11822(final BlockState class7096, final Class1849 class7097, final BlockPos class7098, final Random random) {
        if (!class7096.method21772((Class7111<Boolean>)Class3838.field17451)) {
            class7097.method6688(class7098, ((Class7097<O, BlockState>)class7096).method21773((Class7111<Comparable>)Class3838.field17451, true), 2);
            class7097.method6907().method21345(class7098, this, 2);
        }
        else {
            class7097.method6688(class7098, ((Class7097<O, BlockState>)class7096).method21773((Class7111<Comparable>)Class3838.field17451, false), 2);
        }
            ...
            if (!class7097.isRemote()) {
                if (class7096.method21772((Class7111<Boolean>)Class3838.field17451)) {
                    if (!class7097.method6833().method21340(class7098, this)) {
                        final BlockState class7100 = ((Class7097<O, BlockState>)class7096).method21773((Class7111<Comparable>)Class3838.field17451, false);
    ...
    public void method11829(final BlockState class7096, final World class7097, final BlockPos class7098, final BlockState class7099, final boolean b) {
        if (class7096.method21696() != class7099.method21696()) {
            if (!class7097.isRemote) {
                if (class7096.method21772((Class7111<Boolean>)Class3838.field17451)) {
                    if (class7097.method6833().method21340(class7098, this)) {
                        this.method11897(class7097, class7098, ((Class7097<O, BlockState>)class7096).method21773((Class7111<Comparable>)Class3838.field17451, false));
                    }
                }
            }
        }
    ...
    public BlockState method11846(final Class7074 class7074) {
        return ((Class7097<O, BlockState>)this.method11878()).method21773((Class7111<Comparable>)Class3838.field17415, class7074.method21642().getOpposite().getOpposite());
    }
