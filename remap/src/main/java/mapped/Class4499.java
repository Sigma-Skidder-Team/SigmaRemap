...
public class Class4499 extends Class4484
{
    ...
    public Class4499(final Class1795 class1795, final CompoundNBT class1796) {
    ...
    public boolean method13421(final Class1851 class1851, final Class6346<?> class1852, final Random random, final MutableBoundingBox class1853, final ChunkPos class1854) {
        ...
        final BlockState class1859 = ((StateHolder<O, BlockState>) Blocks.field29396.getDefaultState()).with((IProperty<Comparable>)Class3916.field17732, Direction.NORTH);
        for (int k = 0; k <= 6; ++k) {
            final int n = k + 4;
            for (int l = 5; l <= 7; ++l) {
            ...
            if (n >= 5 && n <= 8) {
                this.method13444(class1851, class1853, 5, 5, n, 7, k + 4, n, Blocks.field29394.getDefaultState(), Blocks.field29394.getDefaultState(), false);
            }
            else if (n >= 9) {
                if (n <= 10) {
                    this.method13444(class1851, class1853, 5, 8, n, 7, k + 4, n, Blocks.field29394.getDefaultState(), Blocks.field29394.getDefaultState(), false);
                }
            }
            if (k >= 1) {
                this.method13444(class1851, class1853, 5, 6 + k, n, 7, 9 + k, n, Blocks.AIR.getDefaultState(), Blocks.AIR.getDefaultState(), false);
            }
        }
        ...
        this.method13444(class1851, class1853, 5, 13, 12, 7, 13, 12, Blocks.AIR.getDefaultState(), Blocks.AIR.getDefaultState(), false);
        this.method13444(class1851, class1853, 2, 5, 2, 3, 5, 3, Blocks.field29394.getDefaultState(), Blocks.field29394.getDefaultState(), false);
        this.method13444(class1851, class1853, 2, 5, 9, 3, 5, 10, Blocks.field29394.getDefaultState(), Blocks.field29394.getDefaultState(), false);
        this.method13444(class1851, class1853, 2, 5, 4, 2, 5, 8, Blocks.field29394.getDefaultState(), Blocks.field29394.getDefaultState(), false);
        this.method13444(class1851, class1853, 9, 5, 2, 10, 5, 3, Blocks.field29394.getDefaultState(), Blocks.field29394.getDefaultState(), false);
        this.method13444(class1851, class1853, 9, 5, 9, 10, 5, 10, Blocks.field29394.getDefaultState(), Blocks.field29394.getDefaultState(), false);
        this.method13444(class1851, class1853, 10, 5, 4, 10, 5, 8, Blocks.field29394.getDefaultState(), Blocks.field29394.getDefaultState(), false);
        ...
        this.method13444(class1851, class1853, 3, 4, 4, 4, 4, 8, Blocks.field29339.getDefaultState(), Blocks.field29339.getDefaultState(), false);
        this.method13444(class1851, class1853, 8, 4, 4, 9, 4, 8, Blocks.field29339.getDefaultState(), Blocks.field29339.getDefaultState(), false);
        this.method13444(class1851, class1853, 3, 5, 4, 4, 5, 8, Blocks.field29397.getDefaultState(), Blocks.field29397.getDefaultState(), false);
        this.method13444(class1851, class1853, 8, 5, 4, 9, 5, 8, Blocks.field29397.getDefaultState(), Blocks.field29397.getDefaultState(), false);
        ...
        for (int n3 = 4; n3 <= 8; ++n3) {
            for (int n4 = 0; n4 <= 2; ++n4) {
                this.method13449(class1851, Blocks.field29394.getDefaultState(), n3, -1, n4, class1853);
                this.method13449(class1851, Blocks.field29394.getDefaultState(), n3, -1, 12 - n4, class1853);
            }
        }
        for (int n5 = 0; n5 <= 2; ++n5) {
            for (int n6 = 4; n6 <= 8; ++n6) {
                this.method13449(class1851, Blocks.field29394.getDefaultState(), n5, -1, n6, class1853);
                this.method13449(class1851, Blocks.field29394.getDefaultState(), 12 - n5, -1, n6, class1853);
            }
        }
        return true;
    }
