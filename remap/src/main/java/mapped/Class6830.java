...
public class Class6830 extends Class6831
{
    ...
    private final PlayerEntity field26825;
    private final Class428 field26826;
    
    public Class6830(final PlayerEntity field26825, final Class428 field26826) {
        ...
        if (!this.field26826.removed) {
            if (this.field26825.isPassenger()) {
                if (this.field26825.method1920() == this.field26826) {
                    final float method35641 = MathHelper.sqrt(Entity.horizontalMag(this.field26826.getMotion()));
                    if (method35641 < 0.01) {
                        this.field26835 = 0.0f;
                        return;
                    }
                    this.field26835 = 0.0f + MathHelper.clamp(method35641, 0.0f, 1.0f) * 0.75f;
                    return;
                }
            }
        }
