...
public class Class6573 extends Class6564
{
    ...
    public void method19904() {
        if (this.field26073 == Class2198.field13376 && !this.field26094.method4150().method24731()) {
            ...
            this.field26094.rotationYaw = this.method19909(this.field26094.rotationYaw, (float)(MathHelper.method35693(class5487.z, class5487.x) * 57.2957763671875) - 90.0f, 90.0f);
            this.field26094.field2951 = this.field26094.rotationYaw;
            ...
            final double n4 = Math.sin((this.field26094.ticksExisted + this.field26094.getEntityId()) * 0.5) * 0.05;
            final double cos = Math.cos(this.field26094.rotationYaw * 0.017453292f);
            final double sin = Math.sin(this.field26094.rotationYaw * 0.017453292f);
            this.field26094.method1936(this.field26094.getMotion().add(n4 * cos, Math.sin((this.field26094.ticksExisted + this.field26094.getEntityId()) * 0.75) * 0.05 * (sin + cos) * 0.25 + method16753 * n2 * 0.1, n4 * sin));
