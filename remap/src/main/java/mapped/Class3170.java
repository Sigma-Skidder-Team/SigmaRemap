...
public class Class3170 extends Class3167
{
    ...
    public Class3170() {
        super(Class8013.field32991, "ShulkerInfo", "Shows shulker information");
        this.field15530 = -1;
    ...
    public void method9927(final double n, final double n2, final double n3, final Entity class399, final float n4) {
        ...
        GL11.glRotatef(Class3170.field15514.field4644.method5833().method18164(), 0.0f, -1.0f, 0.0f);
    ...
    private void method9928(final Class5733 class5733) {
        ...
        if (Class3170.field15514.field4700 instanceof Class516) {
