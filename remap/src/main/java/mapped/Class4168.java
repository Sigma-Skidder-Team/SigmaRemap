...
public class Class4168 extends Class4158<Class490>
{
    ...
    public void method12476(final Class490 class490, final float n, final MatrixStack class491, final IRenderTypeBuffer class492, final int n2, final int n3) {
    ...
    private static void method12477(final MatrixStack class7351, final IRenderTypeBuffer class7352, final float n, final long n2, final int n3, final int n4, final float[] array) {
        method12478(class7351, class7352, Class4168.field18578, n, 1.0f, n2, n3, n4, array, 0.2f, 0.25f);
    }
    
    public static void method12478(final MatrixStack class7351, final IRenderTypeBuffer class7352, final ResourceLocation class7353, final float n, final float n2, final long x, final int n3, final int n4, final float[] array, final float n5, final float n6) {
        final int n7 = n3 + n4;
    ...
    private static void method12479(final MatrixStack class7351, final Class4150 class7352, final float n, final float n2, final float n3, final float n4, final int n5, final int n6, final float n7, final float n8, final float n9, final float n10, final float n11, final float n12, final float n13, final float n14, final float n15, final float n16, final float n17, final float n18) {
    ...
    private static void method12481(final Matrix4f class6789, final Matrix3f class6790, final Class4150 class6791, final float n, final float n2, final float n3, final float n4, final int n5, final float n6, final float n7, final float n8, final float n9) {
        class6791.pos(class6789, n6, (float)n5, n7).color(n, n2, n3, n4).tex(n8, n9).method12441(Class1904.field10335).method12440(15728880).method12445(class6790, 0.0f, 1.0f, 0.0f).endVertex();
    }
