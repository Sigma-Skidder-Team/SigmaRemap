...
public class Class3917 extends Class3833 implements Class3856
{
    ...
    public Class3917(final Class9288 class9288) {
        super(class9288);
        this.method11877(((Class7097<O, BlockState>)((Class7097<O, BlockState>)this.field17406.method32903()).method21773((Class7111<Comparable>)Class3917.field17752, Direction.NORTH)).method21773((Class7111<Comparable>)Class3917.field17753, false));
    }
    ...
    public boolean method11843(final BlockState class7096, final Class1852 class7097, final BlockPos class7098) {
        final Direction class7099 = class7096.method21772((Class7111<Direction>)Class3917.field17752);
    ...
    public BlockState method11789(final BlockState class7096, final Direction class7097, final BlockState class7098, final Class1851 class7099, final BlockPos class7100, final BlockPos class7101) {
        if (class7097.getOpposite() == class7096.method21772((Class7111<Direction>)Class3917.field17752) && !class7096.method21752(class7099, class7100)) {
    ...
    public BlockState method11846(final Class7074 class7074) {
        if (!class7074.method21641()) {
            final BlockState method6701 = class7074.method21654().method6701(class7074.method21639().method1149(class7074.method21648().getOpposite()));
        ...
        BlockState method6702 = this.method11878();
        ...
        for (final Direction class7075 : class7074.method21643()) {
            if (class7075.getAxis().isHorizontal()) {
                method6702 = ((Class7097<Object, BlockState>)method6702).method21773((Class7111<Comparable>)Class3917.field17752, class7075.getOpposite());
                if (method6702.method21752(method6703, method6704)) {
                    return ((Class7097<Object, BlockState>)method6702).method21773((Class7111<Comparable>)Class3917.field17753, method6705.method21779() == Class7558.field29976);
                }
            }
        }
        return null;
    ...
    public BlockState method11790(final BlockState class7096, final Class2052 class7097) {
        return ((Class7097<O, BlockState>)class7096).method21773((Class7111<Comparable>)Class3917.field17752, class7097.method8142(class7096.method21772((Class7111<Direction>)Class3917.field17752)));
    }
    
    @Override
    public BlockState method11791(final BlockState class7096, final Class2181 class7097) {
        return class7096.method21708(class7097.method8344(class7096.method21772((Class7111<Direction>)Class3917.field17752)));
    }
