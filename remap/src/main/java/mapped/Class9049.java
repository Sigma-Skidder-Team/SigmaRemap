...
public class Class9049
{
    ...
    private final Consumer<IPacket<?>> field38304;
    ...
    public Class9049(final Class1849 field38300, final Entity field38301, final int field38302, final boolean field38303, final Consumer<IPacket<?>> field38304) {
        ...
        this.method32543();
        this.field38308 = MathHelper.method35642(field38301.rotationYaw * 256.0f / 360.0f);
        this.field38309 = MathHelper.method35642(field38301.rotationPitch * 256.0f / 360.0f);
        this.field38310 = MathHelper.method35642(field38301.method1844() * 256.0f / 360.0f);
        this.field38316 = field38301.onGround;
    }
    ...
    public void method32538() {
        ...
        if (this.field38301 instanceof Class862) {
            if (this.field38312 % 10 == 0) {
                ...
                if (method1909.getItem() instanceof Class4094) {
                    ...
                    for (final Class513 class513 : this.field38300.getPlayers()) {
        ...
        Label_0352: {
            if (this.field38312 % this.field38302 != 0) {
                if (!this.field38301.isAirBorne) {
                    if (!this.field38301.method1650().method33570()) {
                        break Label_0352;
                    }
                }
            }
            if (!this.field38301.isPassenger()) {
                ++this.field38313;
                final int method1912 = MathHelper.method35642(this.field38301.rotationYaw * 256.0f / 360.0f);
                final int method1913 = MathHelper.method35642(this.field38301.rotationPitch * 256.0f / 360.0f);
                final Vec3d method1914 = this.field38301.method1934().subtract(SEntityPacket.func_218744_a(this.field38305, this.field38306, this.field38307));
                final boolean b = method1914.lengthSquared() >= 7.62939453125E-6;
                IPacket<?> class514 = null;
                ...
                Label_0674: {
                    if (this.field38312 > 0 || this.field38301 instanceof Class402) {
                        final long method1915 = SEntityPacket.func_218743_a(method1914.x);
                        final long method1916 = SEntityPacket.func_218743_a(method1914.y);
                        final long method1917 = SEntityPacket.func_218743_a(method1914.z);
                        boolean b4 = false;
                        Label_0790: {
                        ...
                        if (!b4) {
                            if (this.field38313 <= 400) {
                                if (!this.field38315) {
                                    if (this.field38316 == this.field38301.onGround) {
                                        if (!b2 || !b3) {
                                            if (!(this.field38301 instanceof Class402)) {
                                                if (b2) {
                                                    class514 = new Class4372(this.field38301.getEntityId(), (short)method1915, (short)method1916, (short)method1917, this.field38301.onGround);
                                                    break Label_0674;
                                                }
                                                if (!b3) {
                                                    break Label_0674;
                                                }
                                                class514 = new Class4373(this.field38301.getEntityId(), (byte)method1912, (byte)method1913, this.field38301.onGround);
                                                break Label_0674;
                                            }
                                        }
                                        class514 = new Class4371(this.field38301.getEntityId(), (short)method1915, (short)method1916, (short)method1917, (byte)method1912, (byte)method1913, this.field38301.onGround);
                                        break Label_0674;
                                    }
                                }
                            }
                        }
                        this.field38316 = this.field38301.onGround;
                        this.field38313 = 0;
                ...
                Label_0688: {
                    if (!this.field38303) {
                        if (!this.field38301.isAirBorne) {
                            if (!(this.field38301 instanceof LivingEntity)) {
                                break Label_0688;
                            }
                            if (!((LivingEntity)this.field38301).method2773()) {
                                break Label_0688;
                            }
                        }
                    }
                    if (this.field38312 > 0) {
                        final Vec3d method1918 = this.field38301.getMotion();
                        ...
                        this.field38304.accept(new Class4273(this.field38301.getEntityId(), this.field38311));
                    }
                }
                if (class514 != null) {
                ...
                final int method1920 = MathHelper.method35642(this.field38301.rotationYaw * 256.0f / 360.0f);
                final int method1921 = MathHelper.method35642(this.field38301.rotationPitch * 256.0f / 360.0f);
                if (Math.abs(method1920 - this.field38308) >= 1 || Math.abs(method1921 - this.field38309) >= 1) {
                    this.field38304.accept(new Class4373(this.field38301.getEntityId(), (byte)method1920, (byte)method1921, this.field38301.onGround));
            ...
            this.field38301.isAirBorne = false;
        }
        ++this.field38312;
        if (this.field38301.velocityChanged) {
            this.method32545(new Class4273(this.field38301));
            this.field38301.velocityChanged = false;
        }
    }
    ...
    public void method32541(final Consumer<IPacket<?>> consumer) {
        if (this.field38301.removed) {
            Class9049.field38299.warn("Fetching packet for removed entity " + this.field38301);
        }
        final IPacket<?> method1932 = this.field38301.method1932();
        ...
        if (!this.field38301.method1650().method33579()) {
            consumer.accept(new Class4268(this.field38301.getEntityId(), this.field38301.method1650(), true));
        }
        int field38303 = this.field38303 ? 1 : 0;
        if (this.field38301 instanceof LivingEntity) {
            final Collection<Class7619> method1933 = ((Class6820)((LivingEntity)this.field38301).method2711()).method20877();
            if (!method1933.isEmpty()) {
                consumer.accept(new Class4347(this.field38301.getEntityId(), method1933));
            }
            if (((LivingEntity)this.field38301).method2773()) {
                field38303 = 1;
            }
        }
        this.field38311 = this.field38301.getMotion();
        if (field38303 != 0) {
            if (!(method1932 instanceof Class4276)) {
                consumer.accept(new Class4273(this.field38301.getEntityId(), this.field38311));
            }
        }
        if (this.field38301 instanceof LivingEntity) {
            for (final Class2215 class2215 : Class2215.values()) {
                final ItemStack method1934 = ((LivingEntity)this.field38301).method2718(class2215);
                if (!method1934.method27620()) {
                    consumer.accept(new Class4402(this.field38301.getEntityId(), class2215, method1934));
                }
            }
        }
        if (this.field38301 instanceof LivingEntity) {
            final Iterator<Class1948> iterator = ((LivingEntity)this.field38301).method2651().iterator();
            while (iterator.hasNext()) {
                consumer.accept(new Class4384(this.field38301.getEntityId(), iterator.next()));
            }
        }
    ...
    private void method32542() {
        final EntityDataManager method1650 = this.field38301.method1650();
        if (method1650.method33570()) {
            this.method32545(new Class4268(this.field38301.getEntityId(), method1650, false));
        }
        if (this.field38301 instanceof LivingEntity) {
            final Set<Class7619> method1651 = ((Class6820)((LivingEntity)this.field38301).method2711()).method20876();
            if (!method1651.isEmpty()) {
                this.method32545(new Class4347(this.field38301.getEntityId(), method1651));
            }
            method1651.clear();
        }
    }
    ...
    private void method32543() {
        this.field38305 = SEntityPacket.func_218743_a(this.field38301.getPosX());
        this.field38306 = SEntityPacket.func_218743_a(this.field38301.getPosY());
        this.field38307 = SEntityPacket.func_218743_a(this.field38301.getPosZ());
    }
    
    public Vec3d method32544() {
        return SEntityPacket.func_218744_a(this.field38305, this.field38306, this.field38307);
    }
    
    private void method32545(final IPacket<?> class4252) {
