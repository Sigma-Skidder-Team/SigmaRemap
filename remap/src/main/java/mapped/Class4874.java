...
public class Class4874 extends Class4873 implements Class4870
{
    ...
    public Class4874(final Class4803 class4803, final String s, final int n, final int n2, final int n3, final int n4, final Class7776 class4804, final Class6523 class4805, final String s2, final Class7524 class4806) {
    ...
    public Class4874(final Class4803 class4803, final String s, final int n, final int n2, final int n3, final int n4, final Class7776 class4804, final Class6523 class4805, final String s2) {
        super(class4803, s, n, n2, n3, n4, class4804, class4805, s2);
        this.field20858 = false;
        this.field20859 = new Class9572(90, 90, Class2186.field12965);
    }
    
    public Class4874(final Class4803 class4803, final String s, final int n, final int n2, final int n3, final int n4, final Class7776 class4804, final Class6523 class4805) {
        super(class4803, s, n, n2, n3, n4, class4804, class4805);
        this.field20858 = false;
        this.field20859 = new Class9572(90, 90, Class2186.field12965);
    }
    
    public Class4874(final Class4803 class4803, final String s, final int n, final int n2, final int n3, final int n4, final Class7776 class4804) {
    ...
    public void method14205(final float n) {
        ...
        if (n2 > 1.0f) {
            ...
            Class8154.method26904((1.0f - n2 / this.method14605()) * method19132.method23505(s) / 2.0f + 1.0f - method19132.method23505(s) / 2.0f, method19132.method23506(s) / 3.0f, (float)(method19132.method23505(s) * 2), method19132.method23506(s) * 3.0f, Class7853.field32200, n8 * 0.6f);
            Class8154.method26889(method19132, (1.0f - n2 / this.method14605()) * method19132.method23505(s) / 2.0f + 1.0f, 40.0f, s, Class6430.method19118(this.method14318().method19729(), n8 * 0.6f));
            GL11.glPopMatrix();
        }
        super.method14229(n);
    }
