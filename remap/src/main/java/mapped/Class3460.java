...
public class Class3460<T extends Class776> extends Class3446
{
    ...
    public void method11016() {
        if (this.field16314.method4150().method24714().withinDistance(this.field16314.method1934(), 1.414)) {
            final List<Entity> method6739 = this.field16314.world.method6739((Class<? extends Entity>)Class427.class, this.field16314.getBoundingBox().grow(4.0, 4.0, 4.0), (Predicate<? super Entity>)Class776.method4307());
