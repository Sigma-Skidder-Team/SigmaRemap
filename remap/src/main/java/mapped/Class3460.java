...
public class Class3460<T extends Class776> extends Class3446
{
                ...
                if (this.field16314.method4308()) {
                    if (!ItemStack.method27643(this.field16314.method2718(Class2215.field13605), Class8792.method30651())) {
                        ...
                        if (method4293 == null || !method4293.method1768()) {
                            final List<Entity> method4294 = this.field16314.world.method6739((Class<? extends Entity>)Class427.class, this.field16314.method1886().method18495(16.0, 8.0, 16.0), (Predicate<? super Entity>)Class776.method4307());
    ...
    public void method11016() {
        if (this.field16314.method4150().method24714().withinDistance(this.field16314.method1934(), 1.414)) {
            final List<Entity> method6739 = this.field16314.world.method6739((Class<? extends Entity>)Class427.class, this.field16314.method1886().method18495(4.0, 4.0, 4.0), (Predicate<? super Entity>)Class776.method4307());
