...
public abstract class Class3910 extends Class3911
{
    ...
    private static boolean method12015(final Class7096 class7096, final Class1852 class7097, final BlockPos class7098) {
        ...
        return (method1138.method21696() == Class7521.field29329 && method1138.method21772((IProperty<Integer>)Class4030.field18124) == 1) || Class1890.method7299(class7097, class7096, class7098, method1138, method1137, Direction.UP, method1138.method21700(class7097, method1137)) < class7097.getMaxLightLevel();
    }
        ...
        if (method12015(class7096, class7097, class7098)) {
            if (class7097.method6969(class7098.method1137()) >= 9) {
                ...
                for (int i = 0; i < 4; ++i) {
                    ...
                    if (class7097.getBlockState(method11879).method21696() == Class7521.field29156) {
                        if (method12016(method11878, class7097, method11879)) {
                            class7097.method6692(method11879, ((StateHolder<Object, Class7096>)method11878).with((IProperty<Comparable>)Class3910.field17717, class7097.getBlockState(method11879.method1137()).method21696() == Class7521.field29329));
                        }
                    }
                }
            }
            ...
            class7097.method6692(class7098, Class7521.field29156.getDefaultState());
        }
    }
}
