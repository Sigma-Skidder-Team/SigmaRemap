...
public class Class5894<T extends Entity> extends Class5846<T>
{
    ...
    public void method17557(final T t, final float n, final float n2, final float n3, final float n4, final float n5) {
        ...
        final float method35638 = MathHelper.sin(this.field24203.field25184);
        final float method35639 = MathHelper.cos(this.field24203.field25184);
    ...
    public Iterable<Class6300> method17570() {
        return (Iterable<Class6300>)ImmutableList.of(this.field24203, this.field24204, this.field24205, this.field24206, (Object)this.field24207);
    }
