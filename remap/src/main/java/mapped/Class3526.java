...
public class Class3526 extends Class3446
{
    ...
    private LivingEntity field16539;
    ...
    public boolean method11013() {
        if (this.field16538.isBeingRidden()) {
            return false;
        }
        ...
        if (this.field16539 != null) {
            ...
            return method1734 >= 4.0 && method1734 <= 16.0 && this.field16538.onGround && this.field16538.method2633().nextInt(5) == 0;
        }
        return false;
    }
    ...
    public boolean method11017() {
        return !this.field16538.onGround;
    }
    
    @Override
    public void method11015() {
        final Vec3d method1935 = this.field16538.getMotion();
        ...
        this.field16538.setMotion(method1936.x, this.field16540, method1936.z);
    }
}
