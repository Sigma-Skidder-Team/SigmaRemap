...
{
    private final Block field19057;
    private final Class9342 field19058;
    private final Class8685 field19059;
    
    public Class4241(final Block field19057, final Class9342 field19058, final Class8685 field19059) {
    ...
    public static Class4241 method12747(final Block class3833, final Class9425 class3834, final Class8685 class3835) {
        return new Class4241(class3833, class3834.method35029(), class3835);
    }
    
    public boolean method12748(final Block class3833, final ItemStack class3834, final int n) {
    ...
    public JsonElement method12682() {
        ...
        if (this.field19057 != null) {
            jsonObject.addProperty("block", Registry.BLOCK.getKey(this.field19057).toString());
        }
