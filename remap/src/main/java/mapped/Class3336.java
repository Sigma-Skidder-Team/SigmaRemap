...
public class Class3336 extends Class3167
{
    ...
    public void method10558(final Class5744 class5744) {
        ...
        ++this.field15937;
        if (class5744.method17036() > Class3336.field15514.field4684.field2396 - 1.0E-6 && class5744.method17036() < Class3336.field15514.field4684.field2396 + 1.0E-6) {
            class5744.method17037(Class3336.field15514.field4684.field2396 + 0.4);
            class5744.method17045(false);
        }
        if (this.field15937 <= 60) {
            for (int i = 0; i < 10; ++i) {
                Class3336.field15514.method5269().method17292(new Class4354(Class3336.field15514.field4684.field2395, Class3336.field15514.field4684.field2396 + ((i > 2 && i < 8) ? 0.2 : -0.2), Class3336.field15514.field4684.field2397, true));
            }
            Class3336.field15514.field4684.field4075 = 0.0;
            if (Class3336.field15514.field4684.field2424 <= 1) {
