...
public class Class1658 implements Class1657
{
    ...
    public void method5788(final BlockState class7096, final BlockPos class7097, final Class1856 class7098, final MatrixStack class7099, final Class4150 class7100) {
        this.method5789(class7096, class7097, class7098, class7099, class7100, Class6350.field25397);
    }
    
    public void method5789(final BlockState class7096, final BlockPos class7097, final Class1856 class7098, final MatrixStack class7099, final Class4150 class7100, final Class6349 class7101) {
    ...
    public boolean method5790(final BlockState class7096, final BlockPos class7097, final Class1856 class7098, final MatrixStack class7099, final Class4150 class7100, final boolean b, final Random random) {
        return this.method5791(class7096, class7097, class7098, class7099, class7100, b, random, Class6350.field25397);
    }
    
    public boolean method5791(final BlockState class7096, final BlockPos class7097, final Class1856 class7098, final MatrixStack class7099, final Class4150 class7100, final boolean b, final Random random, final Class6349 class7101) {
        try {
    ...
    public void method5795(final BlockState class7096, final MatrixStack class7097, final IRenderTypeBuffer class7098, final int n, final int n2) {
        this.method5796(class7096, class7097, class7098, n, n2, Class6350.field25397);
    }
    
    public void method5796(final BlockState class7096, final MatrixStack class7097, final IRenderTypeBuffer class7098, final int n, final int n2, final Class6349 class7099) {
        ...
        if (method21710 != Class2115.field12305) {
            switch (Class8083.field33291[method21710.ordinal()]) {
                case 1: {
                    ...
                    this.field9370.method33364(class7097.getLast(), class7098.method25214(Class7969.method25825(class7096)), class7096, method21711, (method21712 >> 16 & 0xFF) / 255.0f, (method21712 >> 8 & 0xFF) / 255.0f, (method21712 & 0xFF) / 255.0f, n, n2, class7099);
                    break;
                }
                case 2: {
