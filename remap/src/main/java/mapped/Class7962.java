...
public class Class7962 implements Class7954
{
    ...
    public Class9017 method25804(final Entity class399, final Random random) {
        ...
        method6916.method27665(new Class2259("filled_map." + this.field32719.toLowerCase(Locale.ROOT)));
        return new Class9017(new ItemStack(Items.field31514, this.field32718), new ItemStack(Items.field31375), method6916, this.field32721, this.field32722, 0.2f);
    }
}
