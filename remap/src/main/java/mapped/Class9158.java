...
public class Class9158
{
    ...
    private static int method33428(final Class7492 class7492, final Collection<Class513> collection, final Predicate<Class8321> predicate, final int n) throws CommandSyntaxException {
        int n2 = 0;
        ...
        if (n2 != 0) {
            if (n != 0) {
                if (collection.size() != 1) {
                    ...
                    class7492.method23257(new Class2259("commands.clear.success.single", new Object[] { n2, collection.iterator().next().method1871() }), true);
                }
            }
                ...
                class7492.method23257(new Class2259("commands.clear.test.single", new Object[] { n2, collection.iterator().next().method1871() }), true);
            }
            return n2;
        }
        if (collection.size() != 1) {
        ...
        throw Class9158.field38803.create((Object)collection.iterator().next().method1841().method8461());
    }
