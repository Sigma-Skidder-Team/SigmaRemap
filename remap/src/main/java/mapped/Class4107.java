...
public abstract class Class4107
{
    ...
    public <T> Dynamic<T> method12355(final DynamicOps<T> dynamicOps) {
        return (Dynamic<T>)new Dynamic((DynamicOps)dynamicOps, dynamicOps.mergeInto(this.method12352((com.mojang.datafixers.types.DynamicOps<Object>)dynamicOps).getValue(), dynamicOps.createString("processor_type"), dynamicOps.createString(Class90.field233.method503(this.method12351()).toString())));
    }
}
