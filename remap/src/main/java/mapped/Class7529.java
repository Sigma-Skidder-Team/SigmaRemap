...
public class Class7529
{
    ...
    private final Function<ResourceLocation, Class9317> field29898;
    private final Set<Class9317> field29899;
    private final Function<ResourceLocation, Class122> field29900;
    private final Set<Class122> field29901;
    private final Map<Class7915<?>, Object> field29902;
    private final Map<ResourceLocation, Class8798> field29903;
    
    private Class7529(final Random field29895, final float field29896, final Class1849 field29897, final Function<ResourceLocation, Class9317> field29898, final Function<ResourceLocation, Class122> field29899, final Map<Class7915<?>, Object> map, final Map<ResourceLocation, Class8798> map2) {
        ...
        this.field29903 = (Map<ResourceLocation, Class8798>)ImmutableMap.copyOf((Map)map2);
    }
    ...
    public void method23578(final ResourceLocation class1932, final Consumer<ItemStack> consumer) {
    ...
    public Class9317 method23584(final ResourceLocation class1932) {
        return this.field29898.apply(class1932);
    }
    
    public Class122 method23585(final ResourceLocation class1932) {
