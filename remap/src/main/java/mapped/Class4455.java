...
public class Class4455 implements Comparator<Class8131>
{
    ...
    public int compare(final Class8131 class8131, final Class8131 class8132) {
        ...
        final boolean method26800 = Client.getInstance().method35190().method29880(method26798);
        final boolean method26801 = Client.getInstance().method35190().method29880(method26799);
