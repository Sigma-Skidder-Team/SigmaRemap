...
public class Class4290 implements IPacket<IClientPlayNetHandler>
{
    ...
    private TextFormatting field19241;
    ...
    public Class4290() {
        this.field19235 = "";
        this.field19236 = new StringTextComponent("");
        this.field19237 = new StringTextComponent("");
        this.field19238 = new StringTextComponent("");
        this.field19239 = Class2097.field12147.field12152;
        this.field19240 = Class343.field2112.field2117;
        this.field19241 = TextFormatting.RESET;
    ...
    public Class4290(final Class6749 class6749, final int field19243) {
        ...
        if (field19243 == 0 || field19243 == 2) {
            ...
            this.field19241 = class6749.getColor();
    ...
    public TextFormatting method12885() {
