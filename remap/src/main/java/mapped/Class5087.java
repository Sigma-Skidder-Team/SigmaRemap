...
public class Class5087 extends RealmsScreen
{
    ...
    @Override
    public void init() {
        this.field21969 = this.width() / 2 - 150;
        this.field21970 = this.width() / 2 + 190;
        this.buttonsAdd(new Class5657(this, 0, this.field21970 - 80 + 8, Class7869.method25488(13) - 5, 70, 20, RealmsScreen.getLocalizedString("gui.back")));
    ...
    public void method15931() {
        for (final Map.Entry<K, Class7424> entry : this.field21965.field28683.entrySet()) {
            ...
            if ((int)entry.getKey() == this.field21965.field28688 && !this.field21965.field28687.equals(Class271.field1472)) {
                class7425 = new Class5660(this, Class5087.field21975.get((int)entry.getKey() - 1), this.method15932((int)entry.getKey()), RealmsScreen.getLocalizedString("mco.brokenworld.download"));
            }
            else {
                class7425 = new Class5625(this, Class5087.field21973.get((int)entry.getKey() - 1), this.method15932((int)entry.getKey()), RealmsScreen.getLocalizedString("mco.brokenworld.play"));
            }
            if (this.field21977.contains(entry.getKey())) {
                class7425.method16917(false);
                class7425.method16925(RealmsScreen.getLocalizedString("mco.brokenworld.downloaded"));
            }
            this.buttonsAdd(class7425);
            this.buttonsAdd(new Class5667(this, Class5087.field21974.get((int)entry.getKey() - 1), this.method15932((int)entry.getKey()), Class7869.method25488(10), 80, 20, RealmsScreen.getLocalizedString("mco.brokenworld.reset")));
        }
    }
    ...
    public void render(final int n, final int n2, final float n3) {
        ...
        this.drawCenteredString(this.field21967, this.width() / 2, 17, 16777215);
        final String[] split = this.field21968.split("\\\\n");
        for (int i = 0; i < split.length; ++i) {
            this.drawCenteredString(split[i], this.width() / 2, Class7869.method25488(-1) + 3 + i * 12, 10526880);
        }
        if (this.field21965 != null) {
            for (final Map.Entry<K, Class7424> entry : this.field21965.field28683.entrySet()) {
    ...
    private void method15933() {
        Realms.setScreen(this.field21963);
    }
    ...
    private void method15934(final long n) {
        new Thread(() -> {
            ...
            try {
                ...
                Realms.setScreen(new RealmsGenericErrorScreen(class9514.getMessage(), this.field21963));
            }
    ...
    private void method15935(final int i) {
        ...
        catch (final RealmsServiceException class5048) {
            Class5087.field21962.error("Couldn't download world data");
            Realms.setScreen(new RealmsGenericErrorScreen(class5048, this));
        }
    }
            ...
            if (s2 != null && l != -1L) {
                ...
                if (n5 != 2) {
                    if (n5 != 3) {
                        ...
                        RealmsScreen.method15419("textures/gui/title/background/panorama_3.png");
                    }
                }
                else {
                    RealmsScreen.method15419("textures/gui/title/background/panorama_2.png");
                }
            }
            else {
                RealmsScreen.method15419("textures/gui/title/background/panorama_0.png");
            }
        }
        else {
            RealmsScreen.method15419("realms:textures/gui/realms/empty_frame.png");
        }
        if (b) {
            if (b) {
