...
public class Class9338
{
    public static void method34607(final CommandDispatcher<Class7492> commandDispatcher) {
        commandDispatcher.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)Class7788.method25001("kill").requires(class7492 -> class7492.method23210(2))).executes(commandContext -> method34608((Class7492)commandContext.getSource(), (Collection<? extends Entity>)ImmutableList.of((Object)((Class7492)commandContext.getSource()).method23252())))).then(Class7788.method25002("targets", (com.mojang.brigadier.arguments.ArgumentType<Object>)Class6886.method21145()).executes(commandContext -> method34608((Class7492)commandContext.getSource(), Class6886.method21146((CommandContext<Class7492>)commandContext, "targets")))));
    }
    ...
    private static int method34608(final Class7492 class7492, final Collection<? extends Entity> collection) {
        ...
        while (iterator.hasNext()) {
            ((Entity)iterator.next()).method1648();
        }
