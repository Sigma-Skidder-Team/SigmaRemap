...
public class Class3276 extends Class3167
{
    ...
    public void method9879() {
        this.field15773 = new Vec3d(Class3276.field15514.player.posX, Class3276.field15514.player.posY, Class3276.field15514.player.posZ);
        this.field15774 = Class3276.field15514.player.rotationYaw;
        this.field15775 = Class3276.field15514.player.rotationPitch;
        Class3276.field15771 = new Class755(Class3276.field15514.world, Class3276.field15514.player.method2844());
        Class3276.field15771.field3006 = Class3276.field15514.player.field3006;
        Class3276.field15771.method1728(this.field15773.x, this.field15773.y, this.field15773.z, this.field15774, this.field15775);
        Class3276.field15771.field2953 = Class3276.field15514.player.field2953;
    ...
    private void method10323(final Class5721 class5721) {
        if (this.method9906()) {
            if (Class3276.field15514.player == null || !(class5721.method16990() instanceof Class4336)) {
