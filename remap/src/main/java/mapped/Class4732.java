...
public class Class4732 extends Class4712<Class800, Class5926<Class800>>
{
    ...
    public void method14050(final Class800 class800, final Class7351 class801, final float n, final float n2, final float n3) {
        ...
        if (method4620 > 0.0f) {
            ...
            final Iterator<Entity> iterator = (Iterator<Entity>)class800.field2391.method7128((Class<? extends Class512>)Class512.class, new AxisAlignedBB(new BlockPos(class800)).method18495(2.0, 2.0, 2.0)).iterator();
