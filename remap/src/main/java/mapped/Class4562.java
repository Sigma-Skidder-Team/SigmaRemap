...
public class Class4562 extends Class4535<Class5141>
{
    ...
    public boolean method13542(final Class1851 class1851, final Class6346<? extends Class7065> class1852, final Random random, BlockPos class1853, final Class5141 class1854) {
        ...
        if (class1851.method6966(class1855.field32290, class1855.field32291, ChunkStatus.field39979).method7047(Class4535.field19972.method13596()).isEmpty()) {
            ...
            for (int n11 = 0; n11 < 16; ++n11) {
                for (int n12 = 0; n12 < 16; ++n12) {
                    for (int n13 = 0; n13 < 8; ++n13) {
                        ...
                        if (b) {
                            final Material method21697 = class1851.getBlockState(class1853.add(n11, n13, n12)).getMaterial();
                            if (n13 >= 4 && method21697.method26438()) {
                                return false;
                            }
                            if (n13 < 4) {
                                if (!method21697.method26439()) {
                                    if (class1851.getBlockState(class1853.add(n11, n13, n12)) != class1854.field22127) {
                                        return false;
                                    }
                                }
                            }
                ...
                for (int n15 = 0; n15 < 16; ++n15) {
                    for (int n16 = 0; n16 < 8; ++n16) {
                        if (array[(n14 * 16 + n15) * 8 + n16]) {
                            class1851.setBlockState(class1853.add(n14, n16, n15), (n16 < 4) ? class1854.field22127 : Class4562.field20040, 2);
                        }
                    }
                }
            }
            ...
            if (class1854.field22127.getMaterial() == Material.LAVA) {
            ...
            if (class1854.field22127.getMaterial() == Material.WATER) {
