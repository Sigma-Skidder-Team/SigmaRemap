...
public class Class548 extends Screen
{
    ...
    private boolean method3214() {
        return this.minecraft.field4648.field23424 && this.field3309 != null;
    }
    ...
    public void init() {
        ...
        this.field3310 = this.font.method6617("Copyright Mojang AB. Do not distribute!");
        ...
        this.method3029(new Class679(this.width / 2 - 124, n + 72 + 12, 20, 20, 0, 106, 20, Class654.field3421, 256, 256, class654 -> this.minecraft.method5244(new Class704(this, this.minecraft.field4648, this.minecraft.method5295())), Class8822.method30773("narrator.button.language", new Object[0])));
        this.method3029(new Class654(this.width / 2 - 100, n + 72 + 12, 98, 20, Class8822.method30773("menu.options", new Object[0]), class654 -> this.minecraft.method5244(new Class550(this, this.minecraft.field4648))));
        this.method3029(new Class654(this.width / 2 + 2, n + 72 + 12, 98, 20, Class8822.method30773("menu.quit", new Object[0]), class654 -> this.minecraft.method5253()));
        this.method3029(new Class679(this.width / 2 + 104, n + 72 + 12, 20, 20, 0, 0, 20, Class548.field3302, 32, 64, class654 -> this.minecraft.method5244(new Class710(this, this.minecraft.field4648)), Class8822.method30773("narrator.button.accessibility", new Object[0])));
        this.minecraft.method5312(false);
        if (this.minecraft.field4648.field23424) {
            if (!this.field3308) {
    ...
    private void method3216(final int n, final int n2) {
        this.method3029(new Class654(this.width / 2 - 100, n, 200, 20, Class8822.method30773("menu.singleplayer", new Object[0]), class654 -> this.minecraft.method5244(new Class544(this))));
        this.method3029(new Class654(this.width / 2 - 100, n + n2 * 1, 200, 20, Class8822.method30773("menu.multiplayer", new Object[0]), class654 -> {
            if (!this.minecraft.field4648.field23434) {
                this.minecraft.method5244(new Class530(this));
            }
            else {
                this.minecraft.method5244(new Class720(this));
            }
        }));
        this.method3029(new Class654(this.width / 2 - 100, n + n2 * 2, 200, 20, Class8822.method30773("menu.online", new Object[0]), class654 -> this.method3218()));
        if (Class9570.field41399.method22619()) {
            if (this.buttons.size() > 0) {
                final Class573 class573 = this.buttons.get(this.buttons.size() - 1);
    ...
    private void method3217(final int n, final int n2) {
        this.method3029(new Class654(this.width / 2 - 100, n, 200, 20, Class8822.method30773("menu.playdemo", new Object[0]), class654 -> this.minecraft.method5262("Demo_World", "Demo_World", MinecraftServer.field2295)));
        this.field3305 = this.method3029(new Class654(this.width / 2 - 100, n + n2 * 1, 200, 20, Class8822.method30773("menu.resetdemo", new Object[0]), class654 -> {
            final WorldInfo method25791 = this.minecraft.method5243().method25791("Demo_World");
            if (method25791 != null) {
                this.minecraft.method5244(new Class546(this::method3219, new Class2259("selectWorld.deleteQuestion", new Object[0]), new Class2259("selectWorld.deleteWarning", new Object[] { method25791.method29549() }), Class8822.method30773("selectWorld.deleteButton", new Object[0]), Class8822.method30773("gui.cancel", new Object[0])));
            }
        }));
    ...
    public void method2975(final int n, final int n2, final float n3) {
        ...
        Class565.method3293(0, 0, this.width, this.height, -1);
        ...
        Class565.method3300(0, 0, this.width, this.height, 0.0f, 0.0f, 16, 128, 16, 128);
        ...
        if ((n7 & 0xFC000000) != 0x0) {
            ...
            if (this.field3304 != null) {
                ...
                Class8726.method30065((float)(this.width / 2 + 90), 70.0f, 0.0f);
                Class8726.method30062(-20.0f, 0.0f, 0.0f, 1.0f);
                final float n8 = (1.8f - MathHelper.method35647(MathHelper.sin(Util.method27837() % 1000L / 1000.0f * 6.2831855f) * 0.1f)) * 100.0f / (this.font.method6617(this.field3304) + 32);
                Class8726.method30063(n8, n8, n8);
                this.method3295(this.font, this.field3304, 0, -8, 0xFFFF00 | n7);
            ...
            if (!Class9570.field41179.method22623()) {
                this.method3297(this.font, str, 2, this.height - 10, 0xFFFFFF | n7);
            }
            else {
                if (Class9570.field41181.method22605()) {
                    Class9570.method35818(Class9570.field41181, true, true, (n10, s) -> this.method3297(this.font, s, 2, this.height - (10 + n10 * 10), 0xFFFFFF | n9));
                }
                if (Class9570.field41182.method22605()) {
                    Class9570.method35818(Class9570.field41182, (n12, s2) -> this.method3297(this.font, s2, this.width - this.font.method6617(s2), this.height - (10 + (n12 + 1) * 10), 0xFFFFFF | n11));
                }
            }
            this.method3297(this.font, "Copyright Mojang AB. Do not distribute!", this.field3311, this.height - 10, 0xFFFFFF | n7);
            if (n > this.field3311) {
                if (n < this.field3311 + this.field3310) {
                    if (n2 > this.height - 10) {
                        if (n2 < this.height) {
                            Class565.method3293(this.field3311, this.height - 1, this.field3311 + this.field3310, this.height, 0xFFFFFF | n7);
                        }
                    }
                }
            }
    ...
    public boolean mouseClicked(final double n, final double n2, final int n3) {
        ...
        if (n > this.field3311) {
            if (n < this.field3311 + this.field3310) {
                if (n2 > this.height - 10) {
                    if (n2 < this.height) {
                        this.minecraft.method5244(new Class697(false, Runnables.doNothing()));
                    }
                }
            }
        }
