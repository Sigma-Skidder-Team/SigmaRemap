...
public class Class5814 implements Class5813
{
    ...
    public void method17460() {
        this.method17461();
        this.field23857.prevPosX = this.field23857.getPosX();
        this.field23857.prevPosY = this.field23857.getPosY();
        this.field23857.prevPosZ = this.field23857.getPosZ();
        this.field23857.method2920();
        this.field23857.method1728(this.field23865, this.field23866, this.field23867, this.field23857.rotationYaw, this.field23857.rotationPitch);
        ++this.field23858;
    ...
    public void method17433(final Class4254 class4254) {
        Class8663.method29631((IPacket<Class5814>)class4254, this, this.field23857.method2940());
    ...
    public void method17442(final Class4251 class4251) {
        Class8663.method29631((IPacket<Class5814>)class4251, this, this.field23857.method2940());
    ...
    public void method17443(final Class4348 class4348) {
        Class8663.method29631((IPacket<Class5814>)class4348, this, this.field23857.method2940());
        if (class4348.method13058() == this.field23879) {
            this.field23857.method1728(this.field23878.x, this.field23878.y, this.field23878.z, this.field23857.rotationYaw, this.field23857.rotationPitch);
    ...
    public void method17444(final Class4397 class4397) {
        Class8663.method29631((IPacket<Class5814>)class4397, this, this.field23857.method2940());
    ...
    public void method17445(final Class4334 class4334) {
        Class8663.method29631((IPacket<Class5814>)class4334, this, this.field23857.method2940());
    ...
    public void method17446(final Class4265 class4265) {
        Class8663.method29631((IPacket<Class5814>)class4265, this, this.field23857.method2940());
    ...
    public void method17447(final Class4266 class4266) {
        ...
        if (!this.field23856.method1531()) {
            ...
            if (method2539 != null) {
                ...
                this.field23857.world.method6729(method2540, method2541);
    ...
    public void method17448(final Class4401 class4401) {
        Class8663.method29631((IPacket<Class5814>)class4401, this, this.field23857.method2940());
        if (this.field23856.method1531()) {
            if (this.field23857.method2908()) {
                final Class865 method13244 = class4401.method13244(this.field23857.world);
                if (method13244 != null) {
    ...
    public void method17450(final Class4362 class4362) {
        Class8663.method29631((IPacket<Class5814>)class4362, this, this.field23857.method2940());
    ...
    public void method17451(final Class4368 class4368) {
        Class8663.method29631((IPacket<Class5814>)class4368, this, this.field23857.method2940());
    ...
    public void method17452(final Class4360 class4360) {
        ...
        if (this.field23857.method2908()) {
            ...
            if (method13103 instanceof Class501) {
                ...
                this.field23857.world.method6693(method13101, method13102, method13102, 3);
            }
        }
    }
    ...
    public void method17457(final Class4270 class4270) {
        ...
        if (this.field23857.method2908()) {
            ...
            if (method12815 instanceof Class498) {
                ...
                this.field23857.world.method6693(method12813, method12814, method12814, 3);
            }
        }
    }
    ...
    public void method17453(final Class4324 class4324) {
        Class8663.method29631((IPacket<Class5814>)class4324, this, this.field23857.method2940());
    ...
    public void method17454(final Class4314 class4314) {
        Class8663.method29631((IPacket<Class5814>)class4314, this, this.field23857.method2940());
        final ItemStack method12967 = class4314.method12967();
    ...
    public void method17455(final Class4261 class4261) {
        Class8663.method29631((IPacket<Class5814>)class4261, this, this.field23857.method2940());
    ...
    public void method17429(final Class4353 class4353) {
        Class8663.method29631((IPacket<Class5814>)class4353, this, this.field23857.method2940());
        if (!method17464(class4353)) {
            ...
            if (!this.field23857.field3071) {
                ...
                if (this.field23878 == null) {
                    ...
                    if (!this.field23857.isPassenger()) {
                        ...
                        final float method1489 = class4353.method13081(this.field23857.rotationYaw);
                        final float method1490 = class4353.method13082(this.field23857.rotationPitch);
                        ...
                        final double method1491 = this.field23857.getMotion().lengthSquared();
                        ...
                        if (!this.field23857.method2783()) {
                            ...
                            if (n3 > 0.0) {
                                this.field23857.fallDistance = 0.0f;
                            }
                            if (this.field23857.onGround) {
                            ...
                            this.field23857.onGround = class4353.method13083();
                            ...
                            this.method17467(this.field23857.getPosX(), this.field23857.getPosY(), this.field23857.getPosZ(), class4353.method13081(this.field23857.rotationYaw), class4353.method13082(this.field23857.rotationPitch));
                        }
                    }
                    else {
                        this.field23857.method1728(this.field23857.getPosX(), this.field23857.getPosY(), this.field23857.getPosZ(), class4353.method13081(this.field23857.rotationYaw), class4353.method13082(this.field23857.rotationPitch));
                        this.field23857.method2940().method6904().method7443(this.field23857);
                    }
                }
                else if (this.field23858 - this.field23880 > 20) {
                    this.field23880 = this.field23858;
                    this.method17467(this.field23878.x, this.field23878.y, this.field23878.z, this.field23857.rotationYaw, this.field23857.rotationPitch);
                }
            }
        }
        else {
    ...
    public void method17468(final double n, final double n2, final double n3, final float n4, final float n5, final Set<Class2143> set) {
        ...
        final float n9 = set.contains(Class2143.field12620) ? this.field23857.rotationYaw : 0.0f;
        final float n10 = set.contains(Class2143.field12621) ? this.field23857.rotationPitch : 0.0f;
    ...
    public void method17431(final Class4399 class4399) {
        Class8663.method29631((IPacket<Class5814>)class4399, this, this.field23857.method2940());
        ...
        switch (Class8365.field34306[method13238.ordinal()]) {
            case 1: {
                if (!this.field23857.isSpectator()) {
                    final ItemStack method13239 = this.field23857.method2715(Class316.field1878);
    ...
    public void method17437(final Class4329 class4329) {
        Class8663.method29631((IPacket<Class5814>)class4329, this, this.field23857.method2940());
        final Class1849 method1481 = this.field23856.method1481(this.field23857.dimension);
    ...
    public void method17438(final Class4307 class4307) {
        Class8663.method29631((IPacket<Class5814>)class4307, this, this.field23857.method2940());
        final Class1849 method1481 = this.field23856.method1481(this.field23857.dimension);
    ...
    public void method17439(final Class4294 class4294) {
        Class8663.method29631((IPacket<Class5814>)class4294, this, this.field23857.method2940());
        if (this.field23857.isSpectator()) {
            for (final Class1849 class4295 : this.field23856.method1482()) {
                ...
                this.field23857.method2958(class4295, method12899.getPosX(), method12899.getPosY(), method12899.getPosZ(), method12899.rotationYaw, method12899.rotationPitch);
            }
        }
    }
    ...
    public void method17441(final Class4302 class4302) {
        Class8663.method29631((IPacket<Class5814>)class4302, this, this.field23857.method2940());
    ...
    public void method17469(final IPacket<?> class4252) {
        this.method17470(class4252, null);
    }
    
    public void method17470(final IPacket<?> class4252, final GenericFutureListener<? extends Future<? super Void>> genericFutureListener) {
    ...
    public void method17418(final Class4317 class4317) {
        Class8663.method29631((IPacket<Class5814>)class4317, this, this.field23857.method2940());
    ...
    public void method17417(final Class4380 class4380) {
        Class8663.method29631((IPacket<Class5814>)class4380, this, this.field23857.method2940());
        this.field23857.method2946();
    ...
    public void method17432(final Class4336 class4336) {
        Class8663.method29631((IPacket<Class5814>)class4336, this, this.field23857.method2940());
        this.field23857.method2946();
    ...
    public void method17427(final Class4381 class4381) {
        Class8663.method29631((IPacket<Class5814>)class4381, this, this.field23857.method2940());
        final Entity method13170 = class4381.method13170(this.field23856.method1481(this.field23857.dimension));
        this.field23857.method2946();
        if (method13170 != null) {
    ...
    public void method17419(final Class4323 class4323) {
        Class8663.method29631((IPacket<Class5814>)class4323, this, this.field23857.method2940());
        this.field23857.method2946();
        switch (Class8365.field34308[class4323.method12987().ordinal()]) {
            case 1: {
                if (this.field23857.field3071) {
                    this.field23857.field3071 = false;
                    this.field23857 = this.field23856.method1537().method20583(this.field23857, DimensionType.field2223, true);
                    Class7770.field31796.method13796(this.field23857, DimensionType.field2225, DimensionType.field2223);
                    break;
                }
                if (this.field23857.method2664() > 0.0f) {
                    return;
                }
                this.field23857 = this.field23856.method1537().method20583(this.field23857, DimensionType.field2223, false);
    ...
    public void method17425(final Class4389 class4389) {
        Class8663.method29631((IPacket<Class5814>)class4389, this, this.field23857.method2940());
        this.field23857.method2933();
    }
    
    @Override
    public void method17423(final Class4256 class4256) {
        Class8663.method29631((IPacket<Class5814>)class4256, this, this.field23857.method2940());
        this.field23857.method2946();
        if (this.field23857.field3009.field16154 == class4256.method12773()) {
            if (this.field23857.field3009.method10886(this.field23857)) {
                if (!this.field23857.isSpectator()) {
                    if (!ItemStack.method27643(class4256.method12777(), this.field23857.field3009.method10879(class4256.method12774(), class4256.method12775(), class4256.method12778(), this.field23857))) {
    ...
    public void method17424(final Class4387 class4387) {
        Class8663.method29631((IPacket<Class5814>)class4387, this, this.field23857.method2940());
        this.field23857.method2946();
        if (!this.field23857.isSpectator()) {
    ...
    public void method17422(final Class4366 class4366) {
        Class8663.method29631((IPacket<Class5814>)class4366, this, this.field23857.method2940());
        this.field23857.method2946();
    ...
    public void method17435(final Class4287 class4287) {
        Class8663.method29631((IPacket<Class5814>)class4287, this, this.field23857.method2940());
        if (this.field23857.field3041.method26484()) {
    ...
    public void method17421(final Class4255 class4255) {
        Class8663.method29631((IPacket<Class5814>)class4255, this, this.field23857.method2940());
    ...
    public void method17436(final Class4344 class4344) {
        Class8663.method29631((IPacket<Class5814>)class4344, this, this.field23857.method2940());
        this.field23857.method2946();
        final Class1849 method1481 = this.field23856.method1481(this.field23857.dimension);
        ...
        if (method1481.method6971(method1482)) {
            ...
            if (!class4345.method2523() || class4345.method2526() != this.field23857) {
                this.field23856.method1480("Player " + this.field23857.getName().getString() + " just tried to change non-editable sign");
                return;
            }
            final String[] method1485 = class4344.method13047();
            for (int i = 0; i < method1485.length; ++i) {
                class4345.method2521(i, new StringTextComponent(TextFormatting.getTextWithoutFormattingCodes(method1485[i])));
            }
    ...
    public void method17430(final Class4358 class4358) {
        Class8663.method29631((IPacket<Class5814>)class4358, this, this.field23857.method2940());
    ...
    public void method17420(final Class4386 class4386) {
        Class8663.method29631((IPacket<Class5814>)class4386, this, this.field23857.method2940());
    ...
    public void method17458(final Class4338 class4338) {
        Class8663.method29631((IPacket<Class5814>)class4338, this, this.field23857.method2940());
    ...
    public void method17459(final Class4291 class4291) {
        Class8663.method29631((IPacket<Class5814>)class4291, this, this.field23857.method2940());
        if (this.field23857.method1926(2) || this.method17462()) {
