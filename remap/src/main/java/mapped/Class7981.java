...
public class Class7981
{
    ...
    private static int method26021(final Class7492 class7492, final Collection<? extends Class399> collection, final Class5328 class7493, final Integer n, final int n2, final boolean b) throws CommandSyntaxException {
        ...
        if (n3 != 0) {
            if (collection.size() != 1) {
                ...
                class7492.method23257(new Class2259("commands.effect.give.success.single", new Object[] { class7493.method16456(), ((Class399)collection.iterator().next()).method1871(), intValue / 20 }), true);
            }
            return n3;
        }
    ...
    private static int method26022(final Class7492 class7492, final Collection<? extends Class399> collection) throws CommandSyntaxException {
        int n = 0;
        for (final Class399 class7493 : collection) {
        ...
        if (n != 0) {
            if (collection.size() != 1) {
                ...
                class7492.method23257(new Class2259("commands.effect.clear.everything.success.single", new Object[] { ((Class399)collection.iterator().next()).method1871() }), true);
            }
            return n;
        }
    ...
    private static int method26023(final Class7492 class7492, final Collection<? extends Class399> collection, final Class5328 class7493) throws CommandSyntaxException {
        int n = 0;
        for (final Class399 class7494 : collection) {
            if (!(class7494 instanceof Class511)) {
                continue;
        ...
        if (n != 0) {
            if (collection.size() != 1) {
                ...
                class7492.method23257(new Class2259("commands.effect.clear.specific.success.single", new Object[] { class7493.method16456(), ((Class399)collection.iterator().next()).method1871() }), true);
            }
            return n;
        }
