...
public class Class7305 extends Class7304<Class5117>
{
    ...
    private void method22412(final Class1860 class1860, final Function<BlockPos, Class3090> function, final long seed, final int n, final int n2, final int n3, double n4, double n5, double n6, final float n7, float n8, float n9, final int n10, final int n11, final double n12, final BitSet set) {
        ...
        for (int j = n10; j < n11; ++j) {
            final double n16 = 1.5 + MathHelper.sin(j * 3.1415927f / n11) * n7;
            ...
            final float method35640 = MathHelper.sin(n9);
