...
public class Class9463
{
    ...
    public static Class9463 method35173() {
        return (Class9463.field40682 != null) ? Class9463.field40682 : (Class9463.field40682 = new Class9463());
    }
    ...
    public void method35175() {
        ...
        GLFW.glfwSetWindowTitle(Class9463.field40683.field4632.method7690(), (CharSequence)"Sigma 5.0");
        System.currentTimeMillis();
        this.method35177();
    ...
    public void method35182(final Class7776 e) {
        Class9463.field40710.add(e);
    }
    
    public void method35183() {
        if (!Class9463.field40710.isEmpty()) {
            final Iterator<Class7776> iterator = Class9463.field40710.iterator();
            while (iterator.hasNext()) {
                iterator.next().method24923();
            }
            Class9463.field40710.clear();
        }
    ...
    public void method35210(final Class2209 \u7d3f\uc854\uc3f2\u6f94\ub5d91) {
        ...
        if (\u7d3f\uc854\uc3f2\u6f94\ub5d91 != Class2209.field13465) {
            if (\u7d3f\uc854\uc3f2\u6f94\ub5d91 == Class2209.field13464) {
                this.method35176();
                GLFW.glfwSetWindowTitle(Class9463.field40683.field4632.method7690(), (CharSequence)"Classic Sigma 5.0");
            }
        }
        else {
            Class9493.method35323();
            method35173().method35193().method32126();
            GLFW.glfwSetWindowTitle(Class9463.field40683.field4632.method7690(), (CharSequence)"Jello for Sigma 5.0");
        }
        if (this.field40690 == null) {
