...
public class WorldDownload extends ValueObject
{
    ...
    public static WorldDownload method22864(final String s) {
        final JsonObject asJsonObject = new JsonParser().parse(s).getAsJsonObject();
        final WorldDownload class7431 = new WorldDownload();
        try {
            ...
            WorldDownload.field28658.error("Could not parse WorldDownload: " + ex.getMessage());
        }
        return class7431;
    }
