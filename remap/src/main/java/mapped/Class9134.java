...
public class Class9134
{
    ...
    public static double[] method33308(final LivingEntity class511) {
        if (class511 != null) {
            return new double[] { class511.posX + (class511.posX - class511.lastTickPosX) * AllUtils.method19135() / 50.0, class511.posY + 0.0 * AllUtils.method19135() / 50.0, class511.posZ + (class511.posZ - class511.lastTickPosZ) * AllUtils.method19135() / 50.0 };
        }
        return new double[] { 0.0, 0.0, 0.0 };
    }
    
    static {
        field38711 = Minecraft.getInstance();
    }
}
