...
public class Class5893<T extends Entity> extends Class5846<T>
{
    ...
    public Iterable<Class6300> method17570() {
        return (Iterable<Class6300>)ImmutableList.of(this.field24196, this.field24197, this.field24198, this.field24201, this.field24199, (Object)this.field24200);
    }
    
    @Override
    public void method17557(final T t, final float n, final float n2, final float n3, final float n4, final float n5) {
        this.field24199.field25185 = -0.2f + 0.4f * MathHelper.sin(n3 * 0.2f);
        this.field24200.field25185 = 0.2f - 0.4f * MathHelper.sin(n3 * 0.2f);
    }
}
