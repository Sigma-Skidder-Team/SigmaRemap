...
public class Class9184
{
    ...
    public static <T> Class8810<T> method33564(final Class<? extends Class399> obj, final Class4410<T> class4410) {
        if (Class9184.field38914.isDebugEnabled()) {
            try {
                ...
                if (!forName.equals(obj)) {
                    Class9184.field38914.debug("defineId called for: {} from {}", (Object)obj, (Object)forName, (Object)new RuntimeException());
                }
            }
            catch (final ClassNotFoundException ex) {}
        }
        int n;
        if (Class9184.field38915.containsKey(obj)) {
            n = Class9184.field38915.get(obj) + 1;
        }
        else {
            int n2 = 0;
        ...
        Class9184.field38915.put(obj, n);
        return class4410.method13348(n);
    }
    
    public <T> void method33565(final Class8810<T> class8810, final T t) {
        ...
        if (Class7709.method24608(class8810.method30738()) >= 0) {
            this.method33566((Class8810<Object>)class8810, t);
            return;
        }
        throw new IllegalArgumentException("Unregistered serializer " + class8810.method30738() + " for " + method30737 + "!");
    }
    
    private <T> void method33566(final Class8810<T> class8810, final T t) {
    ...
    private <T> Class9369<T> method33567(final Class8810<T> class8810) {
    ...
    public <T> T method33568(final Class8810<T> class8810) {
        return this.method33567(class8810).method34768();
    }
    
    public <T> void method33569(final Class8810<T> class8810, final T t) {
    ...
    public static void method33571(final List<Class9369<?>> list, final Class8654 class8654) throws IOException {
        if (list != null) {
    ...
    private static <T> void method33574(final Class8654 class8654, final Class9369<T> class8655) throws IOException {
        final Class8810<T> method34766 = class8655.method34766();
        final int method34767 = Class7709.method24608(method34766.method30738());
        if (method34767 >= 0) {
            class8654.writeByte(method34766.method30737());
            class8654.method29505(method34767);
    ...
    @Nullable
    public static List<Class9369<?>> method33575(final Class8654 class8654) throws IOException {
        List arrayList = null;
        short unsignedByte;
    ...
    private static <T> Class9369<T> method33576(final Class8654 class8654, final int n, final Class4410<T> class8655) {
