...
public class NetworkPlayerInfo
{
    ...
    public NetworkPlayerInfo(final Class4646 class4646) {
    ...
    public Class6749 method32729() {
        return Minecraft.getInstance().world.method6782().method19651(this.method32719().getName());
    }
    ...
    public void method32730() {
        synchronized (this) {
            if (!this.field38441) {
                ...
                Minecraft.getInstance().method5302().method24294(this.field38437, (minecraftProfileTexture$Type, class1932, minecraftProfileTexture) -> {
