...
public class Class4867 extends Panel
{
    ...
    public void draw(final float partialTicks) {
        RenderUtil.method26925((float)this.x, (float)this.y, (float)this.field20480, (float)this.field20481, 10.0f, AllUtils.applyAlpha(-4144960, (this.method14309() ? 0.6f : 0.43f) * this.field20844.calcPercent() * partialTicks));
        final float n2 = (1.0f - this.field20844.calcPercent()) * partialTicks;
        RenderUtil.method26925((float)this.x, (float)this.y, (float)this.field20480, (float)this.field20481, 10.0f, AllUtils.applyAlpha(AllUtils.method19120(-14047489, ClientColors.DEEP_TEAL.color, this.method14309() ? 0.9f : 1.0f), n2));
        GL11.glPushMatrix();
        ...
        GL11.glTranslatef((float)(-this.method14272() - this.method14276() / 2), (float)(-this.method14274() - this.method14278() / 2), 0.0f);
        RenderUtil.drawImage((float)this.x, (float)this.y, (float)this.field20480, (float)this.field20481, ClientAssets.check, AllUtils.applyAlpha(ClientColors.LIGHT_GREYISH_BLUE.color, n2));
        GL11.glPopMatrix();
