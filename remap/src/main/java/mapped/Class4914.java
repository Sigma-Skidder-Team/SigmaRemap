...
public class Class4914 extends Class4825
{
    ...
    public void draw(final float partialTicks) {
        RenderUtil.drawImage((float)this.x, (float)this.y, (float)this.field20480, (float)this.field20481, this.field21020, AllUtils.method19120(ClientColors.DEEP_TEAL.color, ClientColors.LIGHT_GREYISH_BLUE.color, this.method14308() ? (this.method14309() ? 0.3f : 0.15f) : 0.0f));
