...
public class Class3913 extends Block implements Class3872
{
    ...
    public Class3913(final Properties class9288) {
        super(class9288);
        this.method11877(((StateHolder<O, BlockState>) ((StateHolder<O, BlockState>)this.field17406.method32903()).with((IProperty<Comparable>)Class3913.field17723, 0).with(Class3913.field17724, Class184.field574)).with((IProperty<Comparable>)Class3913.field17725, 0));
    }
    ...
    public BlockState method11846(final Class7074 class7074) {
        ...
        return (BlockState)((StateHolder<Object, Object>)this.getDefaultState()).with((IProperty<Comparable>)Class3913.field17723, (method6701.get(Class3913.field17723) > 0) ? 1 : 0);
    }
    ...
    public void method11822(final BlockState class7096, final Class1849 class7097, final BlockPos class7098, final Random random) {
        if (class7096.method21752(class7097, class7098)) {
            if (class7096.get(Class3913.field17725) == 0) {
    ...
    public BlockState method11789(final BlockState class7096, final Direction class7097, final BlockState class7098, final Class1851 class7099, final BlockPos class7100, final BlockPos class7101) {
        ...
        if (class7097 == Direction.UP) {
            if (class7098.getBlock() == Blocks.BAMBOO) {
                if (class7098.get(Class3913.field17723) > class7096.get(Class3913.field17723)) {
                    class7099.setBlockState(class7100, class7096.method21768((IProperty<Comparable>)Class3913.field17723), 2);
                }
            }
        }
    ...
    public boolean method11945(final IBlockReader class1855, final BlockPos class1856, final BlockState class1857, final boolean b) {
        ...
        return method12018 + this.method12019(class1855, class1856) + 1 < 16 && class1855.getBlockState(class1856.method1138(method12018)).get(Class3913.field17725) != 1;
    }
    ...
    public void method11947(final Class1849 class1849, final Random random, final BlockPos class1850, final BlockState class1851) {
        ...
        while (i < n2) {
            ...
            if (n < 16) {
                if (method12020.get(Class3913.field17725) != 1) {
    ...
    public void method12017(final BlockState class7096, final World class7097, final BlockPos class7098, final Random random, final int n) {
        ...
        if (n >= 1) {
            if (method6701.getBlock() == Blocks.BAMBOO && method6701.get(Class3913.field17724) != Class184.field574) {
                if (method6701.getBlock() == Blocks.BAMBOO) {
                    if (method6701.get(Class3913.field17724) != Class184.field574) {
                        class7099 = Class184.field576;
                        if (method6703.getBlock() == Blocks.BAMBOO) {
                            class7097.setBlockState(class7098.method1139(), method6701.with(Class3913.field17724, Class184.field575), 3);
                            class7097.setBlockState(method6702, method6703.with(Class3913.field17724, Class184.field574), 3);
                        }
                    }
                }
            }
        ...
        final int i = (class7096.get(Class3913.field17723) == 1 || method6703.getBlock() == Blocks.BAMBOO) ? 1 : 0;
        int j = 0;
        Label_0257: {
        ...
        class7097.setBlockState(class7098.method1137(), (BlockState)((StateHolder<Object, Object>) ((StateHolder<O, BlockState>)this.getDefaultState()).with((IProperty<Comparable>)Class3913.field17723, i).with(Class3913.field17724, class7099)).with((IProperty<Comparable>)Class3913.field17725, j), 3);
    }
