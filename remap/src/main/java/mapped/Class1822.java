...
public class Class1822<T extends LivingEntity, M extends Class5860<T>> extends Class1820<T, M>
{
    ...
    public void method6586(final MatrixStack class7351, final IRenderTypeBuffer class7352, final int n, final Entity class7353, final float n2, final float n3, final float n4, final float n5) {
        ...
        for (int i = 0; i < 4; ++i) {
            ...
            final Class8996 method35642 = class7351.getLast();
            final Matrix4f method35643 = method35642.getMatrix();
    ...
    private static void method6587(final Class4150 class4150, final Matrix4f class4151, final Matrix3f class4152, final float n, final int n2, final float n3, final float n4, final int n5) {
        class4150.pos(class4151, n, (float)n2, 0.0f).method12399(255, 255, 255, 255).tex(n3, n4).method12441(Class1904.field10335).method12440(n5).method12445(class4152, 0.0f, 1.0f, 0.0f).endVertex();
    }
