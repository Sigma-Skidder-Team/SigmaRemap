...
public class Class8595
{
    ...
    public static void method29101(final CommandDispatcher<Class7492> commandDispatcher) {
        commandDispatcher.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)Class7788.method25001("setblock").requires(class7492 -> class7492.method23210(2))).then(Class7788.method25002("pos", (com.mojang.brigadier.arguments.ArgumentType<Object>)Class8330.method27767()).then(((RequiredArgumentBuilder)Class7788.method25002("block", (com.mojang.brigadier.arguments.ArgumentType<Object>)Class8450.method28195()).executes(commandContext -> method29102(commandContext.getSource(), Class8330.method27768(commandContext, "pos"), Class8450.method28196(commandContext, "block"), Class2193.field13351, null))).then(Class7788.method25001("destroy").executes(commandContext -> method29102(commandContext.getSource(), Class8330.method27768(commandContext, "pos"), Class8450.method28196(commandContext, "block"), Class2193.field13352, null))).then(Class7788.method25001("keep").executes(commandContext -> method29102(commandContext.getSource(), Class8330.method27768(commandContext, "pos"), Class8450.method28196(commandContext, "block"), Class2193.field13351, class7990 -> class7990.method26067().method6961(class7990.method26068())))).then(Class7788.method25001("replace").executes(commandContext -> method29102(commandContext.getSource(), Class8330.method27768(commandContext, "pos"), Class8450.method28196(commandContext, "block"), Class2193.field13351, null))))));
    }
    ...
    private static int method29102(final Class7492 class7492, final BlockPos class7493, final Class118 class7494, final Class2193 class7495, final Predicate<Class7990> predicate) throws CommandSyntaxException {
        ...
        class7492.method23257(new Class2259("commands.setblock.success", class7493.getX(), class7493.getY(), class7493.getZ()), true);
        return 1;
    }
    
    static {
        field36098 = new SimpleCommandExceptionType(new Class2259("commands.setblock.failed", new Object[0]));
    }
}
