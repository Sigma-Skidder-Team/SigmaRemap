...
public class Class3480 extends Class3479
{
            ...
            if (this.method11048()) {
                if (Class793.method4469(this.field16401) >= 1) {
                    if (Class793.method4469(this.field16401) > 200) {
                        ...
                        field2391.setBlockState(this.field16395.method1137(), ((StateHolder<O, BlockState>)Class7521.field29716.getDefaultState()).with((IProperty<Comparable>)Class4005.field18053, Class793.method4471(this.field16401).nextInt(4) + 1), 3);
    ...
    public boolean method11050(final Class1852 class1852, final BlockPos class1853) {
        return class1852.method6961(class1853.method1137()) && class1852.getBlockState(class1853).getBlock() == Class7521.field29175;
    }
}
