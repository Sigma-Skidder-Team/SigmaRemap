...
public class Class3850 extends Class3849
{
    ...
    public Class3850(final Properties class9288) {
        super(class9288);
        this.method11877(((StateHolder<O, Class7096>)this.field17406.method32903()).with((IProperty<Comparable>)Class3850.field17459, 0));
    }
    
    @Override
    public void method11822(final Class7096 class7096, final Class1849 class7097, final BlockPos class7098, final Random random) {
        if ((random.nextInt(3) == 0 || this.method11912(class7097, class7098, 4)) && class7097.method6969(class7098) > 11 - class7096.method21772((IProperty<Integer>)Class3850.field17459) - class7096.method21700(class7097, class7098) && this.method11911(class7096, class7097, class7098)) {
            try (final Class386 method1296 = Class386.method1296()) {
                final Direction[] values = Direction.values();
                for (int length = values.length, i = 0; i < length; ++i) {
                    method1296.method1303(class7098).method1304(values[i]);
                    final Class7096 method1297 = class7097.getBlockState(method1296);
    ...
    private boolean method11911(final Class7096 class7096, final World class7097, final BlockPos class7098) {
        final int intValue = class7096.method21772((IProperty<Integer>)Class3850.field17459);
        if (intValue >= 3) {
            this.method11910(class7096, class7097, class7098);
            return true;
        }
        class7097.setBlockState(class7098, (Class7096)((StateHolder<Object, Object>)class7096).with((IProperty<Comparable>)Class3850.field17459, intValue + 1), 2);
        return false;
    }
    ...
    private boolean method11912(final IBlockReader class1855, final BlockPos class1856, final int n) {
        ...
        try (final Class386 method1296 = Class386.method1296()) {
            ...
            for (int length = values.length, i = 0; i < length; ++i) {
                ...
                if (class1855.getBlockState(method1296).getBlock() == this && ++n2 >= n) {
                    return false;
                }
            }
            return true;
