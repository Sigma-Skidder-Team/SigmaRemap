...
public class Class6376 extends Class6367
{
    ...
    private final Class7909<Item> field25485;
    private final boolean field25486;
    
    private Class6376(final Class7909<Item> field25485, final boolean field25486, final int n, final int n2, final Class122[] array, final Class125[] array2) {
    ...
    private boolean method19039(final Class7529 class7529, final Consumer<Class7182> consumer) {
        if (this.method19019(class7529)) {
            final Iterator<Item> iterator = this.field25485.method25616().iterator();
    ...
    public static Class4948<?> method19040(final Class7909<Item> class7909) {
