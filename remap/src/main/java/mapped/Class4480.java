...
public class Class4480 extends Class4479
{
    ...
    public Class4480(final int n, final MutableBoundingBox field19849, final Direction class179, final Class1964 class180) {
        super(Class9520.field40946, n, class180);
        this.method13456(class179);
        this.field19849 = field19849;
    }
    
    public Class4480(final Class1795 class1795, final CompoundNBT class1796) {
        super(Class9520.field40946, class1796);
    }
    
    public static MutableBoundingBox method13465(final List<Class4473> list, final Random random, final int n, final int n2, final int n3, final Direction class179) {
        final MutableBoundingBox class180 = new MutableBoundingBox(n, n2 - 5, n3, n, n2 + 3 - 1, n3);
    ...
    public void method13431(final Class4473 class4473, final List<Class4473> list, final Random random) {
        ...
        if (method13434 != null) {
            switch (Class8427.field34587[method13434.ordinal()]) {
                default: {
                    Class9191.method33629(class4473, list, random, this.field19849.minX, this.field19849.minY, this.field19849.minZ - 1, Direction.NORTH, method13433);
                    break;
                }
                case 2: {
                    Class9191.method33629(class4473, list, random, this.field19849.minX, this.field19849.minY, this.field19849.maxZ + 1, Direction.SOUTH, method13433);
                    break;
                }
                case 3: {
                    Class9191.method33629(class4473, list, random, this.field19849.minX - 1, this.field19849.minY, this.field19849.minZ, Direction.WEST, method13433);
                    break;
                }
                case 4: {
                    Class9191.method33629(class4473, list, random, this.field19849.maxX + 1, this.field19849.minY, this.field19849.minZ, Direction.EAST, method13433);
                    break;
                }
            }
        }
