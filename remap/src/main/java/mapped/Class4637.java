...
{
    private static final ResourceLocation field20104;
    ...
    @Nullable
    private static Block method13835(final JsonObject jsonObject) {
    ...
    static {
        field20104 = new ResourceLocation("placed_block");
    }
}
