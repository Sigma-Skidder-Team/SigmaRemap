...
public class IRCMessage extends Panel {
    public float field20805;
    public String field20806;

    public IRCMessage(final CustomGuiScreen customGuiScreen, final String s, final int n, final int n2, final int n3, final int n4, final String s2, final String field20806) {
    ...
    public void draw(final float partialTicks) {
        if (this.getTypedText() != null) {
            ...
            if (b) {
                RenderUtil.method26876((float) this.x, (float) this.y, (float) (this.x + this.field20480), (float) (this.y + this.field20481), AllUtils.applyAlpha(-11890462, 1.0f));
            }
            final int n5 = 16;
            final int n6 = 8;
            ...
            RenderUtil.drawString(ClientFonts.JelloLight14, (float) (this.x + n5 + 50), (float) (this.y + n6 + 5), this.field20495, AllUtils.applyAlpha(n7, partialTicks));
            RenderUtil.drawString(ClientFonts.JelloLight12, (float) (this.x + n5 + 50), (float) (this.y + n6 + 19), this.field20806, AllUtils.applyAlpha(n7, partialTicks * 0.5f));
