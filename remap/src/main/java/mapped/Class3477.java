...
public class Class3477 extends Class3446
{
    ...
    public boolean method11013() {
        return this.field16384 <= this.field16385.ticksExisted && (!this.field16385.world.method6739((Class<? extends Entity>)Class427.class, this.field16385.getBoundingBox().grow(8.0, 8.0, 8.0), (Predicate<? super Entity>)Class840.field4478).isEmpty() || !this.field16385.method2718(Class2215.field13600).method27620());
    }
    
    @Override
    public void method11015() {
        final List<Entity> method6739 = this.field16385.world.method6739(Class427.class, this.field16385.getBoundingBox().grow(8.0, 8.0, 8.0), (Predicate<? super Entity>)Class840.field4478);
        if (!method6739.isEmpty()) {
            this.field16385.method4150().method24725(method6739.get(0), 1.2000000476837158);
    ...
    private void method11042(final ItemStack class8321) {
        if (!class8321.method27620()) {
            ...
            this.field16385.world.method6886(class8322);
        }
    }
}
