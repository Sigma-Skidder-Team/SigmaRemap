...
{
    private final Block field19043;
    private final Class9357 field19044;
    
    public Class4234(final Block field19043, final Class9357 field19044) {
        super(Class4625.method13786());
        this.field19043 = field19043;
        this.field19044 = field19044;
    }
    
    public static Class4234 method12733(final Block class3833) {
    ...
    public JsonElement method12682() {
        ...
        if (this.field19043 != null) {
            jsonObject.addProperty("block", Registry.BLOCK.getKey(this.field19043).toString());
        }
    ...
    public boolean method12734(final BlockState class7096) {
        return (this.field19043 == null || class7096.getBlock() == this.field19043) && this.field19044.method34689(class7096);
    }
}
