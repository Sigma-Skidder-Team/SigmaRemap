...
public class Class4487 extends Class4484
{
    ...
    public Class4487(final Class1795 class1795, final CompoundNBT class1796) {
        super(Class9520.field40956, class1796);
        this.field19880 = class1796.getBoolean("Chest");
    }
    
    @Override
    public void method13415(final CompoundNBT class51) {
        super.method13415(class51);
        class51.putBoolean("Chest", this.field19880);
    }
    ...
    public boolean method13421(final Class1851 class1851, final Class6346<?> class1852, final Random random, final MutableBoundingBox class1853, final ChunkPos class1854) {
        ...
        this.method13444(class1851, class1853, 4, 2, 0, 4, 5, 4, Blocks.field29394.getDefaultState(), Blocks.field29394.getDefaultState(), false);
        ...
        this.method13444(class1851, class1853, 0, 2, 0, 0, 5, 0, Blocks.field29394.getDefaultState(), Blocks.field29394.getDefaultState(), false);
        this.method13444(class1851, class1853, 0, 2, 4, 3, 5, 4, Blocks.field29394.getDefaultState(), Blocks.field29394.getDefaultState(), false);
