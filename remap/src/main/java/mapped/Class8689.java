...
public class Class8689
{
    public static void method29779(final CommandDispatcher<Class7492> commandDispatcher) {
        commandDispatcher.register((LiteralArgumentBuilder) ((LiteralArgumentBuilder)Class7788.method25001("banlist").requires(class7492 -> {
            final boolean b;
        ...
        }).then(Class7788.method25001("ips").executes(commandContext -> method29780(commandContext.getSource(), ((Class8006<K, ? extends Class6024<?>>) commandContext.getSource().method23255().method1537().method20592()).method26216()))).then(Class7788.method25001("players").executes(commandContext -> method29780(commandContext.getSource(), ((Class8006<K, ? extends Class6024<?>>) commandContext.getSource().method23255().method1537().method20591()).method26216()))));
    }
    
    private static int method29780(final Class7492 class7492, final Collection<? extends Class6024<?>> collection) {
        if (!collection.isEmpty()) {
            class7492.method23257(new Class2259("commands.banlist.list", collection.size()), false);
            for (final Class6024 class7493 : collection) {
                class7492.method23257(new Class2259("commands.banlist.entry", class7493.method17951(), class7493.method17948(), class7493.method17950()), false);
            }
        }
        else {
            class7492.method23257(new Class2259("commands.banlist.none"), false);
        }
