...
public class Class1873 implements Class1867
{
    ...
    public Class1873(final Class8654 class8654) {
        ...
        for (int i = 0; i < this.field10213.length; ++i) {
            ...
            final Class3090 class8655 = Class90.field217.method499(int1);
            if (class8655 != null) {
    ...
    public Class1873(final Class7859 class7859, final Class1868 class7860, final int[] array) {
        ...
        if (array == null) {
            ...
            for (int j = 0; j < array.length; ++j) {
                this.field10213[j] = (Class3090)Class90.field217.method499(array[j]);
    ...
    public int[] method7125() {
        ...
        for (int i = 0; i < this.field10213.length; ++i) {
            array[i] = Class90.field217.method504(this.field10213[i]);
        }
        return array;
    }
