...
public class Class6824
{
    ...
    public Chunk field26810;
    public ByteBuffer field26811;
    public boolean field26812;
    
    public Class6824(final Chunk field26810) {
    ...
    public void method20911() {
        ...
        for (int i = 0; i < 16; ++i) {
            for (int j = 0; j < 16; ++j) {
                ...
                final int method10409 = MiniMap.method10409(new BlockPos(class354.getX(), this.field26810.method7017(HeightmapType.field11522).method35713(i, j) - 1, class354.getZ()));
    ...
    private boolean method20913() {
        final Chunk method6686 = MiniMap.method10410().field4683.method6686(this.field26810.method7019().field32290, this.field26810.method7019().field32291 + 1);
        final Chunk method6687 = MiniMap.method10411().field4683.method6686(this.field26810.method7019().field32290, this.field26810.method7019().field32291 - 1);
        if (method6686 != null) {
    ...
    public boolean method20914(final Chunk class1862) {
