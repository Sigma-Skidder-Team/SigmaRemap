...
public class Class3204 extends Class3167
{
    ...
    public void method9879() {
        this.field15624 = Class3204.field15514.player.field3006.field2743;
        final float n = 999.0f;
        this.field15621 = n;
        this.field15622 = n;
        ((Class3260)this.method9914()).field15750 = -1;
        if (Class3204.field15514.gameSettings.field23440.method1056()) {
            if (this.method9883("Downwards")) {
                Class3204.field15514.gameSettings.field23440.field2162 = false;
        ...
        this.field15631 = -1.0;
        this.field15630 = false;
        if (Class3204.field15514.player.onGround) {
            this.field15631 = Class3204.field15514.player.posY;
        }
        this.field15626 = -1;
    }
    ...
    public void method9897() {
        if (this.field15624 != -1) {
            if (this.method9914().method9887("ItemSpoof").equals("Switch")) {
                Class3204.field15514.player.field3006.field2743 = this.field15624;
            }
        }
        this.field15624 = -1;
        if (((Class3260)this.method9914()).field15750 >= 0) {
            Class3204.field15514.method5269().method17292(new Class4321(Class3204.field15514.player.field3006.field2743));
            ((Class3260)this.method9914()).field15750 = -1;
        }
    ...
    public void method10044(final Class5738 class5738) {
        if (this.method9906()) {
            if (this.method9887("Speed Mode").equals("Cubecraft") && !Class9463.method35173().method35189().method21551(Class3259.class).method9906()) {
                if (Class3204.field15514.world.method6981(Class3204.field15514.player, Class3204.field15514.player.boundingBox.expand(0.0, -1.5, 0.0).contract(0.05, 0.0, 0.05).contract(-0.05, 0.0, -0.05)).count() == 0L) {
                    if (Class3204.field15514.player.fallDistance < 1.0f) {
                        class5738.method17026(true);
                    }
                }
            }
            else if (Class3204.field15514.player.onGround) {
    ...
    private void method10045(final Class5752 class5752) {
        if (this.method9906() && this.method9883("Downwards")) {
            if (class5752.method17061() == Class3204.field15514.gameSettings.field23440.field2161.field32860) {
    ...
    private void method10046(final Class5715 class5715) {
        if (this.method9906() && this.method9883("Downwards")) {
            if (class5715.method16963() == Class3204.field15514.gameSettings.field23440.field2161.field32860) {
        ...
        if (this.method9906() && this.field15628.method10281() != 0) {
            if (!class5744.method17046()) {
                ...
                if (this.field15623 != null) {
                    ...
                    final int field2743 = Class3204.field15514.player.field3006.field2743;
                    if (!this.method9914().method9887("ItemSpoof").equals("None")) {
                        this.field15628.method10280();
                    }
                    Class3204.field15514.field4682.method27319(Class3204.field15514.player, Class3204.field15514.world, this.field15627, class5745);
                    if (!this.method9914().method9883("NoSwing")) {
                        Class3204.field15514.player.method2707(this.field15627);
                    }
                    else {
                    ...
                    if (this.method9914().method9887("ItemSpoof").equals("Spoof") || this.method9914().method9887("ItemSpoof").equals("LiteSpoof")) {
                        Class3204.field15514.player.field3006.field2743 = field2743;
                    }
                }
            }
            else {
                ...
                Label_0094: {
                    if (Class3260.method10279(Class3204.field15514.player.method2715(Class316.field1878).getItem())) {
                        if (!Class3204.field15514.player.method2715(this.field15627).method27620()) {
                            final Class3260 field2745 = this.field15628;
                            if (Class3260.method10279(Class3204.field15514.player.method2715(this.field15627).getItem())) {
                                break Label_0094;
                            }
                        }
                ...
                if (!Class3204.field15514.player.collidedHorizontally) {
                    if (!Class3204.field15514.gameSettings.field23439.field2162) {
                ...
                Label_0177: {
                    if (Class3204.field15514.player.getMotion().y < 0.0) {
                        if (Class3204.field15514.player.fallDistance > 1.0f) {
                            if (Class4609.method13697(0.0f, 90.0f, 3.0f).getType() == RayTraceResult.Type.MISS) {
                                n3 += Math.min(Class3204.field15514.player.getMotion().y * 2.0, 4.0);
                                break Label_0177;
                            }
                        }
                    }
                    if (this.field15629 && this.method9883("Downwards")) {
                        ...
                        if (!Class3204.field15514.gameSettings.field23439.method1056()) {
                            n3 = this.field15631;
                        }
                    }
                }
                if (!Class4609.method13708(new BlockPos(Class3204.field15514.player.method1934().getX(), Class3204.field15514.player.method1934().getY() - 1.0, Class3204.field15514.player.method1934().getZ()))) {
                    n = Class3204.field15514.player.method1934().getX();
                    n2 = Class3204.field15514.player.method1934().getZ();
                }
                ...
                if (Class3204.field15514.player.rotationYaw != class5744.method17042()) {
                    if (Class3204.field15514.player.rotationPitch != class5744.method17040()) {
                        this.field15625 = 0;
                    }
                }
            }
    ...
    public void method10048(final Class5717 class5717) {
        ...
        if (Class3204.field15514.player.onGround || Class6430.method19160(Class3204.field15514.player, 0.01f)) {
            this.field15631 = Class3204.field15514.player.posY;
        }
        if (this.method9914().method9883("No Sprint")) {
            Class3204.field15514.player.method1816(false);
        }
        if (Class3204.field15514.player.onGround) {
            this.field15626 = 0;
        }
        ...
        switch (method9887) {
            case "Jump": {
                if (Class3204.field15514.player.onGround && Class6430.method19114() && !Class3204.field15514.player.method1809() && !this.field15629) {
                    this.field15630 = false;
                    Class3204.field15514.player.method2725();
                    ((Class3256)Class9463.method35173().method35189().method21551(Class3256.class)).method10269();
                    this.field15630 = true;
                    class5717.method16975(Class3204.field15514.player.getMotion().y);
                    class5717.method16973(Class3204.field15514.player.getMotion().x);
                    class5717.method16977(Class3204.field15514.player.getMotion().z);
                    break;
                }
                break;
            }
            case "AAC": {
                if (this.field15625 == 0 && Class3204.field15514.player.onGround) {
            ...
            case "Cubecraft": {
                double n2 = 0.2;
                final float method9888 = this.method10055(MathHelper.method35668(Class3204.field15514.player.rotationYaw));
                if (Class3204.field15514.gameSettings.field23439.method1056()) {
                    Class3204.field15514.field4633.field26532 = 1.0f;
                }
                else if (Class3204.field15514.player.onGround) {
                    if (Class6430.method19114() && !Class3204.field15514.player.method1809() && !this.field15629) {
    ...
    public void method10049(final Class5721 class5721) {
        if (this.method9906() && Class3204.field15514.player != null) {
    ...
    public void method10051(final Class5741 class5741) {
        if (this.method9906()) {
            if (this.method9887("Speed Mode").equals("Cubecraft")) {
                if (this.field15626 >= 0) {
                    if (Class3204.field15514.player.fallDistance > 1.2f) {
                        return;
                    }
                    if (Class3204.field15514.player.field3019 < this.field15631) {
                        return;
                    }
                    if (!Class3204.field15514.player.field2967) {
                        Class3204.field15514.player.posY = this.field15631;
                        Class3204.field15514.player.lastTickPosY = this.field15631;
                        Class3204.field15514.player.field3019 = this.field15631;
                        Class3204.field15514.player.prevPosY = this.field15631;
                        if (Class7482.method23148()) {
                            Class3204.field15514.player.field3013 = 0.099999994f;
                        }
                    }
                }
            }
    ...
    public double[] method10052() {
        final double field2395 = Class3204.field15514.player.posX;
        final double field2396 = Class3204.field15514.player.posZ;
        final double n = Class3204.field15514.player.field4085.field24722;
        final double n2 = Class3204.field15514.player.field4085.field24721;
        final float field2397 = Class3204.field15514.player.rotationYaw;
        BlockPos class354 = new BlockPos(field2395, Class3204.field15514.player.posY - 1.0, field2396);
        double n3 = field2395;
        double n4 = field2396;
        double n5 = 0.0;
        ...
        while (Class4609.method13708(class354)) {
            ...
            class354 = new BlockPos(n3, Class3204.field15514.player.posY - 1.0, n4);
        }
    ...
    public float method10055(float n) {
        float n2 = 0.0f;
        final float field2968 = Class3204.field15514.player.field2968;
        final float field2969 = Class3204.field15514.player.field2970;
        if (field2968 <= 0.0f) {
            if (field2968 < 0.0f) {
                if (field2969 <= 0.0f) {
                    if (field2969 >= 0.0f) {
