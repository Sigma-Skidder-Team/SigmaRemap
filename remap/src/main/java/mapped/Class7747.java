...
public class Class7747 extends Class7746
{
    ...
    public Vec3d method24734() {
        return new Vec3d(this.field31657.method1938(), this.method24744(), this.field31657.method1945());
    }
    ...
    private int method24744() {
        if (this.field31657.method1706() && this.method24742()) {
            int method35644 = MathHelper.floor(this.field31657.method1941());
            Class3833 class3833 = this.field31658.method6701(new BlockPos(this.field31657.method1938(), method35644, this.field31657.method1945())).method21696();
            int n = 0;
            while (class3833 == Class7521.field29173) {
                ++method35644;
                class3833 = this.field31658.method6701(new BlockPos(this.field31657.method1938(), method35644, this.field31657.method1945())).method21696();
                if (++n <= 16) {
                    continue;
                }
                return MathHelper.floor(this.field31657.method1941());
            }
            return method35644;
        }
        return MathHelper.floor(this.field31657.method1941() + 0.5);
    }
    ...
    public void method24737() {
        super.method24737();
        if (this.field31678) {
            if (this.field31658.method6994(new BlockPos(this.field31657.method1938(), this.field31657.method1941() + 0.5, this.field31657.method1945()))) {
                return;
            }
    ...
    public boolean method24738(final Vec3d class5487, final Vec3d class5488, int n, final int n2, int n3) {
        ...
        int method35645 = MathHelper.floor(class5487.field22772);
        ...
        n += 2;
        n3 += 2;
        if (this.method24745(method35644, MathHelper.floor(class5487.field22771), method35645, n, n2, n3, class5487, a2, a3)) {
            n -= 2;
            n3 -= 2;
            ...
            final int method35646 = MathHelper.floor(class5488.field22770);
            final int method35647 = MathHelper.floor(class5488.field22772);
    ...
    private boolean method24746(final int n, final int n2, final int n3, final int n4, final int n5, final int n6, final Vec3d class5487, final double n7, final double n8) {
        for (final BlockPos class5488 : BlockPos.method1154(new BlockPos(n, n2, n3), new BlockPos(n + n4 - 1, n2 + n5 - 1, n3 + n6 - 1))) {
            if ((class5488.getX() + 0.5 - class5487.field22770) * n7 + (class5488.getZ() + 0.5 - class5487.field22772) * n8 >= 0.0 && !this.field31658.method6701(class5488).method21749(this.field31658, class5488, Class2084.field12051)) {
                return false;
            }
        }
        return true;
