...
public class Class9302
{
    ...
    private static int method34396(final Class7492 class7492, final Class354 class7493, final int i, final Class8321 class7494) throws CommandSyntaxException {
        ...
        if (i >= 0 && i < class7495.method2239()) {
            ...
            class7492.method23257(new Class2259("commands.replaceitem.block.success", new Object[] { class7493.method1074(), class7493.method1075(), class7493.method1076(), class7494.method27684() }), true);
            return 1;
        }
        throw Class9302.field39909.create((Object)i);
    }
    
    private static int method34397(final Class7492 class7492, final Collection<? extends Class399> collection, final int i, final Class8321 class7493) throws CommandSyntaxException {
        ...
        if (!arrayListWithCapacity.isEmpty()) {
            if (arrayListWithCapacity.size() != 1) {
                ...
                class7492.method23257(new Class2259("commands.replaceitem.entity.success.single", new Object[] { ((Class399)arrayListWithCapacity.iterator().next()).method1871(), class7493.method27684() }), true);
            }
