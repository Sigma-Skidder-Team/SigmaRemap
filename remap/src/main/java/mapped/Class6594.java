...
public final class Class6594 implements Class6595
{
    ...
    public Class5414 method20041(final CommandContext<Class7492> commandContext) throws CommandSyntaxException {
        ...
        final TileEntity method27769 = commandContext.getSource().method23250().getTileEntity(method27768);
        if (method27769 != null) {
    ...
    public ArgumentBuilder<Class7492, ?> method20042(final ArgumentBuilder<Class7492, ?> argumentBuilder, final Function<ArgumentBuilder<Class7492, ?>, ArgumentBuilder<Class7492, ?>> function) {
        return (ArgumentBuilder<Class7492, ?>)argumentBuilder.then(Class7788.method25001("block").then(function.apply(Class7788.method25002(this.field26156 + "Pos", (com.mojang.brigadier.arguments.ArgumentType<Object>)Class8330.method27767()))));
    }
}
