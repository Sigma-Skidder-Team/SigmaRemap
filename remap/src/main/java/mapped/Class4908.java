...
public class Class4908 extends Class4825
{
    ...
    public void method14205(final float n) {
        final double max = Math.max(-1.0, Math.min(1.0, (Class869.method5277().field4650.method26959() - Class869.method5277().field4632.method7694() / 2) / (Class869.method5277().field4632.method7694() / 2)));
        final double max2 = Math.max(-1.0, Math.min(1.0, (Class869.method5277().field4650.method26960() - Class869.method5277().field4632.method7695() / 2) / (Class869.method5277().field4632.method7695() / 2)));
        GL11.glPushMatrix();
        GL11.glMatrixMode(5888);
        GL11.glEnable(2929);
        GL11.glTranslatef((float)(this.field20478 + this.field20480 / 2), (float)(this.field20479 + this.field20481 / 2), -1000.0f);
        Class8726.method30067(Class6789.method20755(20.0, (float)(Class869.method5277().field4632.method7692() / Class869.method5277().field4632.method7693()), 0.5f, 1.0f));
