...
public abstract class Class4536 extends Class4535<Class5122>
{
    ...
    public boolean method13537(final Class1851 class1851, final Random random, final BlockPos class1852, final BlockState class1853) {
        ...
        final BlockState method1138 = class1851.method6701(class1852);
            ...
            if (class1851.method6701(method1137).method21696() == Class7521.field29173) {
                ...
                if (random.nextFloat() >= 0.25f) {
                    if (random.nextFloat() < 0.05f) {
                        class1851.method6688(method1137, ((Class7097<O, BlockState>)Class7521.field29757.method11878()).method21773((Class7111<Comparable>)Class3889.field17551, random.nextInt(4) + 1), 2);
                    }
                }
                else {
                ...
                for (final Direction class1854 : Plane.HORIZONTAL) {
                    ...
                    class1851.method6688(method1139, ((Class7097<O, BlockState>)Class7188.field27922.method25620(random).method11878()).method21773((Class7111<Comparable>)Class3926.field17791, class1854), 2);
                }
                return true;
            }
        }
