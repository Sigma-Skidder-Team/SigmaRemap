...
public class Class4810 extends Class4803
{
    ...
    public Class4810(final Class4803 class4803, final String s, final int n, final int n2) {
        ...
        this.addVisualThing(this.field20561 = new Class4909(this, "reload", 0, 0, 120, 40, "Reload", Class265.field1273.field1292));
        this.addVisualThing(this.field20562 = new Class4909(this, "back", 0, 48, 120, 40, "Back", Class265.field1273.field1292));
        final int n3 = 200;
        final int n4 = 146;
        final int n5 = this.method14276() - 625;
        this.addVisualThing(this.field20563 = new Class4909(this, "login", n5, 0, n3, 40, "Login", Class265.field1273.field1292));
        this.addVisualThing(this.field20566 = new Class4909(this, "direct", n5 + n3 + 16, 0, n3, 40, "Direct Login", Class265.field1273.field1292));
        this.addVisualThing(this.field20568 = new Class4909(this, "add", n5 + n3 * 2 + 32, 0, n3, 40, "Add", Class265.field1273.field1292));
        this.addVisualThing(this.field20564 = new Class4909(this, "random", n5, 48, n4, 40, "Random", Class265.field1273.field1292));
        this.addVisualThing(this.field20565 = new Class4909(this, "remove", n5 + n4 + 16, 48, n4, 40, "Remove", Class265.field1273.field1292));
        this.addVisualThing(this.field20567 = new Class4909(this, "edit", n5 + n4 * 2 + 32, 48, n4, 40, "Edit", Class265.field1273.field1292));
        this.addVisualThing(this.field20569 = new Class4909(this, "alpha", n5 + n4 * 3 + 48, 48, n4, 40, "Alphalts", Class265.field1273.field1292));
