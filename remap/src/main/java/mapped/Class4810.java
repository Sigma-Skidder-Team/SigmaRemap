...
public class Class4810 extends CustomGuiScreen
{
    ...
    public Class4810(final CustomGuiScreen customGuiScreen, final String s, final int n, final int n2) {
        ...
        this.field20564.doThis((class4937, n) -> class4804.method14848(Client.getInstance().getAltManager().method25466().get(new Random().nextInt(Client.getInstance().getAltManager().method25466().size()))));
        this.field20562.doThis((class4803, n) -> Minecraft.getInstance().displayGuiScreen(new MainMenu()));
        ...
        this.field20567.doThis((class4937, n) -> {
            ...
            if (method14855 != null) {
                Client.getInstance().getScreenManager().method32156(new Class4933(method14855.field20723));
            }
        });
        this.field20568.doThis((class4803, n) -> Client.getInstance().getScreenManager().method32156(new Class4938()));
        this.field20566.doThis((class4803, n) -> Client.getInstance().getScreenManager().method32156(new Class4931()));
    }
