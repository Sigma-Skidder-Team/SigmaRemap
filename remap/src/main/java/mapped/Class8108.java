...
public class Class8108
{
    ...
    private Consumer<Class51> field33419;
    ...
    public boolean method26645(final int n, final Class51 class51) {
    ...
    private int method26646(final Consumer<Class51> field33419) {
        this.field33419 = field33419;
        return ++this.field33418;
    }
    
    public void method26647(final int n, final Consumer<Class51> consumer) {
