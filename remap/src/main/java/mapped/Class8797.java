...
public class Class8797
{
    ...
    public boolean method30693() {
        return Class8797.field36991.field4683.getBlockState(this.method30692()).method21696() != Class7521.field29174 && Class8797.field36991.field4683.getBlockState(this.method30692()).method21696() != Class7521.field29173 && this.method30699(this.method30692()) && this.method30699(this.method30692().method1137());
    }
    
    public boolean method30694() {
        if (Class8797.field36991.field4683.getBlockState(this.method30692()).method21696() == Class7521.field29174) {
            return false;
        }
        if (Class8797.field36991.field4683.getBlockState(this.method30692()).method21696() != Class7521.field29173) {
    ...
    public static boolean method30695(final BlockPos class354) {
        for (final Class8422 class355 : Class8797.field36993) {
            final BlockState method6701 = Class8797.field36991.field4683.getBlockState(class354.add(class355.field34567, class355.field34568, class355.field34569));
    ...
    public static boolean method30696(final BlockPos class354) {
        for (final Class8422 class355 : Class8797.field36993) {
            if (Class8797.field36991.field4683.getBlockState(class354.add(class355.field34567, class355.field34568, class355.field34569)).method21706()) {
                return false;
            }
        }
        return true;
    ...
    public boolean method30697() {
        for (final Class8422 class8422 : Class8797.field36993) {
            final BlockState method6701 = Class8797.field36991.field4683.getBlockState(this.method30692().add(class8422.field34567, class8422.field34568, class8422.field34569));
            if (method6701.getBlock() == Class7521.field29173 || method6701.getBlock() == Class7521.field29174) {
                return true;
            }
        }
        for (final Class8422 class8423 : Class8797.field36993) {
            final BlockState method6702 = Class8797.field36991.field4683.getBlockState(this.method30692().add(class8423.field34567, class8423.field34568 + 1.0, class8423.field34569));
            if (method6702.getBlock() == Class7521.field29173 || method6702.getBlock() == Class7521.field29174) {
                return true;
            }
        }
        return Class8797.field36991.field4683.getBlockState(this.method30692().method1138(2)).method21696() instanceof Class3986 && !this.field36992.field36694.contains(this.method30692().method1138(2).toLong());
    }
    
    public boolean method30698() {
        if (!this.method30697()) {
            if (Class8797.field36991.field4683.getBlockState(this.method30692()).method21696() != Class7521.field29172) {
                if (Class8797.field36991.field4683.getBlockState(this.method30692().method1137()).method21696() != Class7521.field29172) {
                    return false;
                }
            }
        }
    ...
    public boolean method30699(final BlockPos class354) {
        return this.field36992.field36694.contains(class354.toLong()) || Class869.method5277().field4683.getBlockState(class354).method21727(Class8797.field36991.field4683, class354).method24540();
    }
    
    public boolean method30700() {
        final BlockPos method30692 = this.method30692();
        return !this.field36992.field36694.contains(this.method30692().toLong()) && !Class869.method5277().field4683.getBlockState(method30692).method21727(Class8797.field36991.field4683, method30692).method24540() && Class869.method5277().field4683.getBlockState(method30692).method21727(Class8797.field36991.field4683, method30692).method24537().method18507() == 1.0;
    }
