...
public class Class3454 extends Class3446
{
    ...
    public void method11016() {
        ...
        final boolean equals = field2391.rayTraceBlocks(new RayTraceContext(new Vec3d(MathHelper.floor(this.field16294.getPosX()) + 0.5, method2635 + 0.5, MathHelper.floor(this.field16294.getPosZ()) + 0.5), new Vec3d(method2634 + 0.5, method2635 + 0.5, method2636 + 0.5), RayTraceContext.BlockMode.OUTLINE, RayTraceContext.FluidMode.NONE, this.field16294)).method21447().equals(class354);
