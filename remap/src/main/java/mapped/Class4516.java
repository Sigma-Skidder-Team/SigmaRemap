...
public class Class4516 extends Class4515
{
    ...
    public Class4516(final Class1795 class1795, final Class1932 field19921, final BlockPos class1796, final Class2052 field19922, final int n) {
        ...
        this.field19920 = class1796.method1134(class1797.getX(), class1797.getY() - n, class1797.getZ());
    ...
    public boolean method13421(final Class1851 class1851, final Class6346<?> class1852, final Random random, final Class6997 class1853, final Class7859 class1854) {
        ...
        final BlockPos method32854 = this.field19920.method1135(Class6585.method19953(method32853, new BlockPos(3 - class1855.getX(), 0, 0 - class1855.getZ())));
        ...
        if (this.field19921.equals(Class5172.method16140())) {
            final BlockPos method32857 = this.field19920.method1135(Class6585.method19953(method32853, new BlockPos(3, 0, 5)));
