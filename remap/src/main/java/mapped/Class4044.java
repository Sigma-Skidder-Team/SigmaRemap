...
public class Class4044 extends Class4043
{
    public Class4044(final Block class3833, final Block class3834, final Properties class3835) {
        ...
        Validate.isInstanceOf(Class3944.class, class3833);
        Validate.isInstanceOf(Class3944.class, class3834);
    }
        ...
        if (method27660 != null) {
            if (method27660.contains("Patterns")) {
                ...
                for (int i = 0; i < method27661.size(); ++i) {
                    ...
                    if (method27664 != null) {
                        list.add(new Class2259("block.minecraft.banner." + method27664.method858() + '.' + method27663.method814()).applyTextStyle(TextFormatting.GRAY));
                    }
                }
            }
        }
