...
public class Class9233
{
    public static void method34045(final CommandDispatcher<Class7492> commandDispatcher) {
        final LiteralArgumentBuilder literalArgumentBuilder = Class7788.method25001("gamerule").requires(class7492 -> class7492.method23210(2));
    ...
    private static <T extends Class8117<T>> int method34046(final CommandContext<Class7492> commandContext, final Class9424<T> class9424) {
        final Class7492 class9425 = commandContext.getSource();
        ...
        class9425.method23257(new Class2259("commands.gamerule.set", class9424.method35022(), method31211.toString()), true);
    ...
    private static <T extends Class8117<T>> int method34047(final Class7492 class7492, final Class9424<T> class7493) {
        ...
        class7492.method23257(new Class2259("commands.gamerule.query", class7493.method35022(), method31211.toString()), false);
        return method31211.method26711();
    }
}
