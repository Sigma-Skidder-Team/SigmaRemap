...
public class Class7525 extends Class7524
{
    ...
    public Minecraft field29871;
    
    public Class7525(final int n) {
        super(new Font("Arial", 0, n), false);
        this.field29871 = Minecraft.method5277();
        this.field29870 = n;
    }
    
    private int method23536(final char c) {
        return (int)Math.ceil(this.field29871.fontRenderer.method6618(c) * this.field29870);
    }
    ...
    public int method23539() {
        this.field29871.fontRenderer.getClass();
    ...
    public void method23499(final float n, final float n2, final String s, final Class2427 class2427, final int n3, final int n4) {
        ...
        this.field29871.method5290().method5849(this.field29871.fontRenderer.field10031.field10459);
        this.field29871.fontRenderer.method6610(s, n, n2, new Color(class2427.field14368, class2427.field14369, class2427.field14370, class2427.field14371).getRGB());
        GL11.glPopMatrix();
    }
