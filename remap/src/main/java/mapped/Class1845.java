...
public class Class1845 implements AutoCloseable
{
    ...
    private void method6633(final MatrixStack class7351, final IRenderTypeBuffer class7352, final boolean b, final int n) {
        final Matrix4f method32111 = class7351.getLast().getMatrix();
        final Class4150 method32112 = class7352.method25214(this.field10038);
        method32112.pos(method32111, 0.0f, 128.0f, -0.01f).method12399(255, 255, 255, 255).tex(0.0f, 1.0f).method12440(n).endVertex();
        method32112.pos(method32111, 128.0f, 128.0f, -0.01f).method12399(255, 255, 255, 255).tex(1.0f, 1.0f).method12440(n).endVertex();
        method32112.pos(method32111, 128.0f, 0.0f, -0.01f).method12399(255, 255, 255, 255).tex(1.0f, 0.0f).method12440(n).endVertex();
        method32112.pos(method32111, 0.0f, 0.0f, -0.01f).method12399(255, 255, 255, 255).tex(0.0f, 0.0f).method12440(n).endVertex();
        int n2 = 0;
        for (final Class9323 class7353 : this.field10036.field25431.values()) {
            ...
            method32115.pos(method32114, -1.0f, 1.0f, n2 * -0.001f).method12399(255, 255, 255, 255).tex(n3, n4).method12440(n).endVertex();
            method32115.pos(method32114, 1.0f, 1.0f, n2 * -0.001f).method12399(255, 255, 255, 255).tex(n5, n4).method12440(n).endVertex();
            method32115.pos(method32114, 1.0f, -1.0f, n2 * -0.001f).method12399(255, 255, 255, 255).tex(n5, n6).method12440(n).endVertex();
            method32115.pos(method32114, -1.0f, -1.0f, n2 * -0.001f).method12399(255, 255, 255, 255).tex(n3, n6).method12440(n).endVertex();
            class7351.method22568();
            if (class7353.method34528() != null) {
                final FontRenderer field4643 = Minecraft.getInstance().fontRenderer;
                final String method32116 = class7353.method34528().getFormattedText();
                final float n7 = (float)field4643.getStringWidth(method32116);
                ...
                field4643.renderString(method32116, 0.0f, 0.0f, -1, false, class7351.getLast().getMatrix(), class7352, false, Integer.MIN_VALUE, n);
                class7351.method22568();
            }
            ++n2;
        }
