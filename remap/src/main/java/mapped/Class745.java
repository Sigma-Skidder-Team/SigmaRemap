...
{
    private static final Class1932 field4031;
    
    public Class745(final Class3435 class3435, final Class464 class3436, final Class2250 class3437) {
    ...
    public void method2976(final float n, final int n2, final int n3) {
        ...
        this.field3150.method5290().method5849(Class745.field4031);
        this.method3186((this.field3152 - this.field3075) / 2, (this.field3153 - this.field3076) / 2, 0, 0, this.field3075, this.field3076);
    }
    
    static {
        field4031 = new Class1932("textures/gui/container/shulker_box.png");
    }
}
