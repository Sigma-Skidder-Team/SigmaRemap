...
public class Class1768 extends Class1767
{
            ...
            if (method6303 == null) {
                this.field9839 = CompletableFuture.runAsync(() -> {
                    ...
                    if (this.method6304()) {
                        ...
                        try {
                            final URLConnection urlConnection = new URL(this.field9836).openConnection(Minecraft.getInstance().method5289());
    ...
    private boolean method6304() {
        if (this.field9842) {
            final Proxy method5289 = Minecraft.getInstance().method5289();
    ...
    private void method6305() {
        try {
            final Class8215 method19926 = Class6579.method19926(Class6579.method19919(this.field9836, Minecraft.getInstance().method5289()));
