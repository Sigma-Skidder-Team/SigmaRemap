...
public class Class6868 implements Class6866
{
    ...
    public Class2204 method20978(final Class690 class690, final long n) {
        ...
        if (method31037.size() != 1) {
            if (n >= 1500L) {
                final int n3 = Class9546.method35642(Class9546.method35653((n - 1500L) / 300.0f, 0.0f, 1.0f) * 252.0f) << 24 | 0x4000000;
                ...
                class690.method3853().field4643.method6610(Class8822.method30773("advancements.toast." + method31036.method22531().method8015(), new Object[0]), 30.0f, 11.0f, n2 | (Class9546.method35642(Class9546.method35653((1500L - n) / 300.0f, 0.0f, 1.0f) * 255.0f) << 24 | 0x4000000));
            }
        }
        else {
