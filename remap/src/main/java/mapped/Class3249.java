...
public class Class3249 extends Class3247
{
    ...
    public int method10264() {
        ...
        if (Class3249.field15514.world.method6981(Class3249.field15514.field4684, class6221.offset(0.3000001, 0.0, 0.0)).count() != 0L) {
            return 1;
        }
        if (Class3249.field15514.world.method6981(Class3249.field15514.field4684, class6221.offset(-0.3000001, 0.0, 0.0)).count() != 0L) {
            return 2;
        }
        if (Class3249.field15514.world.method6981(Class3249.field15514.field4684, class6221.offset(0.0, 0.0, 0.3000001)).count() != 0L) {
            return 3;
        }
        if (Class3249.field15514.world.method6981(Class3249.field15514.field4684, class6221.offset(0.0, 0.0, -0.3000001)).count() == 0L) {
            return 0;
