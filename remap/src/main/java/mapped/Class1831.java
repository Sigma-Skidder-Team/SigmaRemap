...
public class Class1831<T extends Class511, M extends Class5845<T> & Class5855> extends Class1799<T, M>
{
    ...
    public void method6551(final Class7351 class7351, final Class7807 class7352, final int n, final T t, final float n2, final float n3, final float n4, final float n5, final float n6, final float n7) {
        final Class8321 method2718 = t.method2718(Class2215.field13605);
        if (!method2718.method27620()) {
            final Class3820 method2719 = method2718.method27622();
            ...
            if (method2719 instanceof Class4036 && ((Class4036)method2719).method12240() instanceof Class3932) {
                ...
                Class869.method5277().method5308().method35143(t, method2718, Class2016.field11491, false, class7351, class7352, n);
            }
