...
public class Class9200
{
    public static void method33670(final CommandDispatcher<Class7492> commandDispatcher) {
        commandDispatcher.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)Class7788.method25001("give").requires(class7492 -> class7492.method23210(2))).then(Class7788.method25002("targets", (com.mojang.brigadier.arguments.ArgumentType<Object>)Class6886.method21151()).then(((RequiredArgumentBuilder)Class7788.method25002("item", (com.mojang.brigadier.arguments.ArgumentType<Object>)Class6767.method20638()).executes(commandContext -> method33671(commandContext.getSource(), Class6767.method20639((com.mojang.brigadier.context.CommandContext<Object>)commandContext, "item"), Class6886.method21152(commandContext, "targets"), 1))).then(Class7788.method25002("count", (com.mojang.brigadier.arguments.ArgumentType<Object>)IntegerArgumentType.integer(1)).executes(commandContext -> method33671(commandContext.getSource(), Class6767.method20639((com.mojang.brigadier.context.CommandContext<Object>)commandContext, "item"), Class6886.method21152(commandContext, "targets"), IntegerArgumentType.getInteger(commandContext, "count")))))));
    }
    ...
    private static int method33671(final Class7492 class7492, final Class175 class7493, final Collection<Class513> collection, final int n) throws CommandSyntaxException {
        ...
        if (collection.size() != 1) {
            class7492.method23257(new Class2259("commands.give.success.single", n, class7493.method772(n, false).method27684(), collection.size()), true);
        }
        else {
            class7492.method23257(new Class2259("commands.give.success.single", n, class7493.method772(n, false).method27684(), collection.iterator().next().getDisplayName()), true);
        }
