...
public class Class3374 extends Class3167
{
    public Class3374() {
        super(Class8013.field32988, "Jargon", "Sends a randomly contructed message in chat");
        this.method9881(new Class5001("Jargon", "A test type button", 0, new String[] { "Excuse", "Techincal", "Audio" }));
    }
