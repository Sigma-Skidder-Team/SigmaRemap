...
public class Class4932 extends Class4800
{
    ...
    public void draw(float method35858) {
        ...
        RenderUtil.method26876((float)this.field20478, (float)this.field20479, (float)(this.field20478 + this.field20480), (float)(this.field20479 + this.field20481), ColorUtils.applyAlpha(ClientColors.field1273.color, 0.25f * method35858));
        super.method14227();
