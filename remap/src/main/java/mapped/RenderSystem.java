...
public class RenderSystem
{
    ...
    private static final Tessellator field36651;
    ...
    public static void method29983() {
        if (RenderSystem.field36656 == null && RenderSystem.field36655 != Thread.currentThread()) {
            RenderSystem.field36656 = Thread.currentThread();
            return;
        }
    ...
    public static boolean method29984() {
        return Thread.currentThread() == RenderSystem.field36656;
    }
    
    public static boolean method29985() {
        return RenderSystem.field36658 || method29984();
    }
    
    public static void method29986(final boolean b) {
        final boolean b2 = RenderSystem.field36656 == Thread.currentThread();
        if (RenderSystem.field36655 == null) {
            if (RenderSystem.field36656 != null) {
                if (b2 != b) {
                    RenderSystem.field36655 = Thread.currentThread();
                    return;
                }
            }
        }
    ...
    public static boolean method29988() {
        return RenderSystem.field36658 || method29987();
    }
    ...
    public static void method29991(final Class7531 e) {
        RenderSystem.field36650.add(e);
    }
    
    public static void method29992(final long n) {
        GLFW.glfwPollEvents();
        method29993();
        Tessellator.getInstance().getBuffer().method12402();
        GLFW.glfwSwapBuffers(n);
        GLFW.glfwPollEvents();
    }
    
    public static void method29993() {
        RenderSystem.field36654 = true;
        while (!RenderSystem.field36650.isEmpty()) {
            RenderSystem.field36650.poll().method23591();
        }
        RenderSystem.field36654 = false;
    }
    
    public static void method29994(final int n) {
        double n2;
        double field36659;
        for (n2 = RenderSystem.field36659 + 1.0 / n, field36659 = GLFW.glfwGetTime(); field36659 < n2; field36659 = GLFW.glfwGetTime()) {
            GLFW.glfwWaitEventsTimeout(n2 - field36659);
        }
        RenderSystem.field36659 = field36659;
    }
    ...
    public static void enableDepthTest() {
        method29989(RenderSystem::method29988);
    ...
    public static void shadeModel(final int n) {
        method29989(RenderSystem::method29987);
    ...
    public static String method30077() {
        method29989(RenderSystem::method29990);
        ...
        if (RenderSystem.field36657 == -1) {
            ...
            for (int i = Math.max(32768, method31664); i >= 1024; i >>= 1) {
                ...
                if (Class8933.method31614(32868, 0, 4096) != 0) {
                    return RenderSystem.field36657 = i;
                }
            }
    ...
    public static void method30089(final int n, final ByteBuffer byteBuffer, final int n2) {
        method29989(RenderSystem::method29985);
    ...
    public static void method30113() {
        RenderSystem.field36658 = true;
    }
    
    public static void method30114() {
        RenderSystem.field36658 = false;
        if (!RenderSystem.field36650.isEmpty()) {
            method29993();
        }
        if (RenderSystem.field36650.isEmpty()) {
            return;
    ...
    public static Tessellator method30116() {
        method29989(RenderSystem::method29984);
        return RenderSystem.field36651;
    }
    ...
    static {
        ...
        field36651 = new Tessellator();
        RenderSystem.field36657 = -1;
        RenderSystem.field36659 = Double.MIN_VALUE;
    }
}
