...
public class Class6804
{
    ...
    public static BufferedImage method20826(final BufferedImage bufferedImage, final int n) {
    ...
    public static BufferedImage method20827(final BufferedImage bufferedImage, final int n) {
        if (bufferedImage != null) {
            final ConvolveOp convolveOp = new ConvolveOp(method20829((float)n), 1, null);
            final int width = bufferedImage.getWidth();
            final int height = bufferedImage.getHeight();
            final BufferedImage bufferedImage2 = new BufferedImage(height + n * 2, width + n * 2, bufferedImage.getType());
    ...
    public static BufferedImage method20828(final BufferedImage bufferedImage) {
        final int width = bufferedImage.getWidth();
        final int height = bufferedImage.getHeight();
    ...
    public static BufferedImage method20830(int n, int n2, int n3, int n4, int n5, final int n6, final int n7, final boolean b) {
        final int n8 = 4;
        ...
        final BufferedImage bufferedImage = new BufferedImage(n3 / n5, n4 / n5, 1);
    ...
    public static BufferedImage method20831(final int n, final int n2, final int n3, final int n4, final int n5, final int n6) {
        return method20830(n, n2, n3, n4, n5, n6, Class265.field1273.field1292, false);
    }
    
    public static BufferedImage method20832(final int n, final int n2, final int n3, final int n4, final int n5, final int n6, final int n7) {
        return method20830(n, n2, n3, n4, n5, n6, n7, false);
    }
    
    public static BufferedImage method20833(final int n, final int n2, final int n3, final int n4, final int n5, final int n6, final boolean b) {
        return method20830(n, n2, n3, n4, n5, n6, Class265.field1273.field1292, b);
    }
    
    public static BufferedImage method20834(final BufferedImage bufferedImage, final int n, final int rgb) {
    ...
    public static BufferedImage method20835(final BufferedImage bufferedImage, final int n) {
        final BufferedImage method20837 = method20837(bufferedImage, (bufferedImage.getWidth() + n * 2) / (float)bufferedImage.getWidth(), (bufferedImage.getHeight() + n * 2) / (float)bufferedImage.getHeight());
    ...
    public static BufferedImage method20836(final BufferedImage bufferedImage, final float n, final float n2, final float n3) {
        final int width = bufferedImage.getWidth();
    ...
    public static BufferedImage method20837(final BufferedImage bufferedImage, final double sx, final double sy) {
