...
public class Class5444 extends Class5419<Class759>
{
        ...
        if (this.field22665 <= 0) {
            ...
            if (method24727 != null) {
                if (this.field22663 != null) {
                    ...
                    if (class1851.method21335().method19204().distanceSq(this.field22663) > 4.0) {
    ...
    private boolean method16629(final Class759 class759, final Class6949 class760, final long l) {
        ...
        if (!this.method16630(class759, class760)) {
            ...
            if (method19206 != null) {
                this.field22662 = class759.method4150().method24719(method19206.x, method19206.y, method19206.z, 0);
    ...
    private boolean method16630(final Class759 class759, final Class6949 class760) {
        return class760.method21335().method19204().manhattanDistance(new BlockPos(class759)) <= class760.method21337();
    }
}
