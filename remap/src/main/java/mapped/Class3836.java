...
public class Class3836 extends Class3834
{
    ...
    public Class3836(final boolean field17445, final Class9288 class9288) {
        super(class9288);
        this.method11877(((Class7097<O, BlockState>)((Class7097<O, BlockState>)this.field17406.method32903()).method21773((Class7111<Comparable>)Class3836.field17415, Direction.NORTH)).method21773((Class7111<Comparable>)Class3836.field17438, false));
    ...
    public BlockState method11846(final Class7074 class7074) {
        return ((Class7097<O, BlockState>)((Class7097<O, BlockState>)this.method11878()).method21773((Class7111<Comparable>)Class3836.field17415, class7074.method21642().getOpposite())).method21773((Class7111<Comparable>)Class3836.field17438, false);
    }
    ...
    private void method11892(final World class1847, final BlockPos class1848, final BlockState class1849) {
        ...
        if (method11893 && !class1849.method21772((Class7111<Boolean>)Class3836.field17438)) {
            ...
            if (class1849.method21772((Class7111<Boolean>)Class3836.field17438)) {
                ...
                final BlockState method11895 = class1847.method6701(method11894);
                int n = 1;
                Label_0143: {
    ...
    public boolean method11857(final BlockState class7096, final World class7097, final BlockPos class7098, final int n, final int n2) {
        ...
        if (!class7097.isRemote) {
            ...
            if (method11893 && (n == 1 || n == 2)) {
                class7097.method6688(class7098, ((Class7097<O, BlockState>)class7096).method21773((Class7111<Comparable>)Class3836.field17438, true), 2);
                return false;
            }
            if (!method11893) {
                if (n == 0) {
        ...
        if (n != 0) {
            if (n == 1 || n == 2) {
                ...
                class7097.method6688(class7098, (BlockState)((Class7097<Object, Object>)((Class7097<Object, Object>)Class7521.field29264.method11878()).method21773((Class7111<Comparable>)Class3960.field17898, class7099)).method21773(Class3960.field17899, this.field17445 ? Class178.field508 : Class178.field507), 3);
                class7097.method6729(class7098, Class3960.method12080(((Class7097<O, BlockState>)this.method11878()).method21773((Class7111<Comparable>)Class3836.field17415, Direction.byIndex(n2 & 0x7)), class7099, false, true));
                if (!this.field17445) {
                    ...
                    final BlockState method11896 = class7097.method6701(method11895);
            ...
            class7097.method6688(class7098, ((Class7097<O, BlockState>)class7096).method21773((Class7111<Comparable>)Class3836.field17438, true), 67);
    ...
    private boolean method11895(final World class1847, final BlockPos class1848, final Direction class1849, final boolean b) {
        ...
        if (class1850.method34052()) {
            ...
            for (int i = 0; i < method1150.size(); ++i) {
                ...
                final BlockState method1151 = class1847.method6701(class1851);
            ...
            for (int j = method1152.size() - 1; j >= 0; --j) {
                ...
                final BlockState method1153 = class1847.method6701(class1853);
            ...
            for (int k = method1150.size() - 1; k >= 0; --k) {
                ...
                final BlockState method1154 = class1847.method6701(class1854);
                final BlockPos method1155 = class1854.method1149(class1852);
                hashMap.remove(method1155);
                class1847.method6688(method1155, ((Class7097<O, BlockState>)Class7521.field29264.method11878()).method21773((Class7111<Comparable>)Class3836.field17415, class1849), 68);
                class1847.method6729(method1155, Class3960.method12080((BlockState)arrayList.get(k), class1849, b, false));
                --n;
                array[n] = method1154;
            }
            if (b) {
                final BlockState class1855 = ((Class7097<O, BlockState>)((Class7097<O, BlockState>)Class7521.field29247.method11878()).method21773((Class7111<Comparable>)Class3835.field17415, class1849)).method21773(Class3835.field17417, this.field17445 ? Class178.field508 : Class178.field507);
                final BlockState class1856 = ((Class7097<O, BlockState>)((Class7097<O, BlockState>)Class7521.field29264.method11878()).method21773((Class7111<Comparable>)Class3960.field17898, class1849)).method21773(Class3960.field17899, this.field17445 ? Class178.field508 : Class178.field507);
            ...
            final BlockState method1156 = Class7521.field29147.method11878();
    ...
    public BlockState method11790(final BlockState class7096, final Class2052 class7097) {
        return ((Class7097<O, BlockState>)class7096).method21773((Class7111<Comparable>)Class3836.field17415, class7097.method8142(class7096.method21772((Class7111<Direction>)Class3836.field17415)));
    }
