...
public class Class705 extends Class703
{
    ...
    @Override
    public void init() {
        this.method3029(new Class654(this.width / 2 - 155, 18, 150, 20, Class8822.method30773("options.mouse_settings", new Object[0]), class654 -> this.minecraft.method5244(new Class706(this, this.field3869))));
        this.method3029(Class6469.field25730.method19362(this.field3869, this.width / 2 - 155 + 160, 18, 150));
        this.field3876 = new Class607(this, this.minecraft);
        this.children.add(this.field3876);
        this.field3877 = this.method3029(new Class654(this.width / 2 - 155, this.height - 29, 150, 20, Class8822.method30773("controls.resetAll", new Object[0]), class654 -> {
            for (final Class350 class655 : this.field3869.field23460) {
                class655.method1062(class655.method1061());
            }
            Class350.method1055();
        }));
        this.method3029(new Class654(this.width / 2 - 155 + 160, this.height - 29, 150, 20, Class8822.method30773("gui.done", new Object[0]), class654 -> this.minecraft.method5244(this.field3868)));
    }
