...
public class Class1114 implements Runnable
{
    ...
    public void run() {
        ...
        this.field6000.method14242(Class4934.method14834(this.field6003, new ScrollablePane(this.field6000, "alts", 0, 114, (int)(Minecraft.getInstance().window.method7694() * Class4934.method14835(this.field6003)) - 4, Minecraft.getInstance().window.method7695() - 119 - Class4934.method14836(this.field6003))));
