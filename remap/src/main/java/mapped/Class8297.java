...
public class Class8297
{
    ...
    public void method27577(final int field34105, final int field34106, final List<Widget> list) {
        if (Math.abs(field34105 - this.field34105) <= 5 && Math.abs(field34106 - this.field34106) <= 5) {
            if (System.currentTimeMillis() >= this.field34107 + 700) {
                final Widget method3898 = Class698.method3898(field34105, field34106, list);
                if (method3898 != null) {
                    ...
                    if (method3900 != null) {
                        ...
                        AbstractGui.fill(method3899.x, method3899.y, method3899.x + method3899.width, method3899.y + method3899.height, -536870912);
    ...
    private void method27578(final int n, final int n2, final int n3, final int n4, final int n5) {
        AbstractGui.fill(n, n2 - 1, n3, n2, n5);
        AbstractGui.fill(n, n4, n3, n4 + 1, n5);
        AbstractGui.fill(n - 1, n2, n, n4, n5);
        AbstractGui.fill(n3, n2, n3 + 1, n4, n5);
    }
}
