...
public class Class9051
{
    ...
    private static int method32547(final Class7492 class7492, final Collection<? extends Class399> collection, final Class399 class7493) {
        final Iterator<? extends Class399> iterator = collection.iterator();
        while (iterator.hasNext()) {
            method32549(class7492, (Class399)iterator.next(), (Class1849)class7493.field2391, class7493.method1938(), class7493.method1941(), class7493.method1945(), EnumSet.noneOf(Class2143.class), class7493.field2399, class7493.field2400, null);
        }
        if (collection.size() != 1) {
            ...
            class7492.method23257(new Class2259("commands.teleport.success.entity.single", new Object[] { ((Class399)collection.iterator().next()).method1871(), class7493.method1871() }), true);
        }
        return collection.size();
    }
    
    private static int method32548(final Class7492 class7492, final Collection<? extends Class399> collection, final Class1849 class7493, final Class5346 class7494, final Class5346 class7495, final Class8140 class7496) throws CommandSyntaxException {
        final Class5487 method16504 = class7494.method16504(class7492);
        ...
        for (final Class399 class7498 : collection) {
            if (class7495 != null) {
        ...
        if (collection.size() != 1) {
            ...
            class7492.method23257(new Class2259("commands.teleport.success.location.single", new Object[] { ((Class399)collection.iterator().next()).method1871(), method16504.field22770, method16504.field22771, method16504.field22772 }), true);
        }
        return collection.size();
    }
    
    private static void method32549(final Class7492 class7492, Class399 method23371, final Class1849 class7493, final double n, final double n2, final double n3, final Set<Class2143> set, final float n4, final float n5, final Class8140 class7494) {
        if (!(method23371 instanceof Class513)) {
            final float method23372 = Class9546.method35668(n4);
            final float method23373 = Class9546.method35653(Class9546.method35668(n5), -90.0f, 90.0f);
            if (class7493 != method23371.field2391) {
                method23371.method1640();
                method23371.field2452 = class7493.field10063.method20487();
                final Class399 class7495 = method23371;
                method23371 = (Class399)method23371.method1642().method23371(class7493);
                if (method23371 == null) {
                    return;
                }
            ...
            class7493.method6904().method7441(Class9105.field38571, new Class7859(new Class354(n, n2, n3)), 1, method23371.method1643());
