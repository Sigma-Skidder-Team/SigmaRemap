...
public class Class4057 extends Class3820
{
    ...
    public static void method12262(final Class51 class51, final List<Class2250> list) {
    ...
    private static Class2250 method12263(final Class2250 class2250, final int[] array) {
    ...
    private static Class2250 method12264(final int n) {
