...
public class Class3392 extends Class3167
{
    ...
    public void method10819(final Class5743 class5743) {
        ...
        if (Class3392.field15514.player.ticksExisted >= 20) {
            final int n = (int)this.method9886("Chunk Range");
            final ArrayList list = new ArrayList();
            for (int i = -4; i < 4; ++i) {
                for (int j = -4; j < 4; ++j) {
                    list.add(new Class7859(Class3392.field15514.player.chunkCoordX + i, Class3392.field15514.player.chunkCoordZ + j));
                }
            }
            final Iterator<Class8938> iterator = this.field16103.iterator();
            while (iterator.hasNext()) {
                final Class8938 class5744 = iterator.next();
                if (class5744.method31700(new Class7859(Class3392.field15514.player.chunkCoordX, Class3392.field15514.player.chunkCoordZ)) <= 7 && !this.field16104.contains(class5744.method31701())) {
                    continue;
                }
                iterator.remove();
            }
        ...
        Label_0262:
            ...
            if (n2 == 0) {
                if (Class3392.field15514.player.onGround) {
                            ...
                            (this.field16106 = new Thread(() -> {
                                ...
                                while (iterator4.hasNext()) {
                                    ...
                                    try {
                                        ...
                                        new Class8733(new Class8797(Class3392.field15514.player.method1894()));
            ...
            if (this.method9906()) {
                if (this.field16105 != null) {
                    if (this.field16106 != null) {
                        if (Class3392.field15514.player.ticksExisted % 20 == 0) {
        ...
        if (this.method9906()) {
            if (this.field16105 != null) {
                if (this.field16106 != null) {
                    ...
                    GL11.glBegin(3);
                    final float min = Math.min(1.0f, (Class3392.field15514.player.ticksExisted % 20 + Class3392.field15514.field4633.field26528) / 20.0f);
