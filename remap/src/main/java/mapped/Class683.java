...
public class Class683 extends AbstractGui
{
    ...
    public Class683(final Class572 field3729, final Minecraft field3730, final Class8863 field3731, final Class7339 field3732) {
        ...
        int max = 29 + field3730.fontRenderer.getStringWidth(this.field3732) + ((method31040 <= 1) ? 0 : (field3730.fontRenderer.getStringWidth("  ") + field3730.fontRenderer.getStringWidth("0") * length * 2 + field3730.fontRenderer.getStringWidth("/")));
        ...
        while (iterator.hasNext()) {
            max = Math.max(max, field3730.fontRenderer.getStringWidth(iterator.next()));
        }
    ...
    private List<String> method3744(final String s, final int n) {
        ...
        final int method6627 = this.field3735.fontRenderer.getStringWidth(s2 + ' ' + method6626.get(1).split(" ")[0]);
        if (method6627 - n > 10) {
            final Matcher matcher = Class683.field3728.matcher(s2);
            if (matcher.matches()) {
                final int method6628 = this.field3735.fontRenderer.getStringWidth(matcher.group(1));
                if (n - method6628 <= 10) {
    ...
    public void method3747(final int n, final int n2) {
        Label_0035: {
            ...
            this.blit(n + this.field3739 + 3, n2 + this.field3740, this.field3731.method22531().method8016(), 128 + class1999.method8019() * 26, 26, 26);
    ...
    public void method3750(final int n, final int n2, final float n3, final int n4, final int n5) {
        ...
        final int n6 = (s != null) ? this.field3735.fontRenderer.getStringWidth(s) : 0;
        ...
        this.blit(n10, n9, 0, class1999.method8019() * 26, method35642, 26);
        this.blit(n10 + method35642, n9, 200 - n8, class2000.method8019() * 26, n8, 26);
        this.blit(n + this.field3739 + 3, n2 + this.field3740, this.field3731.method22531().method8016(), 128 + class2001.method8019() * 26, 26, 26);
        if (!b) {
            this.field3735.fontRenderer.drawStringWithShadow(this.field3732, (float)(n + this.field3739 + 32), (float)(n2 + this.field3740 + 9), -1);
            if (s != null) {
                this.field3735.fontRenderer.drawStringWithShadow(s, (float)(n + this.field3739 + this.field3733 - n6 - 5), (float)(n2 + this.field3740 + 9), -1);
            }
        }
        else {
            this.field3735.fontRenderer.drawStringWithShadow(this.field3732, (float)(n10 + 5), (float)(n2 + this.field3740 + 9), -1);
            if (s != null) {
                this.field3735.fontRenderer.drawStringWithShadow(s, (float)(n + this.field3739 - n6), (float)(n2 + this.field3740 + 9), -1);
            }
        }
        if (!b2) {
    ...
    public void method3751(final int n, final int n2, final int n3, final int n4, final int n5, final int n6, final int n7, final int n8, final int n9) {
        this.blit(n, n2, n8, n9, n5, n5);
        this.method3752(n + n5, n2, n3 - n5 - n5, n5, n8 + n5, n9, n6 - n5 - n5, n7);
        this.blit(n + n3 - n5, n2, n8 + n6 - n5, n9, n5, n5);
        this.blit(n, n2 + n4 - n5, n8, n9 + n7 - n5, n5, n5);
        this.method3752(n + n5, n2 + n4 - n5, n3 - n5 - n5, n5, n8 + n5, n9 + n7 - n5, n6 - n5 - n5, n7);
        this.blit(n + n3 - n5, n2 + n4 - n5, n8 + n6 - n5, n9 + n7 - n5, n5, n5);
    ...
    public void method3752(final int n, final int n2, final int n3, final int n4, final int n5, final int n6, final int a, final int a2) {
        for (int i = 0; i < n3; i += a) {
            ...
            for (int j = 0; j < n4; j += a2) {
                this.blit(n7, n2 + j, n5, n6, min, Math.min(a2, n4 - j));
            }
        }
    }
