...
public class Class3377 extends Class3167
{
    ...
    public void method10769(final Class5743 class5743) {
        if (this.method9906()) {
            if (Class3377.field15514.player.ticksExisted > 10) {
                if (Class3377.field15514.method5285() == null) {
                    if (Class3377.field15514.method5282() != null) {
                        if (Class3377.field15514.player.method2664() / Class3377.field15514.player.method2701() * 10.0f < this.method9886("Min Health") || Class8639.method29375(Items.field31590) == 0) {
                            final boolean method9883 = this.method9883("One Time Use");
                            Class3377.field15514.world.method6751();
                            Class3377.field15514.method5264();
                            Class3377.field15514.displayGuiScreen(new Class735(new Class720(new Class548()), "disconnect.lost", new StringTextComponent("AutoLog disconnected you. " + (method9883 ? "The mod now disabled for you to reconnect." : "Disable it in a singleplayer world to reconnect."))));
                        }
                    }
                }
            }
