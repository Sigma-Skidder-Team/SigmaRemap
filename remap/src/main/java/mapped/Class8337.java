...
public class Class8337
{
    ...
    public static byte[] method27787(final String s) throws IOException {
        ...
        byte[] array;
        try {
            urlConnection = new URL(s).openConnection(Class869.method5277().method5289());
    ...
    public static String method27788(final String spec, final Map map, final byte[] b) throws IOException {
        ...
        String string;
        try {
            httpURLConnection = (HttpURLConnection)new URL(spec).openConnection(Class869.method5277().method5289());
