...
public class Class4794 extends Class4703<Class852>
{
    ...
    public void method14179(final Class852 class852, final float n, final float n2, final MatrixStack class853, final IRenderTypeBuffer class854, final int n3) {
        ...
        if (class852.field4548 != null) {
            class853.method22567();
            method14184((float)(class852.field4548.getPosX() - MathHelper.lerp(n2, class852.prevPosX, class852.getPosX())), (float)(class852.field4548.getPosY() - MathHelper.lerp(n2, class852.prevPosY, class852.getPosY())) + Class4702.method13947(class852.field4548, n2), (float)(class852.field4548.getPosZ() - MathHelper.lerp(n2, class852.prevPosZ, class852.getPosZ())), n2, class852.ticksExisted, class853, class854, n3);
            class853.method22568();
        }
