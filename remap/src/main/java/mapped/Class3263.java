...
public class Class3263 extends Class3247
{
    ...
    public int method10292(final boolean b) {
        for (int i = 36; i < 45; ++i) {
            if (Class3263.field15514.player.field3008.method10878(i).method20054()) {
                final ItemStack method20053 = Class3263.field15514.player.field3008.method10878(i).method20053();
                if (method20053 != null) {
                    if (!b) {
        ...
        for (int j = 9; j < 36; ++j) {
            if (Class3263.field15514.player.field3008.method10878(j).method20054()) {
                final ItemStack method20055 = Class3263.field15514.player.field3008.method10878(j).method20053();
                if (!b) {
