    ...
    public void method19904() {
        ...
        if (Class830.method4949(this.field26084) && this.field26084.method1706()) {
            if ((method4152 != null && method4152.getPosY() > this.field26084.getPosY()) || Class830.method4950(this.field26084)) {
                this.field26084.method1936(this.field26084.method1935().add(0.0, 0.002, 0.0));
            }
            ...
            this.field26084.method1936(this.field26084.method1935().add(method4153 * n * 0.005, method4153 * n4 * 0.1, method4153 * n3 * 0.005));
        }
        else {
            if (!this.field26084.field2404) {
                this.field26084.method1936(this.field26084.method1935().add(0.0, -0.008, 0.0));
            }
            super.method19904();
        }
    }
