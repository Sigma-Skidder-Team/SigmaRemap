...
public final class Class8405 implements Class8404
{
    ...
    private final int[] field34459;
    private final float[][][] field34460;
    private final float[][][] field34461;
    private final float[] field34462;
    private final float[][] field34463;
    private final float[][] field34464;
    private final int[] field34465;
    private final Class2341 field34466;
    private final Class8664 field34467;
    private final Class8560 field34468;
    private final Class8560 field34469;
    private final Class7037 field34470;
    private final int field34471;
    private Class9487 field34472;
    private final Class8012 field34473;
    private final Class8273[] field34474;
    private final Class8273[] field34475;
    private final int field34476;
    private int field34477;
    private int field34478;
    private final int field34479;
    private final int field34480;
    private final int field34481;
    private final int field34482;
    private final float[] field34483;
    private final float[] field34484;
    ...
    private final Class9590[] field34499;
    ...
    private void method28044(final int n, final int n2) {
        ...
        for (int i = 0; i < 576; i += 18) {
            ...
            System.arraycopy(field34133, 0 + i, this.field34492, 0, 18);
            this.method28046(this.field34492, this.field34493, n3);
            System.arraycopy(this.field34492, 0, field34133, 0 + i, 18);
            final float[][] field34134 = this.field34463;
            field34133[i] = this.field34493[0] + field34134[n][i];
            field34134[n][i] = this.field34493[18];
    ...
    public void method28046(final float[] array, final float[] array2, final int n) {
        if (n != 2) {
            ...
            for (int i = 0; i < 3; ++i) {
                ...
                final float n95 = array[i] + n93;
                final float n96 = array[i] - array[12 + i];
