...
public class Class757 extends Class756
{
    ...
    public void method4113() {
        ...
        Client.method35173().method35188().method21097(class5747);
        if (!class5747.method16962()) {
            super.method4113();
        }
    }
    ...
    public void pushOutOfBlocks(final double n, final double n2, final double n3) {
        ...
        Client.method35173().method35188().method21097(class5713);
    ...
    public void method1659() {
        ...
        Client.method35173().method35188().method21097(class5743);
        if (class5743.method16962()) {
            return;
        }
        super.method1659();
    }
    ...
    public void method2738() {
        super.method2738();
        Client.method35173().method35188().method21097(new Class5742());
    }
