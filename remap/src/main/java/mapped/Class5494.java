...
public class Class5494
{
    ...
    private static void method16769(final DataFixerBuilder dataFixerBuilder) {
        ...
        dataFixerBuilder.addFixer(new Class8481(dataFixerBuilder.addSchema(501, (BiFunction)Class7697::new), "Add 1.10 entities fix", Class9451.field40626));
        ...
        dataFixerBuilder.addFixer(new Class8481(dataFixerBuilder.addSchema(808, (BiFunction)Class5177::new), "added shulker box", Class9451.field40621));
        ...
        dataFixerBuilder.addFixer(new Class8481(dataFixerBuilder.addSchema(1451, (BiFunction)Class5182::new), "AddTrappedChestFix", Class9451.field40621));
        ...
        dataFixerBuilder.addFixer(new Class8481(addSchema7, "RemoveNoteBlockFlowerPotFix", Class9451.field40621));
        ...
        dataFixerBuilder.addFixer(new Class8481(dataFixerBuilder.addSchema(1470, (BiFunction)Class5185::new), "Add 1.13 entities fix", Class9451.field40626));
        ...
        dataFixerBuilder.addFixer(new Class8481(dataFixerBuilder.addSchema(1481, (BiFunction)Class5200::new), "Add conduit", Class9451.field40621));
        ...
        dataFixerBuilder.addFixer(new Class8481(addSchema20, "Added 1.14 mobs fix", Class9451.field40626));
        ...
        dataFixerBuilder.addFixer(new Class8481(dataFixerBuilder.addSchema(1801, (BiFunction)Class5197::new), "Added Illager Beast", Class9451.field40626));
        ...
        dataFixerBuilder.addFixer(new Class8481(addSchema22, "Added Cats", Class9451.field40626));
        ...
        dataFixerBuilder.addFixer(new Class8481(dataFixerBuilder.addSchema(1906, (BiFunction)Class5179::new), "Add POI Blocks", Class9451.field40621));
        dataFixerBuilder.addFixer(new Class8481(dataFixerBuilder.addSchema(1909, (BiFunction)Class5199::new), "Add jigsaw", Class9451.field40621));
        ...
        dataFixerBuilder.addFixer(new Class8481(addSchema24, "Add campfire", Class9451.field40621));
        ...
        dataFixerBuilder.addFixer(new Class8481(dataFixerBuilder.addSchema(1929, (BiFunction)Class5184::new), "Add Wandering Trader and Trader Llama", Class9451.field40626));
        dataFixerBuilder.addFixer(new Class8481(dataFixerBuilder.addSchema(1931, (BiFunction)Class5196::new), "Added Fox", Class9451.field40626));
        ...
        dataFixerBuilder.addFixer(new Class8481(addSchema27, "Added Bee and Bee Stinger", Class9451.field40626));
        dataFixerBuilder.addFixer(new Class8481(addSchema27, "Add beehive", Class9451.field40621));
