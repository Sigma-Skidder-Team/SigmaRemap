...
public class Class4916 extends Class4825
{
    ...
    public void method14758() {
        ...
        GL11.glTranslatef((float)(-this.method14272() - 76), (float)(-this.method14274() - 44), 0.0f);
        Class8154.method26889(ClientFonts.JelloMedium25, (float)(this.field20478 + 94), (float)(this.field20479 + 16), this.field21026.field41612.equals("Minecraft Server") ? (this.field21026.field41613.substring(0, 1).toUpperCase() + this.field21026.field41613.substring(1, this.field21026.field41613.length())) : this.field21026.field41612, Class6430.method19118(Class265.field1278.field1292, 0.9f));
        final int n3 = 94;
        final int n4 = 46;
        if (this.field21025.method30981().getTime() != 9223372036854775806L) {
            if (n > 0L && this.field21025.method30981().getTime() != Long.MAX_VALUE) {
                Class8154.method26889(ClientFonts.JelloLight18, (float)(this.field20478 + n3), (float)(this.field20479 + n4), "Unban: " + l + " days, " + k + "h " + j + "m " + i + "s", Class6430.method19120(Class265.field1273.field1292, Class265.field1278.field1292, 0.2f));
            }
            else if (this.field21025.method30981().getTime() != Long.MAX_VALUE) {
                Class8154.method26889(ClientFonts.JelloLight18, (float)(this.field20478 + n3), (float)(this.field20479 + n4), "Unbanned!", Class6430.method19120(Class265.field1276.field1292, Class265.field1278.field1292, 0.3f));
            }
            else {
                Class8154.method26889(ClientFonts.JelloLight18, (float)(this.field20478 + n3), (float)(this.field20479 + n4), "Permanently banned!", Class6430.method19120(Class265.field1283.field1292, Class265.field1278.field1292, 0.3f));
            }
        }
        else {
            Class8154.method26889(ClientFonts.JelloLight18, (float)(this.field20478 + n3), (float)(this.field20479 + n4), "Compromised ban (unbannable)!", Class6430.method19120(Class265.field1284.field1292, Class265.field1278.field1292, 0.3f));
        }
        GL11.glPopMatrix();
        Class8154.method26872();
    }
