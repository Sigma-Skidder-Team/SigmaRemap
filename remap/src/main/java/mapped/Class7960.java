...
public class Class7960 implements Class7954
{
    ...
    public Class9017 method25804(final Entity class399, final Random random) {
        return new Class9017(new ItemStack(Class7739.field31514, this.field32705), new ItemStack(this.field32703.method27622(), this.field32704), new ItemStack(this.field32706.method27622(), this.field32707), this.field32708, this.field32709, this.field32710);
    }
}
