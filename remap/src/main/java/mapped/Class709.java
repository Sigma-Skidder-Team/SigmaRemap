...
public class Class709 extends Class703
{
    ...
    public void init() {
        final int n = 0;
        this.addButton(new Class666(this.minecraft, this.width / 2 - 155 + n % 2 * 160, this.height / 6 - 12 + 24 * (n >> 1), Class286.field1578, 310));
        int n2 = n + 2;
        ...
        this.addButton(new Class654(this.width / 2 - 100, this.height / 6 + 168, 200, 20, Class8822.method30773("gui.done", new Object[0]), class654 -> this.minecraft.displayGuiScreen(this.field3868)));
    }
