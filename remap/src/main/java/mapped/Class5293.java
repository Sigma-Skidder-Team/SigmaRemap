...
public class Class5293 extends Class5291
{
    private static String[] field22347;
    
    public Class7276 method16427(final ByteBuf byteBuf) throws Exception {
        final short unsignedByte = byteBuf.readUnsignedByte();
        if (unsignedByte != 255) {
            final Class1966 method7967 = Class1966.method7967(byteBuf.readByte());
            return new Class7276(unsignedByte, method7967, method7967.method7969().method16378(byteBuf));
        }
        return null;
    }
