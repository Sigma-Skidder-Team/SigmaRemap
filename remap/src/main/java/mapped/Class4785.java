...
public abstract class Class4785<T extends Class402> extends Class4703<T>
{
    ...
    public void method14152(final T t, final float n, final float n2, final MatrixStack class7351, final IRenderTypeBuffer class7352, final int n3) {
        ...
        final Class8996 method25215 = class7351.getLast();
        final Matrix4f method25216 = method25215.getMatrix();
    ...
    public void method14153(final Matrix4f class6789, final Matrix3f class6790, final Class4150 class6791, final int n, final int n2, final int n3, final float n4, final float n5, final int n6, final int n7, final int n8, final int n9) {
        class6791.pos(class6789, (float)n, (float)n2, (float)n3).method12399(255, 255, 255, 255).tex(n4, n5).method12441(Class1904.field10335).method12440(n9).method12445(class6790, (float)n6, (float)n8, (float)n7).endVertex();
    }
}
