            ...
            switch (lowerCase) {
                case "add": {
                    ...
                    if (Pattern.compile("[a-zA-Z0-9_]{2,16}").matcher(array[1].method26314()).matches()) {
                        if (!Client.getInstance().getFriendManager().method29883(array[1].method26314())) {
                ...
                case "remove": {
                    ...
                    if (!Client.getInstance().getFriendManager().method29887(array[1].method26314())) {
                ...
                case "list": {
                    final List<String> method29885 = Client.getInstance().getFriendManager().method29885();
                ...
                case "clear": {
                    if (Client.getInstance().getFriendManager().method29889()) {
