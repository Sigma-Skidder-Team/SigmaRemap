...
public class Class5316 extends Class5260<Class8087>
{
    public Class5316() {
    ...
    public Class8087 method16443(final ByteBuf byteBuf) throws Exception {
        ...
        switch (intValue) {
            ...
            case 27: {
                class8087.method26550().add(new Class9348(Class5260.field22333, Class5260.field22333.method16378(byteBuf)));
                break;
            }
        }
        return class8087;
