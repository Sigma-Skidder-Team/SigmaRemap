...
public class Class4889 extends Panel
{
    ...
    public Class4889(final CustomGuiScreen customGuiScreen, final String s, final int n, final int n2) {
        ...
        this.field20899 = new Animation(300, 100);
        this.method14301(true);
        this.setListening(false);
        final UIButton class4804;
        this.addToList(class4804 = new UIButton(this, "addButton", this.field20480 - 55, 0, ClientFonts.JelloLight25.getWidth("Add"), 69, ColorHelper.field25964, "+", ClientFonts.JelloLight25));
        class4804.doThis((class4803, n) -> this.field20901.method14706(true));
        this.addToList(this.field20901 = new Class4898(this, "profile", 0, 69, this.field20480, 200));
    ...
    public void method14640() {
        ...
        ((Class4801)this.getParent()).method14209();
    }
