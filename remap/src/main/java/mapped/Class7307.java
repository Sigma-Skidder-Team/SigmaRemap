    ...
    public static boolean method22413(final Class7304<?> class7304, final Class1860 class7305, final BitSet set, final Random random, final Class385 class7306, final int n, final int n2, final int n3, final int n4, final int n5, final int n6, final int n7, final int n8) {
        ...
        if (n7 == 10) {
            if (random.nextFloat() >= 0.25) {
                class7305.method7008(class7306, Class7521.field29286.method11878(), false);
            }
            else {
                class7305.method7008(class7306, Class7521.field29642.method11878(), false);
                class7305.method7036().method21345(class7306, Class7521.field29642, 0);
            }
            return true;
        }
        if (n7 < 10) {
            class7305.method7008(class7306, Class7521.field29174.method11878(), false);
            return false;
        }
        int n10 = 0;
