...
public class Class6886 implements ArgumentType<Class9043>
{
    ...
    public static Entity method21144(final CommandContext<Class7492> commandContext, final String s) throws CommandSyntaxException {
        return ((Class9043)commandContext.getArgument(s, (Class)Class9043.class)).method32510(commandContext.getSource());
    }
    ...
    public static Collection<? extends Entity> method21147(final CommandContext<Class7492> commandContext, final String s) throws CommandSyntaxException {
        return ((Class9043)commandContext.getArgument(s, (Class)Class9043.class)).method32511(commandContext.getSource());
    }
    ...
    public static Collection<Class513> method21148(final CommandContext<Class7492> commandContext, final String s) throws CommandSyntaxException {
        return ((Class9043)commandContext.getArgument(s, (Class)Class9043.class)).method32514(commandContext.getSource());
    }
    ...
    public static Class513 method21150(final CommandContext<Class7492> commandContext, final String s) throws CommandSyntaxException {
        return ((Class9043)commandContext.getArgument(s, (Class)Class9043.class)).method32513(commandContext.getSource());
    }
    ...
    public static Collection<Class513> method21152(final CommandContext<Class7492> commandContext, final String s) throws CommandSyntaxException {
        final List<Class513> method32514 = ((Class9043)commandContext.getArgument(s, (Class)Class9043.class)).method32514(commandContext.getSource());
    ...
    public Class9043 parse(final StringReader stringReader) throws CommandSyntaxException {
            ...
            if (method25070.method32506()) {
                if (this.field27008) {
                    if (!method25070.method32507()) {
                        ...
                        throw Class6886.field27003.createWithContext(stringReader);
                    }
                }
            }
            return method25070;
        ...
        if (!this.field27008) {
            stringReader.setCursor(0);
            throw Class6886.field27001.createWithContext(stringReader);
        }
        stringReader.setCursor(0);
        throw Class6886.field27002.createWithContext(stringReader);
    }
    ...
    public <S> CompletableFuture<Suggestions> listSuggestions(final CommandContext<S> commandContext, final SuggestionsBuilder suggestionsBuilder) {
        if (commandContext.getSource() instanceof Class7491) {
            ...
            return class7793.method25081(suggestionsBuilder, suggestionsBuilder2 -> {
                ...
                Class7491.method23226(this.field27008 ? collection : Iterables.concat(collection, (Iterable)class7794.method23206()), suggestionsBuilder2);
            });
        }
    ...
    static {
        ...
        field27001 = new SimpleCommandExceptionType(new Class2259("argument.entity.toomany", new Object[0]));
        field27002 = new SimpleCommandExceptionType(new Class2259("argument.player.toomany", new Object[0]));
        field27003 = new SimpleCommandExceptionType(new Class2259("argument.player.entities", new Object[0]));
        field27004 = new SimpleCommandExceptionType(new Class2259("argument.entity.notfound.entity", new Object[0]));
        field27005 = new SimpleCommandExceptionType(new Class2259("argument.entity.notfound.player", new Object[0]));
        field27006 = new SimpleCommandExceptionType(new Class2259("argument.entity.selector.not_allowed", new Object[0]));
    }
}
