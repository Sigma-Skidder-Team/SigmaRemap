...
public class Class1783 extends Class1779
{
    ...
    private Map<Class1932, Class122> field9894;
    
    public Class1783() {
        super(Class1783.field9893, "predicates");
        this.field9894 = (Map<Class1932, Class122>)ImmutableMap.of();
    }
    
    @Nullable
    public Class122 method6409(final Class1932 class1932) {
    ...
    public void method6377(final Map<Class1932, JsonObject> map, final Class6582 class6582, final IProfiler class6583) {
        ...
        this.field9894 = (Map<Class1932, Class122>)build;
    }
    
    public Set<Class1932> method6410() {
        return Collections.unmodifiableSet((Set<? extends Class1932>)this.field9894.keySet());
    }
