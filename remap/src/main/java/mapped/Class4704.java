...
public class Class4704 extends Class4703<Class423>
{
    ...
    public void method13964(final Class423 class423, final float n, final float n2, final Class7351 class424, final Class7807 class425, final int n3) {
        ...
        class424.method22566(Class9138.field38718.method33328(180.0f - n));
        ...
        if (n4 > 0.0f) {
            class424.method22566(Class9138.field38716.method33328(Class9546.method35638(n4) * n4 * n5 / 10.0f * class423.method2063()));
        }
        if (!Class9546.method35662(class423.method2061(n2), 0.0f)) {
            class424.method22566(new Class9389(new Class9138(1.0f, 0.0f, 1.0f), class423.method2061(n2), true));
        }
        class424.method22565(-1.0f, -1.0f, 1.0f);
        class424.method22566(Class9138.field38718.method33328(90.0f));
