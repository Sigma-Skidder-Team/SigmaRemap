            ...
            if (class7097.getBlockState(method1134).method21706()) {
                if (!class7097.isRemote) {
                    ...
                    for (int j = 0; j < 128; ++j) {
                        ...
                        class7097.method6709(Class8432.field34637, MathHelper.method35701(nextDouble, method1134.getX(), class7098.getX()) + (class7097.rand.nextDouble() - 0.5) + 0.5, MathHelper.method35701(nextDouble, method1134.getY(), class7098.getY()) + class7097.rand.nextDouble() - 0.5, MathHelper.method35701(nextDouble, method1134.getZ(), class7098.getZ()) + (class7097.rand.nextDouble() - 0.5) + 0.5, (class7097.rand.nextFloat() - 0.5f) * 0.2f, (class7097.rand.nextFloat() - 0.5f) * 0.2f, (class7097.rand.nextFloat() - 0.5f) * 0.2f);
                    }
                }
                return;
            }
