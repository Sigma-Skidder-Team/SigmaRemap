...
public class Class3602 extends Class3446
{
    ...
    public void method11016() {
        ...
        if (method2634 != null) {
            ...
            final Class7096 method2635 = this.field16778.field2391.method6701(new BlockPos(this.field16778.getPosX() + class5487.x, this.field16778.getPosY() + class5487.y, this.field16778.getPosZ() + class5487.z));
            if (this.field16778.field2391.method6702(new BlockPos(this.field16778.getPosX() + class5487.x, this.field16778.getPosY() + class5487.y, this.field16778.getPosZ() + class5487.z)).method21793(Class7324.field28319) || method2635.method21706()) {
            ...
            if (this.field16777 % 10 == 5) {
                this.field16778.field2391.method6709(Class8432.field34601, this.field16778.getPosX(), this.field16778.getPosY(), this.field16778.getPosZ(), 0.0, 0.0, 0.0);
            }
        }
    }
}
