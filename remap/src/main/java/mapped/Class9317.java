...
public class Class9317
{
    ...
    private final BiFunction<Class8321, Class7529, Class8321> field40014;
    ...
    public static Consumer<Class8321> method34482(final Consumer<Class8321> consumer) {
        return class8321 -> {
    ...
    public void method34483(final Class7529 class7529, final Consumer<Class8321> consumer) {
        if (!class7529.method23580(this)) {
            Class9317.field40008.warn("Detected infinite loop in loot tables");
        }
        else {
            final Consumer<Class8321> method637 = Class125.method637(this.field40014, consumer, class7529);
    ...
    public void method34484(final Class7529 class7529, final Consumer<Class8321> consumer) {
        this.method34483(class7529, method34482(consumer));
    }
    
    public List<Class8321> method34485(final Class7529 class7529) {
        final ArrayList arrayList = Lists.newArrayList();
        this.method34484(class7529, (Consumer<Class8321>)arrayList::add);
        return arrayList;
    }
    ...
    public void method34488(final Class446 class446, final Class7529 class447) {
        final List<Class8321> method34485 = this.method34485(class447);
        ...
        for (final Class8321 class448 : method34485) {
            ...
            if (!class448.method27620()) {
                ...
                class446.method2160((int)method34487.remove(method34487.size() - 1), Class8321.field34174);
            }
        }
    }
    
    private void method34489(final List<Class8321> list, final int n, final Random rnd) {
        final ArrayList arrayList = Lists.newArrayList();
        final Iterator iterator = list.iterator();
        while (iterator.hasNext()) {
            final Class8321 class8321 = (Class8321)iterator.next();
