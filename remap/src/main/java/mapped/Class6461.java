...
public class Class6461 implements Class6459
{
    ...
    public Class6461(final int n) {
        ...
        this.field25677 = n + ChunkStatus.method34440();
    ...
    public ChunkStatus method19327(final int n, final int n2) {
        return (ChunkStatus)this.field25674.get(Class7859.method25423(n + this.field25675.field32290 - this.field25677, n2 + this.field25675.field32291 - this.field25677));
    }
}
