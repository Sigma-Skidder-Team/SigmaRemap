...
public class Class4173 extends Class4158<Class463>
{
    ...
    public void method12496(final Class463 class463, final float n, final Class7351 class464, final Class7807 class465, final int n2, final int n3) {
        ...
        class464.method22564(0.0, 0.1f + Class9546.method35638(n4 * 0.1f) * 0.01f, 0.0);
        float n5;
        for (n5 = class463.field2734 - class463.field2735; n5 >= 3.1415927f; n5 -= 6.2831855f) {}
        while (n5 < -3.1415927f) {
            n5 += 6.2831855f;
        }
        class464.method22566(Class9138.field38718.method33327(-(class463.field2735 + n5 * n)));
        class464.method22566(Class9138.field38720.method33328(80.0f));
        final float method35700 = Class9546.method35700(n, class463.field2729, class463.field2728);
        this.field18590.method17788(n4, Class9546.method35653(Class9546.method35686(method35700 + 0.25f) * 1.6f - 0.3f, 0.0f, 1.0f), Class9546.method35653(Class9546.method35686(method35700 + 0.75f) * 1.6f - 0.3f, 0.0f, 1.0f), Class9546.method35700(n, class463.field2733, class463.field2732));
