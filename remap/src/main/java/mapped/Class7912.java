...
public class Class7912 extends Class7909<Class3820>
{
    private static String[] field32489;
    private int field32490;
    private Class7909<Class3820> field32491;
    ...
    public boolean method25624(final Class3820 class3820) {
    ...
    @Override
    public Collection<Class3820> method25616() {
        if (this.field32490 != Class7855.method25405()) {
            this.field32491 = Class7855.method25406().method18461(this.method25621());
            this.field32490 = Class7855.method25405();
        }
    ...
    @Override
    public Collection<Class6967<Class3820>> method25617() {
        if (this.field32490 != Class7855.method25405()) {
            this.field32491 = Class7855.method25406().method18461(this.method25621());
            this.field32490 = Class7855.method25405();
        }
