...
public class Class8641
{
    ...
    private static int method29386(final Class7492 class7492, final Collection<Class8263> collection) {
        ...
        if (collection.size() != 1) {
            class7492.method23257(new Class2259("commands.function.success.multiple", n, collection.size()), true);
        }
        else {
            class7492.method23257(new Class2259("commands.function.success.single", n, collection.iterator().next().method27443()), true);
        }
        return n;
    }
    ...
    static {
        field36242 = ((commandContext, suggestionsBuilder) -> {
            final Class1794 method1567 = commandContext.getSource().method23255().method1567();
