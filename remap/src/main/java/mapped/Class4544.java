...
public class Class4544 extends Class4535<Class5122>
{
    ...
    public boolean method13535(final Class1851 class1851, final Class6346<? extends Class7065> class1852, final Random random, final BlockPos class1853, final Class5122 class1854) {
        ...
        if (class1851.getBlockState(method1137).getBlock() == Blocks.field29173) {
            final BlockState method1138 = Blocks.KELP.getDefaultState();
            final BlockState method1139 = Blocks.KELP_PLANT.getDefaultState();
            for (int n2 = 1 + random.nextInt(10), i = 0; i <= n2; ++i) {
                Label_0134: {
                    if (class1851.getBlockState(method1137).getBlock() == Blocks.field29173) {
                        if (class1851.getBlockState(method1137.method1137()).getBlock() == Blocks.field29173) {
                    ...
                    if (i > 0) {
                        ...
                        if (class1851.getBlockState(method1140.method1139()).getBlock() == Blocks.KELP) {
                            break;
                        }
