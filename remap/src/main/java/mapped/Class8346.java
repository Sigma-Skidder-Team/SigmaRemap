...
public class Class8346
{
    ...
    public static Iterator<Class8974> method27814(final ClientWorld clientWorld, final double n, final Entity class1849, final int n2, final Class9112 class1850) {
        ...
        if (method33913 > 0.0f && method33913 < (n2 - 1) * 16) {
            ...
            final float method33914 = clientWorld.method6713((float)n);
