...
public class Class4804 extends CustomGuiScreen
{
    ...
    public void method14200(final int field20519, final int field20520) {
        ...
        if (this.field20515 + this.field20480 >= 0.0f) {
            ...
            this.field20515 = (float) Minecraft.getInstance().window.method7694();
        }
        if (this.field20516 + this.field20481 >= 0.0f) {
            ...
            this.field20516 = (float) Minecraft.getInstance().window.method7695();
        }
    ...
    public void draw(final float partialTicks) {
        RenderUtil.method26886((float)this.x, (float)this.y, (float)this.method14276(), AllUtils.applyAlpha(ClientColors.LIGHT_GREYISH_BLUE.color, 0.07f + ((this.field20517 <= 0.0f) ? 0.0f : (this.field20517 * 0.3f))));
