...
public final class Class6815 implements Class6814
{
    public final Class8674 field26758;
    
    public Class6815(final Class8674 field26758) {
        this.field26758 = field26758;
    }
    
    @Override
    public Class1753 method20856(final Class8711 class8711) throws IOException {
        final Class1753 class8712 = (this.field26758 != null) ? this.field26758.method29705(class8711.method29905()) : null;
        final Class8016 method32937 = new Class9108(System.currentTimeMillis(), class8711.method29905(), class8712).method32937();
        final Class8596 field33021 = method32937.field33021;
        final Class1753 field33022 = method32937.field33022;
        ...
        Class1753 method32938 = null;
        try {
            method32938 = class8711.method29906(field33021);
        }
        finally {
        ...
        if (field33022 != null) {
            if (method32938.method6188() == 304) {
                final Class1753 method32939 = field33022.method6198().method33603(method20860(field33022.method6195(), method32938.method6195())).method33610(method32938.method6205()).method33611(method32938.method6206()).method33606(method20858(field33022)).method33605(method20858(method32938)).method33612();
        ...
        final Class1753 method32940 = method32938.method6198().method33606(method20858(field33022)).method33605(method20858(method32938)).method33612();
        if (this.field26758 != null) {
    ...
    private static Class1753 method20858(final Class1753 class1753) {
        return (class1753 != null && class1753.method6197() != null) ? class1753.method6198().method33604(null).method33612() : class1753;
    }
    
    private Class1753 method20859(final Class6050 class6050, final Class1753 class6051) throws IOException {
        if (class6050 == null) {
            return class6051;
        }
