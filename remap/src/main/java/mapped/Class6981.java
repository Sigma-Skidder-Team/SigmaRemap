...
public class Class6981 extends Class6977
{
    ...
    public Set<Class9488> method21398(final BlockPos class354, final BlockState class355, final Class7614 class356) {
        ...
        final BlockState method6701 = Minecraft.method5277().world.getBlockState(class354);
    ...
    public Set<Class9488> method21399(final BlockPos field27548, final BlockState class7096, final Class7614 class7097) {
        final HashSet set = new HashSet();
        final Class7074 class7098 = new Class7074(this.field27275.world, this.field27275.field4684, Class316.field1877, new ItemStack(class7096.getBlock()), new BlockRayTraceResult(new Vec3d(0.0, 0.0, 0.0), Direction.UP, field27548, false));
