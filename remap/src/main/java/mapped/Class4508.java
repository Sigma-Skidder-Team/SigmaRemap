...
public class Class4508 extends Class4500
{
    ...
    public boolean method13421(final Class1851 class1851, final Class6346<?> class1852, final Random random, final MutableBoundingBox class1853, final ChunkPos class1854) {
        ...
        this.method13444(class1851, class1853, 1, 1, 1, 1, 1, 3, Blocks.field29174.getDefaultState(), Blocks.field29174.getDefaultState(), false);
        this.method13444(class1851, class1853, 9, 1, 1, 9, 1, 3, Blocks.field29174.getDefaultState(), Blocks.field29174.getDefaultState(), false);
        this.method13445(class1851, class1853, 3, 1, 8, 7, 1, 12, false, random, Class6924.method21296());
        this.method13444(class1851, class1853, 4, 1, 9, 6, 1, 11, Blocks.field29174.getDefaultState(), Blocks.field29174.getDefaultState(), false);
        final BlockState class1855 = ((StateHolder<O, BlockState>)((StateHolder<O, BlockState>) Blocks.field29381.getDefaultState()).with((IProperty<Comparable>)Class3853.field17465, true)).with((IProperty<Comparable>)Class3853.field17467, true);
        final BlockState class1856 = ((StateHolder<O, BlockState>)((StateHolder<O, BlockState>) Blocks.field29381.getDefaultState()).with((IProperty<Comparable>)Class3853.field17468, true)).with((IProperty<Comparable>)Class3853.field17466, true);
        ...
        final BlockState class1857 = ((StateHolder<O, BlockState>) Blocks.field29391.getDefaultState()).with((IProperty<Comparable>)Class3916.field17732, Direction.NORTH);
        ...
        final BlockState class1858 = ((StateHolder<O, BlockState>) Blocks.field29402.getDefaultState()).with((IProperty<Comparable>)Class3964.field17908, Direction.NORTH);
        final BlockState class1859 = ((StateHolder<O, BlockState>) Blocks.field29402.getDefaultState()).with((IProperty<Comparable>)Class3964.field17908, Direction.SOUTH);
        final BlockState class1860 = ((StateHolder<O, BlockState>) Blocks.field29402.getDefaultState()).with((IProperty<Comparable>)Class3964.field17908, Direction.EAST);
        final BlockState class1861 = ((StateHolder<O, BlockState>) Blocks.field29402.getDefaultState()).with((IProperty<Comparable>)Class3964.field17908, Direction.WEST);
        boolean b = true;
        ...
        if (b) {
            final BlockState method11878 = Blocks.field29401.getDefaultState();
        ...
        if (!this.field19906) {
            ...
            if (class1853.isVecInside(class1862)) {
                ...
                class1851.setBlockState(class1862, Blocks.SPAWNER.getDefaultState(), 2);
