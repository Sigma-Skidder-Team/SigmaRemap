    ...
    private void method9934(final boolean b) {
        for (final Entity class399 : Class3171.field15514.field4683.method6806()) {
            if (!Class9463.method35173().method35191().method31751(class399)) {
                ...
                final Class7644 method9886 = new Class7644(class399.getBoundingBox().method18499((class399.posX - class399.lastTickPosX) * Class3171.field15514.field4633.field26528 - (class399.posX - class399.lastTickPosX), (class399.posY - class399.lastTickPosY) * Class3171.field15514.field4633.field26528 - (class399.posY - class399.lastTickPosY), (class399.posZ - class399.lastTickPosZ) * Class3171.field15514.field4633.field26528 - (class399.posZ - class399.lastTickPosZ))).method24204(0.10000000149011612);
                if (b) {
