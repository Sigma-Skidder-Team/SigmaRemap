...
public class Class7114<T extends Enum<T> & Class103> extends Class7110<T>
{
    ...
    public Class7114(final String s, final Class<T> clazz, final Collection<T> collection) {
        ...
        for (final Enum<T> & Class103 enum1 : collection) {
            final String method596 = ((T)enum1).method596();
    ...
    public static <T extends Enum<T> & Class103> Class7114<T> method21837(final String s, final Class<T> clazz) {
        return method21838(s, clazz, (Predicate<T>)Predicates.alwaysTrue());
    }
    
    public static <T extends Enum<T> & Class103> Class7114<T> method21838(final String s, final Class<T> clazz, final Predicate<T> predicate) {
    ...
    public static <T extends Enum<T> & Class103> Class7114<T> method21839(final String s, final Class<T> clazz, final T... array) {
        return method21840(s, clazz, Lists.newArrayList((Object[])array));
    }
    
    public static <T extends Enum<T> & Class103> Class7114<T> method21840(final String s, final Class<T> clazz, final Collection<T> collection) {
