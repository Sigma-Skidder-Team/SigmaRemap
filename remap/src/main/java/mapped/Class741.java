...
{
    private static final ResourceLocation field4011;
    ...
    public void method2976(final float n, final int n2, final int n3) {
        ...
        this.minecraft.method5290().method5849(Class741.field4011);
        this.method3186((this.width - this.field3075) / 2, (this.height - this.field3076) / 2, 0, 0, this.field3075, this.field3076);
    }
    
    static {
        field4011 = new ResourceLocation("textures/gui/container/hopper.png");
    }
}
