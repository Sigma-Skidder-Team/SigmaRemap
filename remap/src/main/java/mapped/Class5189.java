...
public class Class5189 extends Class5174
{
    ...
    public Map<String, Supplier<TypeTemplate>> registerEntities(final Schema schema) {
        ...
        schema.register(hashMap, "minecraft:arrow", p1 -> DSL.optionalFields("inTile", Class9451.field40627.in(schema2)));
        ...
        schema.register(hashMap, "minecraft:chest_minecart", p1 -> DSL.optionalFields("DisplayTile", Class9451.field40627.in(schema3), "Items", DSL.list(Class9451.field40622.in(schema3))));
        method16177(schema, hashMap, "minecraft:chicken");
        schema.register(hashMap, "minecraft:commandblock_minecart", p1 -> DSL.optionalFields("DisplayTile", Class9451.field40627.in(schema4)));
        ...
        schema.register(hashMap, "minecraft:enderman", p1 -> DSL.optionalFields("carried", Class9451.field40627.in(schema6), Class9478.method35286(schema6)));
        ...
        schema.register(hashMap, "minecraft:falling_block", p1 -> DSL.optionalFields("Block", Class9451.field40627.in(schema7), "TileEntityData", Class9451.field40621.in(schema7)));
        ...
        schema.register(hashMap, "minecraft:furnace_minecart", p1 -> DSL.optionalFields("DisplayTile", Class9451.field40627.in(schema9)));
        ...
        schema.register(hashMap, "minecraft:hopper_minecart", p1 -> DSL.optionalFields("DisplayTile", Class9451.field40627.in(schema10), "Items", DSL.list(Class9451.field40622.in(schema10))));
        ...
        schema.register(hashMap, "minecraft:minecart", p1 -> DSL.optionalFields("DisplayTile", Class9451.field40627.in(schema14)));
        method16177(schema, hashMap, "minecraft:mooshroom");
        schema.register(hashMap, "minecraft:mule", p1 -> DSL.optionalFields("Items", DSL.list(Class9451.field40622.in(schema15)), "SaddleItem", Class9451.field40622.in(schema15), Class9478.method35286(schema15)));
        ...
        schema.register(hashMap, "minecraft:potion", p1 -> DSL.optionalFields("Potion", Class9451.field40622.in(schema16), "inTile", Class9451.field40627.in(schema16)));
        ...
        schema.register(hashMap, "minecraft:skeleton_horse", p1 -> DSL.optionalFields("SaddleItem", Class9451.field40622.in(schema17), Class9478.method35286(schema17)));
        ...
        schema.register(hashMap, "minecraft:spawner_minecart", p1 -> DSL.optionalFields("DisplayTile", Class9451.field40627.in(schema18), Class9451.field40629.in(schema18)));
        schema.register(hashMap, "minecraft:spectral_arrow", p1 -> DSL.optionalFields("inTile", Class9451.field40627.in(schema19)));
        ...
        schema.register(hashMap, "minecraft:tnt_minecart", p1 -> DSL.optionalFields("DisplayTile", Class9451.field40627.in(schema20)));
        schema.register(hashMap, "minecraft:villager", p1 -> DSL.optionalFields("Inventory", DSL.list(Class9451.field40622.in(schema21)), "Offers", DSL.optionalFields("Recipes", DSL.list(DSL.optionalFields("buy", Class9451.field40622.in(schema21), "buyB", Class9451.field40622.in(schema21), "sell", Class9451.field40622.in(schema21)))), Class9478.method35286(schema21)));
        ...
        schema.register(hashMap, "minecraft:zombie_horse", p1 -> DSL.optionalFields("SaddleItem", Class9451.field40622.in(schema22), Class9478.method35286(schema22)));
        ...
        schema.register(hashMap, "minecraft:llama", p1 -> DSL.optionalFields("Items", DSL.list(Class9451.field40622.in(schema23)), "SaddleItem", Class9451.field40622.in(schema23), "DecorItem", Class9451.field40622.in(schema23), Class9478.method35286(schema23)));
