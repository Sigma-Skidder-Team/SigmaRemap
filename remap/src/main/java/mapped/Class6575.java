...
public class Class6575 extends Class6564
{
    ...
    public void method19904() {
        if (this.field26097.method1720(Class7324.field28319)) {
            this.field26097.method1936(this.field26097.getMotion().add(0.0, 0.005, 0.0));
        }
        if (this.field26073 == Class2198.field13376 && !this.field26097.method4150().method24731()) {
            final double n = this.field26067 - this.field26097.getPosX();
            final double n2 = this.field26068 - this.field26097.getPosY();
            final double n3 = this.field26069 - this.field26097.getPosZ();
            final double n4 = n2 / MathHelper.sqrt(n * n + n2 * n2 + n3 * n3);
            this.field26097.rotationYaw = this.method19909(this.field26097.rotationYaw, (float)(MathHelper.method35693(n3, n) * 57.2957763671875) - 90.0f, 90.0f);
            this.field26097.field2951 = this.field26097.rotationYaw;
            ...
            this.field26097.method1936(this.field26097.getMotion().add(0.0, this.field26097.method2732() * n4 * 0.1, 0.0));
        }
        else {
