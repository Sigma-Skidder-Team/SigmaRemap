...
public class Class9592
{
    ...
    private float method35976(final Class2113 class2113, final long n, final long n2, final float n3) {
        if (class2113 != Class2113.field12290) {
            ...
            final float n5 = MathHelper.clamp((n - 72000.0f) / 1440000.0f, 0.0f, 1.0f) * 0.25f;
            final float n6 = n4 + n5;
            float n7 = 0.0f + MathHelper.clamp(n2 / 3600000.0f, 0.0f, 1.0f) * (b ? 1.0f : 0.75f) + MathHelper.clamp(n3 * 0.25f, 0.0f, n5);
