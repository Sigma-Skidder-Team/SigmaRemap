...
public class JelloChatMessages extends Panel {
    public Class4824 field20756;

    public JelloChatMessages(final CustomGuiScreen customGuiScreen, final String s, final int n, final int n2, final int n3, final int n4) {
