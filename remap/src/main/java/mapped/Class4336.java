...
public class Class4336 implements IPacket<Class5813>
{
    ...
    public Class4336(final Entity class399, final Class287 field19416, final int field19417) {
        this.field19415 = class399.getEntityId();
    ...
    public void readPacketData(final PacketBuffer class8654) throws IOException {
        this.field19415 = class8654.readVarInt();
        this.field19416 = class8654.method29499(Class287.class);
        this.field19417 = class8654.readVarInt();
    }
    
    @Override
    public void writePacketData(final PacketBuffer class8654) throws IOException {
        class8654.writeVarInt(this.field19415);
        class8654.method29500(this.field19416);
        class8654.writeVarInt(this.field19417);
    }
