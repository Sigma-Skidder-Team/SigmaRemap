...
public abstract class Class5509
{
    ...
    public Class5509(final Class5412 class5412, final String s, final float n) {
        this((Class8651<EntityType, Class5412>)Class8651.method29439(class5412), s, n, null);
    }
    
    public Class5509(final Class8651<EntityType, Class5412> field22809, final String field22810, final float field22811, final String[] field22812) {
    ...
    public Class8651<EntityType, Class5412> method16815() {
