...
public class Class4939 extends Class4800
{
    ...
    public void draw(final float n) {
        if (Class568.field3391 != null) {
            ...
            RenderUtil.method26874(0.0f, 0.0f, (float) Minecraft.method5277().window.method7694(), (float) Minecraft.method5277().window.method7695(), ColorUtils.applyAlpha(ClientColors.DEEP_TEAL.color, 0.3f));
            super.draw(n);
            RenderUtil.drawImage(0.0f, 0.0f, (float) Minecraft.method5277().window.method7694(), (float) Minecraft.method5277().window.method7695(), Class568.field3392, ColorUtils.applyAlpha(ClientColors.LIGHT_GREYISH_BLUE.color, 1.0f - Class4939.field21206.calcPercent()));
