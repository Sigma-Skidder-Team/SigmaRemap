...
public class Class726 extends Class516<Class3438> implements Class725<Class3438>
{
    ...
    public void method2976(final float n, final int n2, final int n3) {
        ...
        this.minecraft.method5290().method5849(Class726.field3957);
        final int n4 = (this.width - this.field3075) / 2;
        final int n5 = (this.height - this.field3076) / 2;
        this.blit(n4, n5, 0, 0, this.field3075, this.field3958 * 18 + 17);
        this.blit(n4, n5 + this.field3958 * 18 + 17, 0, 126, this.field3075, 96);
    }
