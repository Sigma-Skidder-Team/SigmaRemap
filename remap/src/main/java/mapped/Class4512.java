...
public class Class4512 extends Class4500
{
    ...
    public boolean method13421(final Class1851 class1851, final Class6346<?> class1852, final Random random, final MutableBoundingBox class1853, final ChunkPos class1854) {
        ...
        final BlockState class1855 = ((StateHolder<O, BlockState>) Blocks.field29309.getDefaultState()).with((IProperty<Comparable>)Class3916.field17732, Direction.SOUTH);
        for (int i = 0; i < 6; ++i) {
            ...
            if (i < 5) {
                this.method13440(class1851, Blocks.field29368.getDefaultState(), 1, 5 - i, 1 + i, class1853);
                this.method13440(class1851, Blocks.field29368.getDefaultState(), 2, 5 - i, 1 + i, class1853);
                this.method13440(class1851, Blocks.field29368.getDefaultState(), 3, 5 - i, 1 + i, class1853);
            }
        }
        return true;
    }
