...
public class Class3297 extends Class3167
{
    ...
    public void method10449(final Class5717 class5717) {
        if (this.method9906()) {
            if (Class3297.field15514.field4684.onGround) {
                if (Class3297.field15514.field4684.collidedVertically) {
                    if (Class3297.field15514.field4684.field2970 != 0.0f || Class3297.field15514.field4684.field2968 != 0.0f) {
                        if (this.method9883("AutoJump")) {
                            ...
                            class5717.method16975(Class3297.field15514.field4684.getMotion().y);
                        }
                    }
                }
            }
            ...
            Class3297.field15514.field4684.getMotion().x = class5717.method16972();
            Class3297.field15514.field4684.getMotion().y = class5717.method16974();
    ...
    private void method10450(final Class5723 class5723) {
        if (this.method9906()) {
            if (Class3297.field15514.field4684 != null) {
                if (class5723.method16998() instanceof Class4273) {
                    final Class4273 class5724 = (Class4273)class5723.method16998();
                    if (class5724.method12822() == Class3297.field15514.field4684.getEntityId()) {
