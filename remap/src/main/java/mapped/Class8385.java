...
public class Class8385
{
    ...
    private final Class8422 field34368;
    private final Class8422 field34369;
    private ArrayList<Class8903> field34370;
    private final ArrayList<Class8903> field34371;
    private final ArrayList<Class8903> field34372;
    private final double field34373;
    private final boolean field34374;
    private static Minecraft field34375;
    ...
    public boolean method27947(final BlockPos class354) {
        for (final Class8422 class355 : Class8385.field34376) {
            final BlockState method6701 = Class8385.field34375.world.getBlockState(class354.add(class355.field34567, class355.field34568, class355.field34569));
    ...
    public boolean method27948(final int n, final int n2, final int n3) {
        ...
        return Class8385.field34375.world.getBlockState(new BlockPos(n, n2 - 1, n3)).method21696() != Blocks.AIR && (!this.method27947(class354) && !this.method27947(class354.method1137()));
    }
    ...
    public boolean method27950(final Class8422 class8422) {
        return Class8385.field34375.world.getBlockState(new BlockPos((int)class8422.method28112(), (int)class8422.method28113() - 1, (int)class8422.method28114())).method21696() != Blocks.AIR;
    }
    ...
    public static boolean method27952(final int n, final int n2, final int n3) {
        return Class8385.field34375.world.getBlockState(new BlockPos(n, n2 + 1, n3)).method21696() != Blocks.AIR || Class8385.field34375.world.getBlockState(new BlockPos(n, n2, n3)).method21696() != Blocks.AIR;
    }
    ...
    public boolean method27954(final Class8903 class8903, final Class8422 class8904, final Class2239 class8905, final double n) {
        ...
        if (method28117 == null || method28117.method31352() == Class2239.field13764) {
            ...
            if (this.field34373 == 0.0 || method28116.method28118(this.field34369) > this.field34373) {
                final ArrayList list = new ArrayList(class8903.method31355());
        ...
        if (method28117.method31357() > n) {
            final ArrayList list2 = new ArrayList(class8903.method31355());
