...
public class Class5773
{
    ...
    public static void method17173(final CommandDispatcher<Class7492> commandDispatcher) {
        ...
        for (final Class6595 class6595 : Class5773.field23619) {
            ((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)literalArgumentBuilder.then((ArgumentBuilder)class6595.method20042((ArgumentBuilder<Class7492, ?>)Class7788.method25001("merge"), argumentBuilder2 -> argumentBuilder2.then(Class7788.method25002("nbt", (com.mojang.brigadier.arguments.ArgumentType<Object>)Class7418.method22831()).executes(commandContext -> method17182((Class7492)commandContext.getSource(), class6597.method20041((CommandContext<Class7492>)commandContext), Class7418.method22832((com.mojang.brigadier.context.CommandContext<Object>)commandContext, "nbt"))))))).then((ArgumentBuilder)class6595.method20042((ArgumentBuilder<Class7492, ?>)Class7788.method25001("get"), argumentBuilder4 -> argumentBuilder4.executes(commandContext -> method17181((Class7492)commandContext.getSource(), class6598.method20041((CommandContext<Class7492>)commandContext))).then(((RequiredArgumentBuilder)Class7788.method25002("path", (com.mojang.brigadier.arguments.ArgumentType<Object>) NBTPathArgument.method27403()).executes(commandContext -> method17179((Class7492)commandContext.getSource(), class6598.method20041((CommandContext<Class7492>)commandContext), NBTPathArgument.method27404((CommandContext<Class7492>)commandContext, "path")))).then(Class7788.method25002("scale", (com.mojang.brigadier.arguments.ArgumentType<Object>)DoubleArgumentType.doubleArg()).executes(commandContext -> method17180((Class7492)commandContext.getSource(), class6598.method20041((CommandContext<Class7492>)commandContext), NBTPathArgument.method27404((CommandContext<Class7492>)commandContext, "path"), DoubleArgumentType.getDouble(commandContext, "scale")))))))).then((ArgumentBuilder)class6595.method20042((ArgumentBuilder<Class7492, ?>)Class7788.method25001("remove"), argumentBuilder6 -> argumentBuilder6.then(Class7788.method25002("path", (com.mojang.brigadier.arguments.ArgumentType<Object>) NBTPathArgument.method27403()).executes(commandContext -> method17177((Class7492)commandContext.getSource(), class6599.method20041((CommandContext<Class7492>)commandContext), NBTPathArgument.method27404((CommandContext<Class7492>)commandContext, "path"))))))).then((ArgumentBuilder)method17175((argumentBuilder7, class6600) -> argumentBuilder7.then(Class7788.method25001("insert").then(Class7788.method25002("index", (com.mojang.brigadier.arguments.ArgumentType<Object>)IntegerArgumentType.integer()).then((ArgumentBuilder)class6600.method31209((commandContext, class51, class52, list) -> method17174(IntegerArgumentType.getInteger(commandContext, "index"), class51, class52, list))))).then(Class7788.method25001("prepend").then((ArgumentBuilder)class6600.method31209((commandContext, class51, class52, list) -> method17174(0, class51, class52, list)))).then(Class7788.method25001("append").then((ArgumentBuilder)class6600.method31209((commandContext, class51, class52, list) -> method17174(-1, class51, class52, list)))).then(Class7788.method25001("set").then((ArgumentBuilder)class6600.method31209((commandContext, class51, class52, list) -> class52.func_218076_b(class51, (INBT)Iterables.getLast((Iterable)list)::method265)))).then(Class7788.method25001("merge").then((ArgumentBuilder)class6600.method31209((commandContext, class51, class52, list) -> {
                final List<INBT> method28807 = class52.func_218073_a(class51, (Supplier<INBT>) CompoundNBT::new);
                int n = 0;
    ...
    private static int method17174(final int n, final CompoundNBT class51, final NBTPath class52, final List<INBT> list) throws CommandSyntaxException {
        final List<INBT> method28807 = class52.func_218073_a(class51, (Supplier<INBT>) ListNBT::new);
        int n2 = 0;
        for (final INBT class53 : method28807) {
        ...
        while (iterator.hasNext()) {
            iterator.next().method20042((ArgumentBuilder<Class7492, ?>)method25001, argumentBuilder2 -> {
                ...
                while (iterator2.hasNext()) {
                    biConsumer2.accept(argumentBuilder3, class6597 -> class6595.method20042((ArgumentBuilder<Class7492, ?>)Class7788.method25001("from"), argumentBuilder2 -> argumentBuilder2.executes(commandContext -> method17176((CommandContext<Class7492>)commandContext, class6599, class6600, (List<INBT>)Collections.singletonList(class6598.method20041((CommandContext<Class7492>)commandContext).method16526()))).then(Class7788.method25002("sourcePath", (com.mojang.brigadier.arguments.ArgumentType<Object>) NBTPathArgument.method27403()).executes(commandContext -> method17176((CommandContext<Class7492>)commandContext, class6599, class6600, NBTPathArgument.method27404((CommandContext<Class7492>)commandContext, "sourcePath").func_218071_a(class6598.method20041((CommandContext<Class7492>)commandContext).method16526()))))));
                }
