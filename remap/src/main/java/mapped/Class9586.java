...
public class Class9586
{
    ...
    private final List<IRecipe<?>> field41792;
    private final Set<IRecipe<?>> field41793;
    private final Set<IRecipe<?>> field41794;
    private final Set<IRecipe<?>> field41795;
    ...
    public void method35940(final Class6521 class6521) {
        for (final IRecipe class6522 : this.field41792) {
    ...
    public void method35941(final Class5024 class5024, final int n, final int n2, final Class6521 class5025) {
        for (int i = 0; i < this.field41792.size(); ++i) {
            final IRecipe class5026 = this.field41792.get(i);
            final boolean b = class5026.canFit(n, n2) && class5025.method19695(class5026);
            if (!b) {
    ...
    public boolean method35942(final IRecipe<?> class3662) {
    ...
    public List<IRecipe<?>> method35945() {
        return this.field41792;
    }
    
    public List<IRecipe<?>> method35946(final boolean b) {
        final ArrayList arrayList = Lists.newArrayList();
        final Set<IRecipe<?>> set = b ? this.field41793 : this.field41794;
        for (final IRecipe class3662 : this.field41792) {
    ...
    public List<IRecipe<?>> method35947(final boolean b) {
        final ArrayList arrayList = Lists.newArrayList();
        for (final IRecipe class3662 : this.field41792) {
    ...
    public void method35948(final IRecipe<?> class3662) {
        this.field41792.add(class3662);
        if (this.field41796) {
            final ItemStack method11292 = this.field41792.get(0).getRecipeOutput();
            final ItemStack method11293 = class3662.getRecipeOutput();
