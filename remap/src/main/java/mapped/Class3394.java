...
public class Class3394 extends Class3167
{
    ...
    private void method10831(final Class5717 class5717) {
        if (this.method9906()) {
            if (!method10834()) {
                if (Class3394.field15514.player.collidedHorizontally) {
    ...
    private void method10833(final double n) {
        double n2 = Class3394.field15514.player.field4085.field24722;
        double n3 = Class3394.field15514.player.field4085.field24721;
        float field2399 = Class3394.field15514.player.rotationYaw;
        if (n2 != 0.0) {
            if (n3 <= 0.0) {
                if (n3 < 0.0) {
        ...
        Class3394.field15514.player.setPosition(Class3394.field15514.player.posX + (n2 * n * Math.cos(Math.toRadians(field2399 + 90.0f)) + n3 * n * Math.sin(Math.toRadians(field2399 + 90.0f))), Class3394.field15514.player.posY, Class3394.field15514.player.posZ + (n2 * n * Math.sin(Math.toRadians(field2399 + 90.0f)) - n3 * n * Math.cos(Math.toRadians(field2399 + 90.0f))));
    }
    
    public static boolean method10834() {
        final double n = 1.0E-7;
        return Class3394.field15514.world.method6981(Class3394.field15514.player, Class3394.field15514.player.boundingBox.expand(n, 0.0, n).expand(-n, 0.0, -n)).count() > 0L;
    }
}
