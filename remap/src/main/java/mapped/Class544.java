...
public class Class544 extends Screen
{
    ...
    public void init() {
        ...
        this.field3283 = this.method3029(new Class654(this.width / 2 - 154, this.height - 52, 150, 20, Class8822.method30773("selectWorld.select", new Object[0]), class654 -> this.field3287.method3610().ifPresent(Class641::method3669)));
        this.method3029(new Class654(this.width / 2 + 4, this.height - 52, 150, 20, Class8822.method30773("selectWorld.create", new Object[0]), class654 -> this.minecraft.method5244(new Class539(this))));
        this.field3284 = this.method3029(new Class654(this.width / 2 - 154, this.height - 28, 72, 20, Class8822.method30773("selectWorld.edit", new Object[0]), class654 -> this.field3287.method3610().ifPresent(Class641::method3671)));
        this.field3282 = this.method3029(new Class654(this.width / 2 - 76, this.height - 28, 72, 20, Class8822.method30773("selectWorld.delete", new Object[0]), class654 -> this.field3287.method3610().ifPresent(Class641::method3670)));
        this.field3285 = this.method3029(new Class654(this.width / 2 + 4, this.height - 28, 72, 20, Class8822.method30773("selectWorld.recreate", new Object[0]), class654 -> this.field3287.method3610().ifPresent(Class641::method3672)));
        this.method3029(new Class654(this.width / 2 + 82, this.height - 28, 72, 20, Class8822.method30773("gui.cancel", new Object[0]), class654 -> this.minecraft.method5244(this.field3280)));
    ...
    public boolean keyPressed(final int n, final int n2, final int n3) {
        return super.keyPressed(n, n2, n3) || this.field3286.keyPressed(n, n2, n3);
    }
    
    @Override
    public void method3028() {
        this.minecraft.method5244(this.field3280);
    }
