...
public class Class4486 extends Class4484
{
    ...
    public boolean method13421(final Class1851 class1851, final Class6346<?> class1852, final Random random, final MutableBoundingBox class1853, final Class7859 class1854) {
        ...
        this.method13444(class1851, class1853, 5, 8, 0, 7, 8, 0, Class7521.field29395.getDefaultState(), Class7521.field29395.getDefaultState(), false);
        ...
        for (int k = 4; k <= 8; ++k) {
            for (int l = 0; l <= 2; ++l) {
                ...
                this.method13449(class1851, Class7521.field29394.getDefaultState(), k, -1, 12 - l, class1853);
            }
        }
        for (int n = 0; n <= 2; ++n) {
            for (int n2 = 4; n2 <= 8; ++n2) {
                this.method13449(class1851, Class7521.field29394.getDefaultState(), n, -1, n2, class1853);
                this.method13449(class1851, Class7521.field29394.getDefaultState(), 12 - n, -1, n2, class1853);
            }
        }
        this.method13444(class1851, class1853, 5, 5, 5, 7, 5, 7, Class7521.field29394.getDefaultState(), Class7521.field29394.getDefaultState(), false);
        this.method13444(class1851, class1853, 6, 1, 6, 6, 4, 6, Class7521.field29147.getDefaultState(), Class7521.field29147.getDefaultState(), false);
        this.method13440(class1851, Class7521.field29394.getDefaultState(), 6, 0, 6, class1853);
        this.method13440(class1851, Class7521.field29174.getDefaultState(), 6, 5, 6, class1853);
