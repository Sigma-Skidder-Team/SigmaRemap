...
{
    public ScrollablePane field20741;
    ...
    public Class4838(final CustomGuiScreen customGuiScreen, final String s, final int n, final int n2, final int n3, final int n4, final String s2) {
        ...
        this.addToList(this.field20741 = new ScrollablePane(this, "albumView", 0, 0, n3, n4, ColorHelper.field25964, "View"));
            ...
            if (this.field20742.method14306()) {
                ...
                new Thread(() -> {
                    ...
                    this.runThisOnDimensionUpdate(() -> {
                        ...
                        final ScrollablePane field20741 = new ScrollablePane(this, "albumView", 0, 0, this.field20480, this.field20481, ColorHelper.field25964, "View");
                        ...
                        if (this.field20743 != null) {
                            ...
                            while (j < this.field20743.size()) {
                                ...
                                final ScrollablePane field20742 = this.field20741;
                                final int n2;
                                final int n3;
