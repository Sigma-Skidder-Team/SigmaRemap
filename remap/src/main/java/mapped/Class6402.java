...
public final class Class6402 extends Class6397
{
    ...
    private Class8321 method19089(final Class5491 class5491, final Class8321 class5492, final Class8321 class5493) {
    ...
    public Class8321 method19087(final Class5491 class5491, final Class8321 class5492) {
        ...
        if (method16765.method21696().method11785(Class7188.field27931) && method16765.method21772((Class7111<Integer>)Class3961.field17902) >= 5) {
            ...
            return this.method19089(class5491, class5492, new Class8321(Class7739.field31635));
        }
        if (!method16763.method6702(method16764).method21793(Class7324.field28319)) {
            return super.method19087(class5491, class5492);
        }
        this.field25515 = true;
        return this.method19089(class5491, class5492, Class5333.method16476(new Class8321(Class7739.field31441), Class8644.field36251));
    }
}
