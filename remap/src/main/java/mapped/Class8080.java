...
public class Class8080
{
    ...
    private static int method26499(final Class7492 class7492, final boolean b) throws CommandSyntaxException {
        ...
        if (method23255.method1451(true, b, true)) {
            class7492.method23257(new Class2259("commands.save.success"), true);
            return 1;
        }
    ...
    static {
        field33273 = new SimpleCommandExceptionType(new Class2259("commands.save.failed", new Object[0]));
    }
}
