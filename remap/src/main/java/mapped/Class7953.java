...
public class Class7953 implements Class7954
{
    ...
    public Class9017 method25804(final Entity class399, final Random random) {
        final ItemStack class400 = new ItemStack(Class7739.field31514, this.field32674);
        ...
        return new Class9017(class400, new ItemStack(this.field32677, this.field32678), Class5333.method16476(new ItemStack(this.field32672.method27622(), this.field32673), (Class8061)list.get(random.nextInt(list.size()))), this.field32675, this.field32676, this.field32679);
    }
}
