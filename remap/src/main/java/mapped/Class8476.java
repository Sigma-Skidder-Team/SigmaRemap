...
{
    private static final Map<String, Integer> field34787;
    
    public Class8476(final Schema schema, final boolean b) {
        super(schema, b);
    }
    
    public static int method28285(final String s) {
        final Integer n = Class8476.field34787.get(s);
        return (n != null) ? n : 0;
    }
    
    public TypeRewriteRule makeRule() {
        return this.fixTypeEverywhereTyped("EntityBlockStateFix", this.getInputSchema().getType(Class9451.field40626), this.getOutputSchema().getType(Class9451.field40626), typed -> {
            final Object o2 = p0 -> {};
            final Object o3 = p1 -> {};
            final Object o4 = p0 -> {};
            ...
            typed = this.method28288((Typed<?>)typed, "minecraft:ender_pearl", function2);
            typed = this.method28288((Typed<?>)typed, "minecraft:fireball", function2);
            typed = this.method28288((Typed<?>)typed, "minecraft:potion", function2);
            typed = this.method28288((Typed<?>)typed, "minecraft:small_fireball", function2);
            typed = this.method28288((Typed<?>)typed, "minecraft:snowball", function2);
            typed = this.method28288((Typed<?>)typed, "minecraft:wither_skull", function2);
            typed = this.method28288((Typed<?>)typed, "minecraft:xp_bottle", function2);
            typed = this.method28288((Typed<?>)typed, "minecraft:commandblock_minecart", function3);
            typed = this.method28288((Typed<?>)typed, "minecraft:minecart", function3);
            typed = this.method28288((Typed<?>)typed, "minecraft:chest_minecart", function3);
            typed = this.method28288((Typed<?>)typed, "minecraft:furnace_minecart", function3);
            typed = this.method28288((Typed<?>)typed, "minecraft:tnt_minecart", function3);
            typed = this.method28288((Typed<?>)typed, "minecraft:hopper_minecart", function3);
            typed = this.method28288((Typed<?>)typed, "minecraft:spawner_minecart", function3);
            return typed;
        });
    }
    ...
    static {
        field34787 = (Map)DataFixUtils.make((Object)Maps.newHashMap(), hashMap -> {
