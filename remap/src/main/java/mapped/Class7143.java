...
public class Class7143 extends Class7139<Class6936>
{
    ...
    public Stream<BlockPos> method21904(final Random random, final Class6936 class6936, final BlockPos class6937) {
        return IntStream.range(0, 3 + random.nextInt(6)).mapToObj(p2 -> new BlockPos(random2.nextInt(16) + class6938.method1074(), random2.nextInt(28) + 4, random2.nextInt(16) + class6938.method1076()));
    }
}
