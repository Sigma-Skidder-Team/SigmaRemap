...
public class Class9391
{
    public static void method34913(final CommandDispatcher<Class7492> commandDispatcher) {
        commandDispatcher.register((LiteralArgumentBuilder) ((LiteralArgumentBuilder)Class7788.method25001("weather").requires(class7492 -> class7492.method23210(2))).then(((LiteralArgumentBuilder)Class7788.method25001("clear").executes(commandContext -> method34914(commandContext.getSource(), 6000))).then(Class7788.method25002("duration", (ArgumentType<Object>)IntegerArgumentType.integer(0, 1000000)).executes(commandContext -> method34914(commandContext.getSource(), IntegerArgumentType.getInteger(commandContext, "duration") * 20)))).then(((LiteralArgumentBuilder)Class7788.method25001("rain").executes(commandContext -> method34915(commandContext.getSource(), 6000))).then(Class7788.method25002("duration", (ArgumentType<Object>)IntegerArgumentType.integer(0, 1000000)).executes(commandContext -> method34915(commandContext.getSource(), IntegerArgumentType.getInteger(commandContext, "duration") * 20)))).then(((LiteralArgumentBuilder)Class7788.method25001("thunder").executes(commandContext -> method34916(commandContext.getSource(), 6000))).then(Class7788.method25002("duration", (com.mojang.brigadier.arguments.ArgumentType<Object>)IntegerArgumentType.integer(0, 1000000)).executes(commandContext -> method34916(commandContext.getSource(), IntegerArgumentType.getInteger(commandContext, "duration") * 20)))));
    }
    ...
    private static int method34914(final Class7492 class7492, final int n) {
        ...
        class7492.method23257(new Class2259("commands.weather.set.clear"), true);
        return n;
    }
    ...
    private static int method34915(final Class7492 class7492, final int n) {
        ...
        class7492.method23250().method6764().method29557(false);
        class7492.method23257(new Class2259("commands.weather.set.rain"), true);
        return n;
    }
    ...
    private static int method34916(final Class7492 class7492, final int n) {
        ...
        class7492.method23257(new Class2259("commands.weather.set.thunder"), true);
        return n;
    }
}
