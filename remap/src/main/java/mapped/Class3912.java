...
public class Class3912 extends Class3910
{
    ...
    public Class3912(final Properties class9288) {
        super(class9288);
    }
    ...
    public void method11823(final BlockState class7096, final World class7097, final BlockPos class7098, final Random random) {
        ...
        if (random.nextInt(10) == 0) {
            class7097.addParticle(Class8432.field34634, class7098.getX() + (double)random.nextFloat(), class7098.getY() + 1.1, class7098.getZ() + (double)random.nextFloat(), 0.0, 0.0, 0.0);
        }
    }
}
