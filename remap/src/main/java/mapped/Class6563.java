...
public class Class6563 extends Class6564
{
    ...
    public void method19904() {
        if (this.field26064.method1706()) {
            this.field26064.method1936(this.field26064.method1935().add(0.0, 0.005, 0.0));
        }
        if (this.field26073 == Class2198.field13376 && !this.field26064.method4150().method24731()) {
            ...
            if (n * n + n2 * n2 + n3 * n3 >= 2.500000277905201E-7) {
                ...
                if (!this.field26064.method1706()) {
                    ...
                    this.field26064.field2400 = this.method19909(this.field26064.field2400, MathHelper.clamp(MathHelper.method35668(-(float)(MathHelper.method35693(n2, MathHelper.sqrt(n * n + n3 * n3)) * 57.2957763671875)), -85.0f, 85.0f), 5.0f);
