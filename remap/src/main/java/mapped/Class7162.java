...
public class Class7162 extends Class7133<Class6933>
{
    ...
    public Stream<BlockPos> method21923(final Class1851 class1851, final Class6346<? extends Class7065> class1852, final Random random, final Class6933 class1853, final BlockPos class1854) {
        ...
        return IntStream.range(0, method6965.method7038(class1853.field27160).length()).filter(bitIndex -> set.get(bitIndex) && random2.nextFloat() < class1855.field27161).mapToObj(n3 -> new BlockPos(class1856.method25426() + (n3 & 0xF), n3 >> 8, class1856.method25427() + (n3 >> 4 & 0xF)));
    }
}
