...
public class Class3189 extends Class3167
{
    ...
    private void method10003(final Class5723 class5723) {
        if (this.method9906()) {
            if (Class3189.field15514.player != null) {
                if (class5723.method16998() instanceof Class4273) {
                    if (((Class4273)class5723.method16998()).method12822() == Class3189.field15514.player.getEntityId()) {
                        this.field15591 = -1;
                    }
                }
            }
    ...
    public void method10004(final Class5717 class5717) {
        ...
        if (this.field15591 >= 0) {
            if (!Class6430.method19114()) {
                if (Class3189.field15514.player.onGround) {
                    this.field15593 = Class3189.field15514.player.rotationYaw + 90.0f;
                }
            }
            else if (!Class3189.field15514.player.onGround) {
