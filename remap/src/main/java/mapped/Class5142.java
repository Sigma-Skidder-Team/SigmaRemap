...
public class Class5142 implements Class5113
{
    ...
    public <T> Dynamic<T> method16010(final DynamicOps<T> dynamicOps) {
        return (Dynamic<T>)new Dynamic(dynamicOps, dynamicOps.createMap((Map)ImmutableMap.of(dynamicOps.createString("feature_true"), this.field22128.method28612((com.mojang.datafixers.types.DynamicOps<Object>)dynamicOps).getValue(), dynamicOps.createString("feature_false"), this.field22129.method28612((com.mojang.datafixers.types.DynamicOps<Object>)dynamicOps).getValue())));
    }
