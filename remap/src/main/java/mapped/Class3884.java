...
public class Class3884 extends Class3874 implements Class3872
{
    ...
    public Class3884(final Class9288 class9288) {
        super(class9288);
        this.method11877(((Class7097<O, BlockState>)this.field17406.method32903()).method21773((Class7111<Comparable>)Class3884.field17541, 0));
    }
        ...
        if (intValue < 3) {
            if (random.nextInt(5) == 0) {
                if (class7097.method6993(class7098.method1137(), 0) >= 9) {
                    class7097.method6688(class7098, (BlockState)((Class7097<Object, Object>)class7096).method21773((Class7111<Comparable>)Class3884.field17541, intValue + 1), 2);
                }
            }
        }
    }
    ...
    public Class2201 method11844(final BlockState class7096, final World class7097, final BlockPos class7098, final Class512 class7099, final Class316 class7100, final Class7005 class7101) {
        ...
        Class3833.method11839(class7097, class7098, new ItemStack(Items.field31630, 1 + class7097.rand.nextInt(2) + n));
        class7097.method6705(null, class7098, Class8520.field35630, Class286.field1582, 1.0f, 0.8f + class7097.rand.nextFloat() * 0.4f);
        class7097.method6688(class7098, ((Class7097<O, BlockState>)class7096).method21773((Class7111<Comparable>)Class3884.field17541, 1), 2);
    ...
    public void method11947(final Class1849 class1849, final Random random, final BlockPos class1850, final BlockState class1851) {
        class1849.method6688(class1850, ((Class7097<O, BlockState>)class1851).method21773((Class7111<Comparable>)Class3884.field17541, Math.min(3, class1851.method21772((Class7111<Integer>)Class3884.field17541) + 1)), 2);
    }
