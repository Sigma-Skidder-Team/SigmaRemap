...
public class Class7548
{
    ...
    public Class7548(String replace, final Color color) throws SlickException {
        this.field29944 = new HashMap();
        this.field29945 = 2;
        replace = replace.replace('\\', '/');
        this.field29943 = replace.substring(0, replace.lastIndexOf("/") + 1);
        this.method23708(replace, color);
    }
    ...
    public Class7548(String replace, final int field29945, final Color color) throws SlickException {
        this.field29944 = new HashMap();
        this.field29945 = 2;
    ...
    private void method23708(final String s, final Color color) throws SlickException {
        final BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(Class8834.method30851(s)));
        try {
            this.field29942 = new Class7764(this.field29943 + bufferedReader.readLine(), false, this.field29945, color);
