...
public class Class4938 extends Class4800
{
    ...
    public Class4938() {
        super("Alt Manager");
        this.field21204 = Class9463.method35173().method35198();
        ...
        n2 += 50;
        this.method14239(this.field21202 = new Class4909(this, "back", n3, n2, n, 40, "Back", Class265.field1281.field1292));
        n2 += 50;
        this.method14239(this.field21203 = new Class4909(this, "import", n3, n2, n, 40, "Import user:pass", Class265.field1281.field1292));
        ...
        this.field21202.method14260((class4803, n) -> Class9463.method35173().method35193().method32156(new Class4936()));
