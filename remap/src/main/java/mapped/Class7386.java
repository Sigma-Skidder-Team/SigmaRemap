...
public class Class7386
{
    ...
    public Class7386() {
        ...
        this.field28457 = (int)(Class3364.method10686().field4632.method7694() * Math.random());
        this.field28458 = (int)(Class3364.method10687().field4632.method7695() * Math.random());
    }
    ...
    public void method22685() {
        ...
        GL11.glPushMatrix();
        GL11.glTranslatef((float)(Class3364.method10688().field4632.method7694() / 2), (float)(Class3364.method10689().field4632.method7695() / 2), 0.0f);
        GL11.glScalef(n, n, 1.0f);
        GL11.glTranslatef((float)(-Class3364.method10690().field4632.method7694() / 2), (float)(-Class3364.method10691().field4632.method7695() / 2), 0.0f);
