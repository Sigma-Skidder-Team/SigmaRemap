...
public class Class5441 extends Class5419<Class824>
{
    ...
    public void method16561(final Class1849 class1849, final Class824 class1850, final long n) {
        ...
        class1849.getServer().method1481(class1851.method1169()).method6921().method7210(class1851.method1170()).ifPresent(p2 -> Registry.field240.method509().filter(class1853 -> class1853.method34575() == class1852).findFirst().ifPresent(class1856 -> {
