...
public class Class4871 extends Class4873 implements Class4870
{
    ...
    public Class4871(final Class4803 class4803, final String s, final int n, final int n2, final int n3, final int n4, final Texture class4804, final Class6523 class4805, final String s2, final TrueTypeFont class4806) {
        super(class4803, s, n, n2, n3, n4, class4804, class4805, s2, class4806);
        this.field20853 = false;
    }
    
    public Class4871(final Class4803 class4803, final String s, final int n, final int n2, final int n3, final int n4, final Texture class4804, final Class6523 class4805, final String s2) {
        super(class4803, s, n, n2, n3, n4, class4804, class4805, s2);
        this.field20853 = false;
    }
    
    public Class4871(final Class4803 class4803, final String s, final int n, final int n2, final int n3, final int n4, final Texture class4804, final Class6523 class4805) {
        super(class4803, s, n, n2, n3, n4, class4804, class4805);
        this.field20853 = false;
    }
    
    public Class4871(final Class4803 class4803, final String s, final int n, final int n2, final int n3, final int n4, final Texture class4804) {
    ...
    public void draw(final float n) {
        ...
        final float[] method19131 = ColorUtils.method19131(this.method14607().method24920(), this.method14607().method24919(), (float)n3, (float)n4);
        RenderUtil.method26871(this.method14280() + n5 - this.field20478, this.method14281() + n6 - this.field20479, this.method14280() + n5 - this.field20478 + n3, this.method14281() + n6 - this.field20479 + n4, true);
        RenderUtil.method26899(n5 + method19131[0], n6 + method19131[1], method19131[2], method19131[3], this.method14607(), ColorUtils.applyAlpha(ColorUtils.method19120(this.field20497.method19729(), this.field20497.method19727(), 1.0f - n2), n));
        ...
        if (this.field20852 > 1.0f) {
            ...
            RenderUtil.method26904((1.0f - this.field20852 / this.method14605()) * method19132.getWidth(s) / 2.0f + 1.0f - method19132.getWidth(s) / 2.0f, method19132.getHeight(s) / 3.0f, (float)(method19132.getWidth(s) * 2), method19132.getHeight(s) * 3.0f, ClientAssets.shadow, n7 * 0.6f * n);
            RenderUtil.drawString(method19132, (1.0f - this.field20852 / this.method14605()) * method19132.getWidth(s) / 2.0f + 1.0f, 40.0f, s, ColorUtils.applyAlpha(this.method14318().method19729(), n7 * 0.6f * n));
            GL11.glPopMatrix();
        }
        super.method14229(n);
    }
