...
public class Class4871 extends Class4873 implements Class4870
{
    ...
    public void draw(final float n) {
        ...
        final float[] method19131 = ColorUtils.method19131(this.method14607().getWidth(), this.method14607().getHeight(), (float)n3, (float)n4);
        ...
        RenderUtil.drawImage(n5 + method19131[0], n6 + method19131[1], method19131[2], method19131[3], this.method14607(), ColorUtils.applyAlpha(ColorUtils.method19120(this.field20497.method19729(), this.field20497.method19727(), 1.0f - n2), n));
