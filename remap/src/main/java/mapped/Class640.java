...
public class Class640 extends Class623<Class640>
{
    ...
    public void method3467(final int n, final int n2, final int n3, final int n4, final int n5, final int n6, final int n7, final boolean b, final float n8) {
        this.field3640.drawString(this.field3640.field3585.font, new Class2259("stat." + this.field3639.method35135().toString().replace(':', '.')).applyTextStyle(TextFormatting.GRAY).getString(), n3 + 2, n2 + 1, (n % 2 != 0) ? 9474192 : 16777215);
