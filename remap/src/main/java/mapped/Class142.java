...
public class Class142 extends Class126
{
    ...
    private final CompoundNBT field423;
    
    private Class142(final Class122[] array, final CompoundNBT field423) {
        super(array);
    ...
    public ItemStack method639(final ItemStack class8321, final Class7529 class8322) {
        class8321.method27658().merge(this.field423);
        return class8321;
    }
    
    public static Class4943<?> method693(final CompoundNBT class51) {
