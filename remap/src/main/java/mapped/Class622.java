...
public class Class622 extends Class593<Class622>
{
    ...
    private final List<Widget> field3602;
    
    private Class622(final List<Widget> field3602) {
    ...
    public static Class622 method3620(final Class5760 class5760, final int n, final Class6469 class5761) {
        return new Class622((List<Widget>)ImmutableList.of((Object)class5761.method19362(class5760, n / 2 - 155, 0, 310)));
    }
