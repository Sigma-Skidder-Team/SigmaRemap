...
public class Class3485 extends Class3479
{
    ...
    public void method11053(final Class1851 class1851, final Class354 class1852) {
    }
    
    public void method11054(final Class1847 class1847, final Class354 class1848) {
    }
    ...
    public void method11016() {
        ...
        final Class354 method11055 = this.method11055(new Class354(this.field16415), field2391);
            ...
            if (method11055 != null) {
                if (this.field16416 > 0) {
                    ...
                    if (!field2391.field10067) {
                        ((Class1849)field2391).method6911(new Class6910(Class8432.field34629, new Class8321(Class7739.field31374)), method11055.method1074() + 0.5, method11055.method1075() + 0.7, method11055.method1076() + 0.5, 3, (method11056.nextFloat() - 0.5) * 0.08, (method11056.nextFloat() - 0.5) * 0.08, (method11056.nextFloat() - 0.5) * 0.08, 0.15000000596046448);
                    }
                }
                ...
                if (this.field16416 > 60) {
                    ...
                    if (!field2391.field10067) {
                        for (int i = 0; i < 20; ++i) {
                            ((Class1849)field2391).method6911(Class8432.field34636, method11055.method1074() + 0.5, method11055.method1075(), method11055.method1076() + 0.5, 1, method11056.nextGaussian() * 0.02, method11056.nextGaussian() * 0.02, method11056.nextGaussian() * 0.02, 0.15000000596046448);
                        }
    ...
    @Nullable
    private Class354 method11055(final Class354 class354, final Class1855 class355) {
        if (class355.method6701(class354).method21696() != this.field16414) {
            for (final Class354 class356 : new Class354[] { class354.method1139(), class354.method1145(), class354.method1147(), class354.method1141(), class354.method1143(), class354.method1139().method1139() }) {
    ...
    public boolean method11050(final Class1852 class1852, final Class354 class1853) {
        final Class1860 method6687 = class1852.method6687(class1853.method1074() >> 4, class1853.method1076() >> 4, Class9312.field39989, false);
        if (method6687 != null) {
