...
public class Class3916 extends Block implements Class3856
{
    ...
    private int method12023(final BlockState class7096) {
    ...
    public static Class183 method12024(final BlockState class7096, final IBlockReader class7097, final BlockPos class7098) {
        ...
        final BlockState method6702 = class7097.getBlockState(class7098.method1149(class7099.getOpposite()));
    ...
    public static boolean method12026(final BlockState class7096) {
    ...
    public BlockState method11790(final BlockState class7096, final Class2052 class7097) {
        return ((StateHolder<O, BlockState>)class7096).with((IProperty<Comparable>)Class3916.field17732, class7097.method8142(class7096.method21772((IProperty<Direction>)Class3916.field17732)));
    }
    ...
    public BlockState method11791(final BlockState class7096, final Class2181 class7097) {
        ...
        Label_0354: {
            switch (class7097.ordinal()) {
                case 1: {
                    if (class7098.getAxis() != Direction.Axis.Z) {
                        break;
                    }
                    switch (class7099.ordinal()) {
                        case 1: {
                            return class7096.method21708(Class2052.field11709)).with(Class3916.field17734, Class183.field569);
                        }
                        case 2: {
                            return class7096.method21708(Class2052.field11709)).with(Class3916.field17734, Class183.field568);
                        }
                        case 3: {
                            return class7096.method21708(Class2052.field11709)).with(Class3916.field17734, Class183.field571);
                        }
                        case 4: {
                            return class7096.method21708(Class2052.field11709)).with(Class3916.field17734, Class183.field570);
                        }
                        default: {
