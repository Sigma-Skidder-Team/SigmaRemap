...
public class Class3524 extends Class3446
{
    ...
    public boolean method11013() {
        if (this.field16532 <= this.field16533.ticksExisted) {
            if (!this.field16533.method2625()) {
                if (!this.field16533.method1706()) {
                    if (this.field16533.method4414()) {
                        if (this.field16533.method4371() <= 0) {
                            return !this.field16533.world.method6739((Class<? extends Entity>)Class427.class, this.field16533.getBoundingBox().grow(6.0, 6.0, 6.0), (Predicate<? super Entity>)Class791.method4427()).isEmpty() || !this.field16533.method2718(Class2215.field13600).method27620();
                        }
                    }
                }
            }
