...
public class Class6519
{
    ...
    public static void method19677(final CommandDispatcher<Class7492> commandDispatcher) {
        commandDispatcher.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)Class7788.method25001("ban-ip").requires(class7492 -> class7492.method23255().method1537().method20592().method26203() && class7492.method23210(3))).then(((RequiredArgumentBuilder)Class7788.method25002("target", (com.mojang.brigadier.arguments.ArgumentType<Object>)StringArgumentType.word()).executes(commandContext -> method19678(commandContext.getSource(), StringArgumentType.getString(commandContext, "target"), null))).then(Class7788.method25002("reason", (com.mojang.brigadier.arguments.ArgumentType<Object>)Class8695.method29806()).executes(commandContext -> method19678(commandContext.getSource(), StringArgumentType.getString(commandContext, "target"), Class8695.method29807(commandContext, "reason"))))));
    }
    ...
    private static int method19679(final Class7492 class7492, final String s, final ITextComponent class7493) throws CommandSyntaxException {
        ...
        if (!method20592.method26223(s)) {
            ...
            method20592.method26206(class7494);
            class7492.method23257(new Class2259("commands.banip.success", s, class7494.method17950()), true);
            if (!method20593.isEmpty()) {
                class7492.method23257(new Class2259("commands.banip.info", method20593.size(), Class9043.method32517(method20593)), true);
            }
            final Iterator iterator = method20593.iterator();
            while (iterator.hasNext()) {
                ((Class513)iterator.next()).field3039.method17463(new Class2259("multiplayer.disconnect.ip_banned"));
            }
    ...
    static {
        ...
        field25944 = new SimpleCommandExceptionType(new Class2259("commands.banip.invalid", new Object[0]));
        field25945 = new SimpleCommandExceptionType(new Class2259("commands.banip.failed", new Object[0]));
    }
}
