...
public class Class3502 extends Class3446
{
    ...
    public boolean method11013() {
        final List<Entity> method6739 = this.field16464.world.method6739(Class759.class, this.field16464.getBoundingBox().intersect(this.field16472), (Predicate<? super Entity>)this.field16465);
    ...
    public boolean method11017() {
        if (this.field16466 != null) {
            if (!this.field16468.method24731()) {
                return this.field16464.method1734(this.field16466) > this.field16470 * this.field16470;
            }
        }
        return false;
    }
