...
public class Class6126 implements Class6113
{
    ...
    public void method18347(final Collection<BlockPos> field24869) {
    ...
    private static void method18349(final String s, final BlockPos class354, final int n) {
        Class7282.method22341(s, class354.getX() + 0.5, class354.getY() + 1.3, class354.getZ() + 0.5, n, 0.04f, true, 0.0f, true);
    }
