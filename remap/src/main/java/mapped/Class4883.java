...
public class Class4883 extends Panel
{
    ...
    public void draw(final float partialTicks) {
        RenderUtil.drawString(ClassicAssets.field40808, (float)(this.x + 10), (float)(this.y + 8), this.field20878.getFormattedName(), AllUtils.applyAlpha(ClientColors.DEEP_TEAL.color, this.field20878.isEnabled() ? 0.9f : 0.5f));
        RenderUtil.drawString(ClassicAssets.field40809, (float)(this.x + 15), (float)(this.y + 33), "Bind", AllUtils.applyAlpha(ClientColors.DEEP_TEAL.color, 1.0f));
        RenderUtil.drawString(ClassicAssets.field40809, (float)(this.x + 15), (float)(this.y + 52), AllUtils.method19166(this.field20878.method9885("Keybind")), AllUtils.applyAlpha(ClientColors.DEEP_TEAL.color, 0.7f));
        if (this.field20878.getSettingMap().size() > 1) {
            RenderUtil.drawString(ClassicAssets.field40810, (float)(this.x + 84), (float)(this.y + 34), "Settings", AllUtils.applyAlpha(ClientColors.DEEP_TEAL.color, 1.0f));
        }
