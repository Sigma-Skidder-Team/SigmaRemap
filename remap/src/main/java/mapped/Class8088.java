...
public class Class8088
{
    ...
    private void method26562(final Class5742 class5742) {
        ...
        if (class5744 == Class2049.field11679 && this.field33313.field4683.method6701(class5743.field36684.method30692().method1139()).method21706()) {
            equals = false;
        }
    ...
    private void method26564(final Class5744 class5744) {
        ...
        if (this.method26560()) {
            ...
            while (iterator.hasNext()) {
                ...
                if (this.field33313.field4683.method6701(method1129).method21706()) {
                    continue;
                }
                list.add(method1129);
            }
