...
public class Class372 extends Class367
{
    ...
    public void method1241(final Class1851 class1851, final Random random2, final List<BlockPos> list4, final List<BlockPos> list2, final Set<BlockPos> set, final MutableBoundingBox class1852) {
        if (random2.nextFloat() < this.field2212) {
            ...
            final List<? super Object> list3 = list4.stream().filter(class1855 -> {
            ...
            if (!list3.isEmpty()) {
                ...
                if (Class4592.method13609(class1851, method1149)) {
                    if (Class4592.method13609(class1851, method1149.method1149(Direction.SOUTH))) {
                        this.method1243(class1851, method1149, ((StateHolder<O, BlockState>) Blocks.BEE_NEST.getDefaultState()).with((IProperty<Comparable>)Class3961.field17901, Direction.SOUTH), set, class1852);
    ...
    public <T> T serialize(final DynamicOps<T> dynamicOps) {
        return (T)new Dynamic(dynamicOps, dynamicOps.createMap(ImmutableMap.of(dynamicOps.createString("type"), dynamicOps.createString(Registry.field221.getKey(this.field2209).toString()), dynamicOps.createString("probability"), dynamicOps.createFloat(this.field2212)))).getValue();
    }
}
