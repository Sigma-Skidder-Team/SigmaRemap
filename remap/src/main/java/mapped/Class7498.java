...
public class Class7498
{
    ...
    public void method23342() {
        ...
        this.field28952 = MathHelper.smallestEncompassingPowerOfTwo(this.field28952);
        this.field28953 = MathHelper.smallestEncompassingPowerOfTwo(this.field28953);
    }
    ...
    private boolean method23346(final Class9260 class9260) {
        MathHelper.smallestEncompassingPowerOfTwo(this.field28952);
        MathHelper.smallestEncompassingPowerOfTwo(this.field28953);
        final int method35679 = MathHelper.smallestEncompassingPowerOfTwo(this.field28952 + class9260.field39721);
        final int method35680 = MathHelper.smallestEncompassingPowerOfTwo(this.field28953 + class9260.field39722);
