...
public class Class862 extends Class860
{
    ...
    public boolean method5189() {
        if (this.world.method6977(this)) {
            ...
            return (method6701.getMaterial().method26439() || (this.field4600.getAxis().isHorizontal() && Class3895.method11975(method6701))) && this.world.getEntitiesInAABBexcluding(this, this.getBoundingBox(), Class862.field4597).isEmpty();
        }
        return false;
    }
