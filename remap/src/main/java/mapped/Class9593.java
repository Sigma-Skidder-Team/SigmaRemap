...
public class Class9593
{
    ...
    public static Class9593 method35977(final BlockState class7098, final Class7686 class7097, final Collection<IProperty<?>> collection) {
        return new Class9593(class7097.method24404().stream().filter(class7101 -> {
            class7098.getBlock().getStateContainer();
    ...
    public static Class9593 method35978(final BlockState class7096, final Class7684 class7097, final Collection<IProperty<?>> collection) {
        return new Class9593((List<Class7684>)ImmutableList.of((Object)class7097), method35979(class7096, collection));
    }
    
    private static List<Object> method35979(final BlockState class7096, final Collection<IProperty<?>> collection) {
        return collection.stream().map((Function<? super IProperty<?>, ?>)class7096::get).collect((Collector<? super Object, Object, List<Object>>)ImmutableList.toImmutableList());
    }
}
