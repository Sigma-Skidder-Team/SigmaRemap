...
public class Class8001
{
    ...
    public static void method26175(final CommandDispatcher<Class7492> commandDispatcher) {
        commandDispatcher.register((LiteralArgumentBuilder) ((LiteralArgumentBuilder)Class7788.method25001("debug").requires(class7492 -> class7492.method23210(3))).then(Class7788.method25001("start").executes(commandContext -> method26176(commandContext.getSource()))).then(Class7788.method25001("stop").executes(commandContext -> method26177(commandContext.getSource()))).then(Class7788.method25001("report").executes(commandContext -> method26178(commandContext.getSource()))));
    }
    ...
    private static int method26176(final Class7492 class7492) throws CommandSyntaxException {
        ...
        if (!method23255.method1590().method15305().method19593()) {
            ...
            class7492.method23257(new Class2259("commands.debug.started", "Started the debug profiler. Type '/debug stop' to stop it."), true);
            return 0;
        }
    ...
    private static int method26177(final Class7492 class7492) throws CommandSyntaxException {
        ...
        if (method23256.method15305().method19593()) {
            ...
            class7492.method23257(new Class2259("commands.debug.stopped", String.format(Locale.ROOT, "%.2f", f), method23257.method17098(), String.format("%.2f", f2)), true);
        ...
        try {
            ...
            if (!Class9528.field41021 && Class8001.field32955 != null) {
                try (final FileSystem fileSystem = Class8001.field32955.newFileSystem(path.resolve(string + ".zip"), (Map<String, ?>)ImmutableMap.of((Object)"create", (Object)"true"))) {
                    method23255.method1593(fileSystem.getPath("/"));
                }
            }
            else {
                method23255.method1593(path.resolve(string));
            }
            class7492.method23257(new Class2259("commands.debug.reportSaved", string), false);
            return 1;
        }
        catch (final IOException ex) {
            Class8001.field32952.error("Failed to save debug dump", ex);
            class7492.method23259(new Class2259("commands.debug.reportFailed"));
            return 0;
        }
    }
    ...
    static {
        ...
        field32953 = new SimpleCommandExceptionType(new Class2259("commands.debug.notRunning", new Object[0]));
        field32954 = new SimpleCommandExceptionType(new Class2259("commands.debug.alreadyRunning", new Object[0]));
