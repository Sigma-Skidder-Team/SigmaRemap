...
public class Class5418 extends Class5419<LivingEntity>
{
    ...
    @Nullable
    private Vec3d method16540(final Class1849 class1849, final LivingEntity class1850) {
        final Random method2633 = class1850.method2633();
        final BlockPos class1851 = new BlockPos(class1850);
        for (int i = 0; i < 10; ++i) {
            final BlockPos method2634 = class1851.add(method2633.nextInt(20) - 10, method2633.nextInt(6) - 3, method2633.nextInt(20) - 10);
