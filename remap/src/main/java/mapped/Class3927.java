...
public class Class3927 extends Class3926
{
    ...
    public Class3927(final Block field17793, final Class9288 class9288) {
        super(class9288);
    ...
    public void method11822(final BlockState class7096, final Class1849 class7097, final BlockPos class7098, final Random random) {
        if (!Class3922.method12038(class7096, class7097, class7098)) {
            class7097.setBlockState(class7098, ((StateHolder<O, BlockState>)((StateHolder<O, BlockState>)this.field17793.getDefaultState()).with((IProperty<Comparable>)Class3927.field17782, false)).with((IProperty<Comparable>)Class3927.field17791, (Comparable)class7096.get((IProperty<V>)Class3927.field17791)), 2);
        }
    }
    
    @Override
    public BlockState method11789(final BlockState class7096, final Direction class7097, final BlockState class7098, final Class1851 class7099, final BlockPos class7100, final BlockPos class7101) {
        if (class7097.getOpposite() == class7096.get((IProperty<Direction>)Class3927.field17791) && !class7096.method21752(class7099, class7100)) {
            return Class7521.field29147.getDefaultState();
        }
        if (class7096.get((IProperty<Boolean>)Class3927.field17782)) {
