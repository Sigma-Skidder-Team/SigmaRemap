...
public class Class5144 implements Class5113
{
    ...
    private Class5144(final Class357 field22133, final Class373 field22134, final Set<Class3833> field22135, final Set<BlockState> field22136, final int field22137, final int field22138, final int field22139, final int field22140, final boolean field22141, final boolean field22142, final boolean field22143) {
    ...
    public static <T> Class5144 method16063(final Dynamic<T> dynamic) {
        return new Class5144(Class90.field218.method505(new Class1932(dynamic.get("state_provider").get("type").asString().orElseThrow(RuntimeException::new))).method30718((Dynamic<?>)dynamic.get("state_provider").orElseEmptyMap()), Class90.field219.method505(new Class1932(dynamic.get("block_placer").get("type").asString().orElseThrow(RuntimeException::new))).method27915((Dynamic<?>)dynamic.get("block_placer").orElseEmptyMap()), (Set<Class3833>)dynamic.get("whitelist").asList((Function) BlockState::method21764).stream().map(BlockState::method21696).collect(Collectors.toSet()), Sets.newHashSet((Iterable)dynamic.get("blacklist").asList((Function) BlockState::method21764)), dynamic.get("tries").asInt(128), dynamic.get("xspread").asInt(7), dynamic.get("yspread").asInt(3), dynamic.get("zspread").asInt(7), dynamic.get("can_replace").asBoolean(false), dynamic.get("project").asBoolean(true), dynamic.get("need_water").asBoolean(false));
    }
}
