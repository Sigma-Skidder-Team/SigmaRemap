...
import com.mentalfrostbyte.jello.auth.agora.AgoraWebSocket;
...
public class AgoraManager {
    ...
    public void createConnection() {
        ...
        try {
            AgoraWebSocket agoraWebSocket = new AgoraWebSocket(this, "wss://wsprg.sigmaclient.info/ws/agora/" + token, headers);
