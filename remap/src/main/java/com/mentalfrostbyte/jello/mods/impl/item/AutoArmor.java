...
public class AutoArmor extends Module
{
    ...
    public void onEnable() {
        if (!this.field15964.isRunning()) {
            this.field15964.start();
        }
    ...
    public void method10601(final EventPlayerTick eventPlayerTick) {
        ...
        if ((AutoArmor.mc.currentScreen == null || AutoArmor.mc.currentScreen instanceof Class518 || AutoArmor.mc.currentScreen instanceof ChatScreen) && this.field15964.getElapsedTime() > n) {
            AutoArmor.field15966 = false;
        ...
        if (!this.field15965 && !(AutoArmor.mc.currentScreen instanceof Class518) && this.field15964.getElapsedTime() > 0L) {
                            ...
                            if (this.field15967) {
                                if (!(AutoArmor.mc.player.inventory.getStackInSlot(36 + Class2215.field13604.getIndex()).getItem() instanceof Class4080)) {
                                    ...
                                    if (Class2215.field13604 == class2215) {
                                        if (!Client.getInstance().moduleManager().getModuleByClass(AutoArmor.class).getBooleanValueFromSettingName("Fake Items") || Client.getInstance().getTimeManager().method28162(j) >= 1500L) {
                                            this.method10603(b);
