            ...
            if (method872 != null) {
                ...
                if (method872.field894 == null) {
                    if (method872.field895 != null) {
                        ...
                        RenderUtil.method26909(class5742, ColorUtils.applyAlpha(ClientColors.DARK_BLUE_GREY.color, 0.1f));
                        RenderUtil.method26911(class5742, ColorUtils.applyAlpha(ClientColors.DARK_BLUE_GREY.color, 0.1f));
                    }
                }
                else {
                    ...
                    RenderUtil.method26909(class5743, ColorUtils.applyAlpha(ClientColors.PALE_ORANGE.color, 0.1f));
                    RenderUtil.method26911(class5743, ColorUtils.applyAlpha(ClientColors.PALE_ORANGE.color, 0.1f));
                    GL11.glPopMatrix();
                }
                GL11.glDisable(2896);
