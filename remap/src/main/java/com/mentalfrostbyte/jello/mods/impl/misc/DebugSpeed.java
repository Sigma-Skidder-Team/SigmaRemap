        ...
        if (this.method9906()) {
            ...
            if (DebugSpeed.mc.player.onGround) {
                if (this.field15620 != null) {
                    ...
                    final boolean b = Client.method35173().method35194().method29228() > 1 && DebugSpeed.mc.player.field2985 == 0;
                    ...
                    ColorUtils.method19106(Client.method35173().method35204().method32671() + "(" + s + "x faster " + (b ? "walking" : "jumping") + ")  Speed: " + d);
                }
            }
            int field15621;
            if (!DebugSpeed.mc.player.onGround) {
