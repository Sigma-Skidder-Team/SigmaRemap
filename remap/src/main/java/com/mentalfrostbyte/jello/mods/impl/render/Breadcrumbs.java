...
public class Breadcrumbs extends Module
{
    ...
    public void method10419(final Custom3DRenderEvent custom3DRenderEvent) {
        if (this.isEnabled()) {
            ...
            GL11.glColor4fv(AllUtils.method19139(AllUtils.applyAlpha(this.method9885("Color"), 0.5f)));
            GL11.glBegin(3);
            for (final Vec3d class5741 : this.field15850) {
                ...
                if (method10419 <= 24.0) {
                    GL11.glColor4fv(AllUtils.method19139(AllUtils.applyAlpha(this.method9885("Color"), (float)n)));
