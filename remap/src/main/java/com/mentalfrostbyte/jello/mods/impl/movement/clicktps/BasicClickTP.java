            ...
            if (this.field15867 != null) {
                if (this.field15867.size() != 0) {
                    ...
                    for (final Class9407 class5741 : this.field15867) {
                        ...
                        RenderUtil.method26909(new Class7644(n - 0.30000001192092896, class5741.method34994() - BasicClickTP.mc.field4644.method5833().method18161().getY(), n2 - 0.30000001192092896, n + 0.30000001192092896, class5741.method34994() - BasicClickTP.mc.field4644.method5833().method18161().getY() + 1.600000023841858, n2 + 0.30000001192092896), AllUtils.applyAlpha(ClientColors.PALE_ORANGE.color, 0.2f));
                    }
                    GL11.glPushMatrix();
