        ...
        if (!this.method10595()) {
            if (AACAntiKnockBack.field15956 < 7) {
                ...
                if (AACAntiKnockBack.field15956 > 1) {
                    ...
                    if (Class8845.method30918(this.field15957, (float)(Math.atan2(y, x) * 180.0 / 3.141592653589793) - 90.0f) > 100.0f && AllUtils.method19114()) {
            ...
            if (!AACAntiKnockBack.mc.player.onGround) {
                if (AACAntiKnockBack.mc.player.field2938 > 0) {
                    if (AACAntiKnockBack.mc.player.fallDistance < 2.0f) {
                        ...
                        AllUtils.method19155(AACAntiKnockBack.mc.player.getMotion().getY());
