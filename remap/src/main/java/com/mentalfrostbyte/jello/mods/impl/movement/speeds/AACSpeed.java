...
public class AACSpeed extends Module
{
    ...
    @EventListener
    public void method10166(final EventReceivePacket eventReceivePacket) {
        if (this.isEnabled()) {
    ...
    public void method10167(final Class5717 class5717) {
        ...
        if (AllUtils.method19160(AACSpeed.mc.player, 0.01f)) {
            ...
            if (AllUtils.method19114() && this.getBooleanValueFromSettingName("Auto Jump")) {
    ...
    private double method10170(final int n) {
        ...
        final boolean method19160 = AllUtils.method19160(AACSpeed.mc.player, 0.37f);
