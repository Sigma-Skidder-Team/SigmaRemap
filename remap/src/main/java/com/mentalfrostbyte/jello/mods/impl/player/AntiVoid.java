...
public class AntiVoid extends Module
{
    ...
    public void onEnable() {
        ...
        this.field15664 = 0;
        this.field15663 = 0;
        if (AntiVoid.mc.player.onGround || AllUtils.method19160(AntiVoid.mc.player, 0.001f)) {
    ...
    private void method10134(final Class5717 class5717) {
        if (this.isEnabled()) {
            ...
            if (this.field15664 <= 0) {
                final Module method21551 = Client.getInstance().moduleManager().getModuleByClass(Fly.class);
                final String method21552 = method21551.getStringSettingValueByName("Type");
                final Module method21553 = Client.getInstance().moduleManager().getModuleByClass(HighJump.class);
    ...
    private void method10138(String s, final Class5717 class5717) {
        ...
        if (s.equals("Cubecraft") && !AllUtils.method19148()) {
            s = "Motion";
        }
        final String s2 = s;
        switch (s2) {
            ...
            case "Cubecraft": {
                ...
                Client.getInstance().moduleManager().getModuleByClass(Fly.class).method9909(false);
                break;
            }
            case "Legit": {
                this.field15664 = 200;
