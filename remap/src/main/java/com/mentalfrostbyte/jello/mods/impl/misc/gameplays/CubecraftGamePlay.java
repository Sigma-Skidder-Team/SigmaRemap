...
public class CubecraftGamePlay extends Module
{
    ...
    private void method10140(final Class5723 class5723) {
        if (this.method9906() && CubecraftGamePlay.mc.player != null) {
                ...
                if (method16999.contains("§a§lPlay Again §r§8\u2022 §r§6§lAuto Mode §r§8\u2022 §r§c§lLeave")) {
                    if (this.field15666.method9883("Auto Join")) {
                        ...
                        while (iterator.hasNext()) {
                            ...
                            Client.method35173().method35197().method25776(new Class6224("Auto Join", "Joining a new game in 3 seconds.", (int)(this.field15666.getNumberSettingValueByName("Auto Join delay") - 1.0f) * 1000));
                            break;
                        }
                    }
                }
