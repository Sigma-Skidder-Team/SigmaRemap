...
public class ShulkerInfo extends Module
{
    ...
    public void method9924(final Custom3DRenderEvent custom3DRenderEvent) {
        if (this.isEnabled()) {
            ...
            for (final Entity class5740 : AllUtils.method19138()) {
                if (class5740 instanceof Class427) {
                    ...
                    if (this.method9925(class5741)) {
                        ...
                        GL11.glEnable(2848);
                        RenderUtil.method26909(new Class7644(n - n4, n2 + 0.009999999776482582, n3 - n4, n + n4, n2 + n4 * 2.0f, n3 + n4), AllUtils.applyAlpha(ClientColors.DEEP_TEAL.color, 0.1f));
                        RenderUtil.method26912(new Class7644(n - n4, n2 + 0.009999999776482582, n3 - n4, n + n4, n2 + n4 * 2.0f, n3 + n4), 3.0f, AllUtils.applyAlpha(ClientColors.DEEP_TEAL.color, 0.3f));
                        GL11.glDisable(3042);
    ...
    private void method9929(final int n, final int n2, final List<ItemStack> list, final String s, final boolean b) {
        ...
        GL11.glAlphaFunc(519, 0.0f);
        if (!b) {
            RenderUtil.method26874((float)n, (float)n2, (float)n6, (float)n5, AllUtils.applyAlpha(AllUtils.method19120(ClientColors.LIGHT_GREYISH_BLUE.color, ClientColors.DEEP_TEAL.color, 75.0f), 0.7f));
            RenderUtil.method26913((float)n, (float)n2, (float)n6, (float)n5, 10.0f, 0.5f);
        }
        else {
            RenderUtil.draw(n, n2, n6, n5, AllUtils.applyAlpha(ClientColors.DEEP_TEAL.color, 0.94f));
        }
        RenderUtil.drawString(ClientFonts.JelloLight25, (float)(n + n3), (float)(n2 + n3 - 3), s, AllUtils.applyAlpha(ClientColors.LIGHT_GREYISH_BLUE.color, 0.8f));
        ...
        for (int i = 0; i < list.size(); ++i) {
            ...
            if (i == this.field15530) {
                if (b) {
                    RenderUtil.method26874((float)n8, (float)n7, (float)round, (float)round, AllUtils.applyAlpha(ClientColors.LIGHT_GREYISH_BLUE.color, 0.15f));
                }
            }
            ...
            if (class8321.field34176 > 1) {
                ...
                GL11.glAlphaFunc(519, 0.0f);
                RenderSystem.method30002();
                RenderUtil.method26900((float)(n8 + n9 - 17 - method23540 / 4), (float)(n7 + 7), (float)(40 + method23540), 40.0f, ClientAssets.shadow, AllUtils.applyAlpha(ClientColors.LIGHT_GREYISH_BLUE.color, 0.7f), false);
        ...
        for (int j = 0; j < list.size(); ++j) {
            ...
            if (j == this.field15530) {
                if (b) {
                    ...
                    RenderUtil.method26874((float)n11, (float)(n10 + round), n12 + 9.0f * RenderUtil.method26867(), 10.0f * RenderUtil.method26867() * method23541.size() + 7.0f * RenderUtil.method26867(), AllUtils.applyAlpha(ClientColors.DEEP_TEAL.color, 0.8f));
                    GL11.glPushMatrix();
